...
0000000000001100 <simple_xdp>:
    ...
    1107:	48 89 ce             	mov    rsi,rcx
    110a:	31 c0                	xor    eax,eax
    110c:	48 39 d6             	cmp    rsi,rdx
    110f:	77 2b                	ja     113c <simple_xdp+0x3c>
    1111:	48 8d 7e 08          	lea    rdi,[rsi+0x8]
    1115:	48 39 d7             	cmp    rdi,rdx
    1118:	77 22                	ja     113c <simple_xdp+0x3c>
    111a:	48 83 c6 48          	add    rsi,0x48
    111e:	48 39 d6             	cmp    rsi,rdx
    1121:	77 19                	ja     113c <simple_xdp+0x3c>
    1123:	66 c7 01 4e 61       	mov    WORD PTR [rcx],0x614e
    1128:	c6 41 02 bc          	mov    BYTE PTR [rcx+0x2],0xbc
    112c:	c7 41 03 00 00 00 00 	mov    DWORD PTR [rcx+0x3],0x0
    1133:	c6 41 07 00          	mov    BYTE PTR [rcx+0x7],0x0
    1137:	b8 02 00 00 00       	mov    eax,0x2
    113c:	c3                   	ret
...
0000000000001140 <_fini>:
    ...
    1144:	48 83 ec 08          	sub    rsp,0x8
    1148:	48 83 c4 08          	add    rsp,0x8
    114c:	c3                   	ret
```
