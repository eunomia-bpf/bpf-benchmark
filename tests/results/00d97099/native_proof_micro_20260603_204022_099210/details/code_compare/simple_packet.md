...
0000000000001100 <simple_packet_xdp>:
    ...
    110f:	77 22                	ja     1133 <simple_packet_xdp+0x33>
    1111:	48 83 c6 08          	add    rsi,0x8
    1115:	48 39 d6             	cmp    rsi,rdx
    1118:	77 19                	ja     1133 <simple_packet_xdp+0x33>
    111a:	66 c7 01 4e 61       	mov    WORD PTR [rcx],0x614e
    111f:	c6 41 02 bc          	mov    BYTE PTR [rcx+0x2],0xbc
    1123:	c7 41 03 00 00 00 00 	mov    DWORD PTR [rcx+0x3],0x0
    112a:	c6 41 07 00          	mov    BYTE PTR [rcx+0x7],0x0
    112e:	b8 02 00 00 00       	mov    eax,0x2
    1133:	c3                   	ret
