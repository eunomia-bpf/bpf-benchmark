...
TARGET_DIR="${ARM64_HOST_DAEMON_TARGET_DIR:-$ROOT_DIR/.cache/aws-arm64/daemon-host-cross/target}"
OUTPUT_DIR="${ARM64_HOST_DAEMON_OUTPUT_DIR:-$ROOT_DIR/.cache/aws-arm64/daemon-host-cross/output}"
OUTPUT_BINARY="${ARM64_HOST_DAEMON_BINARY:-$OUTPUT_DIR/bpfrejit-daemon}"
CARGO_HOME_DIR="${ARM64_HOST_DAEMON_CARGO_HOME:-$ROOT_DIR/.cache/aws-arm64/cargo-home-host-daemon}"
