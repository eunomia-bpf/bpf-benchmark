...
AWS_ARM64_BENCH_SAMPLES="${AWS_ARM64_BENCH_SAMPLES:-1}"
AWS_ARM64_BENCH_WARMUPS="${AWS_ARM64_BENCH_WARMUPS:-0}"
AWS_ARM64_BENCH_INNER_REPEAT="${AWS_ARM64_BENCH_INNER_REPEAT:-10}"
...
Optional env:
  ...
  AWS_ARM64_BENCH_SAMPLES      default: 1
  AWS_ARM64_BENCH_WARMUPS      default: 0
  AWS_ARM64_BENCH_INNER_REPEAT default: 10
EOF
}
