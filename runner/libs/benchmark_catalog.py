...
MACRO_APP_DEFINITIONS: tuple[MacroAppDefinition, ...] = (
    ...
    MacroAppDefinition(name="otelcol-ebpf-profiler/default", runner="otelcol-ebpf-profiler", workload="exec_storm"),
    MacroAppDefinition(name="cilium/default", runner="cilium", workload="network"),
