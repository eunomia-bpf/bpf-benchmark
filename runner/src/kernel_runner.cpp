...
const handcraft_kinsn_desc &handcraft_kinsn_desc_for_selector(int selector)
{
    static constexpr handcraft_kinsn_desc descriptors[] = {
        ...
        {MICRO_HANDCRAFT_BPF_X86_MOVSWL_RR, "bpf_x86_mov_reg", "bpf_x86_movswl_rr"},
        {MICRO_HANDCRAFT_BPF_X86_IMULQ_RR, "bpf_x86_imul", "bpf_x86_imulq_rr"},
        {MICRO_HANDCRAFT_BPF_X86_TESTL_RR, "bpf_x86_cmov", "bpf_x86_testl_rr"},
        {MICRO_HANDCRAFT_BPF_X86_TESTB_RR, "bpf_x86_cmov", "bpf_x86_testb_rr"},
        {MICRO_HANDCRAFT_BPF_X86_TESTB_IMM, "bpf_x86_cmov", "bpf_x86_testb_imm"},
        {MICRO_HANDCRAFT_BPF_X86_NOTB_R, "bpf_x86_not", "bpf_x86_notb_r"},
        {MICRO_HANDCRAFT_BPF_X86_NOTW_R, "bpf_x86_not", "bpf_x86_notw_r"},
        {MICRO_HANDCRAFT_BPF_X86_NOTL_R, "bpf_x86_not", "bpf_x86_notl_r"},
        {MICRO_HANDCRAFT_BPF_X86_NOTQ_R, "bpf_x86_not", "bpf_x86_notq_r"},
        {MICRO_HANDCRAFT_BPF_X86_MOVSXD_SIB, "bpf_x86_mov_sib", "bpf_x86_movsxd_sib"},
        ...
        {MICRO_HANDCRAFT_BPF_X86_SHLDL_IMM, "bpf_x86_shd", "bpf_x86_shldl_imm"},
        {MICRO_HANDCRAFT_BPF_X86_SHLDQ_IMM, "bpf_x86_shd", "bpf_x86_shldq_imm"},
        {MICRO_HANDCRAFT_BPF_X86_SHRDL_IMM, "bpf_x86_shd", "bpf_x86_shrdl_imm"},
        {MICRO_HANDCRAFT_BPF_X86_SHRDQ_IMM, "bpf_x86_shd", "bpf_x86_shrdq_imm"},
        {MICRO_HANDCRAFT_BPF_X86_CMOVBL, "bpf_x86_cmov", "bpf_x86_cmovbl"},
        {MICRO_HANDCRAFT_BPF_X86_CMOVBQ, "bpf_x86_cmov", "bpf_x86_cmovbq"},
        {MICRO_HANDCRAFT_BPF_X86_SETNE_R, "bpf_x86_cmov", "bpf_x86_setne_r"},
