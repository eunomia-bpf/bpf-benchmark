...
/// Retrieve current kernel-translated BPF bytecode through upstream
/// `bpf_prog_info.xlated_prog_*`.
...
/// Retrieve native JIT image bytes through `bpf_prog_info.jited_prog_*`.
...
pub const PERF_FLAG_PID_CGROUP: libc::c_ulong = 1 << 2;
