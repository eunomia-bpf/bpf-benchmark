...
## Test programs in `native-sim/test/`
...
| file | role |
|---|---|
| `native-sim/test/*.bpf.c` | 6 POC test programs |
...
5. **8 new test cases under `native-sim/test/`** spanning helper-only,
...
Stage 2 = the 14 maps/helpers test programs from `native-sim/test/`
