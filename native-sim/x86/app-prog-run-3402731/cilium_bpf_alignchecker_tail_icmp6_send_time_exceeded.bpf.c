...
x86_l_cb:
	/* 0xcb: js     557 <tail_icmp6_send_time_exceeded+0x557> */
	X86_SIM_X86_JCC(X86_CC_S, 0xcb, 0x557, x86_l_557);
x86_l_d1:
	/* 0xd1: mov    eax,0x9 */
...
x86_l_ec:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_ee:
	/* 0xee: js     552 <tail_icmp6_send_time_exceeded+0x552> */
	X86_SIM_X86_JCC(X86_CC_S, 0xee, 0x552, x86_l_552);
x86_l_f4:
...
x86_l_114:
	/* 0x114: jne    557 <tail_icmp6_send_time_exceeded+0x557> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x114, 0x557, x86_l_557);
x86_l_11a:
	/* 0x11a: mov    eax,0x1a */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 26ULL);
x86_l_11f:
...
x86_l_135:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_137:
	/* 0x137: js     557 <tail_icmp6_send_time_exceeded+0x557> */
	X86_SIM_X86_JCC(X86_CC_S, 0x137, 0x557, x86_l_557);
x86_l_13d:
	/* 0x13d: mov    eax,0x1c */
...
x86_l_1f8:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_1fa:
	/* 0x1fa: js     552 <tail_icmp6_send_time_exceeded+0x552> */
	X86_SIM_X86_JCC(X86_CC_S, 0x1fa, 0x552, x86_l_552);
x86_l_200:
	/* 0x200: mov    eax,0x9 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 9ULL);
x86_l_205:
...
x86_l_21a:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_21c:
	/* 0x21c: js     552 <tail_icmp6_send_time_exceeded+0x552> */
	X86_SIM_X86_JCC(X86_CC_S, 0x21c, 0x552, x86_l_552);
x86_l_222:
	/* 0x222: mov    eax,0x9 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 9ULL);
x86_l_227:
...
x86_l_242:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_244:
	/* 0x244: js     557 <tail_icmp6_send_time_exceeded+0x557> */
	X86_SIM_X86_JCC(X86_CC_S, 0x244, 0x557, x86_l_557);
x86_l_24a:
	/* 0x24a: mov    eax,0x1c */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 28ULL);
x86_l_24f:
...
x86_l_305:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_307:
	/* 0x307: js     552 <tail_icmp6_send_time_exceeded+0x552> */
	X86_SIM_X86_JCC(X86_CC_S, 0x307, 0x552, x86_l_552);
x86_l_30d:
	/* 0x30d: mov    eax,0x9 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 9ULL);
x86_l_312:
...
x86_l_327:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_329:
	/* 0x329: js     552 <tail_icmp6_send_time_exceeded+0x552> */
	X86_SIM_X86_JCC(X86_CC_S, 0x329, 0x552, x86_l_552);
x86_l_32f:
	/* 0x32f: mov    eax,0x9 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 9ULL);
x86_l_334:
...
x86_l_34f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_351:
	/* 0x351: js     557 <tail_icmp6_send_time_exceeded+0x557> */
	X86_SIM_X86_JCC(X86_CC_S, 0x351, 0x557, x86_l_557);
x86_l_357:
...
x86_l_373:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_375:
	/* 0x375: js     5e3 <tail_icmp6_send_time_exceeded+0x5e3> */
	X86_SIM_X86_JCC(X86_CC_S, 0x375, 0x5e3, x86_l_5e3);
x86_l_37b:
...
x86_l_395:
	/* 0x395: mov    rax,QWORD PTR [rip+0x0] */
...
x86_l_3c7:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_3c9:
	/* 0x3c9: js     557 <tail_icmp6_send_time_exceeded+0x557> */
	X86_SIM_X86_JCC(X86_CC_S, 0x3c9, 0x557, x86_l_557);
x86_l_3cf:
	/* 0x3cf: mov    eax,0x1a */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 26ULL);
x86_l_3d4:
...
x86_l_3ed:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_3ef:
	/* 0x3ef: js     557 <tail_icmp6_send_time_exceeded+0x557> */
	X86_SIM_X86_JCC(X86_CC_S, 0x3ef, 0x557, x86_l_557);
x86_l_3f5:
	/* 0x3f5: mov    eax,0x9 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 9ULL);
x86_l_3fa:
...
x86_l_40f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_411:
	/* 0x411: js     552 <tail_icmp6_send_time_exceeded+0x552> */
	X86_SIM_X86_JCC(X86_CC_S, 0x411, 0x552, x86_l_552);
x86_l_417:
	/* 0x417: mov    eax,0x9 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 9ULL);
x86_l_41c:
...
x86_l_431:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_433:
	/* 0x433: js     552 <tail_icmp6_send_time_exceeded+0x552> */
	X86_SIM_X86_JCC(X86_CC_S, 0x433, 0x552, x86_l_552);
x86_l_439:
	/* 0x439: mov    eax,0x1c */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 28ULL);
x86_l_43e:
...
x86_l_475:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_477:
	/* 0x477: js     557 <tail_icmp6_send_time_exceeded+0x557> */
	X86_SIM_X86_JCC(X86_CC_S, 0x477, 0x557, x86_l_557);
x86_l_47d:
	/* 0x47d: mov    eax,0x1c */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 28ULL);
x86_l_482:
...
x86_l_4b1:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_4b3:
	/* 0x4b3: js     557 <tail_icmp6_send_time_exceeded+0x557> */
	X86_SIM_X86_JCC(X86_CC_S, 0x4b3, 0x557, x86_l_557);
x86_l_4b9:
	/* 0x4b9: mov    eax,0x1a */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 26ULL);
x86_l_4be:
...
x86_l_4da:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_4dc:
	/* 0x4dc: js     557 <tail_icmp6_send_time_exceeded+0x557> */
	X86_SIM_X86_JCC(X86_CC_S, 0x4dc, 0x557, x86_l_557);
x86_l_4de:
	/* 0x4de: mov    eax,0x9 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 9ULL);
x86_l_4e3:
	/* 0x4e3: lea    rdx,[rsp+0xa0] */
	X86_SIM_L_EXEC_LEA(X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 160ULL);
x86_l_4eb:
	/* 0x4eb: mov    rdi,rbx */
	X86_SIM_L_EXEC_MOV_REG(X86_RDI, X86_RBX, X86_WIDTH_64);
...
x86_l_4fa:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_4fc:
	/* 0x4fc: js     552 <tail_icmp6_send_time_exceeded+0x552> */
	X86_SIM_X86_JCC(X86_CC_S, 0x4fc, 0x552, x86_l_552);
x86_l_4fe:
	/* 0x4fe: mov    eax,0x9 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 9ULL);
x86_l_503:
	/* 0x503: lea    rdx,[rsp+0x98] */
...
x86_l_51e:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_520:
	/* 0x520: mov    ebp,0xffffff73 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RBP, X86_WIDTH_32, 4294967155ULL);
x86_l_525:
	/* 0x525: test   eax,eax */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_527:
	/* 0x527: js     557 <tail_icmp6_send_time_exceeded+0x557> */
	X86_SIM_X86_JCC(X86_CC_S, 0x527, 0x557, x86_l_557);
x86_l_529:
	/* 0x529: mov    rax,QWORD PTR [rbx+0x10] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RAX, X86_RBX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 16ULL);
x86_l_52d:
	/* 0x52d: test   rax,rax */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_530:
	/* 0x530: je     539 <tail_icmp6_send_time_exceeded+0x539> */
	X86_SIM_X86_JCC(X86_CC_E, 0x530, 0x539, x86_l_539);
x86_l_532:
	/* 0x532: mov    r14d,DWORD PTR [rax+0xe0] */
...
x86_l_547:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_549:
	/* 0x549: js     557 <tail_icmp6_send_time_exceeded+0x557> */
	X86_SIM_X86_JCC(X86_CC_S, 0x549, 0x557, x86_l_557);
x86_l_54b:
	/* 0x54b: cmp    ebp,0x2 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBP, X86_WIDTH_32, 2ULL);
x86_l_54e:
	/* 0x54e: jne    5cb <tail_icmp6_send_time_exceeded+0x5cb> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x54e, 0x5cb, x86_l_5cb);
x86_l_550:
	/* 0x550: jmp    557 <tail_icmp6_send_time_exceeded+0x557> */
	X86_SIM_X86_JMP(0x550, 0x557, x86_l_557);
x86_l_552:
	/* 0x552: mov    ebp,0xffffff73 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RBP, X86_WIDTH_32, 4294967155ULL);
x86_l_557:
	/* 0x557: mov    eax,ebp */
...
x86_l_578:
	/* 0x578: mov    BYTE PTR [rsp+0x11],r13b */
...
x86_l_590:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_593:
	/* 0x593: je     59e <tail_icmp6_send_time_exceeded+0x59e> */
	X86_SIM_X86_JCC(X86_CC_E, 0x593, 0x59e, x86_l_59e);
x86_l_595:
	/* 0x595: inc    QWORD PTR [rax] */
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_598:
	/* 0x598: add    QWORD PTR [rax+0x8],rbx */
...
x86_l_5de:
	/* 0x5de: jmp    5ed <tail_icmp6_send_time_exceeded+0x5ed> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_5e3:
	/* 0x5e3: mov    ebp,0xffffff66 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RBP, X86_WIDTH_32, 4294967142ULL);
x86_l_5e8:
	/* 0x5e8: jmp    557 <tail_icmp6_send_time_exceeded+0x557> */
	X86_SIM_X86_JMP(0x5e8, 0x557, x86_l_557);
x86_l_5ed:
