...
SEC("xdp")
int cilium_bpf_overlay_tail_icmp6_send_time_exceeded_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_8e:
	/* 0x8e: mov    rax,QWORD PTR [rip+0x2c0] */
...
x86_l_395:
	/* 0x395: mov    rax,QWORD PTR [rip+0x2c0] */
...
x86_l_5a7:
	/* 0x5a7: mov    rdi,QWORD PTR [rip+0x2bc] */
...
x86_l_5d6:
	/* 0x5d6: mov    rdi,QWORD PTR [rip+0x2bc] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&cilium_metrics)));
x86_l_5dd:
...
x86_l_5f0:
	/* 0x5f0: mov    rsi,QWORD PTR [rip+0x2bc] */
