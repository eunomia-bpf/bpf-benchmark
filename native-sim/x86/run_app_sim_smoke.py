#!/usr/bin/env python3
"""Generate and compile x86 simulator proofs from native app proof objects."""
...
X86_SIM_DIR = Path(__file__).resolve().parent
GENERATOR = X86_SIM_DIR / "micro-prog" / "generate_micro_sim_proofs.py"
DEFAULT_PROOF_ROOT = REPO_ROOT / "vendor" / "build" / "native-bpf" / "x86" / "stage"
DEFAULT_OUTPUT_DIR = X86_SIM_DIR / "app-prog"
