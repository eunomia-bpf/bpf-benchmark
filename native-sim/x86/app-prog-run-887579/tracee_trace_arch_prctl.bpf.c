...
x86_l_38:
	/* 0x38: je     1bc <trace_arch_prctl+0x1bc> */
	X86_SIM_X86_JCC(X86_CC_E, 0x38, 0x1bc, x86_l_1bc);
x86_l_3e:
	/* 0x3e: mov    DWORD PTR [r14+0x68],0x9e */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 446676598942ULL);
x86_l_46:
	/* 0x46: mov    eax,0x7d */
...
x86_l_a0:
	/* 0xa0: jne    e2 <trace_arch_prctl+0xe2> */
...
x86_l_dd:
	/* 0xdd: jmp    191 <trace_arch_prctl+0x191> */
...
x86_l_1b7:
	/* 0x1b7: jmp    6ab <trace_arch_prctl+0x6ab> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_1bc:
...
x86_l_1df:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1e2:
	/* 0x1e2: je     1ae <trace_arch_prctl+0x1ae> */
...
x86_l_2f6:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_2f9:
	/* 0x2f9: je     1ae <trace_arch_prctl+0x1ae> */
...
x86_l_31d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_320:
	/* 0x320: je     1ae <trace_arch_prctl+0x1ae> */
...
x86_l_510:
	/* 0x510: jne    55f <trace_arch_prctl+0x55f> */
...
x86_l_62a:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_TEST_MEM_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 2ULL);
x86_l_62e:
	/* 0x62e: je     635 <trace_arch_prctl+0x635> */
...
x86_l_6a4:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_6a6:
	/* 0x6a6: jmp    3e <trace_arch_prctl+0x3e> */
