...
SEC("xdp")
int cilium_bpf_alignchecker_tail_icmp6_send_time_exceeded_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_87:
	/* 0x87: mov    rax,QWORD PTR [rip+0x0] */
...
x86_l_c4:
	/* 0xc4: js     550 <tail_icmp6_send_time_exceeded+0x550> */
	X86_SIM_X86_JCC(X86_CC_S, 0xc4, 0x550, x86_l_550);
x86_l_ca:
	/* 0xca: mov    eax,0x9 */
...
x86_l_e5:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_e7:
	/* 0xe7: js     54b <tail_icmp6_send_time_exceeded+0x54b> */
	X86_SIM_X86_JCC(X86_CC_S, 0xe7, 0x54b, x86_l_54b);
x86_l_ed:
...
x86_l_10d:
	/* 0x10d: jne    550 <tail_icmp6_send_time_exceeded+0x550> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x10d, 0x550, x86_l_550);
x86_l_113:
	/* 0x113: mov    eax,0x1a */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 26ULL);
x86_l_118:
...
x86_l_12e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_130:
	/* 0x130: js     550 <tail_icmp6_send_time_exceeded+0x550> */
	X86_SIM_X86_JCC(X86_CC_S, 0x130, 0x550, x86_l_550);
x86_l_136:
	/* 0x136: mov    eax,0x1c */
...
x86_l_1f1:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_1f3:
	/* 0x1f3: js     54b <tail_icmp6_send_time_exceeded+0x54b> */
	X86_SIM_X86_JCC(X86_CC_S, 0x1f3, 0x54b, x86_l_54b);
x86_l_1f9:
	/* 0x1f9: mov    eax,0x9 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 9ULL);
x86_l_1fe:
...
x86_l_213:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_215:
	/* 0x215: js     54b <tail_icmp6_send_time_exceeded+0x54b> */
	X86_SIM_X86_JCC(X86_CC_S, 0x215, 0x54b, x86_l_54b);
x86_l_21b:
	/* 0x21b: mov    eax,0x9 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 9ULL);
x86_l_220:
...
x86_l_23b:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_23d:
	/* 0x23d: js     550 <tail_icmp6_send_time_exceeded+0x550> */
	X86_SIM_X86_JCC(X86_CC_S, 0x23d, 0x550, x86_l_550);
x86_l_243:
	/* 0x243: mov    eax,0x1c */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 28ULL);
x86_l_248:
...
x86_l_2fe:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_300:
	/* 0x300: js     54b <tail_icmp6_send_time_exceeded+0x54b> */
	X86_SIM_X86_JCC(X86_CC_S, 0x300, 0x54b, x86_l_54b);
x86_l_306:
	/* 0x306: mov    eax,0x9 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 9ULL);
x86_l_30b:
...
x86_l_320:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_322:
	/* 0x322: js     54b <tail_icmp6_send_time_exceeded+0x54b> */
	X86_SIM_X86_JCC(X86_CC_S, 0x322, 0x54b, x86_l_54b);
x86_l_328:
	/* 0x328: mov    eax,0x9 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 9ULL);
x86_l_32d:
...
x86_l_348:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_34a:
	/* 0x34a: js     550 <tail_icmp6_send_time_exceeded+0x550> */
	X86_SIM_X86_JCC(X86_CC_S, 0x34a, 0x550, x86_l_550);
x86_l_350:
...
x86_l_36c:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_36e:
	/* 0x36e: js     5d5 <tail_icmp6_send_time_exceeded+0x5d5> */
	X86_SIM_X86_JCC(X86_CC_S, 0x36e, 0x5d5, x86_l_5d5);
x86_l_374:
...
x86_l_38e:
	/* 0x38e: mov    rax,QWORD PTR [rip+0x0] */
...
x86_l_3c0:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_3c2:
	/* 0x3c2: js     550 <tail_icmp6_send_time_exceeded+0x550> */
	X86_SIM_X86_JCC(X86_CC_S, 0x3c2, 0x550, x86_l_550);
x86_l_3c8:
	/* 0x3c8: mov    eax,0x1a */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 26ULL);
x86_l_3cd:
...
x86_l_3e6:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_3e8:
	/* 0x3e8: js     550 <tail_icmp6_send_time_exceeded+0x550> */
	X86_SIM_X86_JCC(X86_CC_S, 0x3e8, 0x550, x86_l_550);
x86_l_3ee:
	/* 0x3ee: mov    eax,0x9 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 9ULL);
x86_l_3f3:
...
x86_l_408:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_40a:
	/* 0x40a: js     54b <tail_icmp6_send_time_exceeded+0x54b> */
	X86_SIM_X86_JCC(X86_CC_S, 0x40a, 0x54b, x86_l_54b);
x86_l_410:
	/* 0x410: mov    eax,0x9 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 9ULL);
x86_l_415:
...
x86_l_42a:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_42c:
	/* 0x42c: js     54b <tail_icmp6_send_time_exceeded+0x54b> */
	X86_SIM_X86_JCC(X86_CC_S, 0x42c, 0x54b, x86_l_54b);
x86_l_432:
	/* 0x432: mov    eax,0x1c */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 28ULL);
x86_l_437:
...
x86_l_46e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_470:
	/* 0x470: js     550 <tail_icmp6_send_time_exceeded+0x550> */
	X86_SIM_X86_JCC(X86_CC_S, 0x470, 0x550, x86_l_550);
x86_l_476:
	/* 0x476: mov    eax,0x1c */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 28ULL);
x86_l_47b:
...
x86_l_4aa:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_4ac:
	/* 0x4ac: js     550 <tail_icmp6_send_time_exceeded+0x550> */
	X86_SIM_X86_JCC(X86_CC_S, 0x4ac, 0x550, x86_l_550);
x86_l_4b2:
	/* 0x4b2: mov    eax,0x1a */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 26ULL);
x86_l_4b7:
...
x86_l_4d3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_4d5:
	/* 0x4d5: js     550 <tail_icmp6_send_time_exceeded+0x550> */
	X86_SIM_X86_JCC(X86_CC_S, 0x4d5, 0x550, x86_l_550);
x86_l_4d7:
	/* 0x4d7: mov    eax,0x9 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 9ULL);
x86_l_4dc:
	/* 0x4dc: lea    rdx,[rsp+0xa0] */
	X86_SIM_L_EXEC_LEA(X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 160ULL);
x86_l_4e4:
	/* 0x4e4: mov    rdi,rbx */
	X86_SIM_L_EXEC_MOV_REG(X86_RDI, X86_RBX, X86_WIDTH_64);
...
x86_l_4f3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_4f5:
	/* 0x4f5: js     54b <tail_icmp6_send_time_exceeded+0x54b> */
	X86_SIM_X86_JCC(X86_CC_S, 0x4f5, 0x54b, x86_l_54b);
x86_l_4f7:
	/* 0x4f7: mov    eax,0x9 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 9ULL);
x86_l_4fc:
	/* 0x4fc: lea    rdx,[rsp+0x98] */
...
x86_l_517:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_519:
	/* 0x519: mov    ebp,0xffffff73 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RBP, X86_WIDTH_32, 4294967155ULL);
x86_l_51e:
	/* 0x51e: test   eax,eax */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_520:
	/* 0x520: js     550 <tail_icmp6_send_time_exceeded+0x550> */
	X86_SIM_X86_JCC(X86_CC_S, 0x520, 0x550, x86_l_550);
x86_l_522:
	/* 0x522: mov    rax,QWORD PTR [rbx+0x10] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RAX, X86_RBX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 16ULL);
x86_l_526:
	/* 0x526: test   rax,rax */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_529:
	/* 0x529: je     532 <tail_icmp6_send_time_exceeded+0x532> */
	X86_SIM_X86_JCC(X86_CC_E, 0x529, 0x532, x86_l_532);
x86_l_52b:
	/* 0x52b: mov    r14d,DWORD PTR [rax+0xe0] */
...
x86_l_540:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_542:
	/* 0x542: js     550 <tail_icmp6_send_time_exceeded+0x550> */
	X86_SIM_X86_JCC(X86_CC_S, 0x542, 0x550, x86_l_550);
x86_l_544:
	/* 0x544: cmp    ebp,0x2 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBP, X86_WIDTH_32, 2ULL);
x86_l_547:
	/* 0x547: jne    5c4 <tail_icmp6_send_time_exceeded+0x5c4> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x547, 0x5c4, x86_l_5c4);
x86_l_549:
	/* 0x549: jmp    550 <tail_icmp6_send_time_exceeded+0x550> */
	X86_SIM_X86_JMP(0x549, 0x550, x86_l_550);
x86_l_54b:
	/* 0x54b: mov    ebp,0xffffff73 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RBP, X86_WIDTH_32, 4294967155ULL);
x86_l_550:
	/* 0x550: mov    eax,ebp */
...
x86_l_571:
	/* 0x571: mov    BYTE PTR [rsp+0x11],r13b */
...
x86_l_589:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_58c:
	/* 0x58c: je     597 <tail_icmp6_send_time_exceeded+0x597> */
	X86_SIM_X86_JCC(X86_CC_E, 0x58c, 0x597, x86_l_597);
x86_l_58e:
	/* 0x58e: inc    QWORD PTR [rax] */
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_591:
	/* 0x591: add    QWORD PTR [rax+0x8],rbx */
...
x86_l_595:
	/* 0x595: jmp    5bf <tail_icmp6_send_time_exceeded+0x5bf> */
	X86_SIM_X86_JMP(0x595, 0x5bf, x86_l_5bf);
x86_l_597:
	/* 0x597: mov    QWORD PTR [rsp+0x30],0x1 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 206158430209ULL);
x86_l_5a0:
	/* 0x5a0: mov    QWORD PTR [rsp+0x38],rbx */
...
x86_l_5d0:
	/* 0x5d0: jmp    5df <tail_icmp6_send_time_exceeded+0x5df> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_5d5:
	/* 0x5d5: mov    ebp,0xffffff66 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RBP, X86_WIDTH_32, 4294967142ULL);
x86_l_5da:
	/* 0x5da: jmp    550 <tail_icmp6_send_time_exceeded+0x550> */
	X86_SIM_X86_JMP(0x5da, 0x550, x86_l_550);
x86_l_5df:
