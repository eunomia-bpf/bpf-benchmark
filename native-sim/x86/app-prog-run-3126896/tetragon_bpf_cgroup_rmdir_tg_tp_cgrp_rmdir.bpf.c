...
x86_l_1e:
	/* 0x1e: je     3e9 <tg_tp_cgrp_rmdir+0x3e9> */
...
x86_l_55:
	/* 0x55: je     3e9 <tg_tp_cgrp_rmdir+0x3e9> */
...
x86_l_82:
	/* 0x82: je     3e9 <tg_tp_cgrp_rmdir+0x3e9> */
...
x86_l_9b:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_9e:
	/* 0x9e: je     2ef <tg_tp_cgrp_rmdir+0x2ef> */
...
x86_l_cd:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_d0:
	/* 0xd0: je     3e9 <tg_tp_cgrp_rmdir+0x3e9> */
...
x86_l_d9:
	/* 0xd9: jne    3e9 <tg_tp_cgrp_rmdir+0x3e9> */
...
x86_l_ff:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_102:
	/* 0x102: je     3e9 <tg_tp_cgrp_rmdir+0x3e9> */
...
x86_l_28c:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_28f:
	/* 0x28f: jns    3e9 <tg_tp_cgrp_rmdir+0x3e9> */
...
x86_l_37f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_382:
	/* 0x382: je     3e9 <tg_tp_cgrp_rmdir+0x3e9> */
...
x86_l_389:
	/* 0x389: je     3e9 <tg_tp_cgrp_rmdir+0x3e9> */
...
x86_l_43b:
	/* 0x43b: jmp    3e9 <tg_tp_cgrp_rmdir+0x3e9> */
