...
x86_l_1e:
	/* 0x1e: je     40d <tg_tp_cgrp_rmdir+0x40d> */
...
x86_l_55:
	/* 0x55: je     40d <tg_tp_cgrp_rmdir+0x40d> */
...
x86_l_82:
	/* 0x82: je     40d <tg_tp_cgrp_rmdir+0x40d> */
...
x86_l_9b:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_9e:
	/* 0x9e: je     313 <tg_tp_cgrp_rmdir+0x313> */
...
x86_l_cd:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_d0:
	/* 0xd0: je     40d <tg_tp_cgrp_rmdir+0x40d> */
...
x86_l_d9:
	/* 0xd9: jne    40d <tg_tp_cgrp_rmdir+0x40d> */
...
x86_l_ff:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_102:
	/* 0x102: je     40d <tg_tp_cgrp_rmdir+0x40d> */
...
x86_l_140:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_143:
	/* 0x143: je     16b <tg_tp_cgrp_rmdir+0x16b> */
...
x86_l_16b:
	/* 0x16b: mov    DWORD PTR [rbx+0x20],0x2 */
...
x86_l_1a2:
	/* 0x1a2: je     212 <tg_tp_cgrp_rmdir+0x212> */
...
x86_l_1cd:
	/* 0x1cd: je     212 <tg_tp_cgrp_rmdir+0x212> */
...
x86_l_27e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_281:
	/* 0x281: je     41b <tg_tp_cgrp_rmdir+0x41b> */
...
x86_l_28b:
	/* 0x28b: je     41b <tg_tp_cgrp_rmdir+0x41b> */
...
x86_l_2ba:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_2bd:
	/* 0x2bd: jns    40d <tg_tp_cgrp_rmdir+0x40d> */
...
x86_l_3a3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3a6:
	/* 0x3a6: je     40d <tg_tp_cgrp_rmdir+0x40d> */
...
x86_l_3ad:
	/* 0x3ad: je     40d <tg_tp_cgrp_rmdir+0x40d> */
...
x86_l_416:
	/* 0x416: jmp    4d4 <tg_tp_cgrp_rmdir+0x4d4> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_41b:
...
x86_l_435:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_438:
	/* 0x438: jns    40d <tg_tp_cgrp_rmdir+0x40d> */
...
x86_l_4cf:
	/* 0x4cf: jmp    40d <tg_tp_cgrp_rmdir+0x40d> */
