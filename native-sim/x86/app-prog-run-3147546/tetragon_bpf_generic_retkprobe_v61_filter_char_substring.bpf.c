...
SEC("xdp")
int tetragon_bpf_generic_retkprobe_v61_filter_char_substring_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_34:
	/* 0x34: mov    rdi,QWORD PTR [rip+0x209a] */
...
x86_l_f1:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_f6:
	/* 0xf6: mov    rdi,QWORD PTR [rip+0x20a8] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&substring_map)));
x86_l_fd:
	/* 0xfd: mov    rsi,r13 */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_R13, X86_WIDTH_64);
...
x86_l_178:
	/* 0x178: mov    r15,QWORD PTR [rip+0x20ba] */
...
x86_l_1b6:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RBX, X86_WIDTH_32, 16ULL);
x86_l_1bb:
	/* 0x1bb: mov    r15,QWORD PTR [rip+0x20bc] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_R15, (void *)(long)(((__u64)(long)&substring_map)));
x86_l_1c2:
