...
SEC("xdp")
int tetragon_bpf_generic_retkprobe_v61_generic_retkprobe_actions_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_25:
	/* 0x25: je     12f <generic_retkprobe_actions+0x12f> */
...
x86_l_39:
	/* 0x39: jl     12f <generic_retkprobe_actions+0x12f> */
...
x86_l_54:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_57:
	/* 0x57: je     12f <generic_retkprobe_actions+0x12f> */
...
x86_l_97:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_9a:
	/* 0x9a: je     aa <generic_retkprobe_actions+0xaa> */
...
x86_l_a6:
	/* 0xa6: jae    b2 <generic_retkprobe_actions+0xb2> */
	X86_SIM_X86_JCC(X86_CC_AE, 0xa6, 0xb2, x86_l_b2);
x86_l_a8:
	/* 0xa8: jmp    10d <generic_retkprobe_actions+0x10d> */
...
x86_l_ac:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 5ULL);
x86_l_b0:
	/* 0xb0: jb     10d <generic_retkprobe_actions+0x10d> */
...
x86_l_c6:
	/* 0xc6: call   0 <generic_retkprobe_actions> */
...
x86_l_d5:
	/* 0xd5: jae    10d <generic_retkprobe_actions+0x10d> */
...
x86_l_e4:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_R8, X86_R13, X86_WIDTH_32);
x86_l_e7:
	/* 0xe7: call   0 <generic_retkprobe_actions> */
...
x86_l_f3:
	...
	X86_SIM_L_EXEC_CMP_REG_MEM(X86_RCX, X86_R14, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32), 0ULL);
x86_l_f6:
	/* 0xf6: jae    10d <generic_retkprobe_actions+0x10d> */
...
x86_l_105:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_R8, X86_R13, X86_WIDTH_32);
x86_l_108:
	/* 0x108: call   0 <generic_retkprobe_actions> */
...
x86_l_112:
	/* 0x112: je     12f <generic_retkprobe_actions+0x12f> */
