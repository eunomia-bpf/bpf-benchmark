...
x86_l_25:
	/* 0x25: je     1bb <generic_rawtp_setup_event+0x1bb> */
...
x86_l_43:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_46:
	/* 0x46: je     1bb <generic_rawtp_setup_event+0x1bb> */
...
x86_l_15d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_160:
	/* 0x160: je     185 <generic_rawtp_setup_event+0x185> */
...
x86_l_17a:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_17d:
	/* 0x17d: je     185 <generic_rawtp_setup_event+0x185> */
...
x86_l_183:
	/* 0x183: jne    1a0 <generic_rawtp_setup_event+0x1a0> */
...
x86_l_1c1:
	/* 0x1c1: jmp    1c6 <generic_rawtp_setup_event+0x1c6> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_1c6:
