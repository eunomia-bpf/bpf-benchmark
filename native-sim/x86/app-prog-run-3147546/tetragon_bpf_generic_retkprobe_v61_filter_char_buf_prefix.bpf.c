...
SEC("xdp")
int tetragon_bpf_generic_retkprobe_v61_filter_char_buf_prefix_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_12:
	/* 0x12: mov    rdi,QWORD PTR [rip+0x1df5] */
...
x86_l_34:
	/* 0x34: mov    rdi,QWORD PTR [rip+0x1df4] */
