...
x86_l_2b:
	/* 0x2b: je     61d <generic_rawtp_event+0x61d> */
...
x86_l_53:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_56:
	/* 0x56: je     61d <generic_rawtp_event+0x61d> */
...
x86_l_81:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_84:
	/* 0x84: je     61d <generic_rawtp_event+0x61d> */
...
x86_l_cc:
	/* 0xcc: jmp    61d <generic_rawtp_event+0x61d> */
...
x86_l_149:
	/* 0x149: je     61d <generic_rawtp_event+0x61d> */
...
x86_l_172:
	/* 0x172: je     61d <generic_rawtp_event+0x61d> */
...
x86_l_1da:
	/* 0x1da: jmp    61d <generic_rawtp_event+0x61d> */
...
x86_l_1e6:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1e9:
	/* 0x1e9: je     61d <generic_rawtp_event+0x61d> */
...
x86_l_22e:
	/* 0x22e: je     62e <generic_rawtp_event+0x62e> */
...
x86_l_387:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_38a:
	/* 0x38a: je     420 <generic_rawtp_event+0x420> */
...
x86_l_41c:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_41e:
	/* 0x41e: jmp    428 <generic_rawtp_event+0x428> */
...
x86_l_629:
	/* 0x629: jmp    687 <generic_rawtp_event+0x687> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_62e:
...
x86_l_646:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_649:
	/* 0x649: je     61d <generic_rawtp_event+0x61d> */
...
x86_l_666:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_669:
	/* 0x669: je     61d <generic_rawtp_event+0x61d> */
...
x86_l_67d:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R12, X86_WIDTH_64);
x86_l_680:
	/* 0x680: jne    61d <generic_rawtp_event+0x61d> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x680, 0x61d, x86_l_61d);
x86_l_682:
	/* 0x682: jmp    234 <generic_rawtp_event+0x234> */
