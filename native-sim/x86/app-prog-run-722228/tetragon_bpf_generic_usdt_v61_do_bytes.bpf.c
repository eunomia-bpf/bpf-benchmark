...
SEC("xdp")
int tetragon_bpf_generic_usdt_v61_do_bytes_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_4:
	/* 0x4: mov    rbx,rcx */
	X86_SIM_RUN_OP(X86_OP_MOV_REG, X86_RBX, X86_RCX, X86_WIDTH_64, 0, 0);
x86_l_7:
	/* 0x7: mov    r14,rdx */
	X86_SIM_RUN_OP(X86_OP_MOV_REG, X86_R14, X86_RDX, X86_WIDTH_64, 0, 0);
x86_l_a:
	/* 0xa: mov    r15,rsi */
...
x86_l_1d:
	/* 0x1d: mov    r13d,eax */
	X86_SIM_RUN_OP(X86_OP_MOV_REG, X86_R13, X86_RAX, X86_WIDTH_32, 0, 0);
x86_l_20:
	/* 0x20: and    r13d,0x7fffffff */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_R13, X86_REG_NONE, X86_WIDTH_32, X86_ALU_AND, 2147483647ULL);
x86_l_27:
	/* 0x27: mov    rcx,rbx */
	X86_SIM_RUN_OP(X86_OP_MOV_REG, X86_RCX, X86_RBX, X86_WIDTH_64, 0, 0);
x86_l_2a:
	/* 0x2a: sub    rcx,r13 */
	X86_SIM_RUN_OP(X86_OP_ALU_REG, X86_RCX, X86_R13, X86_WIDTH_64, X86_ALU_SUB, 0);
x86_l_2d:
	/* 0x2d: je     247 <do_bytes+0x247> */
	X86_SIM_X86_JCC(X86_CC_E, 0x2d, 0x247, x86_l_247);
x86_l_33:
	/* 0x33: lea    rdx,[r14+r13*1] */
	X86_SIM_RUN_OP(X86_OP_LEA, X86_RDX, X86_R14, X86_WIDTH_64, X86_MEM_AUX(X86_R13, 0), 0ULL);
x86_l_37:
	/* 0x37: mov    rdi,r12 */
...
x86_l_4a:
	...
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, X86_ALU_AND, 2147483647ULL);
x86_l_4f:
	/* 0x4f: mov    rbp,rax */
	X86_SIM_RUN_OP(X86_OP_MOV_REG, X86_RBP, X86_RAX, X86_WIDTH_64, 0, 0);
x86_l_52:
	/* 0x52: add    rbp,r13 */
	X86_SIM_RUN_OP(X86_OP_ALU_REG, X86_RBP, X86_R13, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_55:
	/* 0x55: mov    rcx,rbx */
	X86_SIM_RUN_OP(X86_OP_MOV_REG, X86_RCX, X86_RBX, X86_WIDTH_64, 0, 0);
x86_l_58:
	/* 0x58: sub    rcx,rbp */
	X86_SIM_RUN_OP(X86_OP_ALU_REG, X86_RCX, X86_RBP, X86_WIDTH_64, X86_ALU_SUB, 0);
x86_l_5b:
	/* 0x5b: je     247 <do_bytes+0x247> */
	X86_SIM_X86_JCC(X86_CC_E, 0x5b, 0x247, x86_l_247);
x86_l_61:
	/* 0x61: lea    rdx,[r14+rbp*1] */
	X86_SIM_RUN_OP(X86_OP_LEA, X86_RDX, X86_R14, X86_WIDTH_64, X86_MEM_AUX(X86_RBP, 0), 0ULL);
x86_l_65:
	/* 0x65: mov    rdi,r12 */
	X86_SIM_RUN_OP(X86_OP_MOV_REG, X86_RDI, X86_R12, X86_WIDTH_64, 0, 0);
x86_l_68:
...
x86_l_80:
	/* 0x80: add    r13,rbp */
	X86_SIM_RUN_OP(X86_OP_ALU_REG, X86_R13, X86_RBP, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_83:
	/* 0x83: mov    rcx,rbx */
	X86_SIM_RUN_OP(X86_OP_MOV_REG, X86_RCX, X86_RBX, X86_WIDTH_64, 0, 0);
x86_l_86:
...
x86_l_19b:
	/* 0x19b: add    r14,r13 */
	X86_SIM_RUN_OP(X86_OP_ALU_REG, X86_R14, X86_R13, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_19e:
	/* 0x19e: mov    rdi,r12 */
	X86_SIM_RUN_OP(X86_OP_MOV_REG, X86_RDI, X86_R12, X86_WIDTH_64, 0, 0);
x86_l_1a1:
...
x86_l_1c0:
	...
	X86_SIM_RUN_OP(X86_OP_MOVSX_REG, X86_RBX, X86_RAX, X86_WIDTH_64, X86_WIDTH_32, 0);
x86_l_1c3:
...
x86_l_1d0:
	...
	X86_SIM_RUN_OP(X86_OP_MOV_LOAD_MAP_PTR, X86_RDI, X86_REG_NONE, X86_WIDTH_64, 0, ((__u64)(long)&tg_stats_map));
x86_l_1d7:
...
x86_l_1e3:
	...
	X86_SIM_RUN_OP(X86_OP_CMP_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_64, 0, 18446744073709551604ULL);
x86_l_1e7:
	/* 0x1e7: jg     203 <do_bytes+0x203> */
	X86_SIM_X86_JCC(X86_CC_G, 0x1e7, 0x203, x86_l_203);
x86_l_1e9:
	/* 0x1e9: cmp    rbx,0xffffffffffffffe4 */
	X86_SIM_RUN_OP(X86_OP_CMP_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_64, 0, 18446744073709551588ULL);
x86_l_1ed:
	/* 0x1ed: je     21d <do_bytes+0x21d> */
	X86_SIM_X86_JCC(X86_CC_E, 0x1ed, 0x21d, x86_l_21d);
x86_l_1ef:
	/* 0x1ef: cmp    rbx,0xffffffffffffffea */
	X86_SIM_RUN_OP(X86_OP_CMP_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_64, 0, 18446744073709551594ULL);
x86_l_1f3:
	/* 0x1f3: je     235 <do_bytes+0x235> */
	X86_SIM_X86_JCC(X86_CC_E, 0x1f3, 0x235, x86_l_235);
x86_l_1f5:
	/* 0x1f5: cmp    rbx,0xfffffffffffffff0 */
	X86_SIM_RUN_OP(X86_OP_CMP_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_64, 0, 18446744073709551600ULL);
x86_l_1f9:
	/* 0x1f9: jne    22d <do_bytes+0x22d> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x1f9, 0x22d, x86_l_22d);
x86_l_1fb:
	/* 0x1fb: add    rax,0x558 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 1368ULL);
x86_l_201:
	/* 0x201: jmp    243 <do_bytes+0x243> */
	X86_SIM_X86_JMP(0x201, 0x243, x86_l_243);
x86_l_203:
	/* 0x203: cmp    rbx,0xfffffffffffffff5 */
	X86_SIM_RUN_OP(X86_OP_CMP_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_64, 0, 18446744073709551605ULL);
x86_l_207:
	/* 0x207: je     225 <do_bytes+0x225> */
	X86_SIM_X86_JCC(X86_CC_E, 0x207, 0x225, x86_l_225);
x86_l_209:
	/* 0x209: cmp    rbx,0xfffffffffffffff9 */
	X86_SIM_RUN_OP(X86_OP_CMP_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_64, 0, 18446744073709551609ULL);
x86_l_20d:
	/* 0x20d: je     23d <do_bytes+0x23d> */
	X86_SIM_X86_JCC(X86_CC_E, 0x20d, 0x23d, x86_l_23d);
x86_l_20f:
	/* 0x20f: cmp    rbx,0xfffffffffffffffe */
	X86_SIM_RUN_OP(X86_OP_CMP_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_64, 0, 18446744073709551614ULL);
x86_l_213:
	/* 0x213: jne    22d <do_bytes+0x22d> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x213, 0x22d, x86_l_22d);
x86_l_215:
	/* 0x215: add    rax,0x548 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 1352ULL);
x86_l_21b:
	/* 0x21b: jmp    243 <do_bytes+0x243> */
	X86_SIM_X86_JMP(0x21b, 0x243, x86_l_243);
x86_l_21d:
	/* 0x21d: add    rax,0x568 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 1384ULL);
x86_l_223:
	/* 0x223: jmp    243 <do_bytes+0x243> */
	X86_SIM_X86_JMP(0x223, 0x243, x86_l_243);
x86_l_225:
	/* 0x225: add    rax,0x570 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 1392ULL);
x86_l_22b:
	/* 0x22b: jmp    243 <do_bytes+0x243> */
	X86_SIM_X86_JMP(0x22b, 0x243, x86_l_243);
x86_l_22d:
	/* 0x22d: add    rax,0x540 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 1344ULL);
x86_l_233:
	/* 0x233: jmp    243 <do_bytes+0x243> */
	X86_SIM_X86_JMP(0x233, 0x243, x86_l_243);
x86_l_235:
	/* 0x235: add    rax,0x560 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 1376ULL);
x86_l_23b:
	/* 0x23b: jmp    243 <do_bytes+0x243> */
	X86_SIM_X86_JMP(0x23b, 0x243, x86_l_243);
x86_l_23d:
	/* 0x23d: add    rax,0x550 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 1360ULL);
x86_l_243:
	/* 0x243: inc QWORD PTR [rax] */
	X86_SIM_RUN_OP(X86_OP_ALU_MEM_UNARY, X86_RAX, X86_REG_NONE, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_247:
	/* 0x247: mov    rax,rbx */
...
x86_l_25e:
	/* 0x25e: test   rcx,rcx */
	X86_SIM_RUN_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64, 0, 0);
x86_l_261:
	/* 0x261: js     2da <__do_bytes+0x84> */
	X86_SIM_X86_SUB_JCC(X86_CC_S, 0x261, 0x2da, x86_l_2da);
x86_l_263:
	/* 0x263: mov    r14,rsi */
	X86_SIM_RUN_OP(X86_OP_MOV_REG, X86_R14, X86_RSI, X86_WIDTH_64, 0, 0);
x86_l_266:
	/* 0x266: mov    r15,rdi */
	X86_SIM_RUN_OP(X86_OP_MOV_REG, X86_R15, X86_RDI, X86_WIDTH_64, 0, 0);
x86_l_269:
	/* 0x269: cmp    rcx,0x7fe0 */
	X86_SIM_RUN_OP(X86_OP_CMP_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_64, 0, 32736ULL);
x86_l_270:
	/* 0x270: mov    ebx,0x7fe0 */
	X86_SIM_RUN_OP(X86_OP_MOV_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_32, 0, 32736ULL);
x86_l_275:
	/* 0x275: cmovb  rbx,rcx */
	X86_SIM_RUN_OP(X86_OP_CMOV, X86_RBX, X86_RCX, X86_WIDTH_64, X86_CC_B, 0);
x86_l_279:
	/* 0x279: lea    rdi,[rsi+0x20] */
	X86_SIM_RUN_OP(X86_OP_LEA, X86_RDI, X86_RSI, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 32ULL);
x86_l_27d:
	/* 0x27d: mov    eax,0x4 */
	X86_SIM_RUN_OP(X86_OP_MOV_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 4ULL);
x86_l_282:
	/* 0x282: mov    esi,ebx */
	X86_SIM_RUN_OP(X86_OP_MOV_REG, X86_RSI, X86_RBX, X86_WIDTH_32, 0, 0);
x86_l_284:
	/* 0x284: call   rax */
	X86_SIM_RUN_OP(X86_OP_CALL_REG, X86_REG_NONE, X86_RAX, X86_WIDTH_64, 0, 0);
x86_l_286:
...
x86_l_28a:
	...
	X86_SIM_RUN_OP(X86_OP_LEA, X86_R12, X86_RBX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 32ULL);
x86_l_28e:
	/* 0x28e: mov    DWORD PTR [r14+0x4],r12d */
	X86_SIM_RUN_OP(X86_OP_MOV_STORE_REG, X86_R14, X86_R12, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 4ULL);
x86_l_292:
...
x86_l_29f:
	...
	X86_SIM_RUN_OP(X86_OP_MOV_LOAD_MAP_PTR, X86_RDI, X86_REG_NONE, X86_WIDTH_64, 0, ((__u64)(long)&tg_conf_map));
x86_l_2a6:
...
x86_l_2b2:
	...
	X86_SIM_RUN_OP(X86_OP_CMP_MEM_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_2b6:
...
x86_l_2bd:
	...
	X86_SIM_RUN_OP(X86_OP_MOV_LOAD_MAP_PTR, X86_RSI, X86_REG_NONE, X86_WIDTH_64, 0, ((__u64)(long)&tcpmon_map));
x86_l_2c4:
...
x86_l_2cf:
	/* 0x2cf: mov    r8,r12 */
	X86_SIM_RUN_OP(X86_OP_MOV_REG, X86_R8, X86_R12, X86_WIDTH_64, 0, 0);
x86_l_2d2:
	/* 0x2d2: call   rax */
	X86_SIM_RUN_OP(X86_OP_CALL_REG, X86_REG_NONE, X86_RAX, X86_WIDTH_64, 0, 0);
x86_l_2d4:
...
x86_l_2da:
	...
	X86_SIM_RUN_OP(X86_OP_MOV_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_64, 0, 18446744073709551615ULL);
x86_l_2e1:
	/* 0x2e1: jmp    300 <__do_bytes+0xaa> */
	X86_SIM_X86_SUB_JMP(0x2e1, 0x300, x86_l_300);
x86_l_2e3:
	/* 0x2e3: mov    eax,0x82 */
	X86_SIM_RUN_OP(X86_OP_MOV_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 130ULL);
x86_l_2e8:
	/* 0x2e8: mov    rdi,QWORD PTR [rip+0x560] */
	X86_SIM_RUN_OP(X86_OP_MOV_LOAD_MAP_PTR, X86_RDI, X86_REG_NONE, X86_WIDTH_64, 0, ((__u64)(long)&tg_rb_events));
x86_l_2ef:
	/* 0x2ef: mov    rsi,r14 */
