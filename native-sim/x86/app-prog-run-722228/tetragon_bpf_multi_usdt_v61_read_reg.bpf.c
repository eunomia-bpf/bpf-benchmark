...
SEC("xdp")
int tetragon_bpf_multi_usdt_v61_read_reg_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_8:
	/* 0x8: cmp    ecx,0x7 */
	X86_SIM_RUN_OP(X86_OP_CMP_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 7ULL);
x86_l_b:
	/* 0xb: jle    42 <read_reg+0x42> */
	X86_SIM_X86_JCC(X86_CC_LE, 0xb, 0x42, x86_l_42);
x86_l_d:
	/* 0xd: cmp    ecx,0xb */
	X86_SIM_RUN_OP(X86_OP_CMP_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 11ULL);
x86_l_10:
...
x86_l_1b:
	/* 0x1b: cmp    ecx,0xe */
	X86_SIM_RUN_OP(X86_OP_CMP_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 14ULL);
x86_l_1e:
	/* 0x1e: je     ff <read_reg+0xff> */
	X86_SIM_X86_JCC(X86_CC_E, 0x1e, 0xff, x86_l_ff);
x86_l_24:
	/* 0x24: cmp    ecx,0x10 */
	X86_SIM_RUN_OP(X86_OP_CMP_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 16ULL);
x86_l_27:
	/* 0x27: je     e7 <read_reg+0xe7> */
	X86_SIM_X86_JCC(X86_CC_E, 0x27, 0xe7, x86_l_e7);
x86_l_2d:
	/* 0x2d: cmp    ecx,0x13 */
	X86_SIM_RUN_OP(X86_OP_CMP_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 19ULL);
x86_l_30:
	/* 0x30: jne    115 <read_reg+0x115> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x30, 0x115, x86_l_115);
x86_l_36:
	/* 0x36: add    rdi,0x98 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 152ULL);
x86_l_3d:
...
x86_l_6b:
	/* 0x6b: cmp    ecx,0x8 */
	X86_SIM_RUN_OP(X86_OP_CMP_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 8ULL);
x86_l_6e:
...
x86_l_79:
	/* 0x79: add    rdi,0x48 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 72ULL);
x86_l_7d:
...
x86_l_95:
	/* 0x95: add    rdi,0x28 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 40ULL);
x86_l_99:
...
x86_l_a5:
	/* 0xa5: add    rdi,0x58 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 88ULL);
x86_l_a9:
...
x86_l_bb:
	/* 0xbb: cmp    ecx,0x6 */
	X86_SIM_RUN_OP(X86_OP_CMP_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 6ULL);
x86_l_be:
...
x86_l_c5:
	/* 0xc5: add    rdi,0x38 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 56ULL);
x86_l_c9:
	/* 0xc9: jmp    109 <read_reg+0x109> */
	X86_SIM_X86_JMP(0xc9, 0x109, x86_l_109);
x86_l_cb:
	/* 0xcb: cmp    ecx,0xc */
	X86_SIM_RUN_OP(X86_OP_CMP_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 12ULL);
x86_l_ce:
...
x86_l_d5:
	/* 0xd5: add    rdi,0x68 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 104ULL);
x86_l_d9:
	/* 0xd9: jmp    109 <read_reg+0x109> */
	X86_SIM_X86_JMP(0xd9, 0x109, x86_l_109);
x86_l_db:
	/* 0xdb: add    rdi,0x40 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 64ULL);
x86_l_df:
	/* 0xdf: jmp    109 <read_reg+0x109> */
	X86_SIM_X86_JMP(0xdf, 0x109, x86_l_109);
x86_l_e1:
	/* 0xe1: add    rdi,0x50 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 80ULL);
x86_l_e5:
	/* 0xe5: jmp    109 <read_reg+0x109> */
	X86_SIM_X86_JMP(0xe5, 0x109, x86_l_109);
x86_l_e7:
	/* 0xe7: sub    rdi,0xffffffffffffff80 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_64, X86_ALU_SUB, 18446744073709551488ULL);
x86_l_eb:
...
x86_l_f9:
	/* 0xf9: add    rdi,0x30 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 48ULL);
x86_l_fd:
	/* 0xfd: jmp    109 <read_reg+0x109> */
	X86_SIM_X86_JMP(0xfd, 0x109, x86_l_109);
x86_l_ff:
	/* 0xff: add    rdi,0x70 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 112ULL);
x86_l_103:
	/* 0x103: jmp    109 <read_reg+0x109> */
	X86_SIM_X86_JMP(0x103, 0x109, x86_l_109);
x86_l_105:
	/* 0x105: add    rdi,0x60 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 96ULL);
x86_l_109:
	/* 0x109: mov    eax,0x40 */
	X86_SIM_RUN_OP(X86_OP_MOV_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 64ULL);
x86_l_10e:
	/* 0x10e: sub    eax,edx */
	X86_SIM_RUN_OP(X86_OP_ALU_REG, X86_RAX, X86_RDX, X86_WIDTH_32, X86_ALU_SUB, 0);
x86_l_110:
