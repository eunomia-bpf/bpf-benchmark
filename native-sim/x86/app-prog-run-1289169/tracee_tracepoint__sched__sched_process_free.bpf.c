...
x86_l_1c:
	/* 0x1c: mov    r13d,DWORD PTR [rsp+0xc] */
...
x86_l_44:
	/* 0x44: jne    a9 <tracepoint__sched__sched_process_free+0xa9> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x44, 0xa9, x86_l_a9);
x86_l_46:
	/* 0x46: mov    eax,0x3 */
...
x86_l_57:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_59:
	/* 0x59: mov    DWORD PTR [rsp+0x14],0x0 */
...
x86_l_77:
	/* 0x77: je     a9 <tracepoint__sched__sched_process_free+0xa9> */
	X86_SIM_X86_JCC(X86_CC_E, 0x77, 0xa9, x86_l_a9);
x86_l_79:
	/* 0x79: movzx  eax,WORD PTR [rax+0xe] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RAX, X86_RAX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_16), 14ULL);
x86_l_7d:
	/* 0x7d: mov    WORD PTR [rsp+0x12],ax */
...
x86_l_95:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_98:
	/* 0x98: je     a9 <tracepoint__sched__sched_process_free+0xa9> */
	X86_SIM_X86_JCC(X86_CC_E, 0x98, 0xa9, x86_l_a9);
x86_l_9a:
	/* 0x9a: mov    ecx,0x3 */
...
x86_l_af:
	/* 0xaf: jmp    b4 <tracepoint__sched__sched_process_free+0xb4> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_b4:
