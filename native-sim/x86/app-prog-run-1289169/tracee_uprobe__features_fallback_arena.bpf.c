...
x86_l_43:
	/* 0x43: jne    b5 <uprobe__features_fallback_arena+0xb5> */
...
x86_l_8c:
	/* 0x8c: jne    94 <uprobe__features_fallback_arena+0x94> */
...
x86_l_92:
	/* 0x92: jmp    b5 <uprobe__features_fallback_arena+0xb5> */
...
x86_l_aa:
	/* 0xaa: je     b0 <uprobe__features_fallback_arena+0xb0> */
	X86_SIM_X86_JCC(X86_CC_E, 0xaa, 0xb0, x86_l_b0);
x86_l_ac:
	/* 0xac: mov    ebp,DWORD PTR [rax] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RBP, X86_RAX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_ae:
	/* 0xae: jmp    b5 <uprobe__features_fallback_arena+0xb5> */
...
x86_l_d0:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_d3:
	/* 0xd3: je     ba9 <uprobe__features_fallback_arena+0xba9> */
...
x86_l_ef:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_f2:
	/* 0xf2: je     ba9 <uprobe__features_fallback_arena+0xba9> */
...
x86_l_224:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_227:
	/* 0x227: je     267 <uprobe__features_fallback_arena+0x267> */
...
x86_l_247:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_24a:
	/* 0x24a: je     49d <uprobe__features_fallback_arena+0x49d> */
...
x86_l_255:
	/* 0x255: jne    a0f <uprobe__features_fallback_arena+0xa0f> */
...
x86_l_260:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_262:
	/* 0x262: jmp    a96 <uprobe__features_fallback_arena+0xa96> */
...
x86_l_28a:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_28d:
	/* 0x28d: je     ba9 <uprobe__features_fallback_arena+0xba9> */
...
x86_l_466:
	/* 0x466: mov    r12,QWORD PTR [rip+0x0] */
...
x86_l_48f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_492:
	/* 0x492: jne    229 <uprobe__features_fallback_arena+0x229> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x492, 0x229, x86_l_229);
x86_l_498:
	/* 0x498: jmp    ba9 <uprobe__features_fallback_arena+0xba9> */
...
x86_l_4ad:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_4b2:
	/* 0x4b2: mov    rdi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&scratch_map)));
x86_l_4b9:
...
x86_l_4c0:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_4c3:
	/* 0x4c3: je     ba9 <uprobe__features_fallback_arena+0xba9> */
...
x86_l_5af:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_R8, X86_WIDTH_32, 2ULL);
x86_l_5b5:
	/* 0x5b5: mov    r12,QWORD PTR [rip+0x0] */
...
x86_l_5de:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5e1:
	/* 0x5e1: je     ba9 <uprobe__features_fallback_arena+0xba9> */
...
x86_l_833:
	/* 0x833: jne    88e <uprobe__features_fallback_arena+0x88e> */
...
x86_l_97b:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_TEST_MEM_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 68719476738ULL);
x86_l_980:
	/* 0x980: je     988 <uprobe__features_fallback_arena+0x988> */
...
x86_l_a04:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_TEST_MEM_IMM, X86_R15, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 17179869216ULL);
x86_l_a09:
	/* 0xa09: je     25b <uprobe__features_fallback_arena+0x25b> */
...
x86_l_a76:
	/* 0xa76: je     a94 <uprobe__features_fallback_arena+0xa94> */
...
x86_l_a8d:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RAX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 16ULL);
x86_l_a92:
	/* 0xa92: jmp    a96 <uprobe__features_fallback_arena+0xa96> */
...
x86_l_ab6:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_ab9:
	/* 0xab9: je     ad3 <uprobe__features_fallback_arena+0xad3> */
...
x86_l_acc:
	/* 0xacc: jne    ad3 <uprobe__features_fallback_arena+0xad3> */
...
x86_l_add:
	/* 0xadd: jne    bba <uprobe__features_fallback_arena+0xbba> */
...
x86_l_b0e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_b11:
	/* 0xb11: je     b7e <uprobe__features_fallback_arena+0xb7e> */
...
x86_l_b22:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_b25:
	/* 0xb25: je     b7e <uprobe__features_fallback_arena+0xb7e> */
...
x86_l_b98:
	/* 0xb98: mov    rsi,QWORD PTR [rip+0x0] */
...
x86_l_bb5:
	/* 0xbb5: jmp    beb <uprobe__features_fallback_arena+0xbeb> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_bba:
	/* 0xbba: mov    rdi,r14 */
...
x86_l_bd7:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_bda:
	/* 0xbda: jne    ba9 <uprobe__features_fallback_arena+0xba9> */
...
x86_l_be6:
	/* 0xbe6: jmp    ae3 <uprobe__features_fallback_arena+0xae3> */
