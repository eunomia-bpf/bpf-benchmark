...
x86_l_22:
	/* 0x22: je     2f <vfs_write_magic_enter+0x2f> */
...
x86_l_2a:
	/* 0x2a: jmp    df <vfs_write_magic_enter+0xdf> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_2f:
...
x86_l_6a:
	/* 0x6a: jne    24 <vfs_write_magic_enter+0x24> */
...
x86_l_d6:
	...
	X86_SIM_L_EXEC_ALU_IMM(X86_RSP, X86_WIDTH_64, X86_ALU_ADD, 64ULL);
x86_l_da:
	/* 0xda: jmp    df <vfs_write_magic_enter+0xdf> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_df:
