...
SEC("xdp")
int tetragon_bpf_generic_retuprobe_generic_retuprobe_output_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_14:
	/* 0x14: mov    rdi,QWORD PTR [rip+0x1651] */
...
x86_l_4f:
	/* 0x4f: mov    rsi,QWORD PTR [rip+0x1651] */
...
x86_l_71:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_76:
	/* 0x76: mov    rdi,QWORD PTR [rip+0x1651] */
...
x86_l_9b:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_a0:
	/* 0xa0: mov    rdi,QWORD PTR [rip+0x1651] */
