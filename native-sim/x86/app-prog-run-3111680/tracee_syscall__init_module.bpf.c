...
x86_l_9:
	/* 0x9: mov    DWORD PTR [rsp+0x18],0x0 */
...
x86_l_27:
	/* 0x27: je     1f4 <syscall__init_module+0x1f4> */
	X86_SIM_X86_JCC(X86_CC_E, 0x27, 0x1f4, x86_l_1f4);
x86_l_2d:
	/* 0x2d: mov    r14,rax */
...
x86_l_43:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_46:
	/* 0x46: je     1f4 <syscall__init_module+0x1f4> */
	X86_SIM_X86_JCC(X86_CC_E, 0x46, 0x1f4, x86_l_1f4);
x86_l_4c:
	/* 0x4c: mov    r15,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_R15, X86_RAX, X86_WIDTH_64);
x86_l_4f:
	/* 0x4f: lea    rsi,[r14+0x28] */
...
x86_l_61:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_64:
	/* 0x64: je     1f4 <syscall__init_module+0x1f4> */
	X86_SIM_X86_JCC(X86_CC_E, 0x64, 0x1f4, x86_l_1f4);
x86_l_6a:
	/* 0x6a: mov    r12,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_R12, X86_RAX, X86_WIDTH_64);
x86_l_6d:
	/* 0x6d: lea    r13,[r14+0x24] */
...
x86_l_82:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_85:
	/* 0x85: je     1f4 <syscall__init_module+0x1f4> */
	X86_SIM_X86_JCC(X86_CC_E, 0x85, 0x1f4, x86_l_1f4);
x86_l_8b:
	/* 0x8b: cmp    BYTE PTR [r12+0xb0],0x0 */
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_R12, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 755914244096ULL);
x86_l_94:
	/* 0x94: je     1f8 <syscall__init_module+0x1f8> */
	X86_SIM_X86_JCC(X86_CC_E, 0x94, 0x1f8, x86_l_1f8);
x86_l_9a:
	/* 0x9a: mov    QWORD PTR [rsp+0x50],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 343597383680ULL);
x86_l_a3:
	/* 0xa3: mov    QWORD PTR [rsp+0x48],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 309237645312ULL);
x86_l_ac:
	/* 0xac: mov    QWORD PTR [rsp+0x40],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 274877906944ULL);
x86_l_b5:
	/* 0xb5: mov    QWORD PTR [rsp+0x38],0x0 */
...
x86_l_1ba:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 113ULL);
x86_l_1bf:
	/* 0x1bf: movzx  ecx,WORD PTR [r14+0x7d8a] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RCX, X86_R14, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_16), 32138ULL);
x86_l_1c7:
	/* 0x1c7: lea    rdi,[r14+rcx*1] */
...
x86_l_1d7:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_1d9:
	/* 0x1d9: mov    rsi,QWORD PTR [rip+0x0] */
...
x86_l_1f6:
	/* 0x1f6: jmp    1fd <syscall__init_module+0x1fd> */
	X86_SIM_X86_JMP(0x1f6, 0x1fd, x86_l_1fd);
x86_l_1f8:
	/* 0x1f8: mov    eax,0xffffffff */
...
x86_l_203:
	/* 0x203: jmp    208 <syscall__init_module+0x208> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_208:
