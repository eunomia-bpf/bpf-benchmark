...
x86_l_27:
	/* 0x27: je     34 <vfs_writev_magic_enter+0x34> */
...
x86_l_2f:
	/* 0x2f: jmp    f5 <vfs_writev_magic_enter+0xf5> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_34:
...
x86_l_7e:
	/* 0x7e: jne    29 <vfs_writev_magic_enter+0x29> */
...
x86_l_ec:
	...
	X86_SIM_L_EXEC_ALU_IMM(X86_RSP, X86_WIDTH_64, X86_ALU_ADD, 64ULL);
x86_l_f0:
	/* 0xf0: jmp    f5 <vfs_writev_magic_enter+0xf5> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_f5:
