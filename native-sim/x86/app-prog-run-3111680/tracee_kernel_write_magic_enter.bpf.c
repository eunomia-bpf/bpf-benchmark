...
x86_l_2f:
	/* 0x2f: jmp    f5 <kernel_write_magic_enter+0xf5> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_34:
	/* 0x34: mov    rdx,QWORD PTR [rbx+0x70] */
...
x86_l_50:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_52:
	/* 0x52: mov    rcx,QWORD PTR [rsp+0x10] */
...
x86_l_5f:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 113ULL);
x86_l_64:
	/* 0x64: mov    rdx,QWORD PTR [rsp+0x10] */
...
x86_l_ec:
	...
	X86_SIM_L_EXEC_ALU_IMM(X86_RSP, X86_WIDTH_64, X86_ALU_ADD, 64ULL);
x86_l_f0:
	/* 0xf0: jmp    f5 <kernel_write_magic_enter+0xf5> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_f5:
