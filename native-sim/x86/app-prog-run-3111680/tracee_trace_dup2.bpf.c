...
SEC("xdp")
int tracee_trace_dup2_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_38:
	/* 0x38: je     158 <trace_dup2+0x158> */
	X86_SIM_X86_JCC(X86_CC_E, 0x38, 0x158, x86_l_158);
x86_l_3e:
	/* 0x3e: mov    DWORD PTR [r15+0x68],0x21 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_R15, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 446676598817ULL);
x86_l_46:
	/* 0x46: mov    eax,0x7d */
...
x86_l_e1:
	/* 0xe1: jmp    122 <trace_dup2+0x122> */
	X86_SIM_X86_JMP(0xe1, 0x122, x86_l_122);
x86_l_e3:
	/* 0xe3: test   r12,r12 */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_R12, X86_R12, X86_WIDTH_64);
x86_l_e6:
	/* 0xe6: je     156 <trace_dup2+0x156> */
...
x86_l_151:
	/* 0x151: jmp    6f3 <trace_dup2+0x6f3> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_156:
	/* 0x156: jmp    126 <trace_dup2+0x126> */
...
x86_l_509:
	/* 0x509: jne    567 <trace_dup2+0x567> */
