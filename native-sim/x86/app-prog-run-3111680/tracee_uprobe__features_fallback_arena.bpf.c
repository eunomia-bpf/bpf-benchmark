...
x86_l_48:
	/* 0x48: jne    b0 <uprobe__features_fallback_arena+0xb0> */
...
x86_l_5e:
	/* 0x5e: je     65 <uprobe__features_fallback_arena+0x65> */
	X86_SIM_X86_JCC(X86_CC_E, 0x5e, 0x65, x86_l_65);
x86_l_60:
	/* 0x60: mov    eax,DWORD PTR [rax+0x78] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RAX, X86_RAX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 120ULL);
x86_l_63:
	/* 0x63: jmp    65 <uprobe__features_fallback_arena+0x65> */
...
x86_l_87:
	/* 0x87: jne    8f <uprobe__features_fallback_arena+0x8f> */
...
x86_l_8d:
	/* 0x8d: jmp    b0 <uprobe__features_fallback_arena+0xb0> */
...
x86_l_a2:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_a5:
	/* 0xa5: je     ab <uprobe__features_fallback_arena+0xab> */
	X86_SIM_X86_JCC(X86_CC_E, 0xa5, 0xab, x86_l_ab);
x86_l_a7:
	/* 0xa7: mov    ebp,DWORD PTR [rax] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RBP, X86_RAX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_a9:
	/* 0xa9: jmp    b0 <uprobe__features_fallback_arena+0xb0> */
...
x86_l_cb:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_ce:
	/* 0xce: je     c7c <uprobe__features_fallback_arena+0xc7c> */
...
x86_l_ea:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_ed:
	/* 0xed: je     c7c <uprobe__features_fallback_arena+0xc7c> */
...
x86_l_21f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_222:
	/* 0x222: je     262 <uprobe__features_fallback_arena+0x262> */
...
x86_l_242:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_245:
	/* 0x245: je     496 <uprobe__features_fallback_arena+0x496> */
...
x86_l_250:
	/* 0x250: jne    aba <uprobe__features_fallback_arena+0xaba> */
...
x86_l_25b:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_25d:
	/* 0x25d: jmp    b64 <uprobe__features_fallback_arena+0xb64> */
...
x86_l_285:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_288:
	/* 0x288: je     c7c <uprobe__features_fallback_arena+0xc7c> */
...
x86_l_45e:
	/* 0x45e: mov    r12,QWORD PTR [rip+0x0] */
...
x86_l_488:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_48b:
	/* 0x48b: jne    224 <uprobe__features_fallback_arena+0x224> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x48b, 0x224, x86_l_224);
x86_l_491:
	/* 0x491: jmp    c7c <uprobe__features_fallback_arena+0xc7c> */
...
x86_l_4bf:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_4c2:
	/* 0x4c2: je     c7c <uprobe__features_fallback_arena+0xc7c> */
...
x86_l_5aa:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_5b1:
	/* 0x5b1: mov    r12,QWORD PTR [rip+0x0] */
...
x86_l_5db:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5de:
	/* 0x5de: je     c7c <uprobe__features_fallback_arena+0xc7c> */
...
x86_l_890:
	/* 0x890: jne    8f8 <uprobe__features_fallback_arena+0x8f8> */
...
x86_l_a0d:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_TEST_MEM_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 68719476738ULL);
x86_l_a12:
	/* 0xa12: je     a1a <uprobe__features_fallback_arena+0xa1a> */
...
x86_l_aaf:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_TEST_MEM_IMM, X86_R15, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 17179869216ULL);
x86_l_ab4:
	/* 0xab4: je     256 <uprobe__features_fallback_arena+0x256> */
...
x86_l_b3f:
	/* 0xb3f: je     b62 <uprobe__features_fallback_arena+0xb62> */
...
x86_l_b5b:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RAX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 16ULL);
x86_l_b60:
	/* 0xb60: jmp    b64 <uprobe__features_fallback_arena+0xb64> */
...
x86_l_b84:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_b87:
	/* 0xb87: je     ba1 <uprobe__features_fallback_arena+0xba1> */
...
x86_l_b9a:
	/* 0xb9a: jne    ba1 <uprobe__features_fallback_arena+0xba1> */
...
x86_l_bab:
	/* 0xbab: jne    c8d <uprobe__features_fallback_arena+0xc8d> */
...
x86_l_bdc:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_bdf:
	/* 0xbdf: je     c4c <uprobe__features_fallback_arena+0xc4c> */
...
x86_l_bf0:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_bf3:
	/* 0xbf3: je     c4c <uprobe__features_fallback_arena+0xc4c> */
...
x86_l_c5f:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_c61:
	/* 0xc61: mov    rsi,QWORD PTR [rip+0x0] */
...
x86_l_c88:
	/* 0xc88: jmp    cc3 <uprobe__features_fallback_arena+0xcc3> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_c8d:
	/* 0xc8d: mov    rdi,r14 */
...
x86_l_caf:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_cb2:
	/* 0xcb2: jne    c7c <uprobe__features_fallback_arena+0xc7c> */
...
x86_l_cbe:
	/* 0xcbe: jmp    bb1 <uprobe__features_fallback_arena+0xbb1> */
