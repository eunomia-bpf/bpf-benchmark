...
SEC("xdp")
int tetragon_bpf_generic_kprobe_v61___do_bytes_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_42:
	/* 0x42: mov    rdi,QWORD PTR [rip+0x687] */
...
x86_l_60:
	/* 0x60: mov    rsi,QWORD PTR [rip+0x687] */
...
x86_l_8b:
	/* 0x8b: mov    rdi,QWORD PTR [rip+0x687] */
