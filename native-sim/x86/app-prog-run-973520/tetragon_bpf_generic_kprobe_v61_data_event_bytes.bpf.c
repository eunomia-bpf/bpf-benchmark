...
x86_l_1d:
	/* 0x1d: mov    rdi,QWORD PTR [rip+0x347] */
...
x86_l_29b:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_2a0:
	/* 0x2a0: mov    rdi,QWORD PTR [rip+0x420] */
...
x86_l_36d:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_372:
	/* 0x372: mov    rdi,QWORD PTR [rip+0x680] */
...
x86_l_390:
	/* 0x390: mov    rsi,QWORD PTR [rip+0x680] */
...
x86_l_3bb:
	/* 0x3bb: mov    rdi,QWORD PTR [rip+0x680] */
