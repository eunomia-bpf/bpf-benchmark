...
x86_l_16:
	/* 0x16: mov    rdi,QWORD PTR [rip+0x5717] */
...
x86_l_27:
	/* 0x27: je     3c6 <generic_tracepoint_output+0x3c6> */
...
x86_l_38:
	/* 0x38: je     262 <generic_tracepoint_output+0x262> */
...
x86_l_5b:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_60:
	/* 0x60: mov    rdi,QWORD PTR [rip+0x5717] */
...
x86_l_6e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_71:
	/* 0x71: je     262 <generic_tracepoint_output+0x262> */
...
x86_l_11d:
	/* 0x11d: je     183 <generic_tracepoint_output+0x183> */
...
x86_l_17f:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_181:
	/* 0x181: jmp    18b <generic_tracepoint_output+0x18b> */
...
x86_l_26a:
	/* 0x26a: je     30f <generic_tracepoint_output+0x30f> */
...
x86_l_28d:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_292:
	/* 0x292: mov    rdi,QWORD PTR [rip+0x5717] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&execve_map)));
x86_l_299:
...
x86_l_2a0:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_2a3:
	/* 0x2a3: je     30f <generic_tracepoint_output+0x30f> */
...
x86_l_334:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_339:
	/* 0x339: mov    rdi,QWORD PTR [rip+0x5717] */
...
x86_l_347:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_34a:
	/* 0x34a: je     386 <generic_tracepoint_output+0x386> */
...
x86_l_350:
	/* 0x350: je     386 <generic_tracepoint_output+0x386> */
	X86_SIM_X86_JCC(X86_CC_E, 0x350, 0x386, x86_l_386);
x86_l_352:
	/* 0x352: mov    eax,0x19 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 25ULL);
x86_l_357:
	/* 0x357: mov    rsi,QWORD PTR [rip+0x5717] */
...
x86_l_36e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_371:
	/* 0x371: js     422 <generic_tracepoint_output+0x422> */
...
x86_l_39c:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_39f:
	/* 0x39f: js     3d3 <generic_tracepoint_output+0x3d3> */
...
x86_l_3a9:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_3ae:
	/* 0x3ae: mov    rdi,QWORD PTR [rip+0x5717] */
...
x86_l_3bc:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3bf:
	/* 0x3bf: je     3c6 <generic_tracepoint_output+0x3c6> */
...
x86_l_3ce:
	/* 0x3ce: jmp    4d5 <generic_tracepoint_output+0x4d5> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_3d3:
	/* 0x3d3: mov    rbx,rax */
...
x86_l_3de:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_3e3:
	/* 0x3e3: mov    rdi,QWORD PTR [rip+0x571a] */
...
x86_l_420:
	/* 0x420: jmp    3c6 <generic_tracepoint_output+0x3c6> */
...
x86_l_42d:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_432:
	/* 0x432: mov    rdi,QWORD PTR [rip+0x571a] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_stats_map)));
x86_l_439:
...
x86_l_49f:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_4a3:
	/* 0x4a3: jmp    3c6 <generic_tracepoint_output+0x3c6> */
...
x86_l_4ae:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_4b2:
	/* 0x4b2: jmp    3c6 <generic_tracepoint_output+0x3c6> */
...
x86_l_4bd:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_4c1:
	/* 0x4c1: jmp    3c6 <generic_tracepoint_output+0x3c6> */
...
x86_l_4cc:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_4d0:
	/* 0x4d0: jmp    3c6 <generic_tracepoint_output+0x3c6> */
