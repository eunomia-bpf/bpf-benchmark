...
x86_l_16:
	/* 0x16: mov    rdi,QWORD PTR [rip+0x1f917] */
...
x86_l_27:
	/* 0x27: je     3ff <generic_usdt_output+0x3ff> */
...
x86_l_5b:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_60:
	/* 0x60: mov    rdi,QWORD PTR [rip+0x1f917] */
...
x86_l_28d:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_292:
	/* 0x292: mov    rdi,QWORD PTR [rip+0x1f917] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&execve_map)));
x86_l_299:
...
x86_l_331:
	/* 0x331: mov    rsi,QWORD PTR [rip+0x1f917] */
...
x86_l_345:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_348:
	/* 0x348: js     378 <generic_usdt_output+0x378> */
...
x86_l_352:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_357:
	/* 0x357: mov    rdi,QWORD PTR [rip+0x1f917] */
...
x86_l_365:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_368:
	/* 0x368: je     3ff <generic_usdt_output+0x3ff> */
...
x86_l_373:
	/* 0x373: jmp    3ff <generic_usdt_output+0x3ff> */
...
x86_l_383:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_388:
	/* 0x388: mov    rdi,QWORD PTR [rip+0x1f917] */
...
x86_l_407:
	/* 0x407: jmp    40c <generic_usdt_output+0x40c> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_40c:
