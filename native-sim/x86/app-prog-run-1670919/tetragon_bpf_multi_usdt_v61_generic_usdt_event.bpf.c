...
x86_l_29:
	/* 0x29: je     4f2 <generic_usdt_event+0x4f2> */
...
x86_l_58:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5b:
	/* 0x5b: je     4f2 <generic_usdt_event+0x4f2> */
...
x86_l_86:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_89:
	/* 0x89: je     4f2 <generic_usdt_event+0x4f2> */
...
x86_l_d0:
	/* 0xd0: jmp    4f2 <generic_usdt_event+0x4f2> */
...
x86_l_13b:
	/* 0x13b: je     4f2 <generic_usdt_event+0x4f2> */
...
x86_l_15f:
	/* 0x15f: je     4f2 <generic_usdt_event+0x4f2> */
...
x86_l_1bc:
	/* 0x1bc: jmp    4f2 <generic_usdt_event+0x4f2> */
...
x86_l_1c7:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1ca:
	/* 0x1ca: je     4f2 <generic_usdt_event+0x4f2> */
...
x86_l_20c:
	/* 0x20c: je     501 <generic_usdt_event+0x501> */
...
x86_l_315:
	/* 0x315: je     37b <generic_usdt_event+0x37b> */
...
x86_l_377:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_379:
	/* 0x379: jmp    383 <generic_usdt_event+0x383> */
...
x86_l_4fc:
	/* 0x4fc: jmp    558 <generic_usdt_event+0x558> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_501:
...
x86_l_519:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_51c:
	/* 0x51c: je     4f2 <generic_usdt_event+0x4f2> */
...
x86_l_539:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_53c:
	/* 0x53c: je     4f2 <generic_usdt_event+0x4f2> */
...
x86_l_54e:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R13, X86_WIDTH_64);
x86_l_551:
	/* 0x551: jne    4f2 <generic_usdt_event+0x4f2> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x551, 0x4f2, x86_l_4f2);
x86_l_553:
	/* 0x553: jmp    212 <generic_usdt_event+0x212> */
