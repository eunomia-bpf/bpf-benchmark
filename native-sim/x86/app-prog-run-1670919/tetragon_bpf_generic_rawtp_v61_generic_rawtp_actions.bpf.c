...
SEC("xdp")
int tetragon_bpf_generic_rawtp_v61_generic_rawtp_actions_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_14:
	/* 0x14: mov    rdi,QWORD PTR [rip+0x5944] */
...
x86_l_25:
	/* 0x25: je     126 <generic_rawtp_actions+0x126> */
...
x86_l_36:
	/* 0x36: jl     126 <generic_rawtp_actions+0x126> */
...
x86_l_47:
	/* 0x47: mov    rdi,QWORD PTR [rip+0x5944] */
...
x86_l_53:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_56:
	/* 0x56: je     126 <generic_rawtp_actions+0x126> */
...
x86_l_80:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_85:
	/* 0x85: mov    rdi,QWORD PTR [rip+0x5944] */
...
x86_l_93:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_96:
	/* 0x96: je     a6 <generic_rawtp_actions+0xa6> */
...
x86_l_a2:
	/* 0xa2: jae    ae <generic_rawtp_actions+0xae> */
	X86_SIM_X86_JCC(X86_CC_AE, 0xa2, 0xae, x86_l_ae);
x86_l_a4:
	/* 0xa4: jmp    109 <generic_rawtp_actions+0x109> */
...
x86_l_a8:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 5ULL);
x86_l_ac:
	/* 0xac: jb     109 <generic_rawtp_actions+0x109> */
...
x86_l_c2:
	/* 0xc2: call   0 <generic_rawtp_actions> */
...
x86_l_d1:
	/* 0xd1: jae    109 <generic_rawtp_actions+0x109> */
...
x86_l_e0:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_R8, X86_R13, X86_WIDTH_32);
x86_l_e3:
	/* 0xe3: call   0 <generic_rawtp_actions> */
...
x86_l_ef:
	...
	X86_SIM_L_EXEC_CMP_REG_MEM(X86_RCX, X86_R14, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32), 0ULL);
x86_l_f2:
	/* 0xf2: jae    109 <generic_rawtp_actions+0x109> */
...
x86_l_101:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_R8, X86_R13, X86_WIDTH_32);
x86_l_104:
	/* 0x104: call   0 <generic_rawtp_actions> */
...
x86_l_10e:
	/* 0x10e: je     126 <generic_rawtp_actions+0x126> */
	X86_SIM_X86_JCC(X86_CC_E, 0x10e, 0x126, x86_l_126);
x86_l_110:
	/* 0x110: mov    eax,0xc */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 12ULL);
x86_l_115:
	/* 0x115: mov    rsi,QWORD PTR [rip+0x5943] */
...
x86_l_15e:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_163:
	/* 0x163: mov    rdi,QWORD PTR [rip+0x26f0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_16a:
...
x86_l_262:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_267:
	/* 0x267: mov    rdi,QWORD PTR [rip+0x26f0] */
...
x86_l_2d2:
	/* 0x2d2: mov    rdi,QWORD PTR [rip+0x26f0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_2d9:
	/* 0x2d9: mov    rsi,rsp */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RSP, X86_WIDTH_64);
...
x86_l_347:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_34c:
	/* 0x34c: mov    rdi,QWORD PTR [rip+0x26f0] */
...
x86_l_41e:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 2ULL);
x86_l_423:
	/* 0x423: mov    rdi,QWORD PTR [rip+0x26f0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_42a:
	/* 0x42a: xor    r15d,r15d */
	X86_SIM_L_EXEC_ALU_REG(X86_R15, X86_R15, X86_WIDTH_32, X86_ALU_XOR);
...
x86_l_49c:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_4a1:
	/* 0x4a1: mov    rdi,QWORD PTR [rip+0x26f0] */
...
x86_l_4d1:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 2ULL);
x86_l_4d6:
	/* 0x4d6: mov    rdi,QWORD PTR [rip+0x26f0] */
...
x86_l_577:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_57c:
	/* 0x57c: mov    rdi,QWORD PTR [rip+0x26f0] */
...
x86_l_5a3:
	/* 0x5a3: mov    rdi,QWORD PTR [rip+0x26f0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_data)));
x86_l_5aa:
...
x86_l_5f0:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_5f5:
	/* 0x5f5: mov    rdi,QWORD PTR [rip+0x26f0] */
...
x86_l_619:
	/* 0x619: mov    rdi,QWORD PTR [rip+0x26f0] */
...
x86_l_686:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_68b:
	/* 0x68b: mov    rdi,QWORD PTR [rip+0x26f0] */
...
x86_l_6aa:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 2ULL);
x86_l_6af:
	/* 0x6af: mov    rdi,QWORD PTR [rip+0x26f0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_missed_notifications)));
x86_l_6b6:
...
x86_l_6ef:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_6f4:
	/* 0x6f4: mov    rdi,QWORD PTR [rip+0x26f0] */
...
x86_l_710:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 3ULL);
x86_l_715:
	/* 0x715: mov    rdi,QWORD PTR [rip+0x26f0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_71c:
	/* 0x71c: mov    rsi,rsp */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RSP, X86_WIDTH_64);
...
x86_l_721:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 3ULL);
x86_l_726:
	/* 0x726: mov    rdi,QWORD PTR [rip+0x26f0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&socktrack_map)));
x86_l_72d:
...
x86_l_793:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_798:
	/* 0x798: mov    rdi,QWORD PTR [rip+0x26f0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_79f:
...
x86_l_7b5:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RCX, X86_WIDTH_32, 1ULL);
x86_l_7ba:
	/* 0x7ba: mov    rdi,QWORD PTR [rip+0x26f0] */
...
x86_l_7fe:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_803:
	/* 0x803: mov    rdi,QWORD PTR [rip+0x26f0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_80a:
...
x86_l_81c:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RCX, X86_WIDTH_32, 1ULL);
x86_l_821:
	/* 0x821: mov    rdi,QWORD PTR [rip+0x26f0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&config_map)));
x86_l_828:
	/* 0x828: mov    rsi,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RAX, X86_WIDTH_64);
...
x86_l_8bd:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_8c2:
	/* 0x8c2: mov    rdi,QWORD PTR [rip+0x26f0] */
...
x86_l_8f5:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 2ULL);
x86_l_8fa:
	/* 0x8fa: mov    rdi,QWORD PTR [rip+0x26f0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&ratelimit_map)));
x86_l_901:
	/* 0x901: mov    rdx,rsp */
	X86_SIM_L_EXEC_MOV_REG(X86_RDX, X86_RSP, X86_WIDTH_64);
...
x86_l_927:
	/* 0x927: mov    rsi,QWORD PTR [rip+0x26f0] */
...
x86_l_94c:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 27ULL);
x86_l_951:
	/* 0x951: mov    rsi,QWORD PTR [rip+0x26f0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&stack_trace_map)));
x86_l_958:
	/* 0x958: mov    edx,0x100 */
...
x86_l_998:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 2ULL);
x86_l_99d:
	/* 0x99d: mov    rdi,QWORD PTR [rip+0x26f0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_errmetrics_map)));
x86_l_9a4:
	/* 0x9a4: mov    rsi,rsp */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RSP, X86_WIDTH_64);
...
x86_l_9b9:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_9be:
	/* 0x9be: mov    rdi,QWORD PTR [rip+0x26f0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_missed_notifications)));
x86_l_9c5:
