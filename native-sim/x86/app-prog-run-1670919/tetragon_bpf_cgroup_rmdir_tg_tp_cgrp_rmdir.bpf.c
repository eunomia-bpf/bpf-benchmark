...
x86_l_1e:
	/* 0x1e: je     392 <tg_tp_cgrp_rmdir+0x392> */
...
x86_l_50:
	/* 0x50: je     392 <tg_tp_cgrp_rmdir+0x392> */
...
x86_l_78:
	/* 0x78: je     392 <tg_tp_cgrp_rmdir+0x392> */
...
x86_l_91:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_94:
	/* 0x94: je     2b2 <tg_tp_cgrp_rmdir+0x2b2> */
...
x86_l_c3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_c6:
	/* 0xc6: je     392 <tg_tp_cgrp_rmdir+0x392> */
...
x86_l_cf:
	/* 0xcf: jne    392 <tg_tp_cgrp_rmdir+0x392> */
...
x86_l_f5:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_f8:
	/* 0xf8: je     392 <tg_tp_cgrp_rmdir+0x392> */
...
x86_l_24f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_252:
	/* 0x252: jns    392 <tg_tp_cgrp_rmdir+0x392> */
...
x86_l_32a:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_32d:
	/* 0x32d: je     392 <tg_tp_cgrp_rmdir+0x392> */
...
x86_l_334:
	/* 0x334: je     392 <tg_tp_cgrp_rmdir+0x392> */
...
x86_l_3e4:
	/* 0x3e4: jmp    392 <tg_tp_cgrp_rmdir+0x392> */
