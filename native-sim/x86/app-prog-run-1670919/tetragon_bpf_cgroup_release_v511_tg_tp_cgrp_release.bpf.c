...
x86_l_1e:
	/* 0x1e: je     3b6 <tg_tp_cgrp_release+0x3b6> */
...
x86_l_50:
	/* 0x50: je     3b6 <tg_tp_cgrp_release+0x3b6> */
...
x86_l_78:
	/* 0x78: je     3b6 <tg_tp_cgrp_release+0x3b6> */
...
x86_l_91:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_94:
	/* 0x94: je     2d6 <tg_tp_cgrp_release+0x2d6> */
...
x86_l_c3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_c6:
	/* 0xc6: je     3b6 <tg_tp_cgrp_release+0x3b6> */
...
x86_l_cf:
	/* 0xcf: jne    3b6 <tg_tp_cgrp_release+0x3b6> */
...
x86_l_f5:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_f8:
	/* 0xf8: je     3b6 <tg_tp_cgrp_release+0x3b6> */
...
x86_l_24b:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_24e:
	/* 0x24e: je     3c4 <tg_tp_cgrp_release+0x3c4> */
...
x86_l_258:
	/* 0x258: je     3c4 <tg_tp_cgrp_release+0x3c4> */
...
x86_l_27d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_280:
	/* 0x280: jns    3b6 <tg_tp_cgrp_release+0x3b6> */
...
x86_l_34e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_351:
	/* 0x351: je     3b6 <tg_tp_cgrp_release+0x3b6> */
...
x86_l_358:
	/* 0x358: je     3b6 <tg_tp_cgrp_release+0x3b6> */
...
x86_l_3bf:
	/* 0x3bf: jmp    47b <tg_tp_cgrp_release+0x47b> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_3c4:
	/* 0x3c4: mov    eax,0x82 */
...
x86_l_3dc:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3df:
	/* 0x3df: jns    3b6 <tg_tp_cgrp_release+0x3b6> */
...
x86_l_476:
	/* 0x476: jmp    3b6 <tg_tp_cgrp_release+0x3b6> */
