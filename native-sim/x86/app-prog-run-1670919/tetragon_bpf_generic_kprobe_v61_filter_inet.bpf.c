...
SEC("xdp")
int tetragon_bpf_generic_kprobe_v61_filter_inet_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_212:
	/* 0x212: mov    rdi,QWORD PTR [rip+0x1bf7] */
...
x86_l_277:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_27c:
	/* 0x27c: mov    rdi,QWORD PTR [rip+0x1bf7] */
...
x86_l_347:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_34c:
	/* 0x34c: mov    rdi,QWORD PTR [rip+0xf40] */
