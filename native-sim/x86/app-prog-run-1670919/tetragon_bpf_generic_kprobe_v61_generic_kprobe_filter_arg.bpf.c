...
x86_l_17:
	/* 0x17: mov    rdi,QWORD PTR [rip+0x5597] */
...
x86_l_28:
	/* 0x28: je     3d2 <generic_kprobe_filter_arg+0x3d2> */
...
x86_l_3f:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_44:
	/* 0x44: mov    rdi,QWORD PTR [rip+0x5597] */
...
x86_l_4d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_50:
	/* 0x50: je     3bc <generic_kprobe_filter_arg+0x3bc> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_3bc;
	}
x86_l_56:
...
x86_l_5e:
	/* 0x5e: je     3bc <generic_kprobe_filter_arg+0x3bc> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_3bc;
	}
x86_l_64:
...
x86_l_f7:
	/* 0xf7: je     3bc <generic_kprobe_filter_arg+0x3bc> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_3bc;
	}
x86_l_fd:
...
x86_l_10f:
	/* 0x10f: je     3e0 <generic_kprobe_filter_arg+0x3e0> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_3e0;
	}
x86_l_115:
...
x86_l_118:
	/* 0x118: je     3ed <generic_kprobe_filter_arg+0x3ed> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_3ed;
	}
x86_l_11e:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R12, X86_WIDTH_32, 1ULL);
x86_l_122:
	/* 0x122: je     3fd <generic_kprobe_filter_arg+0x3fd> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_3fd;
	}
x86_l_128:
...
x86_l_12e:
	/* 0x12e: je     40d <generic_kprobe_filter_arg+0x40d> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_40d;
	}
x86_l_134:
...
x86_l_138:
	/* 0x138: je     41d <generic_kprobe_filter_arg+0x41d> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_41d;
	}
x86_l_13e:
...
x86_l_142:
	/* 0x142: je     42d <generic_kprobe_filter_arg+0x42d> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_42d;
	}
x86_l_148:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R12, X86_WIDTH_32, 4ULL);
x86_l_14c:
	/* 0x14c: jg     45a <generic_kprobe_filter_arg+0x45a> */
	if (X86_SIM_L_EVAL_CC(X86_CC_G)) {
		goto x86_l_45a;
	}
x86_l_152:
...
x86_l_155:
	/* 0x155: jmp    43d <generic_kprobe_filter_arg+0x43d> */
	goto x86_l_43d;
x86_l_15a:
...
x86_l_3ab:
	/* 0x3ab: mov    rsi,QWORD PTR [rip+0x55b0] */
...
x86_l_3bc:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 12ULL);
x86_l_3c1:
	/* 0x3c1: mov    rsi,QWORD PTR [rip+0x55b0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&kprobe_calls)));
x86_l_3c8:
	/* 0x3c8: mov    rdi,rbx */
	X86_SIM_L_EXEC_MOV_REG(X86_RDI, X86_RBX, X86_WIDTH_64);
...
x86_l_3eb:
	/* 0x3eb: jne    43d <generic_kprobe_filter_arg+0x43d> */
	if (X86_SIM_L_EVAL_CC(X86_CC_NE)) {
		goto x86_l_43d;
	}
x86_l_3ed:
...
x86_l_3fb:
	/* 0x3fb: jne    43d <generic_kprobe_filter_arg+0x43d> */
	if (X86_SIM_L_EVAL_CC(X86_CC_NE)) {
		goto x86_l_43d;
	}
x86_l_3fd:
...
x86_l_40b:
	/* 0x40b: jne    43d <generic_kprobe_filter_arg+0x43d> */
	if (X86_SIM_L_EVAL_CC(X86_CC_NE)) {
		goto x86_l_43d;
	}
x86_l_40d:
...
x86_l_41b:
	/* 0x41b: jne    43d <generic_kprobe_filter_arg+0x43d> */
	if (X86_SIM_L_EVAL_CC(X86_CC_NE)) {
		goto x86_l_43d;
	}
x86_l_41d:
...
x86_l_42b:
	/* 0x42b: jne    43d <generic_kprobe_filter_arg+0x43d> */
	if (X86_SIM_L_EVAL_CC(X86_CC_NE)) {
		goto x86_l_43d;
	}
x86_l_42d:
...
x86_l_43b:
	/* 0x43b: je     45a <generic_kprobe_filter_arg+0x45a> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_45a;
	}
x86_l_43d:
...
x86_l_444:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 12ULL);
x86_l_449:
	/* 0x449: mov    rsi,QWORD PTR [rip+0x55b3] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&kprobe_calls)));
x86_l_450:
	/* 0x450: mov    rdi,rbx */
	X86_SIM_L_EXEC_MOV_REG(X86_RDI, X86_RBX, X86_WIDTH_64);
...
x86_l_46f:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_474:
	/* 0x474: mov    rdi,QWORD PTR [rip+0x55b3] */
...
x86_l_482:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_485:
	/* 0x485: je     3d2 <generic_kprobe_filter_arg+0x3d2> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_3d2;
	}
x86_l_48b:
...
x86_l_490:
	/* 0x490: mov    rdi,QWORD PTR [rip+0x55b3] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&retprobe_map)));
x86_l_497:
...
x86_l_49c:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_49e:
	/* 0x49e: jmp    3d2 <generic_kprobe_filter_arg+0x3d2> */
	goto x86_l_3d2;
x86_l_4a3:
	/* 0x4a3: push   rbx */
...
x86_l_7c1:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_7c6:
	/* 0x7c6: mov    rdi,QWORD PTR [rip+0x1bf0] */
...
x86_l_82b:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_830:
	/* 0x830: mov    rdi,QWORD PTR [rip+0x1bf0] */
...
x86_l_f30:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_f35:
	/* 0xf35: mov    rdi,QWORD PTR [rip+0xac0] */
...
x86_l_fad:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_fb2:
	/* 0xfb2: mov    rdi,QWORD PTR [rip+0x23d0] */
...
x86_l_fd6:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_fdb:
	/* 0xfdb: mov    rdi,QWORD PTR [rip+0x23d0] */
...
x86_l_10f4:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_10f9:
	/* 0x10f9: mov    rdi,QWORD PTR [rip+0x2320] */
...
x86_l_1115:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_111a:
	/* 0x111a: mov    rdi,QWORD PTR [rip+0x2320] */
...
x86_l_129e:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_12a3:
	/* 0x12a3: mov    rdi,QWORD PTR [rip+0x1fe0] */
...
x86_l_12b7:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_12bc:
	/* 0x12bc: mov    rdi,QWORD PTR [rip+0x1fe0] */
...
x86_l_1390:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_1395:
	/* 0x1395: mov    rdi,QWORD PTR [rip+0x1fe0] */
...
x86_l_13c1:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_13c6:
	/* 0x13c6: mov    rdi,QWORD PTR [rip+0x1fe0] */
...
x86_l_13ec:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_13f1:
	/* 0x13f1: mov    rdi,QWORD PTR [rip+0x1fe0] */
...
x86_l_140c:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_1411:
	/* 0x1411: mov    rdi,QWORD PTR [rip+0x1fdd] */
...
x86_l_141a:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_141f:
	/* 0x141f: mov    rdi,QWORD PTR [rip+0x1fdd] */
...
x86_l_1428:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_142d:
	/* 0x142d: mov    rdi,QWORD PTR [rip+0x1fdd] */
...
x86_l_1436:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_143b:
	/* 0x143b: mov    rdi,QWORD PTR [rip+0x1fdd] */
...
x86_l_1444:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_1449:
	/* 0x1449: mov    rdi,QWORD PTR [rip+0x1fdd] */
...
x86_l_1452:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_1457:
	/* 0x1457: mov    rdi,QWORD PTR [rip+0x1fdd] */
...
x86_l_1460:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_1465:
	/* 0x1465: mov    rdi,QWORD PTR [rip+0x1fdd] */
...
x86_l_146e:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_1473:
	/* 0x1473: mov    rdi,QWORD PTR [rip+0x1fdd] */
...
x86_l_14e8:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_14ed:
	/* 0x14ed: mov    rdi,QWORD PTR [rip+0x25c3] */
...
x86_l_15aa:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_15af:
	/* 0x15af: mov    rdi,QWORD PTR [rip+0x25d1] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&substring_map)));
x86_l_15b6:
	/* 0x15b6: mov    rsi,r13 */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_R13, X86_WIDTH_64);
...
x86_l_1631:
	/* 0x1631: mov    r15,QWORD PTR [rip+0x25e3] */
...
x86_l_166f:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RBX, X86_WIDTH_32, 16ULL);
x86_l_1674:
	/* 0x1674: mov    r15,QWORD PTR [rip+0x25e5] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_R15, (void *)(long)(((__u64)(long)&substring_map)));
x86_l_167b:
...
x86_l_1aaf:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_1ab4:
	/* 0x1ab4: mov    rdi,QWORD PTR [rip+0x13b0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&argfilter_maps)));
x86_l_1abb:
...
x86_l_1eff:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_1f04:
	/* 0x1f04: mov    rdi,QWORD PTR [rip+0xf40] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&argfilter_maps)));
x86_l_1f0b:
...
x86_l_2356:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_235b:
	/* 0x235b: mov    rdi,QWORD PTR [rip+0x1820] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&argfilter_maps)));
x86_l_2362:
