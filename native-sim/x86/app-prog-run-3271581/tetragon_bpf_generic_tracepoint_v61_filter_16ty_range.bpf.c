...
SEC("xdp")
int tetragon_bpf_generic_tracepoint_v61_filter_16ty_range_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_9:
	/* 0x9: ja     f0 <filter_16ty_range+0xf0> */
...
x86_l_17:
	/* 0x17: jae    f0 <filter_16ty_range+0xf0> */
	X86_SIM_X86_JCC(X86_CC_AE, 0x17, 0xf0, x86_l_f0);
x86_l_1d:
	/* 0x1d: movsx  esi,WORD PTR [rsi] */
...
x86_l_23:
	/* 0x23: jne    8b <filter_16ty_range+0x8b> */
...
x86_l_2d:
	/* 0x2d: jg     38 <filter_16ty_range+0x38> */
...
x86_l_32:
	/* 0x32: jge    107 <filter_16ty_range+0x107> */
...
x86_l_3e:
	/* 0x3e: jb     1ab <filter_16ty_range+0x1ab> */
...
x86_l_47:
	/* 0x47: jg     52 <filter_16ty_range+0x52> */
...
x86_l_5e:
	/* 0x5e: jg     69 <filter_16ty_range+0x69> */
...
x86_l_77:
	/* 0x77: jg     1ad <filter_16ty_range+0x1ad> */
...
x86_l_80:
	/* 0x80: jge    107 <filter_16ty_range+0x107> */
	X86_SIM_X86_JCC(X86_CC_GE, 0x80, 0x107, x86_l_107);
x86_l_86:
	/* 0x86: jmp    1ad <filter_16ty_range+0x1ad> */
...
x86_l_a1:
	/* 0xa1: jb     1ad <filter_16ty_range+0x1ad> */
...
x86_l_be:
	/* 0xbe: jb     1ad <filter_16ty_range+0x1ad> */
...
x86_l_db:
	/* 0xdb: jb     1ad <filter_16ty_range+0x1ad> */
...
x86_l_fd:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_REG, X86_RDI, X86_RSI, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 16ULL);
x86_l_100:
	/* 0x100: ja     16f <filter_16ty_range+0x16f> */
	X86_SIM_X86_JCC(X86_CC_A, 0x100, 0x16f, x86_l_16f);
x86_l_102:
	/* 0x102: cmp    DWORD PTR [rdi+0x14],esi */
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_REG, X86_RDI, X86_RSI, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 20ULL);
x86_l_105:
	/* 0x105: jb     16f <filter_16ty_range+0x16f> */
	X86_SIM_X86_JCC(X86_CC_B, 0x105, 0x16f, x86_l_16f);
x86_l_107:
	/* 0x107: jmp    1c0 <filter_16ty_range+0x1c0> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_10c:
...
x86_l_11f:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RAX, X86_WIDTH_32, 17ULL);
x86_l_122:
	/* 0x122: jb     1ad <filter_16ty_range+0x1ad> */
...
x86_l_13c:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RAX, X86_WIDTH_32, 25ULL);
x86_l_13f:
	/* 0x13f: jb     1ad <filter_16ty_range+0x1ad> */
...
x86_l_155:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RAX, X86_WIDTH_32, 33ULL);
x86_l_158:
	/* 0x158: jb     1ad <filter_16ty_range+0x1ad> */
...
x86_l_16d:
	/* 0x16d: jmp    1ad <filter_16ty_range+0x1ad> */
...
x86_l_1bb:
	/* 0x1bb: jmp    1c0 <filter_16ty_range+0x1c0> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_1c0:
