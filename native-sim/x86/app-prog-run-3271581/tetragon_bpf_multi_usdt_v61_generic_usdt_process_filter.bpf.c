...
static __noinline __u64 tetragon_bpf_multi_usdt_v61_generic_usdt_process_filter_x86_chunk_0(
...
static __noinline __u64 tetragon_bpf_multi_usdt_v61_generic_usdt_process_filter_x86_chunk_1(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_usdt_v61_generic_usdt_process_filter_x86_chunk_2(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_usdt_v61_generic_usdt_process_filter_x86_chunk_3(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_usdt_v61_generic_usdt_process_filter_x86_chunk_4(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_usdt_v61_generic_usdt_process_filter_x86_chunk_5(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_usdt_v61_generic_usdt_process_filter_x86_chunk_6(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
SEC("xdp")
int tetragon_bpf_multi_usdt_v61_generic_usdt_process_filter_x86_sim_xdp(struct xdp_md *ctx)
{
	...
	for (__u32 __x86_iter = 0; __x86_iter < 9328U; __x86_iter++) {
		...
		if (__x86_pc >= 0ULL && __x86_pc <= 1843ULL)
			__x86_pc = tetragon_bpf_multi_usdt_v61_generic_usdt_process_filter_x86_chunk_0(__x86_state, __x86_pc);
		else if (__x86_pc >= 1845ULL && __x86_pc <= 3717ULL)
			__x86_pc = tetragon_bpf_multi_usdt_v61_generic_usdt_process_filter_x86_chunk_1(__x86_state, __x86_pc);
		else if (__x86_pc >= 3719ULL && __x86_pc <= 5458ULL)
			__x86_pc = tetragon_bpf_multi_usdt_v61_generic_usdt_process_filter_x86_chunk_2(__x86_state, __x86_pc);
		else if (__x86_pc >= 5463ULL && __x86_pc <= 7063ULL)
			__x86_pc = tetragon_bpf_multi_usdt_v61_generic_usdt_process_filter_x86_chunk_3(__x86_state, __x86_pc);
		else if (__x86_pc >= 7069ULL && __x86_pc <= 8548ULL)
			__x86_pc = tetragon_bpf_multi_usdt_v61_generic_usdt_process_filter_x86_chunk_4(__x86_state, __x86_pc);
		else if (__x86_pc >= 8553ULL && __x86_pc <= 9985ULL)
			__x86_pc = tetragon_bpf_multi_usdt_v61_generic_usdt_process_filter_x86_chunk_5(__x86_state, __x86_pc);
		else if (__x86_pc >= 9990ULL && __x86_pc <= 10079ULL)
			__x86_pc = tetragon_bpf_multi_usdt_v61_generic_usdt_process_filter_x86_chunk_6(__x86_state, __x86_pc);
		else
