...
x86_l_19:
	/* 0x19: mov    rdi,QWORD PTR [rip+0x6060] */
...
x86_l_63:
	/* 0x63: mov    rdi,QWORD PTR [rip+0x6060] */
...
x86_l_363:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_R15, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 40ULL);
x86_l_368:
	/* 0x368: mov    rdi,QWORD PTR [rip+0x6060] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&execve_map)));
x86_l_36f:
...
x86_l_426:
	/* 0x426: mov    rdi,QWORD PTR [rip+0x605c] */
...
x86_l_444:
	/* 0x444: mov    rsi,QWORD PTR [rip+0x605c] */
...
x86_l_476:
	/* 0x476: mov    rdi,QWORD PTR [rip+0x605c] */
...
x86_l_490:
	/* 0x490: mov    rdi,QWORD PTR [rip+0x605c] */
...
x86_l_4ad:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_4b5:
	/* 0x4b5: mov    rdi,QWORD PTR [rip+0x605c] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&policy_stats)));
x86_l_4bc:
...
x86_l_4ea:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_4f2:
	/* 0x4f2: mov    rdi,QWORD PTR [rip+0x6058] */
...
x86_l_539:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_541:
	/* 0x541: mov    rdi,QWORD PTR [rip+0x6058] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_stats_map)));
x86_l_548:
