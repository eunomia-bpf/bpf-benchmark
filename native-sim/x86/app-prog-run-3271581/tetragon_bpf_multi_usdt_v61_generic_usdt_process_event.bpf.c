...
static __noinline __u64 tetragon_bpf_multi_usdt_v61_generic_usdt_process_event_x86_chunk_8(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
int tetragon_bpf_multi_usdt_v61_generic_usdt_process_event_x86_sim_xdp(struct xdp_md *ctx)
{
	...
	for (__u32 __x86_iter = 0; __x86_iter < 13176U; __x86_iter++) {
		...
		if (__x86_pc >= 0ULL && __x86_pc <= 1773ULL)
			...
			__x86_pc = tetragon_bpf_multi_usdt_v61_generic_usdt_process_event_x86_chunk_8(__x86_state, __x86_pc);
		else
