...
x86_l_19:
	/* 0x19: mov    rdi,QWORD PTR [rip+0x23220] */
...
x86_l_2f:
	/* 0x2f: je     4d2 <generic_fentry_output+0x4d2> */
...
x86_l_40:
	/* 0x40: je     33d <generic_fentry_output+0x33d> */
...
x86_l_63:
	/* 0x63: mov    rdi,QWORD PTR [rip+0x23220] */
...
x86_l_76:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_79:
	/* 0x79: je     33d <generic_fentry_output+0x33d> */
...
x86_l_168:
	/* 0x168: je     1fb <generic_fentry_output+0x1fb> */
...
x86_l_345:
	/* 0x345: je     402 <generic_fentry_output+0x402> */
...
x86_l_363:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_R15, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 40ULL);
x86_l_368:
	/* 0x368: mov    rdi,QWORD PTR [rip+0x23220] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&execve_map)));
x86_l_36f:
...
x86_l_37b:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_37e:
	/* 0x37e: je     402 <generic_fentry_output+0x402> */
...
x86_l_426:
	/* 0x426: mov    rdi,QWORD PTR [rip+0x2321c] */
...
x86_l_439:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_43c:
	/* 0x43c: je     490 <generic_fentry_output+0x490> */
...
x86_l_442:
	/* 0x442: je     490 <generic_fentry_output+0x490> */
	X86_SIM_X86_JCC(X86_CC_E, 0x442, 0x490, x86_l_490);
x86_l_444:
	/* 0x444: mov    rsi,QWORD PTR [rip+0x2321c] */
...
x86_l_489:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_48c:
	/* 0x48c: jne    4cd <generic_fentry_output+0x4cd> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x48c, 0x4cd, x86_l_4cd);
x86_l_48e:
	/* 0x48e: jmp    4d2 <generic_fentry_output+0x4d2> */
	X86_SIM_X86_JMP(0x48e, 0x4d2, x86_l_4d2);
x86_l_490:
	/* 0x490: mov    rdi,QWORD PTR [rip+0x2321c] */
...
x86_l_4c8:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_4cb:
	/* 0x4cb: je     4d2 <generic_fentry_output+0x4d2> */
...
x86_l_4e2:
	/* 0x4e2: jmp    5ed <generic_fentry_output+0x5ed> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_4e7:
	/* 0x4e7: mov    rbx,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RBX, X86_RAX, X86_WIDTH_64);
x86_l_4ea:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_4f2:
	/* 0x4f2: mov    rdi,QWORD PTR [rip+0x23218] */
...
x86_l_534:
	/* 0x534: jmp    4d2 <generic_fentry_output+0x4d2> */
...
x86_l_539:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_541:
	/* 0x541: mov    rdi,QWORD PTR [rip+0x23218] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_stats_map)));
x86_l_548:
...
x86_l_5b7:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_5bb:
	/* 0x5bb: jmp    4d2 <generic_fentry_output+0x4d2> */
...
x86_l_5c6:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_5ca:
	/* 0x5ca: jmp    4d2 <generic_fentry_output+0x4d2> */
...
x86_l_5d5:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_5d9:
	/* 0x5d9: jmp    4d2 <generic_fentry_output+0x4d2> */
...
x86_l_5e4:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_5e8:
	/* 0x5e8: jmp    4d2 <generic_fentry_output+0x4d2> */
