...
x86_l_32:
	/* 0x32: je     60e <generic_usdt_event+0x60e> */
...
x86_l_5a:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5d:
	/* 0x5d: je     60e <generic_usdt_event+0x60e> */
...
x86_l_88:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_8b:
	/* 0x8b: je     60e <generic_usdt_event+0x60e> */
...
x86_l_d3:
	/* 0xd3: jmp    60e <generic_usdt_event+0x60e> */
...
x86_l_150:
	/* 0x150: je     60e <generic_usdt_event+0x60e> */
...
x86_l_179:
	/* 0x179: je     60e <generic_usdt_event+0x60e> */
...
x86_l_1e1:
	/* 0x1e1: jmp    60e <generic_usdt_event+0x60e> */
...
x86_l_1ed:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1f0:
	/* 0x1f0: je     60e <generic_usdt_event+0x60e> */
...
x86_l_235:
	/* 0x235: je     626 <generic_usdt_event+0x626> */
...
x86_l_621:
	/* 0x621: jmp    67f <generic_usdt_event+0x67f> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_626:
...
x86_l_63e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_641:
	/* 0x641: je     60e <generic_usdt_event+0x60e> */
...
x86_l_65e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_661:
	/* 0x661: je     60e <generic_usdt_event+0x60e> */
...
x86_l_675:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R12, X86_WIDTH_64);
x86_l_678:
	/* 0x678: jne    60e <generic_usdt_event+0x60e> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x678, 0x60e, x86_l_60e);
x86_l_67a:
	/* 0x67a: jmp    23b <generic_usdt_event+0x23b> */
