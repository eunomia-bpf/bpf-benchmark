...
static __noinline __u64 tetragon_bpf_generic_tracepoint_v61_generic_tracepoint_event_x86_chunk_7(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
int tetragon_bpf_generic_tracepoint_v61_generic_tracepoint_event_x86_sim_xdp(struct xdp_md *ctx)
{
	...
	for (__u32 __x86_iter = 0; __x86_iter < 11004U; __x86_iter++) {
		...
		if (__x86_pc >= 0ULL && __x86_pc <= 1784ULL)
			...
			__x86_pc = tetragon_bpf_generic_tracepoint_v61_generic_tracepoint_event_x86_chunk_7(__x86_state, __x86_pc);
		else
