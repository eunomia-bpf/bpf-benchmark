...
SEC("xdp")
int tetragon_bpf_generic_tracepoint_v61_filter_8ty_map_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_15:
	/* 0x15: mov    rdi,QWORD PTR [rip+0x1320] */
...
x86_l_2b:
	/* 0x2b: je     61 <filter_8ty_map+0x61> */
	X86_SIM_X86_JCC(X86_CC_E, 0x2b, 0x61, x86_l_61);
x86_l_2d:
	/* 0x2d: mov    rdi,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RDI, X86_RAX, X86_WIDTH_64);
x86_l_30:
	/* 0x30: movzx  eax,BYTE PTR [r14] */
...
x86_l_4d:
	/* 0x4d: ja     7f <filter_8ty_map+0x7f> */
...
x86_l_57:
	/* 0x57: jae    6f <filter_8ty_map+0x6f> */
...
x86_l_5f:
	/* 0x5f: jmp    7f <filter_8ty_map+0x7f> */
...
x86_l_6a:
	/* 0x6a: jmp    8e <filter_8ty_map+0x8e> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_6f:
...
x86_l_74:
	...
	X86_SIM_L_EXEC_BT(X86_RSI, X86_RDX, X86_WIDTH_32);
x86_l_77:
	/* 0x77: jae    7f <filter_8ty_map+0x7f> */
...
x86_l_87:
	...
	X86_SIM_L_EXEC_POP(X86_R14, X86_WIDTH_64);
x86_l_89:
	/* 0x89: jmp    8e <filter_8ty_map+0x8e> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_8e:
