...
x86_l_1f:
	/* 0x1f: mov    rdi,QWORD PTR [rip+0x360] */
...
x86_l_2a1:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 17179869184ULL);
x86_l_2a9:
	/* 0x2a9: mov    rdi,QWORD PTR [rip+0x440] */
...
x86_l_377:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 17179869184ULL);
x86_l_37f:
	/* 0x37f: mov    rdi,QWORD PTR [rip+0x69c] */
...
x86_l_39d:
	/* 0x39d: mov    rsi,QWORD PTR [rip+0x69c] */
...
x86_l_3cd:
	/* 0x3cd: mov    rdi,QWORD PTR [rip+0x69c] */
