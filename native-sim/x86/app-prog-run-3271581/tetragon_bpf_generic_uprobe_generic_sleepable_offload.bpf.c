...
SEC("xdp")
int tetragon_bpf_generic_uprobe_generic_sleepable_offload_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_23:
	/* 0x23: mov    rdi,QWORD PTR [rip+0x10b9] */
...
x86_l_45:
	/* 0x45: mov    rdi,QWORD PTR [rip+0x10b9] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&sleepable_offload)));
x86_l_4c:
...
x86_l_59:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_5b:
	/* 0x5b: mov    rdi,QWORD PTR [rip+0x10b9] */
