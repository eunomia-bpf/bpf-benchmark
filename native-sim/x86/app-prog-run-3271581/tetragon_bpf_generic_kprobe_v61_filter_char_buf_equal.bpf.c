...
SEC("xdp")
int tetragon_bpf_generic_kprobe_v61_filter_char_buf_equal_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_122:
	/* 0x122: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_13b:
	/* 0x13b: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_228:
	/* 0x228: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_262:
	/* 0x262: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_296:
	/* 0x296: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_2bb:
	/* 0x2bb: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_2d1:
	/* 0x2d1: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_2e4:
	/* 0x2e4: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_2f7:
	/* 0x2f7: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_30a:
	/* 0x30a: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_31d:
	/* 0x31d: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_330:
	/* 0x330: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_343:
	/* 0x343: mov    rdi,QWORD PTR [rip+0x200c] */
