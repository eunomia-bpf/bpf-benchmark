...
x86_l_32:
	/* 0x32: je     619 <generic_usdt_event+0x619> */
...
x86_l_235:
	/* 0x235: je     631 <generic_usdt_event+0x631> */
...
x86_l_62c:
	/* 0x62c: jmp    68a <generic_usdt_event+0x68a> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_631:
...
x86_l_649:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_64c:
	/* 0x64c: je     619 <generic_usdt_event+0x619> */
...
x86_l_669:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_66c:
	/* 0x66c: je     619 <generic_usdt_event+0x619> */
...
x86_l_680:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R12, X86_WIDTH_64);
x86_l_683:
	/* 0x683: jne    619 <generic_usdt_event+0x619> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x683, 0x619, x86_l_619);
x86_l_685:
	/* 0x685: jmp    23b <generic_usdt_event+0x23b> */
