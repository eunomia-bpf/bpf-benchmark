...
x86_l_29:
	/* 0x29: je     132 <generic_fexit_actions+0x132> */
...
x86_l_3d:
	/* 0x3d: jl     132 <generic_fexit_actions+0x132> */
...
x86_l_58:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5b:
	/* 0x5b: je     132 <generic_fexit_actions+0x132> */
...
x86_l_9b:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_9e:
	/* 0x9e: je     ae <generic_fexit_actions+0xae> */
...
x86_l_aa:
	/* 0xaa: jae    b6 <generic_fexit_actions+0xb6> */
	X86_SIM_X86_JCC(X86_CC_AE, 0xaa, 0xb6, x86_l_b6);
x86_l_ac:
	/* 0xac: jmp    110 <generic_fexit_actions+0x110> */
...
x86_l_b0:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 5ULL);
x86_l_b4:
	/* 0xb4: jb     110 <generic_fexit_actions+0x110> */
...
x86_l_c9:
	/* 0xc9: call   0 <generic_fexit_actions> */
...
x86_l_d8:
	/* 0xd8: jae    110 <generic_fexit_actions+0x110> */
...
x86_l_e7:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_R8, X86_RBP, X86_WIDTH_32);
x86_l_ea:
	/* 0xea: call   0 <generic_fexit_actions> */
...
x86_l_f6:
	...
	X86_SIM_L_EXEC_CMP_REG_MEM(X86_RCX, X86_R14, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32), 0ULL);
x86_l_f9:
	/* 0xf9: jae    110 <generic_fexit_actions+0x110> */
...
x86_l_108:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_R8, X86_RBP, X86_WIDTH_32);
x86_l_10b:
	/* 0x10b: call   0 <generic_fexit_actions> */
...
x86_l_115:
	/* 0x115: je     132 <generic_fexit_actions+0x132> */
