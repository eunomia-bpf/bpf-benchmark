...
SEC("xdp")
int tetragon_bpf_generic_fexit_v511_generic_fexit_output_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_2a:
	/* 0x2a: je     103 <generic_fexit_output+0x103> */
...
x86_l_6a:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_6d:
	/* 0x6d: je     c1 <generic_fexit_output+0xc1> */
...
x86_l_73:
	/* 0x73: je     c1 <generic_fexit_output+0xc1> */
...
x86_l_96:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_99:
	/* 0x99: js     162 <generic_fexit_output+0x162> */
...
x86_l_ba:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_bd:
	/* 0xbd: jne    fe <generic_fexit_output+0xfe> */
	X86_SIM_X86_JCC(X86_CC_NE, 0xbd, 0xfe, x86_l_fe);
x86_l_bf:
	/* 0xbf: jmp    103 <generic_fexit_output+0x103> */
...
x86_l_d9:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_dc:
	/* 0xdc: js     113 <generic_fexit_output+0x113> */
...
x86_l_f9:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_fc:
	/* 0xfc: je     103 <generic_fexit_output+0x103> */
...
x86_l_10e:
	/* 0x10e: jmp    219 <generic_fexit_output+0x219> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_113:
	/* 0x113: mov    rbx,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RBX, X86_RAX, X86_WIDTH_64);
...
x86_l_160:
	/* 0x160: jmp    103 <generic_fexit_output+0x103> */
...
x86_l_1e3:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_1e7:
	/* 0x1e7: jmp    103 <generic_fexit_output+0x103> */
...
x86_l_1f2:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_1f6:
	/* 0x1f6: jmp    103 <generic_fexit_output+0x103> */
...
x86_l_201:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_205:
	/* 0x205: jmp    103 <generic_fexit_output+0x103> */
...
x86_l_210:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_214:
	/* 0x214: jmp    103 <generic_fexit_output+0x103> */
