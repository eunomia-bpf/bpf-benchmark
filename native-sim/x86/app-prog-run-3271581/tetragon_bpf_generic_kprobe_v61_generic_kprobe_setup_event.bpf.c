...
SEC("xdp")
int tetragon_bpf_generic_kprobe_v61_generic_kprobe_setup_event_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_2a:
	/* 0x2a: je     23d <generic_kprobe_setup_event+0x23d> */
	X86_SIM_X86_JCC(X86_CC_E, 0x2a, 0x23d, x86_l_23d);
x86_l_30:
	/* 0x30: mov    r14,rax */
...
x86_l_48:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_4b:
	/* 0x4b: je     23d <generic_kprobe_setup_event+0x23d> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4b, 0x23d, x86_l_23d);
x86_l_51:
	/* 0x51: mov    r15,rax */
...
x86_l_f7:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_f9:
	/* 0xf9: mov    DWORD PTR [r14+0x7c],eax */
...
x86_l_14f:
	/* 0x14f: lea    rsi,[rsp+0x30] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 48ULL);
x86_l_154:
	/* 0x154: lea    rdx,[rsp+0x18] */
...
x86_l_197:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_19a:
	/* 0x19a: je     1a0 <generic_kprobe_setup_event+0x1a0> */
	X86_SIM_X86_JCC(X86_CC_E, 0x19a, 0x1a0, x86_l_1a0);
x86_l_19c:
	/* 0x19c: inc    DWORD PTR [rax] */
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_32, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_19e:
	/* 0x19e: jmp    1c4 <generic_kprobe_setup_event+0x1c4> */
	X86_SIM_X86_JMP(0x19e, 0x1c4, x86_l_1c4);
x86_l_1a0:
	/* 0x1a0: mov    DWORD PTR [rsp+0x8],0x1 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 34359738369ULL);
x86_l_1a8:
	/* 0x1a8: mov    rdi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_errmetrics_map)));
x86_l_1af:
	/* 0x1af: xor    ecx,ecx */
	X86_SIM_L_EXEC_ALU_REG(X86_RCX, X86_RCX, X86_WIDTH_32, X86_ALU_XOR);
x86_l_1b1:
	/* 0x1b1: lea    rsi,[rsp+0xc] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 12ULL);
x86_l_1b6:
	/* 0x1b6: lea    rdx,[rsp+0x8] */
...
x86_l_1c2:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_1c4:
	/* 0x1c4: mov    DWORD PTR [rsp+0x18],0x0 */
...
x86_l_1df:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1e2:
	/* 0x1e2: je     207 <generic_kprobe_setup_event+0x207> */
	X86_SIM_X86_JCC(X86_CC_E, 0x1e2, 0x207, x86_l_207);
x86_l_1e4:
	/* 0x1e4: mov    rsi,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RAX, X86_WIDTH_64);
x86_l_1e7:
	/* 0x1e7: add    rsi,0x5ef8 */
...
x86_l_1fc:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1ff:
	/* 0x1ff: je     207 <generic_kprobe_setup_event+0x207> */
	X86_SIM_X86_JCC(X86_CC_E, 0x1ff, 0x207, x86_l_207);
x86_l_201:
	/* 0x201: cmp    DWORD PTR [rax+0x40],0xffffffff */
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 279172874239ULL);
x86_l_205:
	/* 0x205: jne    222 <generic_kprobe_setup_event+0x222> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x205, 0x222, x86_l_222);
x86_l_207:
	/* 0x207: mov    rsi,QWORD PTR [rip+0x0] */
...
x86_l_220:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_222:
	/* 0x222: mov    rsi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&kprobe_calls)));
x86_l_229:
	/* 0x229: mov    ecx,0x1 */
...
x86_l_248:
	/* 0x248: jmp    24d <generic_kprobe_setup_event+0x24d> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_24d:
