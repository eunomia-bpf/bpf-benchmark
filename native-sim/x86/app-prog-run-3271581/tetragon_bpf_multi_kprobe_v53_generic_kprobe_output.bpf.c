...
x86_l_19:
	/* 0x19: mov    rdi,QWORD PTR [rip+0x227b0] */
...
x86_l_2f:
	/* 0x2f: je     502 <generic_kprobe_output+0x502> */
...
x86_l_40:
	/* 0x40: je     348 <generic_kprobe_output+0x348> */
...
x86_l_63:
	/* 0x63: mov    rdi,QWORD PTR [rip+0x227b0] */
...
x86_l_76:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_79:
	/* 0x79: je     348 <generic_kprobe_output+0x348> */
...
x86_l_16c:
	/* 0x16c: je     202 <generic_kprobe_output+0x202> */
...
x86_l_1fe:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_200:
	/* 0x200: jmp    20a <generic_kprobe_output+0x20a> */
...
x86_l_350:
	/* 0x350: je     40d <generic_kprobe_output+0x40d> */
...
x86_l_36e:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_R15, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 40ULL);
x86_l_373:
	/* 0x373: mov    rdi,QWORD PTR [rip+0x227b0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&execve_map)));
x86_l_37a:
...
x86_l_386:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_389:
	/* 0x389: je     40d <generic_kprobe_output+0x40d> */
...
x86_l_42a:
	/* 0x42a: mov    rsi,QWORD PTR [rip+0x227ac] */
...
x86_l_468:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_46b:
	/* 0x46b: je     502 <generic_kprobe_output+0x502> */
...
x86_l_476:
	/* 0x476: jmp    502 <generic_kprobe_output+0x502> */
...
x86_l_47e:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_486:
	/* 0x486: mov    rdi,QWORD PTR [rip+0x227ac] */
...
x86_l_512:
	/* 0x512: jmp    517 <generic_kprobe_output+0x517> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_517:
