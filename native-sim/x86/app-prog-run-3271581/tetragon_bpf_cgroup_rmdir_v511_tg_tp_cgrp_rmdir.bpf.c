...
x86_l_25:
	/* 0x25: je     414 <tg_tp_cgrp_rmdir+0x414> */
...
x86_l_5c:
	/* 0x5c: je     414 <tg_tp_cgrp_rmdir+0x414> */
...
x86_l_89:
	/* 0x89: je     414 <tg_tp_cgrp_rmdir+0x414> */
...
x86_l_a2:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_a5:
	/* 0xa5: je     31a <tg_tp_cgrp_rmdir+0x31a> */
...
x86_l_d4:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_d7:
	/* 0xd7: je     414 <tg_tp_cgrp_rmdir+0x414> */
...
x86_l_e0:
	/* 0xe0: jne    414 <tg_tp_cgrp_rmdir+0x414> */
...
x86_l_106:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_109:
	/* 0x109: je     414 <tg_tp_cgrp_rmdir+0x414> */
...
x86_l_285:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_288:
	/* 0x288: je     429 <tg_tp_cgrp_rmdir+0x429> */
...
x86_l_292:
	/* 0x292: je     429 <tg_tp_cgrp_rmdir+0x429> */
...
x86_l_2c1:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_2c4:
	/* 0x2c4: jns    414 <tg_tp_cgrp_rmdir+0x414> */
...
x86_l_3aa:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3ad:
	/* 0x3ad: je     414 <tg_tp_cgrp_rmdir+0x414> */
...
x86_l_3b4:
	/* 0x3b4: je     414 <tg_tp_cgrp_rmdir+0x414> */
...
x86_l_424:
	/* 0x424: jmp    4e2 <tg_tp_cgrp_rmdir+0x4e2> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_429:
...
x86_l_443:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_446:
	/* 0x446: jns    414 <tg_tp_cgrp_rmdir+0x414> */
...
x86_l_4dd:
	/* 0x4dd: jmp    414 <tg_tp_cgrp_rmdir+0x414> */
