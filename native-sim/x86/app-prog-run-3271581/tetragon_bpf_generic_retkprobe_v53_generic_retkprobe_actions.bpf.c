...
x86_l_3d:
	/* 0x3d: je     b19 <generic_retkprobe_actions+0xb19> */
...
x86_l_4f:
	/* 0x4f: jl     b19 <generic_retkprobe_actions+0xb19> */
...
x86_l_6a:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_6d:
	/* 0x6d: je     b19 <generic_retkprobe_actions+0xb19> */
...
x86_l_142:
	/* 0x142: je     af2 <generic_retkprobe_actions+0xaf2> */
...
x86_l_153:
	/* 0x153: jae    af2 <generic_retkprobe_actions+0xaf2> */
...
x86_l_7d8:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_7db:
	/* 0x7db: je     a99 <generic_retkprobe_actions+0xa99> */
	X86_SIM_X86_JCC(X86_CC_E, 0x7db, 0xa99, x86_l_a99);
x86_l_7e1:
	/* 0x7e1: inc    DWORD PTR [rax] */
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_32, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_7e3:
	/* 0x7e3: jmp    abf <generic_retkprobe_actions+0xabf> */
...
x86_l_a5e:
	/* 0xa5e: je     12e <generic_retkprobe_actions+0x12e> */
...
x86_l_a94:
	/* 0xa94: jmp    12e <generic_retkprobe_actions+0x12e> */
...
x86_l_ac4:
	/* 0xac4: je     550 <generic_retkprobe_actions+0x550> */
...
x86_l_add:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_ae0:
	/* 0xae0: je     550 <generic_retkprobe_actions+0x550> */
...
x86_l_aed:
	/* 0xaed: jmp    550 <generic_retkprobe_actions+0x550> */
...
x86_l_af7:
	/* 0xaf7: je     b19 <generic_retkprobe_actions+0xb19> */
...
x86_l_b2c:
	/* 0xb2c: jmp    b31 <generic_retkprobe_actions+0xb31> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_b31:
