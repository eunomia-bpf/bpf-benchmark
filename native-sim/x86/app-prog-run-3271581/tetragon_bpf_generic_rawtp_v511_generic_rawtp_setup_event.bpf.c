...
SEC("xdp")
int tetragon_bpf_generic_rawtp_v511_generic_rawtp_setup_event_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_28:
	/* 0x28: je     1be <generic_rawtp_setup_event+0x1be> */
...
x86_l_46:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_49:
	/* 0x49: je     1be <generic_rawtp_setup_event+0x1be> */
...
x86_l_160:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_163:
	/* 0x163: je     188 <generic_rawtp_setup_event+0x188> */
...
x86_l_17d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_180:
	/* 0x180: je     188 <generic_rawtp_setup_event+0x188> */
...
x86_l_186:
	/* 0x186: jne    1a3 <generic_rawtp_setup_event+0x1a3> */
...
x86_l_1c7:
	/* 0x1c7: jmp    1cc <generic_rawtp_setup_event+0x1cc> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_1cc:
