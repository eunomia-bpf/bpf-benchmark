...
x86_l_1e:
	/* 0x1e: mov    rdi,QWORD PTR [rip+0x218d0] */
...
x86_l_34:
	/* 0x34: je     b72 <generic_uprobe_actions+0xb72> */
	X86_SIM_X86_JCC(X86_CC_E, 0x34, 0xb72, x86_l_b72);
x86_l_3a:
	/* 0x3a: mov    rsi,rax */
...
x86_l_46:
	/* 0x46: jl     b72 <generic_uprobe_actions+0xb72> */
	X86_SIM_X86_JCC(X86_CC_L, 0x46, 0xb72, x86_l_b72);
x86_l_4c:
	/* 0x4c: add    rsi,0x5ef8 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RSI, X86_WIDTH_64, X86_ALU_ADD, 24312ULL);
x86_l_53:
	/* 0x53: mov    rdi,QWORD PTR [rip+0x218d0] */
...
x86_l_61:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_64:
	/* 0x64: je     b72 <generic_uprobe_actions+0xb72> */
	X86_SIM_X86_JCC(X86_CC_E, 0x64, 0xb72, x86_l_b72);
x86_l_6a:
	/* 0x6a: mov    r14,rax */
...
x86_l_80:
	/* 0x80: mov    rdi,QWORD PTR [rip+0x218d0] */
...
x86_l_ec:
	/* 0xec: mov    rbp,QWORD PTR [rip+0x218d0] */
...
x86_l_108:
	/* 0x108: mov    rdi,QWORD PTR [rip+0x218d0] */
...
x86_l_129:
	/* 0x129: je     b4e <generic_uprobe_actions+0xb4e> */
	X86_SIM_X86_JCC(X86_CC_E, 0x129, 0xb4e, x86_l_b4e);
x86_l_12f:
...
x86_l_13a:
	/* 0x13a: jae    b4e <generic_uprobe_actions+0xb4e> */
	X86_SIM_X86_JCC(X86_CC_AE, 0x13a, 0xb4e, x86_l_b4e);
x86_l_140:
	/* 0x140: mov    eax,r15d */
...
x86_l_261:
	/* 0x261: mov    rdi,QWORD PTR [rip+0x218ec] */
...
x86_l_2cc:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_2d1:
	/* 0x2d1: mov    rdi,QWORD PTR [rip+0x218ec] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_2d8:
	/* 0x2d8: mov    rdx,rbx */
...
x86_l_312:
	/* 0x312: jmp    aaf <generic_uprobe_actions+0xaaf> */
	X86_SIM_X86_JMP(0x312, 0xaaf, x86_l_aaf);
x86_l_317:
	/* 0x317: mov    eax,0x9 */
...
x86_l_375:
	/* 0x375: mov    rdi,QWORD PTR [rip+0x218ec] */
...
x86_l_3a9:
	/* 0x3a9: mov    rbp,QWORD PTR [rip+0x218ec] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RBP, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_3b0:
	/* 0x3b0: test   ecx,ecx */
...
x86_l_42b:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_430:
	/* 0x430: mov    rdi,QWORD PTR [rip+0x218ec] */
...
x86_l_471:
	/* 0x471: mov    rdi,QWORD PTR [rip+0x218ec] */
...
x86_l_48b:
	/* 0x48b: je     aaf <generic_uprobe_actions+0xaaf> */
	X86_SIM_X86_JCC(X86_CC_E, 0x48b, 0xaaf, x86_l_aaf);
x86_l_491:
...
x86_l_4a0:
	/* 0x4a0: jmp    aaf <generic_uprobe_actions+0xaaf> */
	X86_SIM_X86_JMP(0x4a0, 0xaaf, x86_l_aaf);
x86_l_4a5:
	/* 0x4a5: inc    r15d */
	X86_SIM_L_EXEC_ALU_IMM(X86_R15, X86_WIDTH_32, X86_ALU_INC, 1);
x86_l_4a8:
...
x86_l_4ce:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 377957122048ULL);
x86_l_4d3:
	/* 0x4d3: je     aaf <generic_uprobe_actions+0xaaf> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4d3, 0xaaf, x86_l_aaf);
x86_l_4d9:
	/* 0x4d9: mov    eax,r15d */
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R15, X86_WIDTH_32);
x86_l_4dc:
...
x86_l_4f6:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 24ULL);
x86_l_4fb:
	/* 0x4fb: mov    rdi,QWORD PTR [rip+0x218ec] */
...
x86_l_513:
	/* 0x513: jb     aa4 <generic_uprobe_actions+0xaa4> */
	X86_SIM_X86_JCC(X86_CC_B, 0x513, 0xaa4, x86_l_aa4);
x86_l_519:
	/* 0x519: mov    eax,ebx */
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_RBX, X86_WIDTH_32);
x86_l_51b:
...
x86_l_548:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_54d:
	/* 0x54d: mov    rdi,QWORD PTR [rip+0x218ec] */
...
x86_l_556:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_559:
	/* 0x559: je     a7b <generic_uprobe_actions+0xa7b> */
	X86_SIM_X86_JCC(X86_CC_E, 0x559, 0xa7b, x86_l_a7b);
x86_l_55f:
	/* 0x55f: inc    DWORD PTR [rax] */
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_32, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_561:
	/* 0x561: jmp    a9f <generic_uprobe_actions+0xa9f> */
	X86_SIM_X86_JMP(0x561, 0xa9f, x86_l_a9f);
x86_l_566:
	/* 0x566: mov    eax,0xe */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 14ULL);
x86_l_56b:
...
x86_l_577:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 48ULL);
x86_l_57c:
	/* 0x57c: mov    rdi,QWORD PTR [rip+0x218ec] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_data)));
x86_l_583:
	/* 0x583: call   rax */
	X86_SIM_BPF_CALL_REG(X86_RAX);
...
x86_l_5a4:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 24ULL);
x86_l_5a9:
	/* 0x5a9: mov    rbx,QWORD PTR [rip+0x218ec] */
...
x86_l_60f:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_614:
	/* 0x614: mov    rbx,QWORD PTR [rip+0x218ec] */
...
x86_l_620:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_623:
	/* 0x623: je     afb <generic_uprobe_actions+0xafb> */
	X86_SIM_X86_JCC(X86_CC_E, 0x623, 0xafb, x86_l_afb);
x86_l_629:
	/* 0x629: inc    DWORD PTR [rax] */
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_32, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_62b:
	/* 0x62b: jmp    b1b <generic_uprobe_actions+0xb1b> */
	X86_SIM_X86_JMP(0x62b, 0xb1b, x86_l_b1b);
x86_l_630:
...
x86_l_66f:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_674:
	/* 0x674: mov    rdi,QWORD PTR [rip+0x218ec] */
...
x86_l_698:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 48ULL);
x86_l_69d:
	/* 0x69d: mov    rdi,QWORD PTR [rip+0x218ec] */
...
x86_l_6fb:
	/* 0x6fb: jmp    aaf <generic_uprobe_actions+0xaaf> */
	X86_SIM_X86_JMP(0x6fb, 0xaaf, x86_l_aaf);
x86_l_700:
...
x86_l_75c:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RDX, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_RAX, 2), 104041287778304ULL);
x86_l_764:
	/* 0x764: mov    rbp,QWORD PTR [rip+0x218ec] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RBP, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_76b:
...
x86_l_7b0:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_7b5:
	/* 0x7b5: mov    rdi,QWORD PTR [rip+0x218ec] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_7bc:
...
x86_l_7dd:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_7e2:
	/* 0x7e2: mov    rdi,QWORD PTR [rip+0x218ec] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_7e9:
	/* 0x7e9: call   rax */
	X86_SIM_BPF_CALL_REG(X86_RAX);
...
x86_l_7ee:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_R14, X86_RBP, X86_WIDTH_64);
x86_l_7f1:
	/* 0x7f1: mov    rbp,QWORD PTR [rip+0x218ec] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RBP, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_7f8:
...
x86_l_80e:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 24ULL);
x86_l_813:
	/* 0x813: mov    rdi,QWORD PTR [rip+0x218ec] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&socktrack_map)));
x86_l_81a:
	/* 0x81a: call   rax */
	X86_SIM_BPF_CALL_REG(X86_RAX);
...
x86_l_8aa:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_8af:
	/* 0x8af: mov    rdi,QWORD PTR [rip+0x218f1] */
...
x86_l_90f:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_914:
	/* 0x914: mov    rdi,QWORD PTR [rip+0x218f1] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&config_map)));
x86_l_91b:
	/* 0x91b: call   rax */
	X86_SIM_BPF_CALL_REG(X86_RAX);
...
x86_l_996:
	/* 0x996: mov    rbp,QWORD PTR [rip+0x218f1] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RBP, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_99d:
...
x86_l_9a7:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_9ac:
	/* 0x9ac: mov    rdi,QWORD PTR [rip+0x218f1] */
...
x86_l_9ef:
	...
	X86_SIM_L_EXEC_ALU_REG(X86_RCX, X86_RCX, X86_WIDTH_32, X86_ALU_XOR);
x86_l_9f1:
	/* 0x9f1: mov    rdi,QWORD PTR [rip+0x218f1] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&ratelimit_map)));
x86_l_9f8:
...
x86_l_a22:
	...
	X86_SIM_L_EXEC_ALU_REG(X86_RCX, X86_RCX, X86_WIDTH_32, X86_ALU_XOR);
x86_l_a24:
	/* 0xa24: mov    rsi,QWORD PTR [rip+0x218f1] */
...
x86_l_a6b:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_a6f:
	/* 0xa6f: mov    QWORD PTR [rdx+0x88],rax */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RDX, X86_RAX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 136ULL);
x86_l_a76:
	/* 0xa76: jmp    115 <generic_uprobe_actions+0x115> */
	X86_SIM_X86_JMP(0xa76, 0x115, x86_l_115);
x86_l_a7b:
...
x86_l_a8f:
	/* 0xa8f: lea    rsi,[rsp+0x8] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_a94:
	/* 0xa94: mov    rdi,QWORD PTR [rip+0x218f1] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_errmetrics_map)));
x86_l_a9b:
	/* 0xa9b: xor    ecx,ecx */
	X86_SIM_L_EXEC_ALU_REG(X86_RCX, X86_RCX, X86_WIDTH_32, X86_ALU_XOR);
...
x86_l_a9f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RBX, X86_RBX, X86_WIDTH_64);
x86_l_aa2:
	/* 0xaa2: je     add <generic_uprobe_actions+0xadd> */
	X86_SIM_X86_JCC(X86_CC_E, 0xaa2, 0xadd, x86_l_add);
x86_l_aa4:
	/* 0xaa4: mov    eax,DWORD PTR [rsp+0x24] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RAX, X86_RSP, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 36ULL);
x86_l_aa8:
	/* 0xaa8: mov    DWORD PTR [rbx],eax */
...
x86_l_aaf:
	/* 0xaaf: mov    DWORD PTR [rsp+0x8],0x0 */
...
x86_l_abc:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_ac1:
	/* 0xac1: mov    rdi,QWORD PTR [rip+0x218f1] */
...
x86_l_aca:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_acd:
	/* 0xacd: je     111 <generic_uprobe_actions+0x111> */
	X86_SIM_X86_JCC(X86_CC_E, 0xacd, 0x111, x86_l_111);
x86_l_ad3:
	/* 0xad3: inc QWORD PTR [rax+rbx*8] */
...
x86_l_ad8:
	/* 0xad8: jmp    111 <generic_uprobe_actions+0x111> */
	X86_SIM_X86_JMP(0xad8, 0x111, x86_l_111);
x86_l_add:
	/* 0xadd: mov    eax,0x2 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 2ULL);
x86_l_ae2:
	...
	X86_SIM_L_EXEC_ALU_REG(X86_RCX, X86_RCX, X86_WIDTH_32, X86_ALU_XOR);
x86_l_ae4:
	/* 0xae4: lea    rsi,[rsp+0x18] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 24ULL);
x86_l_ae9:
	/* 0xae9: mov    rdi,QWORD PTR [rip+0x218f1] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&sleepable_offload)));
x86_l_af0:
	/* 0xaf0: lea    rdx,[rsp+0x24] */
...
x86_l_af7:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_af9:
	/* 0xaf9: jmp    aaa <generic_uprobe_actions+0xaaa> */
	X86_SIM_X86_JMP(0xaf9, 0xaaa, x86_l_aaa);
x86_l_afb:
	/* 0xafb: mov    DWORD PTR [rsp+0x24],0x1 */
...
x86_l_b08:
	...
	X86_SIM_L_EXEC_ALU_REG(X86_RCX, X86_RCX, X86_WIDTH_32, X86_ALU_XOR);
x86_l_b0a:
	/* 0xb0a: lea    rdx,[rsp+0x24] */
	X86_SIM_L_EXEC_LEA(X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 36ULL);
x86_l_b0f:
	/* 0xb0f: lea    rsi,[rsp+0x8] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_b14:
	/* 0xb14: mov    rdi,rbx */
	X86_SIM_L_EXEC_MOV_REG(X86_RDI, X86_RBX, X86_WIDTH_64);
...
x86_l_b19:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_b1b:
	/* 0xb1b: cmp    DWORD PTR [rsp+0x28],0x0 */
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_b20:
	/* 0xb20: je     fe <generic_uprobe_actions+0xfe> */
	X86_SIM_X86_JCC(X86_CC_E, 0xb20, 0xfe, x86_l_fe);
x86_l_b26:
	/* 0xb26: mov    eax,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_b2b:
	/* 0xb2b: lea    rsi,[rsp+0x18] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 24ULL);
x86_l_b30:
	/* 0xb30: mov    rdi,QWORD PTR [rip+0x218f1] */
...
x86_l_b39:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_b3c:
	/* 0xb3c: je     fe <generic_uprobe_actions+0xfe> */
	X86_SIM_X86_JCC(X86_CC_E, 0xb3c, 0xfe, x86_l_fe);
x86_l_b42:
	/* 0xb42: mov    ecx,DWORD PTR [rsp+0x4c] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RCX, X86_RSP, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 76ULL);
x86_l_b46:
	/* 0xb46: add DWORD PTR [rax],ecx */
...
x86_l_b49:
	/* 0xb49: jmp    fe <generic_uprobe_actions+0xfe> */
	X86_SIM_X86_JMP(0xb49, 0xfe, x86_l_fe);
x86_l_b4e:
	/* 0xb4e: cmp    BYTE PTR [rsp+0x3c],0x0 */
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 257698037760ULL);
x86_l_b53:
	/* 0xb53: je     b72 <generic_uprobe_actions+0xb72> */
	X86_SIM_X86_JCC(X86_CC_E, 0xb53, 0xb72, x86_l_b72);
x86_l_b55:
	/* 0xb55: mov    rsi,QWORD PTR [rip+0x218f1] */
...
x86_l_b66:
	/* 0xb66: mov    rdi,QWORD PTR [rsp+0x60] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 96ULL);
x86_l_b6b:
	/* 0xb6b: mov    edx,0x5 */
...
x86_l_b85:
	/* 0xb85: jmp    b8a <generic_uprobe_actions+0xb8a> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_b8a:
