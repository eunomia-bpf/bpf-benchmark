...
x86_l_2f:
	/* 0x2f: je     506 <generic_retuprobe_filter_arg+0x506> */
...
x86_l_57:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5a:
	/* 0x5a: je     4eb <generic_retuprobe_filter_arg+0x4eb> */
...
x86_l_68:
	/* 0x68: je     4eb <generic_retuprobe_filter_arg+0x4eb> */
...
x86_l_7d:
	/* 0x7d: je     474 <generic_retuprobe_filter_arg+0x474> */
...
x86_l_a0:
	/* 0xa0: jb     465 <generic_retuprobe_filter_arg+0x465> */
...
x86_l_b1:
	/* 0xb1: je     465 <generic_retuprobe_filter_arg+0x465> */
...
x86_l_ca:
	/* 0xca: ja     1c5 <generic_retuprobe_filter_arg+0x1c5> */
...
x86_l_de:
	/* 0xde: jae    1c5 <generic_retuprobe_filter_arg+0x1c5> */
...
x86_l_ec:
	/* 0xec: ja     474 <generic_retuprobe_filter_arg+0x474> */
...
x86_l_fb:
	/* 0xfb: jne    474 <generic_retuprobe_filter_arg+0x474> */
...
x86_l_106:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_64, 36ULL);
x86_l_10a:
	/* 0x10a: ja     465 <generic_retuprobe_filter_arg+0x465> */
...
x86_l_128:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_64);
x86_l_12c:
	/* 0x12c: jae    1f9 <generic_retuprobe_filter_arg+0x1f9> */
...
x86_l_13a:
	/* 0x13a: ja     474 <generic_retuprobe_filter_arg+0x474> */
...
x86_l_148:
	/* 0x148: jae    29b <generic_retuprobe_filter_arg+0x29b> */
...
x86_l_154:
	/* 0x154: jb     31a <generic_retuprobe_filter_arg+0x31a> */
	X86_SIM_X86_JCC(X86_CC_B, 0x154, 0x31a, x86_l_31a);
x86_l_15a:
	/* 0x15a: cmp    ecx,0x6 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 6ULL);
x86_l_15d:
	/* 0x15d: je     465 <generic_retuprobe_filter_arg+0x465> */
	X86_SIM_X86_JCC(X86_CC_E, 0x15d, 0x465, x86_l_465);
x86_l_163:
	/* 0x163: cmp    ecx,0xc */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 12ULL);
x86_l_166:
	/* 0x166: jne    474 <generic_retuprobe_filter_arg+0x474> */
...
x86_l_179:
	/* 0x179: jne    465 <generic_retuprobe_filter_arg+0x465> */
...
x86_l_187:
	/* 0x187: jb     474 <generic_retuprobe_filter_arg+0x474> */
...
x86_l_1ba:
	/* 0x1ba: jne    465 <generic_retuprobe_filter_arg+0x465> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x1ba, 0x465, x86_l_465);
x86_l_1c0:
	/* 0x1c0: jmp    474 <generic_retuprobe_filter_arg+0x474> */
...
x86_l_1ea:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDX, X86_WIDTH_64, 4ULL);
x86_l_1ee:
	/* 0x1ee: jbe    f2 <generic_retuprobe_filter_arg+0xf2> */
	X86_SIM_X86_JCC(X86_CC_BE, 0x1ee, 0xf2, x86_l_f2);
x86_l_1f4:
	/* 0x1f4: jmp    474 <generic_retuprobe_filter_arg+0x474> */
...
x86_l_1fe:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_64);
x86_l_202:
	/* 0x202: jae    465 <generic_retuprobe_filter_arg+0x465> */
...
x86_l_20d:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 12ULL);
x86_l_210:
	/* 0x210: ja     474 <generic_retuprobe_filter_arg+0x474> */
...
x86_l_21b:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_32);
x86_l_21e:
	/* 0x21e: jae    373 <generic_retuprobe_filter_arg+0x373> */
...
x86_l_227:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDX, X86_WIDTH_32, 2ULL);
x86_l_22a:
	/* 0x22a: jb     3ef <generic_retuprobe_filter_arg+0x3ef> */
	X86_SIM_X86_JCC(X86_CC_B, 0x22a, 0x3ef, x86_l_3ef);
x86_l_230:
	/* 0x230: cmp    ecx,0x6 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 6ULL);
x86_l_233:
	/* 0x233: je     465 <generic_retuprobe_filter_arg+0x465> */
	X86_SIM_X86_JCC(X86_CC_E, 0x233, 0x465, x86_l_465);
x86_l_239:
	/* 0x239: cmp    ecx,0xc */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 12ULL);
x86_l_23c:
	/* 0x23c: jne    474 <generic_retuprobe_filter_arg+0x474> */
...
x86_l_24f:
	/* 0x24f: jne    465 <generic_retuprobe_filter_arg+0x465> */
...
x86_l_25d:
	/* 0x25d: jb     474 <generic_retuprobe_filter_arg+0x474> */
...
x86_l_268:
	/* 0x268: jne    465 <generic_retuprobe_filter_arg+0x465> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x268, 0x465, x86_l_465);
x86_l_26e:
	/* 0x26e: cmp    edx,0x11 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDX, X86_WIDTH_32, 17ULL);
x86_l_271:
	/* 0x271: jb     474 <generic_retuprobe_filter_arg+0x474> */
...
x86_l_290:
	/* 0x290: jne    465 <generic_retuprobe_filter_arg+0x465> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x290, 0x465, x86_l_465);
x86_l_296:
	/* 0x296: jmp    474 <generic_retuprobe_filter_arg+0x474> */
...
x86_l_2a0:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_32);
x86_l_2a3:
	/* 0x2a3: jae    474 <generic_retuprobe_filter_arg+0x474> */
...
x86_l_2cb:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_2ce:
	/* 0x2ce: je     3eb <generic_retuprobe_filter_arg+0x3eb> */
...
x86_l_2fd:
	/* 0x2fd: je     43b <generic_retuprobe_filter_arg+0x43b> */
	X86_SIM_X86_JCC(X86_CC_E, 0x2fd, 0x43b, x86_l_43b);
x86_l_303:
	/* 0x303: cmp    ecx,0xa */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 10ULL);
x86_l_306:
	/* 0x306: jne    446 <generic_retuprobe_filter_arg+0x446> */
...
x86_l_315:
	/* 0x315: jmp    460 <generic_retuprobe_filter_arg+0x460> */
...
x86_l_327:
	/* 0x327: je     3fe <generic_retuprobe_filter_arg+0x3fe> */
...
x86_l_335:
	/* 0x335: jb     431 <generic_retuprobe_filter_arg+0x431> */
...
x86_l_368:
	/* 0x368: je     3fe <generic_retuprobe_filter_arg+0x3fe> */
	X86_SIM_X86_JCC(X86_CC_E, 0x368, 0x3fe, x86_l_3fe);
x86_l_36e:
	/* 0x36e: jmp    431 <generic_retuprobe_filter_arg+0x431> */
...
x86_l_378:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_32);
x86_l_37b:
	/* 0x37b: jae    474 <generic_retuprobe_filter_arg+0x474> */
...
x86_l_3a3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3a6:
	/* 0x3a6: je     3eb <generic_retuprobe_filter_arg+0x3eb> */
...
x86_l_3d3:
	/* 0x3d3: ja     45d <generic_retuprobe_filter_arg+0x45d> */
...
x86_l_3e1:
	/* 0x3e1: jae    44d <generic_retuprobe_filter_arg+0x44d> */
...
x86_l_3e9:
	/* 0x3e9: jmp    45d <generic_retuprobe_filter_arg+0x45d> */
	X86_SIM_X86_JMP(0x3e9, 0x45d, x86_l_45d);
x86_l_3eb:
	/* 0x3eb: xor    eax,eax */
	X86_SIM_L_EXEC_ALU_REG(X86_RAX, X86_RAX, X86_WIDTH_32, X86_ALU_XOR);
x86_l_3ed:
	/* 0x3ed: jmp    460 <generic_retuprobe_filter_arg+0x460> */
...
x86_l_3fc:
	/* 0x3fc: jne    408 <generic_retuprobe_filter_arg+0x408> */
...
x86_l_406:
	/* 0x406: jmp    460 <generic_retuprobe_filter_arg+0x460> */
...
x86_l_410:
	/* 0x410: jb     431 <generic_retuprobe_filter_arg+0x431> */
...
x86_l_417:
	/* 0x417: je     3fe <generic_retuprobe_filter_arg+0x3fe> */
	X86_SIM_X86_JCC(X86_CC_E, 0x417, 0x3fe, x86_l_3fe);
x86_l_419:
	/* 0x419: cmp    esi,0x11 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RSI, X86_WIDTH_32, 17ULL);
x86_l_41c:
	/* 0x41c: jb     431 <generic_retuprobe_filter_arg+0x431> */
...
x86_l_42f:
	/* 0x42f: je     3fe <generic_retuprobe_filter_arg+0x3fe> */
...
x86_l_434:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 6ULL);
x86_l_437:
	/* 0x437: je     465 <generic_retuprobe_filter_arg+0x465> */
	X86_SIM_X86_JCC(X86_CC_E, 0x437, 0x465, x86_l_465);
x86_l_439:
	/* 0x439: jmp    474 <generic_retuprobe_filter_arg+0x474> */
...
x86_l_441:
	...
	X86_SIM_L_EXEC_MOVX_REG(X86_OP_MOVZX_REG, X86_RAX, X86_RAX, X86_WIDTH_32, X86_WIDTH_8);
x86_l_444:
	/* 0x444: jmp    460 <generic_retuprobe_filter_arg+0x460> */
...
x86_l_448:
	...
	X86_SIM_L_EXEC_MOVX_REG(X86_OP_MOVZX_REG, X86_RAX, X86_RAX, X86_WIDTH_32, X86_WIDTH_8);
x86_l_44b:
	/* 0x44b: jmp    460 <generic_retuprobe_filter_arg+0x460> */
...
x86_l_452:
	...
	X86_SIM_L_EXEC_BT(X86_RSI, X86_RDX, X86_WIDTH_32);
x86_l_455:
	/* 0x455: jae    45d <generic_retuprobe_filter_arg+0x45d> */
...
x86_l_516:
	/* 0x516: jmp    5e3 <generic_retuprobe_filter_arg+0x5e3> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_51b:
	/* 0x51b: xor    r15d,r15d */
...
x86_l_526:
	/* 0x526: jne    578 <generic_retuprobe_filter_arg+0x578> */
...
x86_l_536:
	/* 0x536: jne    578 <generic_retuprobe_filter_arg+0x578> */
...
x86_l_546:
	/* 0x546: jne    578 <generic_retuprobe_filter_arg+0x578> */
...
x86_l_556:
	/* 0x556: jne    578 <generic_retuprobe_filter_arg+0x578> */
...
x86_l_566:
	/* 0x566: jne    578 <generic_retuprobe_filter_arg+0x578> */
...
x86_l_576:
	/* 0x576: je     59a <generic_retuprobe_filter_arg+0x59a> */
...
x86_l_5c2:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5c5:
	/* 0x5c5: je     506 <generic_retuprobe_filter_arg+0x506> */
...
x86_l_5dc:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_5de:
	/* 0x5de: jmp    506 <generic_retuprobe_filter_arg+0x506> */
