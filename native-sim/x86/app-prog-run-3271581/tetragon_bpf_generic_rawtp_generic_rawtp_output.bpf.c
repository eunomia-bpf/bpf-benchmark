...
x86_l_10:
	/* 0x10: mov    rdi,QWORD PTR [rip+0x79d0] */
...
x86_l_26:
	/* 0x26: je     d0 <generic_rawtp_output+0xd0> */
...
x86_l_4b:
	/* 0x4b: mov    rsi,QWORD PTR [rip+0x79d0] */
...
x86_l_81:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_84:
	/* 0x84: je     d0 <generic_rawtp_output+0xd0> */
...
x86_l_8b:
	/* 0x8b: jmp    d0 <generic_rawtp_output+0xd0> */
...
x86_l_98:
	/* 0x98: mov    rdi,QWORD PTR [rip+0x79d0] */
...
x86_l_126:
	...
	X86_SIM_L_EXEC_POP(X86_RBX, X86_WIDTH_64);
x86_l_127:
	/* 0x127: jmp    12c <generic_rawtp_output+0x12c> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_12c:
