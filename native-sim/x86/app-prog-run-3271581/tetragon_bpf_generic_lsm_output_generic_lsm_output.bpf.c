...
x86_l_2f:
	/* 0x2f: je     576 <generic_lsm_output+0x576> */
	X86_SIM_X86_JCC(X86_CC_E, 0x2f, 0x576, x86_l_576);
x86_l_35:
	/* 0x35: cmp    BYTE PTR [rax+0x5f08],0x0 */
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 104487964377088ULL);
x86_l_3c:
	/* 0x3c: je     528 <generic_lsm_output+0x528> */
	X86_SIM_X86_JCC(X86_CC_E, 0x3c, 0x528, x86_l_528);
x86_l_42:
	/* 0x42: mov    DWORD PTR [rsp+0x14],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 85899345920ULL);
x86_l_4a:
	/* 0x4a: mov    rdi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_51:
	/* 0x51: lea    rsi,[rsp+0x14] */
...
x86_l_5d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_60:
	/* 0x60: je     528 <generic_lsm_output+0x528> */
	X86_SIM_X86_JCC(X86_CC_E, 0x60, 0x528, x86_l_528);
x86_l_66:
	/* 0x66: mov    r14,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_R14, X86_RAX, X86_WIDTH_64);
x86_l_69:
	/* 0x69: cmp    QWORD PTR [rax+0x5ee8],0x0 */
...
x86_l_71:
	/* 0x71: je     36e <generic_lsm_output+0x36e> */
	X86_SIM_X86_JCC(X86_CC_E, 0x71, 0x36e, x86_l_36e);
x86_l_77:
	/* 0x77: mov    eax,0xe */
...
x86_l_8f:
	/* 0x8f: mov    DWORD PTR [rsp+0x28],r15d */
...
x86_l_a7:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_aa:
	/* 0xaa: je     36e <generic_lsm_output+0x36e> */
	X86_SIM_X86_JCC(X86_CC_E, 0xaa, 0x36e, x86_l_36e);
x86_l_b0:
	/* 0xb0: mov    r15,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_R15, X86_RAX, X86_WIDTH_64);
x86_l_b3:
	/* 0xb3: lea    rdx,[r12+0xd48] */
	X86_SIM_L_EXEC_LEA(X86_RDX, X86_R12, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 3400ULL);
x86_l_bb:
	/* 0xbb: lea    rdi,[rsp+0x70] */
...
x86_l_e9:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 4ULL);
x86_l_ee:
	/* 0xee: mov    rdx,QWORD PTR [rsp+0x70] */
...
x86_l_ff:
	/* 0xff: mov    rcx,QWORD PTR [rsp+0x30] */
...
x86_l_10c:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 4ULL);
x86_l_111:
	/* 0x111: add    rdx,QWORD PTR [rsp+0x30] */
...
x86_l_129:
	/* 0x129: mov    rcx,QWORD PTR [rsp+0x38] */
...
x86_l_136:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 4ULL);
x86_l_13b:
	/* 0x13b: add    rdx,QWORD PTR [rsp+0x38] */
...
x86_l_190:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_192:
	/* 0x192: mov    rcx,QWORD PTR [rsp] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RCX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_196:
	/* 0x196: test   rcx,rcx */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_199:
	/* 0x199: je     22c <generic_lsm_output+0x22c> */
	X86_SIM_X86_JCC(X86_CC_E, 0x199, 0x22c, x86_l_22c);
x86_l_19f:
	/* 0x19f: mov    DWORD PTR [rsp+0xc],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 51539607552ULL);
x86_l_1a7:
	/* 0x1a7: add    rcx,0x4 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RCX, X86_WIDTH_64, X86_ALU_ADD, 4ULL);
x86_l_1ab:
	/* 0x1ab: lea    rdi,[rsp+0xc] */
...
x86_l_1c2:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_1c4:
	/* 0x1c4: mov    rax,QWORD PTR [rsp] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RAX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_1c8:
	/* 0x1c8: movsxd rcx,DWORD PTR [rsp+0xc] */
...
x86_l_1e5:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 4ULL);
x86_l_1ea:
	/* 0x1ea: mov    rcx,QWORD PTR [rsp] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RCX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_1ee:
	/* 0x1ee: movsxd rdx,DWORD PTR [rsp+0xc] */
...
x86_l_246:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 4ULL);
x86_l_24b:
	/* 0x24b: mov    rdx,QWORD PTR [rsp+0x48] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 72ULL);
x86_l_250:
	/* 0x250: sub    rdx,0xffffffffffffff80 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RDX, X86_WIDTH_64, X86_ALU_SUB, 18446744073709551488ULL);
x86_l_254:
	/* 0x254: mov    esi,0x4 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RSI, X86_WIDTH_32, 4ULL);
...
x86_l_264:
	/* 0x264: mov    rcx,QWORD PTR [rsp+0x50] */
...
x86_l_271:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 4ULL);
x86_l_276:
	/* 0x276: add    rdx,QWORD PTR [rsp+0x50] */
...
x86_l_294:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 4ULL);
x86_l_299:
	/* 0x299: mov    rdx,QWORD PTR [rsp+0x58] */
...
x86_l_2bb:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 4ULL);
x86_l_2c0:
	/* 0x2c0: mov    rdx,QWORD PTR [rsp+0x60] */
...
x86_l_2e2:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 4ULL);
x86_l_2e7:
	/* 0x2e7: mov    rdx,QWORD PTR [rsp+0x68] */
...
x86_l_325:
	/* 0x325: mov    rcx,QWORD PTR [rsp+0x18] */
...
x86_l_335:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 4ULL);
x86_l_33a:
	/* 0x33a: add    rdx,QWORD PTR [rsp+0x18] */
...
x86_l_36c:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_36e:
	/* 0x36e: cmp    QWORD PTR [r14+0x5ef0],0x0 */
...
x86_l_376:
	/* 0x376: je     433 <generic_lsm_output+0x433> */
	X86_SIM_X86_JCC(X86_CC_E, 0x376, 0x433, x86_l_433);
x86_l_37c:
	/* 0x37c: mov    eax,0xe */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 14ULL);
x86_l_381:
...
x86_l_391:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_R12, X86_RAX, X86_WIDTH_64);
x86_l_394:
	/* 0x394: mov    DWORD PTR [rsp+0x28],r15d */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_R15, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 40ULL);
x86_l_399:
	/* 0x399: mov    rdi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&execve_map)));
x86_l_3a0:
	/* 0x3a0: lea    rsi,[rsp+0x28] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 40ULL);
x86_l_3a5:
	/* 0x3a5: mov    eax,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
...
x86_l_3ac:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3af:
	/* 0x3af: je     433 <generic_lsm_output+0x433> */
	X86_SIM_X86_JCC(X86_CC_E, 0x3af, 0x433, x86_l_433);
x86_l_3b5:
	/* 0x3b5: lea    r15,[rax+0x50] */
...
x86_l_438:
	/* 0x438: add    eax,DWORD PTR [r14+0x4] */
...
x86_l_46e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_471:
	/* 0x471: js     4a1 <generic_lsm_output+0x4a1> */
	X86_SIM_X86_JCC(X86_CC_S, 0x471, 0x4a1, x86_l_4a1);
x86_l_473:
	/* 0x473: mov    DWORD PTR [rsp+0x28],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_47b:
	/* 0x47b: mov    rdi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&policy_stats)));
x86_l_482:
	/* 0x482: lea    rsi,[rsp+0x28] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 40ULL);
x86_l_487:
	/* 0x487: mov    eax,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
...
x86_l_48e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_491:
	/* 0x491: je     528 <generic_lsm_output+0x528> */
	X86_SIM_X86_JCC(X86_CC_E, 0x491, 0x528, x86_l_528);
x86_l_497:
	/* 0x497: inc QWORD PTR [rax+0x8] */
...
x86_l_49c:
	/* 0x49c: jmp    528 <generic_lsm_output+0x528> */
	X86_SIM_X86_JMP(0x49c, 0x528, x86_l_528);
x86_l_4a1:
	/* 0x4a1: mov    rbx,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RBX, X86_RAX, X86_WIDTH_64);
x86_l_4a4:
	/* 0x4a4: mov    DWORD PTR [rsp+0x28],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_4ac:
	/* 0x4ac: mov    rdi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_stats_map)));
x86_l_4b3:
	/* 0x4b3: lea    rsi,[rsp+0x28] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 40ULL);
x86_l_4b8:
	/* 0x4b8: mov    eax,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
...
x86_l_4bf:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_4c2:
	/* 0x4c2: je     528 <generic_lsm_output+0x528> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4c2, 0x528, x86_l_528);
x86_l_4c4:
	/* 0x4c4: cmp    rbx,0xfffffffffffffff4 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551604ULL);
x86_l_4c8:
	/* 0x4c8: jg     4e4 <generic_lsm_output+0x4e4> */
	X86_SIM_X86_JCC(X86_CC_G, 0x4c8, 0x4e4, x86_l_4e4);
x86_l_4ca:
	/* 0x4ca: cmp    rbx,0xffffffffffffffe4 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551588ULL);
x86_l_4ce:
	/* 0x4ce: je     4fe <generic_lsm_output+0x4fe> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4ce, 0x4fe, x86_l_4fe);
x86_l_4d0:
	/* 0x4d0: cmp    rbx,0xffffffffffffffea */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551594ULL);
x86_l_4d4:
	/* 0x4d4: je     516 <generic_lsm_output+0x516> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4d4, 0x516, x86_l_516);
x86_l_4d6:
	/* 0x4d6: cmp    rbx,0xfffffffffffffff0 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551600ULL);
x86_l_4da:
	/* 0x4da: jne    50e <generic_lsm_output+0x50e> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x4da, 0x50e, x86_l_50e);
x86_l_4dc:
	/* 0x4dc: add    rax,0x398 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 920ULL);
x86_l_4e2:
	/* 0x4e2: jmp    524 <generic_lsm_output+0x524> */
	X86_SIM_X86_JMP(0x4e2, 0x524, x86_l_524);
x86_l_4e4:
	/* 0x4e4: cmp    rbx,0xfffffffffffffff5 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551605ULL);
x86_l_4e8:
	/* 0x4e8: je     506 <generic_lsm_output+0x506> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4e8, 0x506, x86_l_506);
x86_l_4ea:
	/* 0x4ea: cmp    rbx,0xfffffffffffffff9 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551609ULL);
x86_l_4ee:
	/* 0x4ee: je     51e <generic_lsm_output+0x51e> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4ee, 0x51e, x86_l_51e);
x86_l_4f0:
	/* 0x4f0: cmp    rbx,0xfffffffffffffffe */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551614ULL);
x86_l_4f4:
	/* 0x4f4: jne    50e <generic_lsm_output+0x50e> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x4f4, 0x50e, x86_l_50e);
x86_l_4f6:
	/* 0x4f6: add    rax,0x388 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 904ULL);
x86_l_4fc:
	/* 0x4fc: jmp    524 <generic_lsm_output+0x524> */
	X86_SIM_X86_JMP(0x4fc, 0x524, x86_l_524);
x86_l_4fe:
	/* 0x4fe: add    rax,0x3a8 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 936ULL);
x86_l_504:
	/* 0x504: jmp    524 <generic_lsm_output+0x524> */
	X86_SIM_X86_JMP(0x504, 0x524, x86_l_524);
x86_l_506:
	/* 0x506: add    rax,0x3b0 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 944ULL);
x86_l_50c:
	/* 0x50c: jmp    524 <generic_lsm_output+0x524> */
	X86_SIM_X86_JMP(0x50c, 0x524, x86_l_524);
x86_l_50e:
	/* 0x50e: add    rax,0x380 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 896ULL);
x86_l_514:
	/* 0x514: jmp    524 <generic_lsm_output+0x524> */
	X86_SIM_X86_JMP(0x514, 0x524, x86_l_524);
x86_l_516:
	/* 0x516: add    rax,0x3a0 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 928ULL);
x86_l_51c:
	/* 0x51c: jmp    524 <generic_lsm_output+0x524> */
	X86_SIM_X86_JMP(0x51c, 0x524, x86_l_524);
x86_l_51e:
	/* 0x51e: add    rax,0x390 */
...
x86_l_52d:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_52f:
	/* 0x52f: mov    QWORD PTR [rsp+0x28],rax */
...
x86_l_547:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_54a:
	/* 0x54a: je     576 <generic_lsm_output+0x576> */
	X86_SIM_X86_JCC(X86_CC_E, 0x54a, 0x576, x86_l_576);
x86_l_54c:
	/* 0x54c: mov    rbx,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RBX, X86_RAX, X86_WIDTH_64);
x86_l_54f:
...
x86_l_586:
	/* 0x586: jmp    58b <generic_lsm_output+0x58b> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_58b:
