...
x86_l_3d:
	/* 0x3d: je     b29 <generic_retuprobe_actions+0xb29> */
...
x86_l_4f:
	/* 0x4f: jl     b29 <generic_retuprobe_actions+0xb29> */
...
x86_l_6a:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_6d:
	/* 0x6d: je     b29 <generic_retuprobe_actions+0xb29> */
...
x86_l_142:
	/* 0x142: je     b02 <generic_retuprobe_actions+0xb02> */
...
x86_l_153:
	/* 0x153: jae    b02 <generic_retuprobe_actions+0xb02> */
...
x86_l_7d8:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_7db:
	/* 0x7db: je     aa9 <generic_retuprobe_actions+0xaa9> */
	X86_SIM_X86_JCC(X86_CC_E, 0x7db, 0xaa9, x86_l_aa9);
x86_l_7e1:
	/* 0x7e1: inc    DWORD PTR [rax] */
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_32, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_7e3:
	/* 0x7e3: jmp    acf <generic_retuprobe_actions+0xacf> */
...
x86_l_a58:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_RAX, 2), 17179869184ULL);
x86_l_a5e:
	/* 0xa5e: je     a90 <generic_retuprobe_actions+0xa90> */
...
x86_l_a9a:
	/* 0xa9a: je     12e <generic_retuprobe_actions+0x12e> */
...
x86_l_aa4:
	/* 0xaa4: jmp    12e <generic_retuprobe_actions+0x12e> */
...
x86_l_ad4:
	/* 0xad4: je     550 <generic_retuprobe_actions+0x550> */
...
x86_l_aed:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_af0:
	/* 0xaf0: je     550 <generic_retuprobe_actions+0x550> */
...
x86_l_afd:
	/* 0xafd: jmp    550 <generic_retuprobe_actions+0x550> */
...
x86_l_b07:
	/* 0xb07: je     b29 <generic_retuprobe_actions+0xb29> */
...
x86_l_b3c:
	/* 0xb3c: jmp    b41 <generic_retuprobe_actions+0xb41> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_b41:
