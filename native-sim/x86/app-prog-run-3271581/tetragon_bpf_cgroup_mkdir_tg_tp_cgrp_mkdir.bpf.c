...
x86_l_302:
	/* 0x302: jmp    54c <tg_tp_cgrp_mkdir+0x54c> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_307:
...
x86_l_488:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_48a:
	/* 0x48a: mov    rsi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&tcpmon_map)));
x86_l_491:
	/* 0x491: mov    ecx,0xffffffff */
	X86_SIM_L_EXEC_MOV_IMM(X86_RCX, X86_WIDTH_32, 4294967295ULL);
x86_l_496:
	/* 0x496: mov    edx,0x10d8 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RDX, X86_WIDTH_32, 4312ULL);
x86_l_49b:
	/* 0x49b: mov    eax,0x19 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 25ULL);
x86_l_4a0:
	/* 0x4a0: mov    edx,0xffffffff */
	X86_SIM_L_EXEC_MOV_IMM(X86_RDX, X86_WIDTH_32, 4294967295ULL);
x86_l_4a5:
	/* 0x4a5: mov    r8d,0x10d8 */
...
x86_l_4b3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_4b6:
	/* 0x4b6: jns    2f2 <tg_tp_cgrp_mkdir+0x2f2> */
	X86_SIM_X86_JCC(X86_CC_NS, 0x4b6, 0x2f2, x86_l_2f2);
x86_l_4bc:
	/* 0x4bc: mov    rbx,rax */
...
x86_l_4da:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_4dd:
	/* 0x4dd: je     2f2 <tg_tp_cgrp_mkdir+0x2f2> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4dd, 0x2f2, x86_l_2f2);
x86_l_4e3:
	/* 0x4e3: cmp    rbx,0xfffffffffffffff4 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551604ULL);
x86_l_4e7:
	/* 0x4e7: jg     503 <tg_tp_cgrp_mkdir+0x503> */
	X86_SIM_X86_JCC(X86_CC_G, 0x4e7, 0x503, x86_l_503);
x86_l_4e9:
	/* 0x4e9: cmp    rbx,0xffffffffffffffe4 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551588ULL);
x86_l_4ed:
	/* 0x4ed: je     51d <tg_tp_cgrp_mkdir+0x51d> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4ed, 0x51d, x86_l_51d);
x86_l_4ef:
	/* 0x4ef: cmp    rbx,0xffffffffffffffea */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551594ULL);
x86_l_4f3:
	/* 0x4f3: je     535 <tg_tp_cgrp_mkdir+0x535> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4f3, 0x535, x86_l_535);
x86_l_4f5:
	/* 0x4f5: cmp    rbx,0xfffffffffffffff0 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551600ULL);
x86_l_4f9:
	/* 0x4f9: jne    52d <tg_tp_cgrp_mkdir+0x52d> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x4f9, 0x52d, x86_l_52d);
x86_l_4fb:
	/* 0x4fb: add    rax,0x590 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 1424ULL);
x86_l_501:
	/* 0x501: jmp    543 <tg_tp_cgrp_mkdir+0x543> */
	X86_SIM_X86_JMP(0x501, 0x543, x86_l_543);
x86_l_503:
	/* 0x503: cmp    rbx,0xfffffffffffffff5 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551605ULL);
x86_l_507:
	/* 0x507: je     525 <tg_tp_cgrp_mkdir+0x525> */
	X86_SIM_X86_JCC(X86_CC_E, 0x507, 0x525, x86_l_525);
x86_l_509:
	/* 0x509: cmp    rbx,0xfffffffffffffff9 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551609ULL);
x86_l_50d:
	/* 0x50d: je     53d <tg_tp_cgrp_mkdir+0x53d> */
	X86_SIM_X86_JCC(X86_CC_E, 0x50d, 0x53d, x86_l_53d);
x86_l_50f:
	/* 0x50f: cmp    rbx,0xfffffffffffffffe */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551614ULL);
x86_l_513:
	/* 0x513: jne    52d <tg_tp_cgrp_mkdir+0x52d> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x513, 0x52d, x86_l_52d);
x86_l_515:
	/* 0x515: add    rax,0x580 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 1408ULL);
x86_l_51b:
	/* 0x51b: jmp    543 <tg_tp_cgrp_mkdir+0x543> */
	X86_SIM_X86_JMP(0x51b, 0x543, x86_l_543);
x86_l_51d:
	/* 0x51d: add    rax,0x5a0 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 1440ULL);
x86_l_523:
	/* 0x523: jmp    543 <tg_tp_cgrp_mkdir+0x543> */
	X86_SIM_X86_JMP(0x523, 0x543, x86_l_543);
x86_l_525:
	/* 0x525: add    rax,0x5a8 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 1448ULL);
x86_l_52b:
	/* 0x52b: jmp    543 <tg_tp_cgrp_mkdir+0x543> */
	X86_SIM_X86_JMP(0x52b, 0x543, x86_l_543);
x86_l_52d:
	/* 0x52d: add    rax,0x578 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 1400ULL);
x86_l_533:
	/* 0x533: jmp    543 <tg_tp_cgrp_mkdir+0x543> */
	X86_SIM_X86_JMP(0x533, 0x543, x86_l_543);
x86_l_535:
	/* 0x535: add    rax,0x598 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 1432ULL);
x86_l_53b:
	/* 0x53b: jmp    543 <tg_tp_cgrp_mkdir+0x543> */
	X86_SIM_X86_JMP(0x53b, 0x543, x86_l_543);
x86_l_53d:
	/* 0x53d: add    rax,0x588 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 1416ULL);
x86_l_543:
	/* 0x543: inc QWORD PTR [rax] */
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_547:
	/* 0x547: jmp    2f2 <tg_tp_cgrp_mkdir+0x2f2> */
	X86_SIM_X86_JMP(0x547, 0x2f2, x86_l_2f2);
x86_l_54c:
