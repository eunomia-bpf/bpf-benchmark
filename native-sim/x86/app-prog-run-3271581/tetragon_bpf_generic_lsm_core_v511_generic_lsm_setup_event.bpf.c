...
SEC("xdp")
int tetragon_bpf_generic_lsm_core_v511_generic_lsm_setup_event_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_28:
	/* 0x28: je     1be <generic_lsm_setup_event+0x1be> */
	X86_SIM_X86_JCC(X86_CC_E, 0x28, 0x1be, x86_l_1be);
x86_l_2e:
	/* 0x2e: mov    r14,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_R14, X86_RAX, X86_WIDTH_64);
x86_l_31:
	/* 0x31: lea    rsi,[rax+0x5ef8] */
...
x86_l_46:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_49:
	/* 0x49: je     1be <generic_lsm_setup_event+0x1be> */
	X86_SIM_X86_JCC(X86_CC_E, 0x49, 0x1be, x86_l_1be);
x86_l_4f:
...
x86_l_fe:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_100:
	/* 0x100: mov    rax,QWORD PTR [rsp+0x8] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RAX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_105:
	/* 0x105: mov    QWORD PTR [r14+0x5e70],rax */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_R14, X86_RAX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 24176ULL);
x86_l_10c:
	/* 0x10c: mov    BYTE PTR [r14],0x10 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 16ULL);
x86_l_110:
	/* 0x110: mov    WORD PTR [r14+0x2],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_16, X86_MEM_AUX(X86_REG_NONE, 0), 8589934592ULL);
x86_l_117:
	/* 0x117: mov    DWORD PTR [r14+0x4],0x0 */
...
x86_l_160:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_163:
	/* 0x163: je     188 <generic_lsm_setup_event+0x188> */
	X86_SIM_X86_JCC(X86_CC_E, 0x163, 0x188, x86_l_188);
x86_l_165:
	/* 0x165: mov    rsi,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RAX, X86_WIDTH_64);
x86_l_168:
	/* 0x168: add    rsi,0x5ef8 */
...
x86_l_17d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_180:
	/* 0x180: je     188 <generic_lsm_setup_event+0x188> */
	X86_SIM_X86_JCC(X86_CC_E, 0x180, 0x188, x86_l_188);
x86_l_182:
	/* 0x182: cmp    DWORD PTR [rax+0x40],0xffffffff */
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 279172874239ULL);
x86_l_186:
	/* 0x186: jne    1a3 <generic_lsm_setup_event+0x1a3> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x186, 0x1a3, x86_l_1a3);
x86_l_188:
	/* 0x188: mov    rsi,QWORD PTR [rip+0x0] */
...
x86_l_1a1:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_1a3:
	/* 0x1a3: mov    rsi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&lsm_calls)));
x86_l_1aa:
	/* 0x1aa: mov    ecx,0x1 */
...
x86_l_1c7:
	/* 0x1c7: jmp    1cc <generic_lsm_setup_event+0x1cc> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_1cc:
