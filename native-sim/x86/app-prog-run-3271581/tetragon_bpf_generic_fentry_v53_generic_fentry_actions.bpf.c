...
x86_l_24:
	/* 0x24: mov    rdi,QWORD PTR [rip+0x21870] */
...
x86_l_3d:
	/* 0x3d: je     b19 <generic_fentry_actions+0xb19> */
...
x86_l_6a:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_6d:
	/* 0x6d: je     b19 <generic_fentry_actions+0xb19> */
...
x86_l_8c:
	/* 0x8c: mov    rdi,QWORD PTR [rip+0x21870] */
...
x86_l_114:
	/* 0x114: mov    rbp,QWORD PTR [rip+0x21870] */
...
x86_l_142:
	/* 0x142: je     af2 <generic_fentry_actions+0xaf2> */
...
x86_l_153:
	/* 0x153: jae    af2 <generic_fentry_actions+0xaf2> */
...
x86_l_2a2:
	/* 0x2a2: mov    rdi,QWORD PTR [rip+0x2187a] */
...
x86_l_30e:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 24ULL);
x86_l_313:
	/* 0x313: mov    rdi,QWORD PTR [rip+0x2187a] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_31a:
	/* 0x31a: mov    rdx,rbx */
...
x86_l_3bc:
	/* 0x3bc: mov    rdi,QWORD PTR [rip+0x2187a] */
...
x86_l_3f1:
	/* 0x3f1: mov    rbp,QWORD PTR [rip+0x2187a] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RBP, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_3f8:
	/* 0x3f8: test   ecx,ecx */
...
x86_l_474:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 24ULL);
x86_l_479:
	/* 0x479: mov    rdi,QWORD PTR [rip+0x2187a] */
...
x86_l_4bb:
	/* 0x4bb: mov    rdi,QWORD PTR [rip+0x2187a] */
...
x86_l_507:
	/* 0x507: mov    rdi,QWORD PTR [rip+0x2187a] */
...
x86_l_52b:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 40ULL);
x86_l_530:
	/* 0x530: mov    rbx,QWORD PTR [rip+0x2187a] */
...
x86_l_555:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 80ULL);
x86_l_55a:
	/* 0x55a: mov    rdi,QWORD PTR [rip+0x2187a] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_data)));
x86_l_561:
	/* 0x561: call   rax */
	X86_SIM_BPF_CALL_REG(X86_RAX);
...
x86_l_5ad:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_5b2:
	/* 0x5b2: mov    rdi,QWORD PTR [rip+0x2187a] */
...
x86_l_5d6:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 80ULL);
x86_l_5db:
	/* 0x5db: mov    rdi,QWORD PTR [rip+0x2187a] */
...
x86_l_67b:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 24ULL);
x86_l_680:
	/* 0x680: mov    rdi,QWORD PTR [rip+0x2187a] */
...
x86_l_700:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RDX, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_RAX, 2), 104041287778304ULL);
x86_l_708:
	/* 0x708: mov    rbp,QWORD PTR [rip+0x2187a] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RBP, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_70f:
...
x86_l_755:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 24ULL);
x86_l_75a:
	/* 0x75a: mov    rdi,QWORD PTR [rip+0x2187a] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_761:
...
x86_l_7c7:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 24ULL);
x86_l_7cc:
	/* 0x7cc: mov    rbx,QWORD PTR [rip+0x2187a] */
...
x86_l_7d8:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_7db:
	/* 0x7db: je     a99 <generic_fentry_actions+0xa99> */
	X86_SIM_X86_JCC(X86_CC_E, 0x7db, 0xa99, x86_l_a99);
x86_l_7e1:
	/* 0x7e1: inc    DWORD PTR [rax] */
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_32, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_7e3:
	/* 0x7e3: jmp    abf <generic_fentry_actions+0xabf> */
...
x86_l_7ed:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 24ULL);
x86_l_7f2:
	/* 0x7f2: mov    rdi,QWORD PTR [rip+0x2187a] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_7f9:
	/* 0x7f9: call   rax */
	X86_SIM_BPF_CALL_REG(X86_RAX);
...
x86_l_7fe:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_R14, X86_RBP, X86_WIDTH_64);
x86_l_801:
	/* 0x801: mov    rbp,QWORD PTR [rip+0x2187a] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RBP, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_808:
...
x86_l_81f:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 40ULL);
x86_l_824:
	/* 0x824: mov    rdi,QWORD PTR [rip+0x2187a] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&socktrack_map)));
x86_l_82b:
	/* 0x82b: call   rax */
	X86_SIM_BPF_CALL_REG(X86_RAX);
...
x86_l_8bc:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_8c1:
	/* 0x8c1: mov    rdi,QWORD PTR [rip+0x2187f] */
...
x86_l_922:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_927:
	/* 0x927: mov    rdi,QWORD PTR [rip+0x2187f] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&config_map)));
x86_l_92e:
	/* 0x92e: call   rax */
	X86_SIM_BPF_CALL_REG(X86_RAX);
...
x86_l_9ab:
	/* 0x9ab: mov    rbp,QWORD PTR [rip+0x2187f] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RBP, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_9b2:
...
x86_l_9bc:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_9c1:
	/* 0x9c1: mov    rdi,QWORD PTR [rip+0x2187f] */
...
x86_l_a04:
	...
	X86_SIM_L_EXEC_ALU_REG(X86_RCX, X86_RCX, X86_WIDTH_32, X86_ALU_XOR);
x86_l_a06:
	/* 0xa06: mov    rdi,QWORD PTR [rip+0x2187f] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&ratelimit_map)));
x86_l_a0d:
...
x86_l_a3b:
	...
	X86_SIM_L_EXEC_ALU_REG(X86_RCX, X86_RCX, X86_WIDTH_32, X86_ALU_XOR);
x86_l_a3d:
	/* 0xa3d: mov    rsi,QWORD PTR [rip+0x2187f] */
...
x86_l_a5e:
	/* 0xa5e: je     12e <generic_fentry_actions+0x12e> */
...
x86_l_a6d:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 128ULL);
x86_l_a75:
	/* 0xa75: mov    rsi,QWORD PTR [rip+0x2187f] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&stack_trace_map)));
x86_l_a7c:
	/* 0xa7c: mov    ecx,0x100 */
...
x86_l_a94:
	/* 0xa94: jmp    12e <generic_fentry_actions+0x12e> */
...
x86_l_ac4:
	/* 0xac4: je     550 <generic_fentry_actions+0x550> */
...
x86_l_acf:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 40ULL);
x86_l_ad4:
	/* 0xad4: mov    rdi,QWORD PTR [rip+0x2187f] */
...
x86_l_add:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_ae0:
	/* 0xae0: je     550 <generic_fentry_actions+0x550> */
...
x86_l_aed:
	/* 0xaed: jmp    550 <generic_fentry_actions+0x550> */
...
x86_l_af7:
	/* 0xaf7: je     b19 <generic_fentry_actions+0xb19> */
	X86_SIM_X86_JCC(X86_CC_E, 0xaf7, 0xb19, x86_l_b19);
x86_l_af9:
	/* 0xaf9: mov    rsi,QWORD PTR [rip+0x2187f] */
...
x86_l_b2c:
	/* 0xb2c: jmp    b31 <generic_fentry_actions+0xb31> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_b31:
