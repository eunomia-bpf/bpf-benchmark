...
x86_l_3d:
	/* 0x3d: je     b29 <generic_fexit_actions+0xb29> */
...
x86_l_4f:
	/* 0x4f: jl     b29 <generic_fexit_actions+0xb29> */
...
x86_l_6a:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_6d:
	/* 0x6d: je     b29 <generic_fexit_actions+0xb29> */
...
x86_l_a8:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_ab:
	/* 0xab: je     d2 <generic_fexit_actions+0xd2> */
...
x86_l_b5:
	/* 0xb5: je     ed <generic_fexit_actions+0xed> */
...
x86_l_d0:
	/* 0xd0: jmp    106 <generic_fexit_actions+0x106> */
...
x86_l_eb:
	/* 0xeb: jmp    101 <generic_fexit_actions+0x101> */
...
x86_l_121:
	/* 0x121: jmp    148 <generic_fexit_actions+0x148> */
...
x86_l_142:
	/* 0x142: je     b02 <generic_fexit_actions+0xb02> */
...
x86_l_153:
	/* 0x153: jae    b02 <generic_fexit_actions+0xb02> */
...
x86_l_180:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_183:
	/* 0x183: je     138 <generic_fexit_actions+0x138> */
...
x86_l_201:
	/* 0x201: jne    649 <generic_fexit_actions+0x649> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x201, 0x649, x86_l_649);
x86_l_207:
	/* 0x207: jmp    66e <generic_fexit_actions+0x66e> */
...
x86_l_257:
	/* 0x257: ja     12e <generic_fexit_actions+0x12e> */
...
x86_l_265:
	/* 0x265: jne    12e <generic_fexit_actions+0x12e> */
...
x86_l_2b0:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_2b3:
	/* 0x2b3: je     12e <generic_fexit_actions+0x12e> */
...
x86_l_2bf:
	/* 0x2bf: ja     12e <generic_fexit_actions+0x12e> */
...
x86_l_2cd:
	/* 0x2cd: jne    12e <generic_fexit_actions+0x12e> */
...
x86_l_358:
	/* 0x358: jmp    66e <generic_fexit_actions+0x66e> */
...
x86_l_366:
	/* 0x366: je     632 <generic_fexit_actions+0x632> */
	X86_SIM_X86_JCC(X86_CC_E, 0x366, 0x632, x86_l_632);
x86_l_36c:
	/* 0x36c: cmp    r13d,0x3 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R13, X86_WIDTH_32, 3ULL);
x86_l_370:
	/* 0x370: jne    12e <generic_fexit_actions+0x12e> */
...
x86_l_3c7:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3ca:
	/* 0x3ca: je     7fe <generic_fexit_actions+0x7fe> */
...
x86_l_3d8:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_3dd:
	/* 0x3dd: ja     3ee <generic_fexit_actions+0x3ee> */
...
x86_l_3e8:
	/* 0x3e8: je     6a3 <generic_fexit_actions+0x6a3> */
...
x86_l_3fa:
	/* 0x3fa: jne    138 <generic_fexit_actions+0x138> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x3fa, 0x138, x86_l_138);
x86_l_400:
	/* 0x400: jmp    12e <generic_fexit_actions+0x12e> */
...
x86_l_443:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_446:
	/* 0x446: je     80d <generic_fexit_actions+0x80d> */
...
x86_l_455:
	/* 0x455: jne    81a <generic_fexit_actions+0x81a> */
...
x86_l_487:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_48c:
	/* 0x48c: je     80d <generic_fexit_actions+0x80d> */
...
x86_l_4c2:
	/* 0x4c2: jmp    766 <generic_fexit_actions+0x766> */
...
x86_l_4cf:
	/* 0x4cf: jmp    12e <generic_fexit_actions+0x12e> */
...
x86_l_4e7:
	/* 0x4e7: jmp    66e <generic_fexit_actions+0x66e> */
...
x86_l_510:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_513:
	/* 0x513: je     563 <generic_fexit_actions+0x563> */
...
x86_l_544:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_547:
	/* 0x547: je     77e <generic_fexit_actions+0x77e> */
...
x86_l_563:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_568:
	/* 0x568: jmp    12e <generic_fexit_actions+0x12e> */
...
x86_l_5a7:
	/* 0x5a7: je     a19 <generic_fexit_actions+0xa19> */
...
x86_l_5c0:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5c3:
	/* 0x5c3: je     a19 <generic_fexit_actions+0xa19> */
...
x86_l_62d:
	/* 0x62d: jmp    845 <generic_fexit_actions+0x845> */
...
x86_l_642:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 98784247808ULL);
x86_l_647:
	/* 0x647: je     66e <generic_fexit_actions+0x66e> */
...
x86_l_658:
	/* 0x658: jmp    66e <generic_fexit_actions+0x66e> */
...
x86_l_689:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_68c:
	/* 0x68c: je     693 <generic_fexit_actions+0x693> */
...
x86_l_69e:
	/* 0x69e: jmp    12e <generic_fexit_actions+0x12e> */
...
x86_l_6d8:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R13, X86_WIDTH_32, 1ULL);
x86_l_6dc:
	/* 0x6dc: jne    7e8 <generic_fexit_actions+0x7e8> */
...
x86_l_6f5:
	/* 0x6f5: ja     801 <generic_fexit_actions+0x801> */
...
x86_l_708:
	...
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RBP, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_70f:
	/* 0x70f: jne    80d <generic_fexit_actions+0x80d> */
...
x86_l_771:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_32);
x86_l_773:
	/* 0x773: jne    138 <generic_fexit_actions+0x138> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x773, 0x138, x86_l_138);
x86_l_779:
	/* 0x779: jmp    12e <generic_fexit_actions+0x12e> */
...
x86_l_797:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_79a:
	/* 0x79a: je     550 <generic_fexit_actions+0x550> */
...
x86_l_7d8:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_7db:
	/* 0x7db: je     aa9 <generic_fexit_actions+0xaa9> */
	X86_SIM_X86_JCC(X86_CC_E, 0x7db, 0xaa9, x86_l_aa9);
x86_l_7e1:
	/* 0x7e1: inc    DWORD PTR [rax] */
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_32, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_7e3:
	/* 0x7e3: jmp    acf <generic_fexit_actions+0xacf> */
...
x86_l_80d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_32);
x86_l_80f:
	/* 0x80f: jne    138 <generic_fexit_actions+0x138> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x80f, 0x138, x86_l_138);
x86_l_815:
	/* 0x815: jmp    12e <generic_fexit_actions+0x12e> */
...
x86_l_835:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_32);
x86_l_837:
	/* 0x837: jne    138 <generic_fexit_actions+0x138> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x837, 0x138, x86_l_138);
x86_l_83d:
	/* 0x83d: jmp    12e <generic_fexit_actions+0x12e> */
...
x86_l_87f:
	/* 0x87f: jmp    894 <generic_fexit_actions+0x894> */
...
x86_l_88e:
	/* 0x88e: je     9bc <generic_fexit_actions+0x9bc> */
...
x86_l_8a9:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_8ac:
	/* 0x8ac: je     9bc <generic_fexit_actions+0x9bc> */
...
x86_l_8ca:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_8cd:
	/* 0x8cd: je     9bc <generic_fexit_actions+0x9bc> */
...
x86_l_8d9:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_8de:
	/* 0x8de: je     9bc <generic_fexit_actions+0x9bc> */
...
x86_l_913:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_916:
	/* 0x916: je     956 <generic_fexit_actions+0x956> */
...
x86_l_930:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_933:
	/* 0x933: je     956 <generic_fexit_actions+0x956> */
...
x86_l_940:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RAX, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_R14, 1), 24184ULL);
x86_l_948:
	/* 0x948: je     963 <generic_fexit_actions+0x963> */
...
x86_l_954:
	/* 0x954: jmp    96b <generic_fexit_actions+0x96b> */
...
x86_l_96d:
	/* 0x96d: jle    881 <generic_fexit_actions+0x881> */
...
x86_l_9b7:
	/* 0x9b7: jmp    881 <generic_fexit_actions+0x881> */
...
x86_l_9dd:
	/* 0x9dd: je     9ff <generic_fexit_actions+0x9ff> */
...
x86_l_9f3:
	/* 0x9f3: jbe    9ff <generic_fexit_actions+0x9ff> */
	X86_SIM_X86_JCC(X86_CC_BE, 0x9f3, 0x9ff, x86_l_9ff);
x86_l_9f5:
	/* 0x9f5: mov    DWORD PTR [rsp+0x44],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 292057776128ULL);
x86_l_9fd:
	/* 0x9fd: jmp    a19 <generic_fexit_actions+0xa19> */
...
x86_l_a23:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_a28:
	/* 0xa28: je     a54 <generic_fexit_actions+0xa54> */
...
x86_l_a58:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_RAX, 2), 17179869184ULL);
x86_l_a5e:
	/* 0xa5e: je     a90 <generic_fexit_actions+0xa90> */
...
x86_l_a9a:
	/* 0xa9a: je     12e <generic_fexit_actions+0x12e> */
...
x86_l_aa4:
	/* 0xaa4: jmp    12e <generic_fexit_actions+0x12e> */
...
x86_l_ad4:
	/* 0xad4: je     550 <generic_fexit_actions+0x550> */
...
x86_l_aed:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_af0:
	/* 0xaf0: je     550 <generic_fexit_actions+0x550> */
...
x86_l_afd:
	/* 0xafd: jmp    550 <generic_fexit_actions+0x550> */
...
x86_l_b07:
	/* 0xb07: je     b29 <generic_fexit_actions+0xb29> */
...
x86_l_b3c:
	/* 0xb3c: jmp    b41 <generic_fexit_actions+0xb41> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_b41:
