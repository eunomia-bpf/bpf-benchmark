...
x86_l_c1:
	/* 0xc1: mov    rdi,QWORD PTR [rip+0x2320] */
...
x86_l_ea:
	/* 0xea: mov    rdi,QWORD PTR [rip+0x2320] */
...
x86_l_206:
	/* 0x206: mov    rdi,QWORD PTR [rip+0x2280] */
...
x86_l_227:
	/* 0x227: mov    rdi,QWORD PTR [rip+0x2280] */
...
x86_l_3af:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RBP, X86_RDX, X86_WIDTH_32);
x86_l_3b1:
	/* 0x3b1: mov    rdi,QWORD PTR [rip+0x1ef0] */
...
x86_l_3ca:
	/* 0x3ca: mov    rdi,QWORD PTR [rip+0x1ef0] */
...
x86_l_4b7:
	/* 0x4b7: mov    rdi,QWORD PTR [rip+0x1ef0] */
...
x86_l_4f1:
	/* 0x4f1: mov    rdi,QWORD PTR [rip+0x1ef0] */
...
x86_l_525:
	/* 0x525: mov    rdi,QWORD PTR [rip+0x1eec] */
...
x86_l_54a:
	/* 0x54a: mov    rdi,QWORD PTR [rip+0x1eec] */
...
x86_l_560:
	/* 0x560: mov    rdi,QWORD PTR [rip+0x1eec] */
...
x86_l_573:
	/* 0x573: mov    rdi,QWORD PTR [rip+0x1eec] */
...
x86_l_586:
	/* 0x586: mov    rdi,QWORD PTR [rip+0x1eec] */
...
x86_l_599:
	/* 0x599: mov    rdi,QWORD PTR [rip+0x1eec] */
...
x86_l_5ac:
	/* 0x5ac: mov    rdi,QWORD PTR [rip+0x1eec] */
...
x86_l_5bf:
	/* 0x5bf: mov    rdi,QWORD PTR [rip+0x1eec] */
...
x86_l_5d2:
	/* 0x5d2: mov    rdi,QWORD PTR [rip+0x1eec] */
...
x86_l_652:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_657:
	/* 0x657: mov    rdi,QWORD PTR [rip+0x2523] */
...
x86_l_714:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_719:
	/* 0x719: mov    rdi,QWORD PTR [rip+0x2531] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&substring_map)));
x86_l_720:
	/* 0x720: mov    rsi,r13 */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_R13, X86_WIDTH_64);
...
x86_l_79b:
	/* 0x79b: mov    r15,QWORD PTR [rip+0x2543] */
...
x86_l_7d9:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RBX, X86_WIDTH_32, 16ULL);
x86_l_7de:
	/* 0x7de: mov    r15,QWORD PTR [rip+0x2545] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_R15, (void *)(long)(((__u64)(long)&substring_map)));
x86_l_7e5:
