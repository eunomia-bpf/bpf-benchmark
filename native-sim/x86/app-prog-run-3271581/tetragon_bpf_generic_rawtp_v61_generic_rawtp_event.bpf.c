...
x86_l_32:
	/* 0x32: je     619 <generic_rawtp_event+0x619> */
...
x86_l_5a:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5d:
	/* 0x5d: je     619 <generic_rawtp_event+0x619> */
...
x86_l_88:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_8b:
	/* 0x8b: je     619 <generic_rawtp_event+0x619> */
...
x86_l_d3:
	/* 0xd3: jmp    619 <generic_rawtp_event+0x619> */
...
x86_l_150:
	/* 0x150: je     619 <generic_rawtp_event+0x619> */
...
x86_l_179:
	/* 0x179: je     619 <generic_rawtp_event+0x619> */
...
x86_l_1e1:
	/* 0x1e1: jmp    619 <generic_rawtp_event+0x619> */
...
x86_l_1ed:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1f0:
	/* 0x1f0: je     619 <generic_rawtp_event+0x619> */
...
x86_l_235:
	/* 0x235: je     631 <generic_rawtp_event+0x631> */
...
x86_l_383:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_386:
	/* 0x386: je     41c <generic_rawtp_event+0x41c> */
...
x86_l_418:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_41a:
	/* 0x41a: jmp    424 <generic_rawtp_event+0x424> */
...
x86_l_62c:
	/* 0x62c: jmp    68a <generic_rawtp_event+0x68a> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_631:
...
x86_l_649:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_64c:
	/* 0x64c: je     619 <generic_rawtp_event+0x619> */
...
x86_l_669:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_66c:
	/* 0x66c: je     619 <generic_rawtp_event+0x619> */
...
x86_l_680:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R12, X86_WIDTH_64);
x86_l_683:
	/* 0x683: jne    619 <generic_rawtp_event+0x619> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x683, 0x619, x86_l_619);
x86_l_685:
	/* 0x685: jmp    23b <generic_rawtp_event+0x23b> */
