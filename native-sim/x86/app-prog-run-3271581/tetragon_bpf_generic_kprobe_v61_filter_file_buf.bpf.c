...
x86_l_291:
	/* 0x291: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_2aa:
	/* 0x2aa: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_397:
	/* 0x397: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_3d1:
	/* 0x3d1: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_405:
	/* 0x405: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_42a:
	/* 0x42a: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_440:
	/* 0x440: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_453:
	/* 0x453: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_466:
	/* 0x466: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_479:
	/* 0x479: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_48c:
	/* 0x48c: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_49f:
	/* 0x49f: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_4b2:
	/* 0x4b2: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_516:
	/* 0x516: mov    rdi,QWORD PTR [rip+0x2440] */
...
x86_l_53f:
	/* 0x53f: mov    rdi,QWORD PTR [rip+0x2440] */
...
x86_l_65b:
	/* 0x65b: mov    rdi,QWORD PTR [rip+0x23a0] */
...
x86_l_67c:
	/* 0x67c: mov    rdi,QWORD PTR [rip+0x23a0] */
