...
SEC("xdp")
int tetragon_bpf_generic_retuprobe_v61_filter_char_buf_postfix_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_34:
	/* 0x34: je     13e <filter_char_buf_postfix+0x13e> */
	X86_SIM_X86_JCC(X86_CC_E, 0x34, 0x13e, x86_l_13e);
x86_l_3a:
	/* 0x3a: test   r15,r15 */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_R15, X86_R15, X86_WIDTH_64);
x86_l_3d:
	/* 0x3d: je     13e <filter_char_buf_postfix+0x13e> */
	X86_SIM_X86_JCC(X86_CC_E, 0x3d, 0x13e, x86_l_13e);
x86_l_43:
	/* 0x43: mov    rdi,QWORD PTR [rip+0x1e90] */
...
x86_l_59:
	/* 0x59: je     13c <filter_char_buf_postfix+0x13c> */
	X86_SIM_X86_JCC(X86_CC_E, 0x59, 0x13c, x86_l_13c);
x86_l_5f:
	/* 0x5f: mov    rsi,rax */
...
x86_l_d6:
	...
	X86_SIM_L_EXEC_ALU_IMM(X86_R10, X86_WIDTH_32, X86_ALU_AND, 4095ULL);
x86_l_dd:
	/* 0xdd: movzx  r10d,BYTE PTR [r14+r10*1] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R10, X86_R14, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_R10, 0, X86_WIDTH_8), 0ULL);
x86_l_e2:
	/* 0xe2: mov    BYTE PTR [rdx-0x1],r10b */
...
x86_l_ec:
	/* 0xec: je     125 <filter_char_buf_postfix+0x125> */
	X86_SIM_X86_JCC(X86_CC_E, 0xec, 0x125, x86_l_125);
x86_l_ee:
	/* 0xee: cmp    r9,0xffffffffffffff81 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R9, X86_WIDTH_64, 18446744073709551489ULL);
x86_l_f2:
	/* 0xf2: je     125 <filter_char_buf_postfix+0x125> */
	X86_SIM_X86_JCC(X86_CC_E, 0xf2, 0x125, x86_l_125);
x86_l_f4:
	/* 0xf4: lea    r10d,[rcx+r9*1] */
...
x86_l_13a:
	/* 0x13a: jmp    13e <filter_char_buf_postfix+0x13e> */
	X86_SIM_X86_JMP(0x13a, 0x13e, x86_l_13e);
x86_l_13c:
	/* 0x13c: xor    eax,eax */
	X86_SIM_L_EXEC_ALU_REG(X86_RAX, X86_RAX, X86_WIDTH_32, X86_ALU_XOR);
x86_l_13e:
...
x86_l_147:
	/* 0x147: jmp    14c <filter_char_buf_postfix+0x14c> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_14c:
