...
x86_l_19:
	/* 0x19: mov    rdi,QWORD PTR [rip+0x52a0] */
...
x86_l_2f:
	/* 0x2f: je     557 <generic_kprobe_filter_arg+0x557> */
...
x86_l_49:
	/* 0x49: mov    rdi,QWORD PTR [rip+0x52a0] */
...
x86_l_57:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5a:
	/* 0x5a: je     53c <generic_kprobe_filter_arg+0x53c> */
...
x86_l_68:
	/* 0x68: je     53c <generic_kprobe_filter_arg+0x53c> */
...
x86_l_7d:
	/* 0x7d: je     4c5 <generic_kprobe_filter_arg+0x4c5> */
...
x86_l_f1:
	/* 0xf1: jb     4b6 <generic_kprobe_filter_arg+0x4b6> */
...
x86_l_102:
	/* 0x102: je     4b6 <generic_kprobe_filter_arg+0x4b6> */
...
x86_l_11b:
	/* 0x11b: ja     216 <generic_kprobe_filter_arg+0x216> */
...
x86_l_12f:
	/* 0x12f: jae    216 <generic_kprobe_filter_arg+0x216> */
...
x86_l_13d:
	/* 0x13d: ja     4c5 <generic_kprobe_filter_arg+0x4c5> */
...
x86_l_14c:
	/* 0x14c: jne    4c5 <generic_kprobe_filter_arg+0x4c5> */
...
x86_l_157:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_64, 36ULL);
x86_l_15b:
	/* 0x15b: ja     4b6 <generic_kprobe_filter_arg+0x4b6> */
...
x86_l_179:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_64);
x86_l_17d:
	/* 0x17d: jae    24a <generic_kprobe_filter_arg+0x24a> */
...
x86_l_18b:
	/* 0x18b: ja     4c5 <generic_kprobe_filter_arg+0x4c5> */
...
x86_l_199:
	/* 0x199: jae    2ec <generic_kprobe_filter_arg+0x2ec> */
...
x86_l_1a5:
	/* 0x1a5: jb     36b <generic_kprobe_filter_arg+0x36b> */
	X86_SIM_X86_JCC(X86_CC_B, 0x1a5, 0x36b, x86_l_36b);
x86_l_1ab:
	/* 0x1ab: cmp    ecx,0x6 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 6ULL);
x86_l_1ae:
	/* 0x1ae: je     4b6 <generic_kprobe_filter_arg+0x4b6> */
	X86_SIM_X86_JCC(X86_CC_E, 0x1ae, 0x4b6, x86_l_4b6);
x86_l_1b4:
	/* 0x1b4: cmp    ecx,0xc */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 12ULL);
x86_l_1b7:
	/* 0x1b7: jne    4c5 <generic_kprobe_filter_arg+0x4c5> */
...
x86_l_1ca:
	/* 0x1ca: jne    4b6 <generic_kprobe_filter_arg+0x4b6> */
...
x86_l_1d8:
	/* 0x1d8: jb     4c5 <generic_kprobe_filter_arg+0x4c5> */
...
x86_l_20b:
	/* 0x20b: jne    4b6 <generic_kprobe_filter_arg+0x4b6> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x20b, 0x4b6, x86_l_4b6);
x86_l_211:
	/* 0x211: jmp    4c5 <generic_kprobe_filter_arg+0x4c5> */
	X86_SIM_X86_JMP(0x211, 0x4c5, x86_l_4c5);
x86_l_216:
	/* 0x216: mov    rsi,QWORD PTR [rip+0x52a0] */
...
x86_l_23b:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDX, X86_WIDTH_64, 4ULL);
x86_l_23f:
	/* 0x23f: jbe    143 <generic_kprobe_filter_arg+0x143> */
	X86_SIM_X86_JCC(X86_CC_BE, 0x23f, 0x143, x86_l_143);
x86_l_245:
	/* 0x245: jmp    4c5 <generic_kprobe_filter_arg+0x4c5> */
...
x86_l_24f:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_64);
x86_l_253:
	/* 0x253: jae    4b6 <generic_kprobe_filter_arg+0x4b6> */
...
x86_l_25e:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 12ULL);
x86_l_261:
	/* 0x261: ja     4c5 <generic_kprobe_filter_arg+0x4c5> */
...
x86_l_26c:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_32);
x86_l_26f:
	/* 0x26f: jae    3c4 <generic_kprobe_filter_arg+0x3c4> */
...
x86_l_278:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDX, X86_WIDTH_32, 2ULL);
x86_l_27b:
	/* 0x27b: jb     440 <generic_kprobe_filter_arg+0x440> */
	X86_SIM_X86_JCC(X86_CC_B, 0x27b, 0x440, x86_l_440);
x86_l_281:
	/* 0x281: cmp    ecx,0x6 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 6ULL);
x86_l_284:
	/* 0x284: je     4b6 <generic_kprobe_filter_arg+0x4b6> */
	X86_SIM_X86_JCC(X86_CC_E, 0x284, 0x4b6, x86_l_4b6);
x86_l_28a:
	/* 0x28a: cmp    ecx,0xc */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 12ULL);
x86_l_28d:
	/* 0x28d: jne    4c5 <generic_kprobe_filter_arg+0x4c5> */
...
x86_l_2a0:
	/* 0x2a0: jne    4b6 <generic_kprobe_filter_arg+0x4b6> */
...
x86_l_2ae:
	/* 0x2ae: jb     4c5 <generic_kprobe_filter_arg+0x4c5> */
...
x86_l_2b9:
	/* 0x2b9: jne    4b6 <generic_kprobe_filter_arg+0x4b6> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x2b9, 0x4b6, x86_l_4b6);
x86_l_2bf:
	/* 0x2bf: cmp    edx,0x11 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDX, X86_WIDTH_32, 17ULL);
x86_l_2c2:
	/* 0x2c2: jb     4c5 <generic_kprobe_filter_arg+0x4c5> */
...
x86_l_2e1:
	/* 0x2e1: jne    4b6 <generic_kprobe_filter_arg+0x4b6> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x2e1, 0x4b6, x86_l_4b6);
x86_l_2e7:
	/* 0x2e7: jmp    4c5 <generic_kprobe_filter_arg+0x4c5> */
...
x86_l_2f1:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_32);
x86_l_2f4:
	/* 0x2f4: jae    4c5 <generic_kprobe_filter_arg+0x4c5> */
...
x86_l_309:
	/* 0x309: mov    rdi,QWORD PTR [rip+0x52a0] */
...
x86_l_31c:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_31f:
	/* 0x31f: je     43c <generic_kprobe_filter_arg+0x43c> */
...
x86_l_34e:
	/* 0x34e: je     48c <generic_kprobe_filter_arg+0x48c> */
	X86_SIM_X86_JCC(X86_CC_E, 0x34e, 0x48c, x86_l_48c);
x86_l_354:
	/* 0x354: cmp    ecx,0xa */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 10ULL);
x86_l_357:
	/* 0x357: jne    497 <generic_kprobe_filter_arg+0x497> */
...
x86_l_366:
	/* 0x366: jmp    4b1 <generic_kprobe_filter_arg+0x4b1> */
...
x86_l_378:
	/* 0x378: je     44f <generic_kprobe_filter_arg+0x44f> */
...
x86_l_386:
	/* 0x386: jb     482 <generic_kprobe_filter_arg+0x482> */
...
x86_l_3b9:
	/* 0x3b9: je     44f <generic_kprobe_filter_arg+0x44f> */
	X86_SIM_X86_JCC(X86_CC_E, 0x3b9, 0x44f, x86_l_44f);
x86_l_3bf:
	/* 0x3bf: jmp    482 <generic_kprobe_filter_arg+0x482> */
...
x86_l_3c9:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_32);
x86_l_3cc:
	/* 0x3cc: jae    4c5 <generic_kprobe_filter_arg+0x4c5> */
...
x86_l_3dd:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_RAX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 4ULL);
x86_l_3e1:
	/* 0x3e1: mov    rdi,QWORD PTR [rip+0x52a0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&argfilter_maps)));
x86_l_3e8:
...
x86_l_3f4:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3f7:
	/* 0x3f7: je     43c <generic_kprobe_filter_arg+0x43c> */
...
x86_l_424:
	/* 0x424: ja     4ae <generic_kprobe_filter_arg+0x4ae> */
...
x86_l_432:
	/* 0x432: jae    49e <generic_kprobe_filter_arg+0x49e> */
...
x86_l_43a:
	/* 0x43a: jmp    4ae <generic_kprobe_filter_arg+0x4ae> */
	X86_SIM_X86_JMP(0x43a, 0x4ae, x86_l_4ae);
x86_l_43c:
	/* 0x43c: xor    eax,eax */
	X86_SIM_L_EXEC_ALU_REG(X86_RAX, X86_RAX, X86_WIDTH_32, X86_ALU_XOR);
x86_l_43e:
	/* 0x43e: jmp    4b1 <generic_kprobe_filter_arg+0x4b1> */
...
x86_l_44d:
	/* 0x44d: jne    459 <generic_kprobe_filter_arg+0x459> */
...
x86_l_457:
	/* 0x457: jmp    4b1 <generic_kprobe_filter_arg+0x4b1> */
...
x86_l_461:
	/* 0x461: jb     482 <generic_kprobe_filter_arg+0x482> */
...
x86_l_468:
	/* 0x468: je     44f <generic_kprobe_filter_arg+0x44f> */
	X86_SIM_X86_JCC(X86_CC_E, 0x468, 0x44f, x86_l_44f);
x86_l_46a:
	/* 0x46a: cmp    esi,0x11 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RSI, X86_WIDTH_32, 17ULL);
x86_l_46d:
	/* 0x46d: jb     482 <generic_kprobe_filter_arg+0x482> */
...
x86_l_480:
	/* 0x480: je     44f <generic_kprobe_filter_arg+0x44f> */
...
x86_l_485:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 6ULL);
x86_l_488:
	/* 0x488: je     4b6 <generic_kprobe_filter_arg+0x4b6> */
	X86_SIM_X86_JCC(X86_CC_E, 0x488, 0x4b6, x86_l_4b6);
x86_l_48a:
	/* 0x48a: jmp    4c5 <generic_kprobe_filter_arg+0x4c5> */
...
x86_l_492:
	...
	X86_SIM_L_EXEC_MOVX_REG(X86_OP_MOVZX_REG, X86_RAX, X86_RAX, X86_WIDTH_32, X86_WIDTH_8);
x86_l_495:
	/* 0x495: jmp    4b1 <generic_kprobe_filter_arg+0x4b1> */
...
x86_l_499:
	...
	X86_SIM_L_EXEC_MOVX_REG(X86_OP_MOVZX_REG, X86_RAX, X86_RAX, X86_WIDTH_32, X86_WIDTH_8);
x86_l_49c:
	/* 0x49c: jmp    4b1 <generic_kprobe_filter_arg+0x4b1> */
...
x86_l_4a3:
	...
	X86_SIM_L_EXEC_BT(X86_RSI, X86_RDX, X86_WIDTH_32);
x86_l_4a6:
	/* 0x4a6: jae    4ae <generic_kprobe_filter_arg+0x4ae> */
...
x86_l_521:
	/* 0x521: mov    rsi,QWORD PTR [rip+0x529c] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&kprobe_calls)));
x86_l_528:
	/* 0x528: mov    ecx,0x4 */
...
x86_l_53a:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_53c:
	/* 0x53c: mov    rsi,QWORD PTR [rip+0x529c] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&kprobe_calls)));
x86_l_543:
	/* 0x543: mov    ecx,0x5 */
...
x86_l_567:
	/* 0x567: jmp    634 <generic_kprobe_filter_arg+0x634> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_56c:
	/* 0x56c: xor    r15d,r15d */
...
x86_l_577:
	/* 0x577: jne    5c9 <generic_kprobe_filter_arg+0x5c9> */
...
x86_l_587:
	/* 0x587: jne    5c9 <generic_kprobe_filter_arg+0x5c9> */
...
x86_l_597:
	/* 0x597: jne    5c9 <generic_kprobe_filter_arg+0x5c9> */
...
x86_l_5a7:
	/* 0x5a7: jne    5c9 <generic_kprobe_filter_arg+0x5c9> */
...
x86_l_5b7:
	/* 0x5b7: jne    5c9 <generic_kprobe_filter_arg+0x5c9> */
...
x86_l_5c7:
	/* 0x5c7: je     5eb <generic_kprobe_filter_arg+0x5eb> */
...
x86_l_5d0:
	/* 0x5d0: mov    rsi,QWORD PTR [rip+0x5298] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&kprobe_calls)));
x86_l_5d7:
	/* 0x5d7: mov    ecx,0x3 */
...
x86_l_600:
	/* 0x600: mov    rdi,QWORD PTR [rip+0x5298] */
...
x86_l_613:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_616:
	/* 0x616: je     557 <generic_kprobe_filter_arg+0x557> */
	X86_SIM_X86_JCC(X86_CC_E, 0x616, 0x557, x86_l_557);
x86_l_61c:
	/* 0x61c: mov    rdi,QWORD PTR [rip+0x5298] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&retprobe_map)));
x86_l_623:
...
x86_l_62d:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_62f:
	/* 0x62f: jmp    557 <generic_kprobe_filter_arg+0x557> */
