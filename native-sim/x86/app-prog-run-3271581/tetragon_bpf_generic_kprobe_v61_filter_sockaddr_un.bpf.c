...
SEC("xdp")
int tetragon_bpf_generic_kprobe_v61_filter_sockaddr_un_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_1d9:
	/* 0x1d9: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_1f2:
	/* 0x1f2: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_2df:
	/* 0x2df: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_319:
	/* 0x319: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_34d:
	/* 0x34d: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_372:
	/* 0x372: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_388:
	/* 0x388: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_39b:
	/* 0x39b: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_3ae:
	/* 0x3ae: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_3c1:
	/* 0x3c1: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_3d4:
	/* 0x3d4: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_3e7:
	/* 0x3e7: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_3fa:
	/* 0x3fa: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_45b:
	/* 0x45b: mov    rdi,QWORD PTR [rip+0x23a0] */
...
x86_l_47c:
	/* 0x47c: mov    rdi,QWORD PTR [rip+0x23a0] */
...
x86_l_4f5:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_RAX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 12ULL);
x86_l_4f9:
	/* 0x4f9: mov    rdi,QWORD PTR [rip+0xf60] */
