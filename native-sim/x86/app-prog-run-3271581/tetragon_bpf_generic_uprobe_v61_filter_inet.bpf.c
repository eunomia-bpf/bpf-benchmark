...
SEC("xdp")
int tetragon_bpf_generic_uprobe_v61_filter_inet_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_214:
	/* 0x214: mov    rdi,QWORD PTR [rip+0x1810] */
...
x86_l_27d:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_RAX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_281:
	/* 0x281: mov    rdi,QWORD PTR [rip+0x1810] */
...
x86_l_35a:
	/* 0x35a: mov    rdi,QWORD PTR [rip+0xb60] */
