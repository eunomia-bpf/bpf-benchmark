...
SEC("xdp")
int tetragon_bpf_generic_usdt_v511_generic_usdt_event_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_32:
	/* 0x32: je     624 <generic_usdt_event+0x624> */
...
x86_l_235:
	/* 0x235: je     63c <generic_usdt_event+0x63c> */
...
x86_l_637:
	/* 0x637: jmp    695 <generic_usdt_event+0x695> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_63c:
...
x86_l_654:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_657:
	/* 0x657: je     624 <generic_usdt_event+0x624> */
...
x86_l_674:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_677:
	/* 0x677: je     624 <generic_usdt_event+0x624> */
...
x86_l_68b:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R12, X86_WIDTH_64);
x86_l_68e:
	/* 0x68e: jne    624 <generic_usdt_event+0x624> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x68e, 0x624, x86_l_624);
x86_l_690:
	/* 0x690: jmp    23b <generic_usdt_event+0x23b> */
