...
SEC("xdp")
int tetragon_bpf_generic_kprobe_v61_filter_char_buf_prefix_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_17:
	/* 0x17: mov    rdi,QWORD PTR [rip+0x23a0] */
...
x86_l_38:
	/* 0x38: mov    rdi,QWORD PTR [rip+0x23a0] */
