...
SEC("xdp")
int tetragon_bpf_generic_uprobe_v511_generic_uprobe_setup_event_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_2a:
	/* 0x2a: je     204 <generic_uprobe_setup_event+0x204> */
	X86_SIM_X86_JCC(X86_CC_E, 0x2a, 0x204, x86_l_204);
x86_l_30:
	/* 0x30: mov    r14,rax */
...
x86_l_be:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_c0:
	/* 0xc0: mov    DWORD PTR [r14+0x7c],eax */
...
x86_l_116:
	/* 0x116: lea    rsi,[rsp+0x30] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 48ULL);
x86_l_11b:
	/* 0x11b: lea    rdx,[rsp+0x18] */
...
x86_l_15e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_161:
	/* 0x161: je     167 <generic_uprobe_setup_event+0x167> */
	X86_SIM_X86_JCC(X86_CC_E, 0x161, 0x167, x86_l_167);
x86_l_163:
	/* 0x163: inc    DWORD PTR [rax] */
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_32, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_165:
	/* 0x165: jmp    18b <generic_uprobe_setup_event+0x18b> */
	X86_SIM_X86_JMP(0x165, 0x18b, x86_l_18b);
x86_l_167:
	/* 0x167: mov    DWORD PTR [rsp+0x8],0x1 */
...
x86_l_176:
	...
	X86_SIM_L_EXEC_ALU_REG(X86_RCX, X86_RCX, X86_WIDTH_32, X86_ALU_XOR);
x86_l_178:
	/* 0x178: lea    rsi,[rsp+0xc] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 12ULL);
x86_l_17d:
	/* 0x17d: lea    rdx,[rsp+0x8] */
...
x86_l_189:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_18b:
	/* 0x18b: mov    DWORD PTR [rsp+0x18],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 103079215104ULL);
x86_l_193:
	/* 0x193: mov    rdi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_19a:
	/* 0x19a: lea    rsi,[rsp+0x18] */
...
x86_l_1a6:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1a9:
	/* 0x1a9: je     1ce <generic_uprobe_setup_event+0x1ce> */
	X86_SIM_X86_JCC(X86_CC_E, 0x1a9, 0x1ce, x86_l_1ce);
x86_l_1ab:
	/* 0x1ab: mov    rsi,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RAX, X86_WIDTH_64);
x86_l_1ae:
	/* 0x1ae: add    rsi,0x5ef8 */
...
x86_l_1c3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1c6:
	/* 0x1c6: je     1ce <generic_uprobe_setup_event+0x1ce> */
	X86_SIM_X86_JCC(X86_CC_E, 0x1c6, 0x1ce, x86_l_1ce);
x86_l_1c8:
	/* 0x1c8: cmp    DWORD PTR [rax+0x40],0xffffffff */
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 279172874239ULL);
x86_l_1cc:
	/* 0x1cc: jne    1e9 <generic_uprobe_setup_event+0x1e9> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x1cc, 0x1e9, x86_l_1e9);
x86_l_1ce:
	/* 0x1ce: mov    rsi,QWORD PTR [rip+0x0] */
...
x86_l_20f:
	/* 0x20f: jmp    214 <generic_uprobe_setup_event+0x214> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_214:
