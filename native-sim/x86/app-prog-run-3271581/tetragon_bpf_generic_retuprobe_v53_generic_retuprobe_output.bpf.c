...
x86_l_10:
	/* 0x10: mov    rdi,QWORD PTR [rip+0x3b50] */
...
x86_l_26:
	/* 0x26: je     d0 <generic_retuprobe_output+0xd0> */
...
x86_l_4b:
	/* 0x4b: mov    rsi,QWORD PTR [rip+0x3b50] */
...
x86_l_61:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_64:
	/* 0x64: js     8d <generic_retuprobe_output+0x8d> */
	X86_SIM_X86_JCC(X86_CC_S, 0x64, 0x8d, x86_l_8d);
x86_l_66:
	/* 0x66: mov    DWORD PTR [rsp+0xc],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 51539607552ULL);
x86_l_6e:
	/* 0x6e: mov    rdi,QWORD PTR [rip+0x3b50] */
...
x86_l_81:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_84:
	/* 0x84: je     d0 <generic_retuprobe_output+0xd0> */
...
x86_l_8b:
	/* 0x8b: jmp    d0 <generic_retuprobe_output+0xd0> */
	X86_SIM_X86_JMP(0x8b, 0xd0, x86_l_d0);
x86_l_8d:
	/* 0x8d: mov    rbx,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RBX, X86_RAX, X86_WIDTH_64);
x86_l_90:
	/* 0x90: mov    DWORD PTR [rsp+0x8],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 34359738368ULL);
x86_l_98:
	/* 0x98: mov    rdi,QWORD PTR [rip+0x3b50] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_stats_map)));
x86_l_9f:
	/* 0x9f: lea    rsi,[rsp+0x8] */
...
x86_l_126:
	...
	X86_SIM_L_EXEC_POP(X86_RBX, X86_WIDTH_64);
x86_l_127:
	/* 0x127: jmp    12c <generic_retuprobe_output+0x12c> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_12c:
