...
SEC("xdp")
int tetragon_bpf_generic_uprobe_v61_filter_char_buf_postfix_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_1a:
	/* 0x1a: mov    rdi,QWORD PTR [rip+0x2040] */
...
x86_l_43:
	/* 0x43: mov    rdi,QWORD PTR [rip+0x2040] */
