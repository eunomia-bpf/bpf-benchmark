...
static __noinline __u64 tetragon_bpf_generic_tracepoint_v511_generic_tracepoint_event_x86_chunk_0(
...
x86_l_38:
	/* 0x38: je     3307 <generic_tracepoint_event+0x3307> */
...
x86_l_57:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5a:
	/* 0x5a: je     3307 <generic_tracepoint_event+0x3307> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 13063ULL;
	}
x86_l_60:
...
x86_l_85:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_88:
	/* 0x88: je     3307 <generic_tracepoint_event+0x3307> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 13063ULL;
	}
x86_l_8e:
...
x86_l_d6:
	/* 0xd6: jmp    3307 <generic_tracepoint_event+0x3307> */
	return 13063ULL;
x86_l_db:
	/* 0xdb: xor    ebp,ebp */
...
x86_l_170:
	/* 0x170: je     3307 <generic_tracepoint_event+0x3307> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 13063ULL;
	}
x86_l_176:
...
x86_l_1d8:
	/* 0x1d8: jmp    3307 <generic_tracepoint_event+0x3307> */
	return 13063ULL;
x86_l_1dd:
	/* 0x1dd: xor    eax,eax */
...
x86_l_1e4:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1e7:
	/* 0x1e7: je     3307 <generic_tracepoint_event+0x3307> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 13063ULL;
	}
x86_l_1ed:
...
x86_l_23f:
	/* 0x23f: mov    DWORD PTR [r14+0x5ef8],0x0 */
...
x86_l_479:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_47c:
	/* 0x47c: je     3307 <generic_tracepoint_event+0x3307> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 13063ULL;
	}
x86_l_482:
...
x86_l_49d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_4a0:
	/* 0x4a0: je     3307 <generic_tracepoint_event+0x3307> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 13063ULL;
	}
x86_l_4a6:
...
x86_l_4b5:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_4b8:
	/* 0x4b8: jne    3307 <generic_tracepoint_event+0x3307> */
	if (X86_SIM_L_EVAL_CC(X86_CC_NE)) {
		return 13063ULL;
	}
x86_l_4be:
...
static __noinline __u64 tetragon_bpf_generic_tracepoint_v511_generic_tracepoint_event_x86_chunk_1(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_generic_tracepoint_v511_generic_tracepoint_event_x86_chunk_2(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_generic_tracepoint_v511_generic_tracepoint_event_x86_chunk_3(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_generic_tracepoint_v511_generic_tracepoint_event_x86_chunk_4(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_generic_tracepoint_v511_generic_tracepoint_event_x86_chunk_5(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_generic_tracepoint_v511_generic_tracepoint_event_x86_chunk_6(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
x86_l_2f41:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 14ULL);
x86_l_2f45:
	/* 0x2f45: mov    QWORD PTR [r14+0x5efc],0x0 */
...
static __noinline __u64 tetragon_bpf_generic_tracepoint_v511_generic_tracepoint_event_x86_chunk_7(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
x86_l_32d6:
	/* 0x32d6: mov    QWORD PTR [r14+0x5ee8],0x0 */
...
x86_l_32e1:
	/* 0x32e1: mov    QWORD PTR [r14+0x5ef0],0x0 */
...
x86_l_32ec:
	/* 0x32ec: mov    rsi,QWORD PTR [rip+0x0] */
...
x86_l_331a:
	/* 0x331a: jmp    331f <generic_tracepoint_event+0x331f> ; native-link entry RET */
...
SEC("xdp")
int tetragon_bpf_generic_tracepoint_v511_generic_tracepoint_event_x86_sim_xdp(struct xdp_md *ctx)
{
	...
	__u64 __x86_pc = 0ULL;
	for (__u32 __x86_iter = 0; __x86_iter < 11004U; __x86_iter++) {
		if (__x86_pc == 0xffffffffffffffffULL)
			break;
		if (__x86_pc >= 0ULL && __x86_pc <= 1784ULL)
			__x86_pc = tetragon_bpf_generic_tracepoint_v511_generic_tracepoint_event_x86_chunk_0(__x86_state, __x86_pc);
		else if (__x86_pc >= 1789ULL && __x86_pc <= 3616ULL)
			__x86_pc = tetragon_bpf_generic_tracepoint_v511_generic_tracepoint_event_x86_chunk_1(__x86_state, __x86_pc);
		else if (__x86_pc >= 3620ULL && __x86_pc <= 5447ULL)
			__x86_pc = tetragon_bpf_generic_tracepoint_v511_generic_tracepoint_event_x86_chunk_2(__x86_state, __x86_pc);
		else if (__x86_pc >= 5453ULL && __x86_pc <= 7303ULL)
			__x86_pc = tetragon_bpf_generic_tracepoint_v511_generic_tracepoint_event_x86_chunk_3(__x86_state, __x86_pc);
		else if (__x86_pc >= 7305ULL && __x86_pc <= 9141ULL)
			__x86_pc = tetragon_bpf_generic_tracepoint_v511_generic_tracepoint_event_x86_chunk_4(__x86_state, __x86_pc);
		else if (__x86_pc >= 9146ULL && __x86_pc <= 10963ULL)
			__x86_pc = tetragon_bpf_generic_tracepoint_v511_generic_tracepoint_event_x86_chunk_5(__x86_state, __x86_pc);
		else if (__x86_pc >= 10969ULL && __x86_pc <= 12814ULL)
			__x86_pc = tetragon_bpf_generic_tracepoint_v511_generic_tracepoint_event_x86_chunk_6(__x86_state, __x86_pc);
		else if (__x86_pc >= 12819ULL && __x86_pc <= 13082ULL)
			__x86_pc = tetragon_bpf_generic_tracepoint_v511_generic_tracepoint_event_x86_chunk_7(__x86_state, __x86_pc);
		else
