...
x86_l_13:
	/* 0x13: mov    rdi,QWORD PTR [rip+0x5fe0] */
...
x86_l_29:
	/* 0x29: je     132 <generic_rawtp_actions+0x132> */
...
x86_l_3d:
	/* 0x3d: jl     132 <generic_rawtp_actions+0x132> */
...
x86_l_58:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5b:
	/* 0x5b: je     132 <generic_rawtp_actions+0x132> */
...
x86_l_7b:
	/* 0x7b: mov    rdi,QWORD PTR [rip+0x5fe0] */
...
x86_l_9b:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_9e:
	/* 0x9e: je     ae <generic_rawtp_actions+0xae> */
...
x86_l_aa:
	/* 0xaa: jae    b6 <generic_rawtp_actions+0xb6> */
	X86_SIM_X86_JCC(X86_CC_AE, 0xaa, 0xb6, x86_l_b6);
x86_l_ac:
	/* 0xac: jmp    110 <generic_rawtp_actions+0x110> */
...
x86_l_b0:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 5ULL);
x86_l_b4:
	/* 0xb4: jb     110 <generic_rawtp_actions+0x110> */
...
x86_l_c9:
	/* 0xc9: call   0 <generic_rawtp_actions> */
...
x86_l_d8:
	/* 0xd8: jae    110 <generic_rawtp_actions+0x110> */
...
x86_l_e7:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_R8, X86_RBP, X86_WIDTH_32);
x86_l_ea:
	/* 0xea: call   0 <generic_rawtp_actions> */
...
x86_l_f6:
	...
	X86_SIM_L_EXEC_CMP_REG_MEM(X86_RCX, X86_R14, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32), 0ULL);
x86_l_f9:
	/* 0xf9: jae    110 <generic_rawtp_actions+0x110> */
...
x86_l_108:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_R8, X86_RBP, X86_WIDTH_32);
x86_l_10b:
	/* 0x10b: call   0 <generic_rawtp_actions> */
...
x86_l_115:
	/* 0x115: je     132 <generic_rawtp_actions+0x132> */
	X86_SIM_X86_JCC(X86_CC_E, 0x115, 0x132, x86_l_132);
x86_l_117:
	/* 0x117: mov    rsi,QWORD PTR [rip+0x5fe0] */
...
x86_l_16e:
	/* 0x16e: mov    rdi,QWORD PTR [rip+0x2770] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_175:
...
x86_l_2d9:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_RAX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_2dd:
	/* 0x2dd: mov    rdi,QWORD PTR [rip+0x2770] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_2e4:
	/* 0x2e4: xor    ecx,ecx */
...
x86_l_359:
	/* 0x359: mov    rdi,QWORD PTR [rip+0x2770] */
...
x86_l_430:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_432:
	/* 0x432: mov    rdi,QWORD PTR [rip+0x2770] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_439:
	/* 0x439: xor    r15d,r15d */
	X86_SIM_L_EXEC_ALU_REG(X86_R15, X86_R15, X86_WIDTH_32, X86_ALU_XOR);
...
x86_l_4b0:
	/* 0x4b0: mov    rdi,QWORD PTR [rip+0x2770] */
...
x86_l_4e5:
	/* 0x4e5: mov    rdi,QWORD PTR [rip+0x2770] */
...
x86_l_561:
	/* 0x561: mov    rdi,QWORD PTR [rip+0x2770] */
...
x86_l_58e:
	/* 0x58e: mov    rdi,QWORD PTR [rip+0x2770] */
...
x86_l_607:
	/* 0x607: mov    rdi,QWORD PTR [rip+0x2770] */
...
x86_l_62b:
	/* 0x62b: mov    rdi,QWORD PTR [rip+0x2770] */
...
x86_l_69b:
	/* 0x69b: mov    rdi,QWORD PTR [rip+0x2770] */
...
x86_l_6bf:
	/* 0x6bf: mov    rdi,QWORD PTR [rip+0x2770] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_missed_notifications)));
x86_l_6c6:
...
x86_l_704:
	/* 0x704: mov    rdi,QWORD PTR [rip+0x2770] */
...
x86_l_725:
	/* 0x725: mov    rdi,QWORD PTR [rip+0x2770] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_72c:
	/* 0x72c: mov    rsi,rsp */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RSP, X86_WIDTH_64);
...
x86_l_736:
	/* 0x736: mov    rdi,QWORD PTR [rip+0x2770] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&socktrack_map)));
x86_l_73d:
...
x86_l_7af:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_7b4:
	/* 0x7b4: mov    rdi,QWORD PTR [rip+0x2770] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_7bb:
...
x86_l_7d5:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_7da:
	/* 0x7da: mov    rdi,QWORD PTR [rip+0x2770] */
...
x86_l_81b:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_820:
	/* 0x820: mov    rdi,QWORD PTR [rip+0x2770] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_827:
...
x86_l_83d:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_842:
	/* 0x842: mov    rdi,QWORD PTR [rip+0x2770] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&config_map)));
x86_l_849:
	/* 0x849: call   rax */
	X86_SIM_BPF_CALL_REG(X86_RAX);
...
x86_l_8d4:
	/* 0x8d4: mov    rdi,QWORD PTR [rip+0x2770] */
...
x86_l_90c:
	/* 0x90c: mov    rdi,QWORD PTR [rip+0x2770] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&ratelimit_map)));
x86_l_913:
	/* 0x913: xor    ecx,ecx */
	X86_SIM_L_EXEC_ALU_REG(X86_RCX, X86_RCX, X86_WIDTH_32, X86_ALU_XOR);
...
x86_l_93b:
	/* 0x93b: mov    rsi,QWORD PTR [rip+0x2770] */
...
x86_l_967:
	/* 0x967: mov    rsi,QWORD PTR [rip+0x2770] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&stack_trace_map)));
x86_l_96e:
	/* 0x96e: mov    ecx,0x100 */
...
x86_l_9b8:
	/* 0x9b8: mov    rdi,QWORD PTR [rip+0x2770] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_errmetrics_map)));
x86_l_9bf:
	/* 0x9bf: xor    ecx,ecx */
	X86_SIM_L_EXEC_ALU_REG(X86_RCX, X86_RCX, X86_WIDTH_32, X86_ALU_XOR);
...
x86_l_9db:
	/* 0x9db: mov    rdi,QWORD PTR [rip+0x2770] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_missed_notifications)));
x86_l_9e2:
