...
SEC("xdp")
int tetragon_bpf_enforcer_kprobe_enforcer_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_26:
	/* 0x26: je     65 <kprobe_enforcer+0x65> */
	X86_SIM_X86_JCC(X86_CC_E, 0x26, 0x65, x86_l_65);
x86_l_28:
	/* 0x28: mov    r14,rax */
...
x86_l_33:
	/* 0x33: je     41 <kprobe_enforcer+0x41> */
	X86_SIM_X86_JCC(X86_CC_E, 0x33, 0x41, x86_l_41);
x86_l_35:
	/* 0x35: mov    eax,0x6d */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 109ULL);
x86_l_3a:
	/* 0x3a: movsx  edi,WORD PTR [r14+0x2] */
...
x86_l_59:
	/* 0x59: je     65 <kprobe_enforcer+0x65> */
	X86_SIM_X86_JCC(X86_CC_E, 0x59, 0x65, x86_l_65);
x86_l_5b:
	/* 0x5b: mov    eax,0x3a */
...
x86_l_6e:
	/* 0x6e: jmp    73 <kprobe_enforcer+0x73> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_73:
