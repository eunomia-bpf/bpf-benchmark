...
x86_l_27:
	/* 0x27: je     3c6 <generic_fentry_output+0x3c6> */
...
x86_l_347:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_34a:
	/* 0x34a: je     386 <generic_fentry_output+0x386> */
...
x86_l_350:
	/* 0x350: je     386 <generic_fentry_output+0x386> */
...
x86_l_36e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_371:
	/* 0x371: js     422 <generic_fentry_output+0x422> */
...
x86_l_37f:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_384:
	/* 0x384: jmp    3ae <generic_fentry_output+0x3ae> */
...
x86_l_39c:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_39f:
	/* 0x39f: js     3d3 <generic_fentry_output+0x3d3> */
...
x86_l_3bc:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3bf:
	/* 0x3bf: je     3c6 <generic_fentry_output+0x3c6> */
...
x86_l_3ce:
	/* 0x3ce: jmp    4d5 <generic_fentry_output+0x4d5> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_3d3:
	/* 0x3d3: mov    rbx,rax */
...
x86_l_420:
	/* 0x420: jmp    3c6 <generic_fentry_output+0x3c6> */
...
x86_l_49f:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_4a3:
	/* 0x4a3: jmp    3c6 <generic_fentry_output+0x3c6> */
...
x86_l_4ae:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_4b2:
	/* 0x4b2: jmp    3c6 <generic_fentry_output+0x3c6> */
...
x86_l_4bd:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_4c1:
	/* 0x4c1: jmp    3c6 <generic_fentry_output+0x3c6> */
...
x86_l_4cc:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_4d0:
	/* 0x4d0: jmp    3c6 <generic_fentry_output+0x3c6> */
