...
x86_l_f:
	/* 0xf: je     69 <tg_cgtracker_cgroup_release+0x69> */
	X86_SIM_X86_JCC(X86_CC_E, 0xf, 0x69, x86_l_69);
x86_l_11:
	/* 0x11: add    rdx,0x100 */
...
x86_l_27:
	/* 0x27: mov    rdx,QWORD PTR [rsp] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_2b:
	/* 0x2b: mov    QWORD PTR [rsp],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_33:
	/* 0x33: test   rdx,rdx */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RDX, X86_RDX, X86_WIDTH_64);
x86_l_36:
	/* 0x36: je     69 <tg_cgtracker_cgroup_release+0x69> */
	X86_SIM_X86_JCC(X86_CC_E, 0x36, 0x69, x86_l_69);
x86_l_38:
	/* 0x38: add    rdx,0x60 */
...
x86_l_49:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_4b:
	/* 0x4b: mov    rax,QWORD PTR [rsp] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RAX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_4f:
	/* 0x4f: mov    QWORD PTR [rsp],rax */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_RAX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_53:
	/* 0x53: test   rax,rax */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_56:
	/* 0x56: je     69 <tg_cgtracker_cgroup_release+0x69> */
	X86_SIM_X86_JCC(X86_CC_E, 0x56, 0x69, x86_l_69);
x86_l_58:
	/* 0x58: mov    eax,0x3 */
...
x86_l_6c:
	/* 0x6c: jmp    71 <tg_cgtracker_cgroup_release+0x71> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_71:
