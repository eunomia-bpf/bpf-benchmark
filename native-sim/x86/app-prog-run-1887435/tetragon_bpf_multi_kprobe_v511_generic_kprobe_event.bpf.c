...
x86_l_26:
	/* 0x26: je     3aa <generic_kprobe_event+0x3aa> */
	X86_SIM_X86_JCC(X86_CC_E, 0x26, 0x3aa, x86_l_3aa);
x86_l_2c:
	/* 0x2c: mov    r14,rax */
...
x86_l_58:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5b:
	/* 0x5b: je     3aa <generic_kprobe_event+0x3aa> */
	X86_SIM_X86_JCC(X86_CC_E, 0x5b, 0x3aa, x86_l_3aa);
x86_l_61:
...
x86_l_6a:
	/* 0x6a: je     218 <generic_kprobe_event+0x218> */
...
x86_l_86:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_89:
	/* 0x89: je     3aa <generic_kprobe_event+0x3aa> */
	X86_SIM_X86_JCC(X86_CC_E, 0x89, 0x3aa, x86_l_3aa);
x86_l_8f:
	/* 0x8f: mov    r15,rax */
...
x86_l_ad:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_b0:
	/* 0xb0: je     d6 <generic_kprobe_event+0xd6> */
...
x86_l_ba:
	/* 0xba: jne    da <generic_kprobe_event+0xda> */
...
x86_l_c8:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_cb:
	/* 0xcb: jne    1d3 <generic_kprobe_event+0x1d3> */
	X86_SIM_X86_JCC(X86_CC_NE, 0xcb, 0x1d3, x86_l_1d3);
x86_l_d1:
	/* 0xd1: jmp    3aa <generic_kprobe_event+0x3aa> */
	X86_SIM_X86_JMP(0xd1, 0x3aa, x86_l_3aa);
x86_l_d6:
	/* 0xd6: xor    ebp,ebp */
	X86_SIM_L_EXEC_ALU_REG(X86_RBP, X86_RBP, X86_WIDTH_32, X86_ALU_XOR);
x86_l_d8:
	/* 0xd8: jmp    dd <generic_kprobe_event+0xdd> */
...
x86_l_10b:
	/* 0x10b: je     3aa <generic_kprobe_event+0x3aa> */
	X86_SIM_X86_JCC(X86_CC_E, 0x10b, 0x3aa, x86_l_3aa);
x86_l_111:
	/* 0x111: cmp    ebp,0xb */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBP, X86_WIDTH_32, 11ULL);
x86_l_114:
	/* 0x114: ja     3aa <generic_kprobe_event+0x3aa> */
	X86_SIM_X86_JCC(X86_CC_A, 0x114, 0x3aa, x86_l_3aa);
x86_l_11a:
	/* 0x11a: mov    edx,ebp */
...
x86_l_13c:
	/* 0x13c: je     3aa <generic_kprobe_event+0x3aa> */
	X86_SIM_X86_JCC(X86_CC_E, 0x13c, 0x3aa, x86_l_3aa);
x86_l_142:
	/* 0x142: mov    eax,0x71 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 113ULL);
x86_l_147:
...
x86_l_160:
	/* 0x160: je     3aa <generic_kprobe_event+0x3aa> */
	X86_SIM_X86_JCC(X86_CC_E, 0x160, 0x3aa, x86_l_3aa);
x86_l_166:
...
x86_l_195:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RDX, X86_RDX, X86_WIDTH_64);
x86_l_198:
	/* 0x198: je     1c3 <generic_kprobe_event+0x1c3> */
...
x86_l_1b9:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1bc:
	/* 0x1bc: jne    1d3 <generic_kprobe_event+0x1d3> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x1bc, 0x1d3, x86_l_1d3);
x86_l_1be:
	/* 0x1be: jmp    3aa <generic_kprobe_event+0x3aa> */
	X86_SIM_X86_JMP(0x1be, 0x3aa, x86_l_3aa);
x86_l_1c3:
	/* 0x1c3: xor    eax,eax */
...
x86_l_1ca:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1cd:
	/* 0x1cd: je     3aa <generic_kprobe_event+0x3aa> */
	X86_SIM_X86_JCC(X86_CC_E, 0x1cd, 0x3aa, x86_l_3aa);
x86_l_1d3:
...
x86_l_1eb:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1ee:
	/* 0x1ee: je     1fd <generic_kprobe_event+0x1fd> */
...
x86_l_1f3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1f6:
	/* 0x1f6: je     1fd <generic_kprobe_event+0x1fd> */
...
x86_l_212:
	/* 0x212: je     3b6 <generic_kprobe_event+0x3b6> */
	X86_SIM_X86_JCC(X86_CC_E, 0x212, 0x3b6, x86_l_3b6);
x86_l_218:
...
x86_l_231:
	/* 0x231: mov    DWORD PTR [r14+0x6420],0x0 */
...
x86_l_23c:
	/* 0x23c: mov    QWORD PTR [r14+0x5eb8],0x0 */
...
x86_l_247:
	/* 0x247: mov    QWORD PTR [r14+0x5ec0],0x0 */
...
x86_l_252:
	/* 0x252: mov    QWORD PTR [r14+0x5ec8],0x0 */
...
x86_l_25d:
	/* 0x25d: mov    QWORD PTR [r14+0x5ed0],0x0 */
...
x86_l_268:
	/* 0x268: mov    QWORD PTR [r14+0x5ed8],0x0 */
...
x86_l_273:
	/* 0x273: mov    BYTE PTR [r14+0x5ee0],0x0 */
...
x86_l_2da:
	/* 0x2da: je     2f5 <generic_kprobe_event+0x2f5> */
	X86_SIM_X86_JCC(X86_CC_E, 0x2da, 0x2f5, x86_l_2f5);
x86_l_2dc:
	/* 0x2dc: movsxd r10,DWORD PTR [r9+0x4] */
...
x86_l_389:
	/* 0x389: mov    QWORD PTR [r14+0x5ef0],0x0 */
...
x86_l_399:
	/* 0x399: mov    rsi,QWORD PTR [rip+0x0] */
...
x86_l_3b1:
	/* 0x3b1: jmp    40f <generic_kprobe_event+0x40f> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_3b6:
	/* 0x3b6: mov    QWORD PTR [rsp+0x38],0xffffffffffffffff */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 244813135871ULL);
x86_l_3bf:
	/* 0x3bf: mov    eax,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_3c4:
	/* 0x3c4: lea    rsi,[rsp+0x38] */
...
x86_l_3ce:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3d1:
	/* 0x3d1: je     3aa <generic_kprobe_event+0x3aa> */
	X86_SIM_X86_JCC(X86_CC_E, 0x3d1, 0x3aa, x86_l_3aa);
x86_l_3d3:
	/* 0x3d3: mov    DWORD PTR [rsp+0x14],0x1 */
...
x86_l_3ee:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3f1:
	/* 0x3f1: je     3aa <generic_kprobe_event+0x3aa> */
	X86_SIM_X86_JCC(X86_CC_E, 0x3f1, 0x3aa, x86_l_3aa);
x86_l_3f3:
	/* 0x3f3: mov    ecx,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RCX, X86_WIDTH_32, 1ULL);
x86_l_3f8:
	/* 0x3f8: lea    rsi,[rsp+0x18] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 24ULL);
x86_l_3fd:
	/* 0x3fd: mov    rdi,rax */
...
x86_l_405:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R13, X86_WIDTH_64);
x86_l_408:
	/* 0x408: jne    3aa <generic_kprobe_event+0x3aa> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x408, 0x3aa, x86_l_3aa);
x86_l_40a:
	/* 0x40a: jmp    218 <generic_kprobe_event+0x218> */
	X86_SIM_X86_JMP(0x40a, 0x218, x86_l_218);
x86_l_40f:
