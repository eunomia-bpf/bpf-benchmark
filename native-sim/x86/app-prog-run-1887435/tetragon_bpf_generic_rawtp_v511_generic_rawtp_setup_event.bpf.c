...
x86_l_25:
	/* 0x25: je     197 <generic_rawtp_setup_event+0x197> */
...
x86_l_43:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_46:
	/* 0x46: je     197 <generic_rawtp_setup_event+0x197> */
...
x86_l_144:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_147:
	/* 0x147: je     16b <generic_rawtp_setup_event+0x16b> */
...
x86_l_160:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_163:
	/* 0x163: je     16b <generic_rawtp_setup_event+0x16b> */
...
x86_l_169:
	/* 0x169: jne    181 <generic_rawtp_setup_event+0x181> */
...
x86_l_19d:
	/* 0x19d: jmp    1a2 <generic_rawtp_setup_event+0x1a2> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_1a2:
