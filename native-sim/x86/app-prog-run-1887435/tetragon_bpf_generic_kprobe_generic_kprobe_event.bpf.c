...
x86_l_26:
	/* 0x26: je     38d <generic_kprobe_event+0x38d> */
	X86_SIM_X86_JCC(X86_CC_E, 0x26, 0x38d, x86_l_38d);
x86_l_2c:
	/* 0x2c: mov    r14,rax */
...
x86_l_51:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_54:
	/* 0x54: je     38d <generic_kprobe_event+0x38d> */
	X86_SIM_X86_JCC(X86_CC_E, 0x54, 0x38d, x86_l_38d);
x86_l_5a:
...
x86_l_7f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_82:
	/* 0x82: je     38d <generic_kprobe_event+0x38d> */
	X86_SIM_X86_JCC(X86_CC_E, 0x82, 0x38d, x86_l_38d);
x86_l_88:
	/* 0x88: mov    r15,rax */
...
x86_l_ca:
	/* 0xca: jmp    38d <generic_kprobe_event+0x38d> */
	X86_SIM_X86_JMP(0xca, 0x38d, x86_l_38d);
x86_l_cf:
	/* 0xcf: xor    ebp,ebp */
...
x86_l_104:
	/* 0x104: je     38d <generic_kprobe_event+0x38d> */
	X86_SIM_X86_JCC(X86_CC_E, 0x104, 0x38d, x86_l_38d);
x86_l_10a:
	/* 0x10a: cmp    ebp,0xb */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBP, X86_WIDTH_32, 11ULL);
x86_l_10d:
	/* 0x10d: ja     38d <generic_kprobe_event+0x38d> */
	X86_SIM_X86_JCC(X86_CC_A, 0x10d, 0x38d, x86_l_38d);
x86_l_113:
	/* 0x113: mov    edx,ebp */
...
x86_l_135:
	/* 0x135: je     38d <generic_kprobe_event+0x38d> */
	X86_SIM_X86_JCC(X86_CC_E, 0x135, 0x38d, x86_l_38d);
x86_l_13b:
	/* 0x13b: mov    eax,0x71 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 113ULL);
x86_l_140:
...
x86_l_159:
	/* 0x159: je     38d <generic_kprobe_event+0x38d> */
	X86_SIM_X86_JCC(X86_CC_E, 0x159, 0x38d, x86_l_38d);
x86_l_15f:
...
x86_l_1b7:
	/* 0x1b7: jmp    38d <generic_kprobe_event+0x38d> */
	X86_SIM_X86_JMP(0x1b7, 0x38d, x86_l_38d);
x86_l_1bc:
	/* 0x1bc: xor    eax,eax */
...
x86_l_1c3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1c6:
	/* 0x1c6: je     38d <generic_kprobe_event+0x38d> */
	X86_SIM_X86_JCC(X86_CC_E, 0x1c6, 0x38d, x86_l_38d);
x86_l_1cc:
...
x86_l_20b:
	/* 0x20b: je     399 <generic_kprobe_event+0x399> */
	X86_SIM_X86_JCC(X86_CC_E, 0x20b, 0x399, x86_l_399);
x86_l_211:
...
x86_l_21f:
	/* 0x21f: mov    QWORD PTR [r14+0x5eec],0x0 */
...
x86_l_22a:
	/* 0x22a: mov    DWORD PTR [r14+0x6410],0x0 */
...
x86_l_36a:
	/* 0x36a: mov    BYTE PTR [r14+0x5ef8],0x0 */
...
x86_l_37c:
	/* 0x37c: mov    rsi,QWORD PTR [rip+0x0] */
...
x86_l_394:
	/* 0x394: jmp    3f2 <generic_kprobe_event+0x3f2> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_399:
	/* 0x399: mov    QWORD PTR [rsp+0x38],0xffffffffffffffff */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 244813135871ULL);
x86_l_3a2:
	/* 0x3a2: mov    eax,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_3a7:
	/* 0x3a7: lea    rsi,[rsp+0x38] */
...
x86_l_3b1:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3b4:
	/* 0x3b4: je     38d <generic_kprobe_event+0x38d> */
	X86_SIM_X86_JCC(X86_CC_E, 0x3b4, 0x38d, x86_l_38d);
x86_l_3b6:
	/* 0x3b6: mov    DWORD PTR [rsp+0x14],0x1 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 85899345921ULL);
x86_l_3be:
	/* 0x3be: mov    eax,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_3c3:
	/* 0x3c3: mov    rdi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&policy_filter_maps)));
x86_l_3ca:
	/* 0x3ca: lea    rsi,[rsp+0x14] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 20ULL);
x86_l_3cf:
	/* 0x3cf: call   rax */
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_3d1:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3d4:
	/* 0x3d4: je     38d <generic_kprobe_event+0x38d> */
	X86_SIM_X86_JCC(X86_CC_E, 0x3d4, 0x38d, x86_l_38d);
x86_l_3d6:
	/* 0x3d6: mov    ecx,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RCX, X86_WIDTH_32, 1ULL);
x86_l_3db:
	/* 0x3db: lea    rsi,[rsp+0x18] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 24ULL);
x86_l_3e0:
	/* 0x3e0: mov    rdi,rax */
...
x86_l_3e8:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R13, X86_WIDTH_64);
x86_l_3eb:
	/* 0x3eb: jne    38d <generic_kprobe_event+0x38d> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x3eb, 0x38d, x86_l_38d);
x86_l_3ed:
	/* 0x3ed: jmp    211 <generic_kprobe_event+0x211> */
	X86_SIM_X86_JMP(0x3ed, 0x211, x86_l_211);
x86_l_3f2:
