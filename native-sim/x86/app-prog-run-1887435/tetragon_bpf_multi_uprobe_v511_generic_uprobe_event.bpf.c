...
x86_l_26:
	/* 0x26: je     3aa <generic_uprobe_event+0x3aa> */
...
x86_l_58:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5b:
	/* 0x5b: je     3aa <generic_uprobe_event+0x3aa> */
...
x86_l_6a:
	/* 0x6a: je     218 <generic_uprobe_event+0x218> */
...
x86_l_86:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_89:
	/* 0x89: je     3aa <generic_uprobe_event+0x3aa> */
...
x86_l_ad:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_b0:
	/* 0xb0: je     d6 <generic_uprobe_event+0xd6> */
...
x86_l_ba:
	/* 0xba: jne    da <generic_uprobe_event+0xda> */
...
x86_l_c8:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_cb:
	/* 0xcb: jne    1d3 <generic_uprobe_event+0x1d3> */
	X86_SIM_X86_JCC(X86_CC_NE, 0xcb, 0x1d3, x86_l_1d3);
x86_l_d1:
	/* 0xd1: jmp    3aa <generic_uprobe_event+0x3aa> */
	X86_SIM_X86_JMP(0xd1, 0x3aa, x86_l_3aa);
x86_l_d6:
	/* 0xd6: xor    ebp,ebp */
	X86_SIM_L_EXEC_ALU_REG(X86_RBP, X86_RBP, X86_WIDTH_32, X86_ALU_XOR);
x86_l_d8:
	/* 0xd8: jmp    dd <generic_uprobe_event+0xdd> */
...
x86_l_13c:
	/* 0x13c: je     3aa <generic_uprobe_event+0x3aa> */
...
x86_l_160:
	/* 0x160: je     3aa <generic_uprobe_event+0x3aa> */
...
x86_l_195:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RDX, X86_RDX, X86_WIDTH_64);
x86_l_198:
	/* 0x198: je     1c3 <generic_uprobe_event+0x1c3> */
...
x86_l_1b9:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1bc:
	/* 0x1bc: jne    1d3 <generic_uprobe_event+0x1d3> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x1bc, 0x1d3, x86_l_1d3);
x86_l_1be:
	/* 0x1be: jmp    3aa <generic_uprobe_event+0x3aa> */
...
x86_l_1ca:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1cd:
	/* 0x1cd: je     3aa <generic_uprobe_event+0x3aa> */
...
x86_l_1eb:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1ee:
	/* 0x1ee: je     1fd <generic_uprobe_event+0x1fd> */
...
x86_l_1f3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1f6:
	/* 0x1f6: je     1fd <generic_uprobe_event+0x1fd> */
...
x86_l_212:
	/* 0x212: je     3b6 <generic_uprobe_event+0x3b6> */
...
x86_l_28c:
	/* 0x28c: je     352 <generic_uprobe_event+0x352> */
...
x86_l_2da:
	/* 0x2da: je     2f5 <generic_uprobe_event+0x2f5> */
...
x86_l_2f3:
	/* 0x2f3: jmp    2f8 <generic_uprobe_event+0x2f8> */
...
x86_l_32d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_330:
	/* 0x330: je     34a <generic_uprobe_event+0x34a> */
...
x86_l_339:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_33c:
	/* 0x33c: je     34a <generic_uprobe_event+0x34a> */
...
x86_l_348:
	/* 0x348: jmp    352 <generic_uprobe_event+0x352> */
...
x86_l_3b1:
	/* 0x3b1: jmp    40f <generic_uprobe_event+0x40f> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_3b6:
...
x86_l_3ce:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3d1:
	/* 0x3d1: je     3aa <generic_uprobe_event+0x3aa> */
...
x86_l_3ee:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3f1:
	/* 0x3f1: je     3aa <generic_uprobe_event+0x3aa> */
...
x86_l_405:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R13, X86_WIDTH_64);
x86_l_408:
	/* 0x408: jne    3aa <generic_uprobe_event+0x3aa> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x408, 0x3aa, x86_l_3aa);
x86_l_40a:
	/* 0x40a: jmp    218 <generic_uprobe_event+0x218> */
