...
SEC("xdp")
int tetragon_bpf_generic_fentry_v511_generic_fentry_output_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_14:
	/* 0x14: mov    rdi,QWORD PTR [rip+0x20567] */
...
x86_l_25:
	/* 0x25: je     262 <generic_fentry_output+0x262> */
...
x86_l_36:
	/* 0x36: je     14d <generic_fentry_output+0x14d> */
...
x86_l_59:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_5e:
	/* 0x5e: mov    rdi,QWORD PTR [rip+0x20567] */
...
x86_l_6c:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_6f:
	/* 0x6f: je     14d <generic_fentry_output+0x14d> */
...
x86_l_7f:
	/* 0x7f: je     14d <generic_fentry_output+0x14d> */
...
x86_l_cd:
	/* 0xcd: je     e8 <generic_fentry_output+0xe8> */
...
x86_l_e6:
	/* 0xe6: jmp    eb <generic_fentry_output+0xeb> */
...
x86_l_11c:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_11f:
	/* 0x11f: je     146 <generic_fentry_output+0x146> */
...
x86_l_128:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_12b:
	/* 0x12b: je     321 <generic_fentry_output+0x321> */
...
x86_l_142:
	/* 0x142: jne    157 <generic_fentry_output+0x157> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x142, 0x157, x86_l_157);
x86_l_144:
	/* 0x144: jmp    1ab <generic_fentry_output+0x1ab> */
...
x86_l_14d:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 104384885161984ULL);
x86_l_155:
	/* 0x155: je     1ab <generic_fentry_output+0x1ab> */
...
x86_l_174:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_179:
	/* 0x179: mov    rdi,QWORD PTR [rip+0x20567] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&execve_map)));
x86_l_180:
...
x86_l_187:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_18a:
	/* 0x18a: je     1ab <generic_fentry_output+0x1ab> */
...
x86_l_1d0:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_1d5:
	/* 0x1d5: mov    rdi,QWORD PTR [rip+0x20567] */
...
x86_l_1e3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1e6:
	/* 0x1e6: je     222 <generic_fentry_output+0x222> */
...
x86_l_1ec:
	/* 0x1ec: je     222 <generic_fentry_output+0x222> */
	X86_SIM_X86_JCC(X86_CC_E, 0x1ec, 0x222, x86_l_222);
x86_l_1ee:
	/* 0x1ee: mov    eax,0x19 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 25ULL);
x86_l_1f3:
	/* 0x1f3: mov    rsi,QWORD PTR [rip+0x20567] */
...
x86_l_20a:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_20d:
	/* 0x20d: js     2bc <generic_fentry_output+0x2bc> */
...
x86_l_238:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_23b:
	/* 0x23b: js     26d <generic_fentry_output+0x26d> */
...
x86_l_245:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_24a:
	/* 0x24a: mov    rdi,QWORD PTR [rip+0x20567] */
...
x86_l_258:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_25b:
	/* 0x25b: je     262 <generic_fentry_output+0x262> */
...
x86_l_268:
	/* 0x268: jmp    389 <generic_fentry_output+0x389> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_26d:
	/* 0x26d: mov    rbx,rax */
...
x86_l_278:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_27d:
	/* 0x27d: mov    rdi,QWORD PTR [rip+0x2056a] */
...
x86_l_2ba:
	/* 0x2ba: jmp    262 <generic_fentry_output+0x262> */
...
x86_l_2c7:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_2cc:
	/* 0x2cc: mov    rdi,QWORD PTR [rip+0x2056a] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_stats_map)));
x86_l_2d3:
...
x86_l_318:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_31c:
	/* 0x31c: jmp    262 <generic_fentry_output+0x262> */
...
x86_l_353:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_357:
	/* 0x357: jmp    262 <generic_fentry_output+0x262> */
...
x86_l_362:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_366:
	/* 0x366: jmp    262 <generic_fentry_output+0x262> */
...
x86_l_371:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_375:
	/* 0x375: jmp    262 <generic_fentry_output+0x262> */
...
x86_l_380:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_384:
	/* 0x384: jmp    262 <generic_fentry_output+0x262> */
