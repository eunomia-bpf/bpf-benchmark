...
SEC("xdp")
int tetragon_bpf_generic_tracepoint_v61_filter_char_buf_postfix_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_1a:
	/* 0x1a: mov    rdi,QWORD PTR [rip+0x1eb5] */
...
x86_l_3e:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_43:
	/* 0x43: mov    rdi,QWORD PTR [rip+0x1eb5] */
