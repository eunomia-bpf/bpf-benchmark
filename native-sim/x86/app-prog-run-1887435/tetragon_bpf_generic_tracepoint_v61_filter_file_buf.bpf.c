...
SEC("xdp")
int tetragon_bpf_generic_tracepoint_v61_filter_file_buf_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_27a:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_27f:
	/* 0x27f: mov    rdi,QWORD PTR [rip+0x1ac0] */
...
x86_l_293:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_298:
	/* 0x298: mov    rdi,QWORD PTR [rip+0x1ac0] */
...
x86_l_36c:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_371:
	/* 0x371: mov    rdi,QWORD PTR [rip+0x1ac0] */
...
x86_l_39d:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_3a2:
	/* 0x3a2: mov    rdi,QWORD PTR [rip+0x1ac0] */
...
x86_l_3c8:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_3cd:
	/* 0x3cd: mov    rdi,QWORD PTR [rip+0x1ac0] */
...
x86_l_3e8:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_3ed:
	/* 0x3ed: mov    rdi,QWORD PTR [rip+0x1abd] */
...
x86_l_3f6:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_3fb:
	/* 0x3fb: mov    rdi,QWORD PTR [rip+0x1abd] */
...
x86_l_404:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_409:
	/* 0x409: mov    rdi,QWORD PTR [rip+0x1abd] */
...
x86_l_412:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_417:
	/* 0x417: mov    rdi,QWORD PTR [rip+0x1abd] */
...
x86_l_420:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_425:
	/* 0x425: mov    rdi,QWORD PTR [rip+0x1abd] */
...
x86_l_42e:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_433:
	/* 0x433: mov    rdi,QWORD PTR [rip+0x1abd] */
...
x86_l_43c:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_441:
	/* 0x441: mov    rdi,QWORD PTR [rip+0x1abd] */
...
x86_l_44a:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_44f:
	/* 0x44f: mov    rdi,QWORD PTR [rip+0x1abd] */
...
x86_l_4a8:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_4ad:
	/* 0x4ad: mov    rdi,QWORD PTR [rip+0x1eb0] */
...
x86_l_4d1:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_4d6:
	/* 0x4d6: mov    rdi,QWORD PTR [rip+0x1eb0] */
...
x86_l_5ef:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_5f4:
	/* 0x5f4: mov    rdi,QWORD PTR [rip+0x1e00] */
...
x86_l_610:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_615:
	/* 0x615: mov    rdi,QWORD PTR [rip+0x1e00] */
