...
x86_l_26:
	/* 0x26: je     38d <generic_uprobe_event+0x38d> */
...
x86_l_51:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_54:
	/* 0x54: je     38d <generic_uprobe_event+0x38d> */
...
x86_l_7f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_82:
	/* 0x82: je     38d <generic_uprobe_event+0x38d> */
...
x86_l_ca:
	/* 0xca: jmp    38d <generic_uprobe_event+0x38d> */
...
x86_l_135:
	/* 0x135: je     38d <generic_uprobe_event+0x38d> */
...
x86_l_159:
	/* 0x159: je     38d <generic_uprobe_event+0x38d> */
...
x86_l_1b7:
	/* 0x1b7: jmp    38d <generic_uprobe_event+0x38d> */
...
x86_l_1c3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1c6:
	/* 0x1c6: je     38d <generic_uprobe_event+0x38d> */
...
x86_l_20b:
	/* 0x20b: je     399 <generic_uprobe_event+0x399> */
...
x86_l_394:
	/* 0x394: jmp    3f2 <generic_uprobe_event+0x3f2> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_399:
...
x86_l_3b1:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3b4:
	/* 0x3b4: je     38d <generic_uprobe_event+0x38d> */
...
x86_l_3d1:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3d4:
	/* 0x3d4: je     38d <generic_uprobe_event+0x38d> */
...
x86_l_3e8:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R13, X86_WIDTH_64);
x86_l_3eb:
	/* 0x3eb: jne    38d <generic_uprobe_event+0x38d> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x3eb, 0x38d, x86_l_38d);
x86_l_3ed:
	/* 0x3ed: jmp    211 <generic_uprobe_event+0x211> */
