...
x86_l_14:
	/* 0x14: mov    rdi,QWORD PTR [rip+0x5896] */
...
x86_l_45:
	/* 0x45: mov    rdi,QWORD PTR [rip+0x5892] */
...
x86_l_7a:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_7f:
	/* 0x7f: mov    rdi,QWORD PTR [rip+0x5892] */
...
x86_l_b6:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_bb:
	/* 0xbb: mov    rdi,QWORD PTR [rip+0x5892] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_c2:
...
x86_l_152:
	/* 0x152: mov    rdi,QWORD PTR [rip+0x5892] */
...
x86_l_180:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_185:
	/* 0x185: mov    rdi,QWORD PTR [rip+0x5892] */
...
x86_l_1a0:
	/* 0x1a0: mov    rdi,QWORD PTR [rip+0x5892] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&override_tasks)));
x86_l_1a7:
...
x86_l_247:
	/* 0x247: mov    rsi,QWORD PTR [rip+0x5893] */
