...
SEC("xdp")
int tetragon_bpf_generic_tracepoint_v61_filter_8ty_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_15:
	/* 0x15: jae    22 <filter_8ty+0x22> */
	X86_SIM_X86_JCC(X86_CC_AE, 0x15, 0x22, x86_l_22);
x86_l_17:
	/* 0x17: call   53 <filter_8ty_selector_val> */
	X86_SIM_X86_CALL(x86_l_53, 0x1cULL);
x86_l_1c:
	/* 0x1c: pop    rcx */
	X86_SIM_L_EXEC_POP(X86_RCX, X86_WIDTH_64);
x86_l_1d:
	/* 0x1d: jmp    4ab <filter_8ty_map+0x86> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_22:
	/* 0x22: mov    edx,0xc00 */
...
x86_l_37:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_64);
x86_l_3b:
	/* 0x3b: jae    4d <filter_8ty+0x4d> */
	X86_SIM_X86_JCC(X86_CC_AE, 0x3b, 0x4d, x86_l_4d);
x86_l_3d:
	/* 0x3d: call   26d <filter_8ty_range> */
	X86_SIM_X86_CALL(x86_l_26d, 0x42ULL);
x86_l_42:
	/* 0x42: pop    rcx */
	X86_SIM_L_EXEC_POP(X86_RCX, X86_WIDTH_64);
x86_l_43:
	/* 0x43: jmp    4ab <filter_8ty_map+0x86> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_48:
	/* 0x48: call   425 <filter_8ty_map> */
	X86_SIM_X86_CALL(x86_l_425, 0x4dULL);
x86_l_4d:
	/* 0x4d: pop    rcx */
	X86_SIM_L_EXEC_POP(X86_RCX, X86_WIDTH_64);
x86_l_4e:
	/* 0x4e: jmp    4ab <filter_8ty_map+0x86> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_4ab:
...
x86_l_5f:
	/* 0x5f: ja     d2 <filter_8ty_selector_val+0x7f> */
...
x86_l_6b:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_64);
x86_l_6f:
	/* 0x6f: jae    72 <filter_8ty_selector_val+0x1f> */
...
x86_l_77:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_64);
x86_l_7b:
	/* 0x7b: jae    92 <filter_8ty_selector_val+0x3f> */
	X86_SIM_X86_SUB_JCC(X86_CC_AE, 0x7b, 0x92, x86_l_92);
x86_l_7d:
	/* 0x7d: movzx  edx,BYTE PTR [rsi] */
...
x86_l_83:
	/* 0x83: jne    1a8 <filter_8ty_selector_val+0x155> */
...
x86_l_96:
	/* 0x96: jne    d2 <filter_8ty_selector_val+0x7f> */
	X86_SIM_X86_SUB_JCC(X86_CC_NE, 0x96, 0xd2, x86_l_d2);
x86_l_98:
	/* 0x98: movzx  ecx,BYTE PTR [rsi] */
...
x86_l_9e:
	/* 0x9e: jne    71 <filter_8ty_selector_val+0x1e> */
...
x86_l_a6:
	/* 0xa6: jb     26a <filter_8ty_selector_val+0x217> */
...
x86_l_cb:
	/* 0xcb: jne    71 <filter_8ty_selector_val+0x1e> */
	X86_SIM_X86_SUB_JCC(X86_CC_NE, 0xcb, 0x71, x86_l_71);
x86_l_cd:
	/* 0xcd: jmp    26a <filter_8ty_selector_val+0x217> */
	X86_SIM_X86_SUB_JMP(0xcd, 0x26a, x86_l_26a);
x86_l_d2:
	/* 0xd2: cmp    ecx,0x1 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 1ULL);
x86_l_d5:
	/* 0xd5: je     144 <filter_8ty_selector_val+0xf1> */
	X86_SIM_X86_SUB_JCC(X86_CC_E, 0xd5, 0x144, x86_l_144);
x86_l_d7:
	/* 0xd7: cmp    ecx,0x2 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 2ULL);
x86_l_da:
	/* 0xda: jne    26a <filter_8ty_selector_val+0x217> */
...
x86_l_e6:
	/* 0xe6: ja     231 <filter_8ty_selector_val+0x1de> */
...
x86_l_f4:
	/* 0xf4: jae    231 <filter_8ty_selector_val+0x1de> */
	X86_SIM_X86_SUB_JCC(X86_CC_AE, 0xf4, 0x231, x86_l_231);
x86_l_fa:
	/* 0xfa: movsx  ecx,BYTE PTR [rsi] */
...
x86_l_100:
	/* 0x100: jg     71 <filter_8ty_selector_val+0x1e> */
...
x86_l_109:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDX, X86_WIDTH_32, 13ULL);
x86_l_10c:
	/* 0x10c: jb     26a <filter_8ty_selector_val+0x217> */
...
x86_l_115:
	/* 0x115: jg     71 <filter_8ty_selector_val+0x1e> */
	X86_SIM_X86_SUB_JCC(X86_CC_G, 0x115, 0x71, x86_l_71);
x86_l_11b:
	/* 0x11b: cmp    edx,0x11 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDX, X86_WIDTH_32, 17ULL);
x86_l_11e:
	/* 0x11e: jb     26a <filter_8ty_selector_val+0x217> */
...
x86_l_127:
	/* 0x127: jg     71 <filter_8ty_selector_val+0x1e> */
	X86_SIM_X86_SUB_JCC(X86_CC_G, 0x127, 0x71, x86_l_71);
x86_l_12d:
	/* 0x12d: cmp    edx,0x15 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDX, X86_WIDTH_32, 21ULL);
x86_l_130:
	/* 0x130: jb     26a <filter_8ty_selector_val+0x217> */
...
x86_l_139:
	/* 0x139: jg     71 <filter_8ty_selector_val+0x1e> */
	X86_SIM_X86_SUB_JCC(X86_CC_G, 0x139, 0x71, x86_l_71);
x86_l_13f:
	/* 0x13f: jmp    26a <filter_8ty_selector_val+0x217> */
...
x86_l_147:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 12ULL);
x86_l_14a:
	/* 0x14a: ja     1f6 <filter_8ty_selector_val+0x1a3> */
...
x86_l_155:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_32);
x86_l_158:
	/* 0x158: jae    1f6 <filter_8ty_selector_val+0x1a3> */
	X86_SIM_X86_SUB_JCC(X86_CC_AE, 0x158, 0x1f6, x86_l_1f6);
x86_l_15e:
	/* 0x15e: movsx  ecx,BYTE PTR [rsi] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOVSX_LOAD, X86_RCX, X86_RSI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 0ULL);
x86_l_161:
	/* 0x161: cmp    DWORD PTR [rdi+0x10],ecx */
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_REG, X86_RDI, X86_RCX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 16ULL);
x86_l_164:
	/* 0x164: jl     71 <filter_8ty_selector_val+0x1e> */
...
x86_l_1ae:
	/* 0x1ae: jb     1d5 <filter_8ty_selector_val+0x182> */
...
x86_l_1ea:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_64);
x86_l_1ee:
	/* 0x1ee: jb     71 <filter_8ty_selector_val+0x1e> */
	X86_SIM_X86_SUB_JCC(X86_CC_B, 0x1ee, 0x71, x86_l_71);
x86_l_1f4:
	/* 0x1f4: jmp    26a <filter_8ty_selector_val+0x217> */
	X86_SIM_X86_SUB_JMP(0x1f4, 0x26a, x86_l_26a);
x86_l_1f6:
	/* 0x1f6: movzx  ecx,BYTE PTR [rsi] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RCX, X86_RSI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 0ULL);
x86_l_1f9:
	/* 0x1f9: cmp    DWORD PTR [rdi+0x10],ecx */
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_REG, X86_RDI, X86_RCX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 16ULL);
x86_l_1fc:
	/* 0x1fc: jb     71 <filter_8ty_selector_val+0x1e> */
...
x86_l_276:
	/* 0x276: ja     35d <filter_8ty_range+0xf0> */
...
x86_l_284:
	/* 0x284: jae    35d <filter_8ty_range+0xf0> */
	X86_SIM_X86_SUB_JCC(X86_CC_AE, 0x284, 0x35d, x86_l_35d);
x86_l_28a:
	/* 0x28a: movsx  esi,BYTE PTR [rsi] */
...
x86_l_290:
	/* 0x290: jne    2f8 <filter_8ty_range+0x8b> */
...
x86_l_29a:
	/* 0x29a: jg     2a5 <filter_8ty_range+0x38> */
...
x86_l_29f:
	/* 0x29f: jge    374 <filter_8ty_range+0x107> */
...
x86_l_2a8:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDX, X86_WIDTH_32, 17ULL);
x86_l_2ab:
	/* 0x2ab: jb     414 <filter_8ty_range+0x1a7> */
...
x86_l_2b4:
	/* 0x2b4: jg     2bf <filter_8ty_range+0x52> */
...
x86_l_2cb:
	/* 0x2cb: jg     2d6 <filter_8ty_range+0x69> */
...
x86_l_2e4:
	/* 0x2e4: jg     416 <filter_8ty_range+0x1a9> */
...
x86_l_2ed:
	/* 0x2ed: jge    374 <filter_8ty_range+0x107> */
	X86_SIM_X86_SUB_JCC(X86_CC_GE, 0x2ed, 0x374, x86_l_374);
x86_l_2f3:
	/* 0x2f3: jmp    416 <filter_8ty_range+0x1a9> */
...
x86_l_30e:
	/* 0x30e: jb     416 <filter_8ty_range+0x1a9> */
...
x86_l_32b:
	/* 0x32b: jb     416 <filter_8ty_range+0x1a9> */
...
x86_l_348:
	/* 0x348: jb     416 <filter_8ty_range+0x1a9> */
...
x86_l_388:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RAX, X86_WIDTH_32, 17ULL);
x86_l_38b:
	/* 0x38b: jb     416 <filter_8ty_range+0x1a9> */
...
x86_l_3a5:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RAX, X86_WIDTH_32, 25ULL);
x86_l_3a8:
	/* 0x3a8: jb     416 <filter_8ty_range+0x1a9> */
...
x86_l_3be:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RAX, X86_WIDTH_32, 33ULL);
x86_l_3c1:
	/* 0x3c1: jb     416 <filter_8ty_range+0x1a9> */
...
x86_l_3d6:
	/* 0x3d6: jmp    416 <filter_8ty_range+0x1a9> */
...
x86_l_472:
	/* 0x472: ja     4a0 <filter_8ty_map+0x7b> */
...
x86_l_47c:
	/* 0x47c: jae    490 <filter_8ty_map+0x6b> */
...
x86_l_484:
	/* 0x484: jmp    4a0 <filter_8ty_map+0x7b> */
...
x86_l_495:
	...
	X86_SIM_L_EXEC_BT(X86_RSI, X86_RDX, X86_WIDTH_32);
x86_l_498:
	/* 0x498: jae    4a0 <filter_8ty_map+0x7b> */
