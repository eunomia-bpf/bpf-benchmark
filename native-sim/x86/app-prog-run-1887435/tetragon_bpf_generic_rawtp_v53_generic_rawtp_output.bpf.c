...
x86_l_11:
	/* 0x11: mov    rdi,QWORD PTR [rip+0x1f657] */
...
x86_l_22:
	/* 0x22: je     2aa <generic_rawtp_output+0x2aa> */
...
x86_l_33:
	/* 0x33: je     147 <generic_rawtp_output+0x147> */
...
x86_l_55:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_5a:
	/* 0x5a: mov    rdi,QWORD PTR [rip+0x1f657] */
...
x86_l_66:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_69:
	/* 0x69: je     147 <generic_rawtp_output+0x147> */
...
x86_l_79:
	/* 0x79: je     147 <generic_rawtp_output+0x147> */
...
x86_l_c7:
	/* 0xc7: je     e2 <generic_rawtp_output+0xe2> */
...
x86_l_e0:
	/* 0xe0: jmp    e5 <generic_rawtp_output+0xe5> */
...
x86_l_116:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_119:
	/* 0x119: je     140 <generic_rawtp_output+0x140> */
...
x86_l_122:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_125:
	/* 0x125: je     266 <generic_rawtp_output+0x266> */
...
x86_l_13c:
	/* 0x13c: jne    151 <generic_rawtp_output+0x151> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x13c, 0x151, x86_l_151);
x86_l_13e:
	/* 0x13e: jmp    1a2 <generic_rawtp_output+0x1a2> */
...
x86_l_147:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 104384885161984ULL);
x86_l_14f:
	/* 0x14f: je     1a2 <generic_rawtp_output+0x1a2> */
...
x86_l_16d:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_172:
	/* 0x172: mov    rdi,QWORD PTR [rip+0x1f657] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&execve_map)));
x86_l_179:
	/* 0x179: mov    rsi,rsp */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RSP, X86_WIDTH_64);
...
x86_l_17e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_181:
	/* 0x181: je     1a2 <generic_rawtp_output+0x1a2> */
...
x86_l_1c4:
	/* 0x1c4: mov    rsi,QWORD PTR [rip+0x1f657] */
...
x86_l_1d8:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1db:
	/* 0x1db: js     208 <generic_rawtp_output+0x208> */
...
x86_l_1e4:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_1e9:
	/* 0x1e9: mov    rdi,QWORD PTR [rip+0x1f657] */
...
x86_l_1f5:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1f8:
	/* 0x1f8: je     2aa <generic_rawtp_output+0x2aa> */
...
x86_l_203:
	/* 0x203: jmp    2aa <generic_rawtp_output+0x2aa> */
...
x86_l_212:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_217:
	/* 0x217: mov    rdi,QWORD PTR [rip+0x1f657] */
...
x86_l_2b0:
	/* 0x2b0: jmp    2b5 <generic_rawtp_output+0x2b5> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_2b5:
