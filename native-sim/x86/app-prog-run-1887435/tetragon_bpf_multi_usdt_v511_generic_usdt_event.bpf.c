...
x86_l_26:
	/* 0x26: je     3aa <generic_usdt_event+0x3aa> */
...
x86_l_58:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5b:
	/* 0x5b: je     3aa <generic_usdt_event+0x3aa> */
...
x86_l_86:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_89:
	/* 0x89: je     3aa <generic_usdt_event+0x3aa> */
...
x86_l_d1:
	/* 0xd1: jmp    3aa <generic_usdt_event+0x3aa> */
...
x86_l_13c:
	/* 0x13c: je     3aa <generic_usdt_event+0x3aa> */
...
x86_l_160:
	/* 0x160: je     3aa <generic_usdt_event+0x3aa> */
...
x86_l_1be:
	/* 0x1be: jmp    3aa <generic_usdt_event+0x3aa> */
...
x86_l_1ca:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1cd:
	/* 0x1cd: je     3aa <generic_usdt_event+0x3aa> */
...
x86_l_212:
	/* 0x212: je     3b6 <generic_usdt_event+0x3b6> */
...
x86_l_28c:
	/* 0x28c: je     352 <generic_usdt_event+0x352> */
...
x86_l_2da:
	/* 0x2da: je     2f5 <generic_usdt_event+0x2f5> */
...
x86_l_2f3:
	/* 0x2f3: jmp    2f8 <generic_usdt_event+0x2f8> */
...
x86_l_32d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_330:
	/* 0x330: je     34a <generic_usdt_event+0x34a> */
...
x86_l_339:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_33c:
	/* 0x33c: je     34a <generic_usdt_event+0x34a> */
...
x86_l_348:
	/* 0x348: jmp    352 <generic_usdt_event+0x352> */
...
x86_l_3b1:
	/* 0x3b1: jmp    40f <generic_usdt_event+0x40f> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_3b6:
...
x86_l_3ce:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3d1:
	/* 0x3d1: je     3aa <generic_usdt_event+0x3aa> */
...
x86_l_3ee:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3f1:
	/* 0x3f1: je     3aa <generic_usdt_event+0x3aa> */
...
x86_l_405:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R13, X86_WIDTH_64);
x86_l_408:
	/* 0x408: jne    3aa <generic_usdt_event+0x3aa> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x408, 0x3aa, x86_l_3aa);
x86_l_40a:
	/* 0x40a: jmp    218 <generic_usdt_event+0x218> */
