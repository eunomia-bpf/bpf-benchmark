...
x86_l_26:
	/* 0x26: je     39f <generic_kprobe_event+0x39f> */
...
x86_l_58:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5b:
	/* 0x5b: je     39f <generic_kprobe_event+0x39f> */
...
x86_l_86:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_89:
	/* 0x89: je     39f <generic_kprobe_event+0x39f> */
...
x86_l_d1:
	/* 0xd1: jmp    39f <generic_kprobe_event+0x39f> */
...
x86_l_13c:
	/* 0x13c: je     39f <generic_kprobe_event+0x39f> */
...
x86_l_160:
	/* 0x160: je     39f <generic_kprobe_event+0x39f> */
...
x86_l_1be:
	/* 0x1be: jmp    39f <generic_kprobe_event+0x39f> */
...
x86_l_1ca:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1cd:
	/* 0x1cd: je     39f <generic_kprobe_event+0x39f> */
...
x86_l_212:
	/* 0x212: je     3ab <generic_kprobe_event+0x3ab> */
...
x86_l_281:
	/* 0x281: je     347 <generic_kprobe_event+0x347> */
...
x86_l_2cf:
	/* 0x2cf: je     2ea <generic_kprobe_event+0x2ea> */
...
x86_l_2e8:
	/* 0x2e8: jmp    2ed <generic_kprobe_event+0x2ed> */
...
x86_l_322:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_325:
	/* 0x325: je     33f <generic_kprobe_event+0x33f> */
...
x86_l_32e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_331:
	/* 0x331: je     33f <generic_kprobe_event+0x33f> */
...
x86_l_33d:
	/* 0x33d: jmp    347 <generic_kprobe_event+0x347> */
...
x86_l_3a6:
	/* 0x3a6: jmp    404 <generic_kprobe_event+0x404> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_3ab:
...
x86_l_3c3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3c6:
	/* 0x3c6: je     39f <generic_kprobe_event+0x39f> */
...
x86_l_3e3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3e6:
	/* 0x3e6: je     39f <generic_kprobe_event+0x39f> */
...
x86_l_3fa:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R13, X86_WIDTH_64);
x86_l_3fd:
	/* 0x3fd: jne    39f <generic_kprobe_event+0x39f> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x3fd, 0x39f, x86_l_39f);
x86_l_3ff:
	/* 0x3ff: jmp    218 <generic_kprobe_event+0x218> */
