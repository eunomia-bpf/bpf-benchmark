...
SEC("xdp")
int tetragon_bpf_generic_retuprobe_v61_filter_sockaddr_un_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_1d9:
	/* 0x1d9: mov    rdi,QWORD PTR [rip+0x1a40] */
...
x86_l_1ed:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_1f2:
	/* 0x1f2: mov    rdi,QWORD PTR [rip+0x1a40] */
...
x86_l_2c6:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_2cb:
	/* 0x2cb: mov    rdi,QWORD PTR [rip+0x1a40] */
...
x86_l_2f7:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_2fc:
	/* 0x2fc: mov    rdi,QWORD PTR [rip+0x1a40] */
...
x86_l_322:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_327:
	/* 0x327: mov    rdi,QWORD PTR [rip+0x1a40] */
...
x86_l_342:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_347:
	/* 0x347: mov    rdi,QWORD PTR [rip+0x1a3d] */
...
x86_l_350:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_355:
	/* 0x355: mov    rdi,QWORD PTR [rip+0x1a3d] */
...
x86_l_35e:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_363:
	/* 0x363: mov    rdi,QWORD PTR [rip+0x1a3d] */
...
x86_l_36c:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_371:
	/* 0x371: mov    rdi,QWORD PTR [rip+0x1a3d] */
...
x86_l_37a:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_37f:
	/* 0x37f: mov    rdi,QWORD PTR [rip+0x1a3d] */
...
x86_l_388:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_38d:
	/* 0x38d: mov    rdi,QWORD PTR [rip+0x1a3d] */
...
x86_l_396:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_39b:
	/* 0x39b: mov    rdi,QWORD PTR [rip+0x1a3d] */
...
x86_l_3a4:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_3a9:
	/* 0x3a9: mov    rdi,QWORD PTR [rip+0x1a3d] */
...
x86_l_401:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_406:
	/* 0x406: mov    rdi,QWORD PTR [rip+0x1d80] */
...
x86_l_422:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_427:
	/* 0x427: mov    rdi,QWORD PTR [rip+0x1d80] */
...
x86_l_49f:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_4a4:
	/* 0x4a4: mov    rdi,QWORD PTR [rip+0x9a0] */
