...
SEC("xdp")
int tetragon_bpf_generic_fentry_v61_generic_fentry_output_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_14:
	/* 0x14: mov    rdi,QWORD PTR [rip+0x5ae7] */
...
x86_l_59:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_5e:
	/* 0x5e: mov    rdi,QWORD PTR [rip+0x5ae7] */
...
x86_l_174:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_179:
	/* 0x179: mov    rdi,QWORD PTR [rip+0x5ae7] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&execve_map)));
x86_l_180:
...
x86_l_1d0:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_1d5:
	/* 0x1d5: mov    rdi,QWORD PTR [rip+0x5ae7] */
...
x86_l_1f3:
	/* 0x1f3: mov    rsi,QWORD PTR [rip+0x5ae7] */
...
x86_l_227:
	/* 0x227: mov    rdi,QWORD PTR [rip+0x5ae7] */
...
x86_l_245:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_24a:
	/* 0x24a: mov    rdi,QWORD PTR [rip+0x5ae7] */
...
x86_l_278:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_27d:
	/* 0x27d: mov    rdi,QWORD PTR [rip+0x5aea] */
...
x86_l_2c7:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_2cc:
	/* 0x2cc: mov    rdi,QWORD PTR [rip+0x5aea] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_stats_map)));
x86_l_2d3:
