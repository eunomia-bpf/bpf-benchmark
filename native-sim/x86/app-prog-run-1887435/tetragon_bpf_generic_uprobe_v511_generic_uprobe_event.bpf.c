...
x86_l_26:
	/* 0x26: je     3a3 <generic_uprobe_event+0x3a3> */
...
x86_l_51:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_54:
	/* 0x54: je     3a3 <generic_uprobe_event+0x3a3> */
...
x86_l_63:
	/* 0x63: je     211 <generic_uprobe_event+0x211> */
...
x86_l_7f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_82:
	/* 0x82: je     3a3 <generic_uprobe_event+0x3a3> */
...
x86_l_a6:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_a9:
	/* 0xa9: je     cf <generic_uprobe_event+0xcf> */
...
x86_l_b3:
	/* 0xb3: jne    d3 <generic_uprobe_event+0xd3> */
...
x86_l_c1:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_c4:
	/* 0xc4: jne    1cc <generic_uprobe_event+0x1cc> */
	X86_SIM_X86_JCC(X86_CC_NE, 0xc4, 0x1cc, x86_l_1cc);
x86_l_ca:
	/* 0xca: jmp    3a3 <generic_uprobe_event+0x3a3> */
	X86_SIM_X86_JMP(0xca, 0x3a3, x86_l_3a3);
x86_l_cf:
	/* 0xcf: xor    ebp,ebp */
	X86_SIM_L_EXEC_ALU_REG(X86_RBP, X86_RBP, X86_WIDTH_32, X86_ALU_XOR);
x86_l_d1:
	/* 0xd1: jmp    d6 <generic_uprobe_event+0xd6> */
...
x86_l_135:
	/* 0x135: je     3a3 <generic_uprobe_event+0x3a3> */
...
x86_l_159:
	/* 0x159: je     3a3 <generic_uprobe_event+0x3a3> */
...
x86_l_18e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RDX, X86_RDX, X86_WIDTH_64);
x86_l_191:
	/* 0x191: je     1bc <generic_uprobe_event+0x1bc> */
...
x86_l_1b2:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1b5:
	/* 0x1b5: jne    1cc <generic_uprobe_event+0x1cc> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x1b5, 0x1cc, x86_l_1cc);
x86_l_1b7:
	/* 0x1b7: jmp    3a3 <generic_uprobe_event+0x3a3> */
...
x86_l_1c3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1c6:
	/* 0x1c6: je     3a3 <generic_uprobe_event+0x3a3> */
...
x86_l_1e4:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1e7:
	/* 0x1e7: je     1f6 <generic_uprobe_event+0x1f6> */
...
x86_l_1ec:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1ef:
	/* 0x1ef: je     1f6 <generic_uprobe_event+0x1f6> */
...
x86_l_20b:
	/* 0x20b: je     3af <generic_uprobe_event+0x3af> */
...
x86_l_285:
	/* 0x285: je     34b <generic_uprobe_event+0x34b> */
...
x86_l_2d3:
	/* 0x2d3: je     2ee <generic_uprobe_event+0x2ee> */
...
x86_l_2ec:
	/* 0x2ec: jmp    2f1 <generic_uprobe_event+0x2f1> */
...
x86_l_326:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_329:
	/* 0x329: je     343 <generic_uprobe_event+0x343> */
...
x86_l_332:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_335:
	/* 0x335: je     343 <generic_uprobe_event+0x343> */
...
x86_l_341:
	/* 0x341: jmp    34b <generic_uprobe_event+0x34b> */
...
x86_l_3aa:
	/* 0x3aa: jmp    408 <generic_uprobe_event+0x408> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_3af:
...
x86_l_3c7:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3ca:
	/* 0x3ca: je     3a3 <generic_uprobe_event+0x3a3> */
...
x86_l_3e7:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3ea:
	/* 0x3ea: je     3a3 <generic_uprobe_event+0x3a3> */
...
x86_l_3fe:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R13, X86_WIDTH_64);
x86_l_401:
	/* 0x401: jne    3a3 <generic_uprobe_event+0x3a3> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x401, 0x3a3, x86_l_3a3);
x86_l_403:
	/* 0x403: jmp    211 <generic_uprobe_event+0x211> */
