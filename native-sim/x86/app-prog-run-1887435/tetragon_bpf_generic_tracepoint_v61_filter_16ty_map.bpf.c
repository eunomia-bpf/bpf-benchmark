...
SEC("xdp")
int tetragon_bpf_generic_tracepoint_v61_filter_16ty_map_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_17:
	/* 0x17: mov    rdi,QWORD PTR [rip+0xe93] */
...
x86_l_4a:
	/* 0x4a: ja     79 <filter_16ty_map+0x79> */
...
x86_l_54:
	/* 0x54: jae    69 <filter_16ty_map+0x69> */
...
x86_l_5c:
	/* 0x5c: jmp    79 <filter_16ty_map+0x79> */
...
x86_l_64:
	/* 0x64: jmp    85 <filter_16ty_map+0x85> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_69:
...
x86_l_6e:
	...
	X86_SIM_L_EXEC_BT(X86_RSI, X86_RDX, X86_WIDTH_32);
x86_l_71:
	/* 0x71: jae    79 <filter_16ty_map+0x79> */
...
x86_l_7c:
	...
	X86_SIM_L_EXEC_ALU_IMM(X86_RSP, X86_WIDTH_64, X86_ALU_ADD, 24ULL);
x86_l_80:
	/* 0x80: jmp    85 <filter_16ty_map+0x85> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_85:
