...
x86_l_26:
	/* 0x26: je     398 <generic_kprobe_event+0x398> */
...
x86_l_51:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_54:
	/* 0x54: je     398 <generic_kprobe_event+0x398> */
...
x86_l_7f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_82:
	/* 0x82: je     398 <generic_kprobe_event+0x398> */
...
x86_l_ca:
	/* 0xca: jmp    398 <generic_kprobe_event+0x398> */
...
x86_l_135:
	/* 0x135: je     398 <generic_kprobe_event+0x398> */
...
x86_l_159:
	/* 0x159: je     398 <generic_kprobe_event+0x398> */
...
x86_l_1b7:
	/* 0x1b7: jmp    398 <generic_kprobe_event+0x398> */
...
x86_l_1c3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1c6:
	/* 0x1c6: je     398 <generic_kprobe_event+0x398> */
...
x86_l_20b:
	/* 0x20b: je     3a4 <generic_kprobe_event+0x3a4> */
...
x86_l_27a:
	/* 0x27a: je     340 <generic_kprobe_event+0x340> */
...
x86_l_2c8:
	/* 0x2c8: je     2e3 <generic_kprobe_event+0x2e3> */
...
x86_l_2e1:
	/* 0x2e1: jmp    2e6 <generic_kprobe_event+0x2e6> */
...
x86_l_31b:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_31e:
	/* 0x31e: je     338 <generic_kprobe_event+0x338> */
...
x86_l_327:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_32a:
	/* 0x32a: je     338 <generic_kprobe_event+0x338> */
...
x86_l_336:
	/* 0x336: jmp    340 <generic_kprobe_event+0x340> */
...
x86_l_39f:
	/* 0x39f: jmp    3fd <generic_kprobe_event+0x3fd> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_3a4:
...
x86_l_3bc:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3bf:
	/* 0x3bf: je     398 <generic_kprobe_event+0x398> */
...
x86_l_3dc:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3df:
	/* 0x3df: je     398 <generic_kprobe_event+0x398> */
...
x86_l_3f3:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R13, X86_WIDTH_64);
x86_l_3f6:
	/* 0x3f6: jne    398 <generic_kprobe_event+0x398> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x3f6, 0x398, x86_l_398);
x86_l_3f8:
	/* 0x3f8: jmp    211 <generic_kprobe_event+0x211> */
