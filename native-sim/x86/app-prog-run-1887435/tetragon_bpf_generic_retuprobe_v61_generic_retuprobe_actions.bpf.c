...
x86_l_25:
	/* 0x25: je     126 <generic_retuprobe_actions+0x126> */
...
x86_l_36:
	/* 0x36: jl     126 <generic_retuprobe_actions+0x126> */
...
x86_l_53:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_56:
	/* 0x56: je     126 <generic_retuprobe_actions+0x126> */
...
x86_l_93:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_96:
	/* 0x96: je     a6 <generic_retuprobe_actions+0xa6> */
...
x86_l_a2:
	/* 0xa2: jae    ae <generic_retuprobe_actions+0xae> */
	X86_SIM_X86_JCC(X86_CC_AE, 0xa2, 0xae, x86_l_ae);
x86_l_a4:
	/* 0xa4: jmp    109 <generic_retuprobe_actions+0x109> */
...
x86_l_a8:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 5ULL);
x86_l_ac:
	/* 0xac: jb     109 <generic_retuprobe_actions+0x109> */
...
x86_l_c2:
	/* 0xc2: call   0 <generic_retuprobe_actions> */
...
x86_l_d1:
	/* 0xd1: jae    109 <generic_retuprobe_actions+0x109> */
...
x86_l_e0:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_R8, X86_R13, X86_WIDTH_32);
x86_l_e3:
	/* 0xe3: call   0 <generic_retuprobe_actions> */
...
x86_l_ef:
	...
	X86_SIM_L_EXEC_CMP_REG_MEM(X86_RCX, X86_R14, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32), 0ULL);
x86_l_f2:
	/* 0xf2: jae    109 <generic_retuprobe_actions+0x109> */
...
x86_l_101:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_R8, X86_R13, X86_WIDTH_32);
x86_l_104:
	/* 0x104: call   0 <generic_retuprobe_actions> */
...
x86_l_10e:
	/* 0x10e: je     126 <generic_retuprobe_actions+0x126> */
