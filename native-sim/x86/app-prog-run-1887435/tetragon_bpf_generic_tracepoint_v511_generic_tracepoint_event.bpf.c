...
x86_l_28:
	/* 0x28: je     2c34 <generic_tracepoint_event+0x2c34> */
...
x86_l_44:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_47:
	/* 0x47: je     2c34 <generic_tracepoint_event+0x2c34> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 11316ULL;
	}
x86_l_4d:
...
x86_l_72:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_75:
	/* 0x75: je     2c34 <generic_tracepoint_event+0x2c34> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 11316ULL;
	}
x86_l_7b:
...
x86_l_bd:
	/* 0xbd: jmp    2c34 <generic_tracepoint_event+0x2c34> */
	return 11316ULL;
x86_l_c2:
	/* 0xc2: xor    ebp,ebp */
...
x86_l_140:
	/* 0x140: je     2c34 <generic_tracepoint_event+0x2c34> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 11316ULL;
	}
x86_l_146:
...
x86_l_19e:
	/* 0x19e: jmp    2c34 <generic_tracepoint_event+0x2c34> */
	return 11316ULL;
x86_l_1a3:
	/* 0x1a3: xor    eax,eax */
...
x86_l_1aa:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1ad:
	/* 0x1ad: je     2c34 <generic_tracepoint_event+0x2c34> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 11316ULL;
	}
x86_l_1b3:
...
x86_l_205:
	/* 0x205: mov    DWORD PTR [r14+0x5ef8],0x0 */
...
x86_l_41d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_420:
	/* 0x420: je     2c34 <generic_tracepoint_event+0x2c34> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 11316ULL;
	}
x86_l_426:
...
x86_l_441:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_444:
	/* 0x444: je     2c34 <generic_tracepoint_event+0x2c34> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 11316ULL;
	}
x86_l_44a:
...
x86_l_459:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_45c:
	/* 0x45c: jne    2c34 <generic_tracepoint_event+0x2c34> */
	if (X86_SIM_L_EVAL_CC(X86_CC_NE)) {
		return 11316ULL;
	}
x86_l_462:
...
x86_l_2abf:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 14ULL);
x86_l_2ac3:
	/* 0x2ac3: mov    QWORD PTR [r14+0x5efc],0x0 */
...
x86_l_2c08:
	/* 0x2c08: mov    QWORD PTR [r14+0x5ee8],0x0 */
...
x86_l_2c13:
	/* 0x2c13: mov    QWORD PTR [r14+0x5ef0],0x0 */
...
x86_l_2c23:
	/* 0x2c23: mov    rsi,QWORD PTR [rip+0x0] */
...
x86_l_2c3d:
	/* 0x2c3d: jmp    2c42 <generic_tracepoint_event+0x2c42> ; native-link entry RET */
...
int tetragon_bpf_generic_tracepoint_v511_generic_tracepoint_event_x86_sim_xdp(struct xdp_md *ctx)
{
	...
	__u64 __x86_pc = 0ULL;
	for (__u32 __x86_iter = 0; __x86_iter < 9472U; __x86_iter++) {
		...
		else if (__x86_pc >= 11044ULL && __x86_pc <= 11325ULL)
