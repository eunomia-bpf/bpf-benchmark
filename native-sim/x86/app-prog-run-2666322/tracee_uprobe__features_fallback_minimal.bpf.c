...
x86_l_43:
	/* 0x43: jne    a6 <uprobe__features_fallback_minimal+0xa6> */
...
x86_l_59:
	/* 0x59: je     60 <uprobe__features_fallback_minimal+0x60> */
	X86_SIM_X86_JCC(X86_CC_E, 0x59, 0x60, x86_l_60);
x86_l_5b:
	/* 0x5b: mov    eax,DWORD PTR [rax+0x78] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RAX, X86_RAX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 120ULL);
x86_l_5e:
	/* 0x5e: jmp    60 <uprobe__features_fallback_minimal+0x60> */
...
x86_l_7d:
	/* 0x7d: jne    85 <uprobe__features_fallback_minimal+0x85> */
...
x86_l_83:
	/* 0x83: jmp    a6 <uprobe__features_fallback_minimal+0xa6> */
	X86_SIM_X86_JMP(0x83, 0xa6, x86_l_a6);
x86_l_85:
	/* 0x85: mov    eax,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_8a:
	/* 0x8a: mov    rdi,QWORD PTR [rip+0x17e7] */
...
x86_l_98:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_9b:
	/* 0x9b: je     a1 <uprobe__features_fallback_minimal+0xa1> */
	X86_SIM_X86_JCC(X86_CC_E, 0x9b, 0xa1, x86_l_a1);
x86_l_9d:
	/* 0x9d: mov    ebp,DWORD PTR [rax] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RBP, X86_RAX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_9f:
	/* 0x9f: jmp    a6 <uprobe__features_fallback_minimal+0xa6> */
...
x86_l_ae:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_b3:
	/* 0xb3: mov    rdi,QWORD PTR [rip+0x17e7] */
...
x86_l_c1:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_c4:
	/* 0xc4: je     b93 <uprobe__features_fallback_minimal+0xb93> */
	X86_SIM_X86_JCC(X86_CC_E, 0xc4, 0xb93, x86_l_b93);
x86_l_ca:
	/* 0xca: mov    r14,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_R14, X86_RAX, X86_WIDTH_64);
x86_l_cd:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_d2:
	/* 0xd2: mov    rdi,QWORD PTR [rip+0x17e7] */
...
x86_l_e0:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_e3:
	/* 0xe3: je     b93 <uprobe__features_fallback_minimal+0xb93> */
	X86_SIM_X86_JCC(X86_CC_E, 0xe3, 0xb93, x86_l_b93);
x86_l_e9:
	/* 0xe9: mov    r15,rax */
...
x86_l_202:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_207:
	/* 0x207: mov    rdi,QWORD PTR [rip+0x17e7] */
...
x86_l_215:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_218:
	/* 0x218: je     258 <uprobe__features_fallback_minimal+0x258> */
...
x86_l_222:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_227:
	/* 0x227: mov    rdi,QWORD PTR [rip+0x17e7] */
...
x86_l_238:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_23b:
	/* 0x23b: je     48e <uprobe__features_fallback_minimal+0x48e> */
...
x86_l_246:
	/* 0x246: jne    a00 <uprobe__features_fallback_minimal+0xa00> */
...
x86_l_251:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_253:
	/* 0x253: jmp    a87 <uprobe__features_fallback_minimal+0xa87> */
...
x86_l_268:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_26d:
	/* 0x26d: mov    rdi,QWORD PTR [rip+0x17e7] */
...
x86_l_27b:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_27e:
	/* 0x27e: je     b93 <uprobe__features_fallback_minimal+0xb93> */
	X86_SIM_X86_JCC(X86_CC_E, 0x27e, 0xb93, x86_l_b93);
x86_l_284:
...
x86_l_457:
	/* 0x457: mov    r12,QWORD PTR [rip+0x17e7] */
...
x86_l_480:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_483:
	/* 0x483: jne    21a <uprobe__features_fallback_minimal+0x21a> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x483, 0x21a, x86_l_21a);
x86_l_489:
	/* 0x489: jmp    b93 <uprobe__features_fallback_minimal+0xb93> */
	X86_SIM_X86_JMP(0x489, 0xb93, x86_l_b93);
x86_l_48e:
...
x86_l_49e:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_4a3:
	/* 0x4a3: mov    rdi,QWORD PTR [rip+0x17e7] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&scratch_map)));
x86_l_4aa:
...
x86_l_4b1:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_4b4:
	/* 0x4b4: je     b93 <uprobe__features_fallback_minimal+0xb93> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4b4, 0xb93, x86_l_b93);
x86_l_4ba:
...
x86_l_5a0:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_R8, X86_WIDTH_32, 2ULL);
x86_l_5a6:
	/* 0x5a6: mov    r12,QWORD PTR [rip+0x17e7] */
...
x86_l_5cf:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5d2:
	/* 0x5d2: je     b93 <uprobe__features_fallback_minimal+0xb93> */
	X86_SIM_X86_JCC(X86_CC_E, 0x5d2, 0xb93, x86_l_b93);
x86_l_5d8:
	/* 0x5d8: mov    r12,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_R12, X86_RAX, X86_WIDTH_64);
x86_l_5db:
...
x86_l_824:
	/* 0x824: jne    87f <uprobe__features_fallback_minimal+0x87f> */
...
x86_l_96c:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_TEST_MEM_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 68719476738ULL);
x86_l_971:
	/* 0x971: je     979 <uprobe__features_fallback_minimal+0x979> */
...
x86_l_9f5:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_TEST_MEM_IMM, X86_R15, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 17179869216ULL);
x86_l_9fa:
	/* 0x9fa: je     24c <uprobe__features_fallback_minimal+0x24c> */
...
x86_l_a67:
	/* 0xa67: je     a85 <uprobe__features_fallback_minimal+0xa85> */
...
x86_l_a7e:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RAX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 16ULL);
x86_l_a83:
	/* 0xa83: jmp    a87 <uprobe__features_fallback_minimal+0xa87> */
...
x86_l_a94:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_a99:
	/* 0xa99: mov    rdi,QWORD PTR [rip+0x17e7] */
...
x86_l_aa7:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_aaa:
	/* 0xaaa: je     ac4 <uprobe__features_fallback_minimal+0xac4> */
...
x86_l_abd:
	/* 0xabd: jne    ac4 <uprobe__features_fallback_minimal+0xac4> */
...
x86_l_ace:
	/* 0xace: jne    ba4 <uprobe__features_fallback_minimal+0xba4> */
	X86_SIM_X86_JCC(X86_CC_NE, 0xace, 0xba4, x86_l_ba4);
x86_l_ad4:
...
x86_l_aec:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_af1:
	/* 0xaf1: mov    rdi,QWORD PTR [rip+0x17e7] */
...
x86_l_aff:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_b02:
	/* 0xb02: je     b6f <uprobe__features_fallback_minimal+0xb6f> */
...
x86_l_b13:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_b16:
	/* 0xb16: je     b6f <uprobe__features_fallback_minimal+0xb6f> */
...
x86_l_b82:
	/* 0xb82: mov    rsi,QWORD PTR [rip+0x17e7] */
...
x86_l_b9f:
	/* 0xb9f: jmp    bd5 <uprobe__features_fallback_minimal+0xbd5> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_ba4:
	/* 0xba4: mov    rdi,r14 */
	X86_SIM_L_EXEC_MOV_REG(X86_RDI, X86_R14, X86_WIDTH_64);
x86_l_ba7:
	/* 0xba7: add    rdi,0x7e18 */
...
x86_l_bc1:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_bc4:
	/* 0xbc4: jne    b93 <uprobe__features_fallback_minimal+0xb93> */
	X86_SIM_X86_JCC(X86_CC_NE, 0xbc4, 0xb93, x86_l_b93);
x86_l_bc6:
	/* 0xbc6: movzx  eax,WORD PTR [r15+0xe] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RAX, X86_R15, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_16), 14ULL);
x86_l_bcb:
	/* 0xbcb: mov    WORD PTR [r14+0x7e],ax */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_R14, X86_RAX, X86_WIDTH_16, X86_MEM_AUX(X86_REG_NONE, 0), 126ULL);
x86_l_bd0:
	/* 0xbd0: jmp    ad4 <uprobe__features_fallback_minimal+0xad4> */
	X86_SIM_X86_JMP(0xbd0, 0xad4, x86_l_ad4);
x86_l_bd5:
