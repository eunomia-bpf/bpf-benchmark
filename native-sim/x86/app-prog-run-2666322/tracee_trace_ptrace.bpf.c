...
x86_l_38:
	/* 0x38: je     14e <trace_ptrace+0x14e> */
...
x86_l_dc:
	/* 0xdc: jmp    11d <trace_ptrace+0x11d> */
	X86_SIM_X86_JMP(0xdc, 0x11d, x86_l_11d);
x86_l_de:
	/* 0xde: test   r12,r12 */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_R12, X86_R12, X86_WIDTH_64);
x86_l_e1:
	/* 0xe1: je     14c <trace_ptrace+0x14c> */
...
x86_l_147:
	/* 0x147: jmp    63d <trace_ptrace+0x63d> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_14c:
	/* 0x14c: jmp    121 <trace_ptrace+0x121> */
...
x86_l_171:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_174:
	/* 0x174: je     13e <trace_ptrace+0x13e> */
...
x86_l_288:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_28b:
	/* 0x28b: je     13e <trace_ptrace+0x13e> */
...
x86_l_2af:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_2b2:
	/* 0x2b2: je     13e <trace_ptrace+0x13e> */
...
x86_l_4a2:
	/* 0x4a2: jne    4f1 <trace_ptrace+0x4f1> */
...
x86_l_5bc:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_TEST_MEM_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 2ULL);
x86_l_5c0:
	/* 0x5c0: je     5c7 <trace_ptrace+0x5c7> */
...
x86_l_636:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_638:
	/* 0x638: jmp    3e <trace_ptrace+0x3e> */
