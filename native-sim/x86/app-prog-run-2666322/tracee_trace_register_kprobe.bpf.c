...
SEC("xdp")
int tracee_trace_register_kprobe_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_43:
	/* 0x43: movabs rcx,0x2f100000000 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RCX, X86_WIDTH_64, 3234110373888ULL);
x86_l_4d:
	/* 0x4d: or     rcx,rax */
...
x86_l_72:
	/* 0x72: jmp    77 <trace_register_kprobe+0x77> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_77:
