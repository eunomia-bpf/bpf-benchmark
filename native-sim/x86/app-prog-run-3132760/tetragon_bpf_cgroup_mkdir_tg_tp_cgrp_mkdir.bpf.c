...
x86_l_2f4:
	/* 0x2f4: jmp    53e <tg_tp_cgrp_mkdir+0x53e> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_2f9:
...
x86_l_47a:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_47c:
	/* 0x47c: mov    rsi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&tcpmon_map)));
x86_l_483:
	/* 0x483: mov    ecx,0xffffffff */
	X86_SIM_L_EXEC_MOV_IMM(X86_RCX, X86_WIDTH_32, 4294967295ULL);
x86_l_488:
	/* 0x488: mov    edx,0x10d8 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RDX, X86_WIDTH_32, 4312ULL);
x86_l_48d:
	/* 0x48d: mov    eax,0x19 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 25ULL);
x86_l_492:
	/* 0x492: mov    edx,0xffffffff */
	X86_SIM_L_EXEC_MOV_IMM(X86_RDX, X86_WIDTH_32, 4294967295ULL);
x86_l_497:
	/* 0x497: mov    r8d,0x10d8 */
...
x86_l_4a5:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_4a8:
	/* 0x4a8: jns    2eb <tg_tp_cgrp_mkdir+0x2eb> */
	X86_SIM_X86_JCC(X86_CC_NS, 0x4a8, 0x2eb, x86_l_2eb);
x86_l_4ae:
	/* 0x4ae: mov    rbx,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RBX, X86_RAX, X86_WIDTH_64);
x86_l_4b1:
	/* 0x4b1: mov    DWORD PTR [rsp+0x8],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 34359738368ULL);
x86_l_4b9:
...
x86_l_4cc:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_4cf:
	/* 0x4cf: je     2eb <tg_tp_cgrp_mkdir+0x2eb> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4cf, 0x2eb, x86_l_2eb);
x86_l_4d5:
	/* 0x4d5: cmp    rbx,0xfffffffffffffff4 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551604ULL);
x86_l_4d9:
	/* 0x4d9: jg     4f5 <tg_tp_cgrp_mkdir+0x4f5> */
	X86_SIM_X86_JCC(X86_CC_G, 0x4d9, 0x4f5, x86_l_4f5);
x86_l_4db:
	/* 0x4db: cmp    rbx,0xffffffffffffffe4 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551588ULL);
x86_l_4df:
	/* 0x4df: je     50f <tg_tp_cgrp_mkdir+0x50f> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4df, 0x50f, x86_l_50f);
x86_l_4e1:
	/* 0x4e1: cmp    rbx,0xffffffffffffffea */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551594ULL);
x86_l_4e5:
	/* 0x4e5: je     527 <tg_tp_cgrp_mkdir+0x527> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4e5, 0x527, x86_l_527);
x86_l_4e7:
	/* 0x4e7: cmp    rbx,0xfffffffffffffff0 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551600ULL);
x86_l_4eb:
	/* 0x4eb: jne    51f <tg_tp_cgrp_mkdir+0x51f> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x4eb, 0x51f, x86_l_51f);
x86_l_4ed:
	/* 0x4ed: add    rax,0x590 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 1424ULL);
x86_l_4f3:
	/* 0x4f3: jmp    535 <tg_tp_cgrp_mkdir+0x535> */
	X86_SIM_X86_JMP(0x4f3, 0x535, x86_l_535);
x86_l_4f5:
	/* 0x4f5: cmp    rbx,0xfffffffffffffff5 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551605ULL);
x86_l_4f9:
	/* 0x4f9: je     517 <tg_tp_cgrp_mkdir+0x517> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4f9, 0x517, x86_l_517);
x86_l_4fb:
	/* 0x4fb: cmp    rbx,0xfffffffffffffff9 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551609ULL);
x86_l_4ff:
	/* 0x4ff: je     52f <tg_tp_cgrp_mkdir+0x52f> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4ff, 0x52f, x86_l_52f);
x86_l_501:
	/* 0x501: cmp    rbx,0xfffffffffffffffe */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551614ULL);
x86_l_505:
	/* 0x505: jne    51f <tg_tp_cgrp_mkdir+0x51f> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x505, 0x51f, x86_l_51f);
x86_l_507:
	/* 0x507: add    rax,0x580 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 1408ULL);
x86_l_50d:
	/* 0x50d: jmp    535 <tg_tp_cgrp_mkdir+0x535> */
	X86_SIM_X86_JMP(0x50d, 0x535, x86_l_535);
x86_l_50f:
	/* 0x50f: add    rax,0x5a0 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 1440ULL);
x86_l_515:
	/* 0x515: jmp    535 <tg_tp_cgrp_mkdir+0x535> */
	X86_SIM_X86_JMP(0x515, 0x535, x86_l_535);
x86_l_517:
	/* 0x517: add    rax,0x5a8 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 1448ULL);
x86_l_51d:
	/* 0x51d: jmp    535 <tg_tp_cgrp_mkdir+0x535> */
	X86_SIM_X86_JMP(0x51d, 0x535, x86_l_535);
x86_l_51f:
	/* 0x51f: add    rax,0x578 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 1400ULL);
x86_l_525:
	/* 0x525: jmp    535 <tg_tp_cgrp_mkdir+0x535> */
	X86_SIM_X86_JMP(0x525, 0x535, x86_l_535);
x86_l_527:
	/* 0x527: add    rax,0x598 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 1432ULL);
x86_l_52d:
	/* 0x52d: jmp    535 <tg_tp_cgrp_mkdir+0x535> */
	X86_SIM_X86_JMP(0x52d, 0x535, x86_l_535);
x86_l_52f:
	/* 0x52f: add    rax,0x588 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 1416ULL);
x86_l_535:
	/* 0x535: inc QWORD PTR [rax] */
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_539:
	/* 0x539: jmp    2eb <tg_tp_cgrp_mkdir+0x2eb> */
	X86_SIM_X86_JMP(0x539, 0x2eb, x86_l_2eb);
x86_l_53e:
