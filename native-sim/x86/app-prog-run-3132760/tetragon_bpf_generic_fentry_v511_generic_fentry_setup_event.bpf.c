...
SEC("xdp")
int tetragon_bpf_generic_fentry_v511_generic_fentry_setup_event_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_25:
	/* 0x25: je     2cf <generic_fentry_setup_event+0x2cf> */
	X86_SIM_X86_JCC(X86_CC_E, 0x25, 0x2cf, x86_l_2cf);
x86_l_2b:
	/* 0x2b: mov    r14,rax */
...
x86_l_43:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_46:
	/* 0x46: je     2cf <generic_fentry_setup_event+0x2cf> */
	X86_SIM_X86_JCC(X86_CC_E, 0x46, 0x2cf, x86_l_2cf);
x86_l_4c:
	/* 0x4c: mov    r15,rax */
...
x86_l_53:
	/* 0x53: je     ae <generic_fentry_setup_event+0xae> */
	X86_SIM_X86_JCC(X86_CC_E, 0x53, 0xae, x86_l_ae);
x86_l_55:
	/* 0x55: mov    rdi,rsp */
...
x86_l_18f:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_191:
	/* 0x191: mov    DWORD PTR [r14+0x7c],eax */
...
x86_l_22c:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_22f:
	/* 0x22f: je     235 <generic_fentry_setup_event+0x235> */
	X86_SIM_X86_JCC(X86_CC_E, 0x22f, 0x235, x86_l_235);
x86_l_231:
	/* 0x231: inc    DWORD PTR [rax] */
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_32, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_233:
	/* 0x233: jmp    259 <generic_fentry_setup_event+0x259> */
	X86_SIM_X86_JMP(0x233, 0x259, x86_l_259);
x86_l_235:
	/* 0x235: mov    DWORD PTR [rsp+0x20],0x1 */
...
x86_l_271:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_274:
	/* 0x274: je     299 <generic_fentry_setup_event+0x299> */
	X86_SIM_X86_JCC(X86_CC_E, 0x274, 0x299, x86_l_299);
x86_l_276:
	/* 0x276: mov    rsi,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RAX, X86_WIDTH_64);
x86_l_279:
	/* 0x279: add    rsi,0x5ef8 */
...
x86_l_28e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_291:
	/* 0x291: je     299 <generic_fentry_setup_event+0x299> */
	X86_SIM_X86_JCC(X86_CC_E, 0x291, 0x299, x86_l_299);
x86_l_293:
	/* 0x293: cmp    DWORD PTR [rax+0x40],0xffffffff */
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 279172874239ULL);
x86_l_297:
	/* 0x297: jne    2b4 <generic_fentry_setup_event+0x2b4> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x297, 0x2b4, x86_l_2b4);
x86_l_299:
	/* 0x299: mov    rsi,QWORD PTR [rip+0x0] */
...
x86_l_2b2:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_2b4:
	/* 0x2b4: mov    rsi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&fentry_calls)));
x86_l_2bb:
	/* 0x2bb: mov    ecx,0x1 */
...
x86_l_2d5:
	/* 0x2d5: jmp    2da <generic_fentry_setup_event+0x2da> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_2da:
