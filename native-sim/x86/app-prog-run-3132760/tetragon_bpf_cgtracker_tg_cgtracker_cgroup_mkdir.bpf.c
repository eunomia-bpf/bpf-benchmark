...
x86_l_12:
	/* 0x12: je     19b <tg_cgtracker_cgroup_mkdir+0x19b> */
	X86_SIM_X86_JCC(X86_CC_E, 0x12, 0x19b, x86_l_19b);
x86_l_18:
...
x86_l_33:
	/* 0x33: mov    rdx,QWORD PTR [rsp] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_37:
	/* 0x37: mov    QWORD PTR [rsp],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_3f:
	/* 0x3f: test   rdx,rdx */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RDX, X86_RDX, X86_WIDTH_64);
x86_l_42:
	/* 0x42: je     19b <tg_cgtracker_cgroup_mkdir+0x19b> */
	X86_SIM_X86_JCC(X86_CC_E, 0x42, 0x19b, x86_l_19b);
x86_l_48:
	/* 0x48: add    rdx,0x60 */
...
x86_l_5e:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_60:
	/* 0x60: mov    rax,QWORD PTR [rsp] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RAX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_64:
	/* 0x64: mov    QWORD PTR [rsp+0x18],rax */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_RAX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 24ULL);
x86_l_69:
	/* 0x69: test   rax,rax */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_6c:
	/* 0x6c: je     19b <tg_cgtracker_cgroup_mkdir+0x19b> */
	X86_SIM_X86_JCC(X86_CC_E, 0x6c, 0x19b, x86_l_19b);
x86_l_72:
	/* 0x72: add    rbx,0xc0 */
...
x86_l_8e:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_90:
	/* 0x90: mov    rdx,QWORD PTR [rsp] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_94:
	/* 0x94: test   rdx,rdx */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RDX, X86_RDX, X86_WIDTH_64);
x86_l_97:
	/* 0x97: je     19b <tg_cgtracker_cgroup_mkdir+0x19b> */
	X86_SIM_X86_JCC(X86_CC_E, 0x97, 0x19b, x86_l_19b);
x86_l_9d:
	/* 0x9d: mov    QWORD PTR [rsp],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_a5:
	/* 0xa5: add    rdx,0x100 */
...
x86_l_be:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_c0:
	/* 0xc0: mov    rdx,QWORD PTR [rsp] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_c4:
	/* 0xc4: mov    QWORD PTR [rsp],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_cc:
	/* 0xcc: test   rdx,rdx */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RDX, X86_RDX, X86_WIDTH_64);
x86_l_cf:
	/* 0xcf: je     19b <tg_cgtracker_cgroup_mkdir+0x19b> */
	X86_SIM_X86_JCC(X86_CC_E, 0xcf, 0x19b, x86_l_19b);
x86_l_d5:
	/* 0xd5: add    rdx,0x60 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RDX, X86_WIDTH_64, X86_ALU_ADD, 96ULL);
x86_l_d9:
...
x86_l_f6:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_f9:
	/* 0xf9: je     19b <tg_cgtracker_cgroup_mkdir+0x19b> */
	X86_SIM_X86_JCC(X86_CC_E, 0xf9, 0x19b, x86_l_19b);
x86_l_ff:
	/* 0xff: mov    rdi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_cgtracker_map)));
x86_l_106:
	/* 0x106: lea    rsi,[rsp+0x10] */
...
x86_l_112:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_115:
	/* 0x115: je     19b <tg_cgtracker_cgroup_mkdir+0x19b> */
	X86_SIM_X86_JCC(X86_CC_E, 0x115, 0x19b, x86_l_19b);
x86_l_11b:
	/* 0x11b: mov    rdx,rax */
...
x86_l_135:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_138:
	/* 0x138: je     19b <tg_cgtracker_cgroup_mkdir+0x19b> */
	X86_SIM_X86_JCC(X86_CC_E, 0x138, 0x19b, x86_l_19b);
x86_l_13a:
	/* 0x13a: neg    eax */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_32, X86_ALU_NEG, 0);
x86_l_13c:
	/* 0x13c: mov    WORD PTR [rsp],ax */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_RAX, X86_WIDTH_16, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_140:
	/* 0x140: mov    WORD PTR [rsp+0x2],0x1 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_16, X86_MEM_AUX(X86_REG_NONE, 0), 8589934593ULL);
x86_l_147:
	/* 0x147: movabs rax,0x200000040 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_64, 8589934656ULL);
x86_l_151:
	/* 0x151: mov    QWORD PTR [rsp+0x4],rax */
...
x86_l_167:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_16a:
	/* 0x16a: je     179 <tg_cgtracker_cgroup_mkdir+0x179> */
	X86_SIM_X86_JCC(X86_CC_E, 0x16a, 0x179, x86_l_179);
x86_l_16c:
	/* 0x16c: inc    DWORD PTR [rax] */
...
x86_l_174:
	/* 0x174: jmp    1a6 <tg_cgtracker_cgroup_mkdir+0x1a6> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_179:
	/* 0x179: mov    DWORD PTR [rsp+0xc],0x1 */
...
x86_l_19d:
	...
	X86_SIM_L_EXEC_ALU_IMM(X86_RSP, X86_WIDTH_64, X86_ALU_ADD, 32ULL);
x86_l_1a1:
	/* 0x1a1: jmp    1a6 <tg_cgtracker_cgroup_mkdir+0x1a6> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_1a6:
