...
SEC("xdp")
int tetragon_bpf_generic_fentry_v61_do_action_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_12a:
	/* 0x12a: mov    rdi,QWORD PTR [rip+0x2777] */
...
x86_l_191:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_RAX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_195:
	/* 0x195: mov    rdi,QWORD PTR [rip+0x2777] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_19c:
	/* 0x19c: xor    ecx,ecx */
...
x86_l_211:
	/* 0x211: mov    rdi,QWORD PTR [rip+0x2777] */
...
x86_l_2e8:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_2ea:
	/* 0x2ea: mov    rdi,QWORD PTR [rip+0x2777] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_2f1:
	/* 0x2f1: xor    r15d,r15d */
	X86_SIM_L_EXEC_ALU_REG(X86_R15, X86_R15, X86_WIDTH_32, X86_ALU_XOR);
...
x86_l_368:
	/* 0x368: mov    rdi,QWORD PTR [rip+0x2777] */
...
x86_l_39d:
	/* 0x39d: mov    rdi,QWORD PTR [rip+0x2777] */
...
x86_l_419:
	/* 0x419: mov    rdi,QWORD PTR [rip+0x2777] */
...
x86_l_446:
	/* 0x446: mov    rdi,QWORD PTR [rip+0x2777] */
...
x86_l_46d:
	/* 0x46d: mov    rdi,QWORD PTR [rip+0x2777] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_data)));
x86_l_474:
...
x86_l_4bf:
	/* 0x4bf: mov    rdi,QWORD PTR [rip+0x2777] */
...
x86_l_4e3:
	/* 0x4e3: mov    rdi,QWORD PTR [rip+0x2777] */
...
x86_l_553:
	/* 0x553: mov    rdi,QWORD PTR [rip+0x2777] */
...
x86_l_577:
	/* 0x577: mov    rdi,QWORD PTR [rip+0x2777] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_missed_notifications)));
x86_l_57e:
...
x86_l_5bc:
	/* 0x5bc: mov    rdi,QWORD PTR [rip+0x2777] */
...
x86_l_5dd:
	/* 0x5dd: mov    rdi,QWORD PTR [rip+0x2777] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_5e4:
	/* 0x5e4: mov    rsi,rsp */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RSP, X86_WIDTH_64);
...
x86_l_5ee:
	/* 0x5ee: mov    rdi,QWORD PTR [rip+0x2777] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&socktrack_map)));
x86_l_5f5:
...
x86_l_667:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_66c:
	/* 0x66c: mov    rdi,QWORD PTR [rip+0x2777] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_673:
...
x86_l_68d:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_692:
	/* 0x692: mov    rdi,QWORD PTR [rip+0x2777] */
...
x86_l_6d3:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_6d8:
	/* 0x6d8: mov    rdi,QWORD PTR [rip+0x2777] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_6df:
...
x86_l_6f5:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_6fa:
	/* 0x6fa: mov    rdi,QWORD PTR [rip+0x2777] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&config_map)));
x86_l_701:
	/* 0x701: call   rax */
	X86_SIM_BPF_CALL_REG(X86_RAX);
...
x86_l_78c:
	/* 0x78c: mov    rdi,QWORD PTR [rip+0x2777] */
...
x86_l_7c4:
	/* 0x7c4: mov    rdi,QWORD PTR [rip+0x2777] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&ratelimit_map)));
x86_l_7cb:
	/* 0x7cb: xor    ecx,ecx */
	X86_SIM_L_EXEC_ALU_REG(X86_RCX, X86_RCX, X86_WIDTH_32, X86_ALU_XOR);
...
x86_l_7f3:
	/* 0x7f3: mov    rsi,QWORD PTR [rip+0x2777] */
...
x86_l_81f:
	/* 0x81f: mov    rsi,QWORD PTR [rip+0x2777] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&stack_trace_map)));
x86_l_826:
	/* 0x826: mov    ecx,0x100 */
...
x86_l_86d:
	/* 0x86d: mov    rdi,QWORD PTR [rip+0x277a] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_errmetrics_map)));
x86_l_874:
	/* 0x874: xor    ecx,ecx */
	X86_SIM_L_EXEC_ALU_REG(X86_RCX, X86_RCX, X86_WIDTH_32, X86_ALU_XOR);
...
x86_l_890:
	/* 0x890: mov    rdi,QWORD PTR [rip+0x277a] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_missed_notifications)));
x86_l_897:
