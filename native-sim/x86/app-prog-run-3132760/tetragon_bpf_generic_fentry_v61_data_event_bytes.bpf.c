...
SEC("xdp")
int tetragon_bpf_generic_fentry_v61_data_event_bytes_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_c4:
	/* 0xc4: jmp    3ed <__do_bytes+0xc4> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_3ed:
...
x86_l_293:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 17179869184ULL);
x86_l_29b:
	/* 0x29b: mov    rdi,QWORD PTR [rip+0x320] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_stats_map)));
x86_l_2a2:
	/* 0x2a2: lea    rsi,[rsp+0x4] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 4ULL);
x86_l_2a7:
	/* 0x2a7: mov    eax,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
...
x86_l_334:
	/* 0x334: js     3b6 <__do_bytes+0x8d> */
	X86_SIM_X86_SUB_JCC(X86_CC_S, 0x334, 0x3b6, x86_l_3b6);
x86_l_33a:
	/* 0x33a: mov    r14,rsi */
...
x86_l_35d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_35f:
	/* 0x35f: js     3db <__do_bytes+0xb2> */
	X86_SIM_X86_SUB_JCC(X86_CC_S, 0x35f, 0x3db, x86_l_3db);
x86_l_361:
	/* 0x361: lea    r15d,[rbx+0x20] */
	X86_SIM_L_EXEC_LEA(X86_R15, X86_RBX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 32ULL);
x86_l_365:
	/* 0x365: mov    DWORD PTR [r14+0x4],r15d */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_R14, X86_R15, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 4ULL);
x86_l_369:
	/* 0x369: mov    DWORD PTR [rsp+0x4],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 17179869184ULL);
x86_l_371:
	/* 0x371: mov    rdi,QWORD PTR [rip+0x57c] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_conf_map)));
x86_l_378:
	/* 0x378: lea    rsi,[rsp+0x4] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 4ULL);
x86_l_37d:
	/* 0x37d: mov    eax,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
...
x86_l_384:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_387:
	/* 0x387: je     3bf <__do_bytes+0x96> */
	X86_SIM_X86_SUB_JCC(X86_CC_E, 0x387, 0x3bf, x86_l_3bf);
x86_l_389:
	/* 0x389: cmp    BYTE PTR [rax+0x28],0x0 */
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_38d:
	/* 0x38d: je     3bf <__do_bytes+0x96> */
	X86_SIM_X86_SUB_JCC(X86_CC_E, 0x38d, 0x3bf, x86_l_3bf);
x86_l_38f:
	/* 0x38f: mov    rsi,QWORD PTR [rip+0x57c] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&tcpmon_map)));
x86_l_396:
	/* 0x396: mov    ecx,0xffffffff */
...
x86_l_3b0:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_3b2:
	/* 0x3b2: js     3db <__do_bytes+0xb2> */
	X86_SIM_X86_SUB_JCC(X86_CC_S, 0x3b2, 0x3db, x86_l_3db);
x86_l_3b4:
	/* 0x3b4: jmp    3de <__do_bytes+0xb5> */
	X86_SIM_X86_SUB_JMP(0x3b4, 0x3de, x86_l_3de);
x86_l_3b6:
	/* 0x3b6: mov    rbx,0xffffffffffffffff */
	X86_SIM_L_EXEC_MOV_IMM(X86_RBX, X86_WIDTH_64, 18446744073709551615ULL);
x86_l_3bd:
	/* 0x3bd: jmp    3de <__do_bytes+0xb5> */
	X86_SIM_X86_SUB_JMP(0x3bd, 0x3de, x86_l_3de);
x86_l_3bf:
	/* 0x3bf: mov    rdi,QWORD PTR [rip+0x57c] */
...
x86_l_3d7:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_3d9:
	/* 0x3d9: jns    3de <__do_bytes+0xb5> */
	X86_SIM_X86_SUB_JCC(X86_CC_NS, 0x3d9, 0x3de, x86_l_3de);
x86_l_3db:
	/* 0x3db: movsxd rbx,eax */
	X86_SIM_L_EXEC_MOVX_REG(X86_OP_MOVSX_REG, X86_RBX, X86_RAX, X86_WIDTH_64, X86_WIDTH_32);
x86_l_3de:
	/* 0x3de: mov    rax,rbx */
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_RBX, X86_WIDTH_64);
