...
SEC("xdp")
int tetragon_bpf_execve_event_v61_data_event_bytes_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_293:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 17179869184ULL);
x86_l_29b:
	/* 0x29b: mov    rdi,QWORD PTR [rip+0x3c0] */
...
x86_l_369:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 17179869184ULL);
x86_l_371:
	/* 0x371: mov    rdi,QWORD PTR [rip+0x61c] */
...
x86_l_38f:
	/* 0x38f: mov    rsi,QWORD PTR [rip+0x61c] */
...
x86_l_3bf:
	/* 0x3bf: mov    rdi,QWORD PTR [rip+0x61c] */
