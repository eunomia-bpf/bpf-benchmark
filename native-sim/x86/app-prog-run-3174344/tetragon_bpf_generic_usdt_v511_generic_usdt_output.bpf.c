...
x86_l_12:
	/* 0x12: mov    rdi,QWORD PTR [rip+0x23b57] */
...
x86_l_28:
	/* 0x28: je     4cb <generic_usdt_output+0x4cb> */
...
x86_l_39:
	/* 0x39: je     336 <generic_usdt_output+0x336> */
...
x86_l_5c:
	/* 0x5c: mov    rdi,QWORD PTR [rip+0x23b57] */
...
x86_l_6f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_72:
	/* 0x72: je     336 <generic_usdt_output+0x336> */
...
x86_l_161:
	/* 0x161: je     1f4 <generic_usdt_output+0x1f4> */
...
x86_l_1f0:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_1f2:
	/* 0x1f2: jmp    1fc <generic_usdt_output+0x1fc> */
...
x86_l_33e:
	/* 0x33e: je     3fb <generic_usdt_output+0x3fb> */
...
x86_l_35c:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_R15, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 40ULL);
x86_l_361:
	/* 0x361: mov    rdi,QWORD PTR [rip+0x23b57] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&execve_map)));
x86_l_368:
...
x86_l_374:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_377:
	/* 0x377: je     3fb <generic_usdt_output+0x3fb> */
...
x86_l_41f:
	/* 0x41f: mov    rdi,QWORD PTR [rip+0x23b53] */
...
x86_l_432:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_435:
	/* 0x435: je     489 <generic_usdt_output+0x489> */
...
x86_l_43b:
	/* 0x43b: je     489 <generic_usdt_output+0x489> */
	X86_SIM_X86_JCC(X86_CC_E, 0x43b, 0x489, x86_l_489);
x86_l_43d:
	/* 0x43d: mov    rsi,QWORD PTR [rip+0x23b53] */
...
x86_l_482:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_485:
	/* 0x485: jne    4c6 <generic_usdt_output+0x4c6> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x485, 0x4c6, x86_l_4c6);
x86_l_487:
	/* 0x487: jmp    4cb <generic_usdt_output+0x4cb> */
	X86_SIM_X86_JMP(0x487, 0x4cb, x86_l_4cb);
x86_l_489:
	/* 0x489: mov    rdi,QWORD PTR [rip+0x23b53] */
...
x86_l_4c1:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_4c4:
	/* 0x4c4: je     4cb <generic_usdt_output+0x4cb> */
...
x86_l_4d4:
	/* 0x4d4: jmp    5db <generic_usdt_output+0x5db> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_4d9:
	/* 0x4d9: mov    rbx,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RBX, X86_RAX, X86_WIDTH_64);
x86_l_4dc:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_4e4:
	/* 0x4e4: mov    rdi,QWORD PTR [rip+0x23b56] */
...
x86_l_526:
	/* 0x526: jmp    4cb <generic_usdt_output+0x4cb> */
...
x86_l_52b:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_533:
	/* 0x533: mov    rdi,QWORD PTR [rip+0x23b56] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_stats_map)));
x86_l_53a:
...
x86_l_5a5:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_5a9:
	/* 0x5a9: jmp    4cb <generic_usdt_output+0x4cb> */
...
x86_l_5b4:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_5b8:
	/* 0x5b8: jmp    4cb <generic_usdt_output+0x4cb> */
...
x86_l_5c3:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_5c7:
	/* 0x5c7: jmp    4cb <generic_usdt_output+0x4cb> */
...
x86_l_5d2:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_5d6:
	/* 0x5d6: jmp    4cb <generic_usdt_output+0x4cb> */
