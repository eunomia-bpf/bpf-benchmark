...
SEC("xdp")
int tetragon_bpf_multi_kprobe_v61_do_bytes_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_1cb:
	/* 0x1cb: mov    rdi,QWORD PTR [rip+0x447] */
...
x86_l_296:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 17179869184ULL);
x86_l_29e:
	/* 0x29e: mov    rdi,QWORD PTR [rip+0x69c] */
...
x86_l_2bc:
	/* 0x2bc: mov    rsi,QWORD PTR [rip+0x69c] */
...
x86_l_2ec:
	/* 0x2ec: mov    rdi,QWORD PTR [rip+0x69c] */
