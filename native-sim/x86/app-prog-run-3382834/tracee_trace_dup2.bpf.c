...
x86_l_3f:
	/* 0x3f: je     166 <trace_dup2+0x166> */
	X86_SIM_X86_JCC(X86_CC_E, 0x3f, 0x166, x86_l_166);
x86_l_45:
	/* 0x45: mov    DWORD PTR [r15+0x68],0x21 */
...
x86_l_e8:
	/* 0xe8: jmp    129 <trace_dup2+0x129> */
	X86_SIM_X86_JMP(0xe8, 0x129, x86_l_129);
x86_l_ea:
	/* 0xea: test   r12,r12 */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_R12, X86_R12, X86_WIDTH_64);
x86_l_ed:
	/* 0xed: je     164 <trace_dup2+0x164> */
...
x86_l_15f:
	/* 0x15f: jmp    701 <trace_dup2+0x701> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_164:
	/* 0x164: jmp    12d <trace_dup2+0x12d> */
...
x86_l_517:
	/* 0x517: jne    575 <trace_dup2+0x575> */
