...
SEC("xdp")
int tracee_trace_do_init_module_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_43:
	/* 0x43: movabs rcx,0x2fa00000000 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RCX, X86_WIDTH_64, 3272765079552ULL);
x86_l_4d:
	/* 0x4d: or     rcx,rax */
...
x86_l_74:
	/* 0x74: jmp    79 <trace_do_init_module+0x79> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_79:
