...
x86_l_28:
	/* 0x28: je     36 <vfs_writev_magic_enter+0x36> */
...
x86_l_31:
	/* 0x31: jmp    f8 <vfs_writev_magic_enter+0xf8> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_36:
...
x86_l_80:
	/* 0x80: jne    2a <vfs_writev_magic_enter+0x2a> */
...
x86_l_f2:
	...
	X86_SIM_L_EXEC_POP(X86_RBX, X86_WIDTH_64);
x86_l_f3:
	/* 0xf3: jmp    f8 <vfs_writev_magic_enter+0xf8> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_f8:
