...
x86_l_3f:
	/* 0x3f: je     166 <trace_arch_prctl+0x166> */
	X86_SIM_X86_JCC(X86_CC_E, 0x3f, 0x166, x86_l_166);
x86_l_45:
	/* 0x45: mov    DWORD PTR [r15+0x68],0x9e */
...
x86_l_7b:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_7e:
	/* 0x7e: je     8e <trace_arch_prctl+0x8e> */
...
x86_l_86:
	/* 0x86: je     91 <trace_arch_prctl+0x91> */
...
x86_l_8c:
	/* 0x8c: jmp    91 <trace_arch_prctl+0x91> */
...
x86_l_ac:
	/* 0xac: jne    ea <trace_arch_prctl+0xea> */
...
x86_l_e8:
	/* 0xe8: jmp    129 <trace_arch_prctl+0x129> */
	X86_SIM_X86_JMP(0xe8, 0x129, x86_l_129);
x86_l_ea:
	/* 0xea: test   r12,r12 */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_R12, X86_R12, X86_WIDTH_64);
x86_l_ed:
	/* 0xed: je     164 <trace_arch_prctl+0x164> */
...
x86_l_15f:
	/* 0x15f: jmp    701 <trace_arch_prctl+0x701> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_164:
	/* 0x164: jmp    12d <trace_arch_prctl+0x12d> */
...
x86_l_189:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_18c:
	/* 0x18c: je     14f <trace_arch_prctl+0x14f> */
...
x86_l_29e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_2a1:
	/* 0x2a1: je     14f <trace_arch_prctl+0x14f> */
...
x86_l_2c5:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_2c8:
	/* 0x2c8: je     14f <trace_arch_prctl+0x14f> */
...
x86_l_517:
	/* 0x517: jne    575 <trace_arch_prctl+0x575> */
...
x86_l_667:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_TEST_MEM_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 2ULL);
x86_l_66b:
	/* 0x66b: je     672 <trace_arch_prctl+0x672> */
...
x86_l_6fa:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_6fc:
	/* 0x6fc: jmp    45 <trace_arch_prctl+0x45> */
