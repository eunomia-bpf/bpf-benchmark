...
x86_l_2b:
	/* 0x2b: je     619 <generic_uprobe_event+0x619> */
	X86_SIM_X86_JCC(X86_CC_E, 0x2b, 0x619, x86_l_619);
x86_l_31:
	/* 0x31: mov    r14,rax */
...
x86_l_235:
	/* 0x235: je     62a <generic_uprobe_event+0x62a> */
	X86_SIM_X86_JCC(X86_CC_E, 0x235, 0x62a, x86_l_62a);
x86_l_23b:
...
x86_l_625:
	/* 0x625: jmp    683 <generic_uprobe_event+0x683> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_62a:
	/* 0x62a: mov    QWORD PTR [rsp+0x18],0xffffffffffffffff */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 107374182399ULL);
x86_l_633:
	/* 0x633: lea    rsi,[rsp+0x18] */
...
x86_l_642:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_645:
	/* 0x645: je     619 <generic_uprobe_event+0x619> */
	X86_SIM_X86_JCC(X86_CC_E, 0x645, 0x619, x86_l_619);
x86_l_647:
	/* 0x647: mov    DWORD PTR [rsp+0x14],0x1 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 85899345921ULL);
x86_l_64f:
	/* 0x64f: mov    rdi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&policy_filter_maps)));
x86_l_656:
	/* 0x656: lea    rsi,[rsp+0x14] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 20ULL);
x86_l_65b:
	/* 0x65b: mov    eax,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
...
x86_l_662:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_665:
	/* 0x665: je     619 <generic_uprobe_event+0x619> */
	X86_SIM_X86_JCC(X86_CC_E, 0x665, 0x619, x86_l_619);
x86_l_667:
	/* 0x667: mov    rdi,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RDI, X86_RAX, X86_WIDTH_64);
x86_l_66a:
	/* 0x66a: lea    rsi,[rsp+0x8] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_66f:
	/* 0x66f: mov    eax,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
...
x86_l_679:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R12, X86_WIDTH_64);
x86_l_67c:
	/* 0x67c: jne    619 <generic_uprobe_event+0x619> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x67c, 0x619, x86_l_619);
x86_l_67e:
	/* 0x67e: jmp    23b <generic_uprobe_event+0x23b> */
	X86_SIM_X86_JMP(0x67e, 0x23b, x86_l_23b);
x86_l_683:
