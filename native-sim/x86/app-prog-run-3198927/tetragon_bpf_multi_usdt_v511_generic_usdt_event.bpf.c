...
x86_l_2b:
	/* 0x2b: je     624 <generic_usdt_event+0x624> */
...
x86_l_5a:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5d:
	/* 0x5d: je     624 <generic_usdt_event+0x624> */
...
x86_l_6c:
	/* 0x6c: je     23b <generic_usdt_event+0x23b> */
...
x86_l_88:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_8b:
	/* 0x8b: je     624 <generic_usdt_event+0x624> */
...
x86_l_af:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_b2:
	/* 0xb2: je     d8 <generic_usdt_event+0xd8> */
...
x86_l_bc:
	/* 0xbc: jne    dc <generic_usdt_event+0xdc> */
...
x86_l_ca:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_cd:
	/* 0xcd: jne    1f6 <generic_usdt_event+0x1f6> */
	X86_SIM_X86_JCC(X86_CC_NE, 0xcd, 0x1f6, x86_l_1f6);
x86_l_d3:
	/* 0xd3: jmp    624 <generic_usdt_event+0x624> */
	X86_SIM_X86_JMP(0xd3, 0x624, x86_l_624);
x86_l_d8:
	/* 0xd8: xor    ebp,ebp */
	X86_SIM_L_EXEC_ALU_REG(X86_RBP, X86_RBP, X86_WIDTH_32, X86_ALU_XOR);
x86_l_da:
	/* 0xda: jmp    df <generic_usdt_event+0xdf> */
...
x86_l_150:
	/* 0x150: je     624 <generic_usdt_event+0x624> */
...
x86_l_179:
	/* 0x179: je     624 <generic_usdt_event+0x624> */
...
x86_l_1b3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RDX, X86_RDX, X86_WIDTH_64);
x86_l_1b6:
	/* 0x1b6: je     1e6 <generic_usdt_event+0x1e6> */
...
x86_l_1dc:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1df:
	/* 0x1df: jne    1f6 <generic_usdt_event+0x1f6> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x1df, 0x1f6, x86_l_1f6);
x86_l_1e1:
	/* 0x1e1: jmp    624 <generic_usdt_event+0x624> */
...
x86_l_1ed:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1f0:
	/* 0x1f0: je     624 <generic_usdt_event+0x624> */
...
x86_l_20e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_211:
	/* 0x211: je     220 <generic_usdt_event+0x220> */
...
x86_l_216:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_219:
	/* 0x219: je     220 <generic_usdt_event+0x220> */
...
x86_l_235:
	/* 0x235: je     635 <generic_usdt_event+0x635> */
...
x86_l_38e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_391:
	/* 0x391: je     427 <generic_usdt_event+0x427> */
...
x86_l_423:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_425:
	/* 0x425: jmp    42f <generic_usdt_event+0x42f> */
...
x86_l_630:
	/* 0x630: jmp    68e <generic_usdt_event+0x68e> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_635:
...
x86_l_64d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_650:
	/* 0x650: je     624 <generic_usdt_event+0x624> */
...
x86_l_66d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_670:
	/* 0x670: je     624 <generic_usdt_event+0x624> */
...
x86_l_684:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R12, X86_WIDTH_64);
x86_l_687:
	/* 0x687: jne    624 <generic_usdt_event+0x624> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x687, 0x624, x86_l_624);
x86_l_689:
	/* 0x689: jmp    23b <generic_usdt_event+0x23b> */
