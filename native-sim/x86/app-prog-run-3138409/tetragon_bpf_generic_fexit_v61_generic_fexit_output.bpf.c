...
SEC("xdp")
int tetragon_bpf_generic_fexit_v61_generic_fexit_output_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_25:
	/* 0x25: je     fe <generic_fexit_output+0xfe> */
...
x86_l_65:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_68:
	/* 0x68: je     bc <generic_fexit_output+0xbc> */
...
x86_l_6e:
	/* 0x6e: je     bc <generic_fexit_output+0xbc> */
...
x86_l_91:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_94:
	/* 0x94: js     158 <generic_fexit_output+0x158> */
...
x86_l_b5:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_b8:
	/* 0xb8: jne    f9 <generic_fexit_output+0xf9> */
	X86_SIM_X86_JCC(X86_CC_NE, 0xb8, 0xf9, x86_l_f9);
x86_l_ba:
	/* 0xba: jmp    fe <generic_fexit_output+0xfe> */
...
x86_l_d4:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_d7:
	/* 0xd7: js     109 <generic_fexit_output+0x109> */
...
x86_l_f4:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_f7:
	/* 0xf7: je     fe <generic_fexit_output+0xfe> */
...
x86_l_104:
	/* 0x104: jmp    20b <generic_fexit_output+0x20b> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_109:
	/* 0x109: mov    rbx,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RBX, X86_RAX, X86_WIDTH_64);
...
x86_l_156:
	/* 0x156: jmp    fe <generic_fexit_output+0xfe> */
...
x86_l_1d5:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_1d9:
	/* 0x1d9: jmp    fe <generic_fexit_output+0xfe> */
...
x86_l_1e4:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_1e8:
	/* 0x1e8: jmp    fe <generic_fexit_output+0xfe> */
...
x86_l_1f3:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_1f7:
	/* 0x1f7: jmp    fe <generic_fexit_output+0xfe> */
...
x86_l_202:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_206:
	/* 0x206: jmp    fe <generic_fexit_output+0xfe> */
