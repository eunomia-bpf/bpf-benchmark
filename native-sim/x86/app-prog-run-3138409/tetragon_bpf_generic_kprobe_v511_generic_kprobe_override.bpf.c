...
x86_l_29:
	/* 0x29: je     51 <generic_kprobe_override+0x51> */
	X86_SIM_X86_JCC(X86_CC_E, 0x29, 0x51, x86_l_51);
x86_l_2b:
	/* 0x2b: movsxd rcx,DWORD PTR [rax] */
...
x86_l_57:
	/* 0x57: jmp    5c <generic_kprobe_override+0x5c> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_5c:
