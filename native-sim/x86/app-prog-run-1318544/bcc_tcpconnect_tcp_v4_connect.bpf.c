...
SEC("xdp")
int bcc_tcpconnect_tcp_v4_connect_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_d:
	/* 0xd: call   12 <tcp_v4_connect+0x12> */
...
x86_l_20:
	/* 0x20: je     2c <tcp_v4_connect+0x2c> */
...
x86_l_2a:
	/* 0x2a: jne    5d <tcp_v4_connect+0x5d> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x2a, 0x5d, x86_l_5d);
x86_l_2c:
	/* 0x2c: call   31 <tcp_v4_connect+0x31> */
...
x86_l_3d:
	/* 0x3d: je     45 <tcp_v4_connect+0x45> */
...
x86_l_41:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_CMP_REG, X86_RCX, X86_RAX, X86_WIDTH_32);
x86_l_43:
	/* 0x43: jne    5d <tcp_v4_connect+0x5d> */
...
x86_l_58:
	/* 0x58: call   5d <tcp_v4_connect+0x5d> */
...
x86_l_63:
	/* 0x63: jmp    68 <tcp_v4_connect+0x68> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_68:
