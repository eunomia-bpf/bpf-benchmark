...
x86_l_7:
	/* 0x7: call   c <tracepoint__syscalls__sys_enter_open+0xc> */
...
x86_l_1a:
	/* 0x1a: je     29 <tracepoint__syscalls__sys_enter_open+0x29> */
...
x86_l_27:
	/* 0x27: jne    87 <tracepoint__syscalls__sys_enter_open+0x87> */
...
x86_l_30:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_33:
	/* 0x33: je     3b <tracepoint__syscalls__sys_enter_open+0x3b> */
...
x86_l_39:
	/* 0x39: jne    87 <tracepoint__syscalls__sys_enter_open+0x87> */
...
x86_l_48:
	/* 0x48: je     56 <tracepoint__syscalls__sys_enter_open+0x56> */
	X86_SIM_X86_JCC(X86_CC_E, 0x48, 0x56, x86_l_56);
x86_l_4a:
	/* 0x4a: call   4f <tracepoint__syscalls__sys_enter_open+0x4f> */
...
x86_l_68:
	/* 0x68: mov    eax,DWORD PTR [rbx+0x18] */
...
x86_l_82:
	/* 0x82: call   87 <tracepoint__syscalls__sys_enter_open+0x87> */
...
x86_l_8d:
	/* 0x8d: jmp    92 <tracepoint__syscalls__sys_enter_open+0x92> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_92:
