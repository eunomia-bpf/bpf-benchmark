...
x86_l_c4:
	/* 0xc4: mov    rdi,QWORD PTR [rip+0x1eb0] */
...
x86_l_e8:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_ed:
	/* 0xed: mov    rdi,QWORD PTR [rip+0x1eb0] */
...
x86_l_206:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_20b:
	/* 0x20b: mov    rdi,QWORD PTR [rip+0x1e00] */
...
x86_l_227:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_22c:
	/* 0x22c: mov    rdi,QWORD PTR [rip+0x1e00] */
...
x86_l_3b0:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_3b5:
	/* 0x3b5: mov    rdi,QWORD PTR [rip+0x1ac0] */
...
x86_l_3c9:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_3ce:
	/* 0x3ce: mov    rdi,QWORD PTR [rip+0x1ac0] */
...
x86_l_4a2:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_4a7:
	/* 0x4a7: mov    rdi,QWORD PTR [rip+0x1ac0] */
...
x86_l_4d3:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_4d8:
	/* 0x4d8: mov    rdi,QWORD PTR [rip+0x1ac0] */
...
x86_l_4fe:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_503:
	/* 0x503: mov    rdi,QWORD PTR [rip+0x1ac0] */
...
x86_l_51e:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_523:
	/* 0x523: mov    rdi,QWORD PTR [rip+0x1abd] */
...
x86_l_52c:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_531:
	/* 0x531: mov    rdi,QWORD PTR [rip+0x1abd] */
...
x86_l_53a:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_53f:
	/* 0x53f: mov    rdi,QWORD PTR [rip+0x1abd] */
...
x86_l_548:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_54d:
	/* 0x54d: mov    rdi,QWORD PTR [rip+0x1abd] */
...
x86_l_556:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_55b:
	/* 0x55b: mov    rdi,QWORD PTR [rip+0x1abd] */
...
x86_l_564:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_569:
	/* 0x569: mov    rdi,QWORD PTR [rip+0x1abd] */
...
x86_l_572:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_577:
	/* 0x577: mov    rdi,QWORD PTR [rip+0x1abd] */
...
x86_l_580:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_585:
	/* 0x585: mov    rdi,QWORD PTR [rip+0x1abd] */
...
x86_l_5fa:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_5ff:
	/* 0x5ff: mov    rdi,QWORD PTR [rip+0x20a3] */
...
x86_l_6bc:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_6c1:
	/* 0x6c1: mov    rdi,QWORD PTR [rip+0x20b1] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&substring_map)));
x86_l_6c8:
	/* 0x6c8: mov    rsi,r13 */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_R13, X86_WIDTH_64);
...
x86_l_743:
	/* 0x743: mov    r15,QWORD PTR [rip+0x20c3] */
...
x86_l_781:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RBX, X86_WIDTH_32, 16ULL);
x86_l_786:
	/* 0x786: mov    r15,QWORD PTR [rip+0x20c5] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_R15, (void *)(long)(((__u64)(long)&substring_map)));
x86_l_78d:
