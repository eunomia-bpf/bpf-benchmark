...
x86_l_2d:
	/* 0x2d: je     abd <generic_retuprobe_actions+0xabd> */
...
x86_l_3c:
	/* 0x3c: jl     abd <generic_retuprobe_actions+0xabd> */
...
x86_l_59:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5c:
	/* 0x5c: je     abd <generic_retuprobe_actions+0xabd> */
...
x86_l_12b:
	/* 0x12b: je     a9e <generic_retuprobe_actions+0xa9e> */
...
x86_l_13c:
	/* 0x13c: jae    a9e <generic_retuprobe_actions+0xa9e> */
...
x86_l_79e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_7a1:
	/* 0x7a1: je     a46 <generic_retuprobe_actions+0xa46> */
	X86_SIM_X86_JCC(X86_CC_E, 0x7a1, 0xa46, x86_l_a46);
x86_l_7a7:
	/* 0x7a7: inc    DWORD PTR [rax] */
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_32, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_7a9:
	/* 0x7a9: jmp    a6e <generic_retuprobe_actions+0xa6e> */
...
x86_l_a14:
	/* 0xa14: je     117 <generic_retuprobe_actions+0x117> */
...
x86_l_a41:
	/* 0xa41: jmp    117 <generic_retuprobe_actions+0x117> */
...
x86_l_a6e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RBX, X86_RBX, X86_WIDTH_32);
x86_l_a70:
	/* 0xa70: je     52b <generic_retuprobe_actions+0x52b> */
...
x86_l_a89:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_a8c:
	/* 0xa8c: je     52b <generic_retuprobe_actions+0x52b> */
...
x86_l_a99:
	/* 0xa99: jmp    52b <generic_retuprobe_actions+0x52b> */
...
x86_l_aa3:
	/* 0xaa3: je     abd <generic_retuprobe_actions+0xabd> */
...
x86_l_ac9:
	/* 0xac9: jmp    ace <generic_retuprobe_actions+0xace> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_ace:
