...
x86_l_29:
	/* 0x29: je     4e0 <generic_kprobe_event+0x4e0> */
...
x86_l_51:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_54:
	/* 0x54: je     4e0 <generic_kprobe_event+0x4e0> */
...
x86_l_7f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_82:
	/* 0x82: je     4e0 <generic_kprobe_event+0x4e0> */
...
x86_l_c9:
	/* 0xc9: jmp    4e0 <generic_kprobe_event+0x4e0> */
...
x86_l_134:
	/* 0x134: je     4e0 <generic_kprobe_event+0x4e0> */
...
x86_l_158:
	/* 0x158: je     4e0 <generic_kprobe_event+0x4e0> */
...
x86_l_1b5:
	/* 0x1b5: jmp    4e0 <generic_kprobe_event+0x4e0> */
...
x86_l_1c0:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1c3:
	/* 0x1c3: je     4e0 <generic_kprobe_event+0x4e0> */
...
x86_l_205:
	/* 0x205: je     4ef <generic_kprobe_event+0x4ef> */
...
x86_l_4ea:
	/* 0x4ea: jmp    546 <generic_kprobe_event+0x546> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_4ef:
...
x86_l_507:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_50a:
	/* 0x50a: je     4e0 <generic_kprobe_event+0x4e0> */
...
x86_l_527:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_52a:
	/* 0x52a: je     4e0 <generic_kprobe_event+0x4e0> */
...
x86_l_53c:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R13, X86_WIDTH_64);
x86_l_53f:
	/* 0x53f: jne    4e0 <generic_kprobe_event+0x4e0> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x53f, 0x4e0, x86_l_4e0);
x86_l_541:
	/* 0x541: jmp    20b <generic_kprobe_event+0x20b> */
