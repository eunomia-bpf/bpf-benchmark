...
x86_l_2d:
	/* 0x2d: je     abd <generic_fexit_actions+0xabd> */
...
x86_l_3c:
	/* 0x3c: jl     abd <generic_fexit_actions+0xabd> */
...
x86_l_59:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5c:
	/* 0x5c: je     abd <generic_fexit_actions+0xabd> */
...
x86_l_91:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_94:
	/* 0x94: je     bb <generic_fexit_actions+0xbb> */
...
x86_l_9e:
	/* 0x9e: je     d6 <generic_fexit_actions+0xd6> */
...
x86_l_b9:
	/* 0xb9: jmp    ef <generic_fexit_actions+0xef> */
...
x86_l_d4:
	/* 0xd4: jmp    ea <generic_fexit_actions+0xea> */
...
x86_l_10a:
	/* 0x10a: jmp    131 <generic_fexit_actions+0x131> */
...
x86_l_12b:
	/* 0x12b: je     a9e <generic_fexit_actions+0xa9e> */
...
x86_l_13c:
	/* 0x13c: jae    a9e <generic_fexit_actions+0xa9e> */
...
x86_l_169:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_16c:
	/* 0x16c: je     121 <generic_fexit_actions+0x121> */
...
x86_l_1e9:
	/* 0x1e9: jne    61c <generic_fexit_actions+0x61c> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x1e9, 0x61c, x86_l_61c);
x86_l_1ef:
	/* 0x1ef: jmp    63d <generic_fexit_actions+0x63d> */
...
x86_l_23f:
	/* 0x23f: ja     117 <generic_fexit_actions+0x117> */
...
x86_l_24d:
	/* 0x24d: jne    117 <generic_fexit_actions+0x117> */
...
x86_l_296:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_299:
	/* 0x299: je     117 <generic_fexit_actions+0x117> */
...
x86_l_2a5:
	/* 0x2a5: ja     117 <generic_fexit_actions+0x117> */
...
x86_l_2b3:
	/* 0x2b3: jne    117 <generic_fexit_actions+0x117> */
...
x86_l_33b:
	/* 0x33b: jmp    63d <generic_fexit_actions+0x63d> */
...
x86_l_349:
	/* 0x349: je     606 <generic_fexit_actions+0x606> */
	X86_SIM_X86_JCC(X86_CC_E, 0x349, 0x606, x86_l_606);
x86_l_34f:
	/* 0x34f: cmp    r13d,0x3 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R13, X86_WIDTH_32, 3ULL);
x86_l_353:
	/* 0x353: jne    117 <generic_fexit_actions+0x117> */
...
x86_l_3a9:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3ac:
	/* 0x3ac: je     7c4 <generic_fexit_actions+0x7c4> */
...
x86_l_3ba:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_3be:
	/* 0x3be: ja     3cf <generic_fexit_actions+0x3cf> */
...
x86_l_3c9:
	/* 0x3c9: je     671 <generic_fexit_actions+0x671> */
...
x86_l_3db:
	/* 0x3db: jne    121 <generic_fexit_actions+0x121> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x3db, 0x121, x86_l_121);
x86_l_3e1:
	/* 0x3e1: jmp    117 <generic_fexit_actions+0x117> */
...
x86_l_424:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_427:
	/* 0x427: je     7d2 <generic_fexit_actions+0x7d2> */
...
x86_l_435:
	/* 0x435: jne    7df <generic_fexit_actions+0x7df> */
...
x86_l_467:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_46b:
	/* 0x46b: je     7d2 <generic_fexit_actions+0x7d2> */
...
x86_l_49f:
	/* 0x49f: jmp    730 <generic_fexit_actions+0x730> */
...
x86_l_4ac:
	/* 0x4ac: jmp    117 <generic_fexit_actions+0x117> */
...
x86_l_4c3:
	/* 0x4c3: jmp    63d <generic_fexit_actions+0x63d> */
...
x86_l_4eb:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_4ee:
	/* 0x4ee: je     53e <generic_fexit_actions+0x53e> */
...
x86_l_51f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_522:
	/* 0x522: je     747 <generic_fexit_actions+0x747> */
...
x86_l_53e:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_542:
	/* 0x542: jmp    117 <generic_fexit_actions+0x117> */
...
x86_l_580:
	/* 0x580: je     9d6 <generic_fexit_actions+0x9d6> */
...
x86_l_599:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_59c:
	/* 0x59c: je     9d6 <generic_fexit_actions+0x9d6> */
...
x86_l_601:
	/* 0x601: jmp    809 <generic_fexit_actions+0x809> */
...
x86_l_615:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 64424509440ULL);
x86_l_61a:
	/* 0x61a: je     63d <generic_fexit_actions+0x63d> */
...
x86_l_628:
	/* 0x628: jmp    63d <generic_fexit_actions+0x63d> */
...
x86_l_658:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_65b:
	/* 0x65b: je     662 <generic_fexit_actions+0x662> */
...
x86_l_66c:
	/* 0x66c: jmp    117 <generic_fexit_actions+0x117> */
...
x86_l_6a6:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R13, X86_WIDTH_32, 1ULL);
x86_l_6aa:
	/* 0x6aa: jne    7ae <generic_fexit_actions+0x7ae> */
...
x86_l_6be:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RCX, X86_WIDTH_32, 0ULL);
x86_l_6c3:
	/* 0x6c3: ja     7c7 <generic_fexit_actions+0x7c7> */
...
x86_l_6d5:
	...
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RBP, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_6dc:
	/* 0x6dc: jne    7d2 <generic_fexit_actions+0x7d2> */
...
x86_l_73a:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_32);
x86_l_73c:
	/* 0x73c: jne    121 <generic_fexit_actions+0x121> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x73c, 0x121, x86_l_121);
x86_l_742:
	/* 0x742: jmp    117 <generic_fexit_actions+0x117> */
...
x86_l_762:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_765:
	/* 0x765: je     52b <generic_fexit_actions+0x52b> */
...
x86_l_79e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_7a1:
	/* 0x7a1: je     a46 <generic_fexit_actions+0xa46> */
	X86_SIM_X86_JCC(X86_CC_E, 0x7a1, 0xa46, x86_l_a46);
x86_l_7a7:
	/* 0x7a7: inc    DWORD PTR [rax] */
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_32, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_7a9:
	/* 0x7a9: jmp    a6e <generic_fexit_actions+0xa6e> */
...
x86_l_7d2:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_32);
x86_l_7d4:
	/* 0x7d4: jne    121 <generic_fexit_actions+0x121> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x7d4, 0x121, x86_l_121);
x86_l_7da:
	/* 0x7da: jmp    117 <generic_fexit_actions+0x117> */
...
x86_l_7f9:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_32);
x86_l_7fb:
	/* 0x7fb: jne    121 <generic_fexit_actions+0x121> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x7fb, 0x121, x86_l_121);
x86_l_801:
	/* 0x801: jmp    117 <generic_fexit_actions+0x117> */
...
x86_l_83c:
	...
	X86_SIM_L_EXEC_LEA(X86_RBX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 32ULL);
x86_l_841:
	/* 0x841: jmp    856 <generic_fexit_actions+0x856> */
...
x86_l_850:
	/* 0x850: je     97b <generic_fexit_actions+0x97b> */
...
x86_l_86b:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_86e:
	/* 0x86e: je     97b <generic_fexit_actions+0x97b> */
...
x86_l_88b:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_88e:
	/* 0x88e: je     97b <generic_fexit_actions+0x97b> */
...
x86_l_89a:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_89e:
	/* 0x89e: je     97b <generic_fexit_actions+0x97b> */
...
x86_l_8d3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_8d6:
	/* 0x8d6: je     914 <generic_fexit_actions+0x914> */
...
x86_l_8ef:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_8f2:
	/* 0x8f2: je     914 <generic_fexit_actions+0x914> */
...
x86_l_8fe:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RAX, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_R14, 1), 24184ULL);
x86_l_906:
	/* 0x906: je     920 <generic_fexit_actions+0x920> */
...
x86_l_912:
	/* 0x912: jmp    928 <generic_fexit_actions+0x928> */
...
x86_l_92a:
	/* 0x92a: jle    843 <generic_fexit_actions+0x843> */
...
x86_l_971:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_RAX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 56ULL);
x86_l_976:
	/* 0x976: jmp    843 <generic_fexit_actions+0x843> */
...
x86_l_99c:
	/* 0x99c: je     9be <generic_fexit_actions+0x9be> */
...
x86_l_9b2:
	/* 0x9b2: jbe    9be <generic_fexit_actions+0x9be> */
	X86_SIM_X86_JCC(X86_CC_BE, 0x9b2, 0x9be, x86_l_9be);
x86_l_9b4:
	/* 0x9b4: mov    DWORD PTR [rsp+0x2c],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 188978561024ULL);
x86_l_9bc:
	/* 0x9bc: jmp    9d6 <generic_fexit_actions+0x9d6> */
...
x86_l_9e0:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_9e4:
	/* 0x9e4: je     a0a <generic_fexit_actions+0xa0a> */
...
x86_l_a14:
	/* 0xa14: je     117 <generic_fexit_actions+0x117> */
...
x86_l_a41:
	/* 0xa41: jmp    117 <generic_fexit_actions+0x117> */
...
x86_l_a6e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RBX, X86_RBX, X86_WIDTH_32);
x86_l_a70:
	/* 0xa70: je     52b <generic_fexit_actions+0x52b> */
...
x86_l_a89:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_a8c:
	/* 0xa8c: je     52b <generic_fexit_actions+0x52b> */
...
x86_l_a99:
	/* 0xa99: jmp    52b <generic_fexit_actions+0x52b> */
...
x86_l_aa3:
	/* 0xaa3: je     abd <generic_fexit_actions+0xabd> */
...
x86_l_ac9:
	/* 0xac9: jmp    ace <generic_fexit_actions+0xace> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_ace:
