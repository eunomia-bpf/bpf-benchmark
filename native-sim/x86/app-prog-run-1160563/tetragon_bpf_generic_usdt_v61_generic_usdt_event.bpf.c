...
x86_l_29:
	/* 0x29: je     4eb <generic_usdt_event+0x4eb> */
...
x86_l_51:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_54:
	/* 0x54: je     4eb <generic_usdt_event+0x4eb> */
...
x86_l_7f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_82:
	/* 0x82: je     4eb <generic_usdt_event+0x4eb> */
...
x86_l_c9:
	/* 0xc9: jmp    4eb <generic_usdt_event+0x4eb> */
...
x86_l_134:
	/* 0x134: je     4eb <generic_usdt_event+0x4eb> */
...
x86_l_158:
	/* 0x158: je     4eb <generic_usdt_event+0x4eb> */
...
x86_l_1b5:
	/* 0x1b5: jmp    4eb <generic_usdt_event+0x4eb> */
...
x86_l_1c0:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1c3:
	/* 0x1c3: je     4eb <generic_usdt_event+0x4eb> */
...
x86_l_205:
	/* 0x205: je     4fa <generic_usdt_event+0x4fa> */
...
x86_l_30e:
	/* 0x30e: je     374 <generic_usdt_event+0x374> */
...
x86_l_370:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_372:
	/* 0x372: jmp    37c <generic_usdt_event+0x37c> */
...
x86_l_4f5:
	/* 0x4f5: jmp    551 <generic_usdt_event+0x551> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_4fa:
...
x86_l_512:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_515:
	/* 0x515: je     4eb <generic_usdt_event+0x4eb> */
...
x86_l_532:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_535:
	/* 0x535: je     4eb <generic_usdt_event+0x4eb> */
...
x86_l_547:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R13, X86_WIDTH_64);
x86_l_54a:
	/* 0x54a: jne    4eb <generic_usdt_event+0x4eb> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x54a, 0x4eb, x86_l_4eb);
x86_l_54c:
	/* 0x54c: jmp    20b <generic_usdt_event+0x20b> */
