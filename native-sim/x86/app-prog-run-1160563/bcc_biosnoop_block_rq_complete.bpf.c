...
x86_l_18:
	/* 0x18: je     31 <block_rq_complete+0x31> */
	X86_SIM_X86_JCC(X86_CC_E, 0x18, 0x31, x86_l_31);
x86_l_1a:
...
x86_l_23:
	/* 0x23: call   28 <block_rq_complete+0x28> */
	X86_SIM_BPF_CALL_ID(X86_SIM_HELPER_bpf_current_task_under_cgroup);
x86_l_28:
	/* 0x28: test   rax,rax */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_2b:
	/* 0x2b: je     1b6 <block_rq_complete+0x1b6> */
	X86_SIM_X86_JCC(X86_CC_E, 0x2b, 0x1b6, x86_l_1b6);
x86_l_31:
	/* 0x31: call   36 <block_rq_complete+0x36> */
	X86_SIM_BPF_CALL_ID(X86_SIM_HELPER_bpf_ktime_get_ns);
x86_l_36:
	/* 0x36: mov    r14,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_R14, X86_RAX, X86_WIDTH_64);
x86_l_39:
	/* 0x39: mov    QWORD PTR [rsp+0x40],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 274877906944ULL);
x86_l_42:
	/* 0x42: mov    QWORD PTR [rsp+0x38],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 240518168576ULL);
x86_l_4b:
	/* 0x4b: mov    QWORD PTR [rsp+0x30],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 206158430208ULL);
x86_l_54:
	/* 0x54: mov    QWORD PTR [rsp+0x28],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_5d:
	/* 0x5d: mov    QWORD PTR [rsp+0x20],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 137438953472ULL);
x86_l_66:
	/* 0x66: mov    QWORD PTR [rsp+0x18],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 103079215104ULL);
x86_l_6f:
	/* 0x6f: mov    QWORD PTR [rsp+0x10],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 68719476736ULL);
x86_l_78:
	/* 0x78: mov    QWORD PTR [rsp+0x8],0x0 */
...
x86_l_8b:
	/* 0x8b: call   90 <block_rq_complete+0x90> */
	X86_SIM_BPF_CALL_ID(X86_SIM_HELPER_bpf_map_lookup_elem);
x86_l_90:
	/* 0x90: test   rax,rax */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_93:
	/* 0x93: je     1b6 <block_rq_complete+0x1b6> */
	X86_SIM_X86_JCC(X86_CC_E, 0x93, 0x1b6, x86_l_1b6);
x86_l_99:
	/* 0x99: mov    r15,rax */
...
x86_l_9f:
	/* 0x9f: sub    r13,QWORD PTR [rax+0x8] */
	X86_SIM_L_EXEC_ALU_MEM(X86_R13, X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_SUB)), 8ULL);
x86_l_a3:
	/* 0xa3: js     195 <block_rq_complete+0x195> */
	X86_SIM_X86_JCC(X86_CC_S, 0xa3, 0x195, x86_l_195);
x86_l_a9:
...
x86_l_190:
	/* 0x190: call   195 <block_rq_complete+0x195> */
...
x86_l_1a2:
	/* 0x1a2: call   1a7 <block_rq_complete+0x1a7> */
	X86_SIM_BPF_CALL_ID(X86_SIM_HELPER_bpf_map_delete_elem);
x86_l_1a7:
	/* 0x1a7: mov    rdi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&infobyreq)));
x86_l_1ae:
	/* 0x1ae: mov    rsi,rbx */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RBX, X86_WIDTH_64);
x86_l_1b1:
	/* 0x1b1: call   1b6 <block_rq_complete+0x1b6> */
	X86_SIM_BPF_CALL_ID(X86_SIM_HELPER_bpf_map_delete_elem);
x86_l_1b6:
	/* 0x1b6: xor    eax,eax */
...
x86_l_1bc:
	/* 0x1bc: jmp    1c1 <block_rq_complete+0x1c1> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_1c1:
