...
x86_l_38:
	/* 0x38: je     1bc <trace_dup3+0x1bc> */
	X86_SIM_X86_JCC(X86_CC_E, 0x38, 0x1bc, x86_l_1bc);
x86_l_3e:
	/* 0x3e: mov    DWORD PTR [r14+0x68],0x124 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 446676599076ULL);
x86_l_46:
	/* 0x46: mov    eax,0x7d */
...
x86_l_1b7:
	/* 0x1b7: jmp    6ab <trace_dup3+0x6ab> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_1bc:
...
x86_l_510:
	/* 0x510: jne    55f <trace_dup3+0x55f> */
