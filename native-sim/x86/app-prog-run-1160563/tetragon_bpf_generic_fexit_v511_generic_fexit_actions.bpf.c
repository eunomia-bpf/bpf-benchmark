...
x86_l_2d:
	/* 0x2d: je     acd <generic_fexit_actions+0xacd> */
...
x86_l_3c:
	/* 0x3c: jl     acd <generic_fexit_actions+0xacd> */
...
x86_l_59:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5c:
	/* 0x5c: je     acd <generic_fexit_actions+0xacd> */
...
x86_l_12b:
	/* 0x12b: je     aae <generic_fexit_actions+0xaae> */
...
x86_l_13c:
	/* 0x13c: jae    aae <generic_fexit_actions+0xaae> */
...
x86_l_79e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_7a1:
	/* 0x7a1: je     a56 <generic_fexit_actions+0xa56> */
	X86_SIM_X86_JCC(X86_CC_E, 0x7a1, 0xa56, x86_l_a56);
x86_l_7a7:
	/* 0x7a7: inc    DWORD PTR [rax] */
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_32, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_7a9:
	/* 0x7a9: jmp    a7e <generic_fexit_actions+0xa7e> */
...
x86_l_a0e:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_RAX, 2), 17179869184ULL);
x86_l_a14:
	/* 0xa14: je     a3d <generic_fexit_actions+0xa3d> */
...
x86_l_a47:
	/* 0xa47: je     117 <generic_fexit_actions+0x117> */
...
x86_l_a51:
	/* 0xa51: jmp    117 <generic_fexit_actions+0x117> */
...
x86_l_a7e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RBX, X86_RBX, X86_WIDTH_32);
x86_l_a80:
	/* 0xa80: je     52b <generic_fexit_actions+0x52b> */
...
x86_l_a99:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_a9c:
	/* 0xa9c: je     52b <generic_fexit_actions+0x52b> */
...
x86_l_aa9:
	/* 0xaa9: jmp    52b <generic_fexit_actions+0x52b> */
...
x86_l_ab3:
	/* 0xab3: je     acd <generic_fexit_actions+0xacd> */
...
x86_l_ad9:
	/* 0xad9: jmp    ade <generic_fexit_actions+0xade> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_ade:
