...
SEC("xdp")
int tetragon_bpf_generic_usdt_generic_usdt_output_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_14:
	/* 0x14: mov    rdi,QWORD PTR [rip+0x7eb1] */
...
x86_l_25:
	/* 0x25: je     d3 <generic_usdt_output+0xd3> */
...
x86_l_4f:
	/* 0x4f: mov    rsi,QWORD PTR [rip+0x7eb1] */
...
x86_l_64:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_67:
	/* 0x67: js     90 <generic_usdt_output+0x90> */
...
x86_l_71:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_76:
	/* 0x76: mov    rdi,QWORD PTR [rip+0x7eb1] */
...
x86_l_84:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_87:
	/* 0x87: je     d3 <generic_usdt_output+0xd3> */
...
x86_l_8e:
	/* 0x8e: jmp    d3 <generic_usdt_output+0xd3> */
...
x86_l_9b:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_a0:
	/* 0xa0: mov    rdi,QWORD PTR [rip+0x7eb1] */
...
x86_l_124:
	...
	X86_SIM_L_EXEC_ALU_IMM(X86_RSP, X86_WIDTH_64, X86_ALU_ADD, 16ULL);
x86_l_128:
	/* 0x128: jmp    12d <generic_usdt_output+0x12d> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_12d:
