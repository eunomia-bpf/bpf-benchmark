...
SEC("xdp")
int tetragon_bpf_generic_tracepoint_v61_filter_64ty_map_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_17:
	/* 0x17: mov    rdi,QWORD PTR [rip+0x5a3] */
...
x86_l_28:
	/* 0x28: je     56 <filter_64ty_map+0x56> */
	X86_SIM_X86_JCC(X86_CC_E, 0x28, 0x56, x86_l_56);
x86_l_2a:
	/* 0x2a: mov    rcx,QWORD PTR [r14] */
...
x86_l_41:
	/* 0x41: mov    ecx,DWORD PTR [rbx+0x4] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RCX, X86_RBX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 4ULL);
x86_l_44:
	/* 0x44: cmp    ecx,0xb */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 11ULL);
x86_l_47:
	/* 0x47: je     61 <filter_64ty_map+0x61> */
	X86_SIM_X86_JCC(X86_CC_E, 0x47, 0x61, x86_l_61);
x86_l_49:
	/* 0x49: cmp    ecx,0xa */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 10ULL);
x86_l_4c:
	/* 0x4c: jne    69 <filter_64ty_map+0x69> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x4c, 0x69, x86_l_69);
x86_l_4e:
	/* 0x4e: test   rax,rax */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_51:
...
x86_l_54:
	/* 0x54: jmp    6b <filter_64ty_map+0x6b> */
	X86_SIM_X86_JMP(0x54, 0x6b, x86_l_6b);
x86_l_56:
	/* 0x56: xor    eax,eax */
...
x86_l_5c:
	/* 0x5c: jmp    77 <filter_64ty_map+0x77> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_61:
	/* 0x61: test   rax,rax */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
...
x86_l_67:
	/* 0x67: jmp    6b <filter_64ty_map+0x6b> */
	X86_SIM_X86_JMP(0x67, 0x6b, x86_l_6b);
x86_l_69:
	/* 0x69: xor    eax,eax */
	X86_SIM_L_EXEC_ALU_REG(X86_RAX, X86_RAX, X86_WIDTH_32, X86_ALU_XOR);
x86_l_6b:
...
x86_l_6e:
	...
	X86_SIM_L_EXEC_ALU_IMM(X86_RSP, X86_WIDTH_64, X86_ALU_ADD, 24ULL);
x86_l_72:
	/* 0x72: jmp    77 <filter_64ty_map+0x77> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_77:
