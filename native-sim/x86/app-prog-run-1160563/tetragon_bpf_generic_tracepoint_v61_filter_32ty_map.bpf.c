...
SEC("xdp")
int tetragon_bpf_generic_tracepoint_v61_filter_32ty_map_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_17:
	/* 0x17: mov    rdi,QWORD PTR [rip+0xa23] */
...
x86_l_28:
	/* 0x28: je     5d <filter_32ty_map+0x5d> */
	X86_SIM_X86_JCC(X86_CC_E, 0x28, 0x5d, x86_l_5d);
x86_l_2a:
	/* 0x2a: mov    ecx,DWORD PTR [r14] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RCX, X86_R14, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_2d:
	/* 0x2d: mov    QWORD PTR [rsp+0x10],rcx */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_RCX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 16ULL);
x86_l_32:
	/* 0x32: mov    ecx,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RCX, X86_WIDTH_32, 1ULL);
x86_l_37:
	/* 0x37: lea    rsi,[rsp+0x10] */
...
x86_l_41:
	/* 0x41: mov    edx,DWORD PTR [rbx+0x4] */
...
x86_l_49:
	/* 0x49: ja     78 <filter_32ty_map+0x78> */
	X86_SIM_X86_JCC(X86_CC_A, 0x49, 0x78, x86_l_78);
x86_l_4b:
	/* 0x4b: mov    esi,0x30038400 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RSI, X86_WIDTH_32, 805536768ULL);
x86_l_50:
	/* 0x50: bt     esi,edx */
	X86_SIM_L_EXEC_BT(X86_RSI, X86_RDX, X86_WIDTH_32);
x86_l_53:
	/* 0x53: jae    68 <filter_32ty_map+0x68> */
	X86_SIM_X86_JCC(X86_CC_AE, 0x53, 0x68, x86_l_68);
x86_l_55:
	/* 0x55: test   rax,rax */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_58:
...
x86_l_5b:
	/* 0x5b: jmp    78 <filter_32ty_map+0x78> */
	X86_SIM_X86_JMP(0x5b, 0x78, x86_l_78);
x86_l_5d:
	/* 0x5d: xor    eax,eax */
...
x86_l_63:
	/* 0x63: jmp    84 <filter_32ty_map+0x84> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_68:
	/* 0x68: mov    esi,0xc0800 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RSI, X86_WIDTH_32, 788480ULL);
x86_l_6d:
	/* 0x6d: bt     esi,edx */
	X86_SIM_L_EXEC_BT(X86_RSI, X86_RDX, X86_WIDTH_32);
x86_l_70:
	/* 0x70: jae    78 <filter_32ty_map+0x78> */
	X86_SIM_X86_JCC(X86_CC_AE, 0x70, 0x78, x86_l_78);
x86_l_72:
	/* 0x72: test   rax,rax */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_75:
...
x86_l_7b:
	...
	X86_SIM_L_EXEC_ALU_IMM(X86_RSP, X86_WIDTH_64, X86_ALU_ADD, 24ULL);
x86_l_7f:
	/* 0x7f: jmp    84 <filter_32ty_map+0x84> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_84:
