...
x86_l_2b:
	/* 0x2b: je     619 <generic_usdt_event+0x619> */
...
x86_l_5a:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5d:
	/* 0x5d: je     619 <generic_usdt_event+0x619> */
...
x86_l_88:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_8b:
	/* 0x8b: je     619 <generic_usdt_event+0x619> */
...
x86_l_d3:
	/* 0xd3: jmp    619 <generic_usdt_event+0x619> */
...
x86_l_150:
	/* 0x150: je     619 <generic_usdt_event+0x619> */
...
x86_l_179:
	/* 0x179: je     619 <generic_usdt_event+0x619> */
...
x86_l_1e1:
	/* 0x1e1: jmp    619 <generic_usdt_event+0x619> */
...
x86_l_1ed:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1f0:
	/* 0x1f0: je     619 <generic_usdt_event+0x619> */
...
x86_l_235:
	/* 0x235: je     62a <generic_usdt_event+0x62a> */
...
x86_l_383:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_386:
	/* 0x386: je     41c <generic_usdt_event+0x41c> */
...
x86_l_418:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_41a:
	/* 0x41a: jmp    424 <generic_usdt_event+0x424> */
...
x86_l_625:
	/* 0x625: jmp    683 <generic_usdt_event+0x683> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_62a:
...
x86_l_642:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_645:
	/* 0x645: je     619 <generic_usdt_event+0x619> */
...
x86_l_662:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_665:
	/* 0x665: je     619 <generic_usdt_event+0x619> */
...
x86_l_679:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R12, X86_WIDTH_64);
x86_l_67c:
	/* 0x67c: jne    619 <generic_usdt_event+0x619> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x67c, 0x619, x86_l_619);
x86_l_67e:
	/* 0x67e: jmp    23b <generic_usdt_event+0x23b> */
