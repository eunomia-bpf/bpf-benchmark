...
x86_l_7:
	/* 0x7: je     3b <iter+0x3b> */
	X86_SIM_X86_JCC(X86_CC_E, 0x7, 0x3b, x86_l_3b);
x86_l_9:
	/* 0x9: push   rax */
...
x86_l_3d:
	/* 0x3d: jmp    42 <iter+0x42> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_42:
