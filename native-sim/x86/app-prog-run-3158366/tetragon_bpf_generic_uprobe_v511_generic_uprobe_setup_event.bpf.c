...
x86_l_25:
	/* 0x25: je     1ff <generic_uprobe_setup_event+0x1ff> */
	X86_SIM_X86_JCC(X86_CC_E, 0x25, 0x1ff, x86_l_1ff);
x86_l_2b:
	/* 0x2b: mov    r14,rax */
...
x86_l_43:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_46:
	/* 0x46: je     1ff <generic_uprobe_setup_event+0x1ff> */
	X86_SIM_X86_JCC(X86_CC_E, 0x46, 0x1ff, x86_l_1ff);
x86_l_4c:
	/* 0x4c: mov    r15,rax */
...
x86_l_d9:
	/* 0xd9: jle    186 <generic_uprobe_setup_event+0x186> */
	X86_SIM_X86_JCC(X86_CC_LE, 0xd9, 0x186, x86_l_186);
x86_l_df:
...
x86_l_111:
	/* 0x111: lea    rsi,[rsp+0x30] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 48ULL);
x86_l_116:
	/* 0x116: lea    rdx,[rsp+0x18] */
...
x86_l_159:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_15c:
	/* 0x15c: je     162 <generic_uprobe_setup_event+0x162> */
	X86_SIM_X86_JCC(X86_CC_E, 0x15c, 0x162, x86_l_162);
x86_l_15e:
	/* 0x15e: inc    DWORD PTR [rax] */
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_32, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_160:
	/* 0x160: jmp    186 <generic_uprobe_setup_event+0x186> */
	X86_SIM_X86_JMP(0x160, 0x186, x86_l_186);
x86_l_162:
	/* 0x162: mov    DWORD PTR [rsp+0x8],0x1 */
...
x86_l_184:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_186:
	/* 0x186: mov    DWORD PTR [rsp+0x18],0x0 */
...
x86_l_1a1:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1a4:
	/* 0x1a4: je     1c9 <generic_uprobe_setup_event+0x1c9> */
	X86_SIM_X86_JCC(X86_CC_E, 0x1a4, 0x1c9, x86_l_1c9);
x86_l_1a6:
	/* 0x1a6: mov    rsi,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RAX, X86_WIDTH_64);
x86_l_1a9:
	/* 0x1a9: add    rsi,0x5ef8 */
...
x86_l_1be:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1c1:
	/* 0x1c1: je     1c9 <generic_uprobe_setup_event+0x1c9> */
	X86_SIM_X86_JCC(X86_CC_E, 0x1c1, 0x1c9, x86_l_1c9);
x86_l_1c3:
	/* 0x1c3: cmp    DWORD PTR [rax+0x40],0xffffffff */
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 279172874239ULL);
x86_l_1c7:
	/* 0x1c7: jne    1e4 <generic_uprobe_setup_event+0x1e4> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x1c7, 0x1e4, x86_l_1e4);
x86_l_1c9:
...
x86_l_1e2:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_1e4:
	/* 0x1e4: mov    rsi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&uprobe_calls)));
x86_l_1eb:
	/* 0x1eb: mov    ecx,0x1 */
...
x86_l_205:
	/* 0x205: jmp    20a <generic_uprobe_setup_event+0x20a> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_20a:
