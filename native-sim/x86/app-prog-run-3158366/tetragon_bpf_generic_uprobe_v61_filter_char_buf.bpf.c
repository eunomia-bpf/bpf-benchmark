...
x86_l_bf:
	/* 0xbf: mov    rdi,QWORD PTR [rip+0x2040] */
...
x86_l_e8:
	/* 0xe8: mov    rdi,QWORD PTR [rip+0x2040] */
...
x86_l_204:
	/* 0x204: mov    rdi,QWORD PTR [rip+0x1fa0] */
...
x86_l_225:
	/* 0x225: mov    rdi,QWORD PTR [rip+0x1fa0] */
...
x86_l_3ad:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RBP, X86_RDX, X86_WIDTH_32);
x86_l_3af:
	/* 0x3af: mov    rdi,QWORD PTR [rip+0x1c10] */
...
x86_l_3c8:
	/* 0x3c8: mov    rdi,QWORD PTR [rip+0x1c10] */
...
x86_l_4b5:
	/* 0x4b5: mov    rdi,QWORD PTR [rip+0x1c10] */
...
x86_l_4ef:
	/* 0x4ef: mov    rdi,QWORD PTR [rip+0x1c10] */
...
x86_l_523:
	/* 0x523: mov    rdi,QWORD PTR [rip+0x1c0c] */
...
x86_l_548:
	/* 0x548: mov    rdi,QWORD PTR [rip+0x1c0c] */
...
x86_l_55e:
	/* 0x55e: mov    rdi,QWORD PTR [rip+0x1c0c] */
...
x86_l_571:
	/* 0x571: mov    rdi,QWORD PTR [rip+0x1c0c] */
...
x86_l_584:
	/* 0x584: mov    rdi,QWORD PTR [rip+0x1c0c] */
...
x86_l_597:
	/* 0x597: mov    rdi,QWORD PTR [rip+0x1c0c] */
...
x86_l_5aa:
	/* 0x5aa: mov    rdi,QWORD PTR [rip+0x1c0c] */
...
x86_l_5bd:
	/* 0x5bd: mov    rdi,QWORD PTR [rip+0x1c0c] */
...
x86_l_5d0:
	/* 0x5d0: mov    rdi,QWORD PTR [rip+0x1c0c] */
...
x86_l_650:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_655:
	/* 0x655: mov    rdi,QWORD PTR [rip+0x2243] */
...
x86_l_712:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_717:
	/* 0x717: mov    rdi,QWORD PTR [rip+0x2251] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&substring_map)));
x86_l_71e:
	/* 0x71e: mov    rsi,r13 */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_R13, X86_WIDTH_64);
...
x86_l_799:
	/* 0x799: mov    r15,QWORD PTR [rip+0x2263] */
...
x86_l_7d7:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RBX, X86_WIDTH_32, 16ULL);
x86_l_7dc:
	/* 0x7dc: mov    r15,QWORD PTR [rip+0x2265] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_R15, (void *)(long)(((__u64)(long)&substring_map)));
x86_l_7e3:
