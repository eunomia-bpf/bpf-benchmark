...
SEC("xdp")
int tetragon_bpf_generic_uprobe_generic_uprobe_event_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_2b:
	/* 0x2b: je     607 <generic_uprobe_event+0x607> */
	X86_SIM_X86_JCC(X86_CC_E, 0x2b, 0x607, x86_l_607);
x86_l_31:
	/* 0x31: mov    r14,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_R14, X86_RAX, X86_WIDTH_64);
x86_l_34:
	/* 0x34: lea    rsi,[rax+0x5ee8] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RAX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 24296ULL);
x86_l_3b:
	/* 0x3b: mov    DWORD PTR [rax+0x5ee8],0x0 */
...
x86_l_53:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_56:
	/* 0x56: je     607 <generic_uprobe_event+0x607> */
	X86_SIM_X86_JCC(X86_CC_E, 0x56, 0x607, x86_l_607);
x86_l_5c:
...
x86_l_81:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_84:
	/* 0x84: je     607 <generic_uprobe_event+0x607> */
	X86_SIM_X86_JCC(X86_CC_E, 0x84, 0x607, x86_l_607);
x86_l_8a:
	/* 0x8a: mov    r15,rax */
...
x86_l_cc:
	/* 0xcc: jmp    607 <generic_uprobe_event+0x607> */
	X86_SIM_X86_JMP(0xcc, 0x607, x86_l_607);
x86_l_d1:
	/* 0xd1: xor    ebp,ebp */
...
x86_l_10a:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_10d:
	/* 0x10d: je     607 <generic_uprobe_event+0x607> */
	X86_SIM_X86_JCC(X86_CC_E, 0x10d, 0x607, x86_l_607);
x86_l_113:
	/* 0x113: cmp    ebp,0xb */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBP, X86_WIDTH_32, 11ULL);
x86_l_116:
	/* 0x116: ja     607 <generic_uprobe_event+0x607> */
	X86_SIM_X86_JCC(X86_CC_A, 0x116, 0x607, x86_l_607);
x86_l_11c:
	/* 0x11c: mov    edx,ebp */
...
x86_l_149:
	/* 0x149: je     607 <generic_uprobe_event+0x607> */
	X86_SIM_X86_JCC(X86_CC_E, 0x149, 0x607, x86_l_607);
x86_l_14f:
...
x86_l_172:
	/* 0x172: je     607 <generic_uprobe_event+0x607> */
	X86_SIM_X86_JCC(X86_CC_E, 0x172, 0x607, x86_l_607);
x86_l_178:
...
x86_l_1da:
	/* 0x1da: jmp    607 <generic_uprobe_event+0x607> */
	X86_SIM_X86_JMP(0x1da, 0x607, x86_l_607);
x86_l_1df:
	/* 0x1df: xor    eax,eax */
...
x86_l_1e6:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1e9:
	/* 0x1e9: je     607 <generic_uprobe_event+0x607> */
	X86_SIM_X86_JCC(X86_CC_E, 0x1e9, 0x607, x86_l_607);
x86_l_1ef:
...
x86_l_22e:
	/* 0x22e: je     618 <generic_uprobe_event+0x618> */
	X86_SIM_X86_JCC(X86_CC_E, 0x22e, 0x618, x86_l_618);
x86_l_234:
...
x86_l_242:
	/* 0x242: mov    QWORD PTR [r14+0x5eec],0x0 */
...
x86_l_24d:
	/* 0x24d: mov    DWORD PTR [r14+0x6410],0x0 */
...
x86_l_5dd:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_5df:
	/* 0x5df: mov    BYTE PTR [r14+0x5ef8],0x0 */
...
x86_l_5ec:
	/* 0x5ec: mov    rsi,QWORD PTR [rip+0x0] */
...
x86_l_613:
	/* 0x613: jmp    671 <generic_uprobe_event+0x671> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_618:
	/* 0x618: mov    QWORD PTR [rsp+0x18],0xffffffffffffffff */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 107374182399ULL);
x86_l_621:
	/* 0x621: lea    rsi,[rsp+0x18] */
...
x86_l_630:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_633:
	/* 0x633: je     607 <generic_uprobe_event+0x607> */
	X86_SIM_X86_JCC(X86_CC_E, 0x633, 0x607, x86_l_607);
x86_l_635:
	/* 0x635: mov    DWORD PTR [rsp+0x14],0x1 */
...
x86_l_650:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_653:
	/* 0x653: je     607 <generic_uprobe_event+0x607> */
	X86_SIM_X86_JCC(X86_CC_E, 0x653, 0x607, x86_l_607);
x86_l_655:
	/* 0x655: mov    rdi,rax */
...
x86_l_667:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R12, X86_WIDTH_64);
x86_l_66a:
	/* 0x66a: jne    607 <generic_uprobe_event+0x607> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x66a, 0x607, x86_l_607);
x86_l_66c:
	/* 0x66c: jmp    234 <generic_uprobe_event+0x234> */
	X86_SIM_X86_JMP(0x66c, 0x234, x86_l_234);
x86_l_671:
