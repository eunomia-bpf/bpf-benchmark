...
x86_l_2b:
	/* 0x2b: je     612 <generic_uprobe_event+0x612> */
...
x86_l_53:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_56:
	/* 0x56: je     612 <generic_uprobe_event+0x612> */
...
x86_l_81:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_84:
	/* 0x84: je     612 <generic_uprobe_event+0x612> */
...
x86_l_cc:
	/* 0xcc: jmp    612 <generic_uprobe_event+0x612> */
...
x86_l_149:
	/* 0x149: je     612 <generic_uprobe_event+0x612> */
...
x86_l_172:
	/* 0x172: je     612 <generic_uprobe_event+0x612> */
...
x86_l_1da:
	/* 0x1da: jmp    612 <generic_uprobe_event+0x612> */
...
x86_l_1e6:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1e9:
	/* 0x1e9: je     612 <generic_uprobe_event+0x612> */
...
x86_l_22e:
	/* 0x22e: je     623 <generic_uprobe_event+0x623> */
...
x86_l_37c:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_37f:
	/* 0x37f: je     415 <generic_uprobe_event+0x415> */
...
x86_l_411:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_413:
	/* 0x413: jmp    41d <generic_uprobe_event+0x41d> */
...
x86_l_61e:
	/* 0x61e: jmp    67c <generic_uprobe_event+0x67c> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_623:
...
x86_l_63b:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_63e:
	/* 0x63e: je     612 <generic_uprobe_event+0x612> */
...
x86_l_65b:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_65e:
	/* 0x65e: je     612 <generic_uprobe_event+0x612> */
...
x86_l_672:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R12, X86_WIDTH_64);
x86_l_675:
	/* 0x675: jne    612 <generic_uprobe_event+0x612> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x675, 0x612, x86_l_612);
x86_l_677:
	/* 0x677: jmp    234 <generic_uprobe_event+0x234> */
