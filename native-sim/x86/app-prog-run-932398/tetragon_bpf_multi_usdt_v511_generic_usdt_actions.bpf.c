...
x86_l_1c:
	/* 0x1c: mov    rdi,QWORD PTR [rip+0x1ffb7] */
...
x86_l_4d:
	/* 0x4d: mov    rdi,QWORD PTR [rip+0x1ffb7] */
...
x86_l_7e:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_83:
	/* 0x83: mov    rdi,QWORD PTR [rip+0x1ffb7] */
...
x86_l_204:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_209:
	/* 0x209: mov    rdi,QWORD PTR [rip+0x1ffc4] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_210:
...
x86_l_32b:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_330:
	/* 0x330: mov    rdi,QWORD PTR [rip+0x1ffc8] */
...
x86_l_41f:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_424:
	/* 0x424: mov    rdi,QWORD PTR [rip+0x1ffc8] */
...
x86_l_4fe:
	/* 0x4fe: mov    rdi,QWORD PTR [rip+0x1ffc8] */
...
x86_l_578:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_57d:
	/* 0x57d: mov    rdi,QWORD PTR [rip+0x1ffc8] */
...
x86_l_5ae:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 2ULL);
x86_l_5b3:
	/* 0x5b3: mov    rdi,QWORD PTR [rip+0x1ffc8] */
...
x86_l_632:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_637:
	/* 0x637: mov    rdi,QWORD PTR [rip+0x1ffc8] */
...
x86_l_664:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_669:
	/* 0x669: mov    r13,QWORD PTR [rip+0x1ffc8] */
...
x86_l_696:
	/* 0x696: mov    rdi,QWORD PTR [rip+0x1ffc8] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_data)));
x86_l_69d:
...
x86_l_6e8:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_6ed:
	/* 0x6ed: mov    rdi,QWORD PTR [rip+0x1ffc8] */
...
x86_l_713:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_718:
	/* 0x718: mov    rdi,QWORD PTR [rip+0x1ffc8] */
...
x86_l_7a3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_7a6:
	/* 0x7a6: mov    r13,QWORD PTR [rip+0x1ffc8] */
...
x86_l_81b:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_820:
	/* 0x820: mov    rdi,QWORD PTR [rip+0x1ffc8] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_827:
...
x86_l_889:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 2ULL);
x86_l_88e:
	/* 0x88e: mov    rdi,QWORD PTR [rip+0x1ffc8] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_895:
...
x86_l_8b9:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 3ULL);
x86_l_8be:
	/* 0x8be: mov    rdi,QWORD PTR [rip+0x1ffc8] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_8c5:
...
x86_l_8e1:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 3ULL);
x86_l_8e6:
	/* 0x8e6: mov    rdi,QWORD PTR [rip+0x1ffc8] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&socktrack_map)));
x86_l_8ed:
...
x86_l_957:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_95c:
	/* 0x95c: mov    rdi,QWORD PTR [rip+0x1ffd4] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_963:
	/* 0x963: mov    rsi,r12 */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_R12, X86_WIDTH_64);
...
x86_l_977:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RCX, X86_WIDTH_32, 1ULL);
x86_l_97c:
	/* 0x97c: mov    rdi,QWORD PTR [rip+0x1ffd4] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&config_map)));
x86_l_983:
	/* 0x983: mov    rsi,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RAX, X86_WIDTH_64);
...
x86_l_9c0:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_9c5:
	/* 0x9c5: mov    rdi,QWORD PTR [rip+0x1ffd4] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_9cc:
	/* 0x9cc: mov    rsi,r12 */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_R12, X86_WIDTH_64);
...
x86_l_9dc:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RCX, X86_WIDTH_32, 1ULL);
x86_l_9e1:
	/* 0x9e1: mov    rdi,QWORD PTR [rip+0x1ffd4] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&config_map)));
x86_l_9e8:
	/* 0x9e8: mov    rsi,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RAX, X86_WIDTH_64);
...
x86_l_a80:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_a85:
	/* 0xa85: mov    rdi,QWORD PTR [rip+0x1ffd4] */
...
x86_l_ab8:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 2ULL);
x86_l_abd:
	/* 0xabd: mov    rdi,QWORD PTR [rip+0x1ffd4] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&ratelimit_map)));
x86_l_ac4:
...
x86_l_af1:
	/* 0xaf1: mov    rsi,QWORD PTR [rip+0x1ffd4] */
...
x86_l_b1d:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 64ULL);
x86_l_b22:
	/* 0xb22: mov    rsi,QWORD PTR [rip+0x1ffd4] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&stack_trace_map)));
x86_l_b29:
	/* 0xb29: call   rax */
	X86_SIM_BPF_CALL_REG(X86_RAX);
...
x86_l_bb4:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_bb9:
	/* 0xbb9: mov    rdi,QWORD PTR [rip+0x1ffd4] */
...
x86_l_cfc:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_d01:
	/* 0xd01: mov    rdi,QWORD PTR [rip+0x1ffd4] */
...
x86_l_d25:
	/* 0xd25: mov    rsi,QWORD PTR [rip+0x1ffd4] */
