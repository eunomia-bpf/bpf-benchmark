...
static __noinline __u64 tetragon_bpf_multi_kprobe_v61_generic_kprobe_process_event_x86_chunk_0(
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v61_generic_kprobe_process_event_x86_chunk_1(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v61_generic_kprobe_process_event_x86_chunk_2(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v61_generic_kprobe_process_event_x86_chunk_3(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v61_generic_kprobe_process_event_x86_chunk_4(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v61_generic_kprobe_process_event_x86_chunk_5(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v61_generic_kprobe_process_event_x86_chunk_6(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v61_generic_kprobe_process_event_x86_chunk_7(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v61_generic_kprobe_process_event_x86_chunk_8(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
SEC("xdp")
int tetragon_bpf_multi_kprobe_v61_generic_kprobe_process_event_x86_sim_xdp(struct xdp_md *ctx)
{
	...
	for (__u32 __x86_iter = 0; __x86_iter < 12888U; __x86_iter++) {
		...
		if (__x86_pc >= 0ULL && __x86_pc <= 1724ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v61_generic_kprobe_process_event_x86_chunk_0(__x86_state, __x86_pc);
		else if (__x86_pc >= 1731ULL && __x86_pc <= 3598ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v61_generic_kprobe_process_event_x86_chunk_1(__x86_state, __x86_pc);
		else if (__x86_pc >= 3603ULL && __x86_pc <= 5383ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v61_generic_kprobe_process_event_x86_chunk_2(__x86_state, __x86_pc);
		else if (__x86_pc >= 5388ULL && __x86_pc <= 7170ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v61_generic_kprobe_process_event_x86_chunk_3(__x86_state, __x86_pc);
		else if (__x86_pc >= 7174ULL && __x86_pc <= 8905ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v61_generic_kprobe_process_event_x86_chunk_4(__x86_state, __x86_pc);
		else if (__x86_pc >= 8911ULL && __x86_pc <= 10713ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v61_generic_kprobe_process_event_x86_chunk_5(__x86_state, __x86_pc);
		else if (__x86_pc >= 10718ULL && __x86_pc <= 12263ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v61_generic_kprobe_process_event_x86_chunk_6(__x86_state, __x86_pc);
		else if (__x86_pc >= 12269ULL && __x86_pc <= 13586ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v61_generic_kprobe_process_event_x86_chunk_7(__x86_state, __x86_pc);
		else if (__x86_pc >= 13589ULL && __x86_pc <= 14099ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v61_generic_kprobe_process_event_x86_chunk_8(__x86_state, __x86_pc);
		else
