...
x86_l_1c:
	/* 0x1c: mov    rdi,QWORD PTR [rip+0x1fbc7] */
...
x86_l_4d:
	/* 0x4d: mov    rdi,QWORD PTR [rip+0x1fbc7] */
...
x86_l_7e:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_83:
	/* 0x83: mov    rdi,QWORD PTR [rip+0x1fbc7] */
...
x86_l_100:
	/* 0x100: mov    rbp,QWORD PTR [rip+0x1fbc7] */
...
x86_l_27f:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_284:
	/* 0x284: mov    rdi,QWORD PTR [rip+0x1fbd1] */
...
x86_l_2f2:
	/* 0x2f2: mov    rdi,QWORD PTR [rip+0x1fbd1] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_2f9:
...
x86_l_394:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_399:
	/* 0x399: mov    rdi,QWORD PTR [rip+0x1fbd1] */
...
x86_l_3d2:
	/* 0x3d2: mov    rbp,QWORD PTR [rip+0x1fbd1] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RBP, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_3d9:
	/* 0x3d9: test   ecx,ecx */
...
x86_l_44f:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_454:
	/* 0x454: mov    rdi,QWORD PTR [rip+0x1fbd1] */
...
x86_l_489:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 2ULL);
x86_l_48e:
	/* 0x48e: mov    rdi,QWORD PTR [rip+0x1fbd1] */
...
x86_l_4d8:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_4dd:
	/* 0x4dd: mov    rdi,QWORD PTR [rip+0x1fbd1] */
...
x86_l_501:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_506:
	/* 0x506: mov    rdi,QWORD PTR [rip+0x1fbd1] */
...
x86_l_530:
	/* 0x530: mov    rdi,QWORD PTR [rip+0x1fbd1] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_data)));
x86_l_537:
...
x86_l_586:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_58b:
	/* 0x58b: mov    rdi,QWORD PTR [rip+0x1fbd1] */
...
x86_l_5aa:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_5af:
	/* 0x5af: mov    rdi,QWORD PTR [rip+0x1fbd1] */
...
x86_l_645:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_64a:
	/* 0x64a: mov    rdi,QWORD PTR [rip+0x1fbd1] */
...
x86_l_6cd:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RDX, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_RAX, 2), 104041287778304ULL);
x86_l_6d5:
	/* 0x6d5: mov    rbp,QWORD PTR [rip+0x1fbd1] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RBP, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_6dc:
...
x86_l_71a:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 2ULL);
x86_l_71f:
	/* 0x71f: mov    rdi,QWORD PTR [rip+0x1fbd1] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_726:
...
x86_l_74c:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RCX, X86_WIDTH_32, 1ULL);
x86_l_751:
	/* 0x751: mov    rdi,QWORD PTR [rip+0x1fbd1] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_missed_notifications)));
x86_l_758:
	/* 0x758: mov    rsi,rbx */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RBX, X86_WIDTH_64);
...
x86_l_78b:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_790:
	/* 0x790: mov    rdi,QWORD PTR [rip+0x1fbd1] */
...
x86_l_7ae:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 3ULL);
x86_l_7b3:
	/* 0x7b3: mov    rdi,QWORD PTR [rip+0x1fbd1] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_7ba:
...
x86_l_7c4:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_R14, X86_RBP, X86_WIDTH_64);
x86_l_7c7:
	/* 0x7c7: mov    rbp,QWORD PTR [rip+0x1fbd1] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RBP, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_7ce:
...
x86_l_7df:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 3ULL);
x86_l_7e4:
	/* 0x7e4: mov    rdi,QWORD PTR [rip+0x1fbd1] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&socktrack_map)));
x86_l_7eb:
...
x86_l_87a:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RCX, X86_WIDTH_32, 1ULL);
x86_l_87f:
	/* 0x87f: mov    rdi,QWORD PTR [rip+0x1fbdd] */
...
x86_l_8de:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RCX, X86_WIDTH_32, 1ULL);
x86_l_8e3:
	/* 0x8e3: mov    rdi,QWORD PTR [rip+0x1fbdd] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&config_map)));
x86_l_8ea:
	/* 0x8ea: mov    rsi,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RAX, X86_WIDTH_64);
...
x86_l_968:
	/* 0x968: mov    rbp,QWORD PTR [rip+0x1fbdd] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RBP, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_96f:
	/* 0x96f: mov    eax,ebx */
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_RBX, X86_WIDTH_32);
...
x86_l_97b:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_980:
	/* 0x980: mov    rdi,QWORD PTR [rip+0x1fbdd] */
...
x86_l_9be:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 2ULL);
x86_l_9c3:
	/* 0x9c3: mov    rdi,QWORD PTR [rip+0x1fbdd] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&ratelimit_map)));
x86_l_9ca:
	/* 0x9ca: mov    rsi,rbx */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RBX, X86_WIDTH_64);
...
x86_l_9f4:
	/* 0x9f4: mov    rsi,QWORD PTR [rip+0x1fbdd] */
...
x86_l_a24:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 112ULL);
x86_l_a29:
	/* 0xa29: mov    rsi,QWORD PTR [rip+0x1fbdd] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&stack_trace_map)));
x86_l_a30:
	/* 0xa30: call   rax */
	X86_SIM_BPF_CALL_REG(X86_RAX);
...
x86_l_a61:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 2ULL);
x86_l_a66:
	/* 0xa66: mov    rdi,QWORD PTR [rip+0x1fbdd] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_errmetrics_map)));
x86_l_a6d:
...
x86_l_a86:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_a8b:
	/* 0xa8b: mov    rdi,QWORD PTR [rip+0x1fbdd] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_missed_notifications)));
x86_l_a92:
...
x86_l_aba:
	/* 0xaba: mov    rsi,QWORD PTR [rip+0x1fbdd] */
