...
SEC("xdp")
int tetragon_bpf_generic_uprobe_v61_filter_char_buf_prefix_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_1b:
	/* 0x1b: mov    rdi,QWORD PTR [rip+0x1f23] */
...
x86_l_38:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_3d:
	/* 0x3d: mov    rdi,QWORD PTR [rip+0x1f22] */
