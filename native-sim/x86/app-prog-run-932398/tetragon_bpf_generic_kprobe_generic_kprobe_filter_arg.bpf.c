...
x86_l_17:
	/* 0x17: mov    rdi,QWORD PTR [rip+0x4e67] */
...
x86_l_28:
	/* 0x28: je     53d <generic_kprobe_filter_arg+0x53d> */
...
x86_l_42:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_47:
	/* 0x47: mov    rdi,QWORD PTR [rip+0x4e67] */
...
x86_l_50:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_53:
	/* 0x53: je     527 <generic_kprobe_filter_arg+0x527> */
...
x86_l_61:
	/* 0x61: je     527 <generic_kprobe_filter_arg+0x527> */
...
x86_l_76:
	/* 0x76: je     4b5 <generic_kprobe_filter_arg+0x4b5> */
...
x86_l_ea:
	/* 0xea: jb     4aa <generic_kprobe_filter_arg+0x4aa> */
...
x86_l_fb:
	/* 0xfb: je     4aa <generic_kprobe_filter_arg+0x4aa> */
...
x86_l_136:
	/* 0x136: ja     4b5 <generic_kprobe_filter_arg+0x4b5> */
...
x86_l_145:
	/* 0x145: jne    4b5 <generic_kprobe_filter_arg+0x4b5> */
...
x86_l_150:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_64, 36ULL);
x86_l_154:
	/* 0x154: ja     4aa <generic_kprobe_filter_arg+0x4aa> */
...
x86_l_172:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_64);
x86_l_176:
	/* 0x176: jae    23e <generic_kprobe_filter_arg+0x23e> */
...
x86_l_184:
	/* 0x184: ja     4b5 <generic_kprobe_filter_arg+0x4b5> */
...
x86_l_192:
	/* 0x192: jae    2e0 <generic_kprobe_filter_arg+0x2e0> */
...
x86_l_19e:
	/* 0x19e: jb     35f <generic_kprobe_filter_arg+0x35f> */
	X86_SIM_X86_JCC(X86_CC_B, 0x19e, 0x35f, x86_l_35f);
x86_l_1a4:
	/* 0x1a4: cmp    ecx,0x6 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 6ULL);
x86_l_1a7:
	/* 0x1a7: je     4aa <generic_kprobe_filter_arg+0x4aa> */
	X86_SIM_X86_JCC(X86_CC_E, 0x1a7, 0x4aa, x86_l_4aa);
x86_l_1ad:
	/* 0x1ad: cmp    ecx,0xc */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 12ULL);
x86_l_1b0:
	/* 0x1b0: jne    4b5 <generic_kprobe_filter_arg+0x4b5> */
...
x86_l_1c3:
	/* 0x1c3: jne    4aa <generic_kprobe_filter_arg+0x4aa> */
...
x86_l_1d1:
	/* 0x1d1: jb     4b5 <generic_kprobe_filter_arg+0x4b5> */
...
x86_l_22f:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDX, X86_WIDTH_64, 4ULL);
x86_l_233:
	/* 0x233: jbe    13c <generic_kprobe_filter_arg+0x13c> */
	X86_SIM_X86_JCC(X86_CC_BE, 0x233, 0x13c, x86_l_13c);
x86_l_239:
	/* 0x239: jmp    4b5 <generic_kprobe_filter_arg+0x4b5> */
...
x86_l_243:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_64);
x86_l_247:
	/* 0x247: jae    4aa <generic_kprobe_filter_arg+0x4aa> */
...
x86_l_252:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 12ULL);
x86_l_255:
	/* 0x255: ja     4b5 <generic_kprobe_filter_arg+0x4b5> */
...
x86_l_260:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_32);
x86_l_263:
	/* 0x263: jae    3b8 <generic_kprobe_filter_arg+0x3b8> */
...
x86_l_26c:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDX, X86_WIDTH_32, 2ULL);
x86_l_26f:
	/* 0x26f: jb     434 <generic_kprobe_filter_arg+0x434> */
	X86_SIM_X86_JCC(X86_CC_B, 0x26f, 0x434, x86_l_434);
x86_l_275:
	/* 0x275: cmp    ecx,0x6 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 6ULL);
x86_l_278:
	/* 0x278: je     4aa <generic_kprobe_filter_arg+0x4aa> */
	X86_SIM_X86_JCC(X86_CC_E, 0x278, 0x4aa, x86_l_4aa);
x86_l_27e:
	/* 0x27e: cmp    ecx,0xc */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 12ULL);
x86_l_281:
	/* 0x281: jne    4b5 <generic_kprobe_filter_arg+0x4b5> */
...
x86_l_294:
	/* 0x294: jne    4aa <generic_kprobe_filter_arg+0x4aa> */
...
x86_l_2a2:
	/* 0x2a2: jb     4b5 <generic_kprobe_filter_arg+0x4b5> */
...
x86_l_2ad:
	/* 0x2ad: jne    4aa <generic_kprobe_filter_arg+0x4aa> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x2ad, 0x4aa, x86_l_4aa);
x86_l_2b3:
	/* 0x2b3: cmp    edx,0x11 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDX, X86_WIDTH_32, 17ULL);
x86_l_2b6:
	/* 0x2b6: jb     4b5 <generic_kprobe_filter_arg+0x4b5> */
...
x86_l_2d5:
	/* 0x2d5: jne    4aa <generic_kprobe_filter_arg+0x4aa> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x2d5, 0x4aa, x86_l_4aa);
x86_l_2db:
	/* 0x2db: jmp    4b5 <generic_kprobe_filter_arg+0x4b5> */
...
x86_l_2e5:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_32);
x86_l_2e8:
	/* 0x2e8: jae    4b5 <generic_kprobe_filter_arg+0x4b5> */
...
x86_l_2fd:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_302:
	/* 0x302: mov    rdi,QWORD PTR [rip+0x4e67] */
...
x86_l_310:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_313:
	/* 0x313: je     430 <generic_kprobe_filter_arg+0x430> */
...
x86_l_342:
	/* 0x342: je     480 <generic_kprobe_filter_arg+0x480> */
	X86_SIM_X86_JCC(X86_CC_E, 0x342, 0x480, x86_l_480);
x86_l_348:
	/* 0x348: cmp    ecx,0xa */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 10ULL);
x86_l_34b:
	/* 0x34b: jne    48b <generic_kprobe_filter_arg+0x48b> */
...
x86_l_35a:
	/* 0x35a: jmp    4a5 <generic_kprobe_filter_arg+0x4a5> */
...
x86_l_36c:
	/* 0x36c: je     443 <generic_kprobe_filter_arg+0x443> */
...
x86_l_37a:
	/* 0x37a: jb     476 <generic_kprobe_filter_arg+0x476> */
...
x86_l_3ad:
	/* 0x3ad: je     443 <generic_kprobe_filter_arg+0x443> */
	X86_SIM_X86_JCC(X86_CC_E, 0x3ad, 0x443, x86_l_443);
x86_l_3b3:
	/* 0x3b3: jmp    476 <generic_kprobe_filter_arg+0x476> */
...
x86_l_3bd:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_32);
x86_l_3c0:
	/* 0x3c0: jae    4b5 <generic_kprobe_filter_arg+0x4b5> */
...
x86_l_3d5:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_3da:
	/* 0x3da: mov    rdi,QWORD PTR [rip+0x4e67] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&argfilter_maps)));
x86_l_3e1:
...
x86_l_3e8:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3eb:
	/* 0x3eb: je     430 <generic_kprobe_filter_arg+0x430> */
...
x86_l_418:
	/* 0x418: ja     4a2 <generic_kprobe_filter_arg+0x4a2> */
...
x86_l_426:
	/* 0x426: jae    492 <generic_kprobe_filter_arg+0x492> */
...
x86_l_42e:
	/* 0x42e: jmp    4a2 <generic_kprobe_filter_arg+0x4a2> */
	X86_SIM_X86_JMP(0x42e, 0x4a2, x86_l_4a2);
x86_l_430:
	/* 0x430: xor    eax,eax */
	X86_SIM_L_EXEC_ALU_REG(X86_RAX, X86_RAX, X86_WIDTH_32, X86_ALU_XOR);
x86_l_432:
	/* 0x432: jmp    4a5 <generic_kprobe_filter_arg+0x4a5> */
...
x86_l_441:
	/* 0x441: jne    44d <generic_kprobe_filter_arg+0x44d> */
...
x86_l_44b:
	/* 0x44b: jmp    4a5 <generic_kprobe_filter_arg+0x4a5> */
...
x86_l_455:
	/* 0x455: jb     476 <generic_kprobe_filter_arg+0x476> */
...
x86_l_45c:
	/* 0x45c: je     443 <generic_kprobe_filter_arg+0x443> */
	X86_SIM_X86_JCC(X86_CC_E, 0x45c, 0x443, x86_l_443);
x86_l_45e:
	/* 0x45e: cmp    esi,0x11 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RSI, X86_WIDTH_32, 17ULL);
x86_l_461:
	/* 0x461: jb     476 <generic_kprobe_filter_arg+0x476> */
...
x86_l_474:
	/* 0x474: je     443 <generic_kprobe_filter_arg+0x443> */
...
x86_l_479:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 6ULL);
x86_l_47c:
	/* 0x47c: je     4aa <generic_kprobe_filter_arg+0x4aa> */
	X86_SIM_X86_JCC(X86_CC_E, 0x47c, 0x4aa, x86_l_4aa);
x86_l_47e:
	/* 0x47e: jmp    4b5 <generic_kprobe_filter_arg+0x4b5> */
...
x86_l_486:
	...
	X86_SIM_L_EXEC_MOVX_REG(X86_OP_MOVZX_REG, X86_RAX, X86_RAX, X86_WIDTH_32, X86_WIDTH_8);
x86_l_489:
	/* 0x489: jmp    4a5 <generic_kprobe_filter_arg+0x4a5> */
...
x86_l_48d:
	...
	X86_SIM_L_EXEC_MOVX_REG(X86_OP_MOVZX_REG, X86_RAX, X86_RAX, X86_WIDTH_32, X86_WIDTH_8);
x86_l_490:
	/* 0x490: jmp    4a5 <generic_kprobe_filter_arg+0x4a5> */
...
x86_l_497:
	...
	X86_SIM_L_EXEC_BT(X86_RSI, X86_RDX, X86_WIDTH_32);
x86_l_49a:
	/* 0x49a: jae    4a2 <generic_kprobe_filter_arg+0x4a2> */
...
x86_l_516:
	/* 0x516: mov    rsi,QWORD PTR [rip+0x4e67] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&kprobe_calls)));
x86_l_51d:
	/* 0x51d: mov    rdi,rbx */
	X86_SIM_L_EXEC_MOV_REG(X86_RDI, X86_RBX, X86_WIDTH_64);
...
x86_l_527:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 12ULL);
x86_l_52c:
	/* 0x52c: mov    rsi,QWORD PTR [rip+0x4e67] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&kprobe_calls)));
x86_l_533:
	/* 0x533: mov    rdi,rbx */
	X86_SIM_L_EXEC_MOV_REG(X86_RDI, X86_RBX, X86_WIDTH_64);
...
x86_l_546:
	/* 0x546: jmp    60e <generic_kprobe_filter_arg+0x60e> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_54b:
	/* 0x54b: xor    r15d,r15d */
...
x86_l_556:
	/* 0x556: jne    5a8 <generic_kprobe_filter_arg+0x5a8> */
...
x86_l_566:
	/* 0x566: jne    5a8 <generic_kprobe_filter_arg+0x5a8> */
...
x86_l_576:
	/* 0x576: jne    5a8 <generic_kprobe_filter_arg+0x5a8> */
...
x86_l_586:
	/* 0x586: jne    5a8 <generic_kprobe_filter_arg+0x5a8> */
...
x86_l_596:
	/* 0x596: jne    5a8 <generic_kprobe_filter_arg+0x5a8> */
...
x86_l_5a6:
	/* 0x5a6: je     5c5 <generic_kprobe_filter_arg+0x5c5> */
...
x86_l_5af:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 12ULL);
x86_l_5b4:
	/* 0x5b4: mov    rsi,QWORD PTR [rip+0x4e6a] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&kprobe_calls)));
x86_l_5bb:
	/* 0x5bb: mov    rdi,rbx */
	X86_SIM_L_EXEC_MOV_REG(X86_RDI, X86_RBX, X86_WIDTH_64);
...
x86_l_5da:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_5df:
	/* 0x5df: mov    rdi,QWORD PTR [rip+0x4e6a] */
...
x86_l_5ed:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_5f0:
	/* 0x5f0: je     53d <generic_kprobe_filter_arg+0x53d> */
	X86_SIM_X86_JCC(X86_CC_E, 0x5f0, 0x53d, x86_l_53d);
x86_l_5f6:
	/* 0x5f6: mov    eax,0x3 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 3ULL);
x86_l_5fb:
	/* 0x5fb: mov    rdi,QWORD PTR [rip+0x4e6a] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&retprobe_map)));
x86_l_602:
...
x86_l_607:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_609:
	/* 0x609: jmp    53d <generic_kprobe_filter_arg+0x53d> */
