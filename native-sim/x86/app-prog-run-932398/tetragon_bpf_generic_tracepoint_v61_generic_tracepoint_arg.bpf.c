...
x86_l_17:
	/* 0x17: mov    rdi,QWORD PTR [rip+0x5107] */
...
x86_l_3f:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_44:
	/* 0x44: mov    rdi,QWORD PTR [rip+0x5107] */
...
x86_l_3ab:
	/* 0x3ab: mov    rsi,QWORD PTR [rip+0x5120] */
...
x86_l_3bc:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 12ULL);
x86_l_3c1:
	/* 0x3c1: mov    rsi,QWORD PTR [rip+0x5120] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&tp_calls)));
x86_l_3c8:
	/* 0x3c8: mov    rdi,rbx */
	X86_SIM_L_EXEC_MOV_REG(X86_RDI, X86_RBX, X86_WIDTH_64);
...
x86_l_444:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 12ULL);
x86_l_449:
	/* 0x449: mov    rsi,QWORD PTR [rip+0x5123] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&tp_calls)));
x86_l_450:
	/* 0x450: mov    rdi,rbx */
	X86_SIM_L_EXEC_MOV_REG(X86_RDI, X86_RBX, X86_WIDTH_64);
...
x86_l_46f:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_474:
	/* 0x474: mov    rdi,QWORD PTR [rip+0x5123] */
...
x86_l_490:
	/* 0x490: mov    rdi,QWORD PTR [rip+0x5123] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&retprobe_map)));
x86_l_497:
