...
static __noinline __u64 tetragon_bpf_multi_kprobe_v53_generic_kprobe_filter_arg_x86_chunk_0(
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v53_generic_kprobe_filter_arg_x86_chunk_1(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v53_generic_kprobe_filter_arg_x86_chunk_2(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v53_generic_kprobe_filter_arg_x86_chunk_3(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v53_generic_kprobe_filter_arg_x86_chunk_4(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v53_generic_kprobe_filter_arg_x86_chunk_5(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v53_generic_kprobe_filter_arg_x86_chunk_6(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v53_generic_kprobe_filter_arg_x86_chunk_7(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v53_generic_kprobe_filter_arg_x86_chunk_8(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
SEC("xdp")
int tetragon_bpf_multi_kprobe_v53_generic_kprobe_filter_arg_x86_sim_xdp(struct xdp_md *ctx)
{
	...
	for (__u32 __x86_iter = 0; __x86_iter < 12432U; __x86_iter++) {
		...
		if (__x86_pc >= 0ULL && __x86_pc <= 1741ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v53_generic_kprobe_filter_arg_x86_chunk_0(__x86_state, __x86_pc);
		else if (__x86_pc >= 1747ULL && __x86_pc <= 3349ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v53_generic_kprobe_filter_arg_x86_chunk_1(__x86_state, __x86_pc);
		else if (__x86_pc >= 3354ULL && __x86_pc <= 4950ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v53_generic_kprobe_filter_arg_x86_chunk_2(__x86_state, __x86_pc);
		else if (__x86_pc >= 4954ULL && __x86_pc <= 6526ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v53_generic_kprobe_filter_arg_x86_chunk_3(__x86_state, __x86_pc);
		else if (__x86_pc >= 6531ULL && __x86_pc <= 8098ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v53_generic_kprobe_filter_arg_x86_chunk_4(__x86_state, __x86_pc);
		else if (__x86_pc >= 8102ULL && __x86_pc <= 9659ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v53_generic_kprobe_filter_arg_x86_chunk_5(__x86_state, __x86_pc);
		else if (__x86_pc >= 9664ULL && __x86_pc <= 11294ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v53_generic_kprobe_filter_arg_x86_chunk_6(__x86_state, __x86_pc);
		else if (__x86_pc >= 11299ULL && __x86_pc <= 12865ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v53_generic_kprobe_filter_arg_x86_chunk_7(__x86_state, __x86_pc);
		else if (__x86_pc >= 12868ULL && __x86_pc <= 12973ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v53_generic_kprobe_filter_arg_x86_chunk_8(__x86_state, __x86_pc);
		else
