...
x86_l_412:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_417:
	/* 0x417: mov    rdi,QWORD PTR [rip+0x26f7] */
...
x86_l_43f:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_444:
	/* 0x444: mov    rdi,QWORD PTR [rip+0x26f7] */
...
x86_l_46b:
	/* 0x46b: mov    rdi,QWORD PTR [rip+0x26f7] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_data)));
x86_l_472:
...
x86_l_4b8:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_4bd:
	/* 0x4bd: mov    rdi,QWORD PTR [rip+0x26f7] */
...
x86_l_4e1:
	/* 0x4e1: mov    rdi,QWORD PTR [rip+0x26f7] */
...
x86_l_54e:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_553:
	/* 0x553: mov    rdi,QWORD PTR [rip+0x26f7] */
...
x86_l_572:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 2ULL);
x86_l_577:
	/* 0x577: mov    rdi,QWORD PTR [rip+0x26f7] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_missed_notifications)));
x86_l_57e:
...
x86_l_5b7:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_5bc:
	/* 0x5bc: mov    rdi,QWORD PTR [rip+0x26f7] */
...
x86_l_5d8:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 3ULL);
x86_l_5dd:
	/* 0x5dd: mov    rdi,QWORD PTR [rip+0x26f7] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_5e4:
	/* 0x5e4: mov    rsi,rsp */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RSP, X86_WIDTH_64);
...
x86_l_5e9:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 3ULL);
x86_l_5ee:
	/* 0x5ee: mov    rdi,QWORD PTR [rip+0x26f7] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&socktrack_map)));
x86_l_5f5:
...
x86_l_65b:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_660:
	/* 0x660: mov    rdi,QWORD PTR [rip+0x26f7] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_667:
...
x86_l_67d:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RCX, X86_WIDTH_32, 1ULL);
x86_l_682:
	/* 0x682: mov    rdi,QWORD PTR [rip+0x26f7] */
...
x86_l_6c6:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_6cb:
	/* 0x6cb: mov    rdi,QWORD PTR [rip+0x26f7] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_6d2:
...
x86_l_6e4:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RCX, X86_WIDTH_32, 1ULL);
x86_l_6e9:
	/* 0x6e9: mov    rdi,QWORD PTR [rip+0x26f7] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&config_map)));
x86_l_6f0:
	/* 0x6f0: mov    rsi,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RAX, X86_WIDTH_64);
...
x86_l_785:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_78a:
	/* 0x78a: mov    rdi,QWORD PTR [rip+0x26f7] */
...
x86_l_7bd:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 2ULL);
x86_l_7c2:
	/* 0x7c2: mov    rdi,QWORD PTR [rip+0x26f7] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&ratelimit_map)));
x86_l_7c9:
	/* 0x7c9: mov    rdx,rsp */
	X86_SIM_L_EXEC_MOV_REG(X86_RDX, X86_RSP, X86_WIDTH_64);
...
x86_l_7ef:
	/* 0x7ef: mov    rsi,QWORD PTR [rip+0x26f7] */
...
x86_l_814:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 27ULL);
x86_l_819:
	/* 0x819: mov    rsi,QWORD PTR [rip+0x26f7] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&stack_trace_map)));
x86_l_820:
	/* 0x820: mov    edx,0x100 */
...
x86_l_85d:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 2ULL);
x86_l_862:
	/* 0x862: mov    rdi,QWORD PTR [rip+0x26fa] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_errmetrics_map)));
x86_l_869:
	/* 0x869: mov    rsi,rsp */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RSP, X86_WIDTH_64);
...
x86_l_87e:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_883:
	/* 0x883: mov    rdi,QWORD PTR [rip+0x26fa] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_missed_notifications)));
x86_l_88a:
