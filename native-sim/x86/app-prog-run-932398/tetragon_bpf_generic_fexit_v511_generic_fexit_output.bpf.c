...
x86_l_25:
	/* 0x25: je     e5 <generic_fexit_output+0xe5> */
...
x86_l_66:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_69:
	/* 0x69: je     a5 <generic_fexit_output+0xa5> */
...
x86_l_6f:
	/* 0x6f: je     a5 <generic_fexit_output+0xa5> */
...
x86_l_8d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_90:
	/* 0x90: js     13f <generic_fexit_output+0x13f> */
...
x86_l_9e:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_a3:
	/* 0xa3: jmp    cd <generic_fexit_output+0xcd> */
...
x86_l_bb:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_be:
	/* 0xbe: js     f0 <generic_fexit_output+0xf0> */
...
x86_l_db:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_de:
	/* 0xde: je     e5 <generic_fexit_output+0xe5> */
...
x86_l_eb:
	/* 0xeb: jmp    1f2 <generic_fexit_output+0x1f2> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_f0:
	/* 0xf0: mov    rbx,rax */
...
x86_l_13d:
	/* 0x13d: jmp    e5 <generic_fexit_output+0xe5> */
...
x86_l_1bc:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_1c0:
	/* 0x1c0: jmp    e5 <generic_fexit_output+0xe5> */
...
x86_l_1cb:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_1cf:
	/* 0x1cf: jmp    e5 <generic_fexit_output+0xe5> */
...
x86_l_1da:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_1de:
	/* 0x1de: jmp    e5 <generic_fexit_output+0xe5> */
...
x86_l_1e9:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_1ed:
	/* 0x1ed: jmp    e5 <generic_fexit_output+0xe5> */
