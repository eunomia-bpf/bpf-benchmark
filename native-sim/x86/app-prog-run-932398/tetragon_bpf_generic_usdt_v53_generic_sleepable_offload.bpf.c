...
SEC("xdp")
int tetragon_bpf_generic_usdt_v53_generic_sleepable_offload_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_11:
	/* 0x11: mov    rdi,QWORD PTR [rip+0x3320] */
...
x86_l_3d:
	/* 0x3d: mov    rdi,QWORD PTR [rip+0x3320] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&write_offload)));
x86_l_44:
	/* 0x44: mov    rsi,rsp */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RSP, X86_WIDTH_64);
