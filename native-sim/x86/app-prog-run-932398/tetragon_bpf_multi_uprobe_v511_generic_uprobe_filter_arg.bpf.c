...
static __noinline __u64 tetragon_bpf_multi_uprobe_v511_generic_uprobe_filter_arg_x86_chunk_9(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
int tetragon_bpf_multi_uprobe_v511_generic_uprobe_filter_arg_x86_sim_xdp(struct xdp_md *ctx)
{
	...
	for (__u32 __x86_iter = 0; __x86_iter < 14204U; __x86_iter++) {
		...
		if (__x86_pc >= 0ULL && __x86_pc <= 1710ULL)
			...
			__x86_pc = tetragon_bpf_multi_uprobe_v511_generic_uprobe_filter_arg_x86_chunk_9(__x86_state, __x86_pc);
		else
