...
static __noinline __u64 tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_0(
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_1(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_2(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_3(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_4(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_5(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_6(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_7(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_8(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
static __noinline __u64 tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_9(
	struct x86_sim_state *__x86_state, __u64 __x86_pc)
{
	switch (__x86_pc) {
...
SEC("xdp")
int tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_sim_xdp(struct xdp_md *ctx)
{
	...
	for (__u32 __x86_iter = 0; __x86_iter < 14204U; __x86_iter++) {
		...
		if (__x86_pc >= 0ULL && __x86_pc <= 1710ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_0(__x86_state, __x86_pc);
		else if (__x86_pc >= 1715ULL && __x86_pc <= 3314ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_1(__x86_state, __x86_pc);
		else if (__x86_pc >= 3319ULL && __x86_pc <= 4865ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_2(__x86_state, __x86_pc);
		else if (__x86_pc >= 4869ULL && __x86_pc <= 6453ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_3(__x86_state, __x86_pc);
		else if (__x86_pc >= 6456ULL && __x86_pc <= 8076ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_4(__x86_state, __x86_pc);
		else if (__x86_pc >= 8079ULL && __x86_pc <= 9583ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_5(__x86_state, __x86_pc);
		else if (__x86_pc >= 9588ULL && __x86_pc <= 11221ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_6(__x86_state, __x86_pc);
		else if (__x86_pc >= 11224ULL && __x86_pc <= 12849ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_7(__x86_state, __x86_pc);
		else if (__x86_pc >= 12851ULL && __x86_pc <= 14477ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_8(__x86_state, __x86_pc);
		else if (__x86_pc >= 14482ULL && __x86_pc <= 14820ULL)
			__x86_pc = tetragon_bpf_multi_kprobe_v511_generic_kprobe_filter_arg_x86_chunk_9(__x86_state, __x86_pc);
		else
