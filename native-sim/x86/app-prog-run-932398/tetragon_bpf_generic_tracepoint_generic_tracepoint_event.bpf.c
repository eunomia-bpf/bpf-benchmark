...
x86_l_31:
	/* 0x31: je     2d92 <generic_tracepoint_event+0x2d92> */
...
x86_l_50:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_53:
	/* 0x53: je     2d92 <generic_tracepoint_event+0x2d92> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 11666ULL;
	}
x86_l_59:
...
x86_l_7e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_81:
	/* 0x81: je     2d92 <generic_tracepoint_event+0x2d92> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 11666ULL;
	}
x86_l_87:
...
x86_l_cf:
	/* 0xcf: jmp    2d92 <generic_tracepoint_event+0x2d92> */
	return 11666ULL;
x86_l_d4:
	/* 0xd4: xor    ebp,ebp */
...
x86_l_152:
	/* 0x152: je     2d92 <generic_tracepoint_event+0x2d92> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 11666ULL;
	}
x86_l_158:
...
x86_l_1b0:
	/* 0x1b0: jmp    2d92 <generic_tracepoint_event+0x2d92> */
	return 11666ULL;
x86_l_1b5:
	/* 0x1b5: xor    eax,eax */
...
x86_l_1bc:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1bf:
	/* 0x1bf: je     2d92 <generic_tracepoint_event+0x2d92> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 11666ULL;
	}
x86_l_1c5:
...
x86_l_217:
	/* 0x217: mov    DWORD PTR [r14+0x5ee8],0x0 */
...
x86_l_42f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_432:
	/* 0x432: je     2d92 <generic_tracepoint_event+0x2d92> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 11666ULL;
	}
x86_l_438:
...
x86_l_453:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_456:
	/* 0x456: je     2d92 <generic_tracepoint_event+0x2d92> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 11666ULL;
	}
x86_l_45c:
...
x86_l_46b:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_46e:
	/* 0x46e: jne    2d92 <generic_tracepoint_event+0x2d92> */
	if (X86_SIM_L_EVAL_CC(X86_CC_NE)) {
		return 11666ULL;
	}
x86_l_474:
...
x86_l_2ad1:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 14ULL);
x86_l_2ad5:
	/* 0x2ad5: mov    QWORD PTR [r14+0x5eec],0x0 */
...
x86_l_2d81:
	/* 0x2d81: mov    rsi,QWORD PTR [rip+0x0] */
...
x86_l_2d9e:
	/* 0x2d9e: jmp    2da3 <generic_tracepoint_event+0x2da3> ; native-link entry RET */
...
int tetragon_bpf_generic_tracepoint_generic_tracepoint_event_x86_sim_xdp(struct xdp_md *ctx)
{
	...
	__u64 __x86_pc = 0ULL;
	for (__u32 __x86_iter = 0; __x86_iter < 9788U; __x86_iter++) {
		...
		else if (__x86_pc >= 11060ULL && __x86_pc <= 11678ULL)
