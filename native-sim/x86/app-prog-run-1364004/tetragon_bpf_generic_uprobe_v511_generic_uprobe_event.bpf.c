...
x86_l_29:
	/* 0x29: je     4f6 <generic_uprobe_event+0x4f6> */
...
x86_l_51:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_54:
	/* 0x54: je     4f6 <generic_uprobe_event+0x4f6> */
...
x86_l_63:
	/* 0x63: je     20b <generic_uprobe_event+0x20b> */
...
x86_l_7f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_82:
	/* 0x82: je     4f6 <generic_uprobe_event+0x4f6> */
...
x86_l_a6:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_a9:
	/* 0xa9: je     ce <generic_uprobe_event+0xce> */
...
x86_l_b3:
	/* 0xb3: jne    d2 <generic_uprobe_event+0xd2> */
...
x86_l_c0:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_c3:
	/* 0xc3: jne    1c9 <generic_uprobe_event+0x1c9> */
	X86_SIM_X86_JCC(X86_CC_NE, 0xc3, 0x1c9, x86_l_1c9);
x86_l_c9:
	/* 0xc9: jmp    4f6 <generic_uprobe_event+0x4f6> */
	X86_SIM_X86_JMP(0xc9, 0x4f6, x86_l_4f6);
x86_l_ce:
	/* 0xce: xor    ebp,ebp */
	X86_SIM_L_EXEC_ALU_REG(X86_RBP, X86_RBP, X86_WIDTH_32, X86_ALU_XOR);
x86_l_d0:
	/* 0xd0: jmp    d5 <generic_uprobe_event+0xd5> */
...
x86_l_134:
	/* 0x134: je     4f6 <generic_uprobe_event+0x4f6> */
...
x86_l_158:
	/* 0x158: je     4f6 <generic_uprobe_event+0x4f6> */
...
x86_l_18d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RDX, X86_RDX, X86_WIDTH_64);
x86_l_190:
	/* 0x190: je     1ba <generic_uprobe_event+0x1ba> */
...
x86_l_1b0:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1b3:
	/* 0x1b3: jne    1c9 <generic_uprobe_event+0x1c9> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x1b3, 0x1c9, x86_l_1c9);
x86_l_1b5:
	/* 0x1b5: jmp    4f6 <generic_uprobe_event+0x4f6> */
...
x86_l_1c0:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1c3:
	/* 0x1c3: je     4f6 <generic_uprobe_event+0x4f6> */
...
x86_l_1e1:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1e4:
	/* 0x1e4: je     1f2 <generic_uprobe_event+0x1f2> */
...
x86_l_1e9:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1ec:
	/* 0x1ec: je     1f2 <generic_uprobe_event+0x1f2> */
...
x86_l_205:
	/* 0x205: je     505 <generic_uprobe_event+0x505> */
...
x86_l_319:
	/* 0x319: je     37f <generic_uprobe_event+0x37f> */
...
x86_l_37b:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_37d:
	/* 0x37d: jmp    387 <generic_uprobe_event+0x387> */
...
x86_l_500:
	/* 0x500: jmp    55c <generic_uprobe_event+0x55c> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_505:
...
x86_l_51d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_520:
	/* 0x520: je     4f6 <generic_uprobe_event+0x4f6> */
...
x86_l_53d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_540:
	/* 0x540: je     4f6 <generic_uprobe_event+0x4f6> */
...
x86_l_552:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R13, X86_WIDTH_64);
x86_l_555:
	/* 0x555: jne    4f6 <generic_uprobe_event+0x4f6> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x555, 0x4f6, x86_l_4f6);
x86_l_557:
	/* 0x557: jmp    20b <generic_uprobe_event+0x20b> */
