...
SEC("xdp")
int tetragon_bpf_generic_lsm_ima_file_v61_ima_file_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_26:
	/* 0x26: je     69 <ima_file+0x69> */
	X86_SIM_X86_JCC(X86_CC_E, 0x26, 0x69, x86_l_69);
x86_l_28:
...
x86_l_2b:
	/* 0x2b: jne    69 <ima_file+0x69> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x2b, 0x69, x86_l_69);
x86_l_2d:
...
x86_l_6f:
	/* 0x6f: jmp    74 <ima_file+0x74> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_74:
