...
SEC("xdp")
int tetragon_bpf_generic_kprobe_v61_filter_file_buf_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_28e:
	/* 0x28e: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_2a7:
	/* 0x2a7: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_394:
	/* 0x394: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_3ce:
	/* 0x3ce: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_402:
	/* 0x402: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_427:
	/* 0x427: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_43d:
	/* 0x43d: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_450:
	/* 0x450: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_463:
	/* 0x463: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_476:
	/* 0x476: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_489:
	/* 0x489: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_49c:
	/* 0x49c: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_4af:
	/* 0x4af: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_513:
	/* 0x513: mov    rdi,QWORD PTR [rip+0x2440] */
...
x86_l_53c:
	/* 0x53c: mov    rdi,QWORD PTR [rip+0x2440] */
...
x86_l_658:
	/* 0x658: mov    rdi,QWORD PTR [rip+0x23a0] */
...
x86_l_679:
	/* 0x679: mov    rdi,QWORD PTR [rip+0x23a0] */
