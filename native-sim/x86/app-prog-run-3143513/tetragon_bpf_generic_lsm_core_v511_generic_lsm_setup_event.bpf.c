...
x86_l_25:
	/* 0x25: je     1bb <generic_lsm_setup_event+0x1bb> */
	X86_SIM_X86_JCC(X86_CC_E, 0x25, 0x1bb, x86_l_1bb);
x86_l_2b:
	/* 0x2b: mov    r14,rax */
...
x86_l_43:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_46:
	/* 0x46: je     1bb <generic_lsm_setup_event+0x1bb> */
	X86_SIM_X86_JCC(X86_CC_E, 0x46, 0x1bb, x86_l_1bb);
x86_l_4c:
...
x86_l_13c:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_13e:
	/* 0x13e: mov    DWORD PTR [r14+0x7c],eax */
...
x86_l_15d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_160:
	/* 0x160: je     185 <generic_lsm_setup_event+0x185> */
	X86_SIM_X86_JCC(X86_CC_E, 0x160, 0x185, x86_l_185);
x86_l_162:
	/* 0x162: mov    rsi,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RAX, X86_WIDTH_64);
x86_l_165:
	/* 0x165: add    rsi,0x5ef8 */
...
x86_l_17a:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_17d:
	/* 0x17d: je     185 <generic_lsm_setup_event+0x185> */
	X86_SIM_X86_JCC(X86_CC_E, 0x17d, 0x185, x86_l_185);
x86_l_17f:
	/* 0x17f: cmp    DWORD PTR [rax+0x40],0xffffffff */
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 279172874239ULL);
x86_l_183:
	/* 0x183: jne    1a0 <generic_lsm_setup_event+0x1a0> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x183, 0x1a0, x86_l_1a0);
x86_l_185:
	/* 0x185: mov    rsi,QWORD PTR [rip+0x0] */
...
x86_l_19e:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_1a0:
	/* 0x1a0: mov    rsi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&lsm_calls)));
x86_l_1a7:
	/* 0x1a7: mov    ecx,0x1 */
...
x86_l_1c1:
	/* 0x1c1: jmp    1c6 <generic_lsm_setup_event+0x1c6> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_1c6:
