...
x86_l_1d5:
	/* 0x1d5: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_1ee:
	/* 0x1ee: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_2db:
	/* 0x2db: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_315:
	/* 0x315: mov    rdi,QWORD PTR [rip+0x2010] */
...
x86_l_349:
	/* 0x349: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_36e:
	/* 0x36e: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_384:
	/* 0x384: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_397:
	/* 0x397: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_3aa:
	/* 0x3aa: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_3bd:
	/* 0x3bd: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_3d0:
	/* 0x3d0: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_3e3:
	/* 0x3e3: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_3f6:
	/* 0x3f6: mov    rdi,QWORD PTR [rip+0x200c] */
...
x86_l_457:
	/* 0x457: mov    rdi,QWORD PTR [rip+0x23a0] */
...
x86_l_478:
	/* 0x478: mov    rdi,QWORD PTR [rip+0x23a0] */
...
x86_l_4f1:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_RAX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 12ULL);
x86_l_4f5:
	/* 0x4f5: mov    rdi,QWORD PTR [rip+0xf60] */
