...
SEC("xdp")
int tetragon_bpf_generic_lsm_core_v61_do_bytes_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_1cb:
	/* 0x1cb: mov    rdi,QWORD PTR [rip+0x327] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_stats_map)));
x86_l_1d2:
	/* 0x1d2: lea    rsi,[rsp+0x4] */
...
x86_l_251:
	/* 0x251: jmp    31a <__do_bytes+0xc4> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_31a:
...
x86_l_261:
	/* 0x261: js     2e3 <__do_bytes+0x8d> */
	X86_SIM_X86_SUB_JCC(X86_CC_S, 0x261, 0x2e3, x86_l_2e3);
x86_l_267:
	/* 0x267: mov    r14,rsi */
...
x86_l_28a:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_28c:
	/* 0x28c: js     308 <__do_bytes+0xb2> */
	X86_SIM_X86_SUB_JCC(X86_CC_S, 0x28c, 0x308, x86_l_308);
x86_l_28e:
	/* 0x28e: lea    r15d,[rbx+0x20] */
	X86_SIM_L_EXEC_LEA(X86_R15, X86_RBX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 32ULL);
x86_l_292:
	/* 0x292: mov    DWORD PTR [r14+0x4],r15d */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_R14, X86_R15, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 4ULL);
x86_l_296:
	/* 0x296: mov    DWORD PTR [rsp+0x4],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 17179869184ULL);
x86_l_29e:
	/* 0x29e: mov    rdi,QWORD PTR [rip+0x57c] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_conf_map)));
x86_l_2a5:
	/* 0x2a5: lea    rsi,[rsp+0x4] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 4ULL);
x86_l_2aa:
	/* 0x2aa: mov    eax,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
...
x86_l_2b1:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_2b4:
	/* 0x2b4: je     2ec <__do_bytes+0x96> */
	X86_SIM_X86_SUB_JCC(X86_CC_E, 0x2b4, 0x2ec, x86_l_2ec);
x86_l_2b6:
	/* 0x2b6: cmp    BYTE PTR [rax+0x28],0x0 */
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_2ba:
	/* 0x2ba: je     2ec <__do_bytes+0x96> */
	X86_SIM_X86_SUB_JCC(X86_CC_E, 0x2ba, 0x2ec, x86_l_2ec);
x86_l_2bc:
	/* 0x2bc: mov    rsi,QWORD PTR [rip+0x57c] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&tcpmon_map)));
x86_l_2c3:
	/* 0x2c3: mov    ecx,0xffffffff */
...
x86_l_2dd:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_2df:
	/* 0x2df: js     308 <__do_bytes+0xb2> */
	X86_SIM_X86_SUB_JCC(X86_CC_S, 0x2df, 0x308, x86_l_308);
x86_l_2e1:
	/* 0x2e1: jmp    30b <__do_bytes+0xb5> */
	X86_SIM_X86_SUB_JMP(0x2e1, 0x30b, x86_l_30b);
x86_l_2e3:
	/* 0x2e3: mov    rbx,0xffffffffffffffff */
	X86_SIM_L_EXEC_MOV_IMM(X86_RBX, X86_WIDTH_64, 18446744073709551615ULL);
x86_l_2ea:
	/* 0x2ea: jmp    30b <__do_bytes+0xb5> */
	X86_SIM_X86_SUB_JMP(0x2ea, 0x30b, x86_l_30b);
x86_l_2ec:
	/* 0x2ec: mov    rdi,QWORD PTR [rip+0x57c] */
...
x86_l_304:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_32);
x86_l_306:
	/* 0x306: jns    30b <__do_bytes+0xb5> */
	X86_SIM_X86_SUB_JCC(X86_CC_NS, 0x306, 0x30b, x86_l_30b);
x86_l_308:
	/* 0x308: movsxd rbx,eax */
	X86_SIM_L_EXEC_MOVX_REG(X86_OP_MOVSX_REG, X86_RBX, X86_RAX, X86_WIDTH_64, X86_WIDTH_32);
x86_l_30b:
	/* 0x30b: mov    rax,rbx */
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_RBX, X86_WIDTH_64);
...
x86_sim_ret_dispatch:
	...
	case 0x2b1ULL: goto x86_l_2b1;
	case 0x2ddULL: goto x86_l_2dd;
