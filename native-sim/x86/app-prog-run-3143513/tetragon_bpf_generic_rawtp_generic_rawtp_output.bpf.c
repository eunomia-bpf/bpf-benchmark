...
x86_l_f:
	/* 0xf: mov    rdi,QWORD PTR [rip+0x79d1] */
...
x86_l_25:
	/* 0x25: je     cf <generic_rawtp_output+0xcf> */
...
x86_l_4a:
	/* 0x4a: mov    rsi,QWORD PTR [rip+0x79d1] */
...
x86_l_80:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_83:
	/* 0x83: je     cf <generic_rawtp_output+0xcf> */
...
x86_l_8a:
	/* 0x8a: jmp    cf <generic_rawtp_output+0xcf> */
...
x86_l_97:
	/* 0x97: mov    rdi,QWORD PTR [rip+0x79d1] */
...
x86_l_120:
	...
	X86_SIM_L_EXEC_ALU_IMM(X86_RSP, X86_WIDTH_64, X86_ALU_ADD, 16ULL);
x86_l_124:
	/* 0x124: jmp    129 <generic_rawtp_output+0x129> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_129:
