...
x86_l_2b:
	/* 0x2b: je     607 <generic_rawtp_event+0x607> */
...
x86_l_53:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_56:
	/* 0x56: je     607 <generic_rawtp_event+0x607> */
...
x86_l_81:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_84:
	/* 0x84: je     607 <generic_rawtp_event+0x607> */
...
x86_l_cc:
	/* 0xcc: jmp    607 <generic_rawtp_event+0x607> */
...
x86_l_149:
	/* 0x149: je     607 <generic_rawtp_event+0x607> */
...
x86_l_172:
	/* 0x172: je     607 <generic_rawtp_event+0x607> */
...
x86_l_1da:
	/* 0x1da: jmp    607 <generic_rawtp_event+0x607> */
...
x86_l_1e6:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1e9:
	/* 0x1e9: je     607 <generic_rawtp_event+0x607> */
...
x86_l_22e:
	/* 0x22e: je     618 <generic_rawtp_event+0x618> */
...
x86_l_613:
	/* 0x613: jmp    671 <generic_rawtp_event+0x671> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_618:
...
x86_l_630:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_633:
	/* 0x633: je     607 <generic_rawtp_event+0x607> */
...
x86_l_650:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_653:
	/* 0x653: je     607 <generic_rawtp_event+0x607> */
...
x86_l_667:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R12, X86_WIDTH_64);
x86_l_66a:
	/* 0x66a: jne    607 <generic_rawtp_event+0x607> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x66a, 0x607, x86_l_607);
x86_l_66c:
	/* 0x66c: jmp    234 <generic_rawtp_event+0x234> */
