...
x86_l_12:
	/* 0x12: mov    rdi,QWORD PTR [rip+0x62b7] */
...
x86_l_5c:
	/* 0x5c: mov    rdi,QWORD PTR [rip+0x62b7] */
...
x86_l_35c:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_R15, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 40ULL);
x86_l_361:
	/* 0x361: mov    rdi,QWORD PTR [rip+0x62b7] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&execve_map)));
x86_l_368:
...
x86_l_41f:
	/* 0x41f: mov    rdi,QWORD PTR [rip+0x62b3] */
...
x86_l_43d:
	/* 0x43d: mov    rsi,QWORD PTR [rip+0x62b3] */
...
x86_l_46f:
	/* 0x46f: mov    rdi,QWORD PTR [rip+0x62b3] */
...
x86_l_489:
	/* 0x489: mov    rdi,QWORD PTR [rip+0x62b3] */
...
x86_l_4a6:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_4ae:
	/* 0x4ae: mov    rdi,QWORD PTR [rip+0x62b3] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&policy_stats)));
x86_l_4b5:
...
x86_l_4dc:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_4e4:
	/* 0x4e4: mov    rdi,QWORD PTR [rip+0x62b6] */
...
x86_l_52b:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_533:
	/* 0x533: mov    rdi,QWORD PTR [rip+0x62b6] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_stats_map)));
x86_l_53a:
