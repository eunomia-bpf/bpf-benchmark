...
x86_l_2b:
	/* 0x2b: je     61d <generic_lsm_event+0x61d> */
...
x86_l_53:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_56:
	/* 0x56: je     61d <generic_lsm_event+0x61d> */
...
x86_l_65:
	/* 0x65: je     234 <generic_lsm_event+0x234> */
...
x86_l_81:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_84:
	/* 0x84: je     61d <generic_lsm_event+0x61d> */
...
x86_l_a8:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_ab:
	/* 0xab: je     d1 <generic_lsm_event+0xd1> */
...
x86_l_b5:
	/* 0xb5: jne    d5 <generic_lsm_event+0xd5> */
...
x86_l_c3:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_c6:
	/* 0xc6: jne    1ef <generic_lsm_event+0x1ef> */
	X86_SIM_X86_JCC(X86_CC_NE, 0xc6, 0x1ef, x86_l_1ef);
x86_l_cc:
	/* 0xcc: jmp    61d <generic_lsm_event+0x61d> */
	X86_SIM_X86_JMP(0xcc, 0x61d, x86_l_61d);
x86_l_d1:
	/* 0xd1: xor    ebp,ebp */
	X86_SIM_L_EXEC_ALU_REG(X86_RBP, X86_RBP, X86_WIDTH_32, X86_ALU_XOR);
x86_l_d3:
	/* 0xd3: jmp    d8 <generic_lsm_event+0xd8> */
...
x86_l_149:
	/* 0x149: je     61d <generic_lsm_event+0x61d> */
...
x86_l_172:
	/* 0x172: je     61d <generic_lsm_event+0x61d> */
...
x86_l_1ac:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RDX, X86_RDX, X86_WIDTH_64);
x86_l_1af:
	/* 0x1af: je     1df <generic_lsm_event+0x1df> */
...
x86_l_1d5:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1d8:
	/* 0x1d8: jne    1ef <generic_lsm_event+0x1ef> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x1d8, 0x1ef, x86_l_1ef);
x86_l_1da:
	/* 0x1da: jmp    61d <generic_lsm_event+0x61d> */
...
x86_l_1e6:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1e9:
	/* 0x1e9: je     61d <generic_lsm_event+0x61d> */
...
x86_l_207:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_20a:
	/* 0x20a: je     219 <generic_lsm_event+0x219> */
...
x86_l_20f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_212:
	/* 0x212: je     219 <generic_lsm_event+0x219> */
...
x86_l_22e:
	/* 0x22e: je     62e <generic_lsm_event+0x62e> */
...
x86_l_387:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_38a:
	/* 0x38a: je     420 <generic_lsm_event+0x420> */
...
x86_l_41c:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_41e:
	/* 0x41e: jmp    428 <generic_lsm_event+0x428> */
...
x86_l_629:
	/* 0x629: jmp    687 <generic_lsm_event+0x687> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_62e:
...
x86_l_646:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_649:
	/* 0x649: je     61d <generic_lsm_event+0x61d> */
...
x86_l_666:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_669:
	/* 0x669: je     61d <generic_lsm_event+0x61d> */
...
x86_l_67d:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R12, X86_WIDTH_64);
x86_l_680:
	/* 0x680: jne    61d <generic_lsm_event+0x61d> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x680, 0x61d, x86_l_61d);
x86_l_682:
	/* 0x682: jmp    234 <generic_lsm_event+0x234> */
