...
SEC("xdp")
int tetragon_bpf_multi_uprobe_v511_generic_sleepable_offload_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_21:
	/* 0x21: mov    rdi,QWORD PTR [rip+0x53e7] */
...
x86_l_43:
	/* 0x43: mov    rdi,QWORD PTR [rip+0x53e7] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&sleepable_offload)));
x86_l_4a:
...
x86_l_54:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_59:
	/* 0x59: mov    rdi,QWORD PTR [rip+0x53e7] */
