...
x86_l_17:
	/* 0x17: mov    rdi,QWORD PTR [rip+0x60d7] */
...
x86_l_42:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_47:
	/* 0x47: mov    rdi,QWORD PTR [rip+0x60d7] */
...
x86_l_214:
	/* 0x214: mov    rsi,QWORD PTR [rip+0x60d7] */
...
x86_l_2fd:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_302:
	/* 0x302: mov    rdi,QWORD PTR [rip+0x60d7] */
...
x86_l_3d5:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_3da:
	/* 0x3da: mov    rdi,QWORD PTR [rip+0x60d7] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&argfilter_maps)));
x86_l_3e1:
...
x86_l_516:
	/* 0x516: mov    rsi,QWORD PTR [rip+0x60d7] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&usdt_calls)));
x86_l_51d:
	/* 0x51d: mov    rdi,rbx */
	X86_SIM_L_EXEC_MOV_REG(X86_RDI, X86_RBX, X86_WIDTH_64);
...
x86_l_527:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 12ULL);
x86_l_52c:
	/* 0x52c: mov    rsi,QWORD PTR [rip+0x60d7] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&usdt_calls)));
x86_l_533:
	/* 0x533: mov    rdi,rbx */
	X86_SIM_L_EXEC_MOV_REG(X86_RDI, X86_RBX, X86_WIDTH_64);
...
x86_l_5af:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 12ULL);
x86_l_5b4:
	/* 0x5b4: mov    rsi,QWORD PTR [rip+0x60da] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&usdt_calls)));
x86_l_5bb:
	/* 0x5bb: mov    rdi,rbx */
	X86_SIM_L_EXEC_MOV_REG(X86_RDI, X86_RBX, X86_WIDTH_64);
...
x86_l_5da:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_5df:
	/* 0x5df: mov    rdi,QWORD PTR [rip+0x60da] */
...
x86_l_5fb:
	/* 0x5fb: mov    rdi,QWORD PTR [rip+0x60da] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&retprobe_map)));
x86_l_602:
