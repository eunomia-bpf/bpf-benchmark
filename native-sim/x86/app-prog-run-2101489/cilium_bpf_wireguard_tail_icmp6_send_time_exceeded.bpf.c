...
x86_l_87:
	/* 0x87: mov    rax,QWORD PTR [rip+0x397] */
...
x86_l_38e:
	/* 0x38e: mov    rax,QWORD PTR [rip+0x397] */
...
x86_l_5a0:
	/* 0x5a0: mov    rdi,QWORD PTR [rip+0x393] */
...
x86_l_5cf:
	/* 0x5cf: mov    rdi,QWORD PTR [rip+0x393] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&cilium_metrics)));
x86_l_5d6:
...
x86_l_5e9:
	/* 0x5e9: mov    rsi,QWORD PTR [rip+0x393] */
