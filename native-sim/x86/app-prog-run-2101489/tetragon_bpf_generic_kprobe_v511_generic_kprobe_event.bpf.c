...
x86_l_29:
	/* 0x29: je     4f6 <generic_kprobe_event+0x4f6> */
	X86_SIM_X86_JCC(X86_CC_E, 0x29, 0x4f6, x86_l_4f6);
x86_l_2f:
	/* 0x2f: mov    r14,rax */
...
x86_l_51:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_54:
	/* 0x54: je     4f6 <generic_kprobe_event+0x4f6> */
	X86_SIM_X86_JCC(X86_CC_E, 0x54, 0x4f6, x86_l_4f6);
x86_l_5a:
...
x86_l_63:
	/* 0x63: je     20b <generic_kprobe_event+0x20b> */
...
x86_l_7f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_82:
	/* 0x82: je     4f6 <generic_kprobe_event+0x4f6> */
	X86_SIM_X86_JCC(X86_CC_E, 0x82, 0x4f6, x86_l_4f6);
x86_l_88:
	/* 0x88: mov    r15,rax */
...
x86_l_a6:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_a9:
	/* 0xa9: je     ce <generic_kprobe_event+0xce> */
...
x86_l_b3:
	/* 0xb3: jne    d2 <generic_kprobe_event+0xd2> */
...
x86_l_c0:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_c3:
	/* 0xc3: jne    1c9 <generic_kprobe_event+0x1c9> */
	X86_SIM_X86_JCC(X86_CC_NE, 0xc3, 0x1c9, x86_l_1c9);
x86_l_c9:
	/* 0xc9: jmp    4f6 <generic_kprobe_event+0x4f6> */
	X86_SIM_X86_JMP(0xc9, 0x4f6, x86_l_4f6);
x86_l_ce:
	/* 0xce: xor    ebp,ebp */
	X86_SIM_L_EXEC_ALU_REG(X86_RBP, X86_RBP, X86_WIDTH_32, X86_ALU_XOR);
x86_l_d0:
	/* 0xd0: jmp    d5 <generic_kprobe_event+0xd5> */
...
x86_l_103:
	/* 0x103: je     4f6 <generic_kprobe_event+0x4f6> */
	X86_SIM_X86_JCC(X86_CC_E, 0x103, 0x4f6, x86_l_4f6);
x86_l_109:
	/* 0x109: cmp    ebp,0xb */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBP, X86_WIDTH_32, 11ULL);
x86_l_10c:
	/* 0x10c: ja     4f6 <generic_kprobe_event+0x4f6> */
	X86_SIM_X86_JCC(X86_CC_A, 0x10c, 0x4f6, x86_l_4f6);
x86_l_112:
	/* 0x112: mov    edx,ebp */
...
x86_l_134:
	/* 0x134: je     4f6 <generic_kprobe_event+0x4f6> */
	X86_SIM_X86_JCC(X86_CC_E, 0x134, 0x4f6, x86_l_4f6);
x86_l_13a:
	/* 0x13a: mov    eax,0x71 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 113ULL);
x86_l_13f:
...
x86_l_158:
	/* 0x158: je     4f6 <generic_kprobe_event+0x4f6> */
	X86_SIM_X86_JCC(X86_CC_E, 0x158, 0x4f6, x86_l_4f6);
x86_l_15e:
...
x86_l_18d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RDX, X86_RDX, X86_WIDTH_64);
x86_l_190:
	/* 0x190: je     1ba <generic_kprobe_event+0x1ba> */
...
x86_l_1b0:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1b3:
	/* 0x1b3: jne    1c9 <generic_kprobe_event+0x1c9> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x1b3, 0x1c9, x86_l_1c9);
x86_l_1b5:
	/* 0x1b5: jmp    4f6 <generic_kprobe_event+0x4f6> */
	X86_SIM_X86_JMP(0x1b5, 0x4f6, x86_l_4f6);
x86_l_1ba:
	/* 0x1ba: xor    eax,eax */
...
x86_l_1c0:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1c3:
	/* 0x1c3: je     4f6 <generic_kprobe_event+0x4f6> */
	X86_SIM_X86_JCC(X86_CC_E, 0x1c3, 0x4f6, x86_l_4f6);
x86_l_1c9:
...
x86_l_1e1:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1e4:
	/* 0x1e4: je     1f2 <generic_kprobe_event+0x1f2> */
...
x86_l_1e9:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1ec:
	/* 0x1ec: je     1f2 <generic_kprobe_event+0x1f2> */
...
x86_l_205:
	/* 0x205: je     505 <generic_kprobe_event+0x505> */
	X86_SIM_X86_JCC(X86_CC_E, 0x205, 0x505, x86_l_505);
x86_l_20b:
...
x86_l_224:
	/* 0x224: mov    DWORD PTR [r14+0x6420],0x0 */
...
x86_l_319:
	/* 0x319: je     37f <generic_kprobe_event+0x37f> */
...
x86_l_37b:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_37d:
	/* 0x37d: jmp    387 <generic_kprobe_event+0x387> */
...
x86_l_4bb:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_4bd:
	/* 0x4bd: mov    BYTE PTR [r14+0x5f08],0x0 */
...
x86_l_4ca:
	/* 0x4ca: mov    QWORD PTR [r14+0x5ee8],0x0 */
...
x86_l_4d5:
	/* 0x4d5: mov    QWORD PTR [r14+0x5ef0],0x0 */
...
x86_l_4e5:
	/* 0x4e5: mov    rsi,QWORD PTR [rip+0x0] */
...
x86_l_500:
	/* 0x500: jmp    55c <generic_kprobe_event+0x55c> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_505:
	/* 0x505: mov    QWORD PTR [rsp+0x10],0xffffffffffffffff */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 73014444031ULL);
x86_l_50e:
	/* 0x50e: mov    eax,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_513:
	/* 0x513: lea    rsi,[rsp+0x10] */
...
x86_l_51d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_520:
	/* 0x520: je     4f6 <generic_kprobe_event+0x4f6> */
	X86_SIM_X86_JCC(X86_CC_E, 0x520, 0x4f6, x86_l_4f6);
x86_l_522:
	/* 0x522: mov    DWORD PTR [rsp+0xc],0x1 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 51539607553ULL);
x86_l_52a:
	/* 0x52a: mov    eax,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_52f:
	/* 0x52f: mov    rdi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&policy_filter_maps)));
x86_l_536:
	/* 0x536: lea    rsi,[rsp+0xc] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 12ULL);
x86_l_53b:
	/* 0x53b: call   rax */
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_53d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_540:
	/* 0x540: je     4f6 <generic_kprobe_event+0x4f6> */
	X86_SIM_X86_JCC(X86_CC_E, 0x540, 0x4f6, x86_l_4f6);
x86_l_542:
	/* 0x542: mov    ecx,0x1 */
...
x86_l_552:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RAX, X86_R13, X86_WIDTH_64);
x86_l_555:
	/* 0x555: jne    4f6 <generic_kprobe_event+0x4f6> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x555, 0x4f6, x86_l_4f6);
x86_l_557:
	/* 0x557: jmp    20b <generic_kprobe_event+0x20b> */
	X86_SIM_X86_JMP(0x557, 0x20b, x86_l_20b);
x86_l_55c:
