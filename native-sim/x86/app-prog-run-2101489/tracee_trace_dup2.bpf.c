...
x86_l_dc:
	/* 0xdc: jmp    11d <trace_dup2+0x11d> */
	X86_SIM_X86_JMP(0xdc, 0x11d, x86_l_11d);
x86_l_de:
	/* 0xde: test   r12,r12 */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_R12, X86_R12, X86_WIDTH_64);
x86_l_e1:
	/* 0xe1: je     14c <trace_dup2+0x14c> */
...
x86_l_147:
	/* 0x147: jmp    63d <trace_dup2+0x63d> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_14c:
	/* 0x14c: jmp    121 <trace_dup2+0x121> */
...
x86_l_4a2:
	/* 0x4a2: jne    4f1 <trace_dup2+0x4f1> */
