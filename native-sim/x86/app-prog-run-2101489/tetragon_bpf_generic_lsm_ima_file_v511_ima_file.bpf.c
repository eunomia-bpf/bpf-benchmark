...
x86_l_26:
	/* 0x26: je     62 <ima_file+0x62> */
	X86_SIM_X86_JCC(X86_CC_E, 0x26, 0x62, x86_l_62);
x86_l_28:
...
x86_l_2b:
	/* 0x2b: jne    62 <ima_file+0x62> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x2b, 0x62, x86_l_62);
x86_l_2d:
...
x86_l_68:
	/* 0x68: jmp    6d <ima_file+0x6d> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_6d:
