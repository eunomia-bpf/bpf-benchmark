...
x86_l_12:
	/* 0x12: je     27 <sched_wakeup_new+0x27> */
...
x86_l_39:
	/* 0x39: je     6f <sched_wakeup_new+0x6f> */
...
x86_l_45:
	/* 0x45: je     4d <sched_wakeup_new+0x4d> */
...
x86_l_4b:
	/* 0x4b: jne    6f <sched_wakeup_new+0x6f> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x4b, 0x6f, x86_l_6f);
x86_l_4d:
	/* 0x4d: call   52 <sched_wakeup_new+0x52> */
...
x86_l_6a:
	/* 0x6a: call   6f <sched_wakeup_new+0x6f> */
...
x86_l_76:
	/* 0x76: jmp    7b <sched_wakeup_new+0x7b> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_7b:
