...
x86_l_a:
	/* 0xa: call   f <tracepoint__syscalls__sys_enter_openat+0xf> */
...
x86_l_1d:
	/* 0x1d: je     2c <tracepoint__syscalls__sys_enter_openat+0x2c> */
...
x86_l_2a:
	/* 0x2a: jne    8a <tracepoint__syscalls__sys_enter_openat+0x8a> */
...
x86_l_33:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_36:
	/* 0x36: je     3e <tracepoint__syscalls__sys_enter_openat+0x3e> */
...
x86_l_3c:
	/* 0x3c: jne    8a <tracepoint__syscalls__sys_enter_openat+0x8a> */
...
x86_l_4b:
	/* 0x4b: je     59 <tracepoint__syscalls__sys_enter_openat+0x59> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4b, 0x59, x86_l_59);
x86_l_4d:
	/* 0x4d: call   52 <tracepoint__syscalls__sys_enter_openat+0x52> */
...
x86_l_6b:
	/* 0x6b: mov    eax,DWORD PTR [rbx+0x20] */
...
x86_l_85:
	/* 0x85: call   8a <tracepoint__syscalls__sys_enter_openat+0x8a> */
...
x86_l_93:
	/* 0x93: jmp    98 <tracepoint__syscalls__sys_enter_openat+0x98> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_98:
