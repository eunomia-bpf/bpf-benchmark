...
x86_l_1a:
	/* 0x1a: call   1f <tracepoint__syscalls__sys_exit_open+0x1f> */
	X86_SIM_L_EXEC_CALL_MEMSET(312ULL);
x86_l_1f:
	/* 0x1f: call   24 <tracepoint__syscalls__sys_exit_open+0x24> */
...
x86_l_34:
	/* 0x34: call   39 <tracepoint__syscalls__sys_exit_open+0x39> */
	X86_SIM_BPF_CALL_ID(X86_SIM_HELPER_bpf_map_lookup_elem);
x86_l_39:
	/* 0x39: test   rax,rax */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3c:
	/* 0x3c: je     fa <tracepoint__syscalls__sys_exit_open+0xfa> */
...
x86_l_4f:
	/* 0x4f: je     59 <tracepoint__syscalls__sys_exit_open+0x59> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4f, 0x59, x86_l_59);
x86_l_51:
	/* 0x51: test   ebp,ebp */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RBP, X86_RBP, X86_WIDTH_32);
x86_l_53:
	/* 0x53: jns    e9 <tracepoint__syscalls__sys_exit_open+0xe9> */
	X86_SIM_X86_JCC(X86_CC_NS, 0x53, 0xe9, x86_l_e9);
x86_l_59:
	/* 0x59: mov    r14,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_R14, X86_RAX, X86_WIDTH_64);
x86_l_5c:
	/* 0x5c: call   61 <tracepoint__syscalls__sys_exit_open+0x61> */
	X86_SIM_BPF_CALL_ID(X86_SIM_HELPER_bpf_get_current_pid_tgid);
x86_l_61:
	/* 0x61: shr    rax,0x20 */
...
x86_l_69:
	/* 0x69: call   6e <tracepoint__syscalls__sys_exit_open+0x6e> */
...
x86_l_7c:
	/* 0x7c: call   81 <tracepoint__syscalls__sys_exit_open+0x81> */
...
x86_l_8e:
	/* 0x8e: call   93 <tracepoint__syscalls__sys_exit_open+0x93> */
...
x86_l_b1:
	/* 0xb1: call   b6 <tracepoint__syscalls__sys_exit_open+0xb6> */
...
x86_l_e1:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RDI, X86_RBX, X86_WIDTH_64);
x86_l_e4:
	/* 0xe4: call   e9 <tracepoint__syscalls__sys_exit_open+0xe9> */
...
x86_l_f0:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 12ULL);
x86_l_f5:
	/* 0xf5: call   fa <tracepoint__syscalls__sys_exit_open+0xfa> */
...
x86_l_107:
	/* 0x107: jmp    10c <tracepoint__syscalls__sys_exit_open+0x10c> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_10c:
