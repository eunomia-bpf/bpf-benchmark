...
SEC("xdp")
int tetragon_bpf_generic_tracepoint_v61_filter_16ty_selector_val_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_c:
	/* 0xc: ja     87 <filter_16ty_selector_val+0x87> */
...
x86_l_1c:
	/* 0x1c: jae    23 <filter_16ty_selector_val+0x23> */
	X86_SIM_X86_JCC(X86_CC_AE, 0x1c, 0x23, x86_l_23);
x86_l_1e:
	/* 0x1e: jmp    226 <filter_16ty_selector_val+0x226> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_23:
	/* 0x23: mov    edx,0x18 */
...
x86_l_28:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_64);
x86_l_2c:
	/* 0x2c: jae    47 <filter_16ty_selector_val+0x47> */
	X86_SIM_X86_JCC(X86_CC_AE, 0x2c, 0x47, x86_l_47);
x86_l_2e:
	/* 0x2e: movzx  edx,WORD PTR [rsi] */
...
x86_l_34:
	/* 0x34: jne    15d <filter_16ty_selector_val+0x15d> */
...
x86_l_42:
	/* 0x42: jmp    226 <filter_16ty_selector_val+0x226> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_47:
	/* 0x47: cmp    rcx,0xc */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_64, 12ULL);
x86_l_4b:
	/* 0x4b: jne    87 <filter_16ty_selector_val+0x87> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x4b, 0x87, x86_l_87);
x86_l_4d:
	/* 0x4d: movzx  ecx,WORD PTR [rsi] */
...
x86_l_53:
	/* 0x53: jne    1e <filter_16ty_selector_val+0x1e> */
...
x86_l_5b:
	/* 0x5b: jb     21f <filter_16ty_selector_val+0x21f> */
...
x86_l_80:
	/* 0x80: jne    1e <filter_16ty_selector_val+0x1e> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x80, 0x1e, x86_l_1e);
x86_l_82:
	/* 0x82: jmp    21f <filter_16ty_selector_val+0x21f> */
	X86_SIM_X86_JMP(0x82, 0x21f, x86_l_21f);
x86_l_87:
	/* 0x87: cmp    ecx,0x1 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 1ULL);
x86_l_8a:
	/* 0x8a: je     f9 <filter_16ty_selector_val+0xf9> */
	X86_SIM_X86_JCC(X86_CC_E, 0x8a, 0xf9, x86_l_f9);
x86_l_8c:
	/* 0x8c: cmp    ecx,0x2 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 2ULL);
x86_l_8f:
	/* 0x8f: jne    21f <filter_16ty_selector_val+0x21f> */
...
x86_l_9b:
	/* 0x9b: ja     1e6 <filter_16ty_selector_val+0x1e6> */
...
x86_l_a9:
	/* 0xa9: jae    1e6 <filter_16ty_selector_val+0x1e6> */
	X86_SIM_X86_JCC(X86_CC_AE, 0xa9, 0x1e6, x86_l_1e6);
x86_l_af:
	/* 0xaf: movsx  ecx,WORD PTR [rsi] */
...
x86_l_b5:
	/* 0xb5: jg     1e <filter_16ty_selector_val+0x1e> */
...
x86_l_be:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDX, X86_WIDTH_32, 13ULL);
x86_l_c1:
	/* 0xc1: jb     21f <filter_16ty_selector_val+0x21f> */
...
x86_l_ca:
	/* 0xca: jg     1e <filter_16ty_selector_val+0x1e> */
	X86_SIM_X86_JCC(X86_CC_G, 0xca, 0x1e, x86_l_1e);
x86_l_d0:
	/* 0xd0: cmp    edx,0x11 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDX, X86_WIDTH_32, 17ULL);
x86_l_d3:
	/* 0xd3: jb     21f <filter_16ty_selector_val+0x21f> */
...
x86_l_dc:
	/* 0xdc: jg     1e <filter_16ty_selector_val+0x1e> */
	X86_SIM_X86_JCC(X86_CC_G, 0xdc, 0x1e, x86_l_1e);
x86_l_e2:
	/* 0xe2: cmp    edx,0x15 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDX, X86_WIDTH_32, 21ULL);
x86_l_e5:
	/* 0xe5: jb     21f <filter_16ty_selector_val+0x21f> */
...
x86_l_ee:
	/* 0xee: jg     1e <filter_16ty_selector_val+0x1e> */
	X86_SIM_X86_JCC(X86_CC_G, 0xee, 0x1e, x86_l_1e);
x86_l_f4:
	/* 0xf4: jmp    21f <filter_16ty_selector_val+0x21f> */
...
x86_l_fc:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 12ULL);
x86_l_ff:
	/* 0xff: ja     1ab <filter_16ty_selector_val+0x1ab> */
...
x86_l_10a:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_32);
x86_l_10d:
	/* 0x10d: jae    1ab <filter_16ty_selector_val+0x1ab> */
	X86_SIM_X86_JCC(X86_CC_AE, 0x10d, 0x1ab, x86_l_1ab);
x86_l_113:
	/* 0x113: movsx  ecx,WORD PTR [rsi] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOVSX_LOAD, X86_RCX, X86_RSI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_16), 0ULL);
x86_l_116:
	/* 0x116: cmp    DWORD PTR [rdi+0x10],ecx */
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_REG, X86_RDI, X86_RCX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 16ULL);
x86_l_119:
	/* 0x119: jl     1e <filter_16ty_selector_val+0x1e> */
...
x86_l_163:
	/* 0x163: jb     18a <filter_16ty_selector_val+0x18a> */
...
x86_l_19f:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_64);
x86_l_1a3:
	/* 0x1a3: jb     1e <filter_16ty_selector_val+0x1e> */
	X86_SIM_X86_JCC(X86_CC_B, 0x1a3, 0x1e, x86_l_1e);
x86_l_1a9:
	/* 0x1a9: jmp    21f <filter_16ty_selector_val+0x21f> */
	X86_SIM_X86_JMP(0x1a9, 0x21f, x86_l_21f);
x86_l_1ab:
	/* 0x1ab: movzx  ecx,WORD PTR [rsi] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RCX, X86_RSI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_16), 0ULL);
x86_l_1ae:
	/* 0x1ae: cmp    DWORD PTR [rdi+0x10],ecx */
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_REG, X86_RDI, X86_RCX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 16ULL);
x86_l_1b1:
	/* 0x1b1: jb     1e <filter_16ty_selector_val+0x1e> */
