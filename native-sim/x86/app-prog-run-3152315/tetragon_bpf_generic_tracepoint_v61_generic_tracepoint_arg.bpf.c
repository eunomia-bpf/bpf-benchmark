...
x86_l_12:
	/* 0x12: mov    rdi,QWORD PTR [rip+0x5837] */
...
x86_l_28:
	/* 0x28: je     3dc <generic_tracepoint_arg+0x3dc> */
...
x86_l_3f:
	/* 0x3f: mov    rdi,QWORD PTR [rip+0x5837] */
...
x86_l_4d:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_50:
	/* 0x50: je     3c1 <generic_tracepoint_arg+0x3c1> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_3c1;
	}
x86_l_56:
...
x86_l_5e:
	/* 0x5e: je     3c1 <generic_tracepoint_arg+0x3c1> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_3c1;
	}
x86_l_64:
...
x86_l_f7:
	/* 0xf7: je     3c1 <generic_tracepoint_arg+0x3c1> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_3c1;
	}
x86_l_fd:
...
x86_l_10f:
	/* 0x10f: je     3ea <generic_tracepoint_arg+0x3ea> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_3ea;
	}
x86_l_115:
...
x86_l_118:
	/* 0x118: je     3f7 <generic_tracepoint_arg+0x3f7> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_3f7;
	}
x86_l_11e:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R12, X86_WIDTH_32, 1ULL);
x86_l_122:
	/* 0x122: je     407 <generic_tracepoint_arg+0x407> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_407;
	}
x86_l_128:
...
x86_l_12e:
	/* 0x12e: je     417 <generic_tracepoint_arg+0x417> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_417;
	}
x86_l_134:
...
x86_l_138:
	/* 0x138: je     427 <generic_tracepoint_arg+0x427> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_427;
	}
x86_l_13e:
...
x86_l_142:
	/* 0x142: je     437 <generic_tracepoint_arg+0x437> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_437;
	}
x86_l_148:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R12, X86_WIDTH_32, 4ULL);
x86_l_14c:
	/* 0x14c: jg     469 <generic_tracepoint_arg+0x469> */
	if (X86_SIM_L_EVAL_CC(X86_CC_G)) {
		goto x86_l_469;
	}
x86_l_152:
...
x86_l_155:
	/* 0x155: jmp    447 <generic_tracepoint_arg+0x447> */
	goto x86_l_447;
x86_l_15a:
...
x86_l_3a6:
	/* 0x3a6: mov    rsi,QWORD PTR [rip+0x5850] */
...
x86_l_3bf:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_3c1:
	/* 0x3c1: mov    rsi,QWORD PTR [rip+0x5850] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&tp_calls)));
x86_l_3c8:
	/* 0x3c8: mov    ecx,0x5 */
...
x86_l_3f5:
	/* 0x3f5: jne    447 <generic_tracepoint_arg+0x447> */
	if (X86_SIM_L_EVAL_CC(X86_CC_NE)) {
		goto x86_l_447;
	}
x86_l_3f7:
...
x86_l_405:
	/* 0x405: jne    447 <generic_tracepoint_arg+0x447> */
	if (X86_SIM_L_EVAL_CC(X86_CC_NE)) {
		goto x86_l_447;
	}
x86_l_407:
...
x86_l_415:
	/* 0x415: jne    447 <generic_tracepoint_arg+0x447> */
	if (X86_SIM_L_EVAL_CC(X86_CC_NE)) {
		goto x86_l_447;
	}
x86_l_417:
...
x86_l_425:
	/* 0x425: jne    447 <generic_tracepoint_arg+0x447> */
	if (X86_SIM_L_EVAL_CC(X86_CC_NE)) {
		goto x86_l_447;
	}
x86_l_427:
...
x86_l_435:
	/* 0x435: jne    447 <generic_tracepoint_arg+0x447> */
	if (X86_SIM_L_EVAL_CC(X86_CC_NE)) {
		goto x86_l_447;
	}
x86_l_437:
...
x86_l_445:
	/* 0x445: je     469 <generic_tracepoint_arg+0x469> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_469;
	}
x86_l_447:
...
x86_l_44e:
	/* 0x44e: mov    rsi,QWORD PTR [rip+0x5853] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&tp_calls)));
x86_l_455:
	/* 0x455: mov    ecx,0x3 */
...
x86_l_47e:
	/* 0x47e: mov    rdi,QWORD PTR [rip+0x5853] */
...
x86_l_491:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_494:
	/* 0x494: je     3dc <generic_tracepoint_arg+0x3dc> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		goto x86_l_3dc;
	}
x86_l_49a:
	/* 0x49a: mov    rdi,QWORD PTR [rip+0x5853] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&retprobe_map)));
x86_l_4a1:
...
x86_l_4ab:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_4ad:
	/* 0x4ad: jmp    3dc <generic_tracepoint_arg+0x3dc> */
	goto x86_l_3dc;
x86_l_4b2:
	/* 0x4b2: push   rbx */
...
x86_l_7d0:
	/* 0x7d0: mov    rdi,QWORD PTR [rip+0x16f0] */
...
x86_l_839:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_RAX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_83d:
	/* 0x83d: mov    rdi,QWORD PTR [rip+0x16f0] */
...
x86_l_f3e:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_RAX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 12ULL);
x86_l_f42:
	/* 0xf42: mov    rdi,QWORD PTR [rip+0x5c0] */
...
x86_l_fbf:
	/* 0xfbf: mov    rdi,QWORD PTR [rip+0x1f20] */
...
x86_l_fe8:
	/* 0xfe8: mov    rdi,QWORD PTR [rip+0x1f20] */
...
x86_l_10fd:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_1104:
	/* 0x1104: mov    rdi,QWORD PTR [rip+0x1e80] */
...
x86_l_1125:
	/* 0x1125: mov    rdi,QWORD PTR [rip+0x1e80] */
...
x86_l_12ad:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RBP, X86_RDX, X86_WIDTH_32);
x86_l_12af:
	/* 0x12af: mov    rdi,QWORD PTR [rip+0x1af0] */
...
x86_l_12c8:
	/* 0x12c8: mov    rdi,QWORD PTR [rip+0x1af0] */
...
x86_l_13b5:
	/* 0x13b5: mov    rdi,QWORD PTR [rip+0x1af0] */
...
x86_l_13ef:
	/* 0x13ef: mov    rdi,QWORD PTR [rip+0x1af0] */
...
x86_l_1423:
	/* 0x1423: mov    rdi,QWORD PTR [rip+0x1aec] */
...
x86_l_1448:
	/* 0x1448: mov    rdi,QWORD PTR [rip+0x1aec] */
...
x86_l_1459:
	...
	goto x86_l_14e1;
x86_l_145e:
	/* 0x145e: mov    rdi,QWORD PTR [rip+0x1aec] */
...
x86_l_146f:
	...
	goto x86_l_14e1;
x86_l_1471:
	/* 0x1471: mov    rdi,QWORD PTR [rip+0x1aec] */
...
x86_l_1482:
	...
	goto x86_l_14e1;
x86_l_1484:
	/* 0x1484: mov    rdi,QWORD PTR [rip+0x1aec] */
...
x86_l_1495:
	...
	goto x86_l_14e1;
x86_l_1497:
	/* 0x1497: mov    rdi,QWORD PTR [rip+0x1aec] */
...
x86_l_14a8:
	...
	goto x86_l_14e1;
x86_l_14aa:
	/* 0x14aa: mov    rdi,QWORD PTR [rip+0x1aec] */
...
x86_l_14bb:
	...
	goto x86_l_14e1;
x86_l_14bd:
	/* 0x14bd: mov    rdi,QWORD PTR [rip+0x1aec] */
...
x86_l_14ce:
	...
	goto x86_l_14e1;
x86_l_14d0:
	/* 0x14d0: mov    rdi,QWORD PTR [rip+0x1aec] */
...
x86_l_1550:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_1555:
	/* 0x1555: mov    rdi,QWORD PTR [rip+0x2123] */
...
x86_l_1612:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_1617:
	/* 0x1617: mov    rdi,QWORD PTR [rip+0x2131] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&substring_map)));
x86_l_161e:
	/* 0x161e: mov    rsi,r13 */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_R13, X86_WIDTH_64);
...
x86_l_1699:
	/* 0x1699: mov    r15,QWORD PTR [rip+0x2143] */
...
x86_l_16d7:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RBX, X86_WIDTH_32, 16ULL);
x86_l_16dc:
	/* 0x16dc: mov    r15,QWORD PTR [rip+0x2145] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_R15, (void *)(long)(((__u64)(long)&substring_map)));
x86_l_16e3:
...
x86_l_1b13:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_RAX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 12ULL);
x86_l_1b17:
	/* 0x1b17: mov    rdi,QWORD PTR [rip+0xeb0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&argfilter_maps)));
x86_l_1b1e:
...
x86_l_1f63:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_RAX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 12ULL);
x86_l_1f67:
	/* 0x1f67: mov    rdi,QWORD PTR [rip+0xa40] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&argfilter_maps)));
x86_l_1f6e:
...
x86_l_23ba:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_RAX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 12ULL);
x86_l_23be:
	/* 0x23be: mov    rdi,QWORD PTR [rip+0x1320] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&argfilter_maps)));
x86_l_23c5:
