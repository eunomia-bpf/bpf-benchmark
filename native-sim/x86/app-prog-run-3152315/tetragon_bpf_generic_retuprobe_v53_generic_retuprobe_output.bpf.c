...
x86_l_f:
	/* 0xf: mov    rdi,QWORD PTR [rip+0x3b51] */
...
x86_l_25:
	/* 0x25: je     cf <generic_retuprobe_output+0xcf> */
...
x86_l_4a:
	/* 0x4a: mov    rsi,QWORD PTR [rip+0x3b51] */
...
x86_l_60:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_63:
	/* 0x63: js     8c <generic_retuprobe_output+0x8c> */
	X86_SIM_X86_JCC(X86_CC_S, 0x63, 0x8c, x86_l_8c);
x86_l_65:
	/* 0x65: mov    DWORD PTR [rsp+0xc],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 51539607552ULL);
x86_l_6d:
	/* 0x6d: mov    rdi,QWORD PTR [rip+0x3b51] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&policy_stats)));
x86_l_74:
	/* 0x74: lea    rsi,[rsp+0xc] */
...
x86_l_80:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_83:
	/* 0x83: je     cf <generic_retuprobe_output+0xcf> */
...
x86_l_8a:
	/* 0x8a: jmp    cf <generic_retuprobe_output+0xcf> */
	X86_SIM_X86_JMP(0x8a, 0xcf, x86_l_cf);
x86_l_8c:
	/* 0x8c: mov    rbx,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RBX, X86_RAX, X86_WIDTH_64);
x86_l_8f:
	/* 0x8f: mov    DWORD PTR [rsp+0x8],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 34359738368ULL);
x86_l_97:
	/* 0x97: mov    rdi,QWORD PTR [rip+0x3b51] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_stats_map)));
x86_l_9e:
	/* 0x9e: lea    rsi,[rsp+0x8] */
...
x86_l_120:
	...
	X86_SIM_L_EXEC_ALU_IMM(X86_RSP, X86_WIDTH_64, X86_ALU_ADD, 16ULL);
x86_l_124:
	/* 0x124: jmp    129 <generic_retuprobe_output+0x129> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_129:
