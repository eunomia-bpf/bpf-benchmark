...
SEC("xdp")
int tetragon_bpf_generic_retuprobe_v61_generic_retuprobe_actions_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_f:
	/* 0xf: mov    rdi,QWORD PTR [rip+0x484] */
...
x86_l_25:
	/* 0x25: je     12f <generic_retuprobe_actions+0x12f> */
...
x86_l_54:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_57:
	/* 0x57: je     12f <generic_retuprobe_actions+0x12f> */
...
x86_l_77:
	/* 0x77: mov    rdi,QWORD PTR [rip+0x484] */
...
x86_l_97:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_9a:
	/* 0x9a: je     aa <generic_retuprobe_actions+0xaa> */
...
x86_l_a6:
	/* 0xa6: jae    b2 <generic_retuprobe_actions+0xb2> */
	X86_SIM_X86_JCC(X86_CC_AE, 0xa6, 0xb2, x86_l_b2);
x86_l_a8:
	/* 0xa8: jmp    10d <generic_retuprobe_actions+0x10d> */
...
x86_l_ac:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 5ULL);
x86_l_b0:
	/* 0xb0: jb     10d <generic_retuprobe_actions+0x10d> */
...
x86_l_c6:
	/* 0xc6: call   0 <generic_retuprobe_actions> */
...
x86_l_d5:
	/* 0xd5: jae    10d <generic_retuprobe_actions+0x10d> */
...
x86_l_e4:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_R8, X86_R13, X86_WIDTH_32);
x86_l_e7:
	/* 0xe7: call   0 <generic_retuprobe_actions> */
...
x86_l_f3:
	...
	X86_SIM_L_EXEC_CMP_REG_MEM(X86_RCX, X86_R14, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32), 0ULL);
x86_l_f6:
	/* 0xf6: jae    10d <generic_retuprobe_actions+0x10d> */
...
x86_l_105:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_R8, X86_R13, X86_WIDTH_32);
x86_l_108:
	/* 0x108: call   0 <generic_retuprobe_actions> */
...
x86_l_112:
	/* 0x112: je     12f <generic_retuprobe_actions+0x12f> */
	X86_SIM_X86_JCC(X86_CC_E, 0x112, 0x12f, x86_l_12f);
x86_l_114:
	/* 0x114: mov    rsi,QWORD PTR [rip+0x483] */
...
x86_l_167:
	/* 0x167: mov    rdi,QWORD PTR [rip+0x22e0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_16e:
...
x86_l_26b:
	/* 0x26b: mov    rdi,QWORD PTR [rip+0x22e0] */
...
x86_l_2d2:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_RAX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_2d6:
	/* 0x2d6: mov    rdi,QWORD PTR [rip+0x22e0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_2dd:
	/* 0x2dd: xor    ecx,ecx */
...
x86_l_352:
	/* 0x352: mov    rdi,QWORD PTR [rip+0x22e0] */
...
x86_l_429:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_42b:
	/* 0x42b: mov    rdi,QWORD PTR [rip+0x22e0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_432:
	/* 0x432: xor    r15d,r15d */
	X86_SIM_L_EXEC_ALU_REG(X86_R15, X86_R15, X86_WIDTH_32, X86_ALU_XOR);
...
x86_l_4a9:
	/* 0x4a9: mov    rdi,QWORD PTR [rip+0x22e0] */
...
x86_l_4de:
	/* 0x4de: mov    rdi,QWORD PTR [rip+0x22e0] */
...
x86_l_587:
	/* 0x587: mov    rdi,QWORD PTR [rip+0x22e0] */
...
x86_l_5ae:
	/* 0x5ae: mov    rdi,QWORD PTR [rip+0x22e0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_data)));
x86_l_5b5:
...
x86_l_600:
	/* 0x600: mov    rdi,QWORD PTR [rip+0x22e0] */
...
x86_l_624:
	/* 0x624: mov    rdi,QWORD PTR [rip+0x22e0] */
...
x86_l_694:
	/* 0x694: mov    rdi,QWORD PTR [rip+0x22e0] */
...
x86_l_6b8:
	/* 0x6b8: mov    rdi,QWORD PTR [rip+0x22e0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_missed_notifications)));
x86_l_6bf:
...
x86_l_6fd:
	/* 0x6fd: mov    rdi,QWORD PTR [rip+0x22e0] */
...
x86_l_71e:
	/* 0x71e: mov    rdi,QWORD PTR [rip+0x22e0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&fdinstall_map)));
x86_l_725:
	/* 0x725: mov    rsi,rsp */
	X86_SIM_L_EXEC_MOV_REG(X86_RSI, X86_RSP, X86_WIDTH_64);
...
x86_l_72f:
	/* 0x72f: mov    rdi,QWORD PTR [rip+0x22e0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&socktrack_map)));
x86_l_736:
...
x86_l_7a8:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_7ad:
	/* 0x7ad: mov    rdi,QWORD PTR [rip+0x22e0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_7b4:
...
x86_l_7ce:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_7d3:
	/* 0x7d3: mov    rdi,QWORD PTR [rip+0x22e0] */
...
x86_l_814:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_819:
	/* 0x819: mov    rdi,QWORD PTR [rip+0x22e0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&process_call_heap)));
x86_l_820:
...
x86_l_836:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
x86_l_83b:
	/* 0x83b: mov    rdi,QWORD PTR [rip+0x22e0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&config_map)));
x86_l_842:
	/* 0x842: call   rax */
	X86_SIM_BPF_CALL_REG(X86_RAX);
...
x86_l_8cd:
	/* 0x8cd: mov    rdi,QWORD PTR [rip+0x22e0] */
...
x86_l_905:
	/* 0x905: mov    rdi,QWORD PTR [rip+0x22e0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&ratelimit_map)));
x86_l_90c:
	/* 0x90c: xor    ecx,ecx */
	X86_SIM_L_EXEC_ALU_REG(X86_RCX, X86_RCX, X86_WIDTH_32, X86_ALU_XOR);
...
x86_l_934:
	/* 0x934: mov    rsi,QWORD PTR [rip+0x22e0] */
...
x86_l_960:
	/* 0x960: mov    rsi,QWORD PTR [rip+0x22e0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&stack_trace_map)));
x86_l_967:
	/* 0x967: mov    ecx,0x100 */
...
x86_l_9b1:
	/* 0x9b1: mov    rdi,QWORD PTR [rip+0x22e0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_errmetrics_map)));
x86_l_9b8:
	/* 0x9b8: xor    ecx,ecx */
	X86_SIM_L_EXEC_ALU_REG(X86_RCX, X86_RCX, X86_WIDTH_32, X86_ALU_XOR);
...
x86_l_9d4:
	/* 0x9d4: mov    rdi,QWORD PTR [rip+0x22e0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&enforcer_missed_notifications)));
x86_l_9db:
