...
SEC("xdp")
int tetragon_bpf_generic_retkprobe_v61_generic_retkprobe_output_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_f:
	/* 0xf: mov    rdi,QWORD PTR [rip+0x5c5] */
...
x86_l_25:
	/* 0x25: je     fe <generic_retkprobe_output+0xfe> */
...
x86_l_52:
	/* 0x52: mov    rdi,QWORD PTR [rip+0x5c5] */
...
x86_l_65:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_68:
	/* 0x68: je     bc <generic_retkprobe_output+0xbc> */
...
x86_l_6e:
	/* 0x6e: je     bc <generic_retkprobe_output+0xbc> */
	X86_SIM_X86_JCC(X86_CC_E, 0x6e, 0xbc, x86_l_bc);
x86_l_70:
	/* 0x70: mov    rsi,QWORD PTR [rip+0x5c5] */
...
x86_l_91:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_94:
	/* 0x94: js     158 <generic_retkprobe_output+0x158> */
...
x86_l_a2:
	/* 0xa2: mov    rdi,QWORD PTR [rip+0x5c5] */
...
x86_l_b5:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_b8:
	/* 0xb8: jne    f9 <generic_retkprobe_output+0xf9> */
	X86_SIM_X86_JCC(X86_CC_NE, 0xb8, 0xf9, x86_l_f9);
x86_l_ba:
	/* 0xba: jmp    fe <generic_retkprobe_output+0xfe> */
	X86_SIM_X86_JMP(0xba, 0xfe, x86_l_fe);
x86_l_bc:
	/* 0xbc: mov    rdi,QWORD PTR [rip+0x5c5] */
...
x86_l_f4:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_f7:
	/* 0xf7: je     fe <generic_retkprobe_output+0xfe> */
...
x86_l_104:
	/* 0x104: jmp    20b <generic_retkprobe_output+0x20b> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_109:
	/* 0x109: mov    rbx,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RBX, X86_RAX, X86_WIDTH_64);
x86_l_10c:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 17179869184ULL);
x86_l_114:
	/* 0x114: mov    rdi,QWORD PTR [rip+0x5c6] */
...
x86_l_156:
	/* 0x156: jmp    fe <generic_retkprobe_output+0xfe> */
...
x86_l_15b:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 17179869184ULL);
x86_l_163:
	/* 0x163: mov    rdi,QWORD PTR [rip+0x5c6] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_stats_map)));
x86_l_16a:
...
x86_l_1d5:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_1d9:
	/* 0x1d9: jmp    fe <generic_retkprobe_output+0xfe> */
...
x86_l_1e4:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_1e8:
	/* 0x1e8: jmp    fe <generic_retkprobe_output+0xfe> */
...
x86_l_1f3:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_1f7:
	/* 0x1f7: jmp    fe <generic_retkprobe_output+0xfe> */
...
x86_l_202:
	...
	X86_SIM_L_EXEC_ALU_MEM_UNARY(X86_RAX, X86_WIDTH_64, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_64) | X86_MEM_AUX_ALU_OP(X86_ALU_INC)), 0ULL);
x86_l_206:
	/* 0x206: jmp    fe <generic_retkprobe_output+0xfe> */
