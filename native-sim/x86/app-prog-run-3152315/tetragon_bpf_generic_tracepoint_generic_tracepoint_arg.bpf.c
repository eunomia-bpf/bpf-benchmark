...
x86_l_12:
	/* 0x12: mov    rdi,QWORD PTR [rip+0x4b27] */
...
x86_l_28:
	/* 0x28: je     550 <generic_tracepoint_arg+0x550> */
...
x86_l_42:
	/* 0x42: mov    rdi,QWORD PTR [rip+0x4b27] */
...
x86_l_50:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_53:
	/* 0x53: je     535 <generic_tracepoint_arg+0x535> */
...
x86_l_61:
	/* 0x61: je     535 <generic_tracepoint_arg+0x535> */
...
x86_l_76:
	/* 0x76: je     4be <generic_tracepoint_arg+0x4be> */
...
x86_l_ea:
	/* 0xea: jb     4af <generic_tracepoint_arg+0x4af> */
...
x86_l_fb:
	/* 0xfb: je     4af <generic_tracepoint_arg+0x4af> */
...
x86_l_136:
	/* 0x136: ja     4be <generic_tracepoint_arg+0x4be> */
...
x86_l_145:
	/* 0x145: jne    4be <generic_tracepoint_arg+0x4be> */
...
x86_l_150:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_64, 36ULL);
x86_l_154:
	/* 0x154: ja     4af <generic_tracepoint_arg+0x4af> */
...
x86_l_172:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_64);
x86_l_176:
	/* 0x176: jae    243 <generic_tracepoint_arg+0x243> */
...
x86_l_184:
	/* 0x184: ja     4be <generic_tracepoint_arg+0x4be> */
...
x86_l_192:
	/* 0x192: jae    2e5 <generic_tracepoint_arg+0x2e5> */
...
x86_l_19e:
	/* 0x19e: jb     364 <generic_tracepoint_arg+0x364> */
	X86_SIM_X86_JCC(X86_CC_B, 0x19e, 0x364, x86_l_364);
x86_l_1a4:
	/* 0x1a4: cmp    ecx,0x6 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 6ULL);
x86_l_1a7:
	/* 0x1a7: je     4af <generic_tracepoint_arg+0x4af> */
	X86_SIM_X86_JCC(X86_CC_E, 0x1a7, 0x4af, x86_l_4af);
x86_l_1ad:
	/* 0x1ad: cmp    ecx,0xc */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 12ULL);
x86_l_1b0:
	/* 0x1b0: jne    4be <generic_tracepoint_arg+0x4be> */
...
x86_l_1c3:
	/* 0x1c3: jne    4af <generic_tracepoint_arg+0x4af> */
...
x86_l_1d1:
	/* 0x1d1: jb     4be <generic_tracepoint_arg+0x4be> */
...
x86_l_204:
	/* 0x204: jne    4af <generic_tracepoint_arg+0x4af> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x204, 0x4af, x86_l_4af);
x86_l_20a:
	/* 0x20a: jmp    4be <generic_tracepoint_arg+0x4be> */
	X86_SIM_X86_JMP(0x20a, 0x4be, x86_l_4be);
x86_l_20f:
	/* 0x20f: mov    rsi,QWORD PTR [rip+0x4b27] */
...
x86_l_234:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDX, X86_WIDTH_64, 4ULL);
x86_l_238:
	/* 0x238: jbe    13c <generic_tracepoint_arg+0x13c> */
	X86_SIM_X86_JCC(X86_CC_BE, 0x238, 0x13c, x86_l_13c);
x86_l_23e:
	/* 0x23e: jmp    4be <generic_tracepoint_arg+0x4be> */
...
x86_l_248:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_64);
x86_l_24c:
	/* 0x24c: jae    4af <generic_tracepoint_arg+0x4af> */
...
x86_l_257:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 12ULL);
x86_l_25a:
	/* 0x25a: ja     4be <generic_tracepoint_arg+0x4be> */
...
x86_l_265:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_32);
x86_l_268:
	/* 0x268: jae    3bd <generic_tracepoint_arg+0x3bd> */
...
x86_l_271:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDX, X86_WIDTH_32, 2ULL);
x86_l_274:
	/* 0x274: jb     439 <generic_tracepoint_arg+0x439> */
	X86_SIM_X86_JCC(X86_CC_B, 0x274, 0x439, x86_l_439);
x86_l_27a:
	/* 0x27a: cmp    ecx,0x6 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 6ULL);
x86_l_27d:
	/* 0x27d: je     4af <generic_tracepoint_arg+0x4af> */
	X86_SIM_X86_JCC(X86_CC_E, 0x27d, 0x4af, x86_l_4af);
x86_l_283:
	/* 0x283: cmp    ecx,0xc */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 12ULL);
x86_l_286:
	/* 0x286: jne    4be <generic_tracepoint_arg+0x4be> */
...
x86_l_299:
	/* 0x299: jne    4af <generic_tracepoint_arg+0x4af> */
...
x86_l_2a7:
	/* 0x2a7: jb     4be <generic_tracepoint_arg+0x4be> */
...
x86_l_2b2:
	/* 0x2b2: jne    4af <generic_tracepoint_arg+0x4af> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x2b2, 0x4af, x86_l_4af);
x86_l_2b8:
	/* 0x2b8: cmp    edx,0x11 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDX, X86_WIDTH_32, 17ULL);
x86_l_2bb:
	/* 0x2bb: jb     4be <generic_tracepoint_arg+0x4be> */
...
x86_l_2da:
	/* 0x2da: jne    4af <generic_tracepoint_arg+0x4af> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x2da, 0x4af, x86_l_4af);
x86_l_2e0:
	/* 0x2e0: jmp    4be <generic_tracepoint_arg+0x4be> */
...
x86_l_2ea:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_32);
x86_l_2ed:
	/* 0x2ed: jae    4be <generic_tracepoint_arg+0x4be> */
...
x86_l_302:
	/* 0x302: mov    rdi,QWORD PTR [rip+0x4b27] */
...
x86_l_315:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_318:
	/* 0x318: je     435 <generic_tracepoint_arg+0x435> */
...
x86_l_347:
	/* 0x347: je     485 <generic_tracepoint_arg+0x485> */
	X86_SIM_X86_JCC(X86_CC_E, 0x347, 0x485, x86_l_485);
x86_l_34d:
	/* 0x34d: cmp    ecx,0xa */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 10ULL);
x86_l_350:
	/* 0x350: jne    490 <generic_tracepoint_arg+0x490> */
...
x86_l_35f:
	/* 0x35f: jmp    4aa <generic_tracepoint_arg+0x4aa> */
...
x86_l_371:
	/* 0x371: je     448 <generic_tracepoint_arg+0x448> */
...
x86_l_37f:
	/* 0x37f: jb     47b <generic_tracepoint_arg+0x47b> */
...
x86_l_3b2:
	/* 0x3b2: je     448 <generic_tracepoint_arg+0x448> */
	X86_SIM_X86_JCC(X86_CC_E, 0x3b2, 0x448, x86_l_448);
x86_l_3b8:
	/* 0x3b8: jmp    47b <generic_tracepoint_arg+0x47b> */
...
x86_l_3c2:
	...
	X86_SIM_L_EXEC_BT(X86_RDX, X86_RCX, X86_WIDTH_32);
x86_l_3c5:
	/* 0x3c5: jae    4be <generic_tracepoint_arg+0x4be> */
...
x86_l_3d6:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_RAX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 4ULL);
x86_l_3da:
	/* 0x3da: mov    rdi,QWORD PTR [rip+0x4b27] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&argfilter_maps)));
x86_l_3e1:
...
x86_l_3ed:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_3f0:
	/* 0x3f0: je     435 <generic_tracepoint_arg+0x435> */
...
x86_l_41d:
	/* 0x41d: ja     4a7 <generic_tracepoint_arg+0x4a7> */
...
x86_l_42b:
	/* 0x42b: jae    497 <generic_tracepoint_arg+0x497> */
...
x86_l_433:
	/* 0x433: jmp    4a7 <generic_tracepoint_arg+0x4a7> */
	X86_SIM_X86_JMP(0x433, 0x4a7, x86_l_4a7);
x86_l_435:
	/* 0x435: xor    eax,eax */
	X86_SIM_L_EXEC_ALU_REG(X86_RAX, X86_RAX, X86_WIDTH_32, X86_ALU_XOR);
x86_l_437:
	/* 0x437: jmp    4aa <generic_tracepoint_arg+0x4aa> */
...
x86_l_446:
	/* 0x446: jne    452 <generic_tracepoint_arg+0x452> */
...
x86_l_450:
	/* 0x450: jmp    4aa <generic_tracepoint_arg+0x4aa> */
...
x86_l_45a:
	/* 0x45a: jb     47b <generic_tracepoint_arg+0x47b> */
...
x86_l_461:
	/* 0x461: je     448 <generic_tracepoint_arg+0x448> */
	X86_SIM_X86_JCC(X86_CC_E, 0x461, 0x448, x86_l_448);
x86_l_463:
	/* 0x463: cmp    esi,0x11 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RSI, X86_WIDTH_32, 17ULL);
x86_l_466:
	/* 0x466: jb     47b <generic_tracepoint_arg+0x47b> */
...
x86_l_479:
	/* 0x479: je     448 <generic_tracepoint_arg+0x448> */
...
x86_l_47e:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 6ULL);
x86_l_481:
	/* 0x481: je     4af <generic_tracepoint_arg+0x4af> */
	X86_SIM_X86_JCC(X86_CC_E, 0x481, 0x4af, x86_l_4af);
x86_l_483:
	/* 0x483: jmp    4be <generic_tracepoint_arg+0x4be> */
...
x86_l_48b:
	...
	X86_SIM_L_EXEC_MOVX_REG(X86_OP_MOVZX_REG, X86_RAX, X86_RAX, X86_WIDTH_32, X86_WIDTH_8);
x86_l_48e:
	/* 0x48e: jmp    4aa <generic_tracepoint_arg+0x4aa> */
...
x86_l_492:
	...
	X86_SIM_L_EXEC_MOVX_REG(X86_OP_MOVZX_REG, X86_RAX, X86_RAX, X86_WIDTH_32, X86_WIDTH_8);
x86_l_495:
	/* 0x495: jmp    4aa <generic_tracepoint_arg+0x4aa> */
...
x86_l_49c:
	...
	X86_SIM_L_EXEC_BT(X86_RSI, X86_RDX, X86_WIDTH_32);
x86_l_49f:
	/* 0x49f: jae    4a7 <generic_tracepoint_arg+0x4a7> */
...
x86_l_51a:
	/* 0x51a: mov    rsi,QWORD PTR [rip+0x4b23] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&tp_calls)));
x86_l_521:
	/* 0x521: mov    ecx,0x4 */
...
x86_l_533:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_535:
	/* 0x535: mov    rsi,QWORD PTR [rip+0x4b23] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&tp_calls)));
x86_l_53c:
	/* 0x53c: mov    ecx,0x5 */
...
x86_l_559:
	/* 0x559: jmp    626 <generic_tracepoint_arg+0x626> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_55e:
	/* 0x55e: xor    r15d,r15d */
...
x86_l_569:
	/* 0x569: jne    5bb <generic_tracepoint_arg+0x5bb> */
...
x86_l_579:
	/* 0x579: jne    5bb <generic_tracepoint_arg+0x5bb> */
...
x86_l_589:
	/* 0x589: jne    5bb <generic_tracepoint_arg+0x5bb> */
...
x86_l_599:
	/* 0x599: jne    5bb <generic_tracepoint_arg+0x5bb> */
...
x86_l_5a9:
	/* 0x5a9: jne    5bb <generic_tracepoint_arg+0x5bb> */
...
x86_l_5b9:
	/* 0x5b9: je     5dd <generic_tracepoint_arg+0x5dd> */
...
x86_l_5c2:
	/* 0x5c2: mov    rsi,QWORD PTR [rip+0x4b26] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&tp_calls)));
x86_l_5c9:
	/* 0x5c9: mov    ecx,0x3 */
...
x86_l_5f2:
	/* 0x5f2: mov    rdi,QWORD PTR [rip+0x4b26] */
...
x86_l_605:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_608:
	/* 0x608: je     550 <generic_tracepoint_arg+0x550> */
	X86_SIM_X86_JCC(X86_CC_E, 0x608, 0x550, x86_l_550);
x86_l_60e:
	/* 0x60e: mov    rdi,QWORD PTR [rip+0x4b26] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&retprobe_map)));
x86_l_615:
...
x86_l_61f:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_621:
	/* 0x621: jmp    550 <generic_tracepoint_arg+0x550> */
