...
SEC("xdp")
int tetragon_bpf_generic_tracepoint_v61_filter_inet_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_20d:
	/* 0x20d: mov    rdi,QWORD PTR [rip+0x16f7] */
...
x86_l_276:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_RAX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_27a:
	/* 0x27a: mov    rdi,QWORD PTR [rip+0x16f7] */
...
x86_l_34a:
	/* 0x34a: mov    rdi,QWORD PTR [rip+0xa40] */
