...
x86_l_12:
	/* 0x12: mov    rdi,QWORD PTR [rip+0x217d7] */
...
x86_l_28:
	/* 0x28: je     4fb <generic_tracepoint_output+0x4fb> */
	X86_SIM_X86_JCC(X86_CC_E, 0x28, 0x4fb, x86_l_4fb);
x86_l_2e:
	/* 0x2e: mov    r14,rax */
...
x86_l_39:
	/* 0x39: je     341 <generic_tracepoint_output+0x341> */
	X86_SIM_X86_JCC(X86_CC_E, 0x39, 0x341, x86_l_341);
x86_l_3f:
	/* 0x3f: mov    eax,0xe */
...
x86_l_5c:
	/* 0x5c: mov    rdi,QWORD PTR [rip+0x217d7] */
...
x86_l_6f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_72:
	/* 0x72: je     341 <generic_tracepoint_output+0x341> */
	X86_SIM_X86_JCC(X86_CC_E, 0x72, 0x341, x86_l_341);
x86_l_78:
	/* 0x78: mov    r15,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_R15, X86_RAX, X86_WIDTH_64);
x86_l_7b:
...
x86_l_15b:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_15d:
	/* 0x15d: mov    rcx,QWORD PTR [rsp+0x8] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RCX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_162:
	/* 0x162: test   rcx,rcx */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RCX, X86_RCX, X86_WIDTH_64);
x86_l_165:
	/* 0x165: je     1fb <generic_tracepoint_output+0x1fb> */
	X86_SIM_X86_JCC(X86_CC_E, 0x165, 0x1fb, x86_l_1fb);
x86_l_16b:
	/* 0x16b: mov    DWORD PTR [rsp+0x10],0x0 */
...
x86_l_18f:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_191:
	/* 0x191: mov    rax,QWORD PTR [rsp+0x8] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RAX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_196:
	/* 0x196: movsxd rcx,DWORD PTR [rsp+0x10] */
...
x86_l_1b3:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 4ULL);
x86_l_1b8:
	/* 0x1b8: mov    rcx,QWORD PTR [rsp+0x8] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RCX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_1bd:
	/* 0x1bd: movsxd rdx,DWORD PTR [rsp+0x10] */
...
x86_l_1db:
	/* 0x1db: mov    rcx,QWORD PTR [rsp+0x20] */
...
x86_l_1e4:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 4ULL);
x86_l_1e9:
	/* 0x1e9: mov    rdx,QWORD PTR [rsp+0x20] */
...
x86_l_1f7:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_1f9:
	/* 0x1f9: jmp    203 <generic_tracepoint_output+0x203> */
...
x86_l_2f4:
	/* 0x2f4: mov    rcx,QWORD PTR [rsp+0x18] */
...
x86_l_306:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 4ULL);
x86_l_30b:
	/* 0x30b: add    rdx,QWORD PTR [rsp+0x18] */
...
x86_l_320:
	/* 0x320: mov    rcx,QWORD PTR [rsp+0x8] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RCX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_325:
	/* 0x325: add    rcx,rdx */
	X86_SIM_L_EXEC_ALU_REG(X86_RCX, X86_RDX, X86_WIDTH_64, X86_ALU_ADD);
...
x86_l_32d:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 4ULL);
x86_l_332:
	/* 0x332: add    rdx,QWORD PTR [rsp+0x8] */
...
x86_l_33f:
	...
	X86_SIM_BPF_CALL_REG(X86_RAX);
x86_l_341:
	/* 0x341: cmp    QWORD PTR [r14+0x5ef0],0x0 */
...
x86_l_349:
	/* 0x349: je     406 <generic_tracepoint_output+0x406> */
	X86_SIM_X86_JCC(X86_CC_E, 0x349, 0x406, x86_l_406);
x86_l_34f:
	/* 0x34f: mov    eax,0xe */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 14ULL);
x86_l_354:
...
x86_l_364:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_R12, X86_RAX, X86_WIDTH_64);
x86_l_367:
	/* 0x367: mov    DWORD PTR [rsp+0x28],r15d */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RSP, X86_R15, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 40ULL);
x86_l_36c:
	/* 0x36c: mov    rdi,QWORD PTR [rip+0x217d7] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&execve_map)));
x86_l_373:
	/* 0x373: lea    rsi,[rsp+0x28] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 40ULL);
x86_l_378:
	/* 0x378: mov    eax,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
...
x86_l_37f:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_382:
	/* 0x382: je     406 <generic_tracepoint_output+0x406> */
	X86_SIM_X86_JCC(X86_CC_E, 0x382, 0x406, x86_l_406);
x86_l_388:
	/* 0x388: lea    r15,[rax+0x50] */
...
x86_l_40b:
	/* 0x40b: add    eax,DWORD PTR [r14+0x4] */
...
x86_l_441:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_444:
	/* 0x444: js     474 <generic_tracepoint_output+0x474> */
	X86_SIM_X86_JCC(X86_CC_S, 0x444, 0x474, x86_l_474);
x86_l_446:
	/* 0x446: mov    DWORD PTR [rsp+0x28],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_44e:
	/* 0x44e: mov    rdi,QWORD PTR [rip+0x217d3] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&policy_stats)));
x86_l_455:
	/* 0x455: lea    rsi,[rsp+0x28] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 40ULL);
x86_l_45a:
	/* 0x45a: mov    eax,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
...
x86_l_461:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_464:
	/* 0x464: je     4fb <generic_tracepoint_output+0x4fb> */
	X86_SIM_X86_JCC(X86_CC_E, 0x464, 0x4fb, x86_l_4fb);
x86_l_46a:
	/* 0x46a: inc QWORD PTR [rax+0x8] */
...
x86_l_46f:
	/* 0x46f: jmp    4fb <generic_tracepoint_output+0x4fb> */
	X86_SIM_X86_JMP(0x46f, 0x4fb, x86_l_4fb);
x86_l_474:
	/* 0x474: mov    rbx,rax */
	X86_SIM_L_EXEC_MOV_REG(X86_RBX, X86_RAX, X86_WIDTH_64);
x86_l_477:
	/* 0x477: mov    DWORD PTR [rsp+0x28],0x0 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 171798691840ULL);
x86_l_47f:
	/* 0x47f: mov    rdi,QWORD PTR [rip+0x217d3] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&tg_stats_map)));
x86_l_486:
	/* 0x486: lea    rsi,[rsp+0x28] */
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 40ULL);
x86_l_48b:
	/* 0x48b: mov    eax,0x1 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1ULL);
...
x86_l_492:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_495:
	/* 0x495: je     4fb <generic_tracepoint_output+0x4fb> */
	X86_SIM_X86_JCC(X86_CC_E, 0x495, 0x4fb, x86_l_4fb);
x86_l_497:
	/* 0x497: cmp    rbx,0xfffffffffffffff4 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551604ULL);
x86_l_49b:
	/* 0x49b: jg     4b7 <generic_tracepoint_output+0x4b7> */
	X86_SIM_X86_JCC(X86_CC_G, 0x49b, 0x4b7, x86_l_4b7);
x86_l_49d:
	/* 0x49d: cmp    rbx,0xffffffffffffffe4 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551588ULL);
x86_l_4a1:
	/* 0x4a1: je     4d1 <generic_tracepoint_output+0x4d1> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4a1, 0x4d1, x86_l_4d1);
x86_l_4a3:
	/* 0x4a3: cmp    rbx,0xffffffffffffffea */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551594ULL);
x86_l_4a7:
	/* 0x4a7: je     4e9 <generic_tracepoint_output+0x4e9> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4a7, 0x4e9, x86_l_4e9);
x86_l_4a9:
	/* 0x4a9: cmp    rbx,0xfffffffffffffff0 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551600ULL);
x86_l_4ad:
	/* 0x4ad: jne    4e1 <generic_tracepoint_output+0x4e1> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x4ad, 0x4e1, x86_l_4e1);
x86_l_4af:
	/* 0x4af: add    rax,0x328 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 808ULL);
x86_l_4b5:
	/* 0x4b5: jmp    4f7 <generic_tracepoint_output+0x4f7> */
	X86_SIM_X86_JMP(0x4b5, 0x4f7, x86_l_4f7);
x86_l_4b7:
	/* 0x4b7: cmp    rbx,0xfffffffffffffff5 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551605ULL);
x86_l_4bb:
	/* 0x4bb: je     4d9 <generic_tracepoint_output+0x4d9> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4bb, 0x4d9, x86_l_4d9);
x86_l_4bd:
	/* 0x4bd: cmp    rbx,0xfffffffffffffff9 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551609ULL);
x86_l_4c1:
	/* 0x4c1: je     4f1 <generic_tracepoint_output+0x4f1> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4c1, 0x4f1, x86_l_4f1);
x86_l_4c3:
	/* 0x4c3: cmp    rbx,0xfffffffffffffffe */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBX, X86_WIDTH_64, 18446744073709551614ULL);
x86_l_4c7:
	/* 0x4c7: jne    4e1 <generic_tracepoint_output+0x4e1> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x4c7, 0x4e1, x86_l_4e1);
x86_l_4c9:
	/* 0x4c9: add    rax,0x318 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 792ULL);
x86_l_4cf:
	/* 0x4cf: jmp    4f7 <generic_tracepoint_output+0x4f7> */
	X86_SIM_X86_JMP(0x4cf, 0x4f7, x86_l_4f7);
x86_l_4d1:
	/* 0x4d1: add    rax,0x338 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 824ULL);
x86_l_4d7:
	/* 0x4d7: jmp    4f7 <generic_tracepoint_output+0x4f7> */
	X86_SIM_X86_JMP(0x4d7, 0x4f7, x86_l_4f7);
x86_l_4d9:
	/* 0x4d9: add    rax,0x340 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 832ULL);
x86_l_4df:
	/* 0x4df: jmp    4f7 <generic_tracepoint_output+0x4f7> */
	X86_SIM_X86_JMP(0x4df, 0x4f7, x86_l_4f7);
x86_l_4e1:
	/* 0x4e1: add    rax,0x310 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 784ULL);
x86_l_4e7:
	/* 0x4e7: jmp    4f7 <generic_tracepoint_output+0x4f7> */
	X86_SIM_X86_JMP(0x4e7, 0x4f7, x86_l_4f7);
x86_l_4e9:
	/* 0x4e9: add    rax,0x330 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 816ULL);
x86_l_4ef:
	/* 0x4ef: jmp    4f7 <generic_tracepoint_output+0x4f7> */
	X86_SIM_X86_JMP(0x4ef, 0x4f7, x86_l_4f7);
x86_l_4f1:
	/* 0x4f1: add    rax,0x320 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 800ULL);
x86_l_4f7:
	/* 0x4f7: inc QWORD PTR [rax] */
...
x86_l_504:
	/* 0x504: jmp    509 <generic_tracepoint_output+0x509> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_509:
