...
x86_l_31:
	/* 0x31: je     32ea <generic_tracepoint_event+0x32ea> */
...
x86_l_50:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_53:
	/* 0x53: je     32ea <generic_tracepoint_event+0x32ea> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 13034ULL;
	}
x86_l_59:
...
x86_l_7e:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_81:
	/* 0x81: je     32ea <generic_tracepoint_event+0x32ea> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 13034ULL;
	}
x86_l_87:
...
x86_l_cf:
	/* 0xcf: jmp    32ea <generic_tracepoint_event+0x32ea> */
	return 13034ULL;
x86_l_d4:
	/* 0xd4: xor    ebp,ebp */
...
x86_l_169:
	/* 0x169: je     32ea <generic_tracepoint_event+0x32ea> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 13034ULL;
	}
x86_l_16f:
...
x86_l_1d1:
	/* 0x1d1: jmp    32ea <generic_tracepoint_event+0x32ea> */
	return 13034ULL;
x86_l_1d6:
	/* 0x1d6: xor    eax,eax */
...
x86_l_1dd:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_1e0:
	/* 0x1e0: je     32ea <generic_tracepoint_event+0x32ea> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 13034ULL;
	}
x86_l_1e6:
...
x86_l_238:
	/* 0x238: mov    DWORD PTR [r14+0x5ee8],0x0 */
...
x86_l_472:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_475:
	/* 0x475: je     32ea <generic_tracepoint_event+0x32ea> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 13034ULL;
	}
x86_l_47b:
...
x86_l_496:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_499:
	/* 0x499: je     32ea <generic_tracepoint_event+0x32ea> */
	if (X86_SIM_L_EVAL_CC(X86_CC_E)) {
		return 13034ULL;
	}
x86_l_49f:
...
x86_l_4ae:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_4b1:
	/* 0x4b1: jne    32ea <generic_tracepoint_event+0x32ea> */
	if (X86_SIM_L_EVAL_CC(X86_CC_NE)) {
		return 13034ULL;
	}
x86_l_4b7:
...
x86_l_2f3a:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 14ULL);
x86_l_2f3e:
	/* 0x2f3e: mov    QWORD PTR [r14+0x5eec],0x0 */
...
x86_l_32cf:
	/* 0x32cf: mov    rsi,QWORD PTR [rip+0x0] */
...
x86_l_32f6:
	/* 0x32f6: jmp    32fb <generic_tracepoint_event+0x32fb> ; native-link entry RET */
...
int tetragon_bpf_generic_tracepoint_generic_tracepoint_event_x86_sim_xdp(struct xdp_md *ctx)
{
	...
	__u64 __x86_pc = 0ULL;
	for (__u32 __x86_iter = 0; __x86_iter < 10964U; __x86_iter++) {
		...
		else if (__x86_pc >= 12830ULL && __x86_pc <= 13046ULL)
