...
x86_l_4a:
	/* 0x4a: jne    6e <sched_wakeup+0x6e> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x4a, 0x6e, x86_l_6e);
x86_l_4c:
	/* 0x4c: call   51 <sched_wakeup+0x51> */
...
x86_l_69:
	/* 0x69: call   6e <sched_wakeup+0x6e> */
...
x86_l_74:
	/* 0x74: jmp    79 <sched_wakeup+0x79> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_79:
