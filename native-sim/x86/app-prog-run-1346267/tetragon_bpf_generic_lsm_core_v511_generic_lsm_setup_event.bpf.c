...
x86_l_25:
	/* 0x25: je     197 <generic_lsm_setup_event+0x197> */
	X86_SIM_X86_JCC(X86_CC_E, 0x25, 0x197, x86_l_197);
x86_l_2b:
	/* 0x2b: mov    r14,rax */
...
x86_l_43:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_46:
	/* 0x46: je     197 <generic_lsm_setup_event+0x197> */
	X86_SIM_X86_JCC(X86_CC_E, 0x46, 0x197, x86_l_197);
x86_l_4c:
	/* 0x4c: mov    eax,0x71 */
...
x86_l_144:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_147:
	/* 0x147: je     16b <generic_lsm_setup_event+0x16b> */
	X86_SIM_X86_JCC(X86_CC_E, 0x147, 0x16b, x86_l_16b);
x86_l_149:
	/* 0x149: add    rax,0x5ef8 */
...
x86_l_160:
	...
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_163:
	/* 0x163: je     16b <generic_lsm_setup_event+0x16b> */
	X86_SIM_X86_JCC(X86_CC_E, 0x163, 0x16b, x86_l_16b);
x86_l_165:
	/* 0x165: cmp    DWORD PTR [rax+0x40],0xffffffff */
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 279172874239ULL);
x86_l_169:
	/* 0x169: jne    181 <generic_lsm_setup_event+0x181> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x169, 0x181, x86_l_181);
x86_l_16b:
	/* 0x16b: mov    eax,0xc */
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 12ULL);
x86_l_170:
	/* 0x170: mov    rsi,QWORD PTR [rip+0x0] */
...
x86_l_181:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 12ULL);
x86_l_186:
	/* 0x186: mov    rsi,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RSI, (void *)(long)(((__u64)(long)&lsm_calls)));
x86_l_18d:
	/* 0x18d: mov    rdi,rbx */
	X86_SIM_L_EXEC_MOV_REG(X86_RDI, X86_RBX, X86_WIDTH_64);
...
x86_l_19d:
	/* 0x19d: jmp    1a2 <generic_lsm_setup_event+0x1a2> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_1a2:
