...
SEC("xdp")
int cilium_bpf_lxc_tail_no_service_ipv4_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_179:
	/* 0x179: mov    rdi,QWORD PTR [rip+0x16f7] */
...
x86_l_1a8:
	/* 0x1a8: mov    rdi,QWORD PTR [rip+0x16f7] */
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, (void *)(long)(((__u64)(long)&cilium_metrics)));
x86_l_1af:
...
x86_l_1c2:
	/* 0x1c2: mov    rsi,QWORD PTR [rip+0x16f7] */
