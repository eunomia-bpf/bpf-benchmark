...
x86_l_16:
	/* 0x16: call   1b <tracepoint__syscalls__sys_exit_openat+0x1b> */
	X86_SIM_L_EXEC_CALL_MEMSET(312ULL);
x86_l_1b:
	/* 0x1b: call   20 <tracepoint__syscalls__sys_exit_openat+0x20> */
...
x86_l_30:
	/* 0x30: call   35 <tracepoint__syscalls__sys_exit_openat+0x35> */
	X86_SIM_BPF_CALL_ID(X86_SIM_HELPER_bpf_map_lookup_elem);
x86_l_35:
	/* 0x35: test   rax,rax */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_38:
	/* 0x38: je     f9 <tracepoint__syscalls__sys_exit_openat+0xf9> */
...
x86_l_67:
	/* 0x67: call   6c <tracepoint__syscalls__sys_exit_openat+0x6c> */
...
x86_l_7a:
	/* 0x7a: call   7f <tracepoint__syscalls__sys_exit_openat+0x7f> */
...
x86_l_8c:
	/* 0x8c: call   91 <tracepoint__syscalls__sys_exit_openat+0x91> */
...
x86_l_b0:
	/* 0xb0: call   b5 <tracepoint__syscalls__sys_exit_openat+0xb5> */
...
x86_l_e0:
	...
	X86_SIM_L_EXEC_MOV_REG(X86_RDI, X86_RBX, X86_WIDTH_64);
x86_l_e3:
	/* 0xe3: call   e8 <tracepoint__syscalls__sys_exit_openat+0xe8> */
...
x86_l_ef:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 12ULL);
x86_l_f4:
	/* 0xf4: call   f9 <tracepoint__syscalls__sys_exit_openat+0xf9> */
...
x86_l_102:
	/* 0x102: jmp    107 <tracepoint__syscalls__sys_exit_openat+0x107> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_107:
