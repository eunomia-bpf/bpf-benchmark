...
x86_l_11:
	/* 0x11: je     26 <handle_sched_wakeup_new+0x26> */
...
x86_l_1c:
	/* 0x1c: call   21 <handle_sched_wakeup_new+0x21> */
	X86_SIM_BPF_CALL_ID(X86_SIM_HELPER_bpf_current_task_under_cgroup);
x86_l_21:
	/* 0x21: test   rax,rax */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RAX, X86_RAX, X86_WIDTH_64);
x86_l_24:
	/* 0x24: je     9b <handle_sched_wakeup_new+0x9b> */
...
x86_l_37:
	/* 0x37: call   3c <handle_sched_wakeup_new+0x3c> */
...
x86_l_55:
	/* 0x55: call   5a <handle_sched_wakeup_new+0x5a> */
	X86_SIM_BPF_CALL_ID(X86_SIM_HELPER_bpf_probe_read_kernel);
x86_l_5a:
...
x86_l_64:
	/* 0x64: je     9b <handle_sched_wakeup_new+0x9b> */
...
x86_l_70:
	/* 0x70: je     79 <handle_sched_wakeup_new+0x79> */
...
x86_l_a1:
	/* 0xa1: jmp    a6 <handle_sched_wakeup_new+0xa6> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_a6:
