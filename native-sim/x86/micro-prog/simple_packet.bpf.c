...
x86_l_f:
	/* 0xf: ja     0x38 */
	X86_SIM_X86_JCC(X86_CC_A, 0xf, 0x38, x86_l_38);
x86_l_11:
	/* 0x11: add    rsi,0x8 */
...
x86_l_18:
	/* 0x18: ja     0x38 */
	X86_SIM_X86_JCC(X86_CC_A, 0x18, 0x38, x86_l_38);
x86_l_1a:
	/* 0x1a: push   rbp */
...
x86_l_38:
	/* 0x38: jmp    0x3d ; native-link entry RET */
	X86_SIM_X86_RET();
