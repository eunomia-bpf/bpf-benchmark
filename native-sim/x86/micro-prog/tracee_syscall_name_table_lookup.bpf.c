...
x86_l_1f:
	...
	X86_SIM_L_EXEC_LEA(X86_R8, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 268ULL);
x86_l_26:
	/* 0x26: cmp    r8,rsi */
...
x86_l_2b:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 64ULL);
x86_l_2e:
...
x86_l_3a:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RDI, X86_WIDTH_64, 7640891576956012809ULL);
x86_l_44:
	/* 0x44: movabs r13,0x65736f6c63 */
	X86_SIM_L_EXEC_MOV_IMM(X86_R13, X86_WIDTH_64, 435728378979ULL);
x86_l_4e:
	/* 0x4e: xor    r9d,r9d */
	X86_SIM_L_EXEC_ALU_REG(X86_R9, X86_R9, X86_WIDTH_32, X86_ALU_XOR);
x86_l_51:
	/* 0x51: lea    r8,[r13+0xfa0614] */
	X86_SIM_L_EXEC_LEA(X86_R8, X86_R13, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 16385556ULL);
x86_l_58:
	/* 0x58: movabs r14,0x74616e65706f */
	X86_SIM_L_EXEC_MOV_IMM(X86_R14, X86_WIDTH_64, 127961812791407ULL);
x86_l_62:
	/* 0x62: movabs r10,0x74616b6e696c6e75 */
	X86_SIM_L_EXEC_MOV_IMM(X86_R10, X86_WIDTH_64, 8386102103099862645ULL);
x86_l_6c:
	/* 0x6c: movabs r11,0x74613274617473 */
	X86_SIM_L_EXEC_MOV_IMM(X86_R11, X86_WIDTH_64, 32757966627239027ULL);
x86_l_76:
	/* 0x76: movabs rbx,0x647466656e676973 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RBX, X86_WIDTH_64, 7238523086921230707ULL);
x86_l_80:
	/* 0x80: movzx  r15d,BYTE PTR [rdx+r9*4+0xc] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R15, X86_RDX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_R9, 2, X86_WIDTH_8), 12ULL);
x86_l_86:
	/* 0x86: movzx  eax,BYTE PTR [rdx+r9*4+0xd] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RAX, X86_RDX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_R9, 2, X86_WIDTH_8), 13ULL);
x86_l_8c:
	/* 0x8c: shl    eax,0x8 */
...
x86_l_92:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R12, X86_RDX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_R9, 2, X86_WIDTH_16), 14ULL);
x86_l_98:
	/* 0x98: shl    r12d,0x10 */
...
x86_l_9f:
	/* 0x9f: cmp    r12d,0x4f */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R12, X86_WIDTH_32, 79ULL);
x86_l_a3:
...
x86_l_110:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_64, 461413903445ULL);
x86_l_11a:
...
x86_l_13d:
	/* 0x13d: cmp    r12d,0x39 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R12, X86_WIDTH_32, 57ULL);
x86_l_141:
...
x86_l_147:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1802661734ULL);
x86_l_14c:
	/* 0x14c: jmp    2c1 <tracee_syscall_name_table_lookup_xdp+0x2c1> */
	X86_SIM_X86_JMP(0x14c, 0x2c1, x86_l_2c1);
x86_l_151:
	/* 0x151: cmp    r12d,0x122 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R12, X86_WIDTH_32, 290ULL);
x86_l_158:
...
x86_l_15e:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R12, X86_WIDTH_32, 257ULL);
x86_l_165:
...
x86_l_16b:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R12, X86_WIDTH_32, 263ULL);
x86_l_172:
...
x86_l_178:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R12, X86_WIDTH_32, 281ULL);
x86_l_17f:
...
x86_l_1df:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_64, 110382294525287ULL);
x86_l_1e9:
	/* 0x1e9: jmp    2c1 <tracee_syscall_name_table_lookup_xdp+0x2c1> */
	X86_SIM_X86_JMP(0x1e9, 0x2c1, x86_l_2c1);
x86_l_1ee:
	/* 0x1ee: cmp    r12d,0x3b */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R12, X86_WIDTH_32, 59ULL);
x86_l_1f2:
...
x86_l_1fe:
	/* 0x1fe: cmp    r12d,0x3d */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R12, X86_WIDTH_32, 61ULL);
x86_l_202:
...
x86_l_208:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_64, 57674588845909ULL);
x86_l_212:
	/* 0x212: jmp    2c1 <tracee_syscall_name_table_lookup_xdp+0x2c1> */
	X86_SIM_X86_JMP(0x212, 0x2c1, x86_l_2c1);
x86_l_217:
	/* 0x217: cmp    r12d,0x123 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R12, X86_WIDTH_32, 291ULL);
x86_l_21e:
...
x86_l_224:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R12, X86_WIDTH_32, 321ULL);
x86_l_22b:
...
x86_l_22d:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R12, X86_WIDTH_32, 332ULL);
x86_l_234:
...
x86_l_23a:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 2020893043ULL);
x86_l_23f:
...
x86_l_249:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_64, 118121959288437ULL);
x86_l_253:
...
x86_l_255:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_64, 111524990182229ULL);
x86_l_25f:
...
x86_l_266:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_32, 1885433197ULL);
x86_l_26b:
...
x86_l_295:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_64, 431265707111ULL);
x86_l_29f:
...
x86_l_2a6:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_64, 7814980514819043937ULL);
x86_l_2b0:
...
x86_l_2b2:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_64, 111559148140645ULL);
x86_l_2bc:
...
x86_l_2c4:
	/* 0x2c4: xor    r12,rax */
	X86_SIM_L_EXEC_ALU_REG(X86_R12, X86_RAX, X86_WIDTH_64, X86_ALU_XOR);
x86_l_2c7:
	/* 0x2c7: mov    esi,r9d */
...
x86_l_2cd:
	...
	X86_SIM_L_EXEC_LEA(X86_RBP, X86_RSI, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 1ULL);
x86_l_2d0:
...
x86_l_2e4:
	/* 0x2e4: shl    esi,0x3 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RSI, X86_WIDTH_32, X86_ALU_SHL, 3ULL);
x86_l_2e7:
...
x86_l_2f2:
	/* 0x2f2: cmp    r9,0x40 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R9, X86_WIDTH_64, 64ULL);
x86_l_2f6:
...
x86_l_301:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RSI, X86_WIDTH_64, 11400714785074694791ULL);
x86_l_30b:
	/* 0x30b: imul   rax,rsi */
	X86_SIM_L_EXEC_ALU_REG(X86_RAX, X86_RSI, X86_WIDTH_64, X86_ALU_IMUL);
x86_l_30f:
	/* 0x30f: xor    rdi,rax */
	X86_SIM_L_EXEC_ALU_REG(X86_RDI, X86_RAX, X86_WIDTH_64, X86_ALU_XOR);
x86_l_312:
...
x86_l_31f:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RCX, X86_RDI, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_322:
	/* 0x322: mov    eax,0x2 */
