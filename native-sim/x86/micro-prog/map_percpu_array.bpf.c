...
SEC("xdp")
int map_percpu_array_x86_sim_xdp(struct xdp_md *ctx)
{
...
x86_l_11:
	/* 0x11: ja     68 <map_percpu_array+0x68> */
	X86_SIM_X86_JCC(X86_CC_A, 0x11, 0x68, x86_l_68);
x86_l_13:
	/* 0x13: mov    DWORD PTR [rsp+0xc],0x2 */
	X86_SIM_RUN_OP(X86_OP_MOV_STORE_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 51539607554ULL);
x86_l_1b:
	/* 0x1b: movabs rax,0xfeedfacecafebabe */
	X86_SIM_RUN_OP(X86_OP_MOV_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_64, 0, 18369614221190019774ULL);
x86_l_25:
...
x86_l_2a:
	...
	X86_SIM_RUN_OP(X86_OP_MOV_LOAD_MAP_PTR, X86_RBX, X86_REG_NONE, X86_WIDTH_64, 0, ((__u64)(long)&test_percpu));
x86_l_31:
	/* 0x31: xor    r13d,r13d */
...
x86_l_5b:
	/* 0x5b: je     60 <map_percpu_array+0x60> */
...
x86_l_6c:
	/* 0x6c: jmp    71 <map_percpu_array+0x71> ; native-link entry RET */
	X86_SIM_X86_RET();
x86_l_71:
