...
x86_l_1f:
	...
	X86_SIM_RUN_OP(X86_OP_LEA, X86_RDI, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 784ULL);
x86_l_26:
	/* 0x26: cmp    rdi,rsi */
	X86_SIM_RUN_OP(X86_OP_CMP_REG, X86_RDI, X86_RSI, X86_WIDTH_64, 0, 0);
x86_l_29:
...
x86_l_31:
	...
	X86_SIM_RUN_OP(X86_OP_CMP_MEM_IMM, X86_RDX, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 51539607576ULL);
x86_l_35:
...
x86_l_3a:
	/* 0x3a: add    rdx,0x27 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RDX, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 39ULL);
x86_l_3e:
...
x86_l_48:
	/* 0x48: mov    eax,0x300 */
	X86_SIM_RUN_OP(X86_OP_MOV_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 768ULL);
x86_l_4d:
	/* 0x4d: xor    esi,esi */
...
x86_l_5e:
	...
	X86_SIM_RUN_OP(X86_OP_MOV_LOAD, X86_R11, X86_RDX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_16), 18446744073709551615ULL);
x86_l_63:
	/* 0x63: lea    ebx,[rdi*4+0x0] */
	X86_SIM_RUN_OP(X86_OP_LEA, X86_RBX, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_RDI, 2), 0ULL);
x86_l_6a:
	/* 0x6a: and    bl,0x1c */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_8, X86_ALU_AND, 28ULL);
x86_l_6d:
	/* 0x6d: shlx   r9,r9,rbx */
...
x86_l_75:
	/* 0x75: mov    r10d,esi */
	X86_SIM_RUN_OP(X86_OP_MOV_REG, X86_R10, X86_RSI, X86_WIDTH_32, 0, 0);
x86_l_78:
	/* 0x78: and    r10b,0x18 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_R10, X86_REG_NONE, X86_WIDTH_8, X86_ALU_AND, 24ULL);
x86_l_7c:
...
x86_l_84:
	/* 0x84: and    edi,0x7 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, X86_ALU_AND, 7ULL);
x86_l_87:
	/* 0x87: xor    edi,r8d */
...
x86_l_a6:
	...
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 18446744073709551592ULL);
x86_l_aa:
...
x86_l_ac:
	...
	X86_SIM_RUN_OP(X86_OP_MOV_LOAD, X86_R8, X86_RDX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 18446744073709551593ULL);
x86_l_b1:
	/* 0xb1: and    r8d,0x3 */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_32, X86_ALU_AND, 3ULL);
x86_l_b5:
	/* 0xb5: lea    rdi,[r8+0x18] */
	X86_SIM_RUN_OP(X86_OP_LEA, X86_RDI, X86_R8, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 24ULL);
x86_l_b9:
	/* 0xb9: cmp    rax,rdi */
	X86_SIM_RUN_OP(X86_OP_CMP_REG, X86_RAX, X86_RDI, X86_WIDTH_64, 0, 0);
x86_l_bc:
...
x86_l_be:
	...
	X86_SIM_RUN_OP(X86_OP_MOV_LOAD, X86_RDI, X86_RDX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 18446744073709551594ULL);
x86_l_c2:
	/* 0xc2: mov    r14d,DWORD PTR [rdx-0x13] */
	X86_SIM_RUN_OP(X86_OP_MOV_LOAD, X86_R14, X86_RDX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551597ULL);
x86_l_c6:
	/* 0xc6: mov    ebx,DWORD PTR [rdx-0xf] */
	X86_SIM_RUN_OP(X86_OP_MOV_LOAD, X86_RBX, X86_RDX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551601ULL);
x86_l_c9:
	/* 0xc9: mov    r11d,DWORD PTR [rdx-0xb] */
	X86_SIM_RUN_OP(X86_OP_MOV_LOAD, X86_R11, X86_RDX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551605ULL);
x86_l_cd:
	/* 0xcd: movzx  r10d,WORD PTR [rdx-0x3] */
	X86_SIM_RUN_OP(X86_OP_MOV_LOAD, X86_R10, X86_RDX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_16), 18446744073709551613ULL);
x86_l_d2:
	/* 0xd2: add    r14,r9 */
...
x86_l_d8:
	/* 0xd8: add    r10,r14 */
	X86_SIM_RUN_OP(X86_OP_ALU_REG, X86_R10, X86_R14, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_db:
	/* 0xdb: mov    r9d,DWORD PTR [rdx-0x7] */
	X86_SIM_RUN_OP(X86_OP_MOV_LOAD, X86_R9, X86_RDX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551609ULL);
x86_l_df:
	/* 0xdf: test   dil,0x1 */
	X86_SIM_RUN_OP(X86_OP_TEST_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_8, 0, 1ULL);
x86_l_e3:
...
x86_l_f8:
	...
	X86_SIM_RUN_OP(X86_OP_MOV_STORE_REG, X86_RCX, X86_R9, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_fb:
	/* 0xfb: mov    eax,0x2 */
