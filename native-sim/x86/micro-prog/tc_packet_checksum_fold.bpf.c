...
x86_l_7f:
	/* 0x7f: movzx  r9d,WORD PTR [rax+rcx*2+0x10] */
	X86_SIM_RUN_OP(X86_OP_MOV_LOAD, X86_R9, X86_RAX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_RCX, 1, X86_WIDTH_16), 16ULL);
x86_l_85:
	/* 0x85: add    r9d,r8d */
...
x86_l_90:
	...
	X86_SIM_RUN_OP(X86_OP_ALU_REG, X86_R9, X86_R8, X86_WIDTH_32, X86_ALU_ADD, 0);
x86_l_93:
	/* 0x93: movzx  r8d,WORD PTR [rax+rcx*2+0x12] */
	X86_SIM_RUN_OP(X86_OP_MOV_LOAD, X86_R8, X86_RAX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_RCX, 1, X86_WIDTH_16), 18ULL);
x86_l_99:
	/* 0x99: add    r8d,r9d */
...
x86_l_ce:
	/* 0xce: inc    esi */
	X86_SIM_RUN_OP(X86_OP_ALU_IMM, X86_RSI, X86_REG_NONE, X86_WIDTH_32, X86_ALU_INC, 1);
x86_l_d0:
	/* 0xd0: cmp    esi,0x20 */
