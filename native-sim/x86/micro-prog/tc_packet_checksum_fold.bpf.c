...
x86_l_32:
	...
	X86_SIM_L_EXEC_LEA(X86_RDX, X86_RAX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 1040ULL);
x86_l_39:
	/* 0x39: cmp    rdx,rsi */
...
x86_l_52:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 34359738400ULL);
x86_l_56:
...
x86_l_58:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 51539608064ULL);
x86_l_5f:
...
x86_l_6a:
	/* 0x6a: add    rcx,0x408 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RCX, X86_WIDTH_64, X86_ALU_ADD, 1032ULL);
x86_l_71:
	/* 0x71: cmp    rcx,rdx */
...
x86_l_7f:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R9, X86_RAX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_RSI, 1, X86_WIDTH_16), 16ULL);
x86_l_85:
	/* 0x85: add    r9d,r8d */
...
x86_l_93:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R8, X86_RAX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_RSI, 1, X86_WIDTH_16), 18ULL);
x86_l_99:
	/* 0x99: add    r8d,r9d */
...
x86_l_a7:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R9, X86_RAX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_RSI, 1, X86_WIDTH_16), 20ULL);
x86_l_ad:
	/* 0xad: add    r9d,r8d */
	X86_SIM_L_EXEC_ALU_REG(X86_R9, X86_R8, X86_WIDTH_32, X86_ALU_ADD);
x86_l_b0:
...
x86_l_bb:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R8, X86_RAX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_RSI, 1, X86_WIDTH_16), 22ULL);
x86_l_c1:
	/* 0xc1: add    r8d,r9d */
	X86_SIM_L_EXEC_ALU_REG(X86_R8, X86_R9, X86_WIDTH_32, X86_ALU_ADD);
x86_l_c4:
...
x86_l_d3:
	/* 0xd3: cmp    rsi,0x200 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RSI, X86_WIDTH_64, 512ULL);
x86_l_da:
...
x86_l_f6:
	/* 0xf6: xor    rcx,rsi */
	X86_SIM_L_EXEC_ALU_REG(X86_RCX, X86_RSI, X86_WIDTH_64, X86_ALU_XOR);
x86_l_f9:
	/* 0xf9: inc    edx */
