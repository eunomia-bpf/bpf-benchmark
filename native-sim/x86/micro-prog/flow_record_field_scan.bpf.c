...
x86_l_39:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_R8, X86_WIDTH_64, 11400714819323198485ULL);
x86_l_43:
	/* 0x43: xor    eax,eax */
	X86_SIM_L_EXEC_ALU_REG(X86_RAX, X86_RAX, X86_WIDTH_32, X86_ALU_XOR);
x86_l_45:
...
x86_l_4c:
	/* 0x4c: and    r8b,0x7 */
	X86_SIM_L_EXEC_ALU_IMM(X86_R8, X86_WIDTH_8, X86_ALU_AND, 7ULL);
x86_l_50:
	/* 0x50: shrx   r8,r10,r8 */
	X86_SIM_RUN_OP(X86_OP_SHIFTX, X86_R8, X86_R10, X86_WIDTH_64, X86_R8, X86_ALU_SHR);
x86_l_55:
	/* 0x55: xor    r9,r8 */
	X86_SIM_L_EXEC_ALU_REG(X86_R9, X86_R8, X86_WIDTH_64, X86_ALU_XOR);
x86_l_58:
	/* 0x58: add    r9,r11 */
...
x86_l_5e:
	/* 0x5e: and    r8b,0x18 */
	X86_SIM_L_EXEC_ALU_IMM(X86_R8, X86_WIDTH_8, X86_ALU_AND, 24ULL);
x86_l_62:
	/* 0x62: shlx   r8,rdi,r8 */
	X86_SIM_RUN_OP(X86_OP_SHIFTX, X86_R8, X86_RDI, X86_WIDTH_64, X86_R8, X86_ALU_SHL);
x86_l_67:
	/* 0x67: xor    r8,r9 */
	X86_SIM_L_EXEC_ALU_REG(X86_R8, X86_R9, X86_WIDTH_64, X86_ALU_XOR);
x86_l_6a:
	/* 0x6a: and    dil,0x7 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RDI, X86_WIDTH_8, X86_ALU_AND, 7ULL);
x86_l_6e:
	/* 0x6e: lea    r9d,[rdi+0x1] */
	X86_SIM_L_EXEC_LEA(X86_R9, X86_RDI, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 1ULL);
x86_l_72:
	/* 0x72: shlx   rbx,r8,r9 */
...
x86_l_7f:
	/* 0x7f: or     r8,rbx */
	X86_SIM_L_EXEC_ALU_REG(X86_R8, X86_RBX, X86_WIDTH_64, X86_ALU_OR);
x86_l_82:
	/* 0x82: inc    rsi */
...
x86_l_8f:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R10, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_RAX, 2), 32ULL);
x86_l_94:
	/* 0x94: mov    rbx,QWORD PTR [rdx+rax*4+0x18] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RBX, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_RAX, 2), 24ULL);
x86_l_99:
	/* 0x99: add    rbx,r10 */
	X86_SIM_L_EXEC_ALU_REG(X86_RBX, X86_R10, X86_WIDTH_64, X86_ALU_ADD);
x86_l_9c:
	/* 0x9c: mov    edi,DWORD PTR [rdx+rax*4+0x28] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDI, X86_RDX, X86_WIDTH_32, X86_MEM_AUX(X86_RAX, 2), 40ULL);
x86_l_a0:
	/* 0xa0: shl    rdi,0x20 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RDI, X86_WIDTH_64, X86_ALU_SHL, 32ULL);
x86_l_a4:
	/* 0xa4: mov    r9d,DWORD PTR [rdx+rax*4+0x2c] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R9, X86_RDX, X86_WIDTH_32, X86_MEM_AUX(X86_RAX, 2), 44ULL);
x86_l_a9:
	/* 0xa9: or     r9,rdi */
	X86_SIM_L_EXEC_ALU_REG(X86_R9, X86_RDI, X86_WIDTH_64, X86_ALU_OR);
x86_l_ac:
	/* 0xac: mov    edi,DWORD PTR [rdx+rax*4+0x10] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDI, X86_RDX, X86_WIDTH_32, X86_MEM_AUX(X86_RAX, 2), 16ULL);
x86_l_b0:
	/* 0xb0: mov    r11,rdi */
	X86_SIM_L_EXEC_MOV_REG(X86_R11, X86_RDI, X86_WIDTH_64);
x86_l_b3:
	/* 0xb3: shl    r11,0x10 */
	X86_SIM_L_EXEC_ALU_IMM(X86_R11, X86_WIDTH_64, X86_ALU_SHL, 16ULL);
x86_l_b7:
	/* 0xb7: movzx  r14d,WORD PTR [rdx+rax*4+0x14] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R14, X86_RDX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_RAX, 2, X86_WIDTH_16), 20ULL);
x86_l_bd:
	/* 0xbd: or     r11,r14 */
	X86_SIM_L_EXEC_ALU_REG(X86_R11, X86_R14, X86_WIDTH_64, X86_ALU_OR);
x86_l_c0:
	/* 0xc0: xor    r11,rbx */
	X86_SIM_L_EXEC_ALU_REG(X86_R11, X86_RBX, X86_WIDTH_64, X86_ALU_XOR);
x86_l_c3:
	/* 0xc3: add    r11,r8 */
...
x86_l_d0:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R8, X86_RDX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_RAX, 2, X86_WIDTH_16), 22ULL);
x86_l_d6:
	/* 0xd6: add    r9,r8 */
	X86_SIM_L_EXEC_ALU_REG(X86_R9, X86_R8, X86_WIDTH_64, X86_ALU_ADD);
x86_l_d9:
	/* 0xd9: xor    r9,r11 */
	X86_SIM_L_EXEC_ALU_REG(X86_R9, X86_R11, X86_WIDTH_64, X86_ALU_XOR);
x86_l_dc:
	/* 0xdc: jmp    5b <flow_record_field_scan_xdp+0x5b> */
	X86_SIM_X86_JMP(0xdc, 0x5b, x86_l_5b);
x86_l_e1:
	/* 0xe1: mov    BYTE PTR [rcx],r8b */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RCX, X86_R8, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_e4:
