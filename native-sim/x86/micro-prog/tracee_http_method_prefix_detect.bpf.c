...
x86_l_110f:
	/* 0x110f: jbe    1112 <tracee_http_method_prefix_detect_xdp+0x12> */
...
x86_l_113e:
	/* 0x113e: movabs rbx,0xa0761d6478bd642f */
...
x86_l_1153:
	/* 0x1153: movzx  edi,BYTE PTR [rsi-0x6] */
...
x86_l_1157:
	/* 0x1157: movzx  r8d,BYTE PTR [rsi-0x5] */
...
x86_l_115f:
	...
	X86_SIM_X86_JCC(X86_CC_G, 0x115f, 0x11b0, x86_l_11b0);
x86_l_1161:
	/* 0x1161: cmp    edi,0x44 */
...
x86_l_1164:
	...
	X86_SIM_X86_JCC(X86_CC_E, 0x1164, 0x120f, x86_l_120f);
x86_l_116a:
	/* 0x116a: cmp    edi,0x47 */
	X86_SIM_RUN_OP(X86_OP_CMP_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, 0, 71ULL);
x86_l_116d:
	/* 0x116d: jne    12e0 <tracee_http_method_prefix_detect_xdp+0x1e0> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x116d, 0x12e0, x86_l_12e0);
x86_l_1173:
	/* 0x1173: cmp    r8b,0x45 */
...
x86_l_1177:
	...
	X86_SIM_X86_JCC(X86_CC_NE, 0x1177, 0x12e0, x86_l_12e0);
x86_l_117d:
	/* 0x117d: mov    r8b,0x45 */
	X86_SIM_RUN_OP(X86_OP_MOV_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_8, 0, 69ULL);
x86_l_1180:
	/* 0x1180: cmp    BYTE PTR [rsi-0x4],0x54 */
...
x86_l_1191:
	...
	X86_SIM_X86_JCC(X86_CC_NE, 0x1191, 0x12e0, x86_l_12e0);
x86_l_1197:
	/* 0x1197: mov    r9d,0x1 */
...
x86_l_119d:
	...
	X86_SIM_X86_JMP(0x119d, 0x12ab, x86_l_12ab);
x86_l_11a2:
...
x86_l_11b7:
	...
	X86_SIM_X86_JCC(X86_CC_E, 0x11b7, 0x1261, x86_l_1261);
x86_l_11bd:
	/* 0x11bd: cmp    edi,0x50 */
...
x86_l_11c0:
	...
	X86_SIM_X86_JCC(X86_CC_NE, 0x11c0, 0x12e0, x86_l_12e0);
x86_l_11c6:
	/* 0x11c6: cmp    r9d,0x55 */
...
x86_l_11ca:
	...
	X86_SIM_X86_JCC(X86_CC_E, 0x11ca, 0x1293, x86_l_1293);
x86_l_11d0:
	/* 0x11d0: cmp    r9d,0x4f */
...
x86_l_11d4:
	...
	X86_SIM_X86_JCC(X86_CC_NE, 0x11d4, 0x12e0, x86_l_12e0);
x86_l_11da:
	/* 0x11da: mov    r8b,0x4f */
	X86_SIM_RUN_OP(X86_OP_MOV_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_8, 0, 79ULL);
x86_l_11dd:
	/* 0x11dd: cmp    BYTE PTR [rsi-0x4],0x53 */
...
x86_l_11e1:
	...
	X86_SIM_X86_JCC(X86_CC_NE, 0x11e1, 0x12e0, x86_l_12e0);
x86_l_11e7:
	/* 0x11e7: cmp    BYTE PTR [rsi-0x3],0x54 */
...
x86_l_11f8:
	...
	X86_SIM_X86_JCC(X86_CC_NE, 0x11f8, 0x12e0, x86_l_12e0);
x86_l_11fe:
	/* 0x11fe: mov    r9d,0x2 */
...
x86_l_120a:
	...
	X86_SIM_X86_JMP(0x120a, 0x12f0, x86_l_12f0);
x86_l_120f:
	/* 0x120f: cmp    r8b,0x45 */
	X86_SIM_RUN_OP(X86_OP_CMP_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_8, 0, 69ULL);
x86_l_1213:
	/* 0x1213: jne    12e0 <tracee_http_method_prefix_detect_xdp+0x1e0> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x1213, 0x12e0, x86_l_12e0);
x86_l_1219:
	/* 0x1219: mov    r8b,0x45 */
	X86_SIM_RUN_OP(X86_OP_MOV_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_8, 0, 69ULL);
x86_l_121c:
	/* 0x121c: cmp    BYTE PTR [rsi-0x4],0x4c */
...
x86_l_1220:
	...
	X86_SIM_X86_JCC(X86_CC_NE, 0x1220, 0x12e0, x86_l_12e0);
x86_l_1226:
	/* 0x1226: cmp    BYTE PTR [rsi-0x3],0x45 */
...
x86_l_122a:
	...
	X86_SIM_X86_JCC(X86_CC_NE, 0x122a, 0x12e0, x86_l_12e0);
x86_l_1230:
	/* 0x1230: cmp    BYTE PTR [rsi-0x2],0x54 */
...
x86_l_1234:
	...
	X86_SIM_X86_JCC(X86_CC_NE, 0x1234, 0x12e0, x86_l_12e0);
x86_l_123a:
	/* 0x123a: cmp    BYTE PTR [rsi-0x1],0x45 */
...
x86_l_124a:
	...
	X86_SIM_X86_JCC(X86_CC_NE, 0x124a, 0x12e0, x86_l_12e0);
x86_l_1250:
	/* 0x1250: mov    r9d,0x4 */
...
x86_l_125c:
	...
	X86_SIM_X86_JMP(0x125c, 0x12f0, x86_l_12f0);
x86_l_1261:
	/* 0x1261: cmp    r9d,0x54 */
...
x86_l_1265:
	...
	X86_SIM_X86_JCC(X86_CC_E, 0x1265, 0x12b3, x86_l_12b3);
x86_l_1267:
	/* 0x1267: cmp    r9d,0x45 */
...
x86_l_126b:
	...
	X86_SIM_X86_JCC(X86_CC_NE, 0x126b, 0x12e0, x86_l_12e0);
x86_l_126d:
	/* 0x126d: mov    r8b,0x45 */
	X86_SIM_RUN_OP(X86_OP_MOV_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_8, 0, 69ULL);
x86_l_1270:
	/* 0x1270: cmp    BYTE PTR [rsi-0x4],0x41 */
...
x86_l_1274:
	...
	X86_SIM_X86_JCC(X86_CC_NE, 0x1274, 0x12e0, x86_l_12e0);
x86_l_1276:
	/* 0x1276: cmp    BYTE PTR [rsi-0x3],0x44 */
...
x86_l_127a:
	...
	X86_SIM_X86_JCC(X86_CC_NE, 0x127a, 0x12e0, x86_l_12e0);
x86_l_127c:
	/* 0x127c: mov    r10b,0x45 */
	X86_SIM_RUN_OP(X86_OP_MOV_IMM, X86_R10, X86_REG_NONE, X86_WIDTH_8, 0, 69ULL);
x86_l_127f:
	/* 0x127f: cmp    BYTE PTR [rsi-0x2],0x20 */
	X86_SIM_RUN_OP(X86_OP_CMP_MEM_IMM, X86_RSI, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 18446744065119617056ULL);
x86_l_1283:
	/* 0x1283: jne    12e0 <tracee_http_method_prefix_detect_xdp+0x1e0> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x1283, 0x12e0, x86_l_12e0);
x86_l_1285:
	/* 0x1285: mov    r9d,0x5 */
...
x86_l_12b1:
	...
	X86_SIM_X86_JMP(0x12b1, 0x12f0, x86_l_12f0);
x86_l_12b3:
	/* 0x12b3: mov    r8b,0x54 */
	X86_SIM_RUN_OP(X86_OP_MOV_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_8, 0, 84ULL);
x86_l_12b6:
	/* 0x12b6: cmp    BYTE PTR [rsi-0x4],0x54 */
	X86_SIM_RUN_OP(X86_OP_CMP_MEM_IMM, X86_RSI, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 18446744056529682516ULL);
x86_l_12ba:
	/* 0x12ba: jne    12e0 <tracee_http_method_prefix_detect_xdp+0x1e0> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x12ba, 0x12e0, x86_l_12e0);
x86_l_12bc:
	/* 0x12bc: cmp    BYTE PTR [rsi-0x3],0x50 */
...
x86_l_12c0:
	...
	X86_SIM_X86_JCC(X86_CC_NE, 0x12c0, 0x12e0, x86_l_12e0);
x86_l_12c2:
	/* 0x12c2: cmp    BYTE PTR [rsi-0x2],0x2f */
...
x86_l_12c6:
	...
	X86_SIM_X86_JCC(X86_CC_NE, 0x12c6, 0x12e0, x86_l_12e0);
x86_l_12c8:
	/* 0x12c8: mov    r9d,0x6 */
...
x86_l_12d4:
	...
	X86_SIM_X86_JMP(0x12d4, 0x12f0, x86_l_12f0);
x86_l_12d6:
...
x86_l_12e3:
	/* 0x12e3: movzx  r8d,BYTE PTR [rsi-0x4] */
...
x86_l_12e8:
	/* 0x12e8: movzx  r11d,BYTE PTR [rsi-0x3] */
...
x86_l_133a:
	...
	X86_SIM_X86_JCC(X86_CC_NE, 0x133a, 0x1150, x86_l_1150);
x86_l_1340:
	/* 0x1340: mov    BYTE PTR [rdx],al */
	X86_SIM_RUN_OP(X86_OP_MOV_STORE_REG, X86_RDX, X86_RAX, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_1342:
	/* 0x1342: mov    BYTE PTR [rdx+0x1],bh */
...
x86_l_134a:
	/* 0x134a: mov    BYTE PTR [rdx+0x2],al */
...
x86_l_1352:
	/* 0x1352: mov    BYTE PTR [rdx+0x3],al */
...
x86_l_135c:
	/* 0x135c: mov    BYTE PTR [rdx+0x4],al */
...
x86_l_1366:
	/* 0x1366: mov    BYTE PTR [rdx+0x5],al */
...
x86_l_1370:
	/* 0x1370: mov    BYTE PTR [rdx+0x6],al */
...
x86_l_1377:
	/* 0x1377: mov    BYTE PTR [rdx+0x7],bl */
