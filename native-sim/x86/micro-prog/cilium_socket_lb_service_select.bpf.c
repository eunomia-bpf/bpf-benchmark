...
x86_l_1f:
	...
	X86_SIM_L_EXEC_LEA(X86_RDX, X86_RDI, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 1552ULL);
x86_l_26:
	/* 0x26: cmp    rdx,rcx */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_CMP_REG, X86_RDX, X86_RCX, X86_WIDTH_64);
x86_l_29:
...
x86_l_2b:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 34359738432ULL);
x86_l_2f:
...
x86_l_31:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 51539607576ULL);
x86_l_35:
...
x86_l_3f:
	/* 0x3f: add    rdi,0x27 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RDI, X86_WIDTH_64, X86_ALU_ADD, 39ULL);
x86_l_43:
	/* 0x43: movabs r9,0x243f6a8885a308d3 */
	X86_SIM_L_EXEC_MOV_IMM(X86_R9, X86_WIDTH_64, 2611923443488327891ULL);
x86_l_4d:
	/* 0x4d: xor    r10d,r10d */
...
x86_l_66:
	/* 0x66: cmp    r10,0x40 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R10, X86_WIDTH_64, 64ULL);
x86_l_6a:
...
x86_l_70:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RAX, X86_RDI, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551597ULL);
x86_l_73:
	/* 0x73: movzx  r11d,BYTE PTR [rdi-0xb] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R11, X86_RDI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 18446744073709551605ULL);
x86_l_78:
	/* 0x78: cmp    r11,0x11 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R11, X86_WIDTH_64, 17ULL);
x86_l_7c:
	/* 0x7c: setne  cl */
...
x86_l_86:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RBX, X86_RDI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_16), 18446744073709551603ULL);
x86_l_8a:
	/* 0x8a: movzx  r15d,BYTE PTR [rdi-0xa] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R15, X86_RDI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 18446744073709551606ULL);
x86_l_8f:
	/* 0x8f: test   r15b,0x2 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_TEST_IMM, X86_R15, X86_WIDTH_8, 2ULL);
x86_l_93:
	/* 0x93: mov    ebp,0x0 */
...
x86_l_9b:
	/* 0x9b: test   dl,cl */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_TEST_REG, X86_RDX, X86_RCX, X86_WIDTH_8);
x86_l_9d:
...
x86_l_9f:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R12, X86_RDI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_16), 18446744073709551607ULL);
x86_l_a4:
	/* 0xa4: test   r12w,r12w */
...
x86_l_aa:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RCX, X86_RDI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_16), 18446744073709551601ULL);
x86_l_ae:
	/* 0xae: mov    edx,ecx */
...
x86_l_b3:
	...
	X86_SIM_L_EXEC_ALU_MEM(X86_RDX, X86_RDI, X86_WIDTH_32, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32) | X86_MEM_AUX_ALU_OP(X86_ALU_XOR)), 18446744073709551593ULL);
x86_l_b6:
	/* 0xb6: mov    r14d,DWORD PTR [rdi-0x3] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R14, X86_RDI, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551613ULL);
x86_l_ba:
	/* 0xba: xor    edx,ebx */
	X86_SIM_L_EXEC_ALU_REG(X86_RDX, X86_RBX, X86_WIDTH_32, X86_ALU_XOR);
x86_l_bc:
	/* 0xbc: xor    edx,DWORD PTR [rdi-0x7] */
	X86_SIM_L_EXEC_ALU_MEM(X86_RDX, X86_RDI, X86_WIDTH_32, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32) | X86_MEM_AUX_ALU_OP(X86_ALU_XOR)), 18446744073709551609ULL);
x86_l_bf:
	/* 0xbf: movsx  esi,bx */
	X86_SIM_L_EXEC_MOVX_REG(X86_OP_MOVSX_REG, X86_RSI, X86_RBX, X86_WIDTH_32, X86_WIDTH_16);
x86_l_c2:
	/* 0xc2: cmp    esi,0x752f */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RSI, X86_WIDTH_32, 29999ULL);
x86_l_c8:
...
x86_l_cd:
	/* 0xcd: and    esi,0x2 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RSI, X86_WIDTH_32, X86_ALU_AND, 2ULL);
x86_l_d0:
...
x86_l_d4:
	/* 0xd4: shl    rax,0x10 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_SHL, 16ULL);
x86_l_d8:
	/* 0xd8: movzx  ecx,cx */
...
x86_l_f2:
	...
	X86_SIM_L_EXEC_LEA(X86_RSI, X86_R14, X86_WIDTH_32, X86_MEM_AUX(X86_R15, 0), 0ULL);
x86_l_f6:
	/* 0xf6: add    esi,edx */
...
x86_l_100:
	/* 0x100: rol    esi,cl */
	X86_SIM_L_EXEC_ALU_REG(X86_RSI, X86_RCX, X86_WIDTH_32, X86_ALU_ROL);
x86_l_102:
	/* 0x102: xor    esi,edx */
...
x86_l_10d:
	/* 0x10d: shl    r15d,0x1d */
	X86_SIM_L_EXEC_ALU_IMM(X86_R15, X86_WIDTH_32, X86_ALU_SHL, 29ULL);
x86_l_111:
	/* 0x111: sar    r15d,0x1f */
...
x86_l_118:
	/* 0x118: and    r14d,r15d */
	X86_SIM_L_EXEC_ALU_REG(X86_R14, X86_R15, X86_WIDTH_32, X86_ALU_AND);
x86_l_11b:
	/* 0x11b: xor    r14d,edx */
	X86_SIM_L_EXEC_ALU_REG(X86_R14, X86_RDX, X86_WIDTH_32, X86_ALU_XOR);
x86_l_11e:
	/* 0x11e: mov    eax,ebp */
...
x86_l_12b:
	/* 0x12b: xor    rcx,rax */
	X86_SIM_L_EXEC_ALU_REG(X86_RCX, X86_RAX, X86_WIDTH_64, X86_ALU_XOR);
x86_l_12e:
	/* 0x12e: add    r9,r11 */
...
x86_l_138:
	/* 0x138: or     rsi,r14 */
	X86_SIM_L_EXEC_ALU_REG(X86_RSI, X86_R14, X86_WIDTH_64, X86_ALU_OR);
x86_l_13b:
	/* 0x13b: mov    eax,r10d */
...
x86_l_158:
	...
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_R8, X86_R9, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_15b:
	/* 0x15b: mov    eax,0x2 */
