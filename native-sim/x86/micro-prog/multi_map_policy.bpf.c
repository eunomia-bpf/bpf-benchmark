...
x86_l_31:
	...
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_R14, &policy_array);
x86_l_38:
	/* 0x38: mov    rbp,QWORD PTR [rip+0x0] */
	X86_SIM_L_WRITE_REG_HELPER_ID(X86_RBP, X86_SIM_HELPER_bpf_map_update_elem);
x86_l_3f:
	/* 0x3f: xor    ebx,ebx */
...
x86_l_67:
	...
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, &meta_hash);
x86_l_6e:
...
x86_l_8b:
	...
	X86_SIM_L_WRITE_REG_MAP_PTR(X86_RDI, &counter_pcpu);
x86_l_92:
