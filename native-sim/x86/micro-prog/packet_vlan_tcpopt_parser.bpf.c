...
x86_l_3:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R10, X86_RDI, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_7:
	/* 0x7: xor    eax,eax */
	X86_SIM_L_EXEC_ALU_REG(X86_RAX, X86_RAX, X86_WIDTH_32, X86_ALU_XOR);
x86_l_9:
	/* 0x9: cmp    rdx,r10 */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_CMP_REG, X86_RDX, X86_R10, X86_WIDTH_64);
x86_l_c:
	/* 0xc: ja     2aa <packet_vlan_tcpopt_parser_xdp+0x2aa> */
	X86_SIM_X86_JCC(X86_CC_A, 0xc, 0x2aa, x86_l_2aa);
x86_l_12:
	/* 0x12: lea    rcx,[rdx+0x8] */
	X86_SIM_L_EXEC_LEA(X86_RCX, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_16:
	/* 0x16: cmp    rcx,r10 */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_CMP_REG, X86_RCX, X86_R10, X86_WIDTH_64);
x86_l_19:
	/* 0x19: ja     2aa <packet_vlan_tcpopt_parser_xdp+0x2aa> */
	X86_SIM_X86_JCC(X86_CC_A, 0x19, 0x2aa, x86_l_2aa);
x86_l_1f:
	/* 0x1f: lea    r9,[rdx+0x16] */
	X86_SIM_L_EXEC_LEA(X86_R9, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 22ULL);
x86_l_23:
	/* 0x23: cmp    r9,r10 */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_CMP_REG, X86_R9, X86_R10, X86_WIDTH_64);
x86_l_26:
...
x86_l_49:
	/* 0x49: cmp    ecx,0x88a8 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 34984ULL);
x86_l_4f:
	/* 0x4f: je     5d <packet_vlan_tcpopt_parser_xdp+0x5d> */
	X86_SIM_X86_JCC(X86_CC_E, 0x4f, 0x5d, x86_l_5d);
x86_l_51:
	/* 0x51: cmp    ecx,0x8100 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RCX, X86_WIDTH_32, 33024ULL);
x86_l_57:
	/* 0x57: jne    2a4 <packet_vlan_tcpopt_parser_xdp+0x2a4> */
	X86_SIM_X86_JCC(X86_CC_NE, 0x57, 0x2a4, x86_l_2a4);
x86_l_5d:
	/* 0x5d: lea    r9,[rdx+0x1a] */
	X86_SIM_L_EXEC_LEA(X86_R9, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 26ULL);
x86_l_61:
	/* 0x61: cmp    r9,r10 */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_CMP_REG, X86_R9, X86_R10, X86_WIDTH_64);
x86_l_64:
...
x86_l_99:
	...
	X86_SIM_L_EXEC_LEA(X86_RCX, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 30ULL);
x86_l_9d:
	/* 0x9d: cmp    rcx,r10 */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_CMP_REG, X86_RCX, X86_R10, X86_WIDTH_64);
x86_l_a0:
...
x86_l_bb:
	...
	X86_SIM_L_EXEC_LEA(X86_RCX, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 50ULL);
x86_l_bf:
	/* 0xbf: cmp    rcx,r10 */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_CMP_REG, X86_RCX, X86_R10, X86_WIDTH_64);
x86_l_c2:
...
x86_l_c8:
	...
	X86_SIM_L_EXEC_LEA(X86_R9, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 30ULL);
x86_l_cc:
...
x86_l_e1:
	...
	X86_SIM_L_EXEC_LEA(X86_RDI, X86_R9, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 20ULL);
x86_l_e5:
	/* 0xe5: cmp    rdi,r10 */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_CMP_REG, X86_RDI, X86_R10, X86_WIDTH_64);
x86_l_e8:
...
x86_l_f1:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDI, X86_R9, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 0ULL);
x86_l_f5:
	/* 0xf5: mov    r11d,edi */
	X86_SIM_L_EXEC_MOV_REG(X86_R11, X86_RDI, X86_WIDTH_32);
x86_l_f8:
	/* 0xf8: and    r11b,0xf0 */
	X86_SIM_L_EXEC_ALU_IMM(X86_R11, X86_WIDTH_8, X86_ALU_AND, 240ULL);
x86_l_fc:
	/* 0xfc: cmp    r11b,0x40 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R11, X86_WIDTH_8, 64ULL);
x86_l_100:
...
x86_l_109:
	/* 0x109: cmp    dil,0x5 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDI, X86_WIDTH_8, 5ULL);
x86_l_10d:
	/* 0x10d: jb     2a4 <packet_vlan_tcpopt_parser_xdp+0x2a4> */
	X86_SIM_X86_JCC(X86_CC_B, 0x10d, 0x2a4, x86_l_2a4);
x86_l_113:
	/* 0x113: lea    rbx,[r9+rdi*4] */
	X86_SIM_L_EXEC_LEA(X86_RBX, X86_R9, X86_WIDTH_64, X86_MEM_AUX(X86_RDI, 2), 0ULL);
x86_l_117:
	/* 0x117: cmp    rbx,r10 */
...
x86_l_120:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_R9, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 38654705670ULL);
x86_l_125:
...
x86_l_12f:
	/* 0x12f: cmp    r14,r10 */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_CMP_REG, X86_R14, X86_R10, X86_WIDTH_64);
x86_l_132:
...
x86_l_138:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R11, X86_RBX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 12ULL);
x86_l_13d:
	/* 0x13d: cmp    r11,0x50 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R11, X86_WIDTH_64, 80ULL);
x86_l_141:
	/* 0x141: jb     2a4 <packet_vlan_tcpopt_parser_xdp+0x2a4> */
	X86_SIM_X86_JCC(X86_CC_B, 0x141, 0x2a4, x86_l_2a4);
x86_l_147:
	/* 0x147: shr    r11d,0x2 */
	X86_SIM_L_EXEC_ALU_IMM(X86_R11, X86_WIDTH_32, X86_ALU_SHR, 2ULL);
x86_l_14b:
	/* 0x14b: and    r11d,0xfffffffc */
	X86_SIM_L_EXEC_ALU_IMM(X86_R11, X86_WIDTH_32, X86_ALU_AND, 4294967292ULL);
x86_l_14f:
	/* 0x14f: lea    r15,[rbx+r11*1] */
	X86_SIM_L_EXEC_LEA(X86_R15, X86_RBX, X86_WIDTH_64, X86_MEM_AUX(X86_R11, 0), 0ULL);
x86_l_153:
	/* 0x153: cmp    r15,r10 */
...
x86_l_15c:
	...
	X86_SIM_L_EXEC_LEA(X86_R15, X86_RBX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 32ULL);
x86_l_160:
	/* 0x160: cmp    r15,r10 */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_CMP_REG, X86_R15, X86_R10, X86_WIDTH_64);
x86_l_163:
...
x86_l_169:
	/* 0x169: cmp    r11b,0x20 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R11, X86_WIDTH_8, 32ULL);
x86_l_16d:
	/* 0x16d: jb     2a4 <packet_vlan_tcpopt_parser_xdp+0x2a4> */
	X86_SIM_X86_JCC(X86_CC_B, 0x16d, 0x2a4, x86_l_2a4);
x86_l_173:
	/* 0x173: cmp    BYTE PTR [r14],0x2 */
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 2ULL);
x86_l_177:
...
x86_l_17d:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 90194313220ULL);
x86_l_181:
...
x86_l_187:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 103079215105ULL);
x86_l_18b:
...
x86_l_191:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 107374182403ULL);
x86_l_195:
...
x86_l_19b:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 111669149699ULL);
x86_l_19f:
...
x86_l_1a5:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 120259084292ULL);
x86_l_1a9:
...
x86_l_1af:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 124554051586ULL);
x86_l_1b3:
...
x86_l_1b9:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 128849018881ULL);
x86_l_1bd:
...
x86_l_1ca:
	/* 0x1ca: shl    rdi,0x2 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RDI, X86_WIDTH_64, X86_ALU_SHL, 2ULL);
x86_l_1ce:
...
x86_l_1f5:
	/* 0x1f5: xor    rax,r10 */
	X86_SIM_L_EXEC_ALU_REG(X86_RAX, X86_R10, X86_WIDTH_64, X86_ALU_XOR);
x86_l_1f8:
	/* 0x1f8: add    rax,r9 */
	X86_SIM_L_EXEC_ALU_REG(X86_RAX, X86_R9, X86_WIDTH_64, X86_ALU_ADD);
x86_l_1fb:
	/* 0x1fb: movzx  r9d,BYTE PTR [rbx+0x16] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R9, X86_RBX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 22ULL);
x86_l_200:
	/* 0x200: mov    r10d,r9d */
...
x86_l_207:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R14, X86_RBX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 23ULL);
x86_l_20c:
	/* 0x20c: or     r10d,r14d */
	X86_SIM_L_EXEC_ALU_REG(X86_R10, X86_R14, X86_WIDTH_32, X86_ALU_OR);
x86_l_20f:
	/* 0x20f: add    r10,0x2 */
...
x86_l_21e:
	/* 0x21e: add    r9,r14 */
	X86_SIM_L_EXEC_ALU_REG(X86_R9, X86_R14, X86_WIDTH_64, X86_ALU_ADD);
x86_l_221:
	/* 0x221: add    r9,0x30100 */
	X86_SIM_L_EXEC_ALU_IMM(X86_R9, X86_WIDTH_64, X86_ALU_ADD, 196864ULL);
x86_l_228:
	/* 0x228: movzx  r10d,BYTE PTR [rbx+0x1b] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R10, X86_RBX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 27ULL);
x86_l_22d:
	/* 0x22d: mov    r14,r10 */
...
x86_l_238:
	/* 0x238: xor    r10,r14 */
	X86_SIM_L_EXEC_ALU_REG(X86_R10, X86_R14, X86_WIDTH_64, X86_ALU_XOR);
x86_l_23b:
	/* 0x23b: xor    r10,r9 */
	X86_SIM_L_EXEC_ALU_REG(X86_R10, X86_R9, X86_WIDTH_64, X86_ALU_XOR);
x86_l_23e:
	/* 0x23e: movzx  ebx,BYTE PTR [rbx+0x1f] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RBX, X86_RBX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 31ULL);
x86_l_242:
	/* 0x242: shl    rbx,0x28 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RBX, X86_WIDTH_64, X86_ALU_SHL, 40ULL);
x86_l_246:
	/* 0x246: or     rbx,r10 */
	X86_SIM_L_EXEC_ALU_REG(X86_RBX, X86_R10, X86_WIDTH_64, X86_ALU_OR);
x86_l_249:
	/* 0x249: movabs r9,0x144000000 */
	X86_SIM_L_EXEC_MOV_IMM(X86_R9, X86_WIDTH_64, 5435817984ULL);
x86_l_253:
	/* 0x253: add    r9,rbx */
	X86_SIM_L_EXEC_ALU_REG(X86_R9, X86_RBX, X86_WIDTH_64, X86_ALU_ADD);
x86_l_256:
	/* 0x256: shl    esi,0x10 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RSI, X86_WIDTH_32, X86_ALU_SHL, 16ULL);
x86_l_259:
	/* 0x259: or     rsi,r8 */
	X86_SIM_L_EXEC_ALU_REG(X86_RSI, X86_R8, X86_WIDTH_64, X86_ALU_OR);
x86_l_25c:
	/* 0x25c: xor    rsi,rax */
...
x86_l_262:
	/* 0x262: shl    rax,0x28 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RAX, X86_WIDTH_64, X86_ALU_SHL, 40ULL);
x86_l_266:
	/* 0x266: shl    edi,0x8 */
...
x86_l_26f:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_RAX, X86_WIDTH_64, 25769803776ULL);
x86_l_279:
	/* 0x279: add    rax,rdi */
...
x86_l_282:
	/* 0x282: rol    r9,cl */
	X86_SIM_L_EXEC_ALU_REG(X86_R9, X86_RCX, X86_WIDTH_64, X86_ALU_ROL);
x86_l_285:
	/* 0x285: xor    r9,rax */
	X86_SIM_L_EXEC_ALU_REG(X86_R9, X86_RAX, X86_WIDTH_64, X86_ALU_XOR);
x86_l_288:
	/* 0x288: mov    QWORD PTR [rdx],r9 */
	X86_SIM_L_EXEC_STORE(X86_OP_MOV_STORE_REG, X86_RDX, X86_R9, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_28b:
	/* 0x28b: mov    eax,0x2 */
