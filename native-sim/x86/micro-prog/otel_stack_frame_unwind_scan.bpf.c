...
x86_l_1f:
	...
	X86_SIM_L_EXEC_LEA(X86_RDI, X86_RSI, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 592ULL);
x86_l_26:
	/* 0x26: cmp    rdi,rcx */
	X86_SIM_L_EXEC_CMP_REG_OP(X86_OP_CMP_REG, X86_RDI, X86_RCX, X86_WIDTH_64);
x86_l_29:
...
x86_l_2b:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RSI, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 34359738392ULL);
x86_l_2f:
...
x86_l_4d:
	...
	X86_SIM_L_EXEC_MOV_IMM(X86_R9, X86_WIDTH_64, 6384245875588680899ULL);
x86_l_57:
	/* 0x57: xor    edi,edi */
...
x86_l_61:
	/* 0x61: shl    rcx,0x30 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RCX, X86_WIDTH_64, X86_ALU_SHL, 48ULL);
x86_l_65:
	/* 0x65: or     rcx,rbx */
	X86_SIM_L_EXEC_ALU_REG(X86_RCX, X86_RBX, X86_WIDTH_64, X86_ALU_OR);
x86_l_68:
	/* 0x68: xor    r9,rcx */
	X86_SIM_L_EXEC_ALU_REG(X86_R9, X86_RCX, X86_WIDTH_64, X86_ALU_XOR);
x86_l_6b:
	/* 0x6b: inc    rdi */
...
x86_l_72:
	/* 0x72: cmp    rdi,0x18 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RDI, X86_WIDTH_64, 24ULL);
x86_l_76:
...
x86_l_7c:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RBX, X86_RSI, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551593ULL);
x86_l_80:
	/* 0x80: mov    ebp,DWORD PTR [rsi-0xf] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RBP, X86_RSI, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551601ULL);
x86_l_83:
	/* 0x83: mov    r14d,DWORD PTR [rsi-0xb] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R14, X86_RSI, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551605ULL);
x86_l_87:
	/* 0x87: movzx  r11d,WORD PTR [rsi-0x7] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R11, X86_RSI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_16), 18446744073709551609ULL);
x86_l_8c:
...
x86_l_90:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R10, X86_RSI, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551613ULL);
x86_l_94:
	/* 0x94: cmp    ecx,0x1 */
...
x86_l_a2:
	/* 0xa2: mov    r15d,0x35 */
	X86_SIM_L_EXEC_MOV_IMM(X86_R15, X86_WIDTH_32, 53ULL);
x86_l_a8:
	/* 0xa8: cmp    ebp,0x1000 */
...
x86_l_bc:
	/* 0xbc: mov    r15d,0x89 */
	X86_SIM_L_EXEC_MOV_IMM(X86_R15, X86_WIDTH_32, 137ULL);
x86_l_c2:
	/* 0xc2: cmp    ebp,0x1000 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBP, X86_WIDTH_32, 4096ULL);
x86_l_c8:
...
x86_l_cc:
	/* 0xcc: mov    r15d,0x21 */
	X86_SIM_L_EXEC_MOV_IMM(X86_R15, X86_WIDTH_32, 33ULL);
x86_l_d2:
	/* 0xd2: cmp    ebp,0x1000 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBP, X86_WIDTH_32, 4096ULL);
x86_l_d8:
...
x86_l_dc:
	/* 0xdc: mov    r15d,0x55 */
	X86_SIM_L_EXEC_MOV_IMM(X86_R15, X86_WIDTH_32, 85ULL);
x86_l_e2:
	/* 0xe2: cmp    ebp,0x1000 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RBP, X86_WIDTH_32, 4096ULL);
x86_l_e8:
...
x86_l_ee:
	...
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_R14, X86_WIDTH_32, 8193ULL);
x86_l_f5:
...
x86_l_102:
	...
	X86_SIM_L_EXEC_CMOV(X86_R12, X86_R8, X86_WIDTH_32, X86_CC_E);
x86_l_106:
	/* 0x106: add    r12d,ebp */
...
x86_l_116:
	/* 0x116: xor    rbx,r15 */
	X86_SIM_L_EXEC_ALU_REG(X86_RBX, X86_R15, X86_WIDTH_64, X86_ALU_XOR);
x86_l_119:
	/* 0x119: xor    rbx,rax */
	X86_SIM_L_EXEC_ALU_REG(X86_RBX, X86_RAX, X86_WIDTH_64, X86_ALU_XOR);
x86_l_11c:
	/* 0x11c: test   r11b,0x2 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_TEST_IMM, X86_R11, X86_WIDTH_8, 2ULL);
x86_l_120:
...
x86_l_124:
	/* 0x124: rol    rbx,cl */
	X86_SIM_L_EXEC_ALU_REG(X86_RBX, X86_RCX, X86_WIDTH_64, X86_ALU_ROL);
x86_l_127:
	/* 0x127: mov    ecx,r14d */
	X86_SIM_L_EXEC_MOV_REG(X86_RCX, X86_R14, X86_WIDTH_32);
x86_l_12a:
	/* 0x12a: shl    rcx,0x18 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RCX, X86_WIDTH_64, X86_ALU_SHL, 24ULL);
x86_l_12e:
	/* 0x12e: mov    r14d,ebp */
	X86_SIM_L_EXEC_MOV_REG(X86_R14, X86_RBP, X86_WIDTH_32);
x86_l_131:
	/* 0x131: xor    r14,rcx */
	X86_SIM_L_EXEC_ALU_REG(X86_R14, X86_RCX, X86_WIDTH_64, X86_ALU_XOR);
x86_l_134:
	/* 0x134: test   r11b,0x4 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_TEST_IMM, X86_R11, X86_WIDTH_8, 4ULL);
x86_l_138:
	/* 0x138: mov    ecx,0x0 */
	X86_SIM_L_EXEC_MOV_IMM(X86_RCX, X86_WIDTH_32, 0ULL);
x86_l_13d:
	/* 0x13d: cmovne rcx,r14 */
	X86_SIM_L_EXEC_CMOV(X86_RCX, X86_R14, X86_WIDTH_64, X86_CC_NE);
x86_l_141:
	/* 0x141: add    rcx,rbx */
...
x86_l_146:
	/* 0x146: and    bl,0x7 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RBX, X86_WIDTH_8, X86_ALU_AND, 7ULL);
x86_l_149:
	/* 0x149: lea    r14d,[rbx+0x1] */
	X86_SIM_L_EXEC_LEA(X86_R14, X86_RBX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 1ULL);
x86_l_14d:
	/* 0x14d: shlx   r14,rcx,r14 */
	X86_SIM_RUN_OP(X86_OP_SHIFTX, X86_R14, X86_RCX, X86_WIDTH_64, X86_R14, X86_ALU_SHL);
x86_l_152:
	/* 0x152: not    bl */
	X86_SIM_L_EXEC_ALU_IMM(X86_RBX, X86_WIDTH_8, X86_ALU_NOT, 0);
x86_l_154:
...
x86_l_15f:
	...
	X86_SIM_L_EXEC_MOVX_REG(X86_OP_MOVZX_REG, X86_R9, X86_R11, X86_WIDTH_32, X86_WIDTH_16);
x86_l_163:
	/* 0x163: shl    r9,0x28 */
