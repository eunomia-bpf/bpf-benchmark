...
x86_l_1f:
	...
	X86_SIM_L_EXEC_LEA(X86_R8, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 2064ULL);
x86_l_26:
	/* 0x26: cmp    r8,rsi */
...
x86_l_2b:
	...
	X86_SIM_L_EXEC_CMP_MEM(X86_OP_CMP_MEM_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 256ULL);
x86_l_31:
...
x86_l_38:
	...
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_RDI, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_RAX, 3), 16ULL);
x86_l_3d:
	/* 0x3d: mov    r8,QWORD PTR [rdx+rax*8+0x18] */
	X86_SIM_L_EXEC_MOV_LOAD(X86_OP_MOV_LOAD, X86_R8, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_RAX, 3), 24ULL);
x86_l_42:
	/* 0x42: mov    r9d,eax */
	X86_SIM_L_EXEC_MOV_REG(X86_R9, X86_RAX, X86_WIDTH_32);
x86_l_45:
	/* 0x45: and    r9b,0x6 */
	X86_SIM_L_EXEC_ALU_IMM(X86_R9, X86_WIDTH_8, X86_ALU_AND, 6ULL);
x86_l_49:
	/* 0x49: shrx   r9,rdi,r9 */
	X86_SIM_RUN_OP(X86_OP_SHIFTX, X86_R9, X86_RDI, X86_WIDTH_64, X86_R9, X86_ALU_SHR);
x86_l_4e:
	/* 0x4e: xor    rdi,rsi */
	X86_SIM_L_EXEC_ALU_REG(X86_RDI, X86_RSI, X86_WIDTH_64, X86_ALU_XOR);
x86_l_51:
	/* 0x51: popcnt rdi,rdi */
...
x86_l_5f:
	/* 0x5f: and    sil,0x7 */
	X86_SIM_L_EXEC_ALU_IMM(X86_RSI, X86_WIDTH_8, X86_ALU_AND, 7ULL);
x86_l_63:
...
x86_l_7c:
	/* 0x7c: cmp    rax,0x100 */
	X86_SIM_L_EXEC_CMP_IMM_OP(X86_OP_CMP_IMM, X86_RAX, X86_WIDTH_64, 256ULL);
x86_l_82:
