...
x86_l_26:
	...
	X86_SIM_RUN_OP(X86_OP_MOV_LOAD_MAP_PTR, X86_RBX, X86_REG_NONE, X86_WIDTH_64, 0, ((__u64)(long)&chain_h));
x86_l_2d:
	/* 0x2d: xor    r13d,r13d */
...
x86_l_5c:
	...
	X86_SIM_RUN_OP(X86_OP_MOV_LOAD_MAP_PTR, X86_RDI, X86_REG_NONE, X86_WIDTH_64, 0, ((__u64)(long)&chain_h));
x86_l_63:
