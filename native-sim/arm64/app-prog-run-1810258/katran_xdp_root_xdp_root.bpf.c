...
#define ARM64_SIM_C_HELPER_bpf_tail_call 1U
...
static const struct arm64_sim_compact_step __arm64_sim_steps_katran_xdp_root_xdp_root[] = {
	{ ARM64_SIM_C_OP, ARM64_OP_NOP, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, 0, 0U, 0, 0 },
	{ ARM64_SIM_C_OP, ARM64_OP_NOP, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, 0, 0U, 0, 0 },
	{ ARM64_SIM_C_OP, ARM64_OP_ADRP_GOT, ARM64_X20, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, ((__u64)(long)&root_array_0), 0U, 0, 0 },
...
SEC("xdp")
int katran_xdp_root_xdp_root_arm64_sim_xdp(struct xdp_md *ctx)
{
	...
	for (__u32 __a64_c_guard = 0; __a64_c_guard < __a64_c_guard_limit; __a64_c_guard++) {
		if (__a64_c_pc >= 23U)
			break;
		const struct arm64_sim_compact_step *__a64_c_step = &__arm64_sim_steps_katran_xdp_root_xdp_root[__a64_c_pc];
