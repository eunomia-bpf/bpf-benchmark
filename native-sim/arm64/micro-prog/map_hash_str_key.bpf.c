...
arm64_l_3c:
	/* 0x3c: ldp x9, x8, [x8] */
	ARM64_SIM_L_LOAD_CONST16_PAIR(ARM64_X9, ARM64_X8, 7164775529535926370ULL, 3472325312118467944ULL);
arm64_l_40:
	/* 0x40: mov x1, sp */
...
arm64_l_50:
	/* 0x50: mov x9, #0xbeef */
	ARM64_SIM_RUN_OP3(ARM64_OP_MOV_IMM, ARM64_X9, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, 48879ULL);
arm64_l_54:
	/* 0x54: movk x9, #0xdead, lsl #16 */
	ARM64_SIM_RUN_OP3(ARM64_OP_MOVK, ARM64_X9, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, ARM64_AUX_MOVK(16), 57005ULL);
arm64_l_58:
	/* 0x58: movk x9, #0xface, lsl #32 */
