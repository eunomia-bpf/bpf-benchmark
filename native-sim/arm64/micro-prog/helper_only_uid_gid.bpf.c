...
arm64_l_4:
	/* 0x4: ldp x19, x8, [x0] */
	ARM64_SIM_RUN_OP3(ARM64_OP_LDP, ARM64_X19, ARM64_X8, ARM64_X0, ARM64_REG_NONE, ARM64_WIDTH_64, ARM64_AUX_MEM(ARM64_REG_NONE, ARM64_MOD_NONE, 0, 0), 0ULL);
arm64_l_8:
	/* 0x8: add x9, x19, #0x8 */
	ARM64_SIM_RUN_OP3(ARM64_OP_ALU_IMM, ARM64_X9, ARM64_X19, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, ARM64_AUX_ALU(ARM64_ALU_ADD, ARM64_MOD_NONE, 0), 8ULL);
arm64_l_c:
	/* 0xc: cmp x9, x8 */
...
arm64_l_10:
	/* 0x10: b.ls 20 <helper_only_uid_gid+0x20> */
	ARM64_SIM_A64_JCC(ARM64_COND_LS, 0x10, 0x20, arm64_l_20);
arm64_l_14:
	/* 0x14: mov w0, wzr */
...
arm64_l_18:
	...
	ARM64_SIM_RUN_OP3(ARM64_OP_NOP, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, 0);
arm64_l_1c:
	/* 0x1c: b 38 <__native_link_arm64_ret_trampoline> */
	ARM64_SIM_A64_JMP(0x1c, 0x38, arm64_l_38);
arm64_l_20:
	/* 0x20: bl 0 <bpf_get_current_uid_gid> */
	ARM64_SIM_BPF_CALL_bpf_get_current_uid_gid();
arm64_l_24:
	/* 0x24: str x0, [x19] */
	ARM64_SIM_RUN_OP3(ARM64_OP_STORE, ARM64_X19, ARM64_X0, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, ARM64_AUX_MEM(ARM64_REG_NONE, ARM64_MOD_NONE, 0, 0), 0ULL);
arm64_l_28:
	/* 0x28: mov w0, #0x2 */
...
arm64_l_2c:
	...
	ARM64_SIM_RUN_OP3(ARM64_OP_NOP, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, 0);
arm64_l_30:
	/* 0x30: b 38 <__native_link_arm64_ret_trampoline> */
	ARM64_SIM_A64_JMP(0x30, 0x38, arm64_l_38);
arm64_l_34:
	/* 0x34: nop */
	ARM64_SIM_RUN_OP3(ARM64_OP_NOP, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, 0);
arm64_l_38:
