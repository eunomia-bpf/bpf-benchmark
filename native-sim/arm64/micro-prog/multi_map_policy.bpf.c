...
arm64_l_14:
	/* 0x14: b 124 <multi_map_policy+0x124> */
...
arm64_l_1c:
	/* 0x1c: stp x30, x19, [sp, #64] */
	ARM64_SIM_RUN_OP3(ARM64_OP_STP, ARM64_SP, ARM64_X30, ARM64_X19, ARM64_REG_NONE, ARM64_WIDTH_64, ARM64_AUX_MEM(ARM64_REG_NONE, ARM64_MOD_NONE, 0, 0), 64ULL);
arm64_l_20:
	/* 0x20: mov x9, #0x11 */
...
arm64_l_114:
	/* 0x114: ldp x30, x19, [sp, #64] */
	ARM64_SIM_RUN_OP3(ARM64_OP_LDP, ARM64_X30, ARM64_X19, ARM64_SP, ARM64_REG_NONE, ARM64_WIDTH_64, ARM64_AUX_MEM(ARM64_REG_NONE, ARM64_MOD_NONE, 0, 0), 64ULL);
arm64_l_118:
	/* 0x118: mov w0, #0x2 */
