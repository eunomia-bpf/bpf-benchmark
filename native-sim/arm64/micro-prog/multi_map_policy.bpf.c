...
arm64_l_38:
	/* 0x38: adrp x19, 0 <policy_array> */
	(void)0;
arm64_l_3c:
	/* 0x3c: movk x9, #0xeeff, lsl #16 */
...
arm64_l_58:
	/* 0x58: str x9, [sp, #24] */
	ARM64_SIM_RUN_OP3(ARM64_OP_STORE, ARM64_SP, ARM64_X9, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, ARM64_AUX_MEM(ARM64_REG_NONE, ARM64_MOD_NONE, 0, 0), 24ULL);
arm64_l_5c:
	/* 0x5c: ldr x19, [x19] */
