...
#define ARM64_SIM_RETURN_CASES \
	case 0x48ULL: __a64_lr = 0; goto arm64_l_48; \
	case 0x54ULL: __a64_lr = 0; goto arm64_l_54;
...
arm64_l_c:
	/* 0xc: b.ls 18 <map_percpu_hash_counter+0x18> */
...
arm64_l_14:
	/* 0x14: b 88 <map_percpu_hash_counter+0x88> */
...
arm64_l_20:
	/* 0x20: stp x8, xzr, [sp, #8] */
	ARM64_SIM_RUN_OP3(ARM64_OP_STP, ARM64_SP, ARM64_X8, ARM64_XZR, ARM64_REG_NONE, ARM64_WIDTH_64, ARM64_AUX_MEM(ARM64_REG_NONE, ARM64_MOD_NONE, 0, 0), 8ULL);
arm64_l_24:
	/* 0x24: mov w8, #0x7 */
	ARM64_SIM_RUN_OP3(ARM64_OP_MOV_IMM, ARM64_X8, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_32, 0, 7ULL);
arm64_l_28:
	/* 0x28: adrp x19, 0 <cnt_pcpu> */
	(void)0;
arm64_l_2c:
	/* 0x2c: str w8, [sp, #28] */
...
arm64_l_4c:
	...
	ARM64_SIM_RUN_OP3(ARM64_OP_MOV_REG, ARM64_X0, ARM64_X19, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, 0);
arm64_l_50:
	/* 0x50: bl 0 <bpf_map_lookup_elem> */
	ARM64_SIM_BPF_CALL_bpf_map_lookup_elem();
arm64_l_54:
	/* 0x54: cbz x0, 68 <map_percpu_hash_counter+0x68> */
	ARM64_SIM_A64_CBZ(ARM64_X0, 0x54, 0x68, arm64_l_68);
arm64_l_58:
	/* 0x58: ldr x8, [x0] */
...
arm64_l_64:
	/* 0x64: b 6c <map_percpu_hash_counter+0x6c> */
...
arm64_l_80:
	/* 0x80: b 88 <map_percpu_hash_counter+0x88> */
