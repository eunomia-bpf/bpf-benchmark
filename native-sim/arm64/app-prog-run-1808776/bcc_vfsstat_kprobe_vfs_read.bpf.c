...
static const struct arm64_sim_compact_step __arm64_sim_steps_bcc_vfsstat_kprobe_vfs_read[] = {
	...
	{ ARM64_SIM_C_CBNZ, ARM64_OP_NOP, ARM64_REG_NONE, ARM64_X10, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_32, 0, 0, 2U, 0, 0 },
...
SEC("xdp")
int bcc_vfsstat_kprobe_vfs_read_arm64_sim_xdp(struct xdp_md *ctx)
{
	ARM64_SIM_ENTRY_XDP(ctx);
	__u32 __a64_c_pc = 0;
	__u32 __a64_c_guard_limit = 72U;
	#pragma clang loop unroll(disable)
	for (__u32 __a64_c_guard = 0; __a64_c_guard < __a64_c_guard_limit; __a64_c_guard++) {
		if (__a64_c_pc >= 9U)
			break;
		const struct arm64_sim_compact_step *__a64_c_step = &__arm64_sim_steps_bcc_vfsstat_kprobe_vfs_read[__a64_c_pc];
