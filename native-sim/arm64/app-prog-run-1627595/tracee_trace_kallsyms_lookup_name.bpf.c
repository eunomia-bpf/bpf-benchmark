...
static const struct arm64_sim_compact_step __arm64_sim_steps_tracee_trace_kallsyms_lookup_name[] = {
	...
	{ ARM64_SIM_C_OP, ARM64_OP_STP, ARM64_SP, ARM64_X8, ARM64_X9, ARM64_REG_NONE, ARM64_WIDTH_64, ARM64_AUX_MEM(ARM64_REG_NONE, ARM64_MOD_NONE, 0, ARM64_MEM_PRE), 18446744073709551552ULL, 0U, 0, 0 },
	...
	{ ARM64_SIM_C_OP, ARM64_OP_STP, ARM64_SP, ARM64_X9, ARM64_X30, ARM64_REG_NONE, ARM64_WIDTH_64, ARM64_AUX_MEM(ARM64_REG_NONE, ARM64_MOD_NONE, 0, 0), 40ULL, 0U, 0, 0 },
	...
	{ ARM64_SIM_C_OP, ARM64_OP_MOV_IMM, ARM64_X8, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, 3311419785216ULL, 0U, 0, 0 },
	...
	{ ARM64_SIM_C_OP, ARM64_OP_LOAD, ARM64_X30, ARM64_SP, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, ARM64_AUX_MEM(ARM64_REG_NONE, ARM64_MOD_NONE, 0, 0), 48ULL, 0U, 0, 0 },
	...
	{ ARM64_SIM_C_JMP, ARM64_OP_NOP, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, 0, 24U, 0, 0 },
...
SEC("xdp")
int tracee_trace_kallsyms_lookup_name_arm64_sim_xdp(struct xdp_md *ctx)
{
	ARM64_SIM_ENTRY_XDP(ctx);
	__u32 __a64_c_pc = 0;
	__u32 __a64_c_guard_limit = 200U;
	#pragma clang loop unroll(disable)
	for (__u32 __a64_c_guard = 0; __a64_c_guard < __a64_c_guard_limit; __a64_c_guard++) {
		if (__a64_c_pc >= 25U)
			break;
		const struct arm64_sim_compact_step *__a64_c_step = &__arm64_sim_steps_tracee_trace_kallsyms_lookup_name[__a64_c_pc];
