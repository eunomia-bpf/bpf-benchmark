...
static const struct arm64_sim_compact_step __arm64_sim_steps_tracee_trace_vfs_readv[] = {
...
SEC("xdp")
int tracee_trace_vfs_readv_arm64_sim_xdp(struct xdp_md *ctx)
{
	...
	for (__u32 __a64_c_guard = 0; __a64_c_guard < __a64_c_guard_limit; __a64_c_guard++) {
		if (__a64_c_pc >= 25U)
			break;
		const struct arm64_sim_compact_step *__a64_c_step = &__arm64_sim_steps_tracee_trace_vfs_readv[__a64_c_pc];
