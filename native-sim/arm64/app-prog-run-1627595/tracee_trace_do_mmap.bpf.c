...
static const struct arm64_sim_compact_step __arm64_sim_steps_tracee_trace_do_mmap[] = {
	...
	{ ARM64_SIM_C_OP, ARM64_OP_MOV_IMM, ARM64_X8, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, 3315714752512ULL, 0U, 0, 0 },
...
SEC("xdp")
int tracee_trace_do_mmap_arm64_sim_xdp(struct xdp_md *ctx)
{
	...
	for (__u32 __a64_c_guard = 0; __a64_c_guard < __a64_c_guard_limit; __a64_c_guard++) {
		if (__a64_c_pc >= 25U)
			break;
		const struct arm64_sim_compact_step *__a64_c_step = &__arm64_sim_steps_tracee_trace_do_mmap[__a64_c_pc];
