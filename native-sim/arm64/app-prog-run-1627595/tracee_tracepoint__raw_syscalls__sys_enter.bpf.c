...
struct {
	...
	__type(key, __u32);
	__type(value, __u64);
} sys_enter_init_tail_1 SEC(".maps");
...
static const struct arm64_sim_compact_step __arm64_sim_steps_tracee_tracepoint__raw_syscalls__sys_enter[] = {
	...
	{ ARM64_SIM_C_TBZ, ARM64_OP_NOP, ARM64_REG_NONE, ARM64_X8, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, 22ULL, 22U, 0, 0 },
	...
	{ ARM64_SIM_C_OP, ARM64_OP_ADRP_GOT, ARM64_X1, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, ((__u64)(long)&sys_enter_init_tail_1), 0U, 0, 0 },
...
SEC("xdp")
int tracee_tracepoint__raw_syscalls__sys_enter_arm64_sim_xdp(struct xdp_md *ctx)
{
	...
	for (__u32 __a64_c_guard = 0; __a64_c_guard < __a64_c_guard_limit; __a64_c_guard++) {
		if (__a64_c_pc >= 33U)
			break;
		const struct arm64_sim_compact_step *__a64_c_step = &__arm64_sim_steps_tracee_tracepoint__raw_syscalls__sys_enter[__a64_c_pc];
