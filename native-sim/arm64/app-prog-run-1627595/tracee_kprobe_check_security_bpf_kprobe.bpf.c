...
#define ARM64_SIM_C_HELPER_bpf_map_update_elem 1U
...
static const struct arm64_sim_compact_step __arm64_sim_steps_tracee_kprobe_check_security_bpf_kprobe[] = {
	...
	{ ARM64_SIM_C_OP, ARM64_OP_ADRP_GOT, ARM64_X0, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, ((__u64)(long)&check_result_map_0), 0U, 0, 0 },
...
SEC("xdp")
int tracee_kprobe_check_security_bpf_kprobe_arm64_sim_xdp(struct xdp_md *ctx)
{
	ARM64_SIM_ENTRY_XDP(ctx);
	__u32 __a64_c_pc = 0;
	__u32 __a64_c_guard_limit = 120U;
	#pragma clang loop unroll(disable)
	for (__u32 __a64_c_guard = 0; __a64_c_guard < __a64_c_guard_limit; __a64_c_guard++) {
		if (__a64_c_pc >= 15U)
			break;
		const struct arm64_sim_compact_step *__a64_c_step = &__arm64_sim_steps_tracee_kprobe_check_security_bpf_kprobe[__a64_c_pc];
