...
static const __u64 __arm64_rodata_0[2] = {8367798494427701574ULL, 8367798477130965103ULL};
...
static const struct arm64_sim_compact_step __arm64_sim_steps_otelcol_ebpf_profiler_read_task_struct[] = {
	...
	{ ARM64_SIM_C_OP, ARM64_OP_CMP_REG, ARM64_X19, ARM64_X0, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, ARM64_AUX_ALU(0, ARM64_MOD_LSR, 32), 0, 0U, 0, 0 },
	...
	{ ARM64_SIM_C_OP, ARM64_OP_STORE, ARM64_X20, ARM64_X21, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, ARM64_AUX_MEM(ARM64_REG_NONE, ARM64_MOD_NONE, 0, 0), 0ULL, 0U, 0, 0 },
	...
	{ ARM64_SIM_C_OP, ARM64_OP_ALU_REG, ARM64_X19, ARM64_X8, ARM64_X0, ARM64_REG_NONE, ARM64_WIDTH_64, ARM64_AUX_ALU(ARM64_ALU_ADD, ARM64_MOD_NONE, 0), 0, 0U, 0, 0 },
	{ ARM64_SIM_C_OP, ARM64_OP_ALU_IMM, ARM64_X0, ARM64_X20, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, ARM64_AUX_ALU(ARM64_ALU_ADD, ARM64_MOD_NONE, 0), 12ULL, 0U, 0, 0 },
	...
	{ ARM64_SIM_C_CBNZ, ARM64_OP_NOP, ARM64_REG_NONE, ARM64_X8, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_32, 0, 0, 45U, 0, 0 },
...
SEC("xdp")
int otelcol_ebpf_profiler_read_task_struct_arm64_sim_xdp(struct xdp_md *ctx)
{
	...
	for (__u32 __a64_c_guard = 0; __a64_c_guard < __a64_c_guard_limit; __a64_c_guard++) {
		if (__a64_c_pc >= 63U)
			break;
		const struct arm64_sim_compact_step *__a64_c_step = &__arm64_sim_steps_otelcol_ebpf_profiler_read_task_struct[__a64_c_pc];
