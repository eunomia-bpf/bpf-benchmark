...
static const struct arm64_sim_compact_step __arm64_sim_steps_cilium_bpf_host_cil_host_policy[] = {
...
SEC("xdp")
int cilium_bpf_host_cil_host_policy_arm64_sim_xdp(struct xdp_md *ctx)
{
	...
	for (__u32 __a64_c_guard = 0; __a64_c_guard < __a64_c_guard_limit; __a64_c_guard++) {
		if (__a64_c_pc >= 3U)
			break;
		const struct arm64_sim_compact_step *__a64_c_step = &__arm64_sim_steps_cilium_bpf_host_cil_host_policy[__a64_c_pc];
