...
static const struct arm64_sim_compact_step __arm64_sim_steps_tetragon_bpf_fmodret_enforcer_fmodret_enforcer[] = {
	...
	{ ARM64_SIM_C_CBZ, ARM64_OP_NOP, ARM64_REG_NONE, ARM64_X8, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_32, 0, 0, 17U, 0, 0 },
	{ ARM64_SIM_C_OP, ARM64_OP_MOV_IMM, ARM64_X8, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_32, 0, 109ULL, 0U, 0, 0 },
	{ ARM64_SIM_C_OP, ARM64_OP_LDRSH, ARM64_X0, ARM64_X19, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_32, ARM64_AUX_MEM(ARM64_REG_NONE, ARM64_MOD_NONE, 0, 0), 2ULL, 0U, 0, 0 },
	{ ARM64_SIM_C_HELPER, ARM64_OP_NOP, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, 0, 0U, 0, ARM64_SIM_C_HELPER_bpf_map_lookup_elem },
	...
	{ ARM64_SIM_C_OP, ARM64_OP_LDRSH, ARM64_X0, ARM64_X19, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, ARM64_AUX_MEM(ARM64_REG_NONE, ARM64_MOD_NONE, 0, 0), 0ULL, 0U, 0, 0 },
	{ ARM64_SIM_C_OP, ARM64_OP_NOP, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, 0, 0U, 0, 0 },
...
SEC("xdp")
int tetragon_bpf_fmodret_enforcer_fmodret_enforcer_arm64_sim_xdp(struct xdp_md *ctx)
{
	...
	for (__u32 __a64_c_guard = 0; __a64_c_guard < __a64_c_guard_limit; __a64_c_guard++) {
		if (__a64_c_pc >= 27U)
			break;
		const struct arm64_sim_compact_step *__a64_c_step = &__arm64_sim_steps_tetragon_bpf_fmodret_enforcer_fmodret_enforcer[__a64_c_pc];
