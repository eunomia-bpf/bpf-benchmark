...
struct {
	...
	__type(key, __u32);
	__type(value, __u64);
} execve_map_update_data_0 SEC(".maps");
...
static const struct arm64_sim_compact_step __arm64_sim_steps_tetragon_bpf_execve_map_update_execve_map_update[] = {
	...
	{ ARM64_SIM_C_OP, ARM64_OP_ADRP_GOT, ARM64_X0, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, ((__u64)(long)&execve_map_update_data_0), 0U, 0, 0 },
	...
	{ ARM64_SIM_C_OP, ARM64_OP_CSETM, ARM64_X0, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_32, ARM64_COND_EQ, 0, 0U, 0, 0 },
	...
	{ ARM64_SIM_C_JMP, ARM64_OP_NOP, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, 0, 12U, 0, 0 },
...
SEC("xdp")
int tetragon_bpf_execve_map_update_execve_map_update_arm64_sim_xdp(struct xdp_md *ctx)
{
	ARM64_SIM_ENTRY_XDP(ctx);
	__u32 __a64_c_pc = 0;
	__u32 __a64_c_guard_limit = 104U;
	#pragma clang loop unroll(disable)
	for (__u32 __a64_c_guard = 0; __a64_c_guard < __a64_c_guard_limit; __a64_c_guard++) {
		if (__a64_c_pc >= 13U)
			break;
		const struct arm64_sim_compact_step *__a64_c_step = &__arm64_sim_steps_tetragon_bpf_execve_map_update_execve_map_update[__a64_c_pc];
		...
		if (__a64_c_kind == ARM64_SIM_C_OP) {
			...
			case ARM64_OP_CMP_IMM:
				...
				break;
			case ARM64_OP_CSETM:
				ARM64_SIM_L_EXEC(ARM64_OP_CSETM, __a64_c_dst, __a64_c_src, __a64_c_src2, __a64_c_src3, __a64_c_width, __a64_c_aux, __a64_c_imm);
				break;
			case ARM64_OP_LOAD:
