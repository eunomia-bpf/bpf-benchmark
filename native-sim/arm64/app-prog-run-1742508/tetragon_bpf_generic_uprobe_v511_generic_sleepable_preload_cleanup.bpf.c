...
static const struct arm64_sim_compact_step __arm64_sim_steps_tetragon_bpf_generic_uprobe_v511_generic_sleepable_preload_cleanup[] = {
	...
	{ ARM64_SIM_C_OP, ARM64_OP_ADRP_GOT, ARM64_X0, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, ((__u64)(long)&sleepable_preload_0), 0U, 0, 0 },
...
SEC("xdp")
int tetragon_bpf_generic_uprobe_v511_generic_sleepable_preload_cleanup_arm64_sim_xdp(struct xdp_md *ctx)
{
	...
	for (__u32 __a64_c_guard = 0; __a64_c_guard < __a64_c_guard_limit; __a64_c_guard++) {
		if (__a64_c_pc >= 13U)
			break;
		const struct arm64_sim_compact_step *__a64_c_step = &__arm64_sim_steps_tetragon_bpf_generic_uprobe_v511_generic_sleepable_preload_cleanup[__a64_c_pc];
