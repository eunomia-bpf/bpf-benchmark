...
static const struct arm64_sim_compact_step __arm64_sim_steps_tetragon_bpf_generic_kprobe_v511_generic_kprobe_override[] = {
	...
	{ ARM64_SIM_C_OP, ARM64_OP_ADRP_GOT, ARM64_X0, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, ((__u64)(long)&override_tasks_0), 0U, 0, 0 },
	...
	{ ARM64_SIM_C_CBZ, ARM64_OP_NOP, ARM64_REG_NONE, ARM64_X0, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, 0, 21U, 0, 0 },
	{ ARM64_SIM_C_OP, ARM64_OP_MOV_IMM, ARM64_X8, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_32, 0, 58ULL, 0U, 0, 0 },
	{ ARM64_SIM_C_OP, ARM64_OP_LDRSW, ARM64_X1, ARM64_X0, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, ARM64_AUX_MEM(ARM64_REG_NONE, ARM64_MOD_NONE, 0, 0), 0ULL, 0U, 0, 0 },
...
SEC("xdp")
int tetragon_bpf_generic_kprobe_v511_generic_kprobe_override_arm64_sim_xdp(struct xdp_md *ctx)
{
	...
	for (__u32 __a64_c_guard = 0; __a64_c_guard < __a64_c_guard_limit; __a64_c_guard++) {
		if (__a64_c_pc >= 27U)
			break;
		const struct arm64_sim_compact_step *__a64_c_step = &__arm64_sim_steps_tetragon_bpf_generic_kprobe_v511_generic_kprobe_override[__a64_c_pc];
