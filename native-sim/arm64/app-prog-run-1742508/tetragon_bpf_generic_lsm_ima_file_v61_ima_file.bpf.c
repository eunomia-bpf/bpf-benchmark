...
static const struct arm64_sim_compact_step __arm64_sim_steps_tetragon_bpf_generic_lsm_ima_file_v61_ima_file[] = {
...
SEC("xdp")
int tetragon_bpf_generic_lsm_ima_file_v61_ima_file_arm64_sim_xdp(struct xdp_md *ctx)
{
	...
	for (__u32 __a64_c_guard = 0; __a64_c_guard < __a64_c_guard_limit; __a64_c_guard++) {
		if (__a64_c_pc >= 35U)
			break;
		const struct arm64_sim_compact_step *__a64_c_step = &__arm64_sim_steps_tetragon_bpf_generic_lsm_ima_file_v61_ima_file[__a64_c_pc];
