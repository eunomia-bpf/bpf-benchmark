...
#define ARM64_SIM_C_HELPER_bpf_probe_read_kernel 2U
...
static const struct arm64_sim_compact_step __arm64_sim_steps_tetragon_bpf_cgtracker_tg_cgtracker_cgroup_release[] = {
	{ ARM64_SIM_C_OP, ARM64_OP_STP, ARM64_SP, ARM64_X30, ARM64_XZR, ARM64_REG_NONE, ARM64_WIDTH_64, ARM64_AUX_MEM(ARM64_REG_NONE, ARM64_MOD_NONE, 0, ARM64_MEM_PRE), 18446744073709551600ULL, 0U, 0, 0 },
	...
	{ ARM64_SIM_C_CBZ, ARM64_OP_NOP, ARM64_REG_NONE, ARM64_X8, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, 0, 24U, 0, 0 },
	...
	{ ARM64_SIM_C_OP, ARM64_OP_ADRP_GOT, ARM64_X0, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, ((__u64)(long)&tg_cgtracker_map_0), 0U, 0, 0 },
...
SEC("xdp")
int tetragon_bpf_cgtracker_tg_cgtracker_cgroup_release_arm64_sim_xdp(struct xdp_md *ctx)
{
	...
	for (__u32 __a64_c_guard = 0; __a64_c_guard < __a64_c_guard_limit; __a64_c_guard++) {
		if (__a64_c_pc >= 29U)
			break;
		const struct arm64_sim_compact_step *__a64_c_step = &__arm64_sim_steps_tetragon_bpf_cgtracker_tg_cgtracker_cgroup_release[__a64_c_pc];
