...
static const struct arm64_sim_compact_step __arm64_sim_steps_otelcol_ebpf_profiler_kprobe__dummy[] = {
	...
	{ ARM64_SIM_C_OP, ARM64_OP_ADRP_GOT, ARM64_X1, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_REG_NONE, ARM64_WIDTH_64, 0, ((__u64)(long)&kprobe_progs_0), 0U, 0, 0 },
...
SEC("xdp")
int otelcol_ebpf_profiler_kprobe__dummy_arm64_sim_xdp(struct xdp_md *ctx)
{
	...
	for (__u32 __a64_c_guard = 0; __a64_c_guard < __a64_c_guard_limit; __a64_c_guard++) {
		if (__a64_c_pc >= 11U)
			break;
		const struct arm64_sim_compact_step *__a64_c_step = &__arm64_sim_steps_otelcol_ebpf_profiler_kprobe__dummy[__a64_c_pc];
