...
- Uses `e2e/cases/tracee/config.yaml` plus `corpus/build/<arch>/tracee/tracee.bpf.o`
...
- Uses `corpus/build/<arch>/tetragon/bpf_execve_event.bpf.o` and `corpus/build/<arch>/tetragon/bpf_generic_kprobe.bpf.o`
...
- Uses `corpus/build/<arch>/bcc/libbpf-tools/.output`
...
- `make vm-e2e` now prepares `corpus/build/<arch>/scx/bin/scx_rusty` before entering the VM
- Uses `corpus/build/<arch>/scx/scx_rusty_main.bpf.o`
