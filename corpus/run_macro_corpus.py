...
try:
    from _driver_impl_run_macro_corpus import *  # type: ignore[F403]
except ImportError:
    from corpus._driver_impl_run_macro_corpus import *  # type: ignore[F403]


def _main_through_driver() -> int:
    from micro.driver import main as driver_main
    return driver_main(["corpus", "macro", "--", *sys.argv[1:]])
