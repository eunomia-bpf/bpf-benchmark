...
try:
    from _driver_impl_run_corpus_perf import *  # type: ignore[F403]
except ImportError:
    from corpus._driver_impl_run_corpus_perf import *  # type: ignore[F403]


def _main_through_driver() -> int:
    from micro.driver import main as driver_main
    return driver_main(["corpus", "perf", "--", *sys.argv[1:]])
