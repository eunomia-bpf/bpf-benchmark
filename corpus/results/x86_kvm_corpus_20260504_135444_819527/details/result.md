...
```json
{
  ...
  "generated_at": "2026-05-04T13:55:01.822430+00:00",
  "kop_modules": {
    "captured_at": "2026-05-04T13:54:44.850120+00:00",
    ...
    "module_load": {
      ...
      "failed_modules": [],
      "invoked_at": "2026-05-04T13:54:44.850056+00:00",
      "loaded_count": 6,
      "loaded_modules": [
        "bpf_bulk_memory",
        "bpf_endian",
      ...
      "snapshot_after": {
        "captured_at": "2026-05-04T13:54:44.850048+00:00",
        "expected_modules": [
          "bpf_bulk_memory",
          "bpf_endian",
          "bpf_extract",
    ...
    "module_snapshot_before_daemon": {
      "captured_at": "2026-05-04T13:54:44.835221+00:00",
      "expected_modules": [
        "bpf_bulk_memory",
        "bpf_endian",
        "bpf_extract",
  ...
  "per_program": [
    {
      "app": "cilium/agent",
      "baseline_avg_ns_per_run": 1459.2339743589744,
      "baseline_run_cnt_delta": 312,
      "baseline_run_time_ns_delta": 455281,
      "post_rejit_avg_ns_per_run": 1234.812030075188,
      "post_rejit_run_cnt_delta": 266,
      "post_rejit_run_time_ns_delta": 328460,
      "program": "cil_from_netdev",
      "program_id": 103,
      "ratio": 0.8462056474648814,
      "runner": "cilium",
      "type": "sched_cls",
      "workload": "network"
    }
  ...
  "results": [
    {
      "app": "calico/felix",
      "baseline": null,
      "error": "calicoctl binary not found; expected at corpus/build/calico/bin/calicoctl, /home/yunwei37/workspace/bpf-benchmark/runner/repos/calico/bin/calicoctl, /usr/bin/calicoctl, or BPFREJIT_REPO_ARTIFACT_ROOT/calico/bin/calicoctl",
      "post_rejit": null,
      "rejit_result": null,
      "runner": "calico",
    ...
    },
    {
      ...
      "baseline": {
        "bpf": {
          ...
          "86": {
            "avg_ns_per_run": 1504.0,
            "bytes_jited": 3340,
            "bytes_xlated": 5952,
            "id": 86,
            "name": "cil_from_host",
            "run_cnt_delta": 1,
            "run_time_ns_delta": 1504,
            "type": "sched_cls"
          },
          "87": {
            "avg_ns_per_run": null,
          ...
          "103": {
            "avg_ns_per_run": 1459.2339743589744,
            "bytes_jited": 3094,
            "bytes_xlated": 5368,
            "id": 103,
            "name": "cil_from_netdev",
            "run_cnt_delta": 312,
            "run_time_ns_delta": 455281,
            "type": "sched_cls"
          },
          "104": {
            "avg_ns_per_run": null,
        ...
        "workloads": [
          {
            "duration_s": 1.007211883999986,
            "ops_per_sec": 139.99040543489255,
            "ops_total": 141.0,
            "stderr": "",
            "stdout": "Running 1s test @ http://198.18.0.2:18080/\n  2 threads and 10 connections\n  Thread Stats   Avg      Stdev     Max   +/- Stdev\n    Latency    48.49ms   10.82ms  60.14ms   86.52%\n    Req/Sec    70.50     10.99    90.00     95.00%\n  141 requests in 1.00s, 22.29KB read\nRequests/sec:    140.66\nTransfer/sec:     22.23KB"
          }
        ]
      },
      "error": "",
      "post_rejit": {
        "bpf": {
          ...
          "103": {
            "avg_ns_per_run": 1234.812030075188,
            "bytes_jited": 3118,
            "bytes_xlated": 5496,
            "id": 103,
            "name": "cil_from_netdev",
            "run_cnt_delta": 266,
            "run_time_ns_delta": 328460,
            "type": "sched_cls"
          },
          "104": {
            "avg_ns_per_run": null,
        ...
        "workloads": [
          {
            "duration_s": 1.006414927999998,
            "ops_per_sec": 119.23511532014977,
            "ops_total": 120.0,
            "stderr": "",
            "stdout": "Running 1s test @ http://198.18.0.2:18080/\n  2 threads and 10 connections\n  Thread Stats   Avg      Stdev     Max   +/- Stdev\n    Latency    48.32ms   10.87ms  60.42ms   90.00%\n    Req/Sec    60.05     41.19   101.00    100.00%\n  120 requests in 1.00s, 18.97KB read\nRequests/sec:    119.60\nTransfer/sec:     18.91KB"
          }
        ]
      },
      "rejit_result": {
        ...
        "error_programs": [
          ...
          },
          {
            "applied": false,
            "changed": false,
            "error": "prog 83 pass bulk_memory failed after 4 committed passes: kernel rejected BPF_PROG_REJIT: BPF_PROG_REJIT errno 16: Device or resource busy (os error 16)\nverifier log summary:\nfunc#0 @0\nLive regs before insn:\n      0: .1........ (bf) r6 = r1\n      1: ......6... (61) r7 = *(u32 *)(r6 +48)\n      2: ......67.. (b4) w1 = 0\n      3: .1....67.. (63) *(u32 *)(r6 +48) = r1\n      4: ......67.. (18) r1 = 0xffffcbe080272004\n      6: .1....67.. (71) r1 = *(u8 *)(r1 +0)\n      7: .1....67.. (61) r2 = *(u32 *)(r6 +80)\n      8: .12...67.. (61) r3 = *(u32 *)(r6 +76)\n      9: .123..67.. (0f) r3 += r1\n     10: ..23..67.. (b4) w0 = -134\n     11: 0.23..67.. (07) r3 += 20\n     12: 0.23..67.. (2d) if r3 > r2 goto pc+118\n     13: 0.....67.. (18) r1 = 0xffffcbe08027203c\n     15: 01....67.. (61) r1 = *(u32 *)(r1 +0)\n     16: 0.....67.. (61) r1 = *(u32 *)(r6 +44)\n     17: 01....67.. (63) *(u32 *)(r10 -32) = r1\n     18: 01....67.. (61) r2 = *(u32 *)(r10 -32)\n     19: 012...67.. (63) *(u32 *)(r10 -32) = r1\n     20: 0.2...67.. (54) w2 &= 1\n     21: 0.2...67.. (61) r1 = *(u32 *)(r10 -32)\n     22: 012...67.. (54) w1 &= 2\n     23: 012...67.. (4c) w1 |= w2\n     24: 01....67.. (b4) w8 = 1\n     25: 01....678. (56) if w1 != 0x0 goto pc+1\n     26: 0.....67.. (b4) w8 = 0\n     27: 0.....678. (18) r1 = 0xffffcbe080272004\n     29: 01....678. (71) r1 = *(u8 *)(r1 +0)\n     30: 01....678. (61) r2 = *(u32 *)(r6 +80)\n     31: 012...678. (61) r9 = *(u32 *)(r6 +76)\n     32: 012...6789 (0f) r9 += r1\n     33: 0.2...6789 (bf) r1 = r9\n     34: 012...6789 (07) r1 += 20\n     35: 012...6789 (2d) if r1 > r2 goto pc+95\n     36: ......6789 (61) r1 = *(u32 *)(r9 +16)\n     37: .1....6789 (b7) r2 = 0\n     38: .12...6789 (63) *(u32 *)(r10 -16) = r2\n     39: .12...6789 (63) *(u32 *)(r10 -20) = r2\n     40: .12...6789 (63) *(u32 *)(r10 -24) = r2\n     41: .12...6789 (63) *(u32 *)(r10 -28) = r2\n     42: .1....6789 (63) *(u32 *)(r10 -32) = r1\n     43: ......6789 (b4) w1 = 1\n     44: .1....6789 (73) *(u8 *)(r10 -16) = r1\n     45: ......6789 (bf) r2 = r10\n     46: ..2...6789 (07) r2 += -32\n     47: ..2...6789 (18) r1 = 0xffff8ae145c5a800\n     49: .12...6789 (85) call bpf_map_lookup_elem#1\n     50: 0.....6789 (15) if r0 == 0x0 goto pc+43\n     51: 0.....67.9 (18) r1 = 0xffffcbe080272004\n     53: 01....67.9 (71) r2 = *(u8 *)(r1 +0)\n     54: 0.2...67.9 (61) r1 = *(u32 *)(r0 +8)\n     55: 012...67.9 (54) w1 &= 3\n     56: 012...67.9 (56) if w1 != 0x0 goto pc+62\n     57: 0.2...67.9 (79) r1 = *(u64 *)(r0 +24)\n     58: 012...67.9 (7b) *(u64 *)(r10 -40) = r1\n     59: 0.2...67.9 (79) r1 = *(u64 *)(r0 +16)\n     60: 012...67.9 (7b) *(u64 *)(r10 -48) = r1\n     61: 0.2...67.9 (71) r3 = *(u8 *)(r9 +8)\n     62: 0.23..67.9 (a6) if w3 < 0x2 goto pc+95\n     63: 0.23..67.9 (bf) r8 = r0\n     64: ..23..6789 (bc) w4 = w3\n     65: ..234.6789 (04) w4 += -1\n     66: ..234.6789 (73) *(u8 *)(r9 +8) = r4\n     67: ..234.678. (04) w2 += 10\n     68: ..234.678. (54) w4 &= 255\n     69: ..234.678. (bf) r1 = r6\n     70: .1234.678. (b4) w5 = 2\n     71: .12345678. (85) call bpf_l3_csum_replace#10\n     72: 0.....678. (c6) if w0 s< 0x0 goto pc+105\n     73: ......678. (bf) r3 = r10\n     74: ...3..678. (07) r3 += -40\n     75: ...3..678. (bf) r1 = r6\n     76: .1.3..678. (b4) w2 = 6\n     77: .123..678. (b4) w4 = 6\n     78: .1234.678. (b4) w5 = 0\n     79: .12345678. (85) call bpf_skb_store_bytes#9\n     80: 0.....678. (bc) w1 = w0\n     81: .1....678. (b4) w0 = -141\n     82: 01....678. (c6) if w1 s< 0x0 goto pc+48\n     83: ......678. (bf) r3 = r10\n     84: ...3..678. (07) r3 += -48\n     85: ...3..678. (bf) r1 = r6\n     86: .1.3..678. (b4) w2 = 0\n     87: .123..678. (b4) w4 = 6\n     88: .1234.678. (b4) w5 = 0\n     89: .12345678. (85) call bpf_skb_store_bytes#9\n     90: 0.....678. (bc) w1 = w0\n     91: .1....678. (b4) w0 = -141\n     92: 01....678. (c6) if w1 s< 0x0 goto pc+38\n     93: ......678. (05) goto pc+88\n     94: ......6789 (61) r1 = *(u32 *)(r9 +16)\n     95: .1....678. (b4) w2 = 0\n     96: .12...678. (63) *(u32 *)(r10 -12) = r2\n     97: .12...678. (63) *(u32 *)(r10 -16) = r2\n     98: .12...678. (63) *(u32 *)(r10 -20) = r2\n     99: .1....678. (63) *(u32 *)(r10 -24) = r1\n    100: ......678. (b4) w1 = 64\n    101: .1....678. (63) *(u32 *)(r10 -32) = r1\n    102: ......678. (b4) w1 = 16777216\n    103: .1....678\n... verifier log truncated ...",
            "exit_code": 1,
            "prog_id": 83
          },
          {
            "applied": false,
            "changed": false,
            "error": "prog 88 pass prefetch failed after 5 committed passes: kernel rejected BPF_PROG_REJIT: BPF_PROG_REJIT errno 16: Device or resource busy (os error 16)\nverifier log summary:\nfunc#0 @0\nLive regs before insn:\n      0: .1........ (b7) r4 = 0\n      1: .1..4..... (61) r2 = *(u32 *)(r1 +56)\n      2: .12.4..... (63) *(u32 *)(r10 -56) = r2\n      3: .1..4..... (18) r3 = 0xffffcbe080272049\n      5: .1.34..... (71) r3 = *(u8 *)(r3 +0)\n      6: .1.34..... (16) if w3 == 0x0 goto pc+13\n      7: .1........ (bf) r6 = r1\n      8: ......6... (b4) w1 = 0\n      9: .1....6... (63) *(u32 *)(r10 -48) = r1\n     10: ......6... (bf) r2 = r10\n     11: ..2...6... (07) r2 += -48\n     12: ..2...6... (18) r1 = 0xdeadc0de\n     14: .12...6... (85) call bpf_map_lookup_elem#1\n     15: 0.....6... (b7) r4 = 0\n     16: 0...4.6... (15) if r0 == 0x0 goto pc+2\n     17: 0.....6... (05) goto pc+0\n     18: 0.....6... (79) r4 = *(u64 *)(r0 +0)\n     19: ....4.6... (bf) r1 = r6\n     20: .1..4..... (61) r0 = *(u32 *)(r1 +16)\n     21: 01..4..... (54) w0 &= 65535\n     22: 01..4..... (b4) w3 = 1\n     23: 01.34..... (16) if w0 == 0xdd86 goto pc+1\n     24: .1..4..... (b4) w3 = 0\n     25: .1.34..... (7b) *(u64 *)(r10 -64) = r4\n     26: .1.3...... (61) r6 = *(u32 *)(r1 +64)\n     27: .1.3..6... (61) r2 = *(u32 *)(r1 +0)\n     28: .123..6... (63) *(u32 *)(r10 -80) = r2\n     29: .1.3..6... (18) r0 = 0xffffcbe080272004\n     31: 01.3..6... (71) r0 = *(u8 *)(r0 +0)\n     32: 01.3..6... (b4) w8 = 1\n     33: 01.3..6.8. (16) if w0 == 0x0 goto pc+1\n     34: .1.3..6... (b4) w8 = 0\n     35: .1.3..6.8. (64) w8 <<= 1\n     36: .1.3..6.8. (4c) w8 |= w3\n     37: .1....6.8. (18) r3 = 0xffffcbe08027203c\n     39: .1.3..6.8. (61) r3 = *(u32 *)(r3 +0)\n     40: .1.3..6.8. (61) r2 = *(u32 *)(r1 +0)\n     41: .123..6.8. (63) *(u32 *)(r10 -72) = r2\n     42: .1.3..6.8. (18) r5 = 0xffffcbe08027205c\n     44: .1.3.56.8. (69) r5 = *(u16 *)(r5 +0)\n     45: .1.3.56.8. (61) r7 = *(u32 *)(r1 +40)\n     46: .1.3.5678. (61) r4 = *(u32 *)(r1 +60)\n     47: .1.345678. (61) r2 = *(u32 *)(r1 +52)\n     48: .12345678. (61) r9 = *(u32 *)(r1 +48)\n     49: .123456789 (61) r0 = *(u32 *)(r1 +68)\n     50: 0123456789 (6b) *(u16 *)(r10 -46) = r5\n     51: 01234.6789 (63) *(u32 *)(r10 -44) = r0\n     52: .1234.6789 (b4) w5 = 0\n     53: .123456789 (73) *(u8 *)(r10 -10) = r5\n     54: .123456789 (73) *(u8 *)(r10 -11) = r5\n     55: .123456789 (73) *(u8 *)(r10 -9) = r5\n     56: .1234.6789 (b4) w5 = 1\n     57: .123456789 (73) *(u8 *)(r10 -48) = r5\n     58: .1234.6789 (61) r5 = *(u32 *)(r10 -80)\n     59: .123456789 (63) *(u32 *)(r10 -40) = r5\n     60: .1234.6789 (63) *(u32 *)(r10 -32) = r9\n     61: .1234.678. (63) *(u32 *)(r10 -28) = r2\n     62: .1.34.678. (63) *(u32 *)(r10 -24) = r4\n     63: .1.3..678. (63) *(u32 *)(r10 -16) = r7\n     64: .1.3..6.8. (73) *(u8 *)(r10 -12) = r8\n     65: .1.3..6... (79) r2 = *(u64 *)(r10 -64)\n     66: .123..6... (7b) *(u64 *)(r10 -8) = r2\n     67: .1.3..6... (61) r4 = *(u32 *)(r10 -56)\n     68: .1.34.6... (bc) w2 = w4\n     69: .1234.6... (74) w2 >>= 8\n     70: .1234.6... (73) *(u8 *)(r10 -17) = r2\n     71: .1.34.6... (bc) w2 = w6\n     72: .1234.6... (74) w2 >>= 8\n     73: .1234.6... (73) *(u8 *)(r10 -18) = r2\n     74: .1.34.6... (bc) w2 = w6\n     75: .1234.6... (74) w2 >>= 16\n     76: .1234.6... (6b) *(u16 *)(r10 -20) = r2\n     77: .1.34.6... (73) *(u8 *)(r10 -47) = r4\n     78: .1.3..6... (b4) w2 = 3\n     79: .123..6... (6b) *(u16 *)(r10 -34) = r2\n     80: .1.3..6... (61) r2 = *(u32 *)(r10 -72)\n     81: .123..6... (ae) if w3 < w2 goto pc+1\n     82: .12...6... (bc) w3 = w2\n     83: .1.3..6... (6b) *(u16 *)(r10 -36) = r3\n     84: .1.3..6... (67) r3 <<= 32\n     85: .1.3..6... (18) r2 = 0xffffffff\n     87: .123..6... (4f) r3 |= r2\n     88: .1.3..6... (bf) r4 = r10\n     89: .1.34.6... (07) r4 += -48\n     90: .1.34.6... (18) r2 = 0xffff8ae140348c00\n     92: .1234.6... (b4) w5 = 48\n     93: .123456... (85) call bpf_perf_event_output#25\n     94: ......6... (54) w6 &= 255\n     95: ......6... (bc) w0 = w6\n     96: 0......... (95) exit\n0: R1=ctx() R10=fp0\n0: (b7) r4 = 0                        ; R4=0\n1: (61) r2 = *(u32 *)(r1 +56)         ; R1=ctx() R2=scalar(smin=0,smax=umax=0xffffffff,var_off=(0x0; 0xffffffff))\n2: (63) *(u32 *)(r10 -56) = r2        ; R2=scalar(id=1,smin=0,smax=umax=0xfffff\n... verifier log truncated ...",
            "exit_code": 1,
            "prog_id": 88
          },
          {
          ...
          },
          {
            "applied": false,
            "changed": false,
            "error": "prog 106 pass rotate failed after 0 committed passes: kernel rejected BPF_PROG_REJIT: BPF_PROG_REJIT errno 16: Device or resource busy (os error 16)\nverifier log summary:\nfunc#0 @0\nLive regs before insn:\n      0: .1........ (b7) r4 = 0\n      1: .1..4..... (61) r2 = *(u32 *)(r1 +56)\n      2: .12.4..... (63) *(u32 *)(r10 -56) = r2\n      3: .1..4..... (18) r3 = 0xffffcbe08046a049\n      5: .1.34..... (71) r3 = *(u8 *)(r3 +0)\n      6: .1.34..... (16) if w3 == 0x0 goto pc+12\n      7: .1........ (bf) r6 = r1\n      8: ......6... (b4) w1 = 0\n      9: .1....6... (63) *(u32 *)(r10 -48) = r1\n     10: ......6... (bf) r2 = r10\n     11: ..2...6... (07) r2 += -48\n     12: ..2...6... (18) r1 = 0xdeadc0de\n     14: .12...6... (85) call bpf_map_lookup_elem#1\n     15: 0.....6... (b7) r4 = 0\n     16: 0...4.6... (15) if r0 == 0x0 goto pc+1\n     17: 0.....6... (79) r4 = *(u64 *)(r0 +0)\n     18: ....4.6... (bf) r1 = r6\n     19: .1..4..... (61) r0 = *(u32 *)(r1 +16)\n     20: 01..4..... (54) w0 &= 65535\n     21: 01..4..... (b4) w3 = 1\n     22: 01.34..... (16) if w0 == 0xdd86 goto pc+1\n     23: .1..4..... (b4) w3 = 0\n     24: .1.34..... (7b) *(u64 *)(r10 -64) = r4\n     25: .1.3...... (61) r6 = *(u32 *)(r1 +64)\n     26: .1.3..6... (61) r2 = *(u32 *)(r1 +0)\n     27: .123..6... (63) *(u32 *)(r10 -80) = r2\n     28: .1.3..6... (18) r0 = 0xffffcbe08046a004\n     30: 01.3..6... (71) r0 = *(u8 *)(r0 +0)\n     31: 01.3..6... (b4) w8 = 1\n     32: 01.3..6.8. (16) if w0 == 0x0 goto pc+1\n     33: .1.3..6... (b4) w8 = 0\n     34: .1.3..6.8. (64) w8 <<= 1\n     35: .1.3..6.8. (4c) w8 |= w3\n     36: .1....6.8. (18) r3 = 0xffffcbe08046a03c\n     38: .1.3..6.8. (61) r3 = *(u32 *)(r3 +0)\n     39: .1.3..6.8. (61) r2 = *(u32 *)(r1 +0)\n     40: .123..6.8. (63) *(u32 *)(r10 -72) = r2\n     41: .1.3..6.8. (18) r5 = 0xffffcbe08046a05c\n     43: .1.3.56.8. (69) r5 = *(u16 *)(r5 +0)\n     44: .1.3.56.8. (61) r7 = *(u32 *)(r1 +40)\n     45: .1.3.5678. (61) r4 = *(u32 *)(r1 +60)\n     46: .1.345678. (61) r2 = *(u32 *)(r1 +52)\n     47: .12345678. (61) r9 = *(u32 *)(r1 +48)\n     48: .123456789 (61) r0 = *(u32 *)(r1 +68)\n     49: 0123456789 (6b) *(u16 *)(r10 -46) = r5\n     50: 01234.6789 (63) *(u32 *)(r10 -44) = r0\n     51: .1234.6789 (b4) w5 = 0\n     52: .123456789 (73) *(u8 *)(r10 -10) = r5\n     53: .123456789 (73) *(u8 *)(r10 -11) = r5\n     54: .123456789 (73) *(u8 *)(r10 -9) = r5\n     55: .1234.6789 (b4) w5 = 1\n     56: .123456789 (73) *(u8 *)(r10 -48) = r5\n     57: .1234.6789 (61) r5 = *(u32 *)(r10 -80)\n     58: .123456789 (63) *(u32 *)(r10 -40) = r5\n     59: .1234.6789 (63) *(u32 *)(r10 -32) = r9\n     60: .1234.678. (63) *(u32 *)(r10 -28) = r2\n     61: .1.34.678. (63) *(u32 *)(r10 -24) = r4\n     62: .1.3..678. (63) *(u32 *)(r10 -16) = r7\n     63: .1.3..6.8. (73) *(u8 *)(r10 -12) = r8\n     64: .1.3..6... (79) r2 = *(u64 *)(r10 -64)\n     65: .123..6... (7b) *(u64 *)(r10 -8) = r2\n     66: .1.3..6... (61) r4 = *(u32 *)(r10 -56)\n     67: .1.34.6... (bc) w2 = w4\n     68: .1234.6... (74) w2 >>= 8\n     69: .1234.6... (73) *(u8 *)(r10 -17) = r2\n     70: .1.34.6... (bc) w2 = w6\n     71: .1234.6... (74) w2 >>= 8\n     72: .1234.6... (73) *(u8 *)(r10 -18) = r2\n     73: .1.34.6... (bc) w2 = w6\n     74: .1234.6... (74) w2 >>= 16\n     75: .1234.6... (6b) *(u16 *)(r10 -20) = r2\n     76: .1.34.6... (73) *(u8 *)(r10 -47) = r4\n     77: .1.3..6... (b4) w2 = 3\n     78: .123..6... (6b) *(u16 *)(r10 -34) = r2\n     79: .1.3..6... (61) r2 = *(u32 *)(r10 -72)\n     80: .123..6... (ae) if w3 < w2 goto pc+1\n     81: .12...6... (bc) w3 = w2\n     82: .1.3..6... (6b) *(u16 *)(r10 -36) = r3\n     83: .1.3..6... (67) r3 <<= 32\n     84: .1.3..6... (18) r2 = 0xffffffff\n     86: .123..6... (4f) r3 |= r2\n     87: .1.3..6... (bf) r4 = r10\n     88: .1.34.6... (07) r4 += -48\n     89: .1.34.6... (18) r2 = 0xffff8ae140348c00\n     91: .1234.6... (b4) w5 = 48\n     92: .123456... (85) call bpf_perf_event_output#25\n     93: ......6... (54) w6 &= 255\n     94: ......6... (bc) w0 = w6\n     95: 0......... (95) exit\n0: R1=ctx() R10=fp0\n0: (b7) r4 = 0                        ; R4=0\n1: (61) r2 = *(u32 *)(r1 +56)         ; R1=ctx() R2=scalar(smin=0,smax=umax=0xffffffff,var_off=(0x0; 0xffffffff))\n2: (63) *(u32 *)(r10 -56) = r2        ; R2=scalar(id=1,smin=0,smax=umax=0xffffffff,var_off=(0x0; 0xffffffff)) R10=\n... verifier log truncated ...",
            "exit_code": 1,
            "prog_id": 106
          }
        ],
  ...
  "summary": {
    "losses": 0,
    "per_program_geomean": 0.8462056474648814,
    "program_count": 1,
    "wins": 1
  },
