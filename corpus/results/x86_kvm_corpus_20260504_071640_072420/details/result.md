...
```json
{
  ...
  "generated_at": "2026-05-04T07:17:02.959904+00:00",
  "kinsn_modules": {
    "captured_at": "2026-05-04T07:16:40.101447+00:00",
    ...
    "module_load": {
      ...
      "failed_modules": [],
      "invoked_at": "2026-05-04T07:16:40.101383+00:00",
      "loaded_count": 6,
      "loaded_modules": [
        "bpf_bulk_memory",
        "bpf_endian",
      ...
      "snapshot_after": {
        "captured_at": "2026-05-04T07:16:40.101376+00:00",
        "expected_modules": [
          "bpf_bulk_memory",
          "bpf_endian",
          "bpf_extract",
    ...
    "module_snapshot_before_daemon": {
      "captured_at": "2026-05-04T07:16:40.087961+00:00",
      "expected_modules": [
        "bpf_bulk_memory",
        "bpf_endian",
        "bpf_extract",
  ...
  "per_program": [
    {
      "app": "katran",
      "baseline_avg_ns_per_run": 307.7522893019685,
      "baseline_run_cnt_delta": 36474,
      "baseline_run_time_ns_delta": 11224957,
      "post_rejit_avg_ns_per_run": 297.4585798816568,
      "post_rejit_run_cnt_delta": 37518,
      "post_rejit_run_time_ns_delta": 11160051,
      "program": "xdp_root",
      "program_id": 10,
      "ratio": 0.9665519647517181,
      "runner": "katran",
      "type": "xdp",
      "workload": "network"
    }
  ...
  "results": [
    {
      ...
      "baseline": {
        "bpf": {
          "10": {
            "avg_ns_per_run": 307.7522893019685,
            "bytes_jited": 176,
            "bytes_xlated": 136,
            "id": 10,
            "name": "xdp_root",
            "run_cnt_delta": 36474,
            "run_time_ns_delta": 11224957,
            "type": "xdp"
          },
          "16": {
            "avg_ns_per_run": null,
        ...
        "workloads": [
          {
            "duration_s": 1.0005729979999956,
            "ops_per_sec": 6075.518739913095,
            "ops_total": 6079.0,
            "stderr": "",
            "stdout": ""
          }
      ...
      "post_rejit": {
        "bpf": {
          "10": {
            "avg_ns_per_run": 297.4585798816568,
            "bytes_jited": 176,
            "bytes_xlated": 136,
            "id": 10,
            "name": "xdp_root",
            "run_cnt_delta": 37518,
            "run_time_ns_delta": 11160051,
            "type": "xdp"
          },
          "16": {
            "avg_ns_per_run": null,
        ...
        "workloads": [
          {
            "duration_s": 1.0004197180000176,
            "ops_per_sec": 6250.376604432231,
            "ops_total": 6253.0,
            "stderr": "",
            "stdout": ""
          }
  ...
  "summary": {
    "losses": 0,
    "per_program_geomean": 0.9665519647517181,
    "program_count": 1,
    "wins": 1
  },
