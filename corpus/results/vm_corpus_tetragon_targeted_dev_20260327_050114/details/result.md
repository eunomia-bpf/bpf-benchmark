...
- Generated: 2026-03-27T05:01:14.218752+00:00
...
| --- | --- | --- | --- | --- | --- |
| tetragon:bpf_execve_event.bpf.o | 1 | 499443707 | 443671768 | ok |  |
| tetragon:bpf_fork.bpf.o | 1 | 295686207 | 285467931 | ok |  |

## Per-Program Results

| Program | Repo | Type | Compile Passes | Run Passes | Baseline JIT | REJIT JIT | Code Ratio | Baseline ns | REJIT ns | Exec Ratio | Note |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| tetragon:bpf_execve_event.bpf.o:event_execve | tetragon | tracepoint | - | - | n/a | n/a | n/a | n/a | n/a | n/a | bpf_object__load failed: Bad file descriptor |
| tetragon:bpf_fork.bpf.o:event_wake_up_new_task | tetragon | kprobe | - | - | n/a | n/a | n/a | n/a | n/a | n/a | fixture map 'execve_map' id mismatch: fixture=283 live=556 |

## Top Failure Reasons

| Reason | Count |
| --- | --- |
| bpf_object__load failed: Bad file descriptor | 4 |
| fixture map 'execve_map' id mismatch: fixture=283 live=418 | 1 |
| fixture map 'execve_map' id mismatch: fixture=283 live=556 | 1 |
| fixture map 'execve_map' id mismatch: fixture=283 live=464 | 1 |
| fixture map 'execve_map' id mismatch: fixture=283 live=602 | 1 |
