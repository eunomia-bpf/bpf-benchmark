...
- Generated: 2026-03-27T17:24:02.417917+00:00
...
- Code-size ratio geomean (baseline/rejit): 1.002x
- Exec-time ratio geomean (baseline/rejit): 0.476x
...
| --- | --- | --- | --- | --- | --- | --- |
| katran | 1 | 1 | 1 | 1 | 1.002x | 0.476x |

## By Object

| Object | Programs | Compile | REJIT Compile | Status | Error |
| --- | --- | --- | --- | --- | --- |
| katran:balancer.bpf.o | 1 | 112333265 | 99170990 | ok |  |

## Per-Program Results

| Program | Repo | Type | Compile Passes | Run Passes | Baseline JIT | REJIT JIT | Code Ratio | Baseline ns | REJIT ns | Exec Ratio | Note |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| katran:balancer.bpf.o:balancer_ingress | katran | xdp | map_inline | map_inline | 13656 | 13634 | 1.002x | 1474 | 3096 | 0.476x |  |
