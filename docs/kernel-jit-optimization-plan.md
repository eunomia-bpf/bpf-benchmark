...
> 上次更新：2026-03-12（#141 ✅ per_family v1→v2；#140 ✅ Tetragon connect_storm = workload noise；#139 ✅ micro authoritative rerun 56/56 valid, applied-only 1.049x；#138 ✅ cmov/extract correctness fix；#137 ✅ bpftrace policy artifacts；#133 ✅ corpus v2 fixed 0.875x；此前：#134 ✅ E2E rerun；#130-#132 ✅ steady-state/inline/spec fixes；#135-#136 ✅ parser consistency + plan doc fix；#128-#129 ✅ corpus diagnosis + micro mismatch fix；#118-#126 ✅ kernel-recompile micro/XDP/corpus/per-family/gap/tuned）
