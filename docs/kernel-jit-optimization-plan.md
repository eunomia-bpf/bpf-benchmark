...
- **1.3 `bpfopt` CLI 完整版**：已提供 12 个 pass 子命令、`optimize`、`list-passes`，缺少 required side-input 或 kinsn 不可用时退出 1（`b0da364`、`aaaaa76`；见 `docs/tmp/bpfopt-cli-review-20260428.md`）。
