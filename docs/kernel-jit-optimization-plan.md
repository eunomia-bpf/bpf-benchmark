...
| **Micro 62-bench overall (vm-micro Makefile flow, 7de19ef03, 20260314)** | **1.054x** | **✅ 新 Makefile vm-micro 验证通过！36 applied, 19 regressors; kernel 7de19ef03（+guarded-update COND_SELECT emitter）** |
| **Micro 62-bench applied-only (vm-micro 20260314, 36 benches)** | **1.157x** | **✅ 含新 guarded-update emitter 收益；噪声影响：仅 3 iter，sub-100ns benches 噪声大** |
