...
| Coverage | No BPF program, policy check, selector path, or event path is disabled. Fallback selector path still initializes selector state before filtering. | pass |
