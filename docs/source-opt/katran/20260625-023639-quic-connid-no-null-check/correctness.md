# katran quic-connid-no-null-check correctness
...
- Coverage: passed by source inspection; all paths that cannot assign `connId`
  return before the removed block, and long/short header paths still perform
  their bounds checks.
...
- `/dev/nvme0n1p2 915G 692G 177G 80% /`
