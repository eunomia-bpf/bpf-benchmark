#!/usr/bin/env python3
"""Post-hoc kop corpus evaluation tables and figure for 2026-05-31.
...
OUT_MD = ROOT / "docs" / "tmp" / "kop_eval_20260531_summary.md"
FIG_OUT = FIG_DIR / "eval-kop-corpus-20260531.png"
...
def plot_corpus(workloads: list[WorkloadRow], bpf: list[BpfRow], apply: dict[str, dict[str, Counter[str]]]) -> pathlib.Path:
    ...
    ax.set_title("kop apply coverage")
    ...
    fig.suptitle("x86 KVM kop-6 corpus evaluation", fontsize=16)
...
def write_summary(
    ...
    lines: list[str] = []
    lines.append("# KOperation Corpus Evaluation Summary, 2026-05-31")
    lines.append("")
    lines.append("Generated by `docs/tmp/kop_eval_20260531.py` from raw artifacts.")
    lines.append("")
