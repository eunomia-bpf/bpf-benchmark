...
- Overall geomean (stock / recompile, valid pairs only): `1.049x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| spill-pressure | 1 | 1 | 0 | 1.049x | n/a | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| spill_pressure | spill-pressure | 388.5 ns | 370.5 ns | 1.049x | no | 0 | win |
