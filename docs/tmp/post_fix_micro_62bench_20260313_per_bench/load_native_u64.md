...
- Overall geomean (stock / recompile, valid pairs only): `1.329x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| causal-isolation | 1 | 1 | 0 | 1.329x | n/a | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| load_native_u64 | causal-isolation | 97 ns | 73 ns | 1.329x | no | 0 | win |
