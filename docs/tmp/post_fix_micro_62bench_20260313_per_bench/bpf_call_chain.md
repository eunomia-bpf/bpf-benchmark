...
- Overall geomean (stock / recompile, valid pairs only): `0.829x`
- Applied-only geomean (stock / recompile): `0.829x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| bpf-local-call | 1 | 1 | 1 | 0.829x | 0.829x | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| bpf_call_chain | bpf-local-call | 452 ns | 545.5 ns | 0.829x | yes | 3 | loss |
