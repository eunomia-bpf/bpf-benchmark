...
- Overall geomean (stock / recompile, valid pairs only): `1.924x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| endian-fusion | 1 | 1 | 0 | 1.924x | n/a | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| endian_swap_dense | endian-fusion | 280 ns | 145.5 ns | 1.924x | no | 0 | win |
