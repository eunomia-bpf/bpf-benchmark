...
- Overall geomean (stock / recompile, valid pairs only): `0.638x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| branch-flip | 1 | 1 | 0 | 0.638x | n/a | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| branch_flip_dense | branch-flip | 177.5 ns | 278 ns | 0.638x | no | 0 | loss |
