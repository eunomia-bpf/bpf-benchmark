...
- Overall geomean (stock / recompile, valid pairs only): `1.632x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| bpf-local-call | 1 | 1 | 0 | 1.632x | n/a | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| local_call_fanout | bpf-local-call | 219.5 ns | 134.5 ns | 1.632x | no | 0 | win |
