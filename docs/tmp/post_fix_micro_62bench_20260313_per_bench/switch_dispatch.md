...
- Overall geomean (stock / recompile, valid pairs only): `0.789x`
- Applied-only geomean (stock / recompile): `0.789x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| switch-dispatch | 1 | 1 | 1 | 0.789x | 0.789x | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| switch_dispatch | switch-dispatch | 295 ns | 374 ns | 0.789x | yes | 3 | loss |
