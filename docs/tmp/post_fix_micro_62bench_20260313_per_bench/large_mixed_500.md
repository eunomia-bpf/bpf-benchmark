...
- Overall geomean (stock / recompile, valid pairs only): `0.918x`
- Applied-only geomean (stock / recompile): `0.918x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| large-mixed | 1 | 1 | 1 | 0.918x | 0.918x | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| large_mixed_500 | large-mixed | 652 ns | 710 ns | 0.918x | yes | 3 | loss |
