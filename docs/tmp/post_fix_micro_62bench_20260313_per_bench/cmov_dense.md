...
- Overall geomean (stock / recompile, valid pairs only): `0.701x`
- Applied-only geomean (stock / recompile): `0.701x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| select-diamond | 1 | 1 | 1 | 0.701x | 0.701x | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| cmov_dense | select-diamond | 44.5 ns | 63.5 ns | 0.701x | yes | 26 | loss |
