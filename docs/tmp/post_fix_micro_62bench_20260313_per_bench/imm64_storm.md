...
- Overall geomean (stock / recompile, valid pairs only): `0.851x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| immediate-stress | 1 | 1 | 0 | 0.851x | n/a | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| imm64_storm | immediate-stress | 189 ns | 222 ns | 0.851x | no | 0 | loss |
