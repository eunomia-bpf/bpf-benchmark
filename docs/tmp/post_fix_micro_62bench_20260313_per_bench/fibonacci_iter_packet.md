...
- Overall geomean (stock / recompile, valid pairs only): `0.907x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| recurrence | 1 | 1 | 0 | 0.907x | n/a | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| fibonacci_iter_packet | recurrence | 886.5 ns | 977 ns | 0.907x | no | 0 | loss |
