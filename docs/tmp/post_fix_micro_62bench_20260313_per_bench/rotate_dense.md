...
- Overall geomean (stock / recompile, valid pairs only): `1.187x`
- Applied-only geomean (stock / recompile): `1.187x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| rotate-canonical | 1 | 1 | 1 | 1.187x | 1.187x | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| rotate_dense | rotate-canonical | 349 ns | 294 ns | 1.187x | yes | 5 | win |
