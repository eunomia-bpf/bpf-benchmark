...
- Overall geomean (stock / recompile, valid pairs only): `0.560x`
- Applied-only geomean (stock / recompile): `0.560x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| byte-compare | 1 | 1 | 1 | 0.560x | 0.560x | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| memcmp_prefix_64 | byte-compare | 100 ns | 178.5 ns | 0.560x | yes | 3 | loss |
