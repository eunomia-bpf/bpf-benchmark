...
- Overall geomean (stock / recompile, valid pairs only): `0.927x`
- Applied-only geomean (stock / recompile): `0.927x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| bounds-density | 1 | 1 | 1 | 0.927x | 0.927x | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| bounds_ladder | bounds-density | 215 ns | 232 ns | 0.927x | yes | 4 | loss |
