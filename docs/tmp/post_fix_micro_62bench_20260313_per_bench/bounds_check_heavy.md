...
- Overall geomean (stock / recompile, valid pairs only): `1.051x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| bounds-style | 1 | 1 | 0 | 1.051x | n/a | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| bounds_check_heavy | bounds-style | 301 ns | 286.5 ns | 1.051x | no | 0 | win |
