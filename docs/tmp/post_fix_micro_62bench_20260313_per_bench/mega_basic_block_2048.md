...
- Overall geomean (stock / recompile, valid pairs only): `0.831x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| mega-block | 1 | 1 | 0 | 0.831x | n/a | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| mega_basic_block_2048 | mega-block | 942.5 ns | 1.134 us | 0.831x | no | 0 | loss |
