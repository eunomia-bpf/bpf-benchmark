...
- Overall geomean (stock / recompile, valid pairs only): `0.793x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| bitfield-extract | 1 | 1 | 0 | 0.793x | n/a | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| bitfield_extract | bitfield-extract | 277.5 ns | 350 ns | 0.793x | no | 0 | loss |
