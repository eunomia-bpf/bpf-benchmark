...
- Overall geomean (stock / recompile, valid pairs only): `1.066x`
- Applied-only geomean (stock / recompile): `1.066x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| log2-fold | 1 | 1 | 1 | 1.066x | 1.066x | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| log2_fold | log2-fold | 404.5 ns | 379.5 ns | 1.066x | yes | 3 | win |
