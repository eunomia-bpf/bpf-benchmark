...
- Overall geomean (stock / recompile, valid pairs only): `0.984x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| fixed-loop | 1 | 1 | 0 | 0.984x | n/a | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| fixed_loop_large | fixed-loop | 1.765 us | 1.793 us | 0.984x | no | 0 | loss |
