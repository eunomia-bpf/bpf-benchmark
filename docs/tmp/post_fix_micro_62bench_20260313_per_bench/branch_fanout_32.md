...
- Overall geomean (stock / recompile, valid pairs only): `1.024x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| branch-fanout | 1 | 1 | 0 | 1.024x | n/a | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| branch_fanout_32 | branch-fanout | 492 ns | 480.5 ns | 1.024x | no | 0 | win |
