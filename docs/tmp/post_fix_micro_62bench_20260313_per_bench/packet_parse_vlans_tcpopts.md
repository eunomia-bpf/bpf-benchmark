...
- Overall geomean (stock / recompile, valid pairs only): `0.647x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| parser | 1 | 1 | 0 | 0.647x | n/a | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| packet_parse_vlans_tcpopts | parser | 16.5 ns | 25.5 ns | 0.647x | no | 0 | loss |
