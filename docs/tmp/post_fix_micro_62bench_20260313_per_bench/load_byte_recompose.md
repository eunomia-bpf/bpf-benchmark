...
- Overall geomean (stock / recompile, valid pairs only): `0.766x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| causal-isolation | 1 | 1 | 0 | 0.766x | n/a | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| load_byte_recompose | causal-isolation | 185 ns | 241.5 ns | 0.766x | no | 0 | loss |
