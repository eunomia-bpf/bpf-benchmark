...
- Overall geomean (stock / recompile, valid pairs only): `1.157x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| mixed-width | 1 | 1 | 0 | 1.157x | n/a | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| alu32_64_pingpong | mixed-width | 602 ns | 520.5 ns | 1.157x | no | 0 | win |
