...
- Overall geomean (stock / recompile, valid pairs only): `1.037x`
- Applied-only geomean (stock / recompile): `1.037x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| mixed-alu-mem | 1 | 1 | 1 | 1.037x | 1.037x | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| mixed_alu_mem | mixed-alu-mem | 964 ns | 929.5 ns | 1.037x | yes | 3 | win |
