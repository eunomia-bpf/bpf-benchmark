...
- Overall geomean (stock / recompile, valid pairs only): `1.026x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| strength-reduce | 1 | 1 | 0 | 1.026x | n/a | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| smallmul_strength_reduce | strength-reduce | 410.5 ns | 400 ns | 1.026x | no | 0 | win |
