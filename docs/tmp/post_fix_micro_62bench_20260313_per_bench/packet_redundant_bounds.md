...
- Overall geomean (stock / recompile, valid pairs only): `2.042x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| bounds-density | 1 | 1 | 0 | 2.042x | n/a | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| packet_redundant_bounds | bounds-density | 316.5 ns | 155 ns | 2.042x | no | 0 | win |
