...
- Overall geomean (stock / recompile, valid pairs only): `0.784x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| hash-chain | 1 | 1 | 0 | 0.784x | n/a | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| cgroup_hash_chain | hash-chain | 286.5 ns | 365.5 ns | 0.784x | no | 0 | loss |
