...
- Overall geomean (stock / recompile, valid pairs only): `0.846x`
- Applied-only geomean (stock / recompile): `0.846x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| branch-flip | 1 | 1 | 1 | 0.846x | 0.846x | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| branch_flip_dense | branch-flip | 258.5 ns | 305.5 ns | 0.846x | yes | 255 | loss |
