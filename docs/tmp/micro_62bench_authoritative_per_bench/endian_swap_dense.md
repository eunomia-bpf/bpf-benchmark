...
- Overall geomean (stock / recompile, valid pairs only): `0.640x`
- Applied-only geomean (stock / recompile): `0.640x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| endian-fusion | 1 | 1 | 1 | 0.640x | 0.640x | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| endian_swap_dense | endian-fusion | 129 ns | 201.5 ns | 0.640x | yes | 256 | loss |
