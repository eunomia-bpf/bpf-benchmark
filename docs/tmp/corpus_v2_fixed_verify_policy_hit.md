...
- Generated: 2026-03-12T20:54:54.740584+00:00
...
- Exec-time ratio geomean (baseline/v5): 0.890x
- Total sites: 13
- CMOV sites: 0
- WIDE sites: 0
- ROTATE sites: 10
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| calico | 1 | 1 | 1 | 1 | 0 | 0 | 10 | 0 | 0 | 0 | 1 | 2 | 1.046x | 0.890x | 1 |

## By Family

| Family | Programs | Applied | Sites | Applied Sites | Compile Pairs | Measured Pairs | Code Ratio | Exec Ratio | Regressions |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| rotate | 1 | 1 | 10 | 10 | 1 | 1 | 1.046x | 0.890x | 1 |
| branch-flip | 1 | 1 | 2 | 2 | 1 | 1 | 1.046x | 0.890x | 1 |
| endian | 1 | 1 | 1 | 1 | 1 | 1 | 1.046x | 0.890x | 1 |
...
| --- | --- | --- | --- | --- |
| corpus/build/calico/from_hep_debug.bpf.o:calico_tc_maglev | calico | sched_cls | 0.890x | rotate, endian, branch-flip |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| corpus/build/calico/from_hep_debug.bpf.o:calico_tc_maglev | calico | sched_cls | 13 | rotate, endian, branch-flip | 3260 | 3117 | 1.046x | 1244 | 1397 | 0.890x |  |
