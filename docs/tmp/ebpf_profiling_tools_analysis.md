...
- In particular, I did not find a public Google artifact focused on microarchitectural profiling of BPF programs themselves; the public material I found was adjacent, not directly on-point.
...
- Upstream / public sources:
  ...
  - `bpftool` source for `prog profile`:
    - https://github.com/libbpf/bpftool/blob/main/src/prog.c
    - https://github.com/libbpf/bpftool/blob/main/src/skeleton/profiler.bpf.c
