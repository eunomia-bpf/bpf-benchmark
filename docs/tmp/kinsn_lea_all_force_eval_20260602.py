...
OUT_MD = ROOT / "docs" / "tmp" / "kinsn_lea_all_force_eval_20260602_summary.md"
FIG_OUT = ROOT / "docs" / "figures" / "eval-kinsn-lea-all-force-corpus-20260602.png"


def load_helpers() -> Any:
    path = ROOT / "docs" / "tmp" / "kinsn_eval_20260602.py"
    spec = importlib.util.spec_from_file_location("kinsn_eval_20260602_helpers", path)
...
def write_summary(
    ...
    lines: list[str] = []
    lines.append("# LEA All-Force Kinsn Corpus Evaluation, 2026-06-02")
    lines.append("")
    lines.append("Generated by `docs/tmp/kinsn_lea_all_force_eval_20260602.py` from raw artifacts.")
    lines.append("")
