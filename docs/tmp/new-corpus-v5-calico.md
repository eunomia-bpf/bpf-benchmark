...
- Generated: 2026-03-10T22:31:43.734709+00:00
...
| --- | --- |
| Objects attempted | 8 |
| Objects discovered via libbpf | 8 |
| Objects with discovery failures | 0 |
| Programs attempted | 59 |
| Perf-capable targets | 59 |
| Compile-only targets | 0 |
| Baseline compile successes | 59 |
| v5 compile successes | 59 |
| Scanner successes | 59 |
| Programs with framework-detected sites | 44 |
| Programs with recompile applied | 44 |
| Programs with recompile syscall failures | 0 |
| Compile-only size pairs | 59 |
| Measured runtime pairs | 59 |
| Speedup geomean | 1.022x |
