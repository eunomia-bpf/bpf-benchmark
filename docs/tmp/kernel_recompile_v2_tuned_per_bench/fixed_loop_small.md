...
- Overall geomean (stock / recompile, valid pairs only): `1.089x`
- Applied-only geomean (stock / recompile): `1.089x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| fixed-loop | 1 | 1 | 1 | 1.089x | 1.089x | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| fixed_loop_small | fixed-loop | 122 ns | 112 ns | 1.089x | yes | 4 | win |
