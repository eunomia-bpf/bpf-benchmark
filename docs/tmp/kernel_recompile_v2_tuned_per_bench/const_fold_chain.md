...
- Overall geomean (stock / recompile, valid pairs only): `1.142x`
- Applied-only geomean (stock / recompile): `1.142x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| const-fold | 1 | 1 | 1 | 1.142x | 1.142x | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| const_fold_chain | const-fold | 386.5 ns | 338.5 ns | 1.142x | yes | 2 | win |
