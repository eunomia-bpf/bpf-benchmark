...
- Overall geomean (stock / recompile, valid pairs only): `0.980x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| switch-dispatch | 1 | 1 | 0 | 0.980x | n/a | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| switch_dispatch | switch-dispatch | 346.5 ns | 353.5 ns | 0.980x | no | 0 | loss |
