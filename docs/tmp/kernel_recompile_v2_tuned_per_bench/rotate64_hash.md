...
- Overall geomean (stock / recompile, valid pairs only): `1.408x`
- Applied-only geomean (stock / recompile): `1.408x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| rotate-hash | 1 | 1 | 1 | 1.408x | 1.408x | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| rotate64_hash | rotate-hash | 91.5 ns | 65 ns | 1.408x | yes | 123 | win |
