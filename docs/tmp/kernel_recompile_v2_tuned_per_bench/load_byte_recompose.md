...
- Overall geomean (stock / recompile, valid pairs only): `1.123x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| causal-isolation | 1 | 1 | 0 | 1.123x | n/a | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| load_byte_recompose | causal-isolation | 242.5 ns | 216 ns | 1.123x | no | 0 | win |
