...
- Overall geomean (stock / recompile, valid pairs only): `0.763x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| strength-reduce | 1 | 1 | 0 | 0.763x | n/a | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| smallmul_strength_reduce | strength-reduce | 352 ns | 461.5 ns | 0.763x | no | 0 | loss |
