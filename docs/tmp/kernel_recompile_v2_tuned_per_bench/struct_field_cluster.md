...
- Overall geomean (stock / recompile, valid pairs only): `1.368x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| field-access | 1 | 1 | 0 | 1.368x | n/a | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| struct_field_cluster | field-access | 106 ns | 77.5 ns | 1.368x | no | 0 | win |
