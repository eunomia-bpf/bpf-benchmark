...
- Overall geomean (stock / recompile, valid pairs only): `0.994x`
- Applied-only geomean (stock / recompile): `0.994x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| select-diamond | 1 | 1 | 1 | 0.994x | 0.994x | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| cmov_select | select-diamond | 624 ns | 628 ns | 0.994x | yes | 11 | loss |
