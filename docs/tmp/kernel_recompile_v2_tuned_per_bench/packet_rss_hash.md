...
- Overall geomean (stock / recompile, valid pairs only): `1.139x`
- Applied-only geomean (stock / recompile): `1.139x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| packet-hash | 1 | 1 | 1 | 1.139x | 1.139x | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| packet_rss_hash | packet-hash | 20.5 ns | 18 ns | 1.139x | yes | 13 | win |
