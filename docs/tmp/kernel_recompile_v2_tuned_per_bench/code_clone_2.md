...
- Overall geomean (stock / recompile, valid pairs only): `1.083x`
- Applied-only geomean (stock / recompile): `1.083x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| code-clone | 1 | 1 | 1 | 1.083x | 1.083x | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| code_clone_2 | code-clone | 426 ns | 393.5 ns | 1.083x | yes | 2 | win |
