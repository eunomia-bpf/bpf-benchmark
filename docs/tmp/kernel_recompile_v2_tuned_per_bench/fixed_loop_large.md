...
- Overall geomean (stock / recompile, valid pairs only): `1.050x`
- Applied-only geomean (stock / recompile): `1.050x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| fixed-loop | 1 | 1 | 1 | 1.050x | 1.050x | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| fixed_loop_large | fixed-loop | 1.776 us | 1.690 us | 1.050x | yes | 4 | win |
