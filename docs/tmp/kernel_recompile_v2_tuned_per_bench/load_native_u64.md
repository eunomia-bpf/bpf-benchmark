...
- Overall geomean (stock / recompile, valid pairs only): `1.278x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| causal-isolation | 1 | 1 | 0 | 1.278x | n/a | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| load_native_u64 | causal-isolation | 119.5 ns | 93.5 ns | 1.278x | no | 0 | win |
