...
- Overall geomean (stock / recompile, valid pairs only): `1.133x`
- Applied-only geomean (stock / recompile): `1.133x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| immediate-stress | 1 | 1 | 1 | 1.133x | 1.133x | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| imm64_storm | immediate-stress | 226.5 ns | 200 ns | 1.133x | yes | 68 | win |
