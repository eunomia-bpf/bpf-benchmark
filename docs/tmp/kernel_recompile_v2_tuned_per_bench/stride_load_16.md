...
- Overall geomean (stock / recompile, valid pairs only): `0.996x`
- Applied-only geomean (stock / recompile): `0.996x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| stride-load | 1 | 1 | 1 | 0.996x | 0.996x | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| stride_load_16 | stride-load | 274.5 ns | 275.5 ns | 0.996x | yes | 3 | loss |
