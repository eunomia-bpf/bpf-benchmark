...
- Overall geomean (stock / recompile, valid pairs only): `1.041x`
- Applied-only geomean (stock / recompile): `1.041x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| bounds-density | 1 | 1 | 1 | 1.041x | 1.041x | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| packet_redundant_bounds | bounds-density | 139 ns | 133.5 ns | 1.041x | yes | 8 | win |
