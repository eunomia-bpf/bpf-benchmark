...
- Overall geomean (stock / recompile, valid pairs only): `0.808x`
- Applied-only geomean (stock / recompile): `0.808x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| hash-chain | 1 | 1 | 1 | 0.808x | 0.808x | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| cgroup_hash_chain | hash-chain | 296.5 ns | 367 ns | 0.808x | yes | 2 | loss |
