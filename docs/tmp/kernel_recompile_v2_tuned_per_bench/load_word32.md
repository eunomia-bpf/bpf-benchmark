...
- Overall geomean (stock / recompile, valid pairs only): `1.185x`
- Applied-only geomean (stock / recompile): `1.185x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| load-width | 1 | 1 | 1 | 1.185x | 1.185x | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| load_word32 | load-width | 131.5 ns | 111 ns | 1.185x | yes | 2 | win |
