...
- Overall geomean (stock / recompile, valid pairs only): `1.015x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| large-mixed | 1 | 1 | 1 | 1.015x | 1.015x | 1 | 0 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| large_mixed_1000 | large-mixed | 1.436 us | 1.415 us | 1.015x | yes | 16 | win |
