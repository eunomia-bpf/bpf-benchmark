...
- Overall geomean (stock / recompile, valid pairs only): `0.997x`
- Applied-only geomean (stock / recompile): `0.997x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| large-mixed | 1 | 1 | 1 | 0.997x | 0.997x | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| large_mixed_500 | large-mixed | 664.5 ns | 666.5 ns | 0.997x | yes | 3 | loss |
