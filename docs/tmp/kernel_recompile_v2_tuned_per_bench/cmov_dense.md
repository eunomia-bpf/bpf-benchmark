...
- Overall geomean (stock / recompile, valid pairs only): `0.969x`
- Applied-only geomean (stock / recompile): `0.969x`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| select-diamond | 1 | 1 | 1 | 0.969x | 0.969x | 0 | 1 | 0 |

## Per-Benchmark Table

| Benchmark | Family | Stock median | Recompile median | Stock/Recompile | Applied | Sites | Status |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| cmov_dense | select-diamond | 47.5 ns | 49 ns | 0.969x | yes | 26 | loss |
