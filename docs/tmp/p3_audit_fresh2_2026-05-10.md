...
- `run_pass_once` skips passes when required kop targets are unavailable (`bpfopt/crates/bpfopt/src/pass.rs:931`, `bpfopt/crates/bpfopt/src/pass.rs:948`, `bpfopt/crates/bpfopt/src/pass.rs:962`), while the CLI also has a fail-fast kop validator (`bpfopt/crates/bpfopt/src/main.rs:301`, `bpfopt/crates/bpfopt/src/main.rs:382`, `bpfopt/crates/bpfopt/src/main.rs:408`). Recommendation: remove or test-gate the skip path if production should fail before pass execution.
