...
- Generated: 2026-03-27T17:23:24.168767+00:00
...
- Code-size ratio geomean (baseline/rejit): 1.054x
- Exec-time ratio geomean (baseline/rejit): 0.920x
...
| --- | --- | --- | --- | --- | --- | --- |
| katran | 1 | 1 | 1 | 1 | 1.054x | 0.920x |

## By Object

| Object | Programs | Compile | REJIT Compile | Status | Error |
| --- | --- | --- | --- | --- | --- |
| katran:balancer.bpf.o | 1 | 110312073 | 93262914 | ok |  |

## Per-Program Results

| Program | Repo | Type | Compile Passes | Run Passes | Baseline JIT | REJIT JIT | Code Ratio | Baseline ns | REJIT ns | Exec Ratio | Note |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| katran:balancer.bpf.o:balancer_ingress | katran | xdp | map_inline | map_inline | 13645 | 12946 | 1.054x | 2214 | 2406 | 0.920x |  |
