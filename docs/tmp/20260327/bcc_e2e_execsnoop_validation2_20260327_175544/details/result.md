...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| execsnoop | 1750 | n/a | n/a | n/a | n/a | n/a | n/a | n/a | Command '['/bin/setpriv', '--reuid', '65534', '--regid', '65534', '--clear-groups', '/bin/stress-ng', '--exec', '2', '--exec-method', 'execve', '--temp-path', '/tmp', '--timeout', '5s', '--metrics-brief']' timed out after 35.0 seconds |
