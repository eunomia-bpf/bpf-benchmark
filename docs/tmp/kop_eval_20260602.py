#!/usr/bin/env python3
"""Post-hoc LEA kop corpus evaluation tables and figure for 2026-06-02.
...
OUT_MD = ROOT / "docs" / "tmp" / "kop_eval_20260602_summary.md"
FIG_OUT = FIG_DIR / "eval-kop-lea-corpus-20260602.png"
PASS_NAME = "lea"
...
def plot_corpus(workloads: list[Any], bpf: list[Any], apply: dict[str, dict[str, Counter[str]]]) -> pathlib.Path:
    ...
    fig.suptitle("x86 KVM LEA kop corpus evaluation", fontsize=16)
...
def write_summary(
    ...
    lines: list[str] = []
    lines.append("# LEA KOperation Corpus Evaluation Summary, 2026-06-02")
    lines.append("")
    lines.append("Generated by `docs/tmp/kop_eval_20260602.py` from raw artifacts.")
    lines.append("")
