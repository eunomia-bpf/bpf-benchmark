...
- Generated: 2026-03-24T12:44:47.101750+00:00
...
- Exec-time ratio geomean (baseline/v5): 0.757x
- Total sites: 33
- CMOV sites: 11
- WIDE sites: 12
- ROTATE sites: 10
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| calico | 2 | 2 | 2 | 1 | 11 | 12 | 10 | 0 | 0 | 0 | 0 | 0.998x | 0.757x | 2 |

## By Family

| Family | Programs | Applied | Sites | Applied Sites | Compile Pairs | Measured Pairs | Code Ratio | Exec Ratio | Regressions |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| wide | 1 | 0 | 12 | 0 | 1 | 1 | 1.000x | 0.714x | 1 |
| cmov | 1 | 0 | 11 | 0 | 1 | 1 | 1.000x | 0.714x | 1 |
| rotate | 1 | 1 | 10 | 10 | 1 | 1 | 0.996x | 0.804x | 1 |
...
| --- | --- | --- | --- | --- |
| corpus/build/calico/from_hep_debug.bpf.o:calico_tc_main | calico | sched_cls | 0.714x | cmov, wide |
| corpus/build/calico/from_hep_debug.bpf.o:calico_tc_maglev | calico | sched_cls | 0.804x | rotate |

## Per-Program Results

| Program | Project | Type | Sites | Applied Families | Baseline JIT | v5 JIT | Code Ratio | Baseline ns | v5 ns | Exec Ratio | Note |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| corpus/build/calico/from_hep_debug.bpf.o:calico_tc_maglev | calico | sched_cls | 10 | rotate | 3267 | 3279 | 0.996x | 3434 | 4273 | 0.804x |  |
| corpus/build/calico/from_hep_debug.bpf.o:calico_tc_main | calico | sched_cls | 23 |  | 46216 | 46216 | 1.000x | 3531 | 4947 | 0.714x |  |
