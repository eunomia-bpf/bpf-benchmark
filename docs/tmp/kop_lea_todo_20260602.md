...
- [x] Remove the wrapper-side LLVM kop selector/profitability gate.
...
- [x] Generate post-hoc summary and figure:
  `docs/tmp/kop_eval_20260602_summary.md` and
  `docs/figures/eval-kop-lea-corpus-20260602.png`.
...
- [ ] After LEA-specific cleanup, run the combined x86 kop pass set with the
