# BLSI/BLSR/BLSMSK kop research

Date: 2026-04-30

## Executive summary

Recommendation: **⏸ 后续 phase**. Do not put BLSI/BLSR/BLSMSK into the immediate Paper A/default kop implementation queue.
...
`docs/tmp/20260329/bit_ops_kop_research_20260329.md` does **not** cover BLSI/BLSR/BLSMSK. Its scope is explicitly:
...
These are essentially the original scalar sequences. A cross-arch kop pass would be x86-only useful and ARM64-neutral at best. That is acceptable for a future x86-targeted phase, but weak for the current default kop queue.

## Stage 4: implementation complexity

A minimal implementation would require three new koperation:
