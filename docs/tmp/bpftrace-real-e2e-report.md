...
- Geomean BPF speedup across scripts with both baseline and ReJIT data: `4.721x`.
...
- Note: bpftrace did not attach any programs
- `capable`: sites=0, stock_ns=1075.94, rejit_ns=227.88, speedup=4.721x, ops_stock=396930.35, ops_rejit=463429.54, cpu_stock=0.00, cpu_rejit=0.00
...
- `capable` delta: avg_ns=-78.82%, ops=16.75%, cpu=n/a%
...
- Eligible CMOV-bearing scripts split by workload: improved=['capable'], regressed=['none']. The overall geomean across scripts with stock+ReJIT data is `4.721x`.
