...
- Generated: `2026-03-23T01:15:36.363222+00:00`
- Run mode: `full`
...
- Geomean BPF speedup across scripts with both baseline and ReJIT data: `3.361x`.
...
- Note: bpftrace did not attach any programs
- `capable`: sites=0, stock_ns=859.37, rejit_ns=255.70, speedup=3.361x, ops_stock=787421.45, ops_rejit=794411.53, cpu_stock=0.07, cpu_rejit=0.00
...
- `capable` delta: avg_ns=-70.25%, ops=0.89%, cpu=-100.00%
...
- Eligible CMOV-bearing scripts split by workload: improved=['capable'], regressed=['none']. The overall geomean across scripts with stock+ReJIT data is `3.361x`.
