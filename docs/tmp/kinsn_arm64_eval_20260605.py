#!/usr/bin/env python3
"""Post-hoc arm64 AWS kinsn follow-up for 2026-06-05.
...
FIG_OUT = ROOT / "docs" / "figures" / "eval-kinsn-arm64-aws-20260605.png"
SUMMARY_OUT = ROOT / "docs" / "tmp" / "kinsn_arm64_eval_20260605_summary.md"
...
def plot(artifact: pathlib.Path, apps: list[dict[str, Any]], by_app: Counter[str]) -> pathlib.Path:
    ...
    fig.suptitle("arm64 AWS kinsn follow-up (t4g.small, SAMPLES=3, 30s)", fontsize=13)
...
def write_summary(
    ...
    lines: list[str] = []
    lines.append("# arm64 AWS kinsn follow-up 2026-06-05")
    lines.append("")
