...
corpus/
  ...
  results/
    ...
    real_world_exec_time_v2.md ──→  98 paired / 14 unique / 0.514x (valid packet)
docs/
  ...
  kernel-jit-improvements.md   ──→  3 actionable kernel JIT improvements
  related-work-positioning.md  ──→  K2/Merlin/EPSO orthogonality analysis
micro/
  generate_figures.py          ──→  6 publication-quality PDF figures
  run_pass_ablation.py         ──→  Per-pass ablation experiment script
  results/figures/             ──→  PDF figures for paper
  results/pass_ablation.md     ──→  Pass ablation results
```

---

*Generated 2026-03-07, updated 2026-03-08. Data source: authoritative 30-iteration × 1000-repeat runs on Intel Arrow Lake-S.*
