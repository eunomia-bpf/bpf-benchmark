...
VM_CORPUS_KEEP_FAILURE_ARTIFACTS_ARG := $(if $(filter 1,$(KEEP_FAILURE_ARTIFACTS)),--keep-failure-artifacts,)
VM_CORPUS_SUITE_ARGS = --samples "$(ROOT_VM_CORPUS_SAMPLES_VALUE)" $(VM_CORPUS_KEEP_FAILURE_ARTIFACTS_ARG)
