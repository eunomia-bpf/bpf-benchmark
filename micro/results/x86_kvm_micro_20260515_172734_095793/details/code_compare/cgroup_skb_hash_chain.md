 ...
 * - 0x1130: cmp    DWORD PTR [rax+0x8],0x10 [warning-unmapped: CMP operand form has no current kop selector: cmp    DWORD PTR [rax+0x8],0x10]
 * - 0x1136: cmp    DWORD PTR [rax+0xc],0x8 [warning-unmapped: CMP operand form has no current kop selector: cmp    DWORD PTR [rax+0xc],0x8]
 ...
 * - 0x1180: inc    r9 [warning-reg-remap: incq reg kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x1183: mov    rbx,r9 [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x1186: imul   rbx,r10 [warning-unmapped: IMUL operands are not in the 64-bit BPF JIT register file: imul   rbx,r10]
 * - 0x11a0: mov    r12,r14 [warning-reg-remap: movq register-to-register kop; native r12 has no exact BPF JIT register; remapped to BPF_REG_7]
 ...
 * - 0x11ae: rol    r12,cl [warning-reg-remap: rolq cl kop; verifier instantiate uses temps BPF_REG_6/BPF_REG_8; native r12 has no exact BPF JIT register; remapped to BPF_REG_7]
 * - 0x11b4: imul   r12,r11 [warning-unmapped: IMUL operands are not in the 64-bit BPF JIT register file: imul   r12,r11]
 * - 0x11b8: mov    rdx,r12 [warning-reg-remap: movq register-to-register kop; native r12 has no exact BPF JIT register; remapped to BPF_REG_7]
...
static const struct bpf_insn program[] = {
    ...
    /* 0x1122: cmp    rdx,rcx [exact-kop: cmpq reg,reg kop] */
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_3, BPF_REG_0, 0, 0, 1, 0, 80), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x112b: cmp    rdx,rcx [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_3, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    ...
    /* 0x1186: imul   rbx,r10 [warning-unmapped: IMUL operands are not in the 64-bit BPF JIT register file: imul   rbx,r10] */
    /* 0x118a: mov    r14,r8 [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_8, BPF_REG_5), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x118d: mov    rcx,rsi [exact-kop: movq register-to-register kop] */
    ...
    /* 0x11a0: mov    r12,r14 [warning-reg-remap: movq register-to-register kop; native r12 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_7, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x11a3: xor    r12,rbx [warning-reg-remap: ALU reg operation; native r12 has no exact BPF JIT register; remapped to BPF_REG_7] */
    ...
    /* 0x11ae: rol    r12,cl [warning-reg-remap: rolq cl kop; verifier instantiate uses temps BPF_REG_6/BPF_REG_8; native r12 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KOP(HC_ROTATE_CL_PAYLOAD(BPF_REG_7, BPF_REG_4, BPF_REG_6, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_ROLQ_CL),
    /* 0x11b1: inc    r15 [exact-kop: incq reg kop] */
    HC_KOP(HC_REG_PAYLOAD(BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_INCQ),
    /* 0x11b4: imul   r12,r11 [warning-unmapped: IMUL operands are not in the 64-bit BPF JIT register file: imul   r12,r11] */
    /* 0x11b8: mov    rdx,r12 [warning-reg-remap: movq register-to-register kop; native r12 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_3, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x11bb: shr    rdx,0x1d [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_3, 29), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    /* 0x11bf: xor    rdx,r12 [warning-reg-remap: ALU reg operation; native r12 has no exact BPF JIT register; remapped to BPF_REG_7] */
    ...
    /* 0x11c9: cmp    r15,0x8 [exact-kop: cmpq reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_9, 8), MICRO_HANDCRAFT_BPF_X86_CMPQ_IMM32),
    ...
    /* 0x11d3: cmp    r9,0x10 [exact-kop: cmpq reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_9, 16), MICRO_HANDCRAFT_BPF_X86_CMPQ_IMM32),
    ...
    /* 0x11dc: shr    rdx,0x20 [exact-kop: shrq imm kop] */
