 ...
 * - 0x113b: cmp    cl,0x5 [warning-unmapped: CMP operand form has no current kop selector: cmp    cl,0x5]
 * - 0x1140: cmp    BYTE PTR [rsi+0x1f],0x6 [warning-unmapped: CMP operand form has no current kop selector: cmp    BYTE PTR [rsi+0x1f],0x6]
 ...
 * - 0x11e2: movzx  r9d,BYTE PTR [rsi+0x2c] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x11e7: movzx  r10d,BYTE PTR [rsi+0x2d] [warning-reg-remap: direct memory load via x86 kop selector; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
...
static const struct bpf_insn program[] = {
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_3, BPF_REG_2, 0, 0, 1, 0, 62), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x111c: cmp    rdx,rcx [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_3, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_2, 20), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    ...
    /* 0x112c: cmp    ecx,0x800 [exact-kop: cmpl reg,imm32 kop] */
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_2, 22), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x1138: and    cl,0xf [exact-kop: andb imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_REG_IMM_TMP_PAYLOAD(BPF_REG_4, 15, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ANDB_IMM),
    /* 0x113b: cmp    cl,0x5 [warning-unmapped: CMP operand form has no current kop selector: cmp    cl,0x5] */
    ...
    /* 0x1147: push   r14 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1149: push   rbx [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x114a: lea    rdi,[rsi+0x1f] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_1, BPF_REG_2, 0, 0, 1, 0, 31), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x114e: lea    r8,[rsi+0x22] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_5, BPF_REG_2, 0, 0, 1, 0, 34), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x1174: cmp    ebx,0x68 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_6, 104), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x117e: cmp    ebx,0x1f [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_6, 31), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x1183: cmp    ebx,0x3f [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_6, 63), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x1188: cmp    ebx,0x4f [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_6, 79), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x118d: mov    rcx,rdi [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_4, BPF_REG_1), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x1190: cmp    ebx,0x5f [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_6, 95), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x11aa: and    ecx,0x7 [exact-kop: andl imm32 kop] */
    ...
    /* 0x11b6: mov    ebp,DWORD PTR [r10+rdx*4] [warning-unmapped: unsupported mnemonic or operand form: mov    ebp,DWORD PTR [r10+rdx*4]] */
    /* 0x11ba: or     ebp,DWORD PTR [r9+rdx*4] [warning-unmapped: ALU destination ebp is not in the BPF JIT register file] */
    /* 0x11be: test   ecx,ecx [exact-kop: testl reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_4, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_TESTL_RR),
    /* 0x11c0: je     1170 <packet_toeplitz_rss_hash_xdp+0x70> [warning-unmapped: standalone x86 branch needs an immediately preceding cmp] */
    /* 0x11c2: shl    ebp,cl [warning-unmapped: ALU destination ebp is not in the BPF JIT register file] */
    /* 0x11c4: mov    r14d,DWORD PTR [r11+rdx*4] [warning-unmapped: memory base r11 is not in the BPF JIT register file] */
    ...
    /* 0x11d6: mov    edx,DWORD PTR [rsi+0x26] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_3, BPF_REG_2, 38), MICRO_HANDCRAFT_BPF_X86_MOVL_MEM),
    /* 0x11d9: movzx  ecx,BYTE PTR [rsi+0x2a] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_2, 42), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x11dd: movzx  r8d,BYTE PTR [rsi+0x2b] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_5, BPF_REG_2, 43), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x11e2: movzx  r9d,BYTE PTR [rsi+0x2c] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_9, BPF_REG_2, 44), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x11e7: movzx  r10d,BYTE PTR [rsi+0x2d] [warning-reg-remap: direct memory load via x86 kop selector; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_7, BPF_REG_2, 45), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x11ec: mov    r11,rax [warning-unmapped: unsupported mnemonic or operand form: mov    r11,rax] */
    /* 0x11ef: shl    r11,0x20 [warning-unmapped: ALU destination r11 is not in the BPF JIT register file] */
    /* 0x11f3: xor    edx,DWORD PTR [rsi+0x22] [exact-kop: xorl memory-source kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ALU_MEM_PAYLOAD(BPF_REG_3, BPF_REG_2, 34, BPF_REG_6, 0), MICRO_HANDCRAFT_BPF_X86_XORL_MEM),
    /* 0x11f6: bswap  edx [exact-kop: bswapl kop] */
    HC_KOP(HC_REG_PAYLOAD(BPF_REG_3), MICRO_HANDCRAFT_BPF_X86_BSWAPL),
    ...
    /* 0x121b: and    eax,0x7 [exact-kop: andl imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_0, 7), MICRO_HANDCRAFT_BPF_X86_ANDL_IMM32),
    /* 0x121e: lea    ecx,[rax+0x1] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_4, BPF_REG_0, 0, 0, 1, 0, 1), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x1221: mov    r8,rdx [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_5, BPF_REG_3), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x1224: shl    r8,cl [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_LSH | BPF_X, BPF_REG_5, BPF_REG_4, 0, 0),
    /* 0x1227: not    al [exact-kop: notb reg kop; verifier instantiate uses temp BPF_REG_6] */
    ...
    /* 0x1234: mov    QWORD PTR [rsi],rdx [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_3, BPF_REG_2, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ_MEM_REG),
