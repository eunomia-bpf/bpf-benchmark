 ...
 * - 0x112c: mov    r9,QWORD PTR [rcx+0x8] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x11c4: rol    r9,0x20 [warning-reg-remap: rolq imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x11f7: rol    r9,0x20 [warning-reg-remap: rolq imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x1238: rol    r9,0x10 [warning-reg-remap: rolq imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x1242: rol    r9,0x15 [warning-reg-remap: rolq imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x1268: rol    r9,0x10 [warning-reg-remap: rolq imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x1272: rol    r9,0x15 [warning-reg-remap: rolq imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x12e7: mov    r9,QWORD PTR [rcx+0x28] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x136c: rol    r9,0x20 [warning-reg-remap: rolq imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x139f: rol    r9,0x20 [warning-reg-remap: rolq imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x13e0: rol    r9,0x10 [warning-reg-remap: rolq imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x13ea: rol    r9,0x15 [warning-reg-remap: rolq imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x1410: rol    r9,0x10 [warning-reg-remap: rolq imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x141a: rol    r9,0x15 [warning-reg-remap: rolq imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
...
static const struct bpf_insn program[] = {
    ...
    /* 0x111f: lea    rsi,[rcx+0x48] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_2, BPF_REG_4, 0, 0, 1, 0, 72), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x112c: mov    r9,QWORD PTR [rcx+0x8] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_9, BPF_REG_4, 8), MICRO_HANDCRAFT_BPF_X86_MOVQ_MEM),
    ...
    /* 0x1157: rol    rdi,0x10 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    ...
    /* 0x116b: rol    rdi,0x15 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 21, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    ...
    /* 0x117c: rol    rax,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_0, BPF_REG_0, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    ...
    /* 0x1186: rol    rdx,0xd [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x118a: xor    rdx,r8 [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_5, 0, 0),
    /* 0x118d: rol    r8,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_5, BPF_REG_5, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1191: add    rax,rdi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_1, 0, 0),
    /* 0x1194: rol    rdi,0x10 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    ...
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_5, BPF_REG_1, 0, 0),
    /* 0x119e: rol    rdi,0x15 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 21, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x11a2: add    rax,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_3, 0, 0),
    /* 0x11a5: rol    rdx,0x11 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 17, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x11a9: mov    rsi,QWORD PTR [rcx+0x10] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_2, BPF_REG_4, 16), MICRO_HANDCRAFT_BPF_X86_MOVQ_MEM),
    /* 0x11ad: xor    rdx,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_0, 0, 0),
    /* 0x11b0: rol    rax,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_0, BPF_REG_0, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x11b4: xor    r9,r8 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_9, BPF_REG_5, 0, 0),
    /* 0x11b7: add    r9,rdx [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_9, BPF_REG_3, 0, 0),
    /* 0x11ba: rol    rdx,0xd [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    ...
    /* 0x11c4: rol    r9,0x20 [warning-reg-remap: rolq imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_9, BPF_REG_9, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    ...
    /* 0x11ce: rol    r8,0x10 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_5, BPF_REG_5, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    ...
    /* 0x11d8: rol    r8,0x15 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_5, BPF_REG_5, 21, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x11dc: add    rax,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_3, 0, 0),
    /* 0x11df: rol    rdx,0x11 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 17, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x11e3: xor    rdx,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_0, 0, 0),
    /* 0x11e6: rol    rax,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_0, BPF_REG_0, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x11ea: xor    r8,r9 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_5, BPF_REG_9, 0, 0),
    /* 0x11ed: add    r9,rdx [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_9, BPF_REG_3, 0, 0),
    /* 0x11f0: rol    rdx,0xd [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x11f4: xor    rdx,r9 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_9, 0, 0),
    /* 0x11f7: rol    r9,0x20 [warning-reg-remap: rolq imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_5, 0, 0),
    /* 0x11fe: rol    r8,0x10 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_5, BPF_REG_5, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1202: xor    r8,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_5, BPF_REG_0, 0, 0),
    /* 0x1205: add    r9,r8 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_9, BPF_REG_5, 0, 0),
    /* 0x1208: rol    r8,0x15 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_5, BPF_REG_5, 21, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x120c: add    rax,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_3, 0, 0),
    /* 0x120f: rol    rdx,0x11 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 17, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1213: mov    rdi,QWORD PTR [rcx+0x18] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_1, BPF_REG_4, 24), MICRO_HANDCRAFT_BPF_X86_MOVQ_MEM),
    /* 0x1217: xor    rdx,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_0, 0, 0),
    /* 0x121a: rol    rax,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_0, BPF_REG_0, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x121e: xor    rsi,r9 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x1224: rol    rdx,0xd [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1228: xor    r9,rdi [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x122e: rol    rsi,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1232: xor    r9,r8 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_9, BPF_REG_5, 0, 0),
    /* 0x1235: add    rax,r9 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_9, 0, 0),
    /* 0x1238: rol    r9,0x10 [warning-reg-remap: rolq imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_9, BPF_REG_9, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x123c: xor    r9,rax [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_9, BPF_REG_0, 0, 0),
    /* 0x123f: add    rsi,r9 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_2, BPF_REG_9, 0, 0),
    /* 0x1242: rol    r9,0x15 [warning-reg-remap: rolq imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_9, BPF_REG_9, 21, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1246: add    rax,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_3, 0, 0),
    /* 0x1249: rol    rdx,0x11 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 17, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x124d: xor    rdx,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_0, 0, 0),
    /* 0x1250: rol    rax,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_0, BPF_REG_0, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1254: xor    r9,rsi [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_9, BPF_REG_2, 0, 0),
    /* 0x1257: add    rsi,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_2, BPF_REG_3, 0, 0),
    /* 0x125a: rol    rdx,0xd [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x125e: xor    rdx,rsi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_2, 0, 0),
    /* 0x1261: rol    rsi,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1265: add    rax,r9 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_9, 0, 0),
    /* 0x1268: rol    r9,0x10 [warning-reg-remap: rolq imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_3, 0, 0),
    /* 0x1279: rol    rdx,0x11 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 17, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x127d: mov    r8,QWORD PTR [rcx+0x20] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_5, BPF_REG_4, 32), MICRO_HANDCRAFT_BPF_X86_MOVQ_MEM),
    /* 0x1281: xor    rdx,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_0, 0, 0),
    /* 0x1284: rol    rax,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_0, BPF_REG_0, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    ...
    /* 0x128e: rol    rdx,0xd [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    ...
    /* 0x1298: rol    rdi,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x129c: xor    rsi,r9 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_2, BPF_REG_9, 0, 0),
    /* 0x129f: add    rax,rsi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_2, 0, 0),
    /* 0x12a2: rol    rsi,0x10 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    ...
    /* 0x12ac: rol    rsi,0x15 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 21, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x12b0: add    rax,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_3, 0, 0),
    /* 0x12b3: rol    rdx,0x11 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 17, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x12b7: xor    rdx,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_0, 0, 0),
    /* 0x12ba: rol    rax,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_0, BPF_REG_0, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    ...
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_1, BPF_REG_3, 0, 0),
    /* 0x12c4: rol    rdx,0xd [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x12c8: xor    rdx,rdi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_1, 0, 0),
    /* 0x12cb: rol    rdi,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x12cf: add    rax,rsi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_2, 0, 0),
    /* 0x12d2: rol    rsi,0x10 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x12d6: xor    rsi,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_2, BPF_REG_0, 0, 0),
    /* 0x12d9: add    rdi,rsi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_1, BPF_REG_2, 0, 0),
    /* 0x12dc: rol    rsi,0x15 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 21, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x12e0: add    rax,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_3, 0, 0),
    /* 0x12e3: rol    rdx,0x11 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 17, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x12e7: mov    r9,QWORD PTR [rcx+0x28] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_9, BPF_REG_4, 40), MICRO_HANDCRAFT_BPF_X86_MOVQ_MEM),
    /* 0x12eb: xor    rdx,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_0, 0, 0),
    /* 0x12ee: rol    rax,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_0, BPF_REG_0, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x12f2: xor    r8,rdi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_5, BPF_REG_1, 0, 0),
    /* 0x12f5: add    r8,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_5, BPF_REG_3, 0, 0),
    /* 0x12f8: rol    rdx,0xd [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x12fc: xor    rdi,r9 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_1, BPF_REG_9, 0, 0),
    /* 0x12ff: xor    rdx,r8 [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_5, 0, 0),
    /* 0x1302: rol    r8,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_5, BPF_REG_5, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1306: xor    rdi,rsi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_1, BPF_REG_2, 0, 0),
    /* 0x1309: add    rax,rdi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_1, 0, 0),
    /* 0x130c: rol    rdi,0x10 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1310: xor    rdi,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_1, BPF_REG_0, 0, 0),
    /* 0x1313: add    r8,rdi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_5, BPF_REG_1, 0, 0),
    /* 0x1316: rol    rdi,0x15 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 21, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x131a: add    rax,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_3, 0, 0),
    /* 0x131d: rol    rdx,0x11 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 17, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1321: xor    rdx,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_0, 0, 0),
    /* 0x1324: rol    rax,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_0, BPF_REG_0, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1328: xor    rdi,r8 [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_1, BPF_REG_5, 0, 0),
    /* 0x132b: add    r8,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_5, BPF_REG_3, 0, 0),
    /* 0x132e: rol    rdx,0xd [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1332: xor    rdx,r8 [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_5, 0, 0),
    /* 0x1335: rol    r8,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_5, BPF_REG_5, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1339: add    rax,rdi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_1, 0, 0),
    /* 0x133c: rol    rdi,0x10 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1340: xor    rdi,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_1, BPF_REG_0, 0, 0),
    /* 0x1343: add    r8,rdi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_5, BPF_REG_1, 0, 0),
    /* 0x1346: rol    rdi,0x15 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 21, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x134a: add    rax,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_3, 0, 0),
    /* 0x134d: rol    rdx,0x11 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 17, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1351: mov    rsi,QWORD PTR [rcx+0x30] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_2, BPF_REG_4, 48), MICRO_HANDCRAFT_BPF_X86_MOVQ_MEM),
    /* 0x1355: xor    rdx,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_0, 0, 0),
    /* 0x1358: rol    rax,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_0, BPF_REG_0, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x135c: xor    r9,r8 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_9, BPF_REG_5, 0, 0),
    /* 0x135f: add    r9,rdx [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_9, BPF_REG_3, 0, 0),
    /* 0x1362: rol    rdx,0xd [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    ...
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_5, 0, 0),
    /* 0x1376: rol    r8,0x10 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_5, BPF_REG_5, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x137a: xor    r8,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_5, BPF_REG_0, 0, 0),
    /* 0x137d: add    r9,r8 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_9, BPF_REG_5, 0, 0),
    /* 0x1380: rol    r8,0x15 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_5, BPF_REG_5, 21, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1384: add    rax,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_3, 0, 0),
    /* 0x1387: rol    rdx,0x11 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 17, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x138b: xor    rdx,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_0, 0, 0),
    /* 0x138e: rol    rax,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_0, BPF_REG_0, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1392: xor    r8,r9 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_5, BPF_REG_9, 0, 0),
    /* 0x1395: add    r9,rdx [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_9, BPF_REG_3, 0, 0),
    /* 0x1398: rol    rdx,0xd [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x139c: xor    rdx,r9 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_9, 0, 0),
    /* 0x139f: rol    r9,0x20 [warning-reg-remap: rolq imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_5, 0, 0),
    /* 0x13a6: rol    r8,0x10 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_5, BPF_REG_5, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x13aa: xor    r8,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_5, BPF_REG_0, 0, 0),
    /* 0x13ad: add    r9,r8 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_9, BPF_REG_5, 0, 0),
    /* 0x13b0: rol    r8,0x15 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_5, BPF_REG_5, 21, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x13b4: add    rax,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_3, 0, 0),
    /* 0x13b7: rol    rdx,0x11 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 17, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x13bb: mov    rdi,QWORD PTR [rcx+0x38] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_1, BPF_REG_4, 56), MICRO_HANDCRAFT_BPF_X86_MOVQ_MEM),
    /* 0x13bf: xor    rdx,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_0, 0, 0),
    /* 0x13c2: rol    rax,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_0, BPF_REG_0, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x13c6: xor    rsi,r9 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_2, BPF_REG_9, 0, 0),
    /* 0x13c9: add    rsi,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_2, BPF_REG_3, 0, 0),
    /* 0x13cc: rol    rdx,0xd [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x13d0: xor    r9,rdi [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_9, BPF_REG_1, 0, 0),
    /* 0x13d3: xor    rdx,rsi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_2, 0, 0),
    /* 0x13d6: rol    rsi,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x13da: xor    r9,r8 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_9, BPF_REG_5, 0, 0),
    /* 0x13dd: add    rax,r9 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_3, 0, 0),
    /* 0x13f1: rol    rdx,0x11 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 17, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x13f5: xor    rdx,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_0, 0, 0),
    /* 0x13f8: rol    rax,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_0, BPF_REG_0, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x13fc: xor    r9,rsi [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_9, BPF_REG_2, 0, 0),
    /* 0x13ff: add    rsi,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_2, BPF_REG_3, 0, 0),
    /* 0x1402: rol    rdx,0xd [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1406: xor    rdx,rsi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_2, 0, 0),
    /* 0x1409: rol    rsi,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x140d: add    rax,r9 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_9, 0, 0),
    /* 0x1410: rol    r9,0x10 [warning-reg-remap: rolq imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_3, 0, 0),
    /* 0x1421: rol    rdx,0x11 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 17, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1425: mov    r8,QWORD PTR [rcx+0x40] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_5, BPF_REG_4, 64), MICRO_HANDCRAFT_BPF_X86_MOVQ_MEM),
    /* 0x1429: xor    rdx,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_0, 0, 0),
    /* 0x142c: rol    rax,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_0, BPF_REG_0, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1430: xor    rdi,rsi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_1, BPF_REG_2, 0, 0),
    /* 0x1433: add    rdi,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_1, BPF_REG_3, 0, 0),
    /* 0x1436: rol    rdx,0xd [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x143a: xor    rsi,r8 [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_2, BPF_REG_5, 0, 0),
    /* 0x143d: xor    rdx,rdi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_1, 0, 0),
    /* 0x1440: rol    rdi,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1444: xor    rsi,r9 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_2, BPF_REG_9, 0, 0),
    /* 0x1447: add    rax,rsi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_2, 0, 0),
    /* 0x144a: rol    rsi,0x10 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x144e: xor    rsi,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_2, BPF_REG_0, 0, 0),
    /* 0x1451: add    rdi,rsi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_1, BPF_REG_2, 0, 0),
    /* 0x1454: rol    rsi,0x15 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 21, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1458: add    rax,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_3, 0, 0),
    /* 0x145b: rol    rdx,0x11 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 17, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x145f: xor    rdx,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_0, 0, 0),
    /* 0x1462: rol    rax,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_0, BPF_REG_0, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1466: xor    rsi,rdi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_2, BPF_REG_1, 0, 0),
    /* 0x1469: add    rdi,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_1, BPF_REG_3, 0, 0),
    /* 0x146c: rol    rdx,0xd [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1470: xor    rdx,rdi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_1, 0, 0),
    /* 0x1473: rol    rdi,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1477: add    rax,rsi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_2, 0, 0),
    /* 0x147a: rol    rsi,0x10 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x147e: xor    rsi,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_2, BPF_REG_0, 0, 0),
    /* 0x1481: add    rdi,rsi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_1, BPF_REG_2, 0, 0),
    /* 0x1484: rol    rsi,0x15 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 21, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1488: add    rax,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_3, 0, 0),
    /* 0x148b: rol    rdx,0x11 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 17, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x148f: xor    rsi,rdi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_2, BPF_REG_1, 0, 0),
    /* 0x1492: xor    rdx,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_0, 0, 0),
    /* 0x1495: rol    rax,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_0, BPF_REG_0, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1499: xor    rdi,r8 [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_1, BPF_REG_5, 0, 0),
    /* 0x149c: add    rdi,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_1, BPF_REG_3, 0, 0),
    /* 0x149f: rol    rdx,0xd [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x14a3: xor    rdx,rdi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_1, 0, 0),
    /* 0x14a6: rol    rdi,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    ...
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_2, 0, 0),
    /* 0x14b3: rol    rsi,0x10 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x14b7: xor    rsi,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_2, BPF_REG_0, 0, 0),
    /* 0x14ba: add    rdi,rsi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_1, BPF_REG_2, 0, 0),
    /* 0x14bd: rol    rsi,0x15 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 21, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x14c1: add    rax,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_3, 0, 0),
    /* 0x14c4: rol    rdx,0x11 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 17, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x14c8: xor    rdx,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_0, 0, 0),
    /* 0x14cb: rol    rax,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_0, BPF_REG_0, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x14cf: xor    rsi,rdi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_2, BPF_REG_1, 0, 0),
    /* 0x14d2: add    rdi,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_1, BPF_REG_3, 0, 0),
    /* 0x14d5: rol    rdx,0xd [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x14d9: xor    rdx,rdi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_1, 0, 0),
    /* 0x14dc: rol    rdi,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x14e0: add    rax,rsi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_2, 0, 0),
    /* 0x14e3: rol    rsi,0x10 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x14e7: xor    rsi,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_2, BPF_REG_0, 0, 0),
    /* 0x14ea: add    rdi,rsi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_1, BPF_REG_2, 0, 0),
    /* 0x14ed: rol    rsi,0x15 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 21, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x14f1: add    rax,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_3, 0, 0),
    /* 0x14f4: rol    rdx,0x11 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 17, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x14f8: xor    rdx,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_0, 0, 0),
    /* 0x14fb: rol    rax,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_0, BPF_REG_0, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x14ff: xor    rsi,rdi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_2, BPF_REG_1, 0, 0),
    /* 0x1502: add    rdi,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_1, BPF_REG_3, 0, 0),
    /* 0x1505: rol    rdx,0xd [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1509: xor    rdx,rdi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_1, 0, 0),
    /* 0x150c: rol    rdi,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1510: add    rax,rsi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_2, 0, 0),
    /* 0x1513: rol    rsi,0x10 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1517: xor    rsi,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_2, BPF_REG_0, 0, 0),
    /* 0x151a: add    rdi,rsi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_1, BPF_REG_2, 0, 0),
    /* 0x151d: rol    rsi,0x15 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 21, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1521: add    rax,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_3, 0, 0),
    /* 0x1524: rol    rdx,0x11 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 17, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1528: xor    rdx,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_0, 0, 0),
    /* 0x152b: rol    rax,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_0, BPF_REG_0, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x152f: xor    rsi,rdi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_2, BPF_REG_1, 0, 0),
    /* 0x1532: add    rdi,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_1, BPF_REG_3, 0, 0),
    /* 0x1535: rol    rdx,0xd [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1539: add    rax,rsi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_2, 0, 0),
    /* 0x153c: rol    rsi,0x10 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1540: xor    rsi,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_2, BPF_REG_0, 0, 0),
    /* 0x1543: rol    rsi,0x15 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_2, BPF_REG_2, 21, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1547: xor    rdx,rdi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_3, BPF_REG_1, 0, 0),
    /* 0x154a: add    rax,rdx [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_3, 0, 0),
    /* 0x154d: rol    rdx,0x11 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_3, BPF_REG_3, 17, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    /* 0x1551: mov    rdi,rax [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_1, BPF_REG_0), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x1554: rol    rdi,0x20 [exact-kop: rolq imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 32, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_IMM),
    ...
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_1, BPF_REG_0, 0, 0),
    /* 0x1561: mov    QWORD PTR [rcx],rdi [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_1, BPF_REG_4, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ_MEM_REG),
...
0000000000000000 <.data>:
  ...
  19:	48 0f 45 ca          	cmovne rcx,rdx
  1d:	48 39 d1             	cmp    rcx,rdx
  20:	0f 87 5f 04 00 00    	ja     0x485
  26:	48 8d 71 08          	lea    rsi,[rcx+0x8]
  2a:	48 0f 45 f2          	cmovne rsi,rdx
  2e:	48 39 d6             	cmp    rsi,rdx
  31:	0f 87 4e 04 00 00    	ja     0x485
  37:	48 8d 71 48          	lea    rsi,[rcx+0x48]
  3b:	48 0f 45 f2          	cmovne rsi,rdx
  3f:	48 39 d6             	cmp    rsi,rdx
  42:	0f 87 3d 04 00 00    	ja     0x485
  48:	4c 8b 79 08          	mov    r15,QWORD PTR [rcx+0x8]
  4c:	48 bf 73 65 74 79 62 	movabs rdi,0x7465646279746573
  53:	64 65 74 
  56:	4c 31 ff             	xor    rdi,r15
  59:	48 ba 61 72 65 6e 65 	movabs rdx,0x6c7967656e657261
  60:	67 79 6c 
  63:	48 01 fa             	add    rdx,rdi
  66:	48 b8 d0 ea 9f c1 6f 	movabs rax,0xa60c596fc19fead0
  6d:	59 0c a6 
  70:	48 01 f8             	add    rax,rdi
  73:	48 c1 c7 10          	rol    rdi,0x10
  77:	48 31 d7             	xor    rdi,rdx
  7a:	49 b8 c6 df de d7 e2 	movabs r8,0xded7d4e2d7dedfc6
  81:	d4 d7 de 
  84:	49 01 f8             	add    r8,rdi
  87:	48 c1 c7 15          	rol    rdi,0x15
  8b:	48 ba 25 73 de f0 74 	movabs rdx,0xe414a674f0de7325
  92:	a6 14 e4 
  95:	48 31 c2             	xor    rdx,rax
  98:	48 c1 c0 20          	rol    rax,0x20
  9c:	4c 31 c7             	xor    rdi,r8
  9f:	49 01 d0             	add    r8,rdx
  a2:	48 c1 c2 0d          	rol    rdx,0xd
  a6:	4c 31 c2             	xor    rdx,r8
  a9:	49 c1 c0 20          	rol    r8,0x20
  ad:	48 01 f8             	add    rax,rdi
  b0:	48 c1 c7 10          	rol    rdi,0x10
  b4:	48 31 c7             	xor    rdi,rax
  b7:	49 01 f8             	add    r8,rdi
  ba:	48 c1 c7 15          	rol    rdi,0x15
  be:	48 01 d0             	add    rax,rdx
  c1:	48 c1 c2 11          	rol    rdx,0x11
  c5:	48 8b 71 10          	mov    rsi,QWORD PTR [rcx+0x10]
  c9:	48 31 c2             	xor    rdx,rax
  cc:	48 c1 c0 20          	rol    rax,0x20
  d0:	4d 31 c7             	xor    r15,r8
  d3:	49 01 d7             	add    r15,rdx
  d6:	48 c1 c2 0d          	rol    rdx,0xd
  da:	49 31 f0             	xor    r8,rsi
  dd:	4c 31 fa             	xor    rdx,r15
  e0:	49 c1 c7 20          	rol    r15,0x20
  e4:	49 31 f8             	xor    r8,rdi
  e7:	4c 01 c0             	add    rax,r8
  ea:	49 c1 c0 10          	rol    r8,0x10
  ee:	49 31 c0             	xor    r8,rax
  f1:	4d 01 c7             	add    r15,r8
  f4:	49 c1 c0 15          	rol    r8,0x15
  f8:	48 01 d0             	add    rax,rdx
  fb:	48 c1 c2 11          	rol    rdx,0x11
  ff:	48 31 c2             	xor    rdx,rax
 102:	48 c1 c0 20          	rol    rax,0x20
 106:	4d 31 f8             	xor    r8,r15
 109:	49 01 d7             	add    r15,rdx
 10c:	48 c1 c2 0d          	rol    rdx,0xd
 110:	4c 31 fa             	xor    rdx,r15
 113:	49 c1 c7 20          	rol    r15,0x20
 117:	4c 01 c0             	add    rax,r8
 11a:	49 c1 c0 10          	rol    r8,0x10
 11e:	49 31 c0             	xor    r8,rax
 121:	4d 01 c7             	add    r15,r8
 124:	49 c1 c0 15          	rol    r8,0x15
 128:	48 01 d0             	add    rax,rdx
 12b:	48 c1 c2 11          	rol    rdx,0x11
 12f:	48 8b 79 18          	mov    rdi,QWORD PTR [rcx+0x18]
 133:	48 31 c2             	xor    rdx,rax
 136:	48 c1 c0 20          	rol    rax,0x20
 13a:	4c 31 fe             	xor    rsi,r15
 13d:	48 01 d6             	add    rsi,rdx
 140:	48 c1 c2 0d          	rol    rdx,0xd
 144:	49 31 ff             	xor    r15,rdi
 147:	48 31 f2             	xor    rdx,rsi
 14a:	48 c1 c6 20          	rol    rsi,0x20
 14e:	4d 31 c7             	xor    r15,r8
 151:	4c 01 f8             	add    rax,r15
 154:	49 c1 c7 10          	rol    r15,0x10
 158:	49 31 c7             	xor    r15,rax
 15b:	4c 01 fe             	add    rsi,r15
 15e:	49 c1 c7 15          	rol    r15,0x15
 162:	48 01 d0             	add    rax,rdx
 165:	48 c1 c2 11          	rol    rdx,0x11
 169:	48 31 c2             	xor    rdx,rax
 16c:	48 c1 c0 20          	rol    rax,0x20
 170:	49 31 f7             	xor    r15,rsi
 173:	48 01 d6             	add    rsi,rdx
 176:	48 c1 c2 0d          	rol    rdx,0xd
 17a:	48 31 f2             	xor    rdx,rsi
 17d:	48 c1 c6 20          	rol    rsi,0x20
 181:	4c 01 f8             	add    rax,r15
 184:	49 c1 c7 10          	rol    r15,0x10
 188:	49 31 c7             	xor    r15,rax
 18b:	4c 01 fe             	add    rsi,r15
 18e:	49 c1 c7 15          	rol    r15,0x15
 192:	48 01 d0             	add    rax,rdx
 195:	48 c1 c2 11          	rol    rdx,0x11
 199:	4c 8b 41 20          	mov    r8,QWORD PTR [rcx+0x20]
 19d:	48 31 c2             	xor    rdx,rax
 1a0:	48 c1 c0 20          	rol    rax,0x20
 1a4:	48 31 f7             	xor    rdi,rsi
 1a7:	48 01 d7             	add    rdi,rdx
 1aa:	48 c1 c2 0d          	rol    rdx,0xd
 1ae:	4c 31 c6             	xor    rsi,r8
 1b1:	48 31 fa             	xor    rdx,rdi
 1b4:	48 c1 c7 20          	rol    rdi,0x20
 1b8:	4c 31 fe             	xor    rsi,r15
 1bb:	48 01 f0             	add    rax,rsi
 1be:	48 c1 c6 10          	rol    rsi,0x10
 1c2:	48 31 c6             	xor    rsi,rax
 1c5:	48 01 f7             	add    rdi,rsi
 1c8:	48 c1 c6 15          	rol    rsi,0x15
 1cc:	48 01 d0             	add    rax,rdx
 1cf:	48 c1 c2 11          	rol    rdx,0x11
 1d3:	48 31 c2             	xor    rdx,rax
 1d6:	48 c1 c0 20          	rol    rax,0x20
 1da:	48 31 fe             	xor    rsi,rdi
 1dd:	48 01 d7             	add    rdi,rdx
 1e0:	48 c1 c2 0d          	rol    rdx,0xd
 1e4:	48 31 fa             	xor    rdx,rdi
 1e7:	48 c1 c7 20          	rol    rdi,0x20
 1eb:	48 01 f0             	add    rax,rsi
 1ee:	48 c1 c6 10          	rol    rsi,0x10
 1f2:	48 31 c6             	xor    rsi,rax
 1f5:	48 01 f7             	add    rdi,rsi
 1f8:	48 c1 c6 15          	rol    rsi,0x15
 1fc:	48 01 d0             	add    rax,rdx
 1ff:	48 c1 c2 11          	rol    rdx,0x11
 203:	4c 8b 79 28          	mov    r15,QWORD PTR [rcx+0x28]
 207:	48 31 c2             	xor    rdx,rax
 20a:	48 c1 c0 20          	rol    rax,0x20
 20e:	49 31 f8             	xor    r8,rdi
 211:	49 01 d0             	add    r8,rdx
 214:	48 c1 c2 0d          	rol    rdx,0xd
 218:	4c 31 ff             	xor    rdi,r15
 21b:	4c 31 c2             	xor    rdx,r8
 21e:	49 c1 c0 20          	rol    r8,0x20
 222:	48 31 f7             	xor    rdi,rsi
 225:	48 01 f8             	add    rax,rdi
 228:	48 c1 c7 10          	rol    rdi,0x10
 22c:	48 31 c7             	xor    rdi,rax
 22f:	49 01 f8             	add    r8,rdi
 232:	48 c1 c7 15          	rol    rdi,0x15
 236:	48 01 d0             	add    rax,rdx
 239:	48 c1 c2 11          	rol    rdx,0x11
 23d:	48 31 c2             	xor    rdx,rax
 240:	48 c1 c0 20          	rol    rax,0x20
 244:	4c 31 c7             	xor    rdi,r8
 247:	49 01 d0             	add    r8,rdx
 24a:	48 c1 c2 0d          	rol    rdx,0xd
 24e:	4c 31 c2             	xor    rdx,r8
 251:	49 c1 c0 20          	rol    r8,0x20
 255:	48 01 f8             	add    rax,rdi
 258:	48 c1 c7 10          	rol    rdi,0x10
 25c:	48 31 c7             	xor    rdi,rax
 25f:	49 01 f8             	add    r8,rdi
 262:	48 c1 c7 15          	rol    rdi,0x15
 266:	48 01 d0             	add    rax,rdx
 269:	48 c1 c2 11          	rol    rdx,0x11
 26d:	48 8b 71 30          	mov    rsi,QWORD PTR [rcx+0x30]
 271:	48 31 c2             	xor    rdx,rax
 274:	48 c1 c0 20          	rol    rax,0x20
 278:	4d 31 c7             	xor    r15,r8
 27b:	49 01 d7             	add    r15,rdx
 27e:	48 c1 c2 0d          	rol    rdx,0xd
 282:	49 31 f0             	xor    r8,rsi
 285:	4c 31 fa             	xor    rdx,r15
 288:	49 c1 c7 20          	rol    r15,0x20
 28c:	49 31 f8             	xor    r8,rdi
 28f:	4c 01 c0             	add    rax,r8
 292:	49 c1 c0 10          	rol    r8,0x10
 296:	49 31 c0             	xor    r8,rax
 299:	4d 01 c7             	add    r15,r8
 29c:	49 c1 c0 15          	rol    r8,0x15
 2a0:	48 01 d0             	add    rax,rdx
 2a3:	48 c1 c2 11          	rol    rdx,0x11
 2a7:	48 31 c2             	xor    rdx,rax
 2aa:	48 c1 c0 20          	rol    rax,0x20
 2ae:	4d 31 f8             	xor    r8,r15
 2b1:	49 01 d7             	add    r15,rdx
 2b4:	48 c1 c2 0d          	rol    rdx,0xd
 2b8:	4c 31 fa             	xor    rdx,r15
 2bb:	49 c1 c7 20          	rol    r15,0x20
 2bf:	4c 01 c0             	add    rax,r8
 2c2:	49 c1 c0 10          	rol    r8,0x10
 2c6:	49 31 c0             	xor    r8,rax
 2c9:	4d 01 c7             	add    r15,r8
 2cc:	49 c1 c0 15          	rol    r8,0x15
 2d0:	48 01 d0             	add    rax,rdx
 2d3:	48 c1 c2 11          	rol    rdx,0x11
 2d7:	48 8b 79 38          	mov    rdi,QWORD PTR [rcx+0x38]
 2db:	48 31 c2             	xor    rdx,rax
 2de:	48 c1 c0 20          	rol    rax,0x20
 2e2:	4c 31 fe             	xor    rsi,r15
 2e5:	48 01 d6             	add    rsi,rdx
 2e8:	48 c1 c2 0d          	rol    rdx,0xd
 2ec:	49 31 ff             	xor    r15,rdi
 2ef:	48 31 f2             	xor    rdx,rsi
 2f2:	48 c1 c6 20          	rol    rsi,0x20
 2f6:	4d 31 c7             	xor    r15,r8
 2f9:	4c 01 f8             	add    rax,r15
 2fc:	49 c1 c7 10          	rol    r15,0x10
 300:	49 31 c7             	xor    r15,rax
 303:	4c 01 fe             	add    rsi,r15
 306:	49 c1 c7 15          	rol    r15,0x15
 30a:	48 01 d0             	add    rax,rdx
 30d:	48 c1 c2 11          	rol    rdx,0x11
 311:	48 31 c2             	xor    rdx,rax
 314:	48 c1 c0 20          	rol    rax,0x20
 318:	49 31 f7             	xor    r15,rsi
 31b:	48 01 d6             	add    rsi,rdx
 31e:	48 c1 c2 0d          	rol    rdx,0xd
 322:	48 31 f2             	xor    rdx,rsi
 325:	48 c1 c6 20          	rol    rsi,0x20
 329:	4c 01 f8             	add    rax,r15
 32c:	49 c1 c7 10          	rol    r15,0x10
 330:	49 31 c7             	xor    r15,rax
 333:	4c 01 fe             	add    rsi,r15
 336:	49 c1 c7 15          	rol    r15,0x15
 33a:	48 01 d0             	add    rax,rdx
 33d:	48 c1 c2 11          	rol    rdx,0x11
 341:	4c 8b 41 40          	mov    r8,QWORD PTR [rcx+0x40]
 345:	48 31 c2             	xor    rdx,rax
 348:	48 c1 c0 20          	rol    rax,0x20
 34c:	48 31 f7             	xor    rdi,rsi
 34f:	48 01 d7             	add    rdi,rdx
 352:	48 c1 c2 0d          	rol    rdx,0xd
 356:	4c 31 c6             	xor    rsi,r8
 359:	48 31 fa             	xor    rdx,rdi
 35c:	48 c1 c7 20          	rol    rdi,0x20
 360:	4c 31 fe             	xor    rsi,r15
 363:	48 01 f0             	add    rax,rsi
 366:	48 c1 c6 10          	rol    rsi,0x10
 36a:	48 31 c6             	xor    rsi,rax
 36d:	48 01 f7             	add    rdi,rsi
 370:	48 c1 c6 15          	rol    rsi,0x15
 374:	48 01 d0             	add    rax,rdx
 377:	48 c1 c2 11          	rol    rdx,0x11
 37b:	48 31 c2             	xor    rdx,rax
 37e:	48 c1 c0 20          	rol    rax,0x20
 382:	48 31 fe             	xor    rsi,rdi
 385:	48 01 d7             	add    rdi,rdx
 388:	48 c1 c2 0d          	rol    rdx,0xd
 38c:	48 31 fa             	xor    rdx,rdi
 38f:	48 c1 c7 20          	rol    rdi,0x20
 393:	48 01 f0             	add    rax,rsi
 396:	48 c1 c6 10          	rol    rsi,0x10
 39a:	48 31 c6             	xor    rsi,rax
 39d:	48 01 f7             	add    rdi,rsi
 3a0:	48 c1 c6 15          	rol    rsi,0x15
 3a4:	48 01 d0             	add    rax,rdx
 3a7:	48 c1 c2 11          	rol    rdx,0x11
 3ab:	48 31 fe             	xor    rsi,rdi
 3ae:	48 31 c2             	xor    rdx,rax
 3b1:	48 c1 c0 20          	rol    rax,0x20
 3b5:	4c 31 c7             	xor    rdi,r8
 3b8:	48 01 d7             	add    rdi,rdx
 3bb:	48 c1 c2 0d          	rol    rdx,0xd
 3bf:	48 31 fa             	xor    rdx,rdi
 3c2:	48 c1 c7 20          	rol    rdi,0x20
 3c6:	48 35 ff 00 00 00    	xor    rax,0xff
 3cc:	48 01 f0             	add    rax,rsi
 3cf:	48 c1 c6 10          	rol    rsi,0x10
 3d3:	48 31 c6             	xor    rsi,rax
 3d6:	48 01 f7             	add    rdi,rsi
 3d9:	48 c1 c6 15          	rol    rsi,0x15
 3dd:	48 01 d0             	add    rax,rdx
 3e0:	48 c1 c2 11          	rol    rdx,0x11
 3e4:	48 31 c2             	xor    rdx,rax
 3e7:	48 c1 c0 20          	rol    rax,0x20
 3eb:	48 31 fe             	xor    rsi,rdi
 3ee:	48 01 d7             	add    rdi,rdx
 3f1:	48 c1 c2 0d          	rol    rdx,0xd
 3f5:	48 31 fa             	xor    rdx,rdi
 3f8:	48 c1 c7 20          	rol    rdi,0x20
 3fc:	48 01 f0             	add    rax,rsi
 3ff:	48 c1 c6 10          	rol    rsi,0x10
 403:	48 31 c6             	xor    rsi,rax
 406:	48 01 f7             	add    rdi,rsi
 409:	48 c1 c6 15          	rol    rsi,0x15
 40d:	48 01 d0             	add    rax,rdx
 410:	48 c1 c2 11          	rol    rdx,0x11
 414:	48 31 c2             	xor    rdx,rax
 417:	48 c1 c0 20          	rol    rax,0x20
 41b:	48 31 fe             	xor    rsi,rdi
 41e:	48 01 d7             	add    rdi,rdx
 421:	48 c1 c2 0d          	rol    rdx,0xd
 425:	48 31 fa             	xor    rdx,rdi
 428:	48 c1 c7 20          	rol    rdi,0x20
 42c:	48 01 f0             	add    rax,rsi
 42f:	48 c1 c6 10          	rol    rsi,0x10
 433:	48 31 c6             	xor    rsi,rax
 436:	48 01 f7             	add    rdi,rsi
 439:	48 c1 c6 15          	rol    rsi,0x15
 43d:	48 01 d0             	add    rax,rdx
 440:	48 c1 c2 11          	rol    rdx,0x11
 444:	48 31 c2             	xor    rdx,rax
 447:	48 c1 c0 20          	rol    rax,0x20
 44b:	48 31 fe             	xor    rsi,rdi
 44e:	48 01 d7             	add    rdi,rdx
 451:	48 c1 c2 0d          	rol    rdx,0xd
 455:	48 01 f0             	add    rax,rsi
 458:	48 c1 c6 10          	rol    rsi,0x10
 45c:	48 31 c6             	xor    rsi,rax
 45f:	48 c1 c6 15          	rol    rsi,0x15
 463:	48 31 fa             	xor    rdx,rdi
 466:	48 01 d0             	add    rax,rdx
 469:	48 c1 c2 11          	rol    rdx,0x11
 46d:	48 89 c7             	mov    rdi,rax
 470:	48 c1 c7 20          	rol    rdi,0x20
 474:	48 31 d7             	xor    rdi,rdx
 477:	48 31 f7             	xor    rdi,rsi
 47a:	48 31 c7             	xor    rdi,rax
 47d:	48 89 39             	mov    QWORD PTR [rcx],rdi
 480:	b8 02 00 00 00       	mov    eax,0x2
 485:	41 5f                	pop    r15
 487:	5b                   	pop    rbx
 488:	c9                   	leave
 489:	c3                   	ret
