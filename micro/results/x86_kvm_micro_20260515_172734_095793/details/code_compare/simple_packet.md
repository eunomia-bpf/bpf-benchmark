...
0000000000000000 <.data>:
  ...
  2a:	77 1a                	ja     0x46
  2c:	66 c7 41 00 4e 61    	mov    WORD PTR [rcx+0x0],0x614e
  32:	c6 41 02 bc          	mov    BYTE PTR [rcx+0x2],0xbc
  36:	c7 41 03 00 00 00 00 	mov    DWORD PTR [rcx+0x3],0x0
  3d:	c6 41 07 00          	mov    BYTE PTR [rcx+0x7],0x0
  41:	b8 02 00 00 00       	mov    eax,0x2
  46:	c9                   	leave
  47:	c3                   	ret
```
