 ...
 * - 0x1136: cmp    DWORD PTR [rax+0x8],0x20 [warning-unmapped: CMP operand form has no current kop selector: cmp    DWORD PTR [rax+0x8],0x20]
 * - 0x113c: cmp    DWORD PTR [rax+0xc],0x200 [warning-unmapped: CMP operand form has no current kop selector: cmp    DWORD PTR [rax+0xc],0x200]
 * - 0x1160: movzx  r9d,WORD PTR [rax+rcx*2+0x10] [warning-reg-remap: indexed memory load via x86 SIB kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x1166: add    r9d,r8d [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x1169: movzx  r8d,r9w [warning-reg-remap: movzx r32,r16 kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x116d: shr    r9d,0x10 [warning-reg-remap: ALU imm operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x1171: add    r9d,r8d [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x117a: add    r8d,r9d [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x117d: movzx  r9d,r8w [warning-reg-remap: movzx r32,r16 kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x1185: add    r8d,r9d [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 */
...
static const struct bpf_insn program[] = {
    ...
    /* 0x1107: cmp    rax,rcx [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_0, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_3, BPF_REG_1, 20), MICRO_HANDCRAFT_BPF_X86_MOVL_MEM_REG),
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_3, BPF_REG_0, 0, 0, 1, 0, 8), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x1125: cmp    rdx,rcx [exact-kop: cmpq reg,reg kop] */
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_3, BPF_REG_0, 0, 0, 1, 0, 1040), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x1131: cmp    rdx,rcx [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_3, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    ...
    /* 0x1160: movzx  r9d,WORD PTR [rax+rcx*2+0x10] [warning-reg-remap: indexed memory load via x86 SIB kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_SIB_PAYLOAD(BPF_REG_9, BPF_REG_0, BPF_REG_4, 1, 16), MICRO_HANDCRAFT_BPF_X86_MOVZWL_SIB),
    /* 0x1166: add    r9d,r8d [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    HC_KOP(HC_SIB_PAYLOAD(BPF_REG_5, BPF_REG_0, BPF_REG_4, 1, 18), MICRO_HANDCRAFT_BPF_X86_MOVZWL_SIB),
    /* 0x117a: add    r8d,r9d [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x1181: shr    r8d,0x10 [bpf-jit: ALU imm operation] */
    HC_RAW(BPF_ALU | BPF_RSH | BPF_K, BPF_REG_5, 0, 0, 16),
    /* 0x1185: add    r8d,r9d [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU | BPF_ADD | BPF_X, BPF_REG_5, BPF_REG_9, 0, 0),
    /* 0x1188: add    rcx,0x2 [bpf-jit: ALU imm operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_K, BPF_REG_4, 0, 0, 2),
    /* 0x118c: cmp    rcx,0x200 [exact-kop: cmpq reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 512), MICRO_HANDCRAFT_BPF_X86_CMPQ_IMM32),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_4, 0, -18, 512),
    /* 0x1195: mov    ecx,r8d [bpf-jit: 32-bit register move] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_X, BPF_REG_4, BPF_REG_5, 0, 0),
    /* 0x1198: shr    ecx,0x10 [bpf-jit: ALU imm operation] */
    HC_RAW(BPF_ALU | BPF_RSH | BPF_K, BPF_REG_4, 0, 0, 16),
    /* 0x119b: add    ecx,r8d [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU | BPF_ADD | BPF_X, BPF_REG_4, BPF_REG_5, 0, 0),
    /* 0x119e: not    ecx [exact-kop: notl reg kop] */
    HC_KOP(HC_REG_PAYLOAD(BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_NOTL_R),
    ...
    /* 0x11a4: mov    ecx,esi [bpf-jit: 32-bit register move] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_X, BPF_REG_4, BPF_REG_2, 0, 0),
    /* 0x11a6: shl    ecx,0x4 [bpf-jit: ALU imm operation] */
    ...
    /* 0x11ac: xor    rdx,r8 [bpf-jit: ALU reg operation] */
    ...
    /* 0x11b1: cmp    esi,0x20 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_2, 32), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_2, 0, -35, 32),
    /* 0x11b6: mov    DWORD PTR [rdi+0x10],edx [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_3, BPF_REG_1, 16), MICRO_HANDCRAFT_BPF_X86_MOVL_MEM_REG),
    /* 0x11b9: shr    rdx,0x20 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_3, 32), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    /* 0x11bd: xor    eax,eax [bpf-jit: zero idiom] */
