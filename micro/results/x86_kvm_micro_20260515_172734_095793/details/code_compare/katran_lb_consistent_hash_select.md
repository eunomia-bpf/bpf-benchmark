 ...
 * - 0x1178: cmp    dl,0x5 [warning-unmapped: CMP operand form has no current kop selector: cmp    dl,0x5]
 ...
 * - 0x11d7: cmp    r12,rbx [warning-unmapped: CMP operand form has no current kop selector: cmp    r12,rbx]
 ...
 * - 0x11fd: cmp    r12d,0x2c [warning-unmapped: CMP operand form has no current kop selector: cmp    r12d,0x2c]
 ...
 * - 0x1207: cmp    r12d,0x3a [warning-unmapped: CMP operand form has no current kop selector: cmp    r12d,0x3a]
 ...
 * - 0x1268: cmp    r12d,0x11 [warning-unmapped: CMP operand form has no current kop selector: cmp    r12d,0x11]
 ...
 * - 0x126e: cmp    r12d,0x6 [warning-unmapped: CMP operand form has no current kop selector: cmp    r12d,0x6]
 ...
 * - 0x129a: cmp    r12d,0x6 [warning-unmapped: CMP operand form has no current kop selector: cmp    r12d,0x6]
 ...
 * - 0x12ca: cmp    r10,0x5ea [warning-unmapped: CMP operand form has no current kop selector: cmp    r10,0x5ea]
 ...
 * - 0x1433: rol    r9d,0xe [warning-reg-remap: roll imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x1464: mov    r9,rdi [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x148f: mov    rdi,r9 [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x14ab: mov    r9,rbx [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x14ae: shr    r9,0x2 [warning-reg-remap: shrq imm kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x14be: mov    r9,rdi [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x14d2: inc    r9 [warning-reg-remap: incq reg kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x14d8: mov    rdi,r9 [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x14ff: shr    r9,0x2 [warning-reg-remap: shrq imm kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x1562: cmp    r11,0x10000 [warning-unmapped: CMP operand form has no current kop selector: cmp    r11,0x10000]
 ...
 * - 0x15a2: cmp    r11,0x10000 [warning-unmapped: CMP operand form has no current kop selector: cmp    r11,0x10000]
 ...
 * - 0x15c3: mov    rdx,r9 [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x15ca: mov    rdi,r9 [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x15e6: cmp    r12,rbx [warning-unmapped: CMP operand form has no current kop selector: cmp    r12,rbx]
 ...
 * - 0x162a: movzx  r9d,WORD PTR [rcx+0x2c] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x1642: cmp    r14b,0x6 [warning-unmapped: CMP operand form has no current kop selector: cmp    r14b,0x6]
 ...
 * - 0x1653: cmp    r10,0x5ea [warning-unmapped: CMP operand form has no current kop selector: cmp    r10,0x5ea]
 ...
 * - 0x1670: movzx  r9d,WORD PTR [rcx+0x2a] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x179b: rol    r9w,0x8 [warning-reg-remap: rolw imm8 kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x17c7: lea    rdi,[r9+r8*1] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x17d9: movzx  r9d,di [warning-reg-remap: movzx r32,r16 kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x17f1: movzx  r8d,r9w [warning-reg-remap: movzx r32,r16 kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x17ff: cmovb  r8,r9 [warning-unmapped: cmovb is carry-flag-bound; automatic conversion needs an adjacent unsigned cmp proof]
 * - 0x1809: movzx  r9d,r8w [warning-reg-remap: movzx r32,r16 kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
...
static const struct bpf_insn program[] = {
    ...
    /* 0x1113: cmp    rcx,rbx [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_4, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    ...
    /* 0x1120: cmp    rsi,rbx [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_2, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_3, BPF_REG_4, 0, 0, 1, 0, 22), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x112d: cmp    rdx,rbx [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_3, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_2, BPF_REG_4, 20), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    /* 0x114a: cmp    esi,0xdd86 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_2, 56710), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x1156: cmp    esi,0x8 [exact-kop: cmpl reg,imm32 kop] */
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_2, BPF_REG_4, 0, 0, 1, 0, 42), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x1163: mov    r9d,0x1 [warning-reg-remap: 32-bit immediate move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_K, BPF_REG_9, 0, 0, 1),
    /* 0x1169: cmp    rsi,rbx [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_2, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_3, BPF_REG_3, 0), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x1175: and    dl,0xf [exact-kop: andb imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_REG_IMM_TMP_PAYLOAD(BPF_REG_3, 15, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ANDB_IMM),
    /* 0x1178: cmp    dl,0x5 [warning-unmapped: CMP operand form has no current kop selector: cmp    dl,0x5] */
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_3, BPF_REG_4, 28), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x1185: movzx  esi,BYTE PTR [rcx+0x1d] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_2, BPF_REG_4, 29), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x1189: and    edx,0x3f [exact-kop: andl imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_3, 63), MICRO_HANDCRAFT_BPF_X86_ANDL_IMM32),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_8, BPF_REG_4, 31), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x119a: mov    esi,0x2 [bpf-jit: 32-bit immediate move] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_K, BPF_REG_2, 0, 0, 2),
    /* 0x119f: cmp    r14d,0x1 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_8, 1), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_1, BPF_REG_4, 23), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x11ad: movzx  ebp,WORD PTR [rcx+0x18] [warning-unmapped: destination register ebp is not in the BPF JIT register file] */
    /* 0x11b1: movzx  r11d,WORD PTR [rcx+0x22] [warning-unmapped: destination register r11d is not in the BPF JIT register file] */
    /* 0x11b6: movzx  r8d,BYTE PTR [rcx+0x24] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_5, BPF_REG_4, 36), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x11bb: movzx  edx,BYTE PTR [rcx+0x25] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_3, BPF_REG_4, 37), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x11bf: mov    r15d,DWORD PTR [rcx+0x26] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_9, BPF_REG_4, 38), MICRO_HANDCRAFT_BPF_X86_MOVL_MEM),
    /* 0x11c3: cmp    r14d,0x11 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_8, 17), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x11cd: cmp    r14d,0x6 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_8, 6), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_3, BPF_REG_4, 0, 0, 1, 0, 62), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x11e9: mov    r9d,0x1 [warning-reg-remap: 32-bit immediate move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_K, BPF_REG_9, 0, 0, 1),
    /* 0x11ef: cmp    rdx,rbx [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_3, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    ...
    /* 0x1221: mov    rsi,r10 [warning-unmapped: unsupported mnemonic or operand form: mov    rsi,r10] */
    /* 0x1224: shr    rsi,0x2 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_2, 2), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_3, BPF_REG_4, 22), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x1241: movzx  r15d,BYTE PTR [rcx+0x17] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_9, BPF_REG_4, 23), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x1246: movzx  r14d,WORD PTR [rcx+0x1a] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_8, BPF_REG_4, 26), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    /* 0x124b: mov    edi,DWORD PTR [rcx+0x1e] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_1, BPF_REG_4, 30), MICRO_HANDCRAFT_BPF_X86_MOVL_MEM),
    /* 0x124e: mov    r11d,DWORD PTR [rcx+0x26] [warning-unmapped: unsupported mnemonic or operand form: mov    r11d,DWORD PTR [rcx+0x26]] */
    /* 0x1252: mov    ebp,DWORD PTR [rcx+0x2a] [warning-unmapped: unsupported mnemonic or operand form: mov    ebp,DWORD PTR [rcx+0x2a]] */
    /* 0x1255: mov    r13d,DWORD PTR [rcx+0x2e] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_7, BPF_REG_4, 46), MICRO_HANDCRAFT_BPF_X86_MOVL_MEM),
    /* 0x1259: mov    r8d,0xdeadc0ff [bpf-jit: 32-bit immediate move] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_K, BPF_REG_5, 0, 0, 3735929087),
    /* 0x125f: add    r8d,DWORD PTR [rcx+0x22] [exact-kop: addl memory-source kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ALU_MEM_PAYLOAD(BPF_REG_5, BPF_REG_4, 34, BPF_REG_6, 0), MICRO_HANDCRAFT_BPF_X86_ADDL_MEM),
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_1, BPF_REG_4, 0, 0, 1, 0, 82), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x127d: cmp    rdi,rbx [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_1, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_1, BPF_REG_4, 0, 0, 1, 0, 70), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x1291: cmp    rdi,rbx [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_1, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    ...
    /* 0x129a: cmp    r12d,0x6 [warning-unmapped: CMP operand form has no current kop selector: cmp    r12d,0x6] */
    /* 0x129e: jne    1232 <katran_lb_consistent_hash_select_xdp+0x132> [warning-unmapped: cannot lower cmp    r12d,0x6 + jne    1232 <katran_lb_consistent_hash_select_xdp+0x132> to BPF branch] */
    /* 0x12a0: cmp    r13d,0x101640a [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_7, 16868362), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_1, BPF_REG_4, 64), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    /* 0x12ad: mov    r9d,0x2 [warning-reg-remap: 32-bit immediate move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_K, BPF_REG_9, 0, 0, 2),
    /* 0x12b3: cmp    edi,0x901f [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_1, 36895), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_8, 8), MICRO_HANDCRAFT_BPF_X86_ROLW_IMM),
    /* 0x12ea: movzx  esi,r14w [exact-kop: movzx r32,r16 kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_2, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_MOVZWL_RR),
    /* 0x12ee: mov    edi,ebp [warning-unmapped: unsupported mnemonic or operand form: mov    edi,ebp] */
    /* 0x12f0: and    edi,0xff000000 [exact-kop: andl imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_1, 4278190080), MICRO_HANDCRAFT_BPF_X86_ANDL_IMM32),
    /* 0x12f6: lea    r9d,[r11-0x21523f01] [warning-unmapped: LEA base/index not in BPF register file: [r11-0x21523f01]] */
    /* 0x12fd: mov    r10d,ebp [warning-unmapped: unsupported mnemonic or operand form: mov    r10d,ebp] */
    /* 0x1300: and    r10d,0xff0000 [warning-unmapped: ALU destination r10d is not in the BPF JIT register file] */
    /* 0x1307: add    r10d,edi [warning-unmapped: ALU destination r10d is not in the BPF JIT register file] */
    /* 0x130a: mov    edi,ebp [warning-unmapped: unsupported mnemonic or operand form: mov    edi,ebp] */
    /* 0x130c: and    edi,0xff00 [exact-kop: andl imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_1, 65280), MICRO_HANDCRAFT_BPF_X86_ANDL_IMM32),
    /* 0x1312: add    edi,r10d [warning-unmapped: ALU source r10d is not supported] */
    /* 0x1315: movzx  ebx,bpl [warning-unmapped: movzx source size not recognized: bpl] */
    ...
    /* 0x1328: rol    r14d,0x4 [exact-kop: roll imm kop; verifier instantiate uses temp BPF_REG_6] */
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_5, BPF_REG_4, 62), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    /* 0x1352: xor    r10d,r9d [warning-unmapped: ALU destination r10d is not in the BPF JIT register file] */
    /* 0x1355: sub    r14d,r10d [warning-unmapped: ALU source r10d is not supported] */
    /* 0x1358: mov    r11d,r10d [warning-unmapped: unsupported mnemonic or operand form: mov    r11d,r10d] */
    /* 0x135b: rol    r11d,0x10 [warning-unmapped: ROL width/register not supported by current selectors: r11d] */
    ...
    /* 0x1365: sub    edi,r11d [warning-unmapped: ALU source r11d is not supported] */
    /* 0x1368: mov    r14d,r11d [warning-unmapped: unsupported mnemonic or operand form: mov    r14d,r11d] */
    /* 0x136b: rol    r14d,0x13 [exact-kop: roll imm kop; verifier instantiate uses temp BPF_REG_6] */
    ...
    /* 0x1375: lea    r9d,[r14+r11*1] [warning-unmapped: LEA base/index not in BPF register file: [r14+r11*1]] */
    /* 0x1379: sub    r10d,r14d [warning-unmapped: ALU destination r10d is not in the BPF JIT register file] */
    /* 0x137c: rol    r14d,0x4 [exact-kop: roll imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_8, BPF_REG_8, 4, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x1380: add    r11d,ebx [warning-unmapped: ALU destination r11d is not in the BPF JIT register file] */
    /* 0x1383: xor    r10d,r9d [warning-unmapped: ALU destination r10d is not in the BPF JIT register file] */
    /* 0x1386: xor    r10d,r14d [warning-unmapped: ALU destination r10d is not in the BPF JIT register file] */
    ...
    /* 0x138c: rol    edi,0xe [exact-kop: roll imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 14, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x138f: sub    r10d,edi [warning-unmapped: ALU destination r10d is not in the BPF JIT register file] */
    /* 0x1392: mov    edi,r10d [warning-unmapped: unsupported mnemonic or operand form: mov    edi,r10d] */
    /* 0x1395: rol    edi,0xb [exact-kop: roll imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 11, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x1398: xor    r11d,r10d [warning-unmapped: ALU destination r11d is not in the BPF JIT register file] */
    /* 0x139b: sub    r11d,edi [warning-unmapped: ALU destination r11d is not in the BPF JIT register file] */
    /* 0x139e: xor    r9d,r11d [warning-unmapped: ALU source r11d is not supported] */
    /* 0x13a1: mov    edi,r11d [warning-unmapped: unsupported mnemonic or operand form: mov    edi,r11d] */
    /* 0x13a4: rol    edi,0x19 [exact-kop: roll imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 25, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x13a7: sub    r9d,edi [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU | BPF_SUB | BPF_X, BPF_REG_9, BPF_REG_1, 0, 0),
    /* 0x13aa: xor    r10d,r9d [warning-unmapped: ALU destination r10d is not in the BPF JIT register file] */
    /* 0x13ad: mov    edi,r9d [warning-reg-remap: 32-bit register move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_X, BPF_REG_1, BPF_REG_9, 0, 0),
    /* 0x13b0: rol    edi,0x10 [exact-kop: roll imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x13b3: sub    r10d,edi [warning-unmapped: ALU destination r10d is not in the BPF JIT register file] */
    /* 0x13b6: xor    r11d,r10d [warning-unmapped: ALU destination r11d is not in the BPF JIT register file] */
    /* 0x13b9: mov    edi,r10d [warning-unmapped: unsupported mnemonic or operand form: mov    edi,r10d] */
    /* 0x13bc: rol    edi,0x4 [exact-kop: roll imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 4, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x13bf: sub    r11d,edi [warning-unmapped: ALU destination r11d is not in the BPF JIT register file] */
    /* 0x13c2: xor    r9d,r11d [warning-unmapped: ALU source r11d is not supported] */
    /* 0x13c5: rol    r11d,0xe [warning-unmapped: ROL width/register not supported by current selectors: r11d] */
    /* 0x13c9: sub    r9d,r11d [warning-unmapped: ALU source r11d is not supported] */
    /* 0x13cc: mov    edi,r9d [warning-reg-remap: 32-bit register move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_X, BPF_REG_1, BPF_REG_9, 0, 0),
    /* 0x13cf: rol    edi,0x18 [exact-kop: roll imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 24, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x13d2: xor    r9d,r10d [warning-unmapped: ALU source r10d is not supported] */
    /* 0x13d5: sub    r9d,edi [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU | BPF_SUB | BPF_X, BPF_REG_9, BPF_REG_1, 0, 0),
    /* 0x13d8: add    r9d,0xe0adc0f7 [warning-reg-remap: ALU imm operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x1400: xor    r9d,r10d [warning-unmapped: ALU source r10d is not supported] */
    /* 0x1403: mov    edi,r10d [warning-unmapped: unsupported mnemonic or operand form: mov    edi,r10d] */
    /* 0x1406: rol    edi,0xb [exact-kop: roll imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 11, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x1409: sub    r9d,edi [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU | BPF_SUB | BPF_X, BPF_REG_9, BPF_REG_1, 0, 0),
    /* 0x140c: xor    r11d,r9d [warning-unmapped: ALU destination r11d is not in the BPF JIT register file] */
    /* 0x140f: mov    edi,r9d [warning-reg-remap: 32-bit register move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_X, BPF_REG_1, BPF_REG_9, 0, 0),
    /* 0x1412: rol    edi,0x19 [exact-kop: roll imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 25, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x1415: sub    r11d,edi [warning-unmapped: ALU destination r11d is not in the BPF JIT register file] */
    /* 0x1418: mov    edi,r11d [warning-unmapped: unsupported mnemonic or operand form: mov    edi,r11d] */
    /* 0x141b: rol    edi,0x10 [exact-kop: roll imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x141e: xor    r10d,r11d [warning-unmapped: ALU destination r10d is not in the BPF JIT register file] */
    /* 0x1421: sub    r10d,edi [warning-unmapped: ALU destination r10d is not in the BPF JIT register file] */
    /* 0x1424: xor    r9d,r10d [warning-unmapped: ALU source r10d is not supported] */
    /* 0x1427: mov    edi,r10d [warning-unmapped: unsupported mnemonic or operand form: mov    edi,r10d] */
    /* 0x142a: rol    edi,0x4 [exact-kop: roll imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_1, BPF_REG_1, 4, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x142d: sub    r9d,edi [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU | BPF_SUB | BPF_X, BPF_REG_9, BPF_REG_1, 0, 0),
    /* 0x1430: xor    r11d,r9d [warning-unmapped: ALU destination r11d is not in the BPF JIT register file] */
    /* 0x1433: rol    r9d,0xe [warning-reg-remap: roll imm kop; verifier instantiate uses temp BPF_REG_6; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_9, BPF_REG_9, 14, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x1437: sub    r11d,r9d [warning-unmapped: ALU destination r11d is not in the BPF JIT register file] */
    /* 0x143a: xor    r10d,r11d [warning-unmapped: ALU destination r10d is not in the BPF JIT register file] */
    /* 0x143d: rol    r11d,0x18 [warning-unmapped: ROL width/register not supported by current selectors: r11d] */
    /* 0x1441: sub    r10d,r11d [warning-unmapped: ALU destination r10d is not in the BPF JIT register file] */
    ...
    /* 0x1449: imul   rdi,r10 [warning-unmapped: IMUL operands are not in the 64-bit BPF JIT register file: imul   rdi,r10] */
    /* 0x144d: shr    rdi,0x30 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_1, 48), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    /* 0x1451: mov    r9d,edi [warning-reg-remap: 32-bit register move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x145b: sub    r10d,r9d [warning-unmapped: ALU destination r10d is not in the BPF JIT register file] */
    /* 0x145e: mov    rdi,rdx [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_1, BPF_REG_3), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x1461: add    rdi,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_1, BPF_REG_0, 0, 0),
    /* 0x1464: mov    r9,rdi [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_9, BPF_REG_1), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x1467: shl    r9,0x6 [warning-reg-remap: ALU imm operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x148c: add    r11,rax [warning-unmapped: ALU destination r11 is not in the BPF JIT register file] */
    /* 0x148f: mov    rdi,r9 [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_1, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x1492: shr    rdi,0x2 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_1, 2), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    ...
    /* 0x14a4: mov    rdi,rbx [exact-kop: movq register-to-register kop] */
    ...
    /* 0x14ab: mov    r9,rbx [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_9, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x14ae: shr    r9,0x2 [warning-reg-remap: shrq imm kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_9, 2), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    ...
    /* 0x14cf: add    r9,r10 [warning-unmapped: ALU source r10 is not supported] */
    /* 0x14d2: inc    r9 [warning-reg-remap: incq reg kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_PAYLOAD(BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_INCQ),
    /* 0x14d5: xor    r9,rdi [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_9, BPF_REG_1, 0, 0),
    /* 0x14d8: mov    rdi,r9 [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_1, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    ...
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_5, 8), MICRO_HANDCRAFT_BPF_X86_ROLW_IMM),
    /* 0x150b: shl    r8d,0x10 [bpf-jit: ALU imm operation] */
    HC_RAW(BPF_ALU | BPF_LSH | BPF_K, BPF_REG_5, 0, 0, 16),
    /* 0x150f: and    edx,0xffff0000 [exact-kop: andl imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_3, 4294901760), MICRO_HANDCRAFT_BPF_X86_ANDL_IMM32),
    ...
    /* 0x1543: movzx  r11d,di [warning-unmapped: movzx source size not recognized: di] */
    /* 0x1547: add    r11,r8 [warning-unmapped: ALU destination r11 is not in the BPF JIT register file] */
    /* 0x154a: cmp    rdi,0x10000 [exact-kop: cmpq reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_1, 65536), MICRO_HANDCRAFT_BPF_X86_CMPQ_IMM32),
    /* 0x1551: cmovb  r11,rdi [warning-unmapped: cmovb is carry-flag-bound; automatic conversion needs an adjacent unsigned cmp proof] */
    /* 0x1555: mov    edi,r11d [warning-unmapped: unsupported mnemonic or operand form: mov    edi,r11d] */
    ...
    /* 0x1573: movzx  r11d,r8w [warning-unmapped: movzx source size not recognized: r8w] */
    /* 0x1577: add    r11,rdi [warning-unmapped: ALU destination r11 is not in the BPF JIT register file] */
    /* 0x157a: cmp    r8,0x10000 [exact-kop: cmpq reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_5, 65536), MICRO_HANDCRAFT_BPF_X86_CMPQ_IMM32),
    /* 0x1581: cmovb  r11,r8 [warning-unmapped: cmovb is carry-flag-bound; automatic conversion needs an adjacent unsigned cmp proof] */
    /* 0x1585: mov    edi,r11d [warning-unmapped: unsupported mnemonic or operand form: mov    edi,r11d] */
    ...
    /* 0x15c3: mov    rdx,r9 [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_3, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x15c6: shl    rdx,0x6 [bpf-jit: ALU imm operation] */
    HC_RAW(BPF_ALU64 | BPF_LSH | BPF_K, BPF_REG_3, 0, 0, 6),
    /* 0x15ca: mov    rdi,r9 [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_1, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x15cd: shr    rdi,0x2 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_1, 2), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    ...
    HC_RAW(BPF_ALU | BPF_MOV | BPF_K, BPF_REG_2, 0, 0, 1),
    /* 0x15f0: mov    rdx,rsi [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_3, BPF_REG_2), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x15f3: shl    rdx,0x6 [bpf-jit: ALU imm operation] */
    HC_RAW(BPF_ALU64 | BPF_LSH | BPF_K, BPF_REG_3, 0, 0, 6),
    /* 0x15f7: mov    rdi,rsi [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_1, BPF_REG_2), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x15fa: shr    rdi,0x2 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_1, 2), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    /* 0x15fe: add    rdi,r9 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_1, BPF_REG_9, 0, 0),
    ...
    HC_EXIT(),
    /* 0x161d: cmp    r15d,0x101640a [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_9, 16868362), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x162a: movzx  r9d,WORD PTR [rcx+0x2c] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_9, BPF_REG_4, 44), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    /* 0x162f: cmp    r9d,0x901f [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_9, 36895), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x166d: or     r11d,edx [warning-unmapped: ALU destination r11d is not in the BPF JIT register file] */
    /* 0x1670: movzx  r9d,WORD PTR [rcx+0x2a] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_9, BPF_REG_4, 42), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    /* 0x1675: mov    ebx,r9d [warning-reg-remap: 32-bit register move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x169b: xor    ebp,r10d [warning-unmapped: ALU destination ebp is not in the BPF JIT register file] */
    /* 0x169e: mov    r14d,r10d [warning-unmapped: unsupported mnemonic or operand form: mov    r14d,r10d] */
    /* 0x16a1: rol    r14d,0xb [exact-kop: roll imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_8, BPF_REG_8, 11, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x16a5: sub    ebp,r14d [warning-unmapped: ALU destination ebp is not in the BPF JIT register file] */
    /* 0x16a8: mov    r14d,ebp [warning-unmapped: unsupported mnemonic or operand form: mov    r14d,ebp] */
    /* 0x16ab: rol    r14d,0x19 [exact-kop: roll imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_8, BPF_REG_8, 25, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x16af: xor    ebx,ebp [warning-unmapped: ALU source ebp is not supported] */
    ...
    /* 0x16ba: rol    r14d,0x10 [exact-kop: roll imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_8, BPF_REG_8, 16, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x16be: sub    r10d,r14d [warning-unmapped: ALU destination r10d is not in the BPF JIT register file] */
    /* 0x16c1: xor    ebp,r10d [warning-unmapped: ALU destination ebp is not in the BPF JIT register file] */
    /* 0x16c4: mov    r14d,r10d [warning-unmapped: unsupported mnemonic or operand form: mov    r14d,r10d] */
    /* 0x16c7: rol    r14d,0x4 [exact-kop: roll imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_8, BPF_REG_8, 4, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x16cb: sub    ebp,r14d [warning-unmapped: ALU destination ebp is not in the BPF JIT register file] */
    /* 0x16ce: xor    ebx,ebp [warning-unmapped: ALU source ebp is not supported] */
    /* 0x16d0: rol    ebp,0xe [warning-unmapped: ROL width/register not supported by current selectors: ebp] */
    /* 0x16d3: sub    ebx,ebp [warning-unmapped: ALU source ebp is not supported] */
    /* 0x16d5: xor    r10d,ebx [warning-unmapped: ALU destination r10d is not in the BPF JIT register file] */
    /* 0x16d8: rol    ebx,0x18 [exact-kop: roll imm kop; verifier instantiate uses temp BPF_REG_7] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_6, BPF_REG_6, 24, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x16db: sub    r10d,ebx [warning-unmapped: ALU destination r10d is not in the BPF JIT register file] */
    /* 0x16de: mov    ebx,0xffff0001 [bpf-jit: 32-bit immediate move] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_K, BPF_REG_6, 0, 0, 4294901761),
    /* 0x16e3: imul   rbx,r10 [warning-unmapped: IMUL operands are not in the 64-bit BPF JIT register file: imul   rbx,r10] */
    /* 0x16e7: shr    rbx,0x30 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_6, 48), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    /* 0x16eb: mov    ebp,ebx [warning-unmapped: unsupported mnemonic or operand form: mov    ebp,ebx] */
    /* 0x16ed: shl    ebp,0x10 [warning-unmapped: ALU destination ebp is not in the BPF JIT register file] */
    /* 0x16f0: or     ebp,ebx [warning-unmapped: ALU destination ebp is not in the BPF JIT register file] */
    /* 0x16f2: sub    r10d,ebp [warning-unmapped: ALU destination r10d is not in the BPF JIT register file] */
    ...
    /* 0x1702: mov    r14,r11 [warning-unmapped: unsupported mnemonic or operand form: mov    r14,r11] */
    /* 0x1705: shr    r14,0x2 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_8, 2), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    ...
    /* 0x1719: mov    r11,rbx [warning-unmapped: unsupported mnemonic or operand form: mov    r11,rbx] */
    /* 0x171c: shl    r11,0x6 [warning-unmapped: ALU destination r11 is not in the BPF JIT register file] */
    /* 0x1720: mov    r14,rbx [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_8, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x1723: shr    r14,0x2 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_8, 2), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    /* 0x1727: add    r14,r9 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x173c: mov    r11,r14 [warning-unmapped: unsupported mnemonic or operand form: mov    r11,r14] */
    /* 0x173f: shl    r11,0x6 [warning-unmapped: ALU destination r11 is not in the BPF JIT register file] */
    /* 0x1743: mov    rbx,r14 [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_6, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x1746: shr    rbx,0x2 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_6, 2), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    /* 0x174a: add    r11,rax [warning-unmapped: ALU destination r11 is not in the BPF JIT register file] */
    /* 0x174d: add    r11,rbx [warning-unmapped: ALU destination r11 is not in the BPF JIT register file] */
    /* 0x1750: add    r11,r10 [warning-unmapped: ALU destination r11 is not in the BPF JIT register file] */
    /* 0x1753: xor    r11,r14 [warning-unmapped: ALU destination r11 is not in the BPF JIT register file] */
    ...
    /* 0x175d: add    r10,rax [warning-unmapped: ALU destination r10 is not in the BPF JIT register file] */
    /* 0x1760: mov    rbx,r11 [warning-unmapped: unsupported mnemonic or operand form: mov    rbx,r11] */
    /* 0x1763: shr    rbx,0x2 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_6, 2), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    /* 0x1767: add    r10,rbx [warning-unmapped: ALU destination r10 is not in the BPF JIT register file] */
    /* 0x176a: inc    r10 [warning-unmapped: INC destination r10 is not in the BPF JIT register file] */
    /* 0x176d: xor    r10,r11 [warning-unmapped: ALU destination r10 is not in the BPF JIT register file] */
    ...
    /* 0x1797: shr    r10,0x2 [warning-unmapped: ALU destination r10 is not in the BPF JIT register file] */
    /* 0x179b: rol    r9w,0x8 [warning-reg-remap: rolw imm8 kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_9, 8), MICRO_HANDCRAFT_BPF_X86_ROLW_IMM),
    /* 0x17a0: add    r10,rbx [warning-unmapped: ALU destination r10 is not in the BPF JIT register file] */
    /* 0x17a3: shl    r9d,0x10 [warning-reg-remap: ALU imm operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU | BPF_LSH | BPF_K, BPF_REG_9, 0, 0, 16),
    ...
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_5, BPF_REG_5), MICRO_HANDCRAFT_BPF_X86_MOVZWL_RR),
    /* 0x17bd: mov    r9d,edx [warning-reg-remap: 32-bit register move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_5, BPF_REG_1, 0, 0),
    /* 0x17c7: lea    rdi,[r9+r8*1] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_1, BPF_REG_9, BPF_REG_5, 0, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_RAW(BPF_ALU | BPF_RSH | BPF_K, BPF_REG_5, 0, 0, 16),
    /* 0x17d9: movzx  r9d,di [warning-reg-remap: movzx r32,r16 kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_9, BPF_REG_1), MICRO_HANDCRAFT_BPF_X86_MOVZWL_RR),
    /* 0x17dd: add    r9,r8 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_9, BPF_REG_5, 0, 0),
    /* 0x17e0: cmp    rdi,0x10000 [exact-kop: cmpq reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_1, 65536), MICRO_HANDCRAFT_BPF_X86_CMPQ_IMM32),
    /* 0x17e7: cmovb  r9,rdi [warning-unmapped: cmovb is carry-flag-bound; automatic conversion needs an adjacent unsigned cmp proof] */
    /* 0x17eb: mov    edi,r9d [warning-reg-remap: 32-bit register move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_X, BPF_REG_1, BPF_REG_9, 0, 0),
    ...
    HC_RAW(BPF_ALU | BPF_RSH | BPF_K, BPF_REG_1, 0, 0, 16),
    /* 0x17f1: movzx  r8d,r9w [warning-reg-remap: movzx r32,r16 kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_5, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_MOVZWL_RR),
    /* 0x17f5: add    r8,rdi [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_5, BPF_REG_1, 0, 0),
    /* 0x17f8: cmp    r9,0x10000 [exact-kop: cmpq reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_9, 65536), MICRO_HANDCRAFT_BPF_X86_CMPQ_IMM32),
    /* 0x17ff: cmovb  r8,r9 [warning-unmapped: cmovb is carry-flag-bound; automatic conversion needs an adjacent unsigned cmp proof] */
    ...
    HC_RAW(BPF_ALU | BPF_RSH | BPF_K, BPF_REG_1, 0, 0, 16),
    /* 0x1809: movzx  r9d,r8w [warning-reg-remap: movzx r32,r16 kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_9, BPF_REG_5), MICRO_HANDCRAFT_BPF_X86_MOVZWL_RR),
    /* 0x180d: add    r9,rdi [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_9, BPF_REG_1, 0, 0),
    /* 0x1810: cmp    r8,0x10000 [exact-kop: cmpq reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_5, 65536), MICRO_HANDCRAFT_BPF_X86_CMPQ_IMM32),
    /* 0x1817: cmovb  r9,r8 [warning-unmapped: cmovb is carry-flag-bound; automatic conversion needs an adjacent unsigned cmp proof] */
    /* 0x181b: mov    edi,r9d [warning-reg-remap: 32-bit register move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_X, BPF_REG_1, BPF_REG_9, 0, 0),
    ...
    HC_RAW(BPF_ALU64 | BPF_OR | BPF_K, BPF_REG_3, 0, 0, 33605642),
    /* 0x1838: cmp    r9,0x10000 [exact-kop: cmpq reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_9, 65536), MICRO_HANDCRAFT_BPF_X86_CMPQ_IMM32),
    /* 0x183f: cmovb  edi,r9d [warning-unmapped: cmovb is carry-flag-bound; automatic conversion needs an adjacent unsigned cmp proof] */
    ...
    HC_RAW(BPF_ALU64 | BPF_LSH | BPF_K, BPF_REG_3, 0, 0, 6),
    /* 0x1860: mov    rdi,r10 [warning-unmapped: unsupported mnemonic or operand form: mov    rdi,r10] */
    /* 0x1863: shr    rdi,0x2 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_1, 2), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    ...
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_3, BPF_REG_1, 0, 0),
    /* 0x1870: xor    rdx,r10 [warning-unmapped: ALU source r10 is not supported] */
    /* 0x1873: mov    rsi,rdx [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_2, BPF_REG_3), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    ...
    /* 0x187d: mov    rdi,rdx [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_1, BPF_REG_3), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x1880: shr    rdi,0x2 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_1, 2), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
