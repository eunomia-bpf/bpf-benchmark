 ...
 * - 0x11b2: setge  r9b [warning-reg-remap: setcc kop using adjacent cmp reg,imm proof payload; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x11e0: mov    r10d,DWORD PTR [rsi-0x13] [warning-reg-remap: direct memory load via x86 kop selector; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 ...
 * - 0x11f2: test   r9d,r9d [warning-reg-remap: testl reg,reg kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x122e: lea    r14d,[r10+rbx*1] [warning-reg-remap: LEA via x86 kop selector; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 * - 0x1235: xor    r14d,r11d [warning-unmapped: ALU source r11d is not supported]
 * - 0x123b: lea    ecx,[r9+0x3] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x127a: mov    r8d,r10d [warning-reg-remap: 32-bit register move; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 * - 0x127d: xor    r8,r11 [warning-unmapped: ALU source r11 is not supported]
 * - 0x1290: shl    r10,0x20 [warning-reg-remap: ALU imm operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 * - 0x1294: or     r10,rax [warning-reg-remap: ALU reg operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 * - 0x1297: add    r8,r10 [warning-reg-remap: ALU reg operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
...
static const struct bpf_insn program[] = {
    ...
    HC_KOP(HC_REG_PAYLOAD(BPF_REG_1), MICRO_HANDCRAFT_BPF_X86_INCQ),
    /* 0x115f: add    rsi,0x18 [bpf-jit: ALU imm operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_K, BPF_REG_2, 0, 0, 24),
    /* 0x1163: cmp    rdi,0x20 [exact-kop: cmpq reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_1, 32), MICRO_HANDCRAFT_BPF_X86_CMPQ_IMM32),
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_1, 0, 95, 32),
    /* 0x116d: movzx  eax,WORD PTR [rsi-0x5] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_0, BPF_REG_2, -5), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    /* 0x1171: cmp    eax,0x1f8f [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_0, 8079), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x1178: cmp    eax,0x50 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_0, 80), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x117d: cmp    eax,0x1bb [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_0, 443), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_0, 0, 10, 443),
    /* 0x1184: mov    r9d,0x2 [warning-reg-remap: 32-bit immediate move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x1190: cmp    eax,0x1f90 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_0, 8080), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x1197: cmp    eax,0x20fb [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_0, 8443), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_4, BPF_REG_0), MICRO_HANDCRAFT_BPF_X86_MOVSWL_RR),
    /* 0x11a9: xor    r9d,r9d [warning-reg-remap: zero idiom; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_K, BPF_REG_9, 0, 0, 0),
    /* 0x11ac: cmp    ecx,0x7530 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 30000), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    /* 0x11b2: setge  r9b [warning-reg-remap: setcc kop using adjacent cmp reg,imm proof payload; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_SETCC_CMP_IMM_PAYLOAD(BPF_REG_9, BPF_REG_4, BPF_REG_6, BPF_REG_7, 30000, HC_FLAG_CMP_IMM32), MICRO_HANDCRAFT_BPF_X86_SETGE_R),
    /* 0x11b6: shl    r9d,0x2 [warning-reg-remap: ALU imm operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_6, BPF_REG_2, -23), MICRO_HANDCRAFT_BPF_X86_MOVL_MEM),
    /* 0x11d3: movzx  ecx,BYTE PTR [rsi-0x3] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_2, -3), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x11d7: cmp    ecx,0x2 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 2), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_4, 0, -48, 2),
    /* 0x11e0: mov    r10d,DWORD PTR [rsi-0x13] [warning-reg-remap: direct memory load via x86 kop selector; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_7, BPF_REG_2, -19), MICRO_HANDCRAFT_BPF_X86_MOVL_MEM),
    /* 0x11e4: movzx  ebp,BYTE PTR [rsi-0x2] [warning-unmapped: destination register ebp is not in the BPF JIT register file] */
    /* 0x11e8: test   bpl,0x1 [warning-unmapped: only testq reg,same-reg is supported] */
    /* 0x11ec: je     1290 <bcc_tcpconnect_ipv4_tuple_filter_xdp+0x190> [warning-unmapped: standalone x86 branch needs an immediately preceding cmp] */
    /* 0x11f2: test   r9d,r9d [warning-reg-remap: testl reg,reg kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_9, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_TESTL_RR),
    /* 0x11f5: je     1290 <bcc_tcpconnect_ipv4_tuple_filter_xdp+0x190> [warning-unmapped: standalone x86 branch needs an immediately preceding cmp] */
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_8, BPF_REG_2, -7), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x1203: movzx  r15d,BYTE PTR [rsi-0x6] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_9, BPF_REG_2, -6), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x1208: rol    ecx,0x7 [exact-kop: roll imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ROTATE_PAYLOAD(BPF_REG_4, BPF_REG_4, 7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x120b: xor    ecx,DWORD PTR [rsi-0xf] [exact-kop: xorl memory-source kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_ALU_MEM_PAYLOAD(BPF_REG_4, BPF_REG_2, -15, BPF_REG_6, 0), MICRO_HANDCRAFT_BPF_X86_XORL_MEM),
    /* 0x120e: movzx  r11d,WORD PTR [rsi-0x1] [warning-unmapped: destination register r11d is not in the BPF JIT register file] */
    ...
    /* 0x122e: lea    r14d,[r10+rbx*1] [warning-reg-remap: LEA via x86 kop selector; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_8, BPF_REG_7, BPF_REG_6, 0, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAL),
    ...
    /* 0x123b: lea    ecx,[r9+0x3] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_4, BPF_REG_9, 0, 0, 1, 0, 3), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x123f: mov    eax,r14d [bpf-jit: 32-bit register move] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_X, BPF_REG_0, BPF_REG_8, 0, 0),
    /* 0x1242: rol    eax,cl [exact-kop: roll cl kop; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KOP(HC_ROTATE_CL_PAYLOAD(BPF_REG_0, BPF_REG_4, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_ROLL_CL),
    /* 0x1244: test   bpl,0x4 [warning-unmapped: only testq reg,same-reg is supported] */
    /* 0x1248: cmove  eax,r14d [warning-unmapped: cmove needs an adjacent test/cmp proof payload] */
    ...
    /* 0x1257: and    al,0x7 [exact-kop: andb imm kop; verifier instantiate uses temp BPF_REG_6] */
    ...
    /* 0x125c: mov    r14,rbx [exact-kop: movq register-to-register kop] */
    ...
    /* 0x1262: not    al [exact-kop: notb reg kop; verifier instantiate uses temp BPF_REG_6] */
    ...
    /* 0x1277: or     r11,r9 [warning-unmapped: ALU destination r11 is not in the BPF JIT register file] */
    /* 0x127a: mov    r8d,r10d [warning-reg-remap: 32-bit register move; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_X, BPF_REG_5, BPF_REG_7, 0, 0),
    /* 0x127d: xor    r8,r11 [warning-unmapped: ALU source r11 is not supported] */
    ...
    /* 0x1297: add    r8,r10 [warning-reg-remap: ALU reg operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_5, BPF_REG_7, 0, 0),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_5, BPF_REG_3, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ_MEM_REG),
