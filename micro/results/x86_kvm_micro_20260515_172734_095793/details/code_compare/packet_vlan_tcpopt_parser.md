 ...
 * - 0x1103: mov    r10,QWORD PTR [rdi+0x8] [warning-reg-remap: native xdp_md uses 64-bit host pointer field at off 8; BPF XDP ctx uses u32 field at off 4; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 * - 0x111f: lea    r9,[rdx+0x16] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x115f: lea    r9,[rdx+0x1a] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x11c8: lea    r9,[rdx+0x1e] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x11e3: lea    rdi,[r9+0x14] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x11ef: movzx  edi,BYTE PTR [r9] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x11fa: cmp    r11b,0x40 [warning-unmapped: CMP operand form has no current kop selector: cmp    r11b,0x40]
 ...
 * - 0x1203: cmp    dil,0x5 [warning-unmapped: CMP operand form has no current kop selector: cmp    dil,0x5]
 * - 0x1209: lea    rbx,[r9+rdi*4] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x1212: cmp    BYTE PTR [r9+0x9],0x6 [warning-unmapped: CMP operand form has no current kop selector: cmp    BYTE PTR [r9+0x9],0x6]
 * - 0x1222: movzx  r11d,BYTE PTR [rbx+0xc] [warning-unmapped: destination register r11d is not in the BPF JIT register file]
 * - 0x1227: cmp    r11,0x50 [warning-unmapped: CMP operand form has no current kop selector: cmp    r11,0x50]
 ...
 * - 0x1255: cmp    r11b,0x20 [warning-unmapped: CMP operand form has no current kop selector: cmp    r11b,0x20]
 ...
 * - 0x125b: cmp    BYTE PTR [r14],0x2 [warning-unmapped: CMP operand form has no current kop selector: cmp    BYTE PTR [r14],0x2]
 * - 0x1261: cmp    BYTE PTR [rbx+0x15],0x4 [warning-unmapped: CMP operand form has no current kop selector: cmp    BYTE PTR [rbx+0x15],0x4]
 * - 0x1267: cmp    BYTE PTR [rbx+0x18],0x1 [warning-unmapped: CMP operand form has no current kop selector: cmp    BYTE PTR [rbx+0x18],0x1]
 * - 0x126d: cmp    BYTE PTR [rbx+0x19],0x3 [warning-unmapped: CMP operand form has no current kop selector: cmp    BYTE PTR [rbx+0x19],0x3]
 * - 0x1273: cmp    BYTE PTR [rbx+0x1a],0x3 [warning-unmapped: CMP operand form has no current kop selector: cmp    BYTE PTR [rbx+0x1a],0x3]
 * - 0x1279: cmp    BYTE PTR [rbx+0x1c],0x4 [warning-unmapped: CMP operand form has no current kop selector: cmp    BYTE PTR [rbx+0x1c],0x4]
 * - 0x127f: cmp    BYTE PTR [rbx+0x1d],0x2 [warning-unmapped: CMP operand form has no current kop selector: cmp    BYTE PTR [rbx+0x1d],0x2]
 * - 0x1285: cmp    BYTE PTR [rbx+0x1e],0x1 [warning-unmapped: CMP operand form has no current kop selector: cmp    BYTE PTR [rbx+0x1e],0x1]
 * - 0x128f: movzx  eax,WORD PTR [r9+0x2] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x129b: mov    r10d,DWORD PTR [r9+0xc] [warning-reg-remap: direct memory load via x86 kop selector; native r10 has no exact BPF JIT register; remapped to BPF_REG_7; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x129f: bswap  r10d [warning-reg-remap: bswapl kop; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 * - 0x12a2: mov    r9d,DWORD PTR [r9+0x10] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x12a6: bswap  r9d [warning-reg-remap: bswapl kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x12c8: xor    rax,r10 [warning-reg-remap: ALU reg operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 ...
 * - 0x12ce: movzx  r9d,BYTE PTR [rbx+0x16] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x12d3: mov    r10d,r9d [warning-reg-remap: 32-bit register move; native r10 has no exact BPF JIT register; remapped to BPF_REG_7; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x12d6: shl    r10d,0x8 [warning-reg-remap: ALU imm operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 * - 0x12df: or     r10d,r14d [warning-reg-remap: ALU reg operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 * - 0x12e2: add    r10,0x2 [warning-reg-remap: ALU imm operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 ...
 * - 0x12ea: xor    r9,r10 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 ...
 * - 0x12fb: movzx  r10d,BYTE PTR [rbx+0x1b] [warning-reg-remap: direct memory load via x86 kop selector; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 * - 0x1300: mov    r14,r10 [warning-reg-remap: movq register-to-register kop; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 * - 0x1307: shl    r10d,0x10 [warning-reg-remap: ALU imm operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 * - 0x130b: xor    r10,r14 [warning-reg-remap: ALU reg operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 * - 0x130e: xor    r10,r9 [warning-reg-remap: ALU reg operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x1319: or     rbx,r10 [warning-reg-remap: ALU reg operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 ...
 * - 0x1352: rol    r9,cl [warning-reg-remap: rolq cl kop; verifier instantiate uses temps BPF_REG_6/BPF_REG_7; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x135b: mov    QWORD PTR [rdx],r9 [warning-reg-remap: direct memory store via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 */
...
static const struct bpf_insn program[] = {
    ...
    /* 0x1109: cmp    rdx,r10 [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_3, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    /* 0x110c: ja     1244 <packet_vlan_tcpopt_parser_xdp+0x144> [bpf-branch: lowered cmp    rdx,r10 + ja     1244 <packet_vlan_tcpopt_parser_xdp+0x144> to verifier-visible BPF branch] */
    HC_JMP_REG(BPF_JGT, BPF_REG_3, BPF_REG_7, 107),
    /* 0x1112: lea    rcx,[rdx+0x8] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_4, BPF_REG_3, 0, 0, 1, 0, 8), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x1116: cmp    rcx,r10 [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_4, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    /* 0x1119: ja     1244 <packet_vlan_tcpopt_parser_xdp+0x144> [bpf-branch: lowered cmp    rcx,r10 + ja     1244 <packet_vlan_tcpopt_parser_xdp+0x144> to verifier-visible BPF branch] */
    HC_JMP_REG(BPF_JGT, BPF_REG_4, BPF_REG_7, 102),
    /* 0x111f: lea    r9,[rdx+0x16] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_9, BPF_REG_3, 0, 0, 1, 0, 22), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x1123: cmp    r9,r10 [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_9, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    /* 0x1126: ja     1244 <packet_vlan_tcpopt_parser_xdp+0x144> [bpf-branch: lowered cmp    r9,r10 + ja     1244 <packet_vlan_tcpopt_parser_xdp+0x144> to verifier-visible BPF branch] */
    HC_JMP_REG(BPF_JGT, BPF_REG_9, BPF_REG_7, 97),
    /* 0x112c: push   rbp [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x112d: push   r15 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x112f: push   r14 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1131: push   rbx [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1132: movzx  eax,WORD PTR [rdx+0x14] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_0, BPF_REG_3, 20), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    /* 0x1136: rol    ax,0x8 [exact-kop: rolw imm8 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_0, 8), MICRO_HANDCRAFT_BPF_X86_ROLW_IMM),
    /* 0x113a: movzx  ecx,ax [exact-kop: movzx r32,r16 kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_4, BPF_REG_0), MICRO_HANDCRAFT_BPF_X86_MOVZWL_RR),
    /* 0x113d: xor    eax,eax [bpf-jit: zero idiom] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_K, BPF_REG_0, 0, 0, 0),
    /* 0x113f: cmp    ecx,0x800 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 2048), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_4, 0, 59, 2048),
    /* 0x114b: cmp    ecx,0x88a8 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 34984), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x1153: cmp    ecx,0x8100 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 33024), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_4, 0, 81, 33024),
    /* 0x115f: lea    r9,[rdx+0x1a] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_9, BPF_REG_3, 0, 0, 1, 0, 26), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x1163: cmp    r9,r10 [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_9, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    /* 0x1166: ja     123e <packet_vlan_tcpopt_parser_xdp+0x13e> [bpf-branch: lowered cmp    r9,r10 + ja     123e <packet_vlan_tcpopt_parser_xdp+0x13e> to verifier-visible BPF branch] */
    HC_JMP_REG(BPF_JGT, BPF_REG_9, BPF_REG_7, 76),
    /* 0x116c: movzx  esi,WORD PTR [rdx+0x16] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_2, BPF_REG_3, 22), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    /* 0x1170: movzx  ecx,WORD PTR [rdx+0x18] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_3, 24), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    /* 0x1174: rol    si,0x8 [exact-kop: rolw imm8 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_2, 8), MICRO_HANDCRAFT_BPF_X86_ROLW_IMM),
    /* 0x1178: rol    cx,0x8 [exact-kop: rolw imm8 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 8), MICRO_HANDCRAFT_BPF_X86_ROLW_IMM),
    /* 0x117c: movzx  ecx,cx [exact-kop: movzx r32,r16 kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_4, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_MOVZWL_RR),
    /* 0x117f: cmp    ecx,0x800 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 2048), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_4, 0, 64, 2048),
    /* 0x118b: cmp    ecx,0x88a8 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 34984), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_4, 0, 3, 34984),
    /* 0x1193: cmp    ecx,0x8100 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 33024), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_4, 0, 57, 33024),
    /* 0x119f: lea    rcx,[rdx+0x1e] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_4, BPF_REG_3, 0, 0, 1, 0, 30), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x11a3: cmp    rcx,r10 [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_4, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    /* 0x11a6: ja     123e <packet_vlan_tcpopt_parser_xdp+0x13e> [bpf-branch: lowered cmp    rcx,r10 + ja     123e <packet_vlan_tcpopt_parser_xdp+0x13e> to verifier-visible BPF branch] */
    HC_JMP_REG(BPF_JGT, BPF_REG_4, BPF_REG_7, 52),
    /* 0x11ac: movzx  ecx,WORD PTR [rdx+0x1c] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_3, 28), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    /* 0x11b0: rol    cx,0x8 [exact-kop: rolw imm8 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 8), MICRO_HANDCRAFT_BPF_X86_ROLW_IMM),
    /* 0x11b4: movzx  ecx,cx [exact-kop: movzx r32,r16 kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_4, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_MOVZWL_RR),
    /* 0x11b7: cmp    ecx,0x800 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 2048), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_4, 0, 43, 2048),
    /* 0x11bf: lea    rcx,[rdx+0x32] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_4, BPF_REG_3, 0, 0, 1, 0, 50), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x11c3: cmp    rcx,r10 [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_4, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    /* 0x11c6: ja     123e <packet_vlan_tcpopt_parser_xdp+0x13e> [bpf-branch: lowered cmp    rcx,r10 + ja     123e <packet_vlan_tcpopt_parser_xdp+0x13e> to verifier-visible BPF branch] */
    HC_JMP_REG(BPF_JGT, BPF_REG_4, BPF_REG_7, 38),
    /* 0x11c8: lea    r9,[rdx+0x1e] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_9, BPF_REG_3, 0, 0, 1, 0, 30), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x11cc: movzx  ecx,WORD PTR [rdx+0x1a] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_3, 26), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    /* 0x11d0: rol    cx,0x8 [exact-kop: rolw imm8 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 8), MICRO_HANDCRAFT_BPF_X86_ROLW_IMM),
    /* 0x11d4: movzx  r8d,cx [exact-kop: movzx r32,r16 kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_5, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_MOVZWL_RR),
    ...
    /* 0x11e3: lea    rdi,[r9+0x14] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_1, BPF_REG_9, 0, 0, 1, 0, 20), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x11e7: cmp    rdi,r10 [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_1, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    /* 0x11ea: ja     123e <packet_vlan_tcpopt_parser_xdp+0x13e> [bpf-branch: lowered cmp    rdi,r10 + ja     123e <packet_vlan_tcpopt_parser_xdp+0x13e> to verifier-visible BPF branch] */
    HC_JMP_REG(BPF_JGT, BPF_REG_1, BPF_REG_7, 21),
    /* 0x11ec: xor    r8d,r8d [bpf-jit: zero idiom] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_K, BPF_REG_5, 0, 0, 0),
    /* 0x11ef: movzx  edi,BYTE PTR [r9] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_1, BPF_REG_9, 0), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x11f3: mov    r11d,edi [warning-unmapped: unsupported mnemonic or operand form: mov    r11d,edi] */
    /* 0x11f6: and    r11b,0xf0 [warning-unmapped: ALU destination r11b is not in the BPF JIT register file] */
    /* 0x11fa: cmp    r11b,0x40 [warning-unmapped: CMP operand form has no current kop selector: cmp    r11b,0x40] */
    /* 0x11fe: jne    123e <packet_vlan_tcpopt_parser_xdp+0x13e> [warning-unmapped: cannot lower cmp    r11b,0x40 + jne    123e <packet_vlan_tcpopt_parser_xdp+0x13e> to BPF branch] */
    /* 0x1200: and    edi,0xf [exact-kop: andl imm32 kop] */
    ...
    HC_RAW(BPF_JMP | BPF_JLT | BPF_K, BPF_REG_1, 0, 15, 5),
    /* 0x1209: lea    rbx,[r9+rdi*4] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_6, BPF_REG_9, BPF_REG_1, 2, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x120d: cmp    rbx,r10 [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    /* 0x1210: ja     123e <packet_vlan_tcpopt_parser_xdp+0x13e> [bpf-branch: lowered cmp    rbx,r10 + ja     123e <packet_vlan_tcpopt_parser_xdp+0x13e> to verifier-visible BPF branch] */
    HC_JMP_REG(BPF_JGT, BPF_REG_6, BPF_REG_7, 10),
    /* 0x1212: cmp    BYTE PTR [r9+0x9],0x6 [warning-unmapped: CMP operand form has no current kop selector: cmp    BYTE PTR [r9+0x9],0x6] */
    ...
    HC_LDX(BPF_B, BPF_REG_6, BPF_REG_9, 9),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, 8, 6),
    /* 0x1219: lea    r14,[rbx+0x14] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_8, BPF_REG_6, 0, 0, 1, 0, 20), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x121d: cmp    r14,r10 [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_8, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    /* 0x1220: ja     123e <packet_vlan_tcpopt_parser_xdp+0x13e> [bpf-branch: lowered cmp    r14,r10 + ja     123e <packet_vlan_tcpopt_parser_xdp+0x13e> to verifier-visible BPF branch] */
    HC_JMP_REG(BPF_JGT, BPF_REG_8, BPF_REG_7, 3),
    /* 0x1222: movzx  r11d,BYTE PTR [rbx+0xc] [warning-unmapped: destination register r11d is not in the BPF JIT register file] */
    /* 0x1227: cmp    r11,0x50 [warning-unmapped: CMP operand form has no current kop selector: cmp    r11,0x50] */
    /* 0x122b: jb     123e <packet_vlan_tcpopt_parser_xdp+0x13e> [warning-unmapped: cannot lower cmp    r11,0x50 + jb     123e <packet_vlan_tcpopt_parser_xdp+0x13e> to BPF branch] */
    /* 0x122d: shr    r11d,0x2 [warning-unmapped: ALU destination r11d is not in the BPF JIT register file] */
    /* 0x1231: and    r11d,0xfffffffc [warning-unmapped: ALU destination r11d is not in the BPF JIT register file] */
    /* 0x1235: lea    r15,[rbx+r11*1] [warning-unmapped: LEA base/index not in BPF register file: [rbx+r11*1]] */
    /* 0x1239: cmp    r15,r10 [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_9, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    /* 0x123c: jbe    124c <packet_vlan_tcpopt_parser_xdp+0x14c> [bpf-branch: lowered cmp    r15,r10 + jbe    124c <packet_vlan_tcpopt_parser_xdp+0x14c> to verifier-visible BPF branch] */
    HC_JMP_REG(BPF_JLE, BPF_REG_9, BPF_REG_7, 3),
    /* 0x123e: pop    rbx [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x123f: pop    r14 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1241: pop    r15 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1243: pop    rbp [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_9, BPF_REG_6, 0, 0, 1, 0, 32), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x1250: cmp    r15,r10 [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_9, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    /* 0x1253: ja     123e <packet_vlan_tcpopt_parser_xdp+0x13e> [bpf-branch: lowered cmp    r15,r10 + ja     123e <packet_vlan_tcpopt_parser_xdp+0x13e> to verifier-visible BPF branch] */
    HC_JMP_REG(BPF_JGT, BPF_REG_9, BPF_REG_7, -8),
    /* 0x1255: cmp    r11b,0x20 [warning-unmapped: CMP operand form has no current kop selector: cmp    r11b,0x20] */
    /* 0x1259: jb     123e <packet_vlan_tcpopt_parser_xdp+0x13e> [warning-unmapped: cannot lower cmp    r11b,0x20 + jb     123e <packet_vlan_tcpopt_parser_xdp+0x13e> to BPF branch] */
    /* 0x125b: cmp    BYTE PTR [r14],0x2 [warning-unmapped: CMP operand form has no current kop selector: cmp    BYTE PTR [r14],0x2] */
    ...
    HC_LDX(BPF_B, BPF_REG_6, BPF_REG_8, 0),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, -10, 2),
    /* 0x1261: cmp    BYTE PTR [rbx+0x15],0x4 [warning-unmapped: CMP operand form has no current kop selector: cmp    BYTE PTR [rbx+0x15],0x4] */
    ...
    HC_RAW(BPF_JMP | BPF_JLT | BPF_K, BPF_REG_7, 0, -12, 4),
    /* 0x1267: cmp    BYTE PTR [rbx+0x18],0x1 [warning-unmapped: CMP operand form has no current kop selector: cmp    BYTE PTR [rbx+0x18],0x1] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, -14, 1),
    /* 0x126d: cmp    BYTE PTR [rbx+0x19],0x3 [warning-unmapped: CMP operand form has no current kop selector: cmp    BYTE PTR [rbx+0x19],0x3] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, -16, 3),
    /* 0x1273: cmp    BYTE PTR [rbx+0x1a],0x3 [warning-unmapped: CMP operand form has no current kop selector: cmp    BYTE PTR [rbx+0x1a],0x3] */
    ...
    HC_RAW(BPF_JMP | BPF_JLT | BPF_K, BPF_REG_7, 0, -18, 3),
    /* 0x1279: cmp    BYTE PTR [rbx+0x1c],0x4 [warning-unmapped: CMP operand form has no current kop selector: cmp    BYTE PTR [rbx+0x1c],0x4] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, -20, 4),
    /* 0x127f: cmp    BYTE PTR [rbx+0x1d],0x2 [warning-unmapped: CMP operand form has no current kop selector: cmp    BYTE PTR [rbx+0x1d],0x2] */
    ...
    HC_RAW(BPF_JMP | BPF_JLT | BPF_K, BPF_REG_7, 0, -22, 2),
    /* 0x1285: cmp    BYTE PTR [rbx+0x1e],0x1 [warning-unmapped: CMP operand form has no current kop selector: cmp    BYTE PTR [rbx+0x1e],0x1] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, -24, 1),
    /* 0x128b: shl    rdi,0x2 [bpf-jit: ALU imm operation] */
    HC_RAW(BPF_ALU64 | BPF_LSH | BPF_K, BPF_REG_1, 0, 0, 2),
    /* 0x128f: movzx  eax,WORD PTR [r9+0x2] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_0, BPF_REG_9, 2), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    /* 0x1294: rol    ax,0x8 [exact-kop: rolw imm8 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_0, 8), MICRO_HANDCRAFT_BPF_X86_ROLW_IMM),
    /* 0x1298: movzx  eax,ax [exact-kop: movzx r32,r16 kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_0, BPF_REG_0), MICRO_HANDCRAFT_BPF_X86_MOVZWL_RR),
    /* 0x129b: mov    r10d,DWORD PTR [r9+0xc] [warning-reg-remap: direct memory load via x86 kop selector; native r10 has no exact BPF JIT register; remapped to BPF_REG_7; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_7, BPF_REG_9, 12), MICRO_HANDCRAFT_BPF_X86_MOVL_MEM),
    /* 0x129f: bswap  r10d [warning-reg-remap: bswapl kop; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KOP(HC_REG_PAYLOAD(BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_BSWAPL),
    /* 0x12a2: mov    r9d,DWORD PTR [r9+0x10] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_9, BPF_REG_9, 16), MICRO_HANDCRAFT_BPF_X86_MOVL_MEM),
    /* 0x12a6: bswap  r9d [warning-reg-remap: bswapl kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_PAYLOAD(BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_BSWAPL),
    /* 0x12a9: movzx  ebp,WORD PTR [rbx] [warning-unmapped: destination register ebp is not in the BPF JIT register file] */
    /* 0x12ac: movzx  r14d,WORD PTR [rbx+0x2] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_8, BPF_REG_6, 2), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    /* 0x12b1: rol    bp,0x8 [warning-unmapped: ROL width/register not supported by current selectors: bp] */
    /* 0x12b5: movzx  r15d,bp [warning-unmapped: movzx source size not recognized: bp] */
    ...
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_0, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_MOVZWL_RR),
    /* 0x12c5: add    rax,r15 [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_9, 0, 0),
    /* 0x12c8: xor    rax,r10 [warning-reg-remap: ALU reg operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_0, BPF_REG_7, 0, 0),
    /* 0x12cb: add    rax,r9 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_X, BPF_REG_0, BPF_REG_9, 0, 0),
    /* 0x12ce: movzx  r9d,BYTE PTR [rbx+0x16] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_9, BPF_REG_6, 22), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x12d3: mov    r10d,r9d [warning-reg-remap: 32-bit register move; native r10 has no exact BPF JIT register; remapped to BPF_REG_7; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_8, BPF_REG_6, 23), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x12df: or     r10d,r14d [warning-reg-remap: ALU reg operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_RAW(BPF_ALU | BPF_OR | BPF_X, BPF_REG_7, BPF_REG_8, 0, 0),
    /* 0x12e2: add    r10,0x2 [warning-reg-remap: ALU imm operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_K, BPF_REG_7, 0, 0, 2),
    /* 0x12e6: shl    r9d,0x10 [warning-reg-remap: ALU imm operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x12fb: movzx  r10d,BYTE PTR [rbx+0x1b] [warning-reg-remap: direct memory load via x86 kop selector; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_7, BPF_REG_6, 27), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x1300: mov    r14,r10 [warning-reg-remap: movq register-to-register kop; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_8, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    ...
    /* 0x130b: xor    r10,r14 [warning-reg-remap: ALU reg operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_7, BPF_REG_8, 0, 0),
    /* 0x130e: xor    r10,r9 [warning-reg-remap: ALU reg operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_6, BPF_REG_6, 31), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x1315: shl    rbx,0x28 [bpf-jit: ALU imm operation] */
    HC_RAW(BPF_ALU64 | BPF_LSH | BPF_K, BPF_REG_6, 0, 0, 40),
    /* 0x1319: or     rbx,r10 [warning-reg-remap: ALU reg operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_RAW(BPF_ALU64 | BPF_OR | BPF_X, BPF_REG_6, BPF_REG_7, 0, 0),
    /* 0x131c: movabs r9,0x144000000 [warning-reg-remap: 64-bit immediate load; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x1332: mov    rax,rcx [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_0, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    ...
    /* 0x1352: rol    r9,cl [warning-reg-remap: rolq cl kop; verifier instantiate uses temps BPF_REG_6/BPF_REG_7; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_ROTATE_CL_PAYLOAD(BPF_REG_9, BPF_REG_4, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_ROLQ_CL),
