 ...
 * - 0x1124: cmp    DWORD PTR [rdx],0x80 [warning-unmapped: CMP operand form has no current kop selector: cmp    DWORD PTR [rdx],0x80]
 ...
 * - 0x1144: mov    edx,r11d [warning-reg-remap: 32-bit register move; native r11 has no exact BPF JIT register; remapped to BPF_REG_7]
 * - 0x1154: mov    rax,r10 [warning-unmapped: unsupported mnemonic or operand form: mov    rax,r10]
 * - 0x1157: cmp    r10,0x80 [warning-unmapped: CMP operand form has no current kop selector: cmp    r10,0x80]
 ...
 * - 0x1193: lea    r8d,[r9+0x1] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x119d: mov    r9,rdx [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x11a0: shr    r9,1 [warning-reg-remap: shrq imm kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x11a7: mov    rdx,r9 [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x11d9: movzx  r9d,BYTE PTR [rsi+rax*8+0x17] [warning-reg-remap: indexed memory load via x86 SIB kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x11ed: mov    r11d,0x19 [warning-reg-remap: 32-bit immediate move; native r11 has no exact BPF JIT register; remapped to BPF_REG_7]
 ...
 * - 0x11f7: lea    r14d,[r11+0x1] [warning-reg-remap: LEA via x86 kop selector; native r11 has no exact BPF JIT register; remapped to BPF_REG_7]
 * - 0x11fb: mov    edx,r11d [warning-reg-remap: 32-bit register move; native r11 has no exact BPF JIT register; remapped to BPF_REG_7]
 * - 0x1204: mov    r15,r9 [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x1214: mov    rbx,r9 [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x122f: shr    r9,0x20 [warning-reg-remap: shrq imm kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
...
static const struct bpf_insn program[] = {
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_1, BPF_REG_2, 0, 0, 1, 0, 1040), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_LDX(BPF_W, BPF_REG_6, BPF_REG_3, 0),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_1, BPF_REG_2, 12), MICRO_HANDCRAFT_BPF_X86_MOVL_MEM),
    ...
    /* 0x1144: mov    edx,r11d [warning-reg-remap: 32-bit register move; native r11 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_X, BPF_REG_3, BPF_REG_7, 0, 0),
    /* 0x1147: and    al,0x38 [exact-kop: andb imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_REG_IMM_TMP_PAYLOAD(BPF_REG_0, 56, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ANDB_IMM),
    ...
    /* 0x1151: mov    rdi,rbx [exact-kop: movq register-to-register kop] */
    ...
    HC_KOP(HC_SIB_PAYLOAD(BPF_REG_3, BPF_REG_2, BPF_REG_0, 3, 16), MICRO_HANDCRAFT_BPF_X86_MOVZWL_SIB),
    /* 0x1169: movzx  ecx,BYTE PTR [rsi+rax*8+0x12] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_SIB_PAYLOAD(BPF_REG_4, BPF_REG_2, BPF_REG_0, 3, 18), MICRO_HANDCRAFT_BPF_X86_MOVZBL_SIB),
    ...
    /* 0x117f: and    edx,0xfffff [exact-kop: andl imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_3, 1048575), MICRO_HANDCRAFT_BPF_X86_ANDL_IMM32),
    ...
    /* 0x1193: lea    r8d,[r9+0x1] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_5, BPF_REG_9, 0, 0, 1, 0, 1), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x1197: cmp    r9d,0x3d [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_9, 61), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_K, BPF_REG_9, 0, 9, 61),
    /* 0x119d: mov    r9,rdx [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_9, BPF_REG_3), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x11a0: shr    r9,1 [warning-reg-remap: shrq imm kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_9, 1), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    /* 0x11a3: cmp    rdx,0x3 [exact-kop: cmpq reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_3, 3), MICRO_HANDCRAFT_BPF_X86_CMPQ_IMM32),
    /* 0x11a7: mov    rdx,r9 [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_K, BPF_REG_3, 0, -15, 3),
    /* 0x11ac: movzx  edx,BYTE PTR [rsi+rax*8+0x13] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_SIB_PAYLOAD(BPF_REG_3, BPF_REG_2, BPF_REG_0, 3, 19), MICRO_HANDCRAFT_BPF_X86_MOVZBL_SIB),
    ...
    HC_KOP(HC_SIB_PAYLOAD(BPF_REG_4, BPF_REG_2, BPF_REG_0, 3, 20), MICRO_HANDCRAFT_BPF_X86_MOVZBL_SIB),
    ...
    HC_KOP(HC_SIB_PAYLOAD(BPF_REG_4, BPF_REG_2, BPF_REG_0, 3, 22), MICRO_HANDCRAFT_BPF_X86_MOVZBL_SIB),
    /* 0x11d5: shl    rcx,0x30 [bpf-jit: ALU imm operation] */
    HC_RAW(BPF_ALU64 | BPF_LSH | BPF_K, BPF_REG_4, 0, 0, 48),
    /* 0x11d9: movzx  r9d,BYTE PTR [rsi+rax*8+0x17] [warning-reg-remap: indexed memory load via x86 SIB kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_SIB_PAYLOAD(BPF_REG_9, BPF_REG_2, BPF_REG_0, 3, 23), MICRO_HANDCRAFT_BPF_X86_MOVZBL_SIB),
    /* 0x11df: shl    r9,0x38 [warning-reg-remap: ALU imm operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_LSH | BPF_K, BPF_REG_9, 0, 0, 56),
    /* 0x11e3: or     r9,rcx [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_OR | BPF_X, BPF_REG_9, BPF_REG_4, 0, 0),
    /* 0x11e6: or     r9,r10 [warning-unmapped: ALU source r10 is not supported] */
    /* 0x11e9: cmp    r8d,0x19 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_5, 25), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    /* 0x11ed: mov    r11d,0x19 [warning-reg-remap: 32-bit immediate move; native r11 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_K, BPF_REG_7, 0, 0, 25),
    /* 0x11f3: cmovb  r11d,r8d [warning-unmapped: cmovb is carry-flag-bound; automatic conversion needs an adjacent unsigned cmp proof] */
    /* 0x11f7: lea    r14d,[r11+0x1] [warning-reg-remap: LEA via x86 kop selector; native r11 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_8, BPF_REG_7, 0, 0, 1, 0, 1), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x11fb: mov    edx,r11d [warning-reg-remap: 32-bit register move; native r11 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_X, BPF_REG_3, BPF_REG_7, 0, 0),
    /* 0x11fe: and    dl,0x7 [exact-kop: andb imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_REG_IMM_TMP_PAYLOAD(BPF_REG_3, 7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ANDB_IMM),
    ...
    /* 0x1204: mov    r15,r9 [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_9, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x1207: shl    r15,cl [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_LSH | BPF_X, BPF_REG_9, BPF_REG_4, 0, 0),
    /* 0x120a: lea    r10,[rax+0x1] [warning-unmapped: LEA operands are not representable] */
    /* 0x120e: imul   r14,r10 [warning-unmapped: IMUL operands are not in the 64-bit BPF JIT register file: imul   r14,r10] */
    /* 0x1212: not    dl [exact-kop: notb reg kop; verifier instantiate uses temp BPF_REG_6] */
    ...
    /* 0x1225: cmp    r8d,0x19 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_5, 25), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    HC_RAW(BPF_JMP | BPF_JLT | BPF_K, BPF_REG_5, 0, -78, 25),
    /* 0x122f: shr    r9,0x20 [warning-reg-remap: shrq imm kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_9, 32), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    /* 0x1233: add    rbx,r9 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_1, BPF_REG_2, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ_MEM_REG),
