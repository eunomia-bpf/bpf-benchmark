 ...
 * - 0x1129: cmp    DWORD PTR [rdx+0xc],0x20 [warning-unmapped: CMP operand form has no current kop selector: cmp    DWORD PTR [rdx+0xc],0x20]
 ...
 * - 0x117e: mov    r10,QWORD PTR [rdx+rsi*4+0x20] [warning-reg-remap: indexed memory load via x86 SIB kop; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 * - 0x1188: add    rcx,r10 [warning-reg-remap: ALU reg operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 * - 0x1193: mov    r9d,DWORD PTR [rdx+rsi*4+0x2c] [warning-reg-remap: indexed memory load via x86 SIB kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x119f: mov    r11,rax [warning-reg-remap: movq register-to-register kop; native r11 has no exact BPF JIT register; remapped to BPF_REG_8]
...
static const struct bpf_insn program[] = {
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_1, BPF_REG_3, 0, 0, 1, 0, 1040), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x1142: and    cl,0x7 [exact-kop: andb imm kop; verifier instantiate uses temp BPF_REG_6] */
    ...
    /* 0x1150: and    cl,0x18 [exact-kop: andb imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_REG_IMM_TMP_PAYLOAD(BPF_REG_4, 24, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ANDB_IMM),
    /* 0x1153: mov    r8,rax [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_5, BPF_REG_0), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    ...
    /* 0x115c: and    al,0x7 [exact-kop: andb imm kop; verifier instantiate uses temp BPF_REG_6] */
    ...
    /* 0x1161: mov    rbx,r8 [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_6, BPF_REG_5), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x1164: shl    rbx,cl [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_LSH | BPF_X, BPF_REG_6, BPF_REG_4, 0, 0),
    /* 0x1167: not    al [exact-kop: notb reg kop; verifier instantiate uses temp BPF_REG_6] */
    ...
    /* 0x1178: cmp    rdi,0x20 [exact-kop: cmpq reg,imm32 kop] */
    ...
    /* 0x117e: mov    r10,QWORD PTR [rdx+rsi*4+0x20] [warning-reg-remap: indexed memory load via x86 SIB kop; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KOP(HC_SIB_PAYLOAD(BPF_REG_7, BPF_REG_3, BPF_REG_2, 2, 32), MICRO_HANDCRAFT_BPF_X86_MOVQ_SIB),
    /* 0x1183: mov    rcx,QWORD PTR [rdx+rsi*4+0x18] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_SIB_PAYLOAD(BPF_REG_4, BPF_REG_3, BPF_REG_2, 2, 24), MICRO_HANDCRAFT_BPF_X86_MOVQ_SIB),
    /* 0x1188: add    rcx,r10 [warning-reg-remap: ALU reg operation; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    ...
    HC_KOP(HC_SIB_PAYLOAD(BPF_REG_0, BPF_REG_3, BPF_REG_2, 2, 40), MICRO_HANDCRAFT_BPF_X86_MOVL_SIB),
    /* 0x118f: shl    rax,0x20 [bpf-jit: ALU imm operation] */
    HC_RAW(BPF_ALU64 | BPF_LSH | BPF_K, BPF_REG_0, 0, 0, 32),
    /* 0x1193: mov    r9d,DWORD PTR [rdx+rsi*4+0x2c] [warning-reg-remap: indexed memory load via x86 SIB kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_SIB_PAYLOAD(BPF_REG_9, BPF_REG_3, BPF_REG_2, 2, 44), MICRO_HANDCRAFT_BPF_X86_MOVL_SIB),
    /* 0x1198: or     r9,rax [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    HC_KOP(HC_SIB_PAYLOAD(BPF_REG_0, BPF_REG_3, BPF_REG_2, 2, 16), MICRO_HANDCRAFT_BPF_X86_MOVL_SIB),
    /* 0x119f: mov    r11,rax [warning-reg-remap: movq register-to-register kop; native r11 has no exact BPF JIT register; remapped to BPF_REG_8] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_8, BPF_REG_0), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x11a2: shl    r11,0x10 [warning-reg-remap: ALU imm operation; native r11 has no exact BPF JIT register; remapped to BPF_REG_8] */
    ...
    HC_KOP(HC_SIB_PAYLOAD(BPF_REG_6, BPF_REG_3, BPF_REG_2, 2, 20), MICRO_HANDCRAFT_BPF_X86_MOVZWL_SIB),
    /* 0x11ab: or     r11,rbx [warning-reg-remap: ALU reg operation; native r11 has no exact BPF JIT register; remapped to BPF_REG_8] */
    ...
    /* 0x11b4: test   bl,0x1 [exact-kop: testb imm kop] */
    ...
    HC_KOP(HC_SIB_PAYLOAD(BPF_REG_4, BPF_REG_3, BPF_REG_2, 2, 22), MICRO_HANDCRAFT_BPF_X86_MOVZWL_SIB),
    /* 0x11be: add    r9,rcx [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_5, BPF_REG_3, 0), MICRO_HANDCRAFT_BPF_X86_MOVB_MEM_REG),
    /* 0x11c9: mov    BYTE PTR [rdx+0x1],bh [warning-unmapped: unsupported mnemonic or operand form: mov    BYTE PTR [rdx+0x1],bh] */
    ...
    /* 0x11dc: mov    rax,rbx [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_0, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x11df: shr    rax,0x20 [exact-kop: shrq imm kop] */
    ...
    /* 0x11e6: mov    rax,rbx [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_0, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x11e9: shr    rax,0x28 [exact-kop: shrq imm kop] */
    ...
    /* 0x11f0: mov    rax,rbx [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_0, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x11f3: shr    rax,0x30 [exact-kop: shrq imm kop] */
    ...
    /* 0x11fa: shr    rbx,0x38 [exact-kop: shrq imm kop] */
