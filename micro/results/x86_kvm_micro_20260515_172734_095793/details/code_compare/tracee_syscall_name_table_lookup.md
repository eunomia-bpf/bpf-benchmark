 ...
 * - 0x1124: cmp    DWORD PTR [rsi],0x40 [warning-unmapped: CMP operand form has no current kop selector: cmp    DWORD PTR [rsi],0x40]
 ...
 * - 0x123e: mov    rcx,r9 [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
...
static const struct bpf_insn program[] = {
    ...
    /* 0x1180: movzx  edi,BYTE PTR [rdx+r8*4+0xc] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_SIB_PAYLOAD(BPF_REG_1, BPF_REG_3, BPF_REG_5, 2, 12), MICRO_HANDCRAFT_BPF_X86_MOVZBL_SIB),
    /* 0x1186: movzx  ecx,BYTE PTR [rdx+r8*4+0xd] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_SIB_PAYLOAD(BPF_REG_4, BPF_REG_3, BPF_REG_5, 2, 13), MICRO_HANDCRAFT_BPF_X86_MOVZBL_SIB),
    ...
    /* 0x1191: movzx  eax,WORD PTR [rdx+r8*4+0xe] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_SIB_PAYLOAD(BPF_REG_0, BPF_REG_3, BPF_REG_5, 2, 14), MICRO_HANDCRAFT_BPF_X86_MOVZWL_SIB),
    ...
    /* 0x119c: cmp    eax,0xd8 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_0, 216), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x11a3: cmp    eax,0x9e [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_0, 158), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x11c0: cmp    eax,0x140 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_0, 320), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x11c7: lea    ecx,[rax-0x101] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_4, BPF_REG_0, 0, 0, 1, 0, -257), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x11cd: cmp    ecx,0x22 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 34), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x11d2: movsxd rcx,DWORD PTR [r15+rcx*4] [exact-kop: movsxd SIB kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_SIB_TMP_PAYLOAD(BPF_REG_4, BPF_REG_9, BPF_REG_4, 2, 0, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVSXD_SIB),
    ...
    /* 0x11ea: cmp    eax,0x141 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_0, 321), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x11f1: cmp    eax,0x14c [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_0, 332), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x1202: cmp    eax,0xd9 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_0, 217), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x1218: cmp    eax,0xca [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_0, 202), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x122e: mov    rcx,r13 [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_4, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    ...
    /* 0x123e: mov    rcx,r9 [warning-reg-remap: movq register-to-register kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_4, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    ...
    /* 0x125c: imul   rax,rcx [exact-kop: imulq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_0, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_IMULQ_RR),
    ...
    /* 0x12b5: mov    rcx,rsi [exact-kop: movq register-to-register kop] */
    ...
    /* 0x1308: and    eax,0x7 [exact-kop: andl imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_0, 7), MICRO_HANDCRAFT_BPF_X86_ANDL_IMM32),
    /* 0x130b: lea    ecx,[rax+0x1] [exact-kop: LEA via x86 kop selector] */
    ...
    HC_RAW(BPF_ALU | BPF_MOV | BPF_X, BPF_REG_4, BPF_REG_0, 0, 0),
    /* 0x1316: not    cl [exact-kop: notb reg kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_NOT_NARROW_PAYLOAD(BPF_REG_4, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_NOTB_R),
    ...
    /* 0x132c: mov    r14,rdi [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_8, BPF_REG_1), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x132f: inc    r8 [exact-kop: incq reg kop] */
    HC_KOP(HC_REG_PAYLOAD(BPF_REG_5), MICRO_HANDCRAFT_BPF_X86_INCQ),
    /* 0x1332: cmp    r8,0x40 [exact-kop: cmpq reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_5, 64), MICRO_HANDCRAFT_BPF_X86_CMPQ_IMM32),
    ...
    /* 0x133c: mov    QWORD PTR [rdx],r14 [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_8, BPF_REG_3, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ_MEM_REG),
