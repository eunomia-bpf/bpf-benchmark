...
/*
 * native asm to handcraft warnings: 75
 *
 ...
 * - 0x112a: cmp    DWORD PTR [rsi+0xc],0x20 [warning-unmapped: CMP operand form has no current kop selector: cmp    DWORD PTR [rsi+0xc],0x20]
 ...
 * - 0x11f4: movzx  r9d,BYTE PTR [rdi-0x5] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x125f: cmp    r10,r11 [warning-unmapped: CMP operand form has no current kop selector: cmp    r10,r11]
 ...
 * - 0x129e: movzx  r9d,BYTE PTR [rdi-0xe] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x12e4: cmp    dl,0x42 [warning-unmapped: CMP operand form has no current kop selector: cmp    dl,0x42]
...
static const struct bpf_insn program[] = {
    ...
    /* 0x1139: push   rbx [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x113a: mov    QWORD PTR [rsp-0x30],rsi [warning-unmapped: store base rsp is not in the BPF JIT register file] */
    /* 0x113f: lea    rdi,[rsi+0x2f] [exact-kop: LEA via x86 kop selector] */
    ...
    /* 0x1174: cmp    r8,0x20 [exact-kop: cmpq reg,imm32 kop] */
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_5, 0, 151, 32),
    /* 0x117e: movzx  eax,BYTE PTR [rdi-0x13] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_0, BPF_REG_1, -19), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x1182: movzx  ecx,BYTE PTR [rdi-0x12] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_1, -18), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    ...
    /* 0x118c: lea    edx,[rcx-0x1] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_3, BPF_REG_4, 0, 0, 1, 0, -1), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x118f: cmp    edx,0xc [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_3, 12), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x1194: lea    rsi,[rip+0xe65] [warning-unmapped: LEA base/index not in BPF register file: [rip+0xe65]] */
    /* 0x119b: movsxd rdx,DWORD PTR [rsi+rdx*4] [exact-kop: movsxd SIB kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_SIB_TMP_PAYLOAD(BPF_REG_3, BPF_REG_2, BPF_REG_3, 2, 0, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVSXD_SIB),
    ...
    /* 0x11f0: movzx  esi,WORD PTR [rdi-0x7] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_2, BPF_REG_1, -7), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    /* 0x11f4: movzx  r9d,BYTE PTR [rdi-0x5] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_9, BPF_REG_1, -5), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x11f9: shl    r9d,0x10 [warning-reg-remap: ALU imm operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU | BPF_LSH | BPF_K, BPF_REG_9, 0, 0, 16),
    /* 0x11fd: or     r9,rsi [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU64 | BPF_OR | BPF_X, BPF_REG_9, BPF_REG_2, 0, 0),
    /* 0x1200: movzx  esi,BYTE PTR [rdi-0x4] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_2, BPF_REG_1, -4), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    ...
    /* 0x121c: or     r10,r11 [warning-unmapped: ALU destination r10 is not in the BPF JIT register file] */
    /* 0x121f: or     r10,rsi [warning-unmapped: ALU destination r10 is not in the BPF JIT register file] */
    /* 0x1222: cmp    rsi,0x68736162 [exact-kop: cmpq reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_2, 1752392034), MICRO_HANDCRAFT_BPF_X86_CMPQ_IMM32),
    ...
    /* 0x122b: cmp    esi,0x6c727563 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_2, 1819440483), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    /* 0x1266: cmp    r9d,0x6873 [exact-kop: cmpl reg,imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_9, 26739), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    /* 0x126d: sete   sil [exact-kop: setcc kop using adjacent cmp reg,imm proof payload] */
    HC_KOP(HC_SETCC_CMP_IMM_PAYLOAD(BPF_REG_2, BPF_REG_9, BPF_REG_6, BPF_REG_7, 26739, HC_FLAG_CMP_IMM32), MICRO_HANDCRAFT_BPF_X86_SETE_R),
    ...
    /* 0x1280: mov    r12d,DWORD PTR [rdi-0x1f] [warning-unmapped: unsupported mnemonic or operand form: mov    r12d,DWORD PTR [rdi-0x1f]] */
    /* 0x1284: test   dl,dl [exact-kop: testb reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_3, BPF_REG_3), MICRO_HANDCRAFT_BPF_X86_TESTB_RR),
    /* 0x1286: jne    1160 <tetragon_process_event_arg_filter_xdp+0x60> [warning-unmapped: standalone x86 branch needs an immediately preceding cmp] */
    /* 0x128c: mov    QWORD PTR [rsp-0x38],rbx [warning-unmapped: store base rsp is not in the BPF JIT register file] */
    /* 0x1291: movzx  edx,BYTE PTR [rdi-0x17] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_3, BPF_REG_1, -23), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x1295: movzx  ecx,BYTE PTR [rdi-0xf] [exact-kop: direct memory load via x86 kop selector] */
    ...
    /* 0x12a3: movzx  ecx,BYTE PTR [rdi-0xd] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_1, -13), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x12a7: mov    DWORD PTR [rsp-0x3c],ecx [warning-unmapped: store base rsp is not in the BPF JIT register file] */
    /* 0x12ab: movzx  ebp,BYTE PTR [rdi-0xc] [warning-unmapped: destination register ebp is not in the BPF JIT register file] */
    /* 0x12af: movzx  ecx,BYTE PTR [rdi-0xb] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_1, -11), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x12b3: mov    QWORD PTR [rsp-0x18],rcx [warning-unmapped: store base rsp is not in the BPF JIT register file] */
    /* 0x12b8: movzx  ebx,BYTE PTR [rdi-0xa] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_6, BPF_REG_1, -10), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x12bc: movzx  ecx,BYTE PTR [rdi-0x9] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_1, -9), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x12c0: mov    QWORD PTR [rsp-0x10],rcx [warning-unmapped: store base rsp is not in the BPF JIT register file] */
    /* 0x12c5: movzx  ecx,BYTE PTR [rdi-0x8] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_1, -8), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x12c9: mov    QWORD PTR [rsp-0x8],rcx [warning-unmapped: store base rsp is not in the BPF JIT register file] */
    /* 0x12ce: movzx  ecx,BYTE PTR [rdi-0x1] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_1, -1), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x12d2: mov    QWORD PTR [rsp-0x28],rcx [warning-unmapped: store base rsp is not in the BPF JIT register file] */
    /* 0x12d7: movzx  r15d,BYTE PTR [rdi] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_9, BPF_REG_1, 0), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x12db: movzx  r11d,WORD PTR [rdi-0x11] [warning-unmapped: destination register r11d is not in the BPF JIT register file] */
    /* 0x12e0: mov    r13d,DWORD PTR [rdi-0x1b] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_7, BPF_REG_1, -27), MICRO_HANDCRAFT_BPF_X86_MOVL_MEM),
    /* 0x12e4: cmp    dl,0x42 [warning-unmapped: CMP operand form has no current kop selector: cmp    dl,0x42] */
    ...
    /* 0x12ec: and    ecx,0x24 [exact-kop: andl imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 36), MICRO_HANDCRAFT_BPF_X86_ANDL_IMM32),
    ...
    /* 0x12f1: movzx  eax,BYTE PTR [rdi-0x16] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_0, BPF_REG_1, -22), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x12f5: shl    eax,0x8 [bpf-jit: ALU imm operation] */
    HC_RAW(BPF_ALU | BPF_LSH | BPF_K, BPF_REG_0, 0, 0, 8),
    /* 0x12f8: movzx  ecx,WORD PTR [rdi-0x15] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_1, -21), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    ...
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, -110, 0),
    /* 0x1319: nop    DWORD PTR [rax+0x0] [padding: padding is not part of BPF semantics] */
    /* 0x1320: mov    rcx,rsi [exact-kop: movq register-to-register kop] */
    ...
    /* 0x133e: test   r11b,0x2 [warning-unmapped: only testq reg,same-reg is supported] */
    /* 0x1342: je     1373 <tetragon_process_event_arg_filter_xdp+0x273> [warning-unmapped: standalone x86 branch needs an immediately preceding cmp] */
    /* 0x1344: test   esi,esi [exact-kop: testl reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_2, BPF_REG_2), MICRO_HANDCRAFT_BPF_X86_TESTL_RR),
    /* 0x1346: je     1373 <tetragon_process_event_arg_filter_xdp+0x273> [warning-unmapped: standalone x86 branch needs an immediately preceding cmp] */
    /* 0x1348: mov    rcx,QWORD PTR [rsp-0x28] [warning-unmapped: memory base rsp is not in the BPF JIT register file] */
    ...
    /* 0x1358: or     r15,r10 [warning-unmapped: ALU source r10 is not supported] */
    /* 0x135b: and    al,0x7 [exact-kop: andb imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_REG_IMM_TMP_PAYLOAD(BPF_REG_0, 7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ANDB_IMM),
    /* 0x135d: lea    ecx,[rax+0x1] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_4, BPF_REG_0, 0, 0, 1, 0, 1), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x1360: mov    rdx,r15 [exact-kop: movq register-to-register kop] */
    ...
    /* 0x1366: not    al [exact-kop: notb reg kop; verifier instantiate uses temp BPF_REG_6] */
    ...
    /* 0x13cc: and    al,0x7 [exact-kop: andb imm kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_REG_IMM_TMP_PAYLOAD(BPF_REG_0, 7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ANDB_IMM),
    /* 0x13ce: lea    ecx,[rax+0x1] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_4, BPF_REG_0, 0, 0, 1, 0, 1), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x13d1: mov    rsi,rdx [exact-kop: movq register-to-register kop] */
    ...
    /* 0x13d7: not    al [exact-kop: notb reg kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_NOT_NARROW_PAYLOAD(BPF_REG_0, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_NOTB_R),
    ...
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, -157, 0),
    /* 0x13ee: mov    rax,QWORD PTR [rsp-0x30] [warning-unmapped: memory base rsp is not in the BPF JIT register file] */
    /* 0x13f3: mov    QWORD PTR [rax],rbx [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_6, BPF_REG_0, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ_MEM_REG),
