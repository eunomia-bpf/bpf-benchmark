...
/*
 * native asm to handcraft warnings: 72
 *
 ...
 * - 0x1124: cmp    DWORD PTR [rsi+0x8],0x20 [warning-unmapped: CMP operand form has no current kop selector: cmp    DWORD PTR [rsi+0x8],0x20]
 * - 0x112a: cmp    DWORD PTR [rsi+0xc],0x2 [warning-unmapped: CMP operand form has no current kop selector: cmp    DWORD PTR [rsi+0xc],0x2]
 ...
 * - 0x1169: movzx  r9d,BYTE PTR [rdi-0xe] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x1266: and    r9d,0x1f [warning-reg-remap: andl imm32 kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x1287: lea    rsi,[r9+r13*1] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x130c: lea    rbx,[rdx+r9*1] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
...
static const struct bpf_insn program[] = {
    ...
    /* 0x1109: cmp    rsi,rcx [exact-kop: cmpq reg,reg kop] */
    ...
    /* 0x1113: cmp    rdx,rcx [exact-kop: cmpq reg,reg kop] */
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_3, BPF_REG_2, 0, 0, 1, 0, 528), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x111f: cmp    rdx,rcx [exact-kop: cmpq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_3, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_1, BPF_REG_2, 0, 0, 1, 0, 31), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_6, BPF_REG_1, -15), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x1169: movzx  r9d,BYTE PTR [rdi-0xe] [warning-reg-remap: direct memory load via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_0, BPF_REG_1, -13), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_0, BPF_REG_1, -4), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_9, BPF_REG_1, -3), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_2, BPF_REG_1, -2), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_4, BPF_REG_9, BPF_REG_2, 0, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_0, BPF_REG_1, -1), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_3, BPF_REG_1, 0), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_8, BPF_REG_1, -8), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    ...
    /* 0x11f1: and    eax,0x3f [exact-kop: andl imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_0, 63), MICRO_HANDCRAFT_BPF_X86_ANDL_IMM32),
    /* 0x11f4: shr    r13d,0x6 [bpf-jit: ALU imm operation] */
    HC_RAW(BPF_ALU | BPF_RSH | BPF_K, BPF_REG_7, 0, 0, 6),
    /* 0x11f8: and    r13d,0x1f [exact-kop: andl imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_7, 31), MICRO_HANDCRAFT_BPF_X86_ANDL_IMM32),
    /* 0x11fc: shr    r14,0x36 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_8, 54), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_7, BPF_REG_1, -7), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x120b: or     r10,rbp [warning-unmapped: ALU destination r10 is not in the BPF JIT register file] */
    /* 0x120e: shr    ebp,0xb [warning-unmapped: ALU destination ebp is not in the BPF JIT register file] */
    /* 0x1211: and    ebp,0x7ff [warning-unmapped: ALU destination ebp is not in the BPF JIT register file] */
    /* 0x1217: shr    r12d,0x16 [warning-unmapped: ALU destination r12d is not in the BPF JIT register file] */
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_2, BPF_REG_1, -6), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_0, BPF_REG_1, -5), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    ...
    /* 0x1254: mov    r12d,r13d [warning-unmapped: unsupported mnemonic or operand form: mov    r12d,r13d] */
    /* 0x1257: and    r12d,0xf [warning-unmapped: ALU destination r12d is not in the BPF JIT register file] */
    /* 0x125b: shr    r15,0x18 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_9, 24), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    /* 0x125f: shr    rdx,0x28 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_3, 40), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    /* 0x1263: shr    r9d,1 [warning-reg-remap: ALU imm operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_RAW(BPF_ALU | BPF_RSH | BPF_K, BPF_REG_9, 0, 0, 1),
    /* 0x1266: and    r9d,0x1f [warning-reg-remap: andl imm32 kop; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_9, 31), MICRO_HANDCRAFT_BPF_X86_ANDL_IMM32),
    /* 0x126a: shr    rcx,0x26 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 38), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    /* 0x126e: and    ecx,0x7f [exact-kop: andl imm32 kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 127), MICRO_HANDCRAFT_BPF_X86_ANDL_IMM32),
    /* 0x1271: add    r12,r15 [warning-unmapped: ALU destination r12 is not in the BPF JIT register file] */
    /* 0x1274: add    r12,rdx [warning-unmapped: ALU destination r12 is not in the BPF JIT register file] */
    ...
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_7, BPF_REG_2), MICRO_HANDCRAFT_BPF_X86_MOVZBL_RR),
    /* 0x1287: lea    rsi,[r9+r13*1] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_2, BPF_REG_9, BPF_REG_7, 0, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x128b: mov    r8,QWORD PTR [rsp-0x18] [warning-unmapped: memory base rsp is not in the BPF JIT register file] */
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_0, BPF_REG_8, BPF_REG_8, 2, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x12ba: lea    rax,[r14+rax*2] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_0, BPF_REG_8, BPF_REG_0, 1, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x12be: lea    r13,[r15+r15*2] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_7, BPF_REG_9, BPF_REG_9, 1, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x12c2: lea    r15,[r15+r13*4] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_9, BPF_REG_9, BPF_REG_7, 2, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x12c6: lea    r13,[rdx+rdx*8] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_7, BPF_REG_3, BPF_REG_3, 3, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_0, BPF_REG_4, BPF_REG_4, 3, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x12e1: lea    rax,[rcx+rax*2] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_0, BPF_REG_4, BPF_REG_0, 1, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x12e5: xor    rax,r15 [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_0, BPF_REG_9, 0, 0),
    /* 0x12e8: and    bl,0x7 [exact-kop: andb imm kop; verifier instantiate uses temp BPF_REG_7] */
    HC_KOP(HC_REG_IMM_TMP_PAYLOAD(BPF_REG_6, 7, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_ANDB_IMM),
    /* 0x12eb: lea    ecx,[rbx+0x1] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_4, BPF_REG_6, 0, 0, 1, 0, 1), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x12ee: mov    r15,rsi [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_9, BPF_REG_2), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x12f1: shl    r15,cl [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_LSH | BPF_X, BPF_REG_9, BPF_REG_4, 0, 0),
    /* 0x12f4: not    bl [exact-kop: notb reg kop; verifier instantiate uses temp BPF_REG_7] */
    HC_KOP(HC_NOT_NARROW_PAYLOAD(BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_NOTB_R),
    ...
    /* 0x130c: lea    rbx,[rdx+r9*1] [warning-reg-remap: LEA via x86 kop selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_6, BPF_REG_3, BPF_REG_9, 0, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x1310: add    rbx,r10 [warning-unmapped: ALU source r10 is not supported] */
    ...
    /* 0x1319: and    dl,0xf [exact-kop: andb imm kop; verifier instantiate uses temp BPF_REG_6] */
    ...
    /* 0x131f: mov    rax,rbx [exact-kop: movq register-to-register kop] */
    ...
    /* 0x1325: not    dl [exact-kop: notb reg kop; verifier instantiate uses temp BPF_REG_6] */
    HC_KOP(HC_NOT_NARROW_PAYLOAD(BPF_REG_3, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_NOTB_R),
    ...
    /* 0x1336: mov    rcx,r8 [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_4, BPF_REG_5), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x1339: mov    QWORD PTR [rsp-0x18],r8 [warning-unmapped: store base rsp is not in the BPF JIT register file] */
    /* 0x133e: cmp    r8,0x20 [exact-kop: cmpq reg,imm32 kop] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_5, 0, -132, 32),
    /* 0x1348: mov    rdx,QWORD PTR [rsp-0x10] [warning-unmapped: memory base rsp is not in the BPF JIT register file] */
    /* 0x134d: mov    BYTE PTR [rdx],bl [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_6, BPF_REG_3, 0), MICRO_HANDCRAFT_BPF_X86_MOVB_MEM_REG),
    /* 0x134f: mov    BYTE PTR [rdx+0x1],bh [warning-unmapped: unsupported mnemonic or operand form: mov    BYTE PTR [rdx+0x1],bh] */
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_3, 2), MICRO_HANDCRAFT_BPF_X86_MOVB_MEM_REG),
    ...
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_3, 3), MICRO_HANDCRAFT_BPF_X86_MOVB_MEM_REG),
    /* 0x1362: mov    rcx,rax [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_4, BPF_REG_0), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x1365: shr    rcx,0x20 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 32), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    /* 0x1369: mov    BYTE PTR [rdx+0x4],cl [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_3, 4), MICRO_HANDCRAFT_BPF_X86_MOVB_MEM_REG),
    /* 0x136c: mov    rcx,rax [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_4, BPF_REG_0), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x136f: shr    rcx,0x28 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 40), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    /* 0x1373: mov    BYTE PTR [rdx+0x5],cl [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_3, 5), MICRO_HANDCRAFT_BPF_X86_MOVB_MEM_REG),
    /* 0x1376: mov    rcx,rax [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_4, BPF_REG_0), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x1379: shr    rcx,0x30 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_4, 48), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    /* 0x137d: mov    BYTE PTR [rdx+0x6],cl [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_3, 6), MICRO_HANDCRAFT_BPF_X86_MOVB_MEM_REG),
    /* 0x1380: shr    rax,0x38 [exact-kop: shrq imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(BPF_REG_0, 56), MICRO_HANDCRAFT_BPF_X86_SHRQ_IMM),
    /* 0x1384: mov    BYTE PTR [rdx+0x7],al [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_MEM_PAYLOAD(BPF_REG_0, BPF_REG_3, 7), MICRO_HANDCRAFT_BPF_X86_MOVB_MEM_REG),
