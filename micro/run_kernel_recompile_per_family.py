...
def render_markdown(results: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "## Methodology",
        "",
        f"- Family policies: `{', '.join(entry['name'] for entry in results.get('families', []))}` via `micro/policies/per_family/*.yaml` allowlists",
...
def run_host_mode(args: argparse.Namespace) -> int:
    ...
    for benchmark in benchmarks:
        ...
        for family in families:
            ...
            policy_file = policy_path_for_family(family).resolve()
