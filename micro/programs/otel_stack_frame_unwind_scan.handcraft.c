...
static const struct bpf_insn program[] = {
    ...
    /* 0x1124: cmp    DWORD PTR [rsi+0x8],0x18 [exact-kinsn: cmp memory,imm kinsn] */
    HC_KINSN(HC_X86_CMP_MEM_IMM_PAYLOAD(BPF_REG_2, 8, 24), MICRO_HANDCRAFT_BPF_X86_CMPL),
    ...
    /* 0x112a: cmp    DWORD PTR [rsi+0xc],0x18 [exact-kinsn: cmp memory,imm kinsn] */
    ...
    /* 0x113c: movabs r8,0x100000000 [exact-bpf: movabs via verifier-visible BPF shadow write] */
    HC_LD_IMM64_RAW(BPF_REG_5, 0, 0x100000000ULL),
    /* 0x1146: movabs r11,0x589965cc75374cc3 [exact-bpf: movabs via verifier-visible BPF shadow write] */
    HC_STX(BPF_DW, BPF_REG_10, BPF_REG_6, -376),
    ...
    /* 0x1171: cmp    r9,0x18 [exact-kinsn: cmpq reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_R9, 24), MICRO_HANDCRAFT_BPF_X86_CMPQ),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, 2),
    HC_LDX(BPF_DW, BPF_REG_6, BPF_REG_10, -376),
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (141) - 1),
    ...
    /* 0x1192: cmp    eax,0x1 [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_0, 0, (14) - 1, 1),
    /* 0x1197: test   eax,eax [exact-kinsn: testl reg,reg kinsn] */
    ...
    /* 0x11a5: cmp    r14d,0x1000 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_8, 4096), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x11ac: jbe    11ec <otel_stack_frame_unwind_scan_xdp+0xec> [exact-bpf: jbe ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JLE | BPF_K, BPF_REG_8, 0, (25) - 1, 4096),
    ...
    /* 0x11b0: cmp    eax,0x2 [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_0, 0, (16) - 1, 2),
    /* 0x11b5: cmp    eax,0x3 [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_0, 0, (-52) - 1, 3),
    ...
    /* 0x11bf: cmp    r14d,0x1000 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_8, 4096), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x11c6: jbe    11ec <otel_stack_frame_unwind_scan_xdp+0xec> [exact-bpf: jbe ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JLE | BPF_K, BPF_REG_8, 0, (13) - 1, 4096),
    ...
    /* 0x11cf: cmp    r14d,0x1000 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_8, 4096), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x11d6: jbe    11ec <otel_stack_frame_unwind_scan_xdp+0xec> [exact-bpf: jbe ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JLE | BPF_K, BPF_REG_8, 0, (7) - 1, 4096),
    ...
    /* 0x11df: cmp    r14d,0x1000 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_8, 4096), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x11e6: ja     1160 <otel_stack_frame_unwind_scan_xdp+0x60> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JGT | BPF_K, BPF_REG_8, 0, (-69) - 1, 4096),
    /* 0x11ec: cmp    r15d,0x2001 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_9, 8193), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x11f3: jae    1160 <otel_stack_frame_unwind_scan_xdp+0x60> [exact-bpf: jae ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JGE | BPF_K, BPF_REG_9, 0, (-72) - 1, 8193),
    ...
    /* 0x121a: test   bpl,0x2 [exact-kinsn: testb imm kinsn] */
