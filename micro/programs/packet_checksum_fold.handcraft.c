 ...
 * - 0x1128: jne    110e <packet_checksum_fold_xdp+0xe> [warning-unmapped: jcc has no immediately preceding branchable cmp/test; needs a machine-level branch kinsn]
 * - 0x1131: jne    110e <packet_checksum_fold_xdp+0xe> [warning-unmapped: jcc has no immediately preceding branchable cmp/test; needs a machine-level branch kinsn]
 * - 0x1133: push   rbp [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR]
 * - 0x1134: mov    rbp,rsp [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR]
...
static const struct bpf_insn program[] = {
    ...
    /* 0x110c: jbe    110f <packet_checksum_fold_xdp+0xf> [bpf-branch: verifier-visible branch from preceding cmp    rdx,rcx; cmp kinsn is preserved] */
    ...
    /* 0x1116: ja     110e <packet_checksum_fold_xdp+0xe> [bpf-branch: verifier-visible branch from preceding cmp    rsi,rcx; cmp kinsn is preserved] */
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_2, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_CMPQ),
    /* 0x1122: ja     110e <packet_checksum_fold_xdp+0xe> [bpf-branch: verifier-visible branch from preceding cmp    rsi,rcx; cmp kinsn is preserved] */
    ...
    /* 0x1181: jne    1150 <packet_checksum_fold_xdp+0x50> [bpf-branch: verifier-visible branch from preceding cmp    rcx,0x413; cmp kinsn is preserved] */
    ...
    /* 0x119f: jne    1140 <packet_checksum_fold_xdp+0x40> [bpf-branch: verifier-visible branch from preceding cmp    eax,0x20; cmp kinsn is preserved] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_0, 0, -51, 32),
