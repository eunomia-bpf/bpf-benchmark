...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_5, BPF_REG_1, 0, 0), MICRO_HANDCRAFT_BPF_X86_ADDL),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_1, BPF_REG_5, 0, 0), MICRO_HANDCRAFT_BPF_X86_ADDL),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_4, 4, 0), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_4, 0, -24, 1043),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_4, BPF_REG_1, 0, 0), MICRO_HANDCRAFT_BPF_X86_ADDL),
