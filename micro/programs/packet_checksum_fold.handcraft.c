 ...
 * - 0x110c: jbe    110f <packet_checksum_fold_xdp+0xf> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1116: ja     110e <packet_checksum_fold_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1122: ja     110e <packet_checksum_fold_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1128: jne    110e <packet_checksum_fold_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1131: jne    110e <packet_checksum_fold_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1181: jne    1150 <packet_checksum_fold_xdp+0x50> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x119f: jne    1140 <packet_checksum_fold_xdp+0x40> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 */
