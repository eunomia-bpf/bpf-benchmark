 ...
 * - 0x1152: movabs r10,0x100000001b3 [warning-unmapped: movabs into HC_X86_R10 needs an immediate-load kinsn]
 * - 0x1180: shr    r11,cl [warning-unmapped: shr    r11,cl needs a shadow-aware ALU kinsn]
 ...
 * - 0x1239: xor    r11,rbp [warning-unmapped: ALU source rbp is not supported]
 * - 0x123c: mov    rbp,QWORD PTR [rsp-0x10] [warning-unmapped: unsupported mnemonic or operand form: mov    rbp,QWORD PTR [rsp-0x10]]
 * - 0x1245: xor    r11,rbp [warning-unmapped: ALU source rbp is not supported]
...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_3, BPF_REG_5, 0, 0, 1, 0, 8, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_3, BPF_REG_5, 0, 0, 1, 0, 1040, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_1, BPF_REG_5, 0, 0, 1, 0, 47, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x1160: shl    r12d,0x8 [exact-kinsn: shl32 imm kinsn; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R12, 8, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x1164: shl    r15d,0x10 [exact-kinsn: shl32 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_9, 16, 0), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x1168: or     r15d,r12d [exact-kinsn: or32 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_9, HC_X86_R12, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_ORL),
    /* 0x116b: shl    ebx,0x18 [exact-kinsn: shl32 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_6, 24, 0), MICRO_HANDCRAFT_BPF_X86_SHLL),
    ...
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_4, BPF_REG_0, 0, 0, 1, 0, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x1176: mov    rdx,r11 [exact-kinsn: movq register-to-register kinsn; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(BPF_REG_3, HC_X86_R11, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_6, BPF_REG_9, 0, 0), MICRO_HANDCRAFT_BPF_X86_ORL),
    /* 0x1186: or     ebx,r9d [exact-kinsn: or32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_8] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_6, HC_X86_R9, BPF_REG_7, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_ORL),
    /* 0x1189: or     r11,rdx [exact-kinsn: or64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_3, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_ORQ),
    ...
    /* 0x118f: xor    rax,r11 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_0, HC_X86_R11, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    HC_KINSN(HC_REG_REG_PAYLOAD(BPF_REG_2, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVL_RR),
    /* 0x1198: or     rsi,r14 [exact-kinsn: or64 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_2, BPF_REG_8, 0, 0), MICRO_HANDCRAFT_BPF_X86_ORQ),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_1, 32, 0), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    /* 0x11b9: movzx  r9d,BYTE PTR [rdi-0x1e] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R9, BPF_REG_1, -30, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    ...
    /* 0x11e6: movzx  r12d,BYTE PTR [rdi-0x16] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R12, BPF_REG_1, -22, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    ...
    /* 0x11f4: mov    r11,r13 [exact-kinsn: movq register-to-register kinsn; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(HC_X86_R11, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x11f7: movabs rcx,0xcbf29ce484222325 [bpf-jit: 64-bit immediate load] */
    HC_LD_IMM64_RAW(BPF_REG_4, 0, 0xcbf29ce484222325ULL),
    /* 0x1201: xor    r11,rcx [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_4, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1204: imul   r11,r10 [exact-kinsn: imulq reg,reg kinsn] */
    HC_KINSN(HC_REG_REG_PAYLOAD(HC_X86_R11, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_IMULQ_RR),
    /* 0x1208: mov    QWORD PTR [rsp-0x38],r9 [warning-unmapped: store base rsp is not in the BPF JIT register file] */
    /* 0x120d: xor    r11,r9 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, HC_X86_R9, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1210: mov    r9,r8 [exact-kinsn: movq register-to-register kinsn; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(HC_X86_R9, BPF_REG_5, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x1213: mov    r8,QWORD PTR [rsp-0x18] [warning-unmapped: memory base rsp is not in the BPF JIT register file] */
    /* 0x1218: imul   r11,r10 [exact-kinsn: imulq reg,reg kinsn] */
    HC_KINSN(HC_REG_REG_PAYLOAD(HC_X86_R11, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_IMULQ_RR),
    /* 0x121c: mov    QWORD PTR [rsp-0x28],rax [warning-unmapped: store base rsp is not in the BPF JIT register file] */
    /* 0x1221: xor    r11,rax [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_0, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1224: imul   r11,r10 [exact-kinsn: imulq reg,reg kinsn] */
    HC_KINSN(HC_REG_REG_PAYLOAD(HC_X86_R11, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_IMULQ_RR),
    /* 0x1228: mov    QWORD PTR [rsp-0x30],rdx [warning-unmapped: store base rsp is not in the BPF JIT register file] */
    /* 0x122d: xor    r11,rdx [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_3, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    HC_KINSN(HC_REG_REG_PAYLOAD(HC_X86_R11, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_IMULQ_RR),
    /* 0x124c: xor    r11,r8 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_5, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x124f: imul   r11,r10 [exact-kinsn: imulq reg,reg kinsn] */
    HC_KINSN(HC_REG_REG_PAYLOAD(HC_X86_R11, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_IMULQ_RR),
    /* 0x1253: xor    r11,r9 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, HC_X86_R9, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1256: imul   r11,r10 [exact-kinsn: imulq reg,reg kinsn] */
    HC_KINSN(HC_REG_REG_PAYLOAD(HC_X86_R11, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_IMULQ_RR),
    /* 0x125a: mov    QWORD PTR [rsp-0x48],r14 [warning-unmapped: store base rsp is not in the BPF JIT register file] */
    /* 0x125f: xor    r11,r14 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    ...
    HC_KINSN(HC_REG_REG_PAYLOAD(HC_X86_R11, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_IMULQ_RR),
    /* 0x1266: xor    r11,r12 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, HC_X86_R12, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1269: imul   r11,r10 [exact-kinsn: imulq reg,reg kinsn] */
    HC_KINSN(HC_REG_REG_PAYLOAD(HC_X86_R11, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_IMULQ_RR),
    /* 0x126d: xor    r11,r15 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_9, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    /* 0x1277: xor    r14,r11 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_8, HC_X86_R11, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x127a: imul   r14,r10 [exact-kinsn: imulq reg,reg kinsn] */
    HC_KINSN(HC_REG_REG_PAYLOAD(BPF_REG_8, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_IMULQ_RR),
    /* 0x127e: movzx  r11d,BYTE PTR [rdi-0xf] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R11, BPF_REG_1, -15, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x1283: xor    r11,r14 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_8, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    /* 0x128f: xor    r14,r11 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_8, HC_X86_R11, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1292: imul   r14,r10 [exact-kinsn: imulq reg,reg kinsn] */
    HC_KINSN(HC_REG_REG_PAYLOAD(BPF_REG_8, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_IMULQ_RR),
    /* 0x1296: movzx  r11d,BYTE PTR [rdi-0xd] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R11, BPF_REG_1, -13, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x129b: xor    r11,r14 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_8, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    /* 0x12a7: xor    r14,r11 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_8, HC_X86_R11, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x12aa: imul   r14,r10 [exact-kinsn: imulq reg,reg kinsn] */
    HC_KINSN(HC_REG_REG_PAYLOAD(BPF_REG_8, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_IMULQ_RR),
    /* 0x12ae: movzx  r11d,BYTE PTR [rdi-0xb] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R11, BPF_REG_1, -11, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x12b3: xor    r11,r14 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_8, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    /* 0x12bf: xor    r14,r11 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_8, HC_X86_R11, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x12c2: imul   r14,r10 [exact-kinsn: imulq reg,reg kinsn] */
    HC_KINSN(HC_REG_REG_PAYLOAD(BPF_REG_8, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_IMULQ_RR),
    /* 0x12c6: movzx  r11d,BYTE PTR [rdi-0x9] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R11, BPF_REG_1, -9, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x12cb: xor    r11,r14 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_8, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    /* 0x12d7: xor    r14,r11 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_8, HC_X86_R11, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x12da: imul   r14,r10 [exact-kinsn: imulq reg,reg kinsn] */
    HC_KINSN(HC_REG_REG_PAYLOAD(BPF_REG_8, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_IMULQ_RR),
    /* 0x12de: movzx  r11d,BYTE PTR [rdi-0x7] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R11, BPF_REG_1, -7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x12e3: xor    r11,r14 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_8, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    /* 0x12ef: xor    r14,r11 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_8, HC_X86_R11, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x12f2: imul   r14,r10 [exact-kinsn: imulq reg,reg kinsn] */
    HC_KINSN(HC_REG_REG_PAYLOAD(BPF_REG_8, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_IMULQ_RR),
    /* 0x12f6: movzx  r11d,BYTE PTR [rdi-0x5] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R11, BPF_REG_1, -5, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x12fb: xor    r11,r14 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_8, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    /* 0x1307: xor    r14,r11 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_8, HC_X86_R11, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x130a: imul   r14,r10 [exact-kinsn: imulq reg,reg kinsn] */
    HC_KINSN(HC_REG_REG_PAYLOAD(BPF_REG_8, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_IMULQ_RR),
    /* 0x130e: movzx  r11d,BYTE PTR [rdi-0x3] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R11, BPF_REG_1, -3, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x1313: xor    r11,r14 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_8, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    /* 0x131f: xor    r14,r11 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_8, HC_X86_R11, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_4, BPF_REG_8, 0, 0), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x132d: imul   rcx,r10 [exact-kinsn: imulq reg,reg kinsn] */
    HC_KINSN(HC_REG_REG_PAYLOAD(BPF_REG_4, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_IMULQ_RR),
    /* 0x1331: movzx  r11d,BYTE PTR [rdi] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R11, BPF_REG_1, 0, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x1335: xor    r11,rcx [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_4, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    /* 0x1350: shl    r9d,0x18 [exact-kinsn: shl32 imm kinsn; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R9, 24, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_SHLL),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_4, 56, 0), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x136d: mov    rdx,QWORD PTR [rsp-0x38] [warning-unmapped: memory base rsp is not in the BPF JIT register file] */
    /* 0x1372: shl    rdx,0x28 [exact-kinsn: shl64 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_3, 40, 0), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x1376: shl    r13,0x20 [exact-kinsn: shl64 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_7, 32, 0), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x137a: or     r13,rdx [exact-kinsn: or64 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_7, BPF_REG_3, 0, 0), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x137d: or     r13,rax [exact-kinsn: or64 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_7, BPF_REG_0, 0, 0), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x1380: or     r13,rcx [exact-kinsn: or64 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_7, BPF_REG_4, 0, 0), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x1383: or     r13,rbp [warning-unmapped: ALU source rbp is not supported] */
    /* 0x1386: or     r13,r8 [exact-kinsn: or64 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_7, BPF_REG_5, 0, 0), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x1389: or     r13,r9 [exact-kinsn: or64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_8] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_7, HC_X86_R9, BPF_REG_6, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x138c: or     r13,QWORD PTR [rsp-0x20] [warning-unmapped: ALU memory base rsp is not in the BPF JIT register file] */
    /* 0x1391: mov    r9,QWORD PTR [rsp-0x48] [warning-unmapped: memory base rsp is not in the BPF JIT register file] */
    /* 0x1396: mov    eax,r9d [exact-kinsn: movl register-to-register kinsn; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(BPF_REG_0, HC_X86_R9, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVL_RR),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_7, BPF_REG_3, 0, 0), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x13ae: xor    r11,r13 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_8] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_7, BPF_REG_6, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    /* 0x13ca: add    rax,r11 [exact-kinsn: add64 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_0, HC_X86_R11, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x13cd: cmp    BYTE PTR [rdi-0xf],0x70 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    BYTE PTR [rdi-0xf],0x70] */
    /* 0x13d1: cmove  r11,rax [warning-unmapped: cmove needs an adjacent test/cmp proof payload] */
