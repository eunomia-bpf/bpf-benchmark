...
static const struct bpf_insn program[] = {
    ...
    /* 0x11a5: cmp    r8,0x20 [absorbed-control-flow: cmp folded into following ordinary BPF je] */
    /* 0x11a9: je     13da <bpftrace_comm_key_fnv_hash_xdp+0x2da> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_5, 0, (280) - 1, 32),
    ...
    HC_KINSN(HC_REG_REG_PAYLOAD(HC_X86_R11, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_IMULQ),
    /* 0x1341: test   r14b,0x1 [absorbed-control-flow: test folded into following ordinary BPF jne] */
    /* 0x1345: jne    1350 <bpftrace_comm_key_fnv_hash_xdp+0x250> [exact-bpf: jne ordinary BPF branch from preceding test] */
    ...
    /* 0x13ba: je     1160 <bpftrace_comm_key_fnv_hash_xdp+0x60> [exact-bpf: je ordinary BPF branch from preceding test] */
    HC_MOV64_REG(BPF_REG_6, BPF_REG_8),
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
