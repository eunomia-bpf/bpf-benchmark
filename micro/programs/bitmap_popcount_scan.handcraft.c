 ...
 * - 0x112a: jne    110e <bitmap_popcount_scan_xdp+0xe> [warning-unmapped: jcc has no immediately preceding branchable cmp/test; needs a machine-level branch kinsn]
 ...
 * - 0x1174: pop    rbp [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR]
 */
...
static const struct bpf_insn program[] = {
    ...
    /* 0x110c: jbe    110f <bitmap_popcount_scan_xdp+0xf> [bpf-branch: verifier-visible branch from preceding cmp    rdx,rcx; cmp kinsn is preserved] */
    ...
    /* 0x1116: ja     110e <bitmap_popcount_scan_xdp+0xe> [bpf-branch: verifier-visible branch from preceding cmp    rsi,rcx; cmp kinsn is preserved] */
    ...
    /* 0x1122: ja     110e <bitmap_popcount_scan_xdp+0xe> [bpf-branch: verifier-visible branch from preceding cmp    rdi,rcx; cmp kinsn is preserved] */
    ...
    /* 0x116a: jne    1140 <bitmap_popcount_scan_xdp+0x40> [bpf-branch: verifier-visible branch from preceding cmp    rax,0x100; cmp kinsn is preserved] */
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_0, 0, -25, 256),
    ...
    /* 0x1174: pop    rbp [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1175: ret [bpf-jit: BPF exit; kernel JIT emits the real return sequence] */
    HC_EXIT(),
};
