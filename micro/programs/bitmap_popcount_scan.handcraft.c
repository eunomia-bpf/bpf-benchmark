...
static const struct bpf_insn program[] = {
    ...
    /* 0x110c: jbe    110f <bitmap_popcount_scan_xdp+0xf> [exact-kinsn: jbe branch kinsn] */
    ...
    /* 0x1116: ja     110e <bitmap_popcount_scan_xdp+0xe> [exact-kinsn: ja branch kinsn] */
    ...
    /* 0x1122: ja     110e <bitmap_popcount_scan_xdp+0xe> [exact-kinsn: ja branch kinsn] */
    ...
    /* 0x116a: jne    1140 <bitmap_popcount_scan_xdp+0x40> [exact-kinsn: jne branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-24, -44, 0), MICRO_HANDCRAFT_BPF_X86_JNE),
