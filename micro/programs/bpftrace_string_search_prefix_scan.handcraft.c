...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(926, 438, 1, 0, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JA),
    ...
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(893, 425, 1, 0, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JA),
    ...
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(860, 412, 1, 0, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JA),
    ...
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(587, 284, 1, 1, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JA),
    ...
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(555, 272, 1, 1, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JNE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(529, 264, 1), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(65, 39, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(-66, -25, 0, 0, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JA),
    ...
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(-163, -57, 0, 1, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JB),
    ...
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(-204, -74, 0, 1, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JB),
    ...
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(-245, -91, 0, 1, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JB),
    ...
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(-286, -108, 0, 1, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JB),
    ...
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(-327, -125, 0, 1, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JB),
    ...
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(-368, -146, 1, 1, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JB),
    ...
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(-409, -167, 1, 1, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JB),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-433, -184, 1), MICRO_HANDCRAFT_BPF_X86_JMP),
