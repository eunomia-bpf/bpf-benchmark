...
static const struct bpf_insn program[] = {
    ...
    /* 0x110c: ja     12c8 <bpftrace_string_search_prefix_scan_xdp+0x1c8> [exact-kinsn: ja branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(226, 438, 1), MICRO_HANDCRAFT_BPF_X86_JA),
    ...
    /* 0x1119: ja     12c8 <bpftrace_string_search_prefix_scan_xdp+0x1c8> [exact-kinsn: ja branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(220, 425, 1), MICRO_HANDCRAFT_BPF_X86_JA),
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_2, BPF_REG_3), MICRO_HANDCRAFT_BPF_X86_CMPQ),
    /* 0x1126: ja     12c8 <bpftrace_string_search_prefix_scan_xdp+0x1c8> [exact-kinsn: ja branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(214, 412, 1), MICRO_HANDCRAFT_BPF_X86_JA),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(56, 98, 0), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(30, 46, 0), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(30, 48, 0), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(30, 50, 0), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(30, 52, 0), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(30, 54, 0), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(30, 56, 0), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(24, 46, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(20, 38, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(16, 30, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(12, 22, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(8, 14, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(4, 6, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    /* 0x11a5: ja     12c7 <bpftrace_string_search_prefix_scan_xdp+0x1c7> [exact-kinsn: ja branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(140, 284, 1), MICRO_HANDCRAFT_BPF_X86_JA),
    ...
    /* 0x11b1: jne    12c7 <bpftrace_string_search_prefix_scan_xdp+0x1c7> [exact-kinsn: jne branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(134, 272, 1), MICRO_HANDCRAFT_BPF_X86_JNE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(130, 264, 1), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(14, 39, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(96, 175, 1), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    /* 0x1203: je     12bf <bpftrace_string_search_prefix_scan_xdp+0x1bf> [exact-kinsn: je branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(102, 182, 1), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    /* 0x1210: ja     11f9 <bpftrace_string_search_prefix_scan_xdp+0xf9> [exact-kinsn: ja branch kinsn] */
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(78, 141, 1), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    /* 0x1227: jb     11f0 <bpftrace_string_search_prefix_scan_xdp+0xf0> [exact-kinsn: jb branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-28, -57, 0), MICRO_HANDCRAFT_BPF_X86_JB),
    ...
    /* 0x1238: jb     11f0 <bpftrace_string_search_prefix_scan_xdp+0xf0> [exact-kinsn: jb branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-38, -74, 0), MICRO_HANDCRAFT_BPF_X86_JB),
    ...
    /* 0x1249: jb     11f0 <bpftrace_string_search_prefix_scan_xdp+0xf0> [exact-kinsn: jb branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-48, -91, 0), MICRO_HANDCRAFT_BPF_X86_JB),
    ...
    /* 0x125a: jb     11f0 <bpftrace_string_search_prefix_scan_xdp+0xf0> [exact-kinsn: jb branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-58, -108, 0), MICRO_HANDCRAFT_BPF_X86_JB),
    ...
    /* 0x126b: jb     11f0 <bpftrace_string_search_prefix_scan_xdp+0xf0> [exact-kinsn: jb branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-68, -125, 0), MICRO_HANDCRAFT_BPF_X86_JB),
    ...
    /* 0x127c: jb     11f0 <bpftrace_string_search_prefix_scan_xdp+0xf0> [exact-kinsn: jb branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-78, -146, 1), MICRO_HANDCRAFT_BPF_X86_JB),
    ...
    /* 0x1291: jb     11f0 <bpftrace_string_search_prefix_scan_xdp+0xf0> [exact-kinsn: jb branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-88, -167, 1), MICRO_HANDCRAFT_BPF_X86_JB),
    ...
    /* 0x12ac: je     12bf <bpftrace_string_search_prefix_scan_xdp+0x1bf> [exact-kinsn: je branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(12, 17, 0), MICRO_HANDCRAFT_BPF_X86_JE),
