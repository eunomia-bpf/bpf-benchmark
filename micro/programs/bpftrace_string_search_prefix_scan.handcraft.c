...
static const struct bpf_insn program[] = {
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_4, BPF_REG_3, (218) - 1, 0),
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_2, BPF_REG_3, (215) - 1, 0),
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_2, BPF_REG_3, (212) - 1, 0),
    ...
    HC_RAW(BPF_JMP32 | BPF_JGT | BPF_K, BPF_REG_1, 0, (120) - 1, 96),
    ...
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_X, BPF_REG_2, BPF_REG_5, (117) - 1, 0),
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_5, 0, (81) - 1, 89),
    ...
    HC_RAW(BPF_JMP32 | BPF_JLT | BPF_K, BPF_REG_2, 0, (-31) - 1, 2),
    ...
    HC_RAW(BPF_JMP32 | BPF_JLT | BPF_K, BPF_REG_2, 0, (-38) - 1, 3),
    ...
    HC_RAW(BPF_JMP32 | BPF_JLT | BPF_K, BPF_REG_2, 0, (-45) - 1, 4),
    ...
    HC_RAW(BPF_JMP32 | BPF_JLT | BPF_K, BPF_REG_2, 0, (-52) - 1, 5),
    ...
    HC_RAW(BPF_JMP32 | BPF_JLT | BPF_K, BPF_REG_2, 0, (-59) - 1, 6),
    ...
    HC_RAW(BPF_JMP32 | BPF_JLT | BPF_K, BPF_REG_2, 0, (-66) - 1, 7),
    ...
    HC_RAW(BPF_JMP32 | BPF_JLT | BPF_K, BPF_REG_2, 0, (-73) - 1, 8),
