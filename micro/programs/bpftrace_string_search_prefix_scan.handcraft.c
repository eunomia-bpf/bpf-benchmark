...
static const struct bpf_insn program[] = {
    ...
    HC_RAW(BPF_JMP | BPF_JLE | BPF_X, BPF_REG_2, BPF_REG_3, 1, 0),
    HC_EXIT(),
    ...
    /* 0x113c: test   dl,dl [absorbed-control-flow: test folded into following ordinary BPF je] */
    ...
    /* 0x1140: cmp    BYTE PTR [rcx+0x71],0x0 [absorbed-control-flow: cmp folded into following ordinary BPF je] */
    ...
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_6, 0, 1, 0),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (33) - 1, 0),
    /* 0x1146: cmp    BYTE PTR [rcx+0x72],0x0 [absorbed-control-flow: cmp folded into following ordinary BPF je] */
    ...
    /* 0x114c: cmp    BYTE PTR [rcx+0x73],0x0 [absorbed-control-flow: cmp folded into following ordinary BPF je] */
    ...
    /* 0x1152: cmp    BYTE PTR [rcx+0x74],0x0 [absorbed-control-flow: cmp folded into following ordinary BPF je] */
    ...
    /* 0x1158: cmp    BYTE PTR [rcx+0x75],0x0 [absorbed-control-flow: cmp folded into following ordinary BPF je] */
    ...
    /* 0x115e: cmp    BYTE PTR [rcx+0x76],0x0 [absorbed-control-flow: cmp folded into following ordinary BPF je] */
    ...
    /* 0x11a2: cmp    edi,0x60 [absorbed-control-flow: cmp folded into following ordinary BPF ja] */
    /* 0x11a5: ja     12c7 <bpftrace_string_search_prefix_scan_xdp+0x1c7> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JGT | BPF_K, BPF_REG_1, 0, (111) - 1, 96),
    ...
    /* 0x11ae: cmp    esi,r8d [absorbed-control-flow: cmp folded into following ordinary BPF jne] */
    /* 0x11b1: jne    12c7 <bpftrace_string_search_prefix_scan_xdp+0x1c7> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_X, BPF_REG_2, BPF_REG_5, (108) - 1, 0),
    /* 0x11b7: test   dl,dl [absorbed-control-flow: test folded into following ordinary BPF je] */
    /* 0x11b9: je     12c7 <bpftrace_string_search_prefix_scan_xdp+0x1c7> [exact-bpf: je ordinary BPF branch from preceding test] */
    HC_MOV64_REG(BPF_REG_6, BPF_REG_3),
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_RAW(BPF_JMP | BPF_JSET | BPF_K, BPF_REG_6, 0, 1, 255),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (104) - 1, 0),
    ...
    /* 0x11f0: test   r11b,r11b [absorbed-control-flow: test folded into following ordinary BPF je] */
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_1, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11ff: cmp    r8,0x59 [absorbed-control-flow: cmp folded into following ordinary BPF je] */
    /* 0x1203: je     12bf <bpftrace_string_search_prefix_scan_xdp+0x1bf> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_5, 0, (77) - 1, 89),
    ...
    /* 0x120d: cmp    r11,r9 [absorbed-control-flow: cmp folded into following ordinary BPF ja] */
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_7, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_6, BPF_REG_7, 1, 0),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (-13) - 1, 0),
    /* 0x1212: test   rsi,rsi [absorbed-control-flow: test folded into following ordinary BPF je] */
    ...
    /* 0x1224: cmp    esi,0x2 [absorbed-control-flow: cmp folded into following ordinary BPF jb] */
    /* 0x1227: jb     11f0 <bpftrace_string_search_prefix_scan_xdp+0xf0> [exact-bpf: jb ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JLT | BPF_K, BPF_REG_2, 0, (-25) - 1, 2),
    ...
    /* 0x1235: cmp    esi,0x3 [absorbed-control-flow: cmp folded into following ordinary BPF jb] */
    /* 0x1238: jb     11f0 <bpftrace_string_search_prefix_scan_xdp+0xf0> [exact-bpf: jb ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JLT | BPF_K, BPF_REG_2, 0, (-32) - 1, 3),
    ...
    HC_KINSN(HC_REG_REG_PAYLOAD(HC_X86_R11, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ORB),
    /* 0x1246: cmp    esi,0x4 [absorbed-control-flow: cmp folded into following ordinary BPF jb] */
    /* 0x1249: jb     11f0 <bpftrace_string_search_prefix_scan_xdp+0xf0> [exact-bpf: jb ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JLT | BPF_K, BPF_REG_2, 0, (-39) - 1, 4),
    ...
    HC_KINSN(HC_REG_REG_PAYLOAD(HC_X86_R11, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ORB),
    /* 0x1257: cmp    esi,0x5 [absorbed-control-flow: cmp folded into following ordinary BPF jb] */
    /* 0x125a: jb     11f0 <bpftrace_string_search_prefix_scan_xdp+0xf0> [exact-bpf: jb ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JLT | BPF_K, BPF_REG_2, 0, (-46) - 1, 5),
    ...
    HC_KINSN(HC_REG_REG_PAYLOAD(HC_X86_R11, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ORB),
    /* 0x1268: cmp    esi,0x6 [absorbed-control-flow: cmp folded into following ordinary BPF jb] */
    /* 0x126b: jb     11f0 <bpftrace_string_search_prefix_scan_xdp+0xf0> [exact-bpf: jb ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JLT | BPF_K, BPF_REG_2, 0, (-53) - 1, 6),
    ...
    HC_KINSN(HC_REG_REG_PAYLOAD(HC_X86_R11, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ORB),
    /* 0x1279: cmp    esi,0x7 [absorbed-control-flow: cmp folded into following ordinary BPF jb] */
    /* 0x127c: jb     11f0 <bpftrace_string_search_prefix_scan_xdp+0xf0> [exact-bpf: jb ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JLT | BPF_K, BPF_REG_2, 0, (-60) - 1, 7),
    ...
    HC_KINSN(HC_REG_REG_PAYLOAD(HC_X86_R11, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ORB),
    /* 0x128e: cmp    esi,0x8 [absorbed-control-flow: cmp folded into following ordinary BPF jb] */
    /* 0x1291: jb     11f0 <bpftrace_string_search_prefix_scan_xdp+0xf0> [exact-bpf: jb ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JLT | BPF_K, BPF_REG_2, 0, (-67) - 1, 8),
    ...
    /* 0x12a8: cmp    r8,0x60 [absorbed-control-flow: cmp folded into following ordinary BPF je] */
