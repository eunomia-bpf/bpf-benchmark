...
/*
 * native asm to handcraft warnings: 16
 *
 ...
 * - 0x115f: movabs r10,0x9e3779b97f4a7c15 [warning-unmapped: movabs into HC_X86_R10 needs an immediate-load kinsn]
 * - 0x1169: movabs r11,0x100000001b3 [warning-unmapped: movabs into HC_X86_R11 needs an immediate-load kinsn]
 ...
 * - 0x11d7: jne    1180 <cgroup_skb_hash_chain_prog+0x80> [warning-unmapped: cannot lower cmp    r9,0x10 + jne    1180 <cgroup_skb_hash_chain_prog+0x80> to BPF branch]
...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_3, BPF_REG_0, 0, 0, 1, 0, 80, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_JMP_REG(BPF_JGT, BPF_REG_3, BPF_REG_4, -17),
    /* 0x1130: cmp    DWORD PTR [rax+0x8],0x10 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    DWORD PTR [rax+0x8],0x10] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, -19, 16),
    /* 0x1136: cmp    DWORD PTR [rax+0xc],0x8 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    DWORD PTR [rax+0xc],0x8] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, -21, 8),
    /* 0x113c: push   r15 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x113e: push   r14 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1140: push   r12 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1142: push   rbx [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    ...
    /* 0x115c: xor    r9d,r9d [exact-kinsn: xor32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    ...
    /* 0x1183: mov    rbx,r9 [exact-kinsn: movq register-to-register kinsn; verifier instantiate uses temp BPF_REG_7] */
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_9, BPF_REG_9, 0, 0), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1193: data16 data16 data16 cs nop WORD PTR [rax+rax*1+0x0] [padding: padding is not part of BPF semantics] */
    /* 0x11a0: mov    r12,r14 [exact-kinsn: movq register-to-register kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(HC_X86_R12, BPF_REG_8, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x11a3: xor    r12,rbx [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_8] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R12, BPF_REG_6, BPF_REG_7, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x11a6: add    r12,QWORD PTR [rax+r15*8+0x10] [warning-unmapped: ALU memory source form has no current selector: add    r12,QWORD PTR [rax+r15*8+0x10]] */
    /* 0x11ab: xor    r12,rdx [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R12, BPF_REG_3, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x11ae: rol    r12,cl [exact-kinsn: rolq cl kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_ROTATE_CL_PAYLOAD(HC_X86_R12, BPF_REG_4, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLQ_CL),
    ...
    /* 0x11b8: mov    rdx,r12 [exact-kinsn: movq register-to-register kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(BPF_REG_3, HC_X86_R12, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x11bb: shr    rdx,0x1d [exact-kinsn: shr64 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_3, 29, 0), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x11bf: xor    rdx,r12 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_3, HC_X86_R12, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x11c2: add    rcx,0xb [exact-kinsn: add64 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_4, 11, 0), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11c6: add    r14,r8 [exact-kinsn: add64 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_8, BPF_REG_5, 0, 0), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_2, 5, 0), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11d3: cmp    r9,0x10 [exact-kinsn: cmpq reg,imm32 kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_TMP_IMM_PAYLOAD(HC_X86_R9, BPF_REG_7, 16), MICRO_HANDCRAFT_BPF_X86_CMPQ_IMM32),
    /* 0x11d7: jne    1180 <cgroup_skb_hash_chain_prog+0x80> [warning-unmapped: cannot lower cmp    r9,0x10 + jne    1180 <cgroup_skb_hash_chain_prog+0x80> to BPF branch] */
