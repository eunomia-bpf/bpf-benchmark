 ...
 * - 0x1134: jne    110c <cgroup_skb_hash_chain_prog+0xc> [warning-unmapped: jcc has no immediately preceding branchable cmp/test; needs a machine-level branch kinsn]
 * - 0x113a: jne    110c <cgroup_skb_hash_chain_prog+0xc> [warning-unmapped: jcc has no immediately preceding branchable cmp/test; needs a machine-level branch kinsn]
 * - 0x113c: push   rbp [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR]
 * - 0x113d: mov    rbp,rsp [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR]
 * - 0x1140: push   r15 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR]
 * - 0x1142: push   r14 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR]
 * - 0x1144: push   r12 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR]
 * - 0x1146: push   rbx [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR]
 * - 0x1163: movabs r10,0x9e3779b97f4a7c15 [warning-unmapped: movabs into HC_X86_R10 needs an immediate-load kinsn]
 * - 0x116d: movabs r11,0x100000001b3 [warning-unmapped: movabs into HC_X86_R11 needs an immediate-load kinsn]
 ...
 * - 0x11ec: pop    rbp [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR]
 */
...
static const struct bpf_insn program[] = {
    ...
    /* 0x110a: jbe    111e <cgroup_skb_hash_chain_prog+0x1e> [bpf-branch: verifier-visible branch from preceding cmp    rax,rcx; cmp kinsn is preserved] */
    ...
    /* 0x1125: ja     110c <cgroup_skb_hash_chain_prog+0xc> [bpf-branch: verifier-visible branch from preceding cmp    rdx,rcx; cmp kinsn is preserved] */
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_3, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_CMPQ),
    /* 0x112e: ja     110c <cgroup_skb_hash_chain_prog+0xc> [bpf-branch: verifier-visible branch from preceding cmp    rdx,rcx; cmp kinsn is preserved] */
    ...
    /* 0x1144: push   r12 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1146: push   rbx [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1147: movabs rdx,0xcbf29ce484222325 [bpf-jit: 64-bit immediate load] */
    HC_LD_IMM64_RAW(BPF_REG_3, 0, 0xcbf29ce484222325ULL),
    /* 0x1151: mov    esi,0x7 [exact-kinsn: movl immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 7), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1156: movabs r8,0xd1342543de82ef95 [bpf-jit: 64-bit immediate load] */
    HC_LD_IMM64_RAW(BPF_REG_5, 0, 0xd1342543de82ef95ULL),
    /* 0x1160: xor    r9d,r9d [exact-kinsn: xor32 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1163: movabs r10,0x9e3779b97f4a7c15 [warning-unmapped: movabs into HC_X86_R10 needs an immediate-load kinsn] */
    /* 0x116d: movabs r11,0x100000001b3 [warning-unmapped: movabs into HC_X86_R11 needs an immediate-load kinsn] */
    /* 0x1177: nop    WORD PTR [rax+rax*1+0x0] [padding: padding is not part of BPF semantics] */
    ...
    /* 0x11cd: jne    11a0 <cgroup_skb_hash_chain_prog+0xa0> [bpf-branch: verifier-visible branch from preceding cmp    r15,0x8; cmp kinsn is preserved] */
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_9, 0, -27, 8),
    ...
    /* 0x11d7: jne    1180 <cgroup_skb_hash_chain_prog+0x80> [bpf-branch: verifier-visible branch from preceding cmp    r9,0x10; cmp kinsn is preserved] */
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, HC_X86_R9, 0, -44, 16),
    ...
    /* 0x11ea: pop    r15 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x11ec: pop    rbp [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x11ed: mov    DWORD PTR [rdi+0x14],edx [exact-kinsn: direct memory store via x86 kinsn selector] */
    HC_KINSN(HC_X86_STORE_PAYLOAD(BPF_REG_3, BPF_REG_1, 20), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11f0: ret [bpf-jit: BPF exit; kernel JIT emits the real return sequence] */
    HC_EXIT(),
};
