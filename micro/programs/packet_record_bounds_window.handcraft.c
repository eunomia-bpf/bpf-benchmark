...
static const struct bpf_insn program[] = {
    ...
    /* 0x11b1: cmp    rdi,rax [absorbed-control-flow: cmp folded into following ordinary BPF jb] */
    /* 0x11b4: jb     1196 <packet_record_bounds_window_xdp+0x96> [exact-bpf: jb ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP | BPF_JLT | BPF_X, BPF_REG_1, BPF_REG_0, (-14) - 1, 0),
    ...
    /* 0x11d5: test   al,0x1 [absorbed-control-flow: test folded into following ordinary BPF je] */
