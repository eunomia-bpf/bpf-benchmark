...
static const struct bpf_insn program[] = {
    ...
    /* 0x110c: jbe    110f <packet_record_bounds_window_xdp+0xf> [exact-kinsn: jbe branch kinsn] */
    ...
    /* 0x1116: ja     110e <packet_record_bounds_window_xdp+0xe> [exact-kinsn: ja branch kinsn] */
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_2, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_CMPQ),
    /* 0x1122: ja     110e <packet_record_bounds_window_xdp+0xe> [exact-kinsn: ja branch kinsn] */
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(54, 89, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(42, 72, 0), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    /* 0x11b4: jb     1196 <packet_record_bounds_window_xdp+0x96> [exact-kinsn: jb branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-16, -32, 0), MICRO_HANDCRAFT_BPF_X86_JB),
