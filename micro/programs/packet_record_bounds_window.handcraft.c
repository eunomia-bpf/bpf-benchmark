 ...
 * - 0x11c4: movzx  r11d,WORD PTR [rsi-0x3] [warning-reg-remap: direct memory load via x86 kinsn selector; native r11 has no exact BPF JIT register; remapped to BPF_REG_7]
...
static const struct bpf_insn program[] = {
    ...
    /* 0x1168: and    cl,0x1c [exact-kinsn: andb imm kinsn; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_REG_IMM_TMP_PAYLOAD(BPF_REG_4, 28, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ANDB_IMM),
    ...
    /* 0x1174: and    cl,0x18 [exact-kinsn: andb imm kinsn; verifier instantiate uses temp BPF_REG_6] */
    ...
    /* 0x1186: mov    r10,r9 [warning-unmapped: unsupported mnemonic or operand form: mov    r10,r9] */
    /* 0x1189: shl    r10,cl [warning-unmapped: ALU destination r10 is not in the BPF JIT register file] */
    /* 0x118c: not    al [exact-kinsn: notb reg kinsn; verifier instantiate uses temp BPF_REG_6] */
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_1, 0, 25, 0),
    /* 0x11a4: movzx  r10d,BYTE PTR [rsi-0x17] [warning-unmapped: destination register r10d is not in the BPF JIT register file] */
    /* 0x11a9: and    r10d,0x3 [warning-unmapped: ALU destination r10d is not in the BPF JIT register file] */
    /* 0x11ad: lea    rax,[r10+0x18] [warning-unmapped: LEA base/index not in BPF register file: [r10+0x18]] */
    ...
    /* 0x11c4: movzx  r11d,WORD PTR [rsi-0x3] [warning-reg-remap: direct memory load via x86 kinsn selector; native r11 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_7, BPF_REG_2, -3), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    /* 0x11c9: add    rbx,r9 [warning-reg-remap: ALU reg operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
