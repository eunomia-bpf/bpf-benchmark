...
static const struct bpf_insn program[] = {
    ...
    /* 0x1159: add    r11,rcx [exact-kinsn: add64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_9] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_4, BPF_REG_7, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x115c: movzx  r9d,WORD PTR [rsi-0x1] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R9, BPF_REG_2, -1, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    /* 0x1161: lea    ecx,[rax*4+0x0] [exact-kinsn: LEA via x86 kinsn selector] */
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_4, 0, BPF_REG_0, 2, 0, 1, 0, 0), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x1168: and    cl,0x1c [exact-kinsn: andb imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_IMM_TMP_PAYLOAD(BPF_REG_4, 28, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_ANDB_IMM),
    /* 0x116b: shl    rbx,cl [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_LSH | BPF_X, BPF_REG_6, BPF_REG_4, 0, 0),
    /* 0x116e: xor    rbx,r11 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_9] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_6, HC_X86_R11, BPF_REG_7, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    /* 0x1174: and    cl,0x18 [exact-kinsn: andb imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_IMM_TMP_PAYLOAD(BPF_REG_4, 24, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_ANDB_IMM),
    /* 0x1177: shl    r9,cl [warning-unmapped: shl    r9,cl needs a shadow-aware ALU kinsn] */
    /* 0x117a: add    r9,rbx [exact-kinsn: add64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_9] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, BPF_REG_6, BPF_REG_7, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x117d: and    eax,0x7 [exact-kinsn: and32 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_0, 7, 0), MICRO_HANDCRAFT_BPF_X86_ANDL),
    /* 0x1180: xor    eax,r10d [exact-kinsn: xor32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_9] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_0, HC_X86_R10, BPF_REG_7, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_XORL),
    ...
    /* 0x1186: mov    r10,r9 [exact-kinsn: movq register-to-register kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(HC_X86_R10, HC_X86_R9, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x1189: shl    r10,cl [warning-unmapped: shl    r10,cl needs a shadow-aware ALU kinsn] */
    ...
    /* 0x1190: shr    r9,cl [warning-unmapped: shr    r9,cl needs a shadow-aware ALU kinsn] */
    /* 0x1193: or     r9,r10 [exact-kinsn: or64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_9] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, HC_X86_R10, BPF_REG_7, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x1196: add    r8,0x8 [exact-kinsn: add64 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_5, 8, 0), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_1, 18446744073709551592, 0), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_1, 0, 37, 0),
    /* 0x11a4: movzx  r10d,BYTE PTR [rsi-0x17] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R10, BPF_REG_2, -23, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x11a9: and    r10d,0x3 [exact-kinsn: and32 imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R10, 3, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_ANDL),
    /* 0x11ad: lea    rax,[r10+0x18] [exact-kinsn: LEA via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_0, HC_X86_R10, 0, 0, 1, 0, 24, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_JMP_REG(BPF_JLT, BPF_REG_1, BPF_REG_0, -15),
    ...
    /* 0x11c4: movzx  r11d,WORD PTR [rsi-0x3] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R11, BPF_REG_2, -3, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    /* 0x11c9: add    rbx,r9 [exact-kinsn: add64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_9] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_6, HC_X86_R9, BPF_REG_7, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11cc: add    r11,r14 [exact-kinsn: add64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_9] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_8, BPF_REG_7, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11cf: add    r11,rbx [exact-kinsn: add64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_9] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_6, BPF_REG_7, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_4, BPF_REG_6, 0, 0), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x11e4: xor    r11,rcx [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_9] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_4, BPF_REG_7, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    /* 0x11ec: mov    QWORD PTR [rdx],r9 [exact-kinsn: direct memory store via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
