...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_MEM_PAYLOAD(HC_X86_R9, BPF_REG_2, -1), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(HC_X86_R10, BPF_REG_2, -23), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_0, BPF_REG_2, -22), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x11ba: mov    ebx,DWORD PTR [rsi-0x13] [exact-kinsn: direct memory load via x86 kinsn selector] */
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_6, BPF_REG_2, -19), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11bd: mov    r14d,DWORD PTR [rsi-0xf] [exact-kinsn: direct memory load via x86 kinsn selector] */
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_8, BPF_REG_2, -15), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(HC_X86_R11, BPF_REG_2, -3), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_6, BPF_REG_2, -7), MICRO_HANDCRAFT_BPF_X86_MOVL),
