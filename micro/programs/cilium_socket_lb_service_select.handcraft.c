 ...
 * - 0x110c: jbe    110f <cilium_socket_lb_service_select_xdp+0xf> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1116: ja     110e <cilium_socket_lb_service_select_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1122: ja     110e <cilium_socket_lb_service_select_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1129: jne    110e <cilium_socket_lb_service_select_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1130: jne    110e <cilium_socket_lb_service_select_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x114b: jmp    116e <cilium_socket_lb_service_select_xdp+0x6e> [warning-unmapped: needs a machine-level x86 branch kinsn]
 * - 0x1168: je     125c <cilium_socket_lb_service_select_xdp+0x15c> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x119d: jne    1150 <cilium_socket_lb_service_select_xdp+0x50> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x11a8: je     1150 <cilium_socket_lb_service_select_xdp+0x50> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x11cb: jg     11f0 <cilium_socket_lb_service_select_xdp+0xf0> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x11d3: jne    11f0 <cilium_socket_lb_service_select_xdp+0xf0> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x11e4: jmp    115d <cilium_socket_lb_service_select_xdp+0x5d> [warning-unmapped: needs a machine-level x86 branch kinsn]
 * - 0x1208: div    r12d [warning-unmapped: unsupported mnemonic or operand form: div    r12d]
 * - 0x1257: jmp    115d <cilium_socket_lb_service_select_xdp+0x5d> [warning-unmapped: needs a machine-level x86 branch kinsn]
 */
