 ...
 * - 0x1159: rol    r12d,0xb [warning-reg-remap: roll imm kinsn; verifier instantiate uses temp BPF_REG_6; native r12 has no exact BPF JIT register; remapped to BPF_REG_7]
 ...
 * - 0x11e1: cmp    r10d,0x6 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    r10d,0x6]
 ...
 * - 0x11e7: cmp    r10d,0x11 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    r10d,0x11]
 ...
 * - 0x11fe: lea    r12,[rdi-0x1f] [warning-reg-remap: LEA via x86 kinsn selector; native r12 has no exact BPF JIT register; remapped to BPF_REG_7]
 ...
 * - 0x1228: mov    r12d,DWORD PTR [r12] [warning-reg-remap: direct memory load via x86 kinsn selector; native r12 has no exact BPF JIT register; remapped to BPF_REG_7]
...
static const struct bpf_insn program[] = {
    ...
    /* 0x1156: mov    r12d,ebp [warning-unmapped: unsupported mnemonic or operand form: mov    r12d,ebp] */
    /* 0x1159: rol    r12d,0xb [warning-reg-remap: roll imm kinsn; verifier instantiate uses temp BPF_REG_6; native r12 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KINSN(HC_ROTATE_PAYLOAD(BPF_REG_7, BPF_REG_7, 11, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    ...
    /* 0x11ac: not    al [exact-kinsn: notb reg kinsn; verifier instantiate uses temp BPF_REG_6] */
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_5, 0, 29, 32),
    /* 0x11d0: movzx  r10d,BYTE PTR [rdi-0x13] [warning-unmapped: destination register r10d is not in the BPF JIT register file] */
    /* 0x11d5: movzx  r9d,WORD PTR [rdi-0x7] [warning-reg-remap: direct memory load via x86 kinsn selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x121b: cmovne r14d,r9d [warning-unmapped: cmovne needs an adjacent test/cmp proof payload] */
    /* 0x121f: cmovne r15,rbx [warning-unmapped: cmovne needs an adjacent test/cmp proof payload] */
    /* 0x1223: xor    r14w,WORD PTR [rdi-0x15] [exact-kinsn: xorw memory-source kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_ALU_MEM_PAYLOAD(BPF_REG_8, BPF_REG_1, -21, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORW_MEM),
    /* 0x1228: mov    r12d,DWORD PTR [r12] [warning-reg-remap: direct memory load via x86 kinsn selector; native r12 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_7, BPF_REG_7, 0), MICRO_HANDCRAFT_BPF_X86_MOVL_MEM),
