...
static const struct bpf_insn program[] = {
    ...
    /* 0x110c: jbe    110f <cilium_ct_nat_tuple_rewrite_xdp+0xf> [exact-kinsn: jbe branch kinsn] */
    ...
    /* 0x1116: ja     110e <cilium_ct_nat_tuple_rewrite_xdp+0xe> [exact-kinsn: ja branch kinsn] */
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_2, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_CMPQ),
    /* 0x1122: ja     110e <cilium_ct_nat_tuple_rewrite_xdp+0xe> [exact-kinsn: ja branch kinsn] */
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(80, 130, 1), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    /* 0x11ca: je     1261 <cilium_ct_nat_tuple_rewrite_xdp+0x161> [exact-kinsn: je branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(76, 145, 1), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    /* 0x11e5: je     11ed <cilium_ct_nat_tuple_rewrite_xdp+0xed> [exact-kinsn: je branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(6, 6, 0), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    /* 0x11eb: jne    1250 <cilium_ct_nat_tuple_rewrite_xdp+0x150> [exact-kinsn: jne branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(50, 99, 0), MICRO_HANDCRAFT_BPF_X86_JNE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-130, -233, 1), MICRO_HANDCRAFT_BPF_X86_JNE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-136, -243, 1), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-80, -162, 1), MICRO_HANDCRAFT_BPF_X86_JMP),
