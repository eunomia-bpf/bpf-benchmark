 ...
 * - 0x110c: jbe    110f <cilium_ct_nat_tuple_rewrite_xdp+0xf> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1116: ja     110e <cilium_ct_nat_tuple_rewrite_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1122: ja     110e <cilium_ct_nat_tuple_rewrite_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1128: jne    110e <cilium_ct_nat_tuple_rewrite_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x112e: jne    110e <cilium_ct_nat_tuple_rewrite_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1149: jmp    11d0 <cilium_ct_nat_tuple_rewrite_xdp+0xd0> [warning-unmapped: needs a machine-level x86 branch kinsn]
 * - 0x11ca: je     1261 <cilium_ct_nat_tuple_rewrite_xdp+0x161> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x11e5: je     11ed <cilium_ct_nat_tuple_rewrite_xdp+0xed> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x11eb: jne    1250 <cilium_ct_nat_tuple_rewrite_xdp+0x150> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1233: jne    1150 <cilium_ct_nat_tuple_rewrite_xdp+0x50> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1244: jmp    1156 <cilium_ct_nat_tuple_rewrite_xdp+0x56> [warning-unmapped: needs a machine-level x86 branch kinsn]
 * - 0x125c: jmp    11bf <cilium_ct_nat_tuple_rewrite_xdp+0xbf> [warning-unmapped: needs a machine-level x86 branch kinsn]
 */
