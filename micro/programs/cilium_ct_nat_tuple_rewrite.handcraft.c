...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_2, BPF_REG_3, 0, 0, 1, 0, 8, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_2, BPF_REG_3, 0, 0, 1, 0, 1040, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, -13, 32),
    /* 0x112a: cmp    DWORD PTR [rdx+0xc],0x20 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    DWORD PTR [rdx+0xc],0x20] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, -15, 32),
    /* 0x1130: push   rbp [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1131: push   r15 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1133: push   r14 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1135: push   r12 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    ...
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_1, BPF_REG_3, 0, 0, 1, 0, 47, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x1153: mov    ebp,r12d [warning-unmapped: unsupported mnemonic or operand form: mov    ebp,r12d] */
    /* 0x1156: mov    r12d,ebp [warning-unmapped: unsupported mnemonic or operand form: mov    r12d,ebp] */
    /* 0x1159: rol    r12d,0xb [exact-kinsn: roll imm kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_ROTATE_SHADOW_PAYLOAD(HC_X86_R12, HC_X86_R12, 11, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x115d: shl    r14d,0x10 [exact-kinsn: shl32 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_8, 16, 0), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x1161: xor    r14d,r12d [exact-kinsn: xor32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_8, HC_X86_R12, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_XORL),
    ...
    /* 0x1168: shl    r10d,0x18 [exact-kinsn: shl32 imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R10, 24, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x116c: or     ecx,r10d [exact-kinsn: or32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_4, HC_X86_R10, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ORL),
    /* 0x116f: xor    ecx,r15d [exact-kinsn: xor32 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_4, BPF_REG_9, 0, 0), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1172: xor    ecx,r14d [exact-kinsn: xor32 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_4, BPF_REG_8, 0, 0), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1175: xor    ecx,ebx [exact-kinsn: xor32 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_4, BPF_REG_6, 0, 0), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1177: shl    r11d,0x1d [exact-kinsn: shl32 imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R11, 29, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x117b: sar    r11d,0x1f [exact-kinsn: sar32 imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R11, 31, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_SARL),
    /* 0x117f: shl    r9d,0x8 [exact-kinsn: shl32 imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R9, 8, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x1183: xor    r9d,eax [exact-kinsn: xor32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, BPF_REG_0, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1186: and    r9d,r11d [exact-kinsn: and32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, HC_X86_R11, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ANDL),
    /* 0x1189: add    r9d,ecx [exact-kinsn: add32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, BPF_REG_4, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ADDL),
    /* 0x118c: shl    r9,0x20 [exact-kinsn: shl64 imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R9, 32, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x1190: mov    r10d,eax [exact-kinsn: movl register-to-register kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(HC_X86_R10, BPF_REG_0, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVL_RR),
    /* 0x1193: shl    rbx,0x20 [exact-kinsn: shl64 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_6, 32, 0), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x1197: mov    r11d,ebp [warning-unmapped: unsupported mnemonic or operand form: mov    r11d,ebp] */
    /* 0x119a: or     r11,rbx [exact-kinsn: or64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_8] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_6, BPF_REG_7, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_ORQ),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_0, 7, 0), MICRO_HANDCRAFT_BPF_X86_ANDL),
    ...
    /* 0x11a6: mov    rbx,r11 [exact-kinsn: movq register-to-register kinsn; verifier instantiate uses temp BPF_REG_7] */
    ...
    /* 0x11b0: shr    r11,cl [warning-unmapped: shr    r11,cl needs a shadow-aware ALU kinsn] */
    /* 0x11b3: add    rsi,r10 [exact-kinsn: add64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_2, HC_X86_R10, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11b6: add    rsi,r9 [exact-kinsn: add64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_2, HC_X86_R9, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11b9: or     r11,rbx [exact-kinsn: or64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_8] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_6, BPF_REG_7, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x11bc: xor    rsi,r11 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_2, HC_X86_R11, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    /* 0x11d0: movzx  r10d,BYTE PTR [rdi-0x13] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R10, BPF_REG_1, -19, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x11d5: movzx  r9d,WORD PTR [rdi-0x7] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R9, BPF_REG_1, -7, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    ...
    /* 0x11e1: cmp    r10d,0x6 [exact-kinsn: cmpl reg,imm32 kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_TMP_IMM_PAYLOAD(HC_X86_R10, BPF_REG_7, 6), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    /* 0x11e5: je     11ed <cilium_ct_nat_tuple_rewrite_xdp+0xed> [warning-unmapped: cannot lower cmp    r10d,0x6 + je     11ed <cilium_ct_nat_tuple_rewrite_xdp+0xed> to BPF branch] */
    /* 0x11e7: cmp    r10d,0x11 [exact-kinsn: cmpl reg,imm32 kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_TMP_IMM_PAYLOAD(HC_X86_R10, BPF_REG_7, 17), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    /* 0x11eb: jne    1250 <cilium_ct_nat_tuple_rewrite_xdp+0x150> [warning-unmapped: cannot lower cmp    r10d,0x11 + jne    1250 <cilium_ct_nat_tuple_rewrite_xdp+0x150> to BPF branch] */
    /* 0x11ed: lea    rbx,[rdi-0xb] [exact-kinsn: LEA via x86 kinsn selector] */
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_6, BPF_REG_1, 0, 0, 1, 0, -11, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x11f1: lea    r14,[rdi-0xf] [exact-kinsn: LEA via x86 kinsn selector] */
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_8, BPF_REG_1, 0, 0, 1, 0, -15, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x11f5: movzx  r11d,BYTE PTR [rdi-0x11] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R11, BPF_REG_1, -17, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x11fa: lea    r15,[rdi-0x1b] [exact-kinsn: LEA via x86 kinsn selector] */
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_9, BPF_REG_1, 0, 0, 1, 0, -27, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x11fe: lea    r12,[rdi-0x1f] [exact-kinsn: LEA via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_LEA_TMP_PAYLOAD(HC_X86_R12, BPF_REG_1, 0, 0, 1, 0, -31, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x1202: mov    ebp,r11d [warning-unmapped: unsupported mnemonic or operand form: mov    ebp,r11d] */
    /* 0x1205: and    ebp,0x1 [warning-unmapped: ALU destination ebp is not in the BPF JIT register file] */
    /* 0x1208: cmovne ebp,r9d [warning-unmapped: cmovne operands are not supported] */
    /* 0x120c: cmovne r12,r14 [warning-unmapped: cmovne needs an adjacent test/cmp proof payload] */
    /* 0x1210: xor    bp,WORD PTR [rdi-0x17] [warning-unmapped: ALU destination bp is not in the BPF JIT register file] */
    /* 0x1214: mov    r14d,r11d [exact-kinsn: movl register-to-register kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(BPF_REG_8, HC_X86_R11, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVL_RR),
    /* 0x1217: and    r14d,0x2 [exact-kinsn: and32 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_8, 2, 0), MICRO_HANDCRAFT_BPF_X86_ANDL),
    /* 0x121b: cmovne r14d,r9d [warning-unmapped: cmovne needs an adjacent test/cmp proof payload] */
    /* 0x121f: cmovne r15,rbx [warning-unmapped: cmovne needs an adjacent test/cmp proof payload] */
    ...
    /* 0x1228: mov    r12d,DWORD PTR [r12] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R12, HC_X86_R12, 0, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVL_MEM),
    ...
    /* 0x123c: mov    r14d,ebp [warning-unmapped: unsupported mnemonic or operand form: mov    r14d,ebp] */
    /* 0x123f: mov    ebp,ebx [warning-unmapped: unsupported mnemonic or operand form: mov    ebp,ebx] */
    /* 0x1241: mov    ebx,r12d [exact-kinsn: movl register-to-register kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(BPF_REG_6, HC_X86_R12, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVL_RR),
    ...
    /* 0x1250: shl    r10,0x38 [exact-kinsn: shl64 imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R10, 56, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    ...
    /* 0x1256: or     rax,r10 [exact-kinsn: or64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_0, HC_X86_R10, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ORQ),
