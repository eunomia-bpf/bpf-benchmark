...
static const struct bpf_insn program[] = {
    ...
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_6, 0, 1, 2),
    HC_EXIT(),
    ...
    /* 0x133e: cmp    r8,0x20 [absorbed-control-flow: cmp folded into following ordinary BPF jne] */
    /* 0x1342: jne    1160 <packed_header_bitfield_decode_xdp+0x60> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
