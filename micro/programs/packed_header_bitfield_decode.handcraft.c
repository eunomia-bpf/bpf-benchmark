...
static const struct bpf_insn program[] = {
    ...
    /* 0x110c: jbe    110f <packed_header_bitfield_decode_xdp+0xf> [exact-kinsn: jbe branch kinsn] */
    ...
    /* 0x1116: ja     110e <packed_header_bitfield_decode_xdp+0xe> [exact-kinsn: ja branch kinsn] */
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_3, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_CMPQ),
    /* 0x1122: ja     110e <packed_header_bitfield_decode_xdp+0xe> [exact-kinsn: ja branch kinsn] */
    ...
    /* 0x1342: jne    1160 <packed_header_bitfield_decode_xdp+0x60> [exact-kinsn: jne branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-266, -488, 1), MICRO_HANDCRAFT_BPF_X86_JNE),
