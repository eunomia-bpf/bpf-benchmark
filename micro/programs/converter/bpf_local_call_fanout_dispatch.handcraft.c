...
static const struct bpf_insn program[] = {
    ...
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RDX, HC_X86_R14, 0, 0, 1, 0, 8), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x112c: mov    QWORD PTR [rsp],rdx [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(HC_X86_RDX, HC_X86_RSP, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RDX, HC_X86_R14, 0, 0, 1, 0, 400), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_R15, HC_X86_R15), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x115c: mov    r12d,0x17 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R12, 23), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1162: xor    r13d,r13d [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_R13, HC_X86_R13), MICRO_HANDCRAFT_BPF_X86_XORL),
    ...
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_RSI, HC_X86_RSP, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1174: mov    ecx,ebp [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RCX, HC_X86_RBP), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1176: call   1260 <local_call_pressure> [abi-boundary: native direct call maps to BPF pseudo call] */
    HC_CALL(103),
    /* 0x117b: mov    ecx,r13d [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RCX, HC_X86_R13), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x117e: and    cl,0x38 [exact-kop: andb imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RCX, 56), MICRO_HANDCRAFT_BPF_X86_ANDB),
    /* 0x1181: shl    rbx,cl [exact-kop: shl64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RBX, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x1184: mov    edi,ebp [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RDI, HC_X86_RBP), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1186: add    rdi,rbx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RDI, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R13, 8), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1190: add    r15d,0x10 [exact-kop: add32 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R15, 16), MICRO_HANDCRAFT_BPF_X86_ADDL),
    ...
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RBX, HC_X86_R14, HC_X86_R12, 0, -7), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x11a7: and    ebx,0x3 [exact-kop: and32 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RBX, 3), MICRO_HANDCRAFT_BPF_X86_ANDL),
    /* 0x11aa: mov    ebp,DWORD PTR [r14+r12*1-0x3] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RBP, HC_X86_R14, HC_X86_R12, 0, -3), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11af: xor    ebp,r15d [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RBP, HC_X86_R15), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x11b2: lea    rdx,[r12-0xf] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RDX, HC_X86_R12, 0, 0, 1, 0, -15), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_RSI, HC_X86_RSP, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x11ca: mov    ecx,ebp [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RCX, HC_X86_RBP), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_RSI, HC_X86_RSP, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x11e4: mov    ecx,ebp [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RCX, HC_X86_RBP), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_RSI, HC_X86_RSP, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x11f4: mov    ecx,ebp [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RCX, HC_X86_RBP), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_STORE_PAYLOAD(HC_X86_RDI, HC_X86_R14, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1203: mov    eax,0x2 [exact-kop: mov32 immediate kop] */
    ...
    /* 0x1210: mov    r8d,ecx [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R8, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1213: mov    ecx,edx [exact-kop: mov32 register-to-register kop] */
    ...
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RAX, HC_X86_RCX, HC_X86_RSI, 0, 8), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x121a: lea    r9,[rax+rax*2] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_R9, HC_X86_RAX, HC_X86_RAX, 1, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x121e: mov    edx,r8d [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RDX, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_R9, HC_X86_RCX, HC_X86_RSI, 0, 16), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x122c: shl    rdx,0xb [exact-kop: shl64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDX, 11), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x1230: add    rdx,r9 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RDX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1233: and    r8d,0x7 [exact-kop: and32 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R8, 7), MICRO_HANDCRAFT_BPF_X86_ANDL),
    /* 0x1237: lea    ecx,[r8+0x1] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RCX, HC_X86_R8, 0, 0, 1, 0, 1), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x123b: mov    rsi,rdx [exact-kop: mov64 register-to-register kop] */
    ...
    /* 0x1241: not    r8b [exact-kop: not8 reg kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R8, 0), MICRO_HANDCRAFT_BPF_X86_NOTB),
    /* 0x1244: mov    ecx,r8d [exact-kop: mov32 register-to-register kop] */
    ...
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RAX, 3), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    ...
    /* 0x1260: mov    eax,edx [exact-kop: mov32 register-to-register kop] */
    ...
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_R8, HC_X86_RAX, HC_X86_RSI, 0, 8), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1267: mov    rdx,QWORD PTR [rax+rsi*1+0x10] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RDX, HC_X86_RAX, HC_X86_RSI, 0, 16), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x126c: xor    rdi,r8 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RDI, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x126f: mov    eax,ecx [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RAX, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1271: shl    rax,0x11 [exact-kop: shl64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RAX, 17), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x1275: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1278: lea    rcx,[rdi*8+0x0] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RCX, 0, HC_X86_RDI, 3, 0, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x1280: shr    rdx,0x2 [exact-kop: shr64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDX, 2), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    ...
    HC_KOP(HC_ROTATE_PAYLOAD(HC_X86_R8, HC_X86_R8, 5), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x128b: xor    rdx,rcx [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RDX, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x128e: lea    rcx,[rdx+rdi*1] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RCX, HC_X86_RDX, HC_X86_RDI, 0, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x1292: rol    rcx,0xb [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_PAYLOAD(HC_X86_RCX, HC_X86_RCX, 11), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    ...
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RAX, 7), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x12a0: xor    rax,rcx [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RAX, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x12a3: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x12a6: xor    rax,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    HC_KOP(HC_X86_RBX, MICRO_HANDCRAFT_BPF_X86_PUSHQ),
    /* 0x12b3: mov    r8d,ecx [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R8, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12b6: mov    eax,edx [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12b8: movzx  edx,BYTE PTR [rsi+rax*1] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RDX, HC_X86_RSI, HC_X86_RAX, 0, 0), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x12bc: lea    rcx,[rax+0x4] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RCX, HC_X86_RAX, 0, 0, 1, 0, 4), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x12c0: movzx  r9d,BYTE PTR [rsi+rax*1+0x4] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_R9, HC_X86_RSI, HC_X86_RAX, 0, 4), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x12c6: movsxd r11,ecx [exact-kop: movsxd reg kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R11, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_MOVSXD),
    /* 0x12c9: movzx  r10d,BYTE PTR [rsi+r11*1+0x1] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_R10, HC_X86_RSI, HC_X86_R11, 0, 1), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x12cf: add    rdi,QWORD PTR [rsi+rax*1+0x8] [exact-kop: add64 SIB memory-source kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RDI, HC_X86_RSI, HC_X86_RAX, 0, 8), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x12d4: mov    rax,QWORD PTR [rsi+rax*1+0x10] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RAX, HC_X86_RSI, HC_X86_RAX, 0, 16), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    /* 0x12e2: mov    rbx,rax [exact-kop: mov64 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RBX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_R14, HC_X86_RSI, HC_X86_R11, 0, 2), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x12ee: movzx  esi,BYTE PTR [rsi+r11*1+0x3] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RSI, HC_X86_RSI, HC_X86_R11, 0, 3), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x12f4: mov    ecx,edx [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RCX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12f6: not    cl [exact-kop: not8 reg kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_RCX, 0), MICRO_HANDCRAFT_BPF_X86_NOTB),
    /* 0x12f8: shr    rax,cl [exact-kop: shr64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RAX, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x12fb: or     rax,rbx [exact-kop: or64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RAX, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x12fe: shl    rsi,0x21 [exact-kop: shl64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RSI, 33), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x1302: shl    r14,0x19 [exact-kop: shl64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R14, 25), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    ...
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, HC_X86_R14), MICRO_HANDCRAFT_BPF_X86_ORQ),
    ...
    /* 0x131d: mov    esi,r8d [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RSI, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1320: mov    ecx,edx [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RCX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RAX, 5), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x132c: xor    rax,rsi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RAX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    /* 0x1340: mov    eax,ecx [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RAX, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1342: mov    ecx,edx [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RCX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1344: movzx  edx,BYTE PTR [rsi+rcx*1] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RDX, HC_X86_RSI, HC_X86_RCX, 0, 0), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_R8, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1358: add    r8,rax [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_R8, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x135b: rol    r8,1 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_PAYLOAD(HC_X86_R8, HC_X86_R8, 1), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x135e: movzx  edx,BYTE PTR [rsi+rcx*1+0x1] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RDX, HC_X86_RSI, HC_X86_RCX, 0, 1), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1363: shl    edx,0x8 [exact-kop: shl32 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDX, 8), MICRO_HANDCRAFT_BPF_X86_SHLL),
    ...
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_RDX, 0), MICRO_HANDCRAFT_BPF_X86_INCQ),
    /* 0x136f: rol    rdx,0x2 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 2), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1373: movzx  edi,BYTE PTR [rsi+rcx*1+0x2] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RDI, HC_X86_RSI, HC_X86_RCX, 0, 2), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RDX, HC_X86_RAX, HC_X86_RDI, 0, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x1382: add    rdx,0x2 [exact-kop: add64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDX, 2), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1386: rol    rdx,0x3 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 3), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x138a: movzx  edi,BYTE PTR [rsi+rcx*1+0x3] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RDI, HC_X86_RSI, HC_X86_RCX, 0, 3), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x138f: shl    edi,0x18 [exact-kop: shl32 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDI, 24), MICRO_HANDCRAFT_BPF_X86_SHLL),
    ...
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDX, 3), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x139d: rol    rdx,0x4 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 4), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x13a1: movzx  edi,BYTE PTR [rsi+rcx*1+0x4] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RDI, HC_X86_RSI, HC_X86_RCX, 0, 4), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x13a6: shl    rdi,0x20 [exact-kop: shl64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDI, 32), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    ...
    HC_KOP(HC_ROTATE_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 5), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x13b9: movzx  edi,BYTE PTR [rsi+rcx*1+0x5] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RDI, HC_X86_RSI, HC_X86_RCX, 0, 5), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x13be: shl    rdi,0x28 [exact-kop: shl64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDI, 40), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    ...
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDX, 5), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x13cd: rol    rdx,0x6 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 6), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x13d1: movzx  edi,BYTE PTR [rsi+rcx*1+0x6] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RDI, HC_X86_RSI, HC_X86_RCX, 0, 6), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x13d6: shl    rdi,0x30 [exact-kop: shl64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDI, 48), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    ...
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDX, 6), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x13e5: rol    rdx,0x7 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 7), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x13e9: movzx  edi,BYTE PTR [rsi+rcx*1+0x7] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RDI, HC_X86_RSI, HC_X86_RCX, 0, 7), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x13ee: shl    rdi,0x38 [exact-kop: shl64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDI, 56), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    ...
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RAX, 7), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x13fc: rol    rax,0x8 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 8), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1400: add    rax,QWORD PTR [rsi+rcx*1+0x8] [exact-kop: add64 SIB memory-source kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RAX, HC_X86_RSI, HC_X86_RCX, 0, 8), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1405: xor    rax,QWORD PTR [rsi+rcx*1+0x10] [exact-kop: xor64 SIB memory-source kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RAX, HC_X86_RSI, HC_X86_RCX, 0, 16), MICRO_HANDCRAFT_BPF_X86_XORQ),
