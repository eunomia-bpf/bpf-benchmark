...
static const struct bpf_insn program[] = {
    ...
    /* 0x112d: mov    edx,0xf [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RDX, 15), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1136: mov    ebx,0xc [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 12), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_RBX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    /* 0x15f4: mov    ebx,0x19 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 25), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x15fe: mov    ebx,0x22 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 34), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1608: mov    ebx,0x2d [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 45), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1612: mov    ebx,0x2 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 2), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x161c: mov    ebx,0x20 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 32), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1626: mov    ebx,0x26 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 38), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1630: mov    ebx,0x1 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 1), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x163a: mov    ebx,0xe [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 14), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1644: mov    ebx,0x35 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 53), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x164e: mov    ebx,0x1d [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 29), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1658: mov    ebx,0xd [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 13), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1662: mov    ebx,0x13 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 19), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x166c: mov    ebx,0x8 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 8), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1676: mov    ebx,0x21 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 33), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1680: mov    ebx,0x3c [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 60), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x168a: mov    ebx,0x39 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 57), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1694: mov    ebx,0xb [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 11), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x169e: mov    ebx,0x2f [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 47), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x16a8: mov    ebx,0x9 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x16b2: mov    ebx,0x31 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 49), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x16bc: mov    ebx,0x7 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 7), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x16c6: mov    ebx,0x11 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 17), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x16d0: mov    ebx,0x16 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 22), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x16da: mov    ebx,0xa [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 10), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x16e4: mov    ebx,0x18 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 24), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x16ee: mov    ebx,0xf [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 15), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x16f8: mov    ebx,0x1e [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 30), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1702: mov    ebx,0x25 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 37), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x170c: mov    ebx,0x33 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 51), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1716: mov    ebx,0x17 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 23), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1720: mov    ebx,0x1bf52 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RBX, 114514), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RBX, 16), MICRO_HANDCRAFT_BPF_X86_SHRL),
    /* 0x1732: mov    BYTE PTR [rcx+0x2],bl [exact-kinsn: direct memory store via x86 kinsn selector] */
    HC_KINSN(HC_X86_STORE_PAYLOAD(HC_X86_RBX, HC_X86_RCX, 2), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1735: mov    edx,eax [exact-kinsn: mov32 register-to-register kinsn] */
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KINSN(HC_X86_STORE_PAYLOAD(HC_X86_RDX, HC_X86_RCX, 3), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x173d: mov    rdx,rax [exact-kinsn: mov64 register-to-register kinsn] */
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    /* 0x1747: mov    rdx,rax [exact-kinsn: mov64 register-to-register kinsn] */
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KINSN(HC_X86_STORE_PAYLOAD(HC_X86_RDX, HC_X86_RCX, 5), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1751: mov    rdx,rax [exact-kinsn: mov64 register-to-register kinsn] */
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1754: shr    rdx,0x30 [exact-kinsn: shr64 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDX, 48), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x1758: mov    BYTE PTR [rcx+0x6],dl [exact-kinsn: direct memory store via x86 kinsn selector] */
    HC_KINSN(HC_X86_STORE_PAYLOAD(HC_X86_RDX, HC_X86_RCX, 6), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    HC_KINSN(HC_X86_STORE_PAYLOAD(HC_X86_RAX, HC_X86_RCX, 7), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1762: mov    eax,0x2 [exact-kinsn: mov32 immediate kinsn] */
