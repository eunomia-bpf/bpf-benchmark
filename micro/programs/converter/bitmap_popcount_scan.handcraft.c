...
static const struct bpf_insn program[] = {
    ...
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RDI, HC_X86_RDX, 0, 0, 1, 0, 2064), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_RCX, HC_X86_RDX, 12), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x112f: xor    eax,eax [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RAX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORL),
    ...
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RSI, HC_X86_RDX, HC_X86_RAX, 3, 16), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RDI, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x114b: popcnt rdi,rdi [exact-kop: popcntq kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RDI, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_POPCNTQ),
    ...
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RCX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    HC_KOP(HC_X86_STORE_PAYLOAD(HC_X86_RCX, HC_X86_RDX, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ),
