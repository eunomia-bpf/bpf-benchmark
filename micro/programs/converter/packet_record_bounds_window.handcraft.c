...
static const struct bpf_insn program[] = {
    ...
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_RDI, 768), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RCX, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x115c: movzx  r9d,WORD PTR [rsi-0x1] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_R9, HC_X86_RSI, -1), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    /* 0x1161: lea    ecx,[rax*4+0x0] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RCX, 0, HC_X86_RAX, 2, 0, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x1168: and    cl,0x1c [exact-kop: andb imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RCX, 28), MICRO_HANDCRAFT_BPF_X86_ANDB),
    ...
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    ...
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x1193: or     r9,r10 [exact-kop: or64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x1196: add    r8,0x8 [exact-kop: add64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R8, 8), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_R10, HC_X86_RSI, -23), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x11a9: and    r10d,0x3 [exact-kop: and32 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R10, 3), MICRO_HANDCRAFT_BPF_X86_ANDL),
    /* 0x11ad: lea    rax,[r10+0x18] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RAX, HC_X86_R10, 0, 0, 1, 0, 24), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_RAW(BPF_JMP | BPF_JLT | BPF_X, BPF_REG_6, BPF_REG_7, (-16) - 1, 0),
    /* 0x11b6: movzx  eax,BYTE PTR [rsi-0x16] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_RAX, HC_X86_RSI, -22), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x11ba: mov    ebx,DWORD PTR [rsi-0x13] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_RBX, HC_X86_RSI, -19), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11bd: mov    r14d,DWORD PTR [rsi-0xf] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_R14, HC_X86_RSI, -15), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_R11, HC_X86_RSI, -3), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    /* 0x11c9: add    rbx,r9 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RBX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_RBX, HC_X86_RSI, -7), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RCX, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_ORQ),
