...
static const struct bpf_insn program[] = {
    ...
    HC_KOP(HC_LEA_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RCX, 0, 0, 1, 0, 120), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RDI, HC_X86_RCX, 8), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1130: movzx  edx,BYTE PTR [rcx+0x70] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RDX, HC_X86_RCX, 112), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KOP(HC_X86_CMP_ARCH_MEM_IMM_PAYLOAD(HC_X86_RCX, 119, 1), MICRO_HANDCRAFT_BPF_X86_CMPB),
    /* 0x1168: mov    r8d,0x8 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R8, 8), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R8, 1), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R8, 2), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R8, 3), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R8, 4), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R8, 5), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R8, 6), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RSI, HC_X86_RCX, 12), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_7, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_LEA_ARCH_PAYLOAD(HC_X86_R10, HC_X86_RSI, 0, 0, 1, 0, 3), MICRO_HANDCRAFT_BPF_X86_LEAL),
    ...
    HC_KOP(HC_LEA_ARCH_PAYLOAD(HC_X86_R11, HC_X86_RSI, HC_X86_R8, 0, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KOP(HC_X86_ARCH_SIB_PAYLOAD(HC_X86_R11, HC_X86_RCX, HC_X86_R8, 0, 16), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1221: xor    r11b,dl [exact-kop: xorb reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R11, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_XORB),
    ...
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RBX, HC_X86_RCX, 113), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x122d: xor    bl,BYTE PTR [rcx+r8*1+0x11] [exact-kop: xorb SIB memory-source kop] */
    HC_KOP(HC_X86_ARCH_SIB_PAYLOAD(HC_X86_RBX, HC_X86_RCX, HC_X86_R8, 0, 17), MICRO_HANDCRAFT_BPF_X86_XORB),
    /* 0x1232: or     r11b,bl [exact-kop: orb reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(HC_X86_R11, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_ORB),
    ...
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RBX, HC_X86_RCX, 114), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x123e: xor    bl,BYTE PTR [rcx+r8*1+0x12] [exact-kop: xorb SIB memory-source kop] */
    HC_KOP(HC_X86_ARCH_SIB_PAYLOAD(HC_X86_RBX, HC_X86_RCX, HC_X86_R8, 0, 18), MICRO_HANDCRAFT_BPF_X86_XORB),
    ...
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RBX, HC_X86_RCX, 115), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x124f: xor    bl,BYTE PTR [rcx+r8*1+0x13] [exact-kop: xorb SIB memory-source kop] */
    HC_KOP(HC_X86_ARCH_SIB_PAYLOAD(HC_X86_RBX, HC_X86_RCX, HC_X86_R8, 0, 19), MICRO_HANDCRAFT_BPF_X86_XORB),
    ...
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RBX, HC_X86_RCX, 116), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1260: xor    bl,BYTE PTR [rcx+r8*1+0x14] [exact-kop: xorb SIB memory-source kop] */
    HC_KOP(HC_X86_ARCH_SIB_PAYLOAD(HC_X86_RBX, HC_X86_RCX, HC_X86_R8, 0, 20), MICRO_HANDCRAFT_BPF_X86_XORB),
    ...
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RBX, HC_X86_RCX, 117), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1271: xor    bl,BYTE PTR [rcx+r8*1+0x15] [exact-kop: xorb SIB memory-source kop] */
    HC_KOP(HC_X86_ARCH_SIB_PAYLOAD(HC_X86_RBX, HC_X86_RCX, HC_X86_R8, 0, 21), MICRO_HANDCRAFT_BPF_X86_XORB),
    ...
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RBX, HC_X86_RCX, 118), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1286: xor    bl,BYTE PTR [rcx+r8*1+0x16] [exact-kop: xorb SIB memory-source kop] */
    HC_KOP(HC_X86_ARCH_SIB_PAYLOAD(HC_X86_RBX, HC_X86_RCX, HC_X86_R8, 0, 22), MICRO_HANDCRAFT_BPF_X86_XORB),
    ...
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RBX, HC_X86_RCX, 119), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x129b: xor    bl,BYTE PTR [rcx+r8*1+0x17] [exact-kop: xorb SIB memory-source kop] */
    HC_KOP(HC_X86_ARCH_SIB_PAYLOAD(HC_X86_RBX, HC_X86_RCX, HC_X86_R8, 0, 23), MICRO_HANDCRAFT_BPF_X86_XORB),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RSI, 32), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    ...
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 3), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    ...
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x12bf: mov    QWORD PTR [rcx],rax [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_STORE_PAYLOAD(HC_X86_RAX, HC_X86_RCX, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ),
