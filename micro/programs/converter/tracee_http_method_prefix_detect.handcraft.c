...
static const struct bpf_insn program[] = {
    ...
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RSI, HC_X86_RDX, 0, 0, 1, 0, 144), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x1133: lea    rax,[rdx+0x16] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RAX, HC_X86_RDX, 0, 0, 1, 0, 22), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x1141: mov    ecx,0x1 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_RCX, 1), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1146: cs nop WORD PTR [rax+rax*1+0x0] [padding: prefixed nop padding is not part of BPF semantics] */
    /* 0x1150: mov    rsi,rbx [exact-kop: mov64 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RSI, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1153: movzx  edi,BYTE PTR [rax-0x6] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_RDI, HC_X86_RAX, -6), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1157: movzx  r8d,BYTE PTR [rax-0x5] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_R8, HC_X86_RAX, -5), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_MOV64_REG(BPF_REG_6, HC_X86_RDI),
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_6, 0, (56) - 1, 68),
    ...
    HC_MOV64_REG(BPF_REG_6, HC_X86_RDI),
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_6, 0, (157) - 1, 71),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, (154) - 1, 69),
    /* 0x117d: mov    r8b,0x45 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R8, 69), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, (148) - 1, 84),
    /* 0x118a: mov    r10b,0x45 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R10, 69), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, (142) - 1, 32),
    /* 0x1197: mov    r9d,0x1 [exact-kop: mov32 immediate kop] */
    ...
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (113) - 1, 0),
    /* 0x11a2: data16 data16 data16 data16 cs nop WORD PTR [rax+rax*1+0x0] [padding: padding is not part of BPF semantics] */
    /* 0x11b0: movzx  r9d,r8b [exact-kop: movzx r32,r8 kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R9, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_MOV64_REG(BPF_REG_6, HC_X86_RDI),
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_6, 0, (66) - 1, 72),
    ...
    HC_MOV64_REG(BPF_REG_6, HC_X86_RDI),
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_6, 0, (133) - 1, 80),
    ...
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_6, 0, (90) - 1, 85),
    ...
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RBX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_6, 0, (127) - 1, 79),
    /* 0x11da: mov    r8b,0x4f [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R8, 79), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    HC_LDX(BPF_B, BPF_REG_6, BPF_REG_6, -4),
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, (121) - 1, 83),
    ...
    HC_LDX(BPF_B, BPF_REG_6, BPF_REG_6, -3),
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, (117) - 1, 84),
    /* 0x11f1: mov    r10b,0x4f [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R10, 79), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, (111) - 1, 32),
    /* 0x11fe: mov    r9d,0x2 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R9, 2), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1204: mov    r8b,0x53 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R8, 83), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1207: mov    r11b,0x54 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R11, 84), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    HC_MOV64_REG(BPF_REG_6, HC_X86_R8),
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, (101) - 1, 69),
    /* 0x1219: mov    r8b,0x45 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R8, 69), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    HC_LDX(BPF_B, BPF_REG_6, BPF_REG_6, -4),
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, (95) - 1, 76),
    ...
    HC_LDX(BPF_B, BPF_REG_6, BPF_REG_6, -3),
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, (91) - 1, 69),
    ...
    HC_LDX(BPF_B, BPF_REG_6, BPF_REG_6, -2),
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, (87) - 1, 84),
    ...
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, (83) - 1, 69),
    /* 0x1244: mov    r11b,0x45 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R11, 69), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, (77) - 1, 32),
    /* 0x1250: mov    r9d,0x4 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R9, 4), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1256: mov    r8b,0x4c [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R8, 76), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1259: mov    r10b,0x45 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R10, 69), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RBX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_6, 0, (46) - 1, 84),
    ...
    /* 0x126d: mov    r8b,0x45 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R8, 69), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    /* 0x127c: mov    r10b,0x45 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R10, 69), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    /* 0x1285: mov    r9d,0x5 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R9, 5), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x128b: mov    r8b,0x41 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R8, 65), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x128e: mov    r11b,0x44 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R11, 68), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    /* 0x1293: mov    r8b,0x55 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R8, 85), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    /* 0x129c: mov    r10b,0x55 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R10, 85), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    /* 0x12a5: mov    r9d,0x3 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R9, 3), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12ab: mov    r8b,0x54 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R8, 84), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x12ae: mov    r11b,0x20 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R11, 32), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    /* 0x12b3: mov    r8b,0x54 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R8, 84), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    /* 0x12c8: mov    r9d,0x6 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R9, 6), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12ce: mov    r11b,0x50 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R11, 80), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x12d1: mov    r10b,0x54 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R10, 84), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    /* 0x12e0: mov    r10d,r8d [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R10, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12e3: movzx  r8d,BYTE PTR [rax-0x4] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_R8, HC_X86_RAX, -4), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x12e8: movzx  r11d,BYTE PTR [rax-0x3] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_R11, HC_X86_RAX, -3), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x12ed: xor    r9d,r9d [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x12f0: movzx  r11d,r11b [exact-kop: movzx r32,r8 kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R11, HC_X86_R11), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x12f4: lea    ebx,[r9+0x1] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RBX, HC_X86_R9, 0, 0, 1, 0, 1), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x12f8: lea    r14,[rcx+0xa] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_R14, HC_X86_RCX, 0, 0, 1, 0, 10), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x12fc: imul   rbx,r14 [exact-kop: imulq reg,reg kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RBX, HC_X86_R14), MICRO_HANDCRAFT_BPF_X86_IMULQ),
    /* 0x1300: add    rsi,rbx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RSI, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1303: shl    r11,0x20 [exact-kop: shl64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R11, 32), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x1307: movzx  r8d,r8b [exact-kop: movzx r32,r8 kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R8, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x130b: shl    r8d,0x18 [exact-kop: shl32 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R8, 24), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x130f: movzx  r10d,r10b [exact-kop: movzx r32,r8 kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R10, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1313: shl    r10d,0x10 [exact-kop: shl32 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R10, 16), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x1317: shl    edi,0x8 [exact-kop: shl32 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDI, 8), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x131a: or     edi,r10d [exact-kop: or32 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RDI, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_ORL),
    /* 0x131d: or     edi,r8d [exact-kop: or32 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RDI, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_ORL),
    /* 0x1320: or     rdi,r11 [exact-kop: or64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RDI, HC_X86_R11), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x1323: mov    ebx,r9d [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RBX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1326: or     rbx,rdi [exact-kop: or64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RBX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x1329: shl    rbx,cl [exact-kop: shl64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RBX, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x132c: xor    rbx,rsi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RBX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x132f: add    rax,0x10 [exact-kop: add64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RAX, 16), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1333: inc    rcx [exact-kop: incq reg kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_RCX, 0), MICRO_HANDCRAFT_BPF_X86_INCQ),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, (-217) - 1, 9),
    /* 0x1340: mov    BYTE PTR [rdx],sil [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(HC_X86_RSI, HC_X86_RDX, 0), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1343: mov    BYTE PTR [rdx+0x1],bh [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_BYTE_PAYLOAD(HC_X86_RBX, HC_X86_RDX, 1, 1), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1346: mov    eax,ebx [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RAX, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1348: shr    eax,0x10 [exact-kop: shr32 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RAX, 16), MICRO_HANDCRAFT_BPF_X86_SHRL),
    /* 0x134b: mov    BYTE PTR [rdx+0x2],al [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(HC_X86_RAX, HC_X86_RDX, 2), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x134e: mov    eax,ebx [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RAX, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1350: shr    eax,0x18 [exact-kop: shr32 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RAX, 24), MICRO_HANDCRAFT_BPF_X86_SHRL),
    /* 0x1353: mov    BYTE PTR [rdx+0x3],al [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(HC_X86_RAX, HC_X86_RDX, 3), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1356: mov    rax,rbx [exact-kop: mov64 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RAX, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1359: shr    rax,0x20 [exact-kop: shr64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x135d: mov    BYTE PTR [rdx+0x4],al [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(HC_X86_RAX, HC_X86_RDX, 4), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1360: mov    rax,rbx [exact-kop: mov64 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RAX, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1363: shr    rax,0x28 [exact-kop: shr64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RAX, 40), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x1367: mov    BYTE PTR [rdx+0x5],al [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(HC_X86_RAX, HC_X86_RDX, 5), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x136a: mov    rax,rbx [exact-kop: mov64 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RAX, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x136d: shr    rax,0x30 [exact-kop: shr64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RAX, 48), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x1371: mov    BYTE PTR [rdx+0x6],al [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(HC_X86_RAX, HC_X86_RDX, 6), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1374: shr    rbx,0x38 [exact-kop: shr64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RBX, 56), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x1378: mov    BYTE PTR [rdx+0x7],bl [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(HC_X86_RBX, HC_X86_RDX, 7), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x137b: mov    eax,0x2 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_RAX, 2), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1380: pop    rbx [exact-kop: popq kop] */
    HC_KOP(HC_X86_RBX, MICRO_HANDCRAFT_BPF_X86_POPQ),
    /* 0x1381: pop    r14 [exact-kop: popq kop] */
