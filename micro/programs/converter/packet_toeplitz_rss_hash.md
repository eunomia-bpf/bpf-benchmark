...
static const struct bpf_insn program[] = {
    ...
    HC_KOP(HC_LEA_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RSI, 0, 0, 1, 0, 62), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RCX, HC_X86_RSI, 20), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    ...
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RCX, HC_X86_RSI, 22), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1138: and    cl,0xf [exact-kop: andb imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(HC_X86_RCX, 15), MICRO_HANDCRAFT_BPF_X86_ANDB),
    ...
    HC_KOP(HC_LEA_ARCH_PAYLOAD(HC_X86_R8, HC_X86_RSI, 0, 0, 1, 0, 34), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x114e: xor    eax,eax [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1150: xor    r9d,r9d [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R11, 194), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RDX, 8), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1162: sub    dl,cl [exact-kop: sub8 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_SUBB),
    ...
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R11, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_SHRL),
    /* 0x1169: or     r10d,r11d [exact-kop: or32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R10, HC_X86_R11), MICRO_HANDCRAFT_BPF_X86_ORL),
    ...
    HC_KOP(HC_REG_PAYLOAD(HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_INCL),
    ...
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RCX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RCX, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11a5: movzx  r10d,BYTE PTR [rcx] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_R10, HC_X86_RCX, 0), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x11a9: mov    ecx,r9d [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RCX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11ac: and    ecx,0x7 [exact-kop: and32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RCX, 7), MICRO_HANDCRAFT_BPF_X86_ANDL),
    /* 0x11af: shl    r10d,cl [exact-kop: shl32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R10, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_SHLL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R11, 67), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11d5: mov    r10d,0x67253d00 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R10, 1730493696), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R11, 37), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11f8: mov    r10d,0x5a56da00 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R10, 1515641344), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R10, 3259066112), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R10, 626724352), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R11, 143), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1248: mov    r10d,0x3d43a300 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R10, 1027842816), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R11, 103), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1256: mov    r10d,0xec24100 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R10, 247611648), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R11, 218), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1264: mov    r10d,0x6d5a5600 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R10, 1834636800), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R11, 14), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1272: mov    r10d,0xda255b00 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R10, 3659881216), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R11, 61), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1280: mov    r10d,0x41672500 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R10, 1097278720), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R11, 163), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x128e: mov    r10d,0x253d4300 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R10, 624771840), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R11, 176), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x129c: mov    r10d,0x43a38f00 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R10, 1134792448), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R11, 91), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12aa: mov    r10d,0x56da2500 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R10, 1457136896), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R11, 65), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12b8: mov    r10d,0x5b0ec200 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R10, 1527693824), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R11, 208), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RDX, HC_X86_RSI, 38), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x138c: movzx  ecx,BYTE PTR [rsi+0x2a] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RCX, HC_X86_RSI, 42), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1390: movzx  r8d,BYTE PTR [rsi+0x2b] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_R8, HC_X86_RSI, 43), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1395: movzx  r9d,BYTE PTR [rsi+0x2c] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_R9, HC_X86_RSI, 44), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x139a: movzx  r10d,BYTE PTR [rsi+0x2d] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_R10, HC_X86_RSI, 45), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x139f: mov    r11,rax [exact-kop: mov64 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R11, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x13a2: shl    r11,0x20 [exact-kop: shl64 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R11, 32), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x13a6: xor    edx,DWORD PTR [rsi+0x22] [exact-kop: xor32 memory-source kop] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RDX, HC_X86_RSI, 34), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x13a9: bswap  edx [exact-kop: bswap32 kop] */
    HC_KOP(HC_REG_PAYLOAD(HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_BSWAPL),
    ...
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R8, 48), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x13ba: or     r8,rcx [exact-kop: or64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x13bd: shl    r9,0x28 [exact-kop: shl64 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R9, 40), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x13c1: or     r9,r8 [exact-kop: or64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_ORQ),
    ...
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x13cb: or     rdx,r10 [exact-kop: or64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_ORQ),
    ...
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x13e1: or     rdx,r8 [exact-kop: or64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_ORQ),
    ...
    HC_KOP(HC_X86_ARCH_STORE_PAYLOAD(HC_X86_RDX, HC_X86_RSI, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ),
