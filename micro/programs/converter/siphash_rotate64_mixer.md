...
static const struct bpf_insn program[] = {
    ...
    HC_KOP(HC_LEA_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RCX, 0, 0, 1, 0, 72), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x112c: mov    r9,QWORD PTR [rcx+0x8] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_R9, HC_X86_RCX, 8), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KOP(HC_X86_BPF_TO_ARCH_RR_PAYLOAD(HC_X86_RDI, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x113a: xor    rdi,r9 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    HC_KOP(HC_X86_BPF_TO_ARCH_RR_PAYLOAD(HC_X86_RDX, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1147: add    rdx,rdi [exact-kop: add64 reg kop] */
    ...
    /* 0x1154: add    rax,rdi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1157: rol    rdi,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDI, HC_X86_RDI, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x115b: xor    rdi,rdx [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    /* 0x1168: add    r8,rdi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x116b: rol    rdi,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDI, HC_X86_RDI, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    ...
    HC_KOP(HC_X86_BPF_TO_ARCH_RR_PAYLOAD(HC_X86_RDX, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1179: xor    rdx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x117c: rol    rax,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1180: xor    rdi,r8 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1183: add    r8,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1186: rol    rdx,0xd [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x118a: xor    rdx,r8 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x118d: rol    r8,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R8, HC_X86_R8, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1191: add    rax,rdi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1194: rol    rdi,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDI, HC_X86_RDI, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1198: xor    rdi,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x119b: add    r8,rdi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x119e: rol    rdi,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDI, HC_X86_RDI, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x11a2: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11a5: rol    rdx,0x11 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x11a9: mov    rsi,QWORD PTR [rcx+0x10] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RSI, HC_X86_RCX, 16), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x11ad: xor    rdx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x11b0: rol    rax,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x11b4: xor    r9,r8 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x11b7: add    r9,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11ba: rol    rdx,0xd [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x11be: xor    r8,rsi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x11c1: xor    rdx,r9 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x11c4: rol    r9,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R9, HC_X86_R9, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x11c8: xor    r8,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x11cb: add    rax,r8 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11ce: rol    r8,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R8, HC_X86_R8, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x11d2: xor    r8,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x11d5: add    r9,r8 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11d8: rol    r8,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R8, HC_X86_R8, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x11dc: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11df: rol    rdx,0x11 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x11e3: xor    rdx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x11e6: rol    rax,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x11ea: xor    r8,r9 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x11ed: add    r9,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11f0: rol    rdx,0xd [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x11f4: xor    rdx,r9 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x11f7: rol    r9,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R9, HC_X86_R9, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x11fb: add    rax,r8 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11fe: rol    r8,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R8, HC_X86_R8, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1202: xor    r8,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1205: add    r9,r8 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1208: rol    r8,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R8, HC_X86_R8, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x120c: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x120f: rol    rdx,0x11 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1213: mov    rdi,QWORD PTR [rcx+0x18] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RDI, HC_X86_RCX, 24), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1217: xor    rdx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x121a: rol    rax,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x121e: xor    rsi,r9 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1221: add    rsi,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1224: rol    rdx,0xd [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1228: xor    r9,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x122b: xor    rdx,rsi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x122e: rol    rsi,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1232: xor    r9,r8 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1235: add    rax,r9 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1238: rol    r9,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R9, HC_X86_R9, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x123c: xor    r9,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x123f: add    rsi,r9 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1242: rol    r9,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R9, HC_X86_R9, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1246: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1249: rol    rdx,0x11 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x124d: xor    rdx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1250: rol    rax,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1254: xor    r9,rsi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1257: add    rsi,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x125a: rol    rdx,0xd [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x125e: xor    rdx,rsi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1261: rol    rsi,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1265: add    rax,r9 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1268: rol    r9,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R9, HC_X86_R9, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x126c: xor    r9,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x126f: add    rsi,r9 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1272: rol    r9,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R9, HC_X86_R9, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1276: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1279: rol    rdx,0x11 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x127d: mov    r8,QWORD PTR [rcx+0x20] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_R8, HC_X86_RCX, 32), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1281: xor    rdx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1284: rol    rax,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1288: xor    rdi,rsi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x128b: add    rdi,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x128e: rol    rdx,0xd [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1292: xor    rsi,r8 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1295: xor    rdx,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1298: rol    rdi,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDI, HC_X86_RDI, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x129c: xor    rsi,r9 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x129f: add    rax,rsi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x12a2: rol    rsi,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x12a6: xor    rsi,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x12a9: add    rdi,rsi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x12ac: rol    rsi,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x12b0: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x12b3: rol    rdx,0x11 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x12b7: xor    rdx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x12ba: rol    rax,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x12be: xor    rsi,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x12c1: add    rdi,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x12c4: rol    rdx,0xd [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x12c8: xor    rdx,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x12cb: rol    rdi,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDI, HC_X86_RDI, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x12cf: add    rax,rsi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x12d2: rol    rsi,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x12d6: xor    rsi,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x12d9: add    rdi,rsi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x12dc: rol    rsi,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x12e0: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x12e3: rol    rdx,0x11 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x12e7: mov    r9,QWORD PTR [rcx+0x28] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_R9, HC_X86_RCX, 40), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x12eb: xor    rdx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x12ee: rol    rax,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x12f2: xor    r8,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x12f5: add    r8,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x12f8: rol    rdx,0xd [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x12fc: xor    rdi,r9 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x12ff: xor    rdx,r8 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1302: rol    r8,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R8, HC_X86_R8, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1306: xor    rdi,rsi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1309: add    rax,rdi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x130c: rol    rdi,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDI, HC_X86_RDI, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1310: xor    rdi,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1313: add    r8,rdi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1316: rol    rdi,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDI, HC_X86_RDI, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x131a: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x131d: rol    rdx,0x11 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1321: xor    rdx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1324: rol    rax,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1328: xor    rdi,r8 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x132b: add    r8,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x132e: rol    rdx,0xd [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1332: xor    rdx,r8 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1335: rol    r8,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R8, HC_X86_R8, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1339: add    rax,rdi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x133c: rol    rdi,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDI, HC_X86_RDI, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1340: xor    rdi,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1343: add    r8,rdi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1346: rol    rdi,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDI, HC_X86_RDI, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x134a: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x134d: rol    rdx,0x11 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1351: mov    rsi,QWORD PTR [rcx+0x30] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RSI, HC_X86_RCX, 48), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1355: xor    rdx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1358: rol    rax,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x135c: xor    r9,r8 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x135f: add    r9,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1362: rol    rdx,0xd [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1366: xor    r8,rsi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1369: xor    rdx,r9 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x136c: rol    r9,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R9, HC_X86_R9, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1370: xor    r8,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1373: add    rax,r8 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1376: rol    r8,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R8, HC_X86_R8, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x137a: xor    r8,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x137d: add    r9,r8 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1380: rol    r8,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R8, HC_X86_R8, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1384: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1387: rol    rdx,0x11 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x138b: xor    rdx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x138e: rol    rax,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1392: xor    r8,r9 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1395: add    r9,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1398: rol    rdx,0xd [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x139c: xor    rdx,r9 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x139f: rol    r9,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R9, HC_X86_R9, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x13a3: add    rax,r8 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x13a6: rol    r8,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R8, HC_X86_R8, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x13aa: xor    r8,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x13ad: add    r9,r8 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x13b0: rol    r8,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R8, HC_X86_R8, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x13b4: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x13b7: rol    rdx,0x11 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x13bb: mov    rdi,QWORD PTR [rcx+0x38] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RDI, HC_X86_RCX, 56), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x13bf: xor    rdx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x13c2: rol    rax,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x13c6: xor    rsi,r9 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x13c9: add    rsi,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x13cc: rol    rdx,0xd [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x13d0: xor    r9,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x13d3: xor    rdx,rsi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x13d6: rol    rsi,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x13da: xor    r9,r8 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x13dd: add    rax,r9 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x13e0: rol    r9,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R9, HC_X86_R9, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x13e4: xor    r9,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x13e7: add    rsi,r9 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x13ea: rol    r9,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R9, HC_X86_R9, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x13ee: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x13f1: rol    rdx,0x11 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x13f5: xor    rdx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x13f8: rol    rax,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x13fc: xor    r9,rsi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x13ff: add    rsi,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1402: rol    rdx,0xd [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1406: xor    rdx,rsi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1409: rol    rsi,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x140d: add    rax,r9 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1410: rol    r9,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R9, HC_X86_R9, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1414: xor    r9,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1417: add    rsi,r9 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x141a: rol    r9,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R9, HC_X86_R9, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x141e: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1421: rol    rdx,0x11 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1425: mov    r8,QWORD PTR [rcx+0x40] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_R8, HC_X86_RCX, 64), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1429: xor    rdx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x142c: rol    rax,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1430: xor    rdi,rsi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1433: add    rdi,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1436: rol    rdx,0xd [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x143a: xor    rsi,r8 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x143d: xor    rdx,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1440: rol    rdi,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDI, HC_X86_RDI, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1444: xor    rsi,r9 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1447: add    rax,rsi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x144a: rol    rsi,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x144e: xor    rsi,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1451: add    rdi,rsi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1454: rol    rsi,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1458: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x145b: rol    rdx,0x11 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x145f: xor    rdx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1462: rol    rax,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1466: xor    rsi,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1469: add    rdi,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x146c: rol    rdx,0xd [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1470: xor    rdx,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1473: rol    rdi,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDI, HC_X86_RDI, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1477: add    rax,rsi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x147a: rol    rsi,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x147e: xor    rsi,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1481: add    rdi,rsi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1484: rol    rsi,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1488: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x148b: rol    rdx,0x11 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x148f: xor    rsi,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1492: xor    rdx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1495: rol    rax,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1499: xor    rdi,r8 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x149c: add    rdi,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x149f: rol    rdx,0xd [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x14a3: xor    rdx,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x14a6: rol    rdi,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDI, HC_X86_RDI, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x14aa: xor    rax,0xff [exact-kop: xor64 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RAX, 255), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x14b0: add    rax,rsi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x14b3: rol    rsi,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x14b7: xor    rsi,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x14ba: add    rdi,rsi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x14bd: rol    rsi,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x14c1: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x14c4: rol    rdx,0x11 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x14c8: xor    rdx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x14cb: rol    rax,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x14cf: xor    rsi,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x14d2: add    rdi,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x14d5: rol    rdx,0xd [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x14d9: xor    rdx,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x14dc: rol    rdi,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDI, HC_X86_RDI, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x14e0: add    rax,rsi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x14e3: rol    rsi,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x14e7: xor    rsi,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x14ea: add    rdi,rsi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x14ed: rol    rsi,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x14f1: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x14f4: rol    rdx,0x11 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x14f8: xor    rdx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x14fb: rol    rax,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x14ff: xor    rsi,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1502: add    rdi,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1505: rol    rdx,0xd [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1509: xor    rdx,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x150c: rol    rdi,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDI, HC_X86_RDI, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1510: add    rax,rsi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1513: rol    rsi,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1517: xor    rsi,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x151a: add    rdi,rsi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x151d: rol    rsi,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1521: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1524: rol    rdx,0x11 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1528: xor    rdx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x152b: rol    rax,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x152f: xor    rsi,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1532: add    rdi,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1535: rol    rdx,0xd [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1539: add    rax,rsi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x153c: rol    rsi,0x10 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1540: xor    rsi,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1543: rol    rsi,0x15 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1547: xor    rdx,rdi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x154a: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x154d: rol    rdx,0x11 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1551: mov    rdi,rax [exact-kop: mov64 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1554: rol    rdi,0x20 [exact-kop: rolq imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RDI, HC_X86_RDI, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1558: xor    rdi,rdx [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x155b: xor    rdi,rsi [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x155e: xor    rdi,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1561: mov    QWORD PTR [rcx],rdi [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_STORE_PAYLOAD(HC_X86_RDI, HC_X86_RCX, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1564: mov    eax,0x2 [exact-kop: mov32 immediate kop] */
