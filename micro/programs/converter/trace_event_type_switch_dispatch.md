...
static const struct bpf_insn program[] = {
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_1, BPF_REG_4, 0, 0, 1, 0, 524), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x112d: mov    edx,0xf [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_3, 15), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1132: xor    ebx,ebx [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(BPF_REG_6, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_XORL),
    ...
    /* 0x1136: mov    ebx,0xc [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 12), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(BPF_REG_6, BPF_REG_0), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    /* 0x1154: mov    rax,rbx [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_0, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1157: mov    esi,DWORD PTR [rcx+rdx*1-0x3] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(BPF_REG_2, BPF_REG_4, BPF_REG_3, 0, -3), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1180: mov    ebx,0x38 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 56), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1192: mov    ebx,0x2b [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 43), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x11d2: mov    ebx,0x27 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 39), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x120d: mov    ebx,0x3e [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 62), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1278: mov    ebx,0x3f [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 63), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x12a6: mov    ebx,0x32 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 50), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x12d4: mov    ebx,0x1a [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 26), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1302: mov    ebx,0x36 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 54), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1327: mov    ebx,0x3d [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 61), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x134c: mov    ebx,0x4 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 4), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1371: mov    ebx,0x15 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 21), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1396: mov    ebx,0x14 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 20), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x13bb: mov    ebx,0x2a [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 42), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x13e0: mov    ebx,0x2c [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 44), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1405: mov    ebx,0x1f [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 31), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x142a: mov    ebx,0x5 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 5), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1446: mov    ebx,0x1c [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 28), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1462: mov    ebx,0x1b [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 27), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x147e: mov    ebx,0x6 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 6), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x149a: mov    ebx,0x3 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 3), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x14b6: mov    ebx,0x24 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 36), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x14d2: mov    ebx,0x23 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 35), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x14ee: mov    ebx,0x29 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 41), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x150a: mov    ebx,0x10 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 16), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1526: mov    ebx,0x3a [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 58), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1542: mov    ebx,0x30 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 48), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x155e: mov    ebx,0x28 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 40), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x157a: mov    ebx,0x12 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 18), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1596: mov    ebx,0x2e [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 46), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x15b2: mov    ebx,0x3b [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 59), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x15ce: mov    ebx,0x34 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 52), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x15ea: mov    ebx,0x37 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 55), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x15f4: mov    ebx,0x19 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 25), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x15fe: mov    ebx,0x22 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 34), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1608: mov    ebx,0x2d [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 45), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1612: mov    ebx,0x2 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 2), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x161c: mov    ebx,0x20 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 32), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1626: mov    ebx,0x26 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 38), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1630: mov    ebx,0x1 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 1), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x163a: mov    ebx,0xe [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 14), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1644: mov    ebx,0x35 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 53), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x164e: mov    ebx,0x1d [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 29), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1658: mov    ebx,0xd [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 13), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1662: mov    ebx,0x13 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 19), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x166c: mov    ebx,0x8 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 8), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1676: mov    ebx,0x21 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 33), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1680: mov    ebx,0x3c [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 60), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x168a: mov    ebx,0x39 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 57), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1694: mov    ebx,0xb [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 11), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x169e: mov    ebx,0x2f [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 47), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x16a8: mov    ebx,0x9 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x16b2: mov    ebx,0x31 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 49), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x16bc: mov    ebx,0x7 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 7), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x16c6: mov    ebx,0x11 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 17), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x16d0: mov    ebx,0x16 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 22), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x16da: mov    ebx,0xa [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 10), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x16e4: mov    ebx,0x18 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 24), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x16ee: mov    ebx,0xf [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 15), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x16f8: mov    ebx,0x1e [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 30), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1702: mov    ebx,0x25 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 37), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x170c: mov    ebx,0x33 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 51), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1716: mov    ebx,0x17 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 23), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x1720: mov    ebx,0x1bf52 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_6, 114514), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_STORE_PAYLOAD(BPF_REG_6, BPF_REG_4, 0), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x172c: mov    BYTE PTR [rcx+0x1],bh [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_BYTE_PAYLOAD(BPF_REG_6, BPF_REG_4, 1, 1), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x172f: shr    ebx,0x10 [exact-kop: shr32 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_6, 16), MICRO_HANDCRAFT_BPF_X86_SHRL),
    /* 0x1732: mov    BYTE PTR [rcx+0x2],bl [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(BPF_REG_6, BPF_REG_4, 2), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1735: mov    edx,eax [exact-kop: movl register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_3, BPF_REG_0), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1737: shr    edx,0x18 [exact-kop: shr32 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_3, 24), MICRO_HANDCRAFT_BPF_X86_SHRL),
    /* 0x173a: mov    BYTE PTR [rcx+0x3],dl [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(BPF_REG_3, BPF_REG_4, 3), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x173d: mov    rdx,rax [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_3, BPF_REG_0), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1740: shr    rdx,0x20 [exact-kop: shr64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_3, 32), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x1744: mov    BYTE PTR [rcx+0x4],dl [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(BPF_REG_3, BPF_REG_4, 4), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1747: mov    rdx,rax [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_3, BPF_REG_0), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x174a: shr    rdx,0x28 [exact-kop: shr64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_3, 40), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x174e: mov    BYTE PTR [rcx+0x5],dl [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(BPF_REG_3, BPF_REG_4, 5), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1751: mov    rdx,rax [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_3, BPF_REG_0), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1754: shr    rdx,0x30 [exact-kop: shr64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_3, 48), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x1758: mov    BYTE PTR [rcx+0x6],dl [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(BPF_REG_3, BPF_REG_4, 6), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x175b: shr    rax,0x38 [exact-kop: shr64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_0, 56), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x175f: mov    BYTE PTR [rcx+0x7],al [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(BPF_REG_0, BPF_REG_4, 7), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1762: mov    eax,0x2 [exact-kop: movl immediate kop] */
