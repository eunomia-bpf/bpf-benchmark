...
static const struct bpf_insn program[] = {
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_3, BPF_REG_2, 0, 0, 1, 0, 592), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_1, BPF_REG_2, 0, 0, 1, 0, 39), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x1153: mov    r10d,0x8 [exact-kop: movl immediate kop] */
    ...
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(BPF_REG_0, BPF_REG_3), MICRO_HANDCRAFT_BPF_X86_ORQ),
    ...
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_1, 24), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_STX(BPF_DW, BPF_REG_10, BPF_REG_6, -376),
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_6, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KOP(HC_X86_MEM_PAYLOAD(BPF_REG_3, BPF_REG_1, -23), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x117f: mov    r14d,DWORD PTR [rdi-0xf] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_MEM_PAYLOAD(BPF_REG_8, BPF_REG_1, -15), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1183: mov    r15d,DWORD PTR [rdi-0xb] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_MEM_PAYLOAD(BPF_REG_9, BPF_REG_1, -11), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1187: movzx  ebp,WORD PTR [rdi-0x7] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_RBP, BPF_REG_1, -7), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    /* 0x118b: movzx  eax,WORD PTR [rdi-0x5] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_MEM_PAYLOAD(BPF_REG_0, BPF_REG_1, -5), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    /* 0x118f: mov    ebx,DWORD PTR [rdi-0x3] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_MEM_PAYLOAD(BPF_REG_6, BPF_REG_1, -3), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x11a0: mov    ecx,0x35 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_4, 53), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x11ba: mov    ecx,0x89 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_4, 137), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x11ca: mov    ecx,0x21 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_4, 33), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x11da: mov    ecx,0x55 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_4, 85), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RBP, 1), MICRO_HANDCRAFT_BPF_X86_TESTB),
    /* 0x11fd: mov    r12d,r15d [exact-kop: movl register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R12, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1200: cmove  r12d,r10d [exact-kop: cmov kop using module shadow flags] */
    HC_KOP(HC_CMOV_STACK_PAYLOAD(HC_X86_R12, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_CMOVEL),
    /* 0x1204: add    r12d,r14d [exact-kop: add32 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_R12, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_ADDL),
    /* 0x1207: add    r8,r12 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(BPF_REG_5, HC_X86_R12), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x120a: mov    r12,rbx [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R12, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(BPF_REG_4, HC_X86_R12), MICRO_HANDCRAFT_BPF_X86_ORQ),
    ...
    HC_STX(BPF_DW, BPF_REG_10, BPF_REG_6, -376),
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(BPF_REG_6, HC_X86_RBP), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_LDX(BPF_DW, BPF_REG_6, BPF_REG_10, -376),
    /* 0x1222: mov    ecx,eax [exact-kop: movl register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_4, BPF_REG_0), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1224: rol    rdx,cl [exact-kop: rolq cl kop] */
    HC_KOP(HC_ROTATE_CL_PAYLOAD(BPF_REG_3, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1227: mov    eax,r15d [exact-kop: movl register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_0, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x122a: shl    rax,0x18 [exact-kop: shl64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_0, 24), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x122e: mov    ecx,r14d [exact-kop: movl register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_4, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1231: xor    rcx,rax [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(BPF_REG_4, BPF_REG_0), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1234: test   bpl,0x4 [exact-kop: testb imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RBP, 4), MICRO_HANDCRAFT_BPF_X86_TESTB),
    /* 0x1238: mov    eax,0x0 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_0, 0), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x123d: cmovne rax,rcx [exact-kop: cmov kop using module shadow flags] */
    HC_KOP(HC_CMOV_STACK_PAYLOAD(BPF_REG_0, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_CMOVNEQ),
    /* 0x1241: add    rax,rdx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(BPF_REG_0, BPF_REG_3), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1244: mov    edx,r9d [exact-kop: movl register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_3, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x124d: mov    r14,rax [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_8, BPF_REG_0), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1250: shl    r14,cl [exact-kop: shl64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(BPF_REG_8, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x1253: not    dl [exact-kop: notb reg kop] */
    HC_KOP(HC_NOT_NARROW_PAYLOAD(BPF_REG_3), MICRO_HANDCRAFT_BPF_X86_NOTB),
    /* 0x1255: mov    ecx,edx [exact-kop: movl register-to-register kop] */
    ...
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(BPF_REG_0, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x125d: add    rax,r11 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(BPF_REG_0, HC_X86_R11), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1260: movzx  ecx,bp [exact-kop: movzx r32,r16 kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(BPF_REG_4, HC_X86_RBP), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    /* 0x1263: shl    rcx,0x28 [exact-kop: shl64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_4, 40), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x1267: or     rbx,rcx [exact-kop: or64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(BPF_REG_6, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x126a: mov    r11,rbx [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R11, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KOP(HC_X86_STORE_PAYLOAD(HC_X86_R11, BPF_REG_2, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1275: mov    eax,0x2 [exact-kop: movl immediate kop] */
