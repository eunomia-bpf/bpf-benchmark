...
static const struct bpf_insn program[] = {
    ...
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RSI, HC_X86_RCX, 0, 0, 1, 0, 400), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x1130: xor    eax,eax [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RAX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1132: xor    edx,edx [exact-kop: xor32 reg kop] */
    ...
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RSI, HC_X86_RCX, HC_X86_RAX, 3, 272), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KOP(HC_SETCC_PAYLOAD(HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_SETE),
    /* 0x115f: cmove  rdi,r8 [exact-kop: cmov kop using module shadow flags] */
    HC_KOP(HC_CMOV_PAYLOAD(HC_X86_RDI, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_CMOVEQ),
    /* 0x1163: or     r9b,r10b [exact-kop: orb reg kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R9, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_ORB),
    /* 0x1166: test   r10b,0x1 [exact-kop: testb imm kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R10, 1), MICRO_HANDCRAFT_BPF_X86_TESTB),
    /* 0x116a: cmovne rdi,r11 [exact-kop: cmov kop using module shadow flags] */
    HC_KOP(HC_CMOV_PAYLOAD(HC_X86_RDI, HC_X86_R11), MICRO_HANDCRAFT_BPF_X86_CMOVNEQ),
    ...
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RSI, 32), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R9, 1), MICRO_HANDCRAFT_BPF_X86_TESTB),
    /* 0x1185: cmovne rdx,rdi [exact-kop: cmov kop using module shadow flags] */
    HC_KOP(HC_CMOV_PAYLOAD(HC_X86_RDX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_CMOVNEQ),
