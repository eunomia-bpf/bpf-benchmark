...
static const struct bpf_insn program[] = {
    ...
    /* 0x1118: lea    rdi,[rdx+0x410] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_ARCH_PAYLOAD(HC_X86_RDI, HC_X86_RDX, 0, 0, 1, 0, 1040), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x112f: push   rbx [exact-kop: pushq kop] */
    ...
    /* 0x113a: xor    esi,esi [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x113c: xor    edi,edi [exact-kop: xor32 reg kop] */
    ...
    /* 0x1140: mov    ecx,edi [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RCX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1142: and    cl,0x7 [exact-kop: andb imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(HC_X86_RCX, 7), MICRO_HANDCRAFT_BPF_X86_ANDB),
    /* 0x1145: shr    r10,cl [exact-kop: shr64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R10, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x1148: xor    r9,r10 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x114b: add    r9,r11 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R11), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x114e: mov    ecx,esi [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RCX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1150: and    cl,0x18 [exact-kop: andb imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(HC_X86_RCX, 24), MICRO_HANDCRAFT_BPF_X86_ANDB),
    /* 0x1153: mov    r8,rax [exact-kop: mov64 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1156: shl    r8,cl [exact-kop: shl64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x1159: xor    r8,r9 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x115c: and    al,0x7 [exact-kop: andb imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(HC_X86_RAX, 7), MICRO_HANDCRAFT_BPF_X86_ANDB),
    /* 0x115e: lea    ecx,[rax+0x1] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_ARCH_PAYLOAD(HC_X86_RCX, HC_X86_RAX, 0, 0, 1, 0, 1), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x1161: mov    rbx,r8 [exact-kop: mov64 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RBX, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1164: shl    rbx,cl [exact-kop: shl64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RBX, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x1167: not    al [exact-kop: not8 reg kop] */
    HC_KOP(HC_NOT_NARROW_PAYLOAD(HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_NOTB),
    /* 0x1169: mov    ecx,eax [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RCX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x116b: shr    r8,cl [exact-kop: shr64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x116e: or     r8,rbx [exact-kop: or64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x1171: inc    rdi [exact-kop: incq reg kop] */
    HC_KOP(HC_REG_PAYLOAD(HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_INCQ),
    /* 0x1174: add    rsi,0x8 [exact-kop: add64 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RSI, 8), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_6, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_6, 0, (40) - 1, 32),
    /* 0x117e: mov    r10,QWORD PTR [rdx+rsi*4+0x20] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_ARCH_SIB_PAYLOAD(HC_X86_R10, HC_X86_RDX, HC_X86_RSI, 2, 32), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1183: mov    rcx,QWORD PTR [rdx+rsi*4+0x18] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_ARCH_SIB_PAYLOAD(HC_X86_RCX, HC_X86_RDX, HC_X86_RSI, 2, 24), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1188: add    rcx,r10 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RCX, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x118b: mov    eax,DWORD PTR [rdx+rsi*4+0x28] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_ARCH_SIB_PAYLOAD(HC_X86_RAX, HC_X86_RDX, HC_X86_RSI, 2, 40), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x118f: shl    rax,0x20 [exact-kop: shl64 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x1193: mov    r9d,DWORD PTR [rdx+rsi*4+0x2c] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_ARCH_SIB_PAYLOAD(HC_X86_R9, HC_X86_RDX, HC_X86_RSI, 2, 44), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1198: or     r9,rax [exact-kop: or64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x119b: mov    eax,DWORD PTR [rdx+rsi*4+0x10] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_ARCH_SIB_PAYLOAD(HC_X86_RAX, HC_X86_RDX, HC_X86_RSI, 2, 16), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x119f: mov    r11,rax [exact-kop: mov64 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R11, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x11a2: shl    r11,0x10 [exact-kop: shl64 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R11, 16), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x11a6: movzx  ebx,WORD PTR [rdx+rsi*4+0x14] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_ARCH_SIB_PAYLOAD(HC_X86_RBX, HC_X86_RDX, HC_X86_RSI, 2, 20), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    /* 0x11ab: or     r11,rbx [exact-kop: or64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R11, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x11ae: xor    r11,rcx [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R11, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x11b1: add    r11,r8 [exact-kop: add64 reg kop] */
    ...
    /* 0x11b9: movzx  ecx,WORD PTR [rdx+rsi*4+0x16] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_ARCH_SIB_PAYLOAD(HC_X86_RCX, HC_X86_RDX, HC_X86_RSI, 2, 22), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    /* 0x11be: add    r9,rcx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11c1: xor    r9,r11 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R11), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x11c4: jmp    114e <flow_record_field_scan_xdp+0x4e> [exact-bpf: native jmp maps to ordinary BPF JA] */
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (-71) - 1, 0),
    /* 0x11c6: mov    BYTE PTR [rdx],r8b [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_STORE_PAYLOAD(HC_X86_R8, HC_X86_RDX, 0), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x11c9: mov    BYTE PTR [rdx+0x1],bh [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_STORE_BYTE_PAYLOAD(HC_X86_RBX, HC_X86_RDX, 1, 1), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x11cc: mov    eax,ebx [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11ce: shr    eax,0x10 [exact-kop: shr32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RAX, 16), MICRO_HANDCRAFT_BPF_X86_SHRL),
    /* 0x11d1: mov    BYTE PTR [rdx+0x2],al [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_STORE_PAYLOAD(HC_X86_RAX, HC_X86_RDX, 2), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x11d4: mov    eax,ebx [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11d6: shr    eax,0x18 [exact-kop: shr32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RAX, 24), MICRO_HANDCRAFT_BPF_X86_SHRL),
    /* 0x11d9: mov    BYTE PTR [rdx+0x3],al [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_STORE_PAYLOAD(HC_X86_RAX, HC_X86_RDX, 3), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x11dc: mov    rax,rbx [exact-kop: mov64 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x11df: shr    rax,0x20 [exact-kop: shr64 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x11e3: mov    BYTE PTR [rdx+0x4],al [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_STORE_PAYLOAD(HC_X86_RAX, HC_X86_RDX, 4), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x11e6: mov    rax,rbx [exact-kop: mov64 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x11e9: shr    rax,0x28 [exact-kop: shr64 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RAX, 40), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x11ed: mov    BYTE PTR [rdx+0x5],al [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_STORE_PAYLOAD(HC_X86_RAX, HC_X86_RDX, 5), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x11f0: mov    rax,rbx [exact-kop: mov64 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x11f3: shr    rax,0x30 [exact-kop: shr64 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RAX, 48), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x11f7: mov    BYTE PTR [rdx+0x6],al [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_STORE_PAYLOAD(HC_X86_RAX, HC_X86_RDX, 6), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x11fa: shr    rbx,0x38 [exact-kop: shr64 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RBX, 56), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x11fe: mov    BYTE PTR [rdx+0x7],bl [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_STORE_PAYLOAD(HC_X86_RBX, HC_X86_RDX, 7), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1201: mov    eax,0x2 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RAX, 2), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1206: pop    rbx [exact-kop: popq kop] */
