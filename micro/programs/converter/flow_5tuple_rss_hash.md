...
static const struct bpf_insn program[] = {
    ...
    /* 0x110c: ja     130f <flow_5tuple_rss_hash_xdp+0x20f> [exact-bpf: ja as ordinary BPF branch] */
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_6, BPF_REG_7, (301) - 1, 0),
    ...
    /* 0x1119: ja     130f <flow_5tuple_rss_hash_xdp+0x20f> [exact-bpf: ja as ordinary BPF branch] */
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_6, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_7, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_6, BPF_REG_7, (294) - 1, 0),
    /* 0x111f: lea    rsi,[rcx+0x16] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RCX, 0, 0, 1, 0, 22), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x1123: cmp    rsi,rdx [control-flow-operand: cmp folded into BPF branch] */
    /* 0x1126: ja     130f <flow_5tuple_rss_hash_xdp+0x20f> [exact-bpf: ja as ordinary BPF branch] */
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_6, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_7, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_6, BPF_REG_7, (287) - 1, 0),
    /* 0x112c: push   rbp [exact-kop: pushq kop] */
    HC_KOP(HC_REG_PAYLOAD(HC_X86_RBP), MICRO_HANDCRAFT_BPF_X86_PUSHQ),
    /* 0x112d: mov    rbp,rsp [exact-kop: movq frame-register kop] */
    HC_KOP(HC_X86_FRAME_PAYLOAD(HC_X86_RBP, HC_X86_RSP), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1130: push   r15 [exact-kop: pushq kop] */
    HC_KOP(HC_REG_PAYLOAD(HC_X86_R15), MICRO_HANDCRAFT_BPF_X86_PUSHQ),
    /* 0x1132: push   r14 [exact-kop: pushq kop] */
    HC_KOP(HC_REG_PAYLOAD(HC_X86_R14), MICRO_HANDCRAFT_BPF_X86_PUSHQ),
    /* 0x1134: push   r12 [exact-kop: pushq kop] */
    HC_KOP(HC_REG_PAYLOAD(HC_X86_R12), MICRO_HANDCRAFT_BPF_X86_PUSHQ),
    /* 0x1136: push   rbx [exact-kop: pushq kop] */
    HC_KOP(HC_REG_PAYLOAD(HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_PUSHQ),
    /* 0x1137: movzx  edi,WORD PTR [rcx+0x14] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RDI, HC_X86_RCX, 20), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    /* 0x113b: rol    di,0x8 [exact-kop: rolw imm8 kop] */
    HC_KOP(HC_REG_IMM_ARCH_PAYLOAD(HC_X86_RDI, 8), MICRO_HANDCRAFT_BPF_X86_ROLW),
    /* 0x113f: movzx  edi,di [exact-kop: movzx r32,r16 kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    /* 0x1142: cmp    edi,0x800 [control-flow-operand: cmp folded into BPF branch] */
    /* 0x1148: jne    1307 <flow_5tuple_rss_hash_xdp+0x207> [exact-bpf: jne as ordinary BPF branch] */
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_6, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_MOVL),
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_6, 0, (256) - 1, 2048),
    /* 0x114e: lea    rdi,[rcx+0x2a] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_ARCH_PAYLOAD(HC_X86_RDI, HC_X86_RCX, 0, 0, 1, 0, 42), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x1152: cmp    rdi,rdx [control-flow-operand: cmp folded into BPF branch] */
    /* 0x1155: ja     1307 <flow_5tuple_rss_hash_xdp+0x207> [exact-bpf: ja as ordinary BPF branch] */
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_6, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_7, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_6, BPF_REG_7, (249) - 1, 0),
    /* 0x115b: movzx  edi,BYTE PTR [rsi] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RDI, HC_X86_RSI, 0), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x115e: mov    r8d,edi [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1161: and    r8b,0xf0 [exact-kop: andb imm kop] */
    HC_KOP(HC_REG_IMM_PAYLOAD(HC_X86_R8, 240), MICRO_HANDCRAFT_BPF_X86_ANDB),
    /* 0x1165: cmp    r8b,0x40 [control-flow-operand: cmp folded into BPF branch] */
    /* 0x1169: jne    1307 <flow_5tuple_rss_hash_xdp+0x207> [exact-bpf: jne as ordinary BPF branch] */
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_6, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, (239) - 1, 64),
    /* 0x116f: and    edi,0xf [exact-kop: and32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RDI, 15), MICRO_HANDCRAFT_BPF_X86_ANDL),
    /* 0x1172: cmp    dil,0x5 [control-flow-operand: cmp folded into BPF branch] */
    /* 0x1176: jb     1307 <flow_5tuple_rss_hash_xdp+0x207> [exact-bpf: jb as ordinary BPF branch] */
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_6, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_RAW(BPF_JMP | BPF_JLT | BPF_K, BPF_REG_6, 0, (233) - 1, 5),
    /* 0x117c: lea    rsi,[rsi+rdi*4] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_ARCH_PAYLOAD(HC_X86_RSI, HC_X86_RSI, HC_X86_RDI, 2, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x1180: cmp    rsi,rdx [control-flow-operand: cmp folded into BPF branch] */
    /* 0x1183: ja     1307 <flow_5tuple_rss_hash_xdp+0x207> [exact-bpf: ja as ordinary BPF branch] */
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_6, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_7, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_6, BPF_REG_7, (226) - 1, 0),
    /* 0x1189: movzx  r11d,BYTE PTR [rcx+0x18] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_R11, HC_X86_RCX, 24), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x118e: movzx  edi,BYTE PTR [rcx+0x19] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RDI, HC_X86_RCX, 25), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1192: movzx  ebx,BYTE PTR [rcx+0x1f] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RBX, HC_X86_RCX, 31), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1196: cmp    ebx,0x11 [control-flow-operand: cmp folded into BPF branch] */
    /* 0x1199: je     11a4 <flow_5tuple_rss_hash_xdp+0xa4> [exact-bpf: je as ordinary BPF branch] */
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_6, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_6, 0, (4) - 1, 17),
    /* 0x119b: cmp    ebx,0x6 [control-flow-operand: cmp folded into BPF branch] */
    /* 0x119e: jne    1307 <flow_5tuple_rss_hash_xdp+0x207> [exact-bpf: jne as ordinary BPF branch] */
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_6, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_6, 0, (214) - 1, 6),
    /* 0x11a4: lea    r8,[rsi+0x4] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_ARCH_PAYLOAD(HC_X86_R8, HC_X86_RSI, 0, 0, 1, 0, 4), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x11a8: cmp    r8,rdx [control-flow-operand: cmp folded into BPF branch] */
    /* 0x11ab: ja     1307 <flow_5tuple_rss_hash_xdp+0x207> [exact-bpf: ja as ordinary BPF branch] */
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_6, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_7, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_6, BPF_REG_7, (207) - 1, 0),
    /* 0x11b1: mov    eax,r11d [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_R11), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11b4: shl    eax,0x8 [exact-kop: shl32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RAX, 8), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x11b7: or     eax,edi [exact-kop: or32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_ORL),
    /* 0x11b9: mov    r8d,DWORD PTR [rcx+0x22] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_R8, HC_X86_RCX, 34), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11bd: mov    r10d,DWORD PTR [rcx+0x26] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_R10, HC_X86_RCX, 38), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11c1: bswap  r10d [exact-kop: bswap32 kop] */
    HC_KOP(HC_REG_PAYLOAD(HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_BSWAPL),
    /* 0x11c4: bswap  r8d [exact-kop: bswap32 kop] */
    HC_KOP(HC_REG_PAYLOAD(HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_BSWAPL),
    /* 0x11c7: movzx  edx,WORD PTR [rsi] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RDX, HC_X86_RSI, 0), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    /* 0x11ca: movzx  edi,WORD PTR [rsi+0x2] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RDI, HC_X86_RSI, 2), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    /* 0x11ce: rol    dx,0x8 [exact-kop: rolw imm8 kop] */
    HC_KOP(HC_REG_IMM_ARCH_PAYLOAD(HC_X86_RDX, 8), MICRO_HANDCRAFT_BPF_X86_ROLW),
    /* 0x11d2: movzx  esi,dx [exact-kop: movzx r32,r16 kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    /* 0x11d5: rol    di,0x8 [exact-kop: rolw imm8 kop] */
    HC_KOP(HC_REG_IMM_ARCH_PAYLOAD(HC_X86_RDI, 8), MICRO_HANDCRAFT_BPF_X86_ROLW),
    /* 0x11d9: movzx  edi,di [exact-kop: movzx r32,r16 kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDI, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    /* 0x11dc: lea    r9d,[rax+r8*1] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_ARCH_PAYLOAD(HC_X86_R9, HC_X86_RAX, HC_X86_R8, 0, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x11e0: lea    r14d,[r10-0x61c88647] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_ARCH_PAYLOAD(HC_X86_R14, HC_X86_R10, 0, 0, 1, 0, -1640531527), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x11e7: mov    edx,esi [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11e9: shl    edx,0x10 [exact-kop: shl32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RDX, 16), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x11ec: or     edx,edi [exact-kop: or32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_ORL),
    /* 0x11ee: lea    r12d,[rbx+rdx*1] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_ARCH_PAYLOAD(HC_X86_R12, HC_X86_RBX, HC_X86_RDX, 0, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x11f2: lea    r15d,[rbx+rdx*1] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_ARCH_PAYLOAD(HC_X86_R15, HC_X86_RBX, HC_X86_RDX, 0, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x11f6: add    r15d,0x12345678 [exact-kop: add32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R15, 305419896), MICRO_HANDCRAFT_BPF_X86_ADDL),
    /* 0x11fd: sub    r9d,r15d [exact-kop: sub32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R15), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x1200: add    r9d,0xdeadbeef [exact-kop: add32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R9, -559038737), MICRO_HANDCRAFT_BPF_X86_ADDL),
    /* 0x1207: rol    r15d,0x4 [exact-kop: roll imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R15, HC_X86_R15, 4), MICRO_HANDCRAFT_BPF_X86_ROLL),
    /* 0x120b: xor    r15d,r9d [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R15, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x120e: lea    r9d,[r10+r12*1] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_ARCH_PAYLOAD(HC_X86_R9, HC_X86_R10, HC_X86_R12, 0, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x1212: add    r9d,0xb06bd031 [exact-kop: add32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R9, -1335111631), MICRO_HANDCRAFT_BPF_X86_ADDL),
    /* 0x1219: mov    r12d,r15d [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R12, HC_X86_R15), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x121c: rol    r12d,0x6 [exact-kop: roll imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R12, HC_X86_R12, 6), MICRO_HANDCRAFT_BPF_X86_ROLL),
    /* 0x1220: sub    r14d,r15d [exact-kop: sub32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R14, HC_X86_R15), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x1223: xor    r12d,r14d [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R12, HC_X86_R14), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1226: add    r15d,r9d [exact-kop: add32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R15, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_ADDL),
    /* 0x1229: sub    r9d,r12d [exact-kop: sub32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R12), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x122c: mov    r14d,r12d [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R14, HC_X86_R12), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x122f: rol    r14d,0x8 [exact-kop: roll imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R14, HC_X86_R14, 8), MICRO_HANDCRAFT_BPF_X86_ROLL),
    /* 0x1233: xor    r14d,r9d [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R14, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1236: add    r12d,r15d [exact-kop: add32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R12, HC_X86_R15), MICRO_HANDCRAFT_BPF_X86_ADDL),
    /* 0x1239: mov    r9d,r14d [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R14), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x123c: rol    r9d,0x10 [exact-kop: roll imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R9, HC_X86_R9, 16), MICRO_HANDCRAFT_BPF_X86_ROLL),
    /* 0x1240: sub    r15d,r14d [exact-kop: sub32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R15, HC_X86_R14), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x1243: xor    r9d,r15d [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R15), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1246: add    r14d,r12d [exact-kop: add32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R14, HC_X86_R12), MICRO_HANDCRAFT_BPF_X86_ADDL),
    /* 0x1249: sub    r12d,r9d [exact-kop: sub32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R12, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x124c: mov    r15d,r9d [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R15, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x124f: rol    r15d,0x13 [exact-kop: roll imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R15, HC_X86_R15, 19), MICRO_HANDCRAFT_BPF_X86_ROLL),
    /* 0x1253: xor    r15d,r12d [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R15, HC_X86_R12), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1256: add    r9d,r14d [exact-kop: add32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R14), MICRO_HANDCRAFT_BPF_X86_ADDL),
    /* 0x1259: xor    r8d,r10d [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x125c: rol    r8d,0x7 [exact-kop: roll imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R8, HC_X86_R8, 7), MICRO_HANDCRAFT_BPF_X86_ROLL),
    /* 0x1260: sub    r14d,r15d [exact-kop: sub32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R14, HC_X86_R15), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x1263: add    r8d,r9d [exact-kop: add32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_ADDL),
    /* 0x1266: add    r9d,edx [exact-kop: add32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDL),
    /* 0x1269: add    r9d,r15d [exact-kop: add32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R15), MICRO_HANDCRAFT_BPF_X86_ADDL),
    /* 0x126c: rol    r15d,0x4 [exact-kop: roll imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R15, HC_X86_R15, 4), MICRO_HANDCRAFT_BPF_X86_ROLL),
    /* 0x1270: xor    r15d,r14d [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R15, HC_X86_R14), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1273: mov    edx,ebx [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1275: shl    edx,0x18 [exact-kop: shl32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RDX, 24), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x1278: or     edx,eax [exact-kop: or32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_ORL),
    /* 0x127a: add    edx,r15d [exact-kop: add32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_R15), MICRO_HANDCRAFT_BPF_X86_ADDL),
    /* 0x127d: xor    edx,r9d [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1280: mov    r10d,r9d [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R10, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1283: rol    r10d,0xe [exact-kop: roll imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R10, HC_X86_R10, 14), MICRO_HANDCRAFT_BPF_X86_ROLL),
    /* 0x1287: sub    edx,r10d [exact-kop: sub32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x128a: mov    r10d,edx [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R10, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x128d: rol    r10d,0xb [exact-kop: roll imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R10, HC_X86_R10, 11), MICRO_HANDCRAFT_BPF_X86_ROLL),
    /* 0x1291: xor    r8d,edx [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1294: sub    r8d,r10d [exact-kop: sub32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x1297: xor    r9d,r8d [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x129a: mov    r10d,r8d [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R10, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x129d: rol    r10d,0x19 [exact-kop: roll imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R10, HC_X86_R10, 25), MICRO_HANDCRAFT_BPF_X86_ROLL),
    /* 0x12a1: sub    r9d,r10d [exact-kop: sub32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x12a4: xor    edx,r9d [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x12a7: mov    r10d,r9d [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R10, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12aa: rol    r10d,0x10 [exact-kop: roll imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R10, HC_X86_R10, 16), MICRO_HANDCRAFT_BPF_X86_ROLL),
    /* 0x12ae: sub    edx,r10d [exact-kop: sub32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x12b1: xor    r8d,edx [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x12b4: mov    r10d,edx [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R10, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12b7: rol    r10d,0x4 [exact-kop: roll imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R10, HC_X86_R10, 4), MICRO_HANDCRAFT_BPF_X86_ROLL),
    /* 0x12bb: sub    r8d,r10d [exact-kop: sub32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x12be: xor    r9d,r8d [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x12c1: rol    r8d,0xe [exact-kop: roll imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R8, HC_X86_R8, 14), MICRO_HANDCRAFT_BPF_X86_ROLL),
    /* 0x12c5: sub    r9d,r8d [exact-kop: sub32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R9, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x12c8: xor    edx,r9d [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x12cb: rol    r9d,0x18 [exact-kop: roll imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_R9, HC_X86_R9, 24), MICRO_HANDCRAFT_BPF_X86_ROLL),
    /* 0x12cf: sub    edx,r9d [exact-kop: sub32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x12d2: shl    eax,0x10 [exact-kop: shl32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RAX, 16), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x12d5: shl    esi,0x8 [exact-kop: shl32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RSI, 8), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x12d8: or     ebx,esi [exact-kop: or32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RBX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_ORL),
    /* 0x12da: xor    ebx,edi [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RBX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x12dc: xor    esi,eax [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RSI, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x12de: mov    BYTE PTR [rcx],bl [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_STORE_PAYLOAD(HC_X86_RBX, HC_X86_RCX, 0), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x12e0: mov    BYTE PTR [rcx+0x1],bh [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_STORE_BYTE_PAYLOAD(HC_X86_RBX, HC_X86_RCX, 1, 1), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x12e3: shr    esi,0x10 [exact-kop: shr32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RSI, 16), MICRO_HANDCRAFT_BPF_X86_SHRL),
    /* 0x12e6: mov    BYTE PTR [rcx+0x2],sil [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_STORE_PAYLOAD(HC_X86_RSI, HC_X86_RCX, 2), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x12ea: mov    BYTE PTR [rcx+0x3],r11b [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_STORE_PAYLOAD(HC_X86_R11, HC_X86_RCX, 3), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x12ee: mov    BYTE PTR [rcx+0x4],dl [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_STORE_PAYLOAD(HC_X86_RDX, HC_X86_RCX, 4), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x12f1: mov    BYTE PTR [rcx+0x5],dh [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_STORE_BYTE_PAYLOAD(HC_X86_RDX, HC_X86_RCX, 5, 1), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x12f4: mov    eax,edx [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12f6: shr    eax,0x10 [exact-kop: shr32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RAX, 16), MICRO_HANDCRAFT_BPF_X86_SHRL),
    /* 0x12f9: mov    BYTE PTR [rcx+0x6],al [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_STORE_PAYLOAD(HC_X86_RAX, HC_X86_RCX, 6), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x12fc: shr    edx,0x18 [exact-kop: shr32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RDX, 24), MICRO_HANDCRAFT_BPF_X86_SHRL),
    /* 0x12ff: mov    BYTE PTR [rcx+0x7],dl [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_STORE_PAYLOAD(HC_X86_RDX, HC_X86_RCX, 7), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1302: mov    eax,0x2 [exact-kop: mov32 immediate kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RAX, 2), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1307: pop    rbx [exact-kop: popq kop] */
    HC_KOP(HC_REG_PAYLOAD(HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_POPQ),
    /* 0x1308: pop    r12 [exact-kop: popq kop] */
    HC_KOP(HC_REG_PAYLOAD(HC_X86_R12), MICRO_HANDCRAFT_BPF_X86_POPQ),
    /* 0x130a: pop    r14 [exact-kop: popq kop] */
    HC_KOP(HC_REG_PAYLOAD(HC_X86_R14), MICRO_HANDCRAFT_BPF_X86_POPQ),
    /* 0x130c: pop    r15 [exact-kop: popq kop] */
    HC_KOP(HC_REG_PAYLOAD(HC_X86_R15), MICRO_HANDCRAFT_BPF_X86_POPQ),
    /* 0x130e: pop    rbp [exact-kop: popq kop] */
    HC_KOP(HC_REG_PAYLOAD(HC_X86_RBP), MICRO_HANDCRAFT_BPF_X86_POPQ),
    /* 0x130f: ret [abi-boundary: native ret materializes x86 rax to BPF r0 then exits] */
