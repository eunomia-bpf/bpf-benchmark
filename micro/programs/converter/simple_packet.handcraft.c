...
static const struct bpf_insn program[] = {
    ...
    /* 0x1117: mov    WORD PTR [rcx],0x614e [exact-kop: mov immediate memory store via x86 kop selector] */
    ...
    /* 0x1120: mov    DWORD PTR [rcx+0x3],0x0 [exact-kop: mov immediate memory store via x86 kop selector] */
    ...
    /* 0x112b: mov    eax,0x2 [exact-kop: mov32 immediate kop] */
