...
static const struct bpf_insn program[] = {
    ...
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_ORQ),
    ...
    HC_KOP(HC_REG_PAYLOAD(HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_INCQ),
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_6, 0, (150) - 1, 32),
    /* 0x116d: movzx  eax,WORD PTR [rsi-0x5] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RAX, HC_X86_RSI, -5), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    ...
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_6, 0, (10) - 1, 8079),
    ...
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_6, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_6, 0, (27) - 1, 80),
    ...
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_6, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_6, 0, (13) - 1, 443),
    ...
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_6, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_6, 0, (4) - 1, 8080),
    ...
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RCX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_MOVSWL),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RCX, 30000), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x11b2: setge  r9b [exact-kop: setcc kop using module shadow flags] */
    HC_KOP(HC_SETCC_STACK_PAYLOAD(HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_SETGE),
    /* 0x11b6: shl    r9d,0x2 [exact-kop: shl32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R9, 2), MICRO_HANDCRAFT_BPF_X86_SHLL),
    ...
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RBX, HC_X86_RSI, -23), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11d3: movzx  ecx,BYTE PTR [rsi-0x3] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RCX, HC_X86_RSI, -3), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_6, 0, (-57) - 1, 2),
    /* 0x11e0: mov    r10d,DWORD PTR [rsi-0x13] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_R10, HC_X86_RSI, -19), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11e4: movzx  ebp,BYTE PTR [rsi-0x2] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RBP, HC_X86_RSI, -2), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KOP(HC_X86_ARCH_TO_BPF_RR_PAYLOAD(BPF_REG_6, HC_X86_RBP), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_R14, HC_X86_RSI, -7), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1203: movzx  r15d,BYTE PTR [rsi-0x6] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_R15, HC_X86_RSI, -6), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1208: rol    ecx,0x7 [exact-kop: roll imm kop] */
    HC_KOP(HC_ROTATE_ARCH_PAYLOAD(HC_X86_RCX, HC_X86_RCX, 7), MICRO_HANDCRAFT_BPF_X86_ROLL),
    /* 0x120b: xor    ecx,DWORD PTR [rsi-0xf] [exact-kop: xor32 memory-source kop] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_RCX, HC_X86_RSI, -15), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x120e: movzx  r11d,WORD PTR [rsi-0x1] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_MEM_PAYLOAD(HC_X86_R11, HC_X86_RSI, -1), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    /* 0x1213: shl    r15d,0x18 [exact-kop: shl32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R15, 24), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x1217: shl    r14d,0x10 [exact-kop: shl32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R14, 16), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x121b: or     r14d,r15d [exact-kop: or32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R14, HC_X86_R15), MICRO_HANDCRAFT_BPF_X86_ORL),
    ...
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_R14), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1224: xor    eax,ecx [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1226: mov    ecx,ebp [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RCX, HC_X86_RBP), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1228: shl    ecx,0x1e [exact-kop: shl32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RCX, 30), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x122b: sar    ecx,0x1f [exact-kop: sar32 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RCX, 31), MICRO_HANDCRAFT_BPF_X86_SARL),
    /* 0x122e: lea    r14d,[r10+rbx*1] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_ARCH_PAYLOAD(HC_X86_R14, HC_X86_R10, HC_X86_RBX, 0, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x1232: and    r14d,ecx [exact-kop: and32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R14, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_ANDL),
    /* 0x1235: xor    r14d,r11d [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R14, HC_X86_R11), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1238: xor    r14d,eax [exact-kop: xor32 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R14, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x123b: lea    ecx,[r9+0x3] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_ARCH_PAYLOAD(HC_X86_RCX, HC_X86_R9, 0, 0, 1, 0, 3), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x123f: mov    eax,r14d [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_R14), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1242: rol    eax,cl [exact-kop: roll cl kop] */
    HC_KOP(HC_ROTATE_ARCH_CL_PAYLOAD(HC_X86_RAX, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_ROLL),
    /* 0x1244: test   bpl,0x4 [exact-kop: testb imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RBP, 4), MICRO_HANDCRAFT_BPF_X86_TESTB),
    /* 0x1248: cmove  eax,r14d [exact-kop: cmov kop using module shadow flags] */
    HC_KOP(HC_CMOV_ARCH_STACK_PAYLOAD(HC_X86_RAX, HC_X86_R14), MICRO_HANDCRAFT_BPF_X86_CMOVEL),
    /* 0x124c: shl    rax,0x20 [exact-kop: shl64 imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x1250: mov    ebx,ebx [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RBX, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R14, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    ...
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RBX, HC_X86_R14), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x126c: xor    rbx,r8 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RBX, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_R11, 16), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x1277: or     r11,r9 [exact-kop: or64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R11, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x127a: mov    r8d,r10d [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x127d: xor    r8,r11 [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_R11), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1280: add    r8,rbx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_RBX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R10, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x1297: add    r8,r10 [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R8, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x129a: jmp    115c <bcc_tcpconnect_ipv4_tuple_filter_xdp+0x5c> [exact-bpf: native jmp maps to ordinary BPF JA] */
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (-155) - 1, 0),
    /* 0x129f: mov    QWORD PTR [rdx],r8 [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_ARCH_STORE_PAYLOAD(HC_X86_R8, HC_X86_RDX, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ),
