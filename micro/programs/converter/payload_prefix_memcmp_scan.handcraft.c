...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_LEA_PAYLOAD(HC_X86_RDI, HC_X86_RCX, 0, 0, 1, 0, 204), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RDX, 29), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x112b: mov    dil,0x4 [exact-kinsn: mov8 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RDI, 4), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    HC_KINSN(HC_X86_SIB_PAYLOAD(HC_X86_RSI, HC_X86_RCX, HC_X86_RAX, 0, 12), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1135: lea    r9d,[rdx-0x1d] [exact-kinsn: LEA via x86 kinsn selector] */
    HC_KINSN(HC_LEA_PAYLOAD(HC_X86_R9, HC_X86_RDX, 0, 0, 1, 0, -29), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x1139: lea    r8d,[rdi-0x4] [exact-kinsn: LEA via x86 kinsn selector] */
    HC_KINSN(HC_LEA_PAYLOAD(HC_X86_R8, HC_X86_RDI, 0, 0, 1, 0, -4), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x113d: xor    r8b,r9b [exact-kinsn: xorb reg kinsn] */
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_R8, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORB),
    /* 0x1140: xor    r8b,0xa5 [exact-kinsn: xorb imm kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_R8, 165), MICRO_HANDCRAFT_BPF_X86_XORB),
    /* 0x1144: add    r8b,0x11 [exact-kinsn: add8 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R8, 17), MICRO_HANDCRAFT_BPF_X86_ADDB),
    ...
    HC_KINSN(HC_X86_SIB_PAYLOAD(HC_X86_RSI, HC_X86_RCX, HC_X86_RAX, 0, 13), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1152: mov    r8d,edx [exact-kinsn: mov32 register-to-register kinsn] */
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_R8, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1155: xor    r8b,dil [exact-kinsn: xorb reg kinsn] */
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_R8, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORB),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RAX, 2), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDX, 58), MICRO_HANDCRAFT_BPF_X86_ADDB),
    /* 0x116c: add    dil,0x8 [exact-kinsn: add8 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDI, 8), MICRO_HANDCRAFT_BPF_X86_ADDB),
    ...
    HC_KINSN(HC_X86_MEM_PAYLOAD(HC_X86_RAX, HC_X86_RCX, 75), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_RAX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x118b: lea    rax,[rax+rax*4] [exact-kinsn: LEA via x86 kinsn selector] */
    HC_KINSN(HC_LEA_PAYLOAD(HC_X86_RAX, HC_X86_RAX, HC_X86_RAX, 2, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_RAX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x11a0: xor    rax,rdx [exact-kinsn: xor64 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x11a3: movzx  edx,r8b [exact-kinsn: movzx r32,r8 kinsn] */
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_RDX, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RSI, 29), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    HC_KINSN(HC_X86_SIB_PAYLOAD(HC_X86_R8, HC_X86_RCX, HC_X86_RAX, 0, 76), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x11c6: lea    r10d,[rsi-0x1d] [exact-kinsn: LEA via x86 kinsn selector] */
    HC_KINSN(HC_LEA_PAYLOAD(HC_X86_R10, HC_X86_RSI, 0, 0, 1, 0, -29), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x11ca: lea    r9d,[rdi-0x4] [exact-kinsn: LEA via x86 kinsn selector] */
    HC_KINSN(HC_LEA_PAYLOAD(HC_X86_R9, HC_X86_RDI, 0, 0, 1, 0, -4), MICRO_HANDCRAFT_BPF_X86_LEAL),
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_R13, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_ALU64_IMM(BPF_AND, BPF_REG_7, 0xff),
    ...
    HC_KINSN(HC_X86_SIB_PAYLOAD(HC_X86_R8, HC_X86_RCX, HC_X86_RAX, 0, 77), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x11e4: mov    r9d,esi [exact-kinsn: mov32 register-to-register kinsn] */
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_R9, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11e7: xor    r9b,dil [exact-kinsn: xorb reg kinsn] */
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_R9, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORB),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RSI, 58), MICRO_HANDCRAFT_BPF_X86_ADDB),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_RDX, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1216: movzx  eax,BYTE PTR [rcx+0x8b] [exact-kinsn: direct memory load via x86 kinsn selector] */
    HC_KINSN(HC_X86_MEM_PAYLOAD(HC_X86_RAX, HC_X86_RCX, 139), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_LEA_PAYLOAD(HC_X86_RAX, HC_X86_RAX, HC_X86_RAX, 1, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x122b: lea    rax,[rdx+rax*2] [exact-kinsn: LEA via x86 kinsn selector] */
    HC_KINSN(HC_LEA_PAYLOAD(HC_X86_RAX, HC_X86_RDX, HC_X86_RAX, 1, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_RAX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_ROTATE_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 6), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1244: mov    dil,0x1d [exact-kinsn: mov8 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RDI, 29), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1247: mov    r8b,0x4 [exact-kinsn: mov8 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_R8, 4), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    HC_KINSN(HC_X86_SIB_PAYLOAD(HC_X86_RSI, HC_X86_RCX, HC_X86_RDX, 0, 140), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1258: lea    r10d,[rdi-0x1d] [exact-kinsn: LEA via x86 kinsn selector] */
    HC_KINSN(HC_LEA_PAYLOAD(HC_X86_R10, HC_X86_RDI, 0, 0, 1, 0, -29), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x125c: lea    r9d,[r8-0x4] [exact-kinsn: LEA via x86 kinsn selector] */
    HC_KINSN(HC_LEA_PAYLOAD(HC_X86_R9, HC_X86_R8, 0, 0, 1, 0, -4), MICRO_HANDCRAFT_BPF_X86_LEAL),
    ...
    HC_KINSN(HC_X86_SIB_PAYLOAD(HC_X86_RSI, HC_X86_RCX, HC_X86_RDX, 0, 141), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_R9, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORB),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDI, 58), MICRO_HANDCRAFT_BPF_X86_ADDB),
    /* 0x1293: add    r8b,0x8 [exact-kinsn: add8 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R8, 8), MICRO_HANDCRAFT_BPF_X86_ADDB),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDX, 1), MICRO_HANDCRAFT_BPF_X86_ORQ),
    ...
    HC_KINSN(HC_X86_MEM_PAYLOAD(HC_X86_RDX, HC_X86_RCX, 203), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_RDX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12c2: lea    rdi,[rdx*8+0x0] [exact-kinsn: LEA via x86 kinsn selector] */
    HC_KINSN(HC_LEA_PAYLOAD(HC_X86_RDI, 0, HC_X86_RDX, 3, 0, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x12ca: sub    rdi,rdx [exact-kinsn: sub64 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_RDI, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_SUBQ),
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_RSI, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_RDX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x12de: add    rdx,rsi [exact-kinsn: add64 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_RDX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
