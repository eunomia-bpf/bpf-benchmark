...
static const struct bpf_insn program[] = {
    ...
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RDI, HC_X86_RCX, 0, 0, 1, 0, 204), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_6, 0, (-13) - 1, 3),
    /* 0x1129: mov    dl,0x1d [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_RDX, 29), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x112b: mov    dil,0x4 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_RDI, 4), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RSI, HC_X86_RCX, HC_X86_RAX, 0, 12), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1135: lea    r9d,[rdx-0x1d] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_R9, HC_X86_RDX, 0, 0, 1, 0, -29), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x1139: lea    r8d,[rdi-0x4] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_R8, HC_X86_RDI, 0, 0, 1, 0, -4), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x113d: xor    r8b,r9b [exact-kop: xorb reg kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R8, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORB),
    /* 0x1140: xor    r8b,0xa5 [exact-kop: xorb imm kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R8, 165), MICRO_HANDCRAFT_BPF_X86_XORB),
    /* 0x1144: add    r8b,0x11 [exact-kop: add8 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R8, 17), MICRO_HANDCRAFT_BPF_X86_ADDB),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_X, BPF_REG_6, BPF_REG_7, (30) - 1, 0),
    /* 0x114d: movzx  esi,BYTE PTR [rcx+rax*1+0xd] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RSI, HC_X86_RCX, HC_X86_RAX, 0, 13), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1152: mov    r8d,edx [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R8, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1155: xor    r8b,dil [exact-kop: xorb reg kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R8, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORB),
    ...
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RAX, 2), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_ALU64_IMM(BPF_AND, BPF_REG_7, 0xff),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_X, BPF_REG_6, BPF_REG_7, (15) - 1, 0),
    /* 0x1169: add    dl,0x3a [exact-kop: add8 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDX, 58), MICRO_HANDCRAFT_BPF_X86_ADDB),
    /* 0x116c: add    dil,0x8 [exact-kop: add8 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDI, 8), MICRO_HANDCRAFT_BPF_X86_ADDB),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, (-39) - 1, 64),
    /* 0x1176: movzx  eax,BYTE PTR [rcx+0x4b] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_RAX, HC_X86_RCX, 75), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_RAX, 0), MICRO_HANDCRAFT_BPF_X86_INCQ),
    ...
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RAX, HC_X86_RAX, HC_X86_RAX, 2, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RAX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x11a0: xor    rax,rdx [exact-kop: xor64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RAX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x11a3: movzx  edx,r8b [exact-kop: movzx r32,r8 kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RDX, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_RSI, 29), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_R8, HC_X86_RCX, HC_X86_RAX, 0, 76), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x11c6: lea    r10d,[rsi-0x1d] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_R10, HC_X86_RSI, 0, 0, 1, 0, -29), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x11ca: lea    r9d,[rdi-0x4] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_R9, HC_X86_RDI, 0, 0, 1, 0, -4), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x11ce: xor    r9b,r10b [exact-kop: xorb reg kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R9, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_XORB),
    /* 0x11d1: xor    r9b,0xa5 [exact-kop: xorb imm kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R9, 165), MICRO_HANDCRAFT_BPF_X86_XORB),
    /* 0x11d5: add    r9b,0x11 [exact-kop: add8 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R9, 17), MICRO_HANDCRAFT_BPF_X86_ADDB),
    ...
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_ALU64_IMM(BPF_AND, BPF_REG_7, 0xff),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_X, BPF_REG_6, BPF_REG_7, (35) - 1, 0),
    /* 0x11de: movzx  r8d,BYTE PTR [rcx+rax*1+0x4d] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_R8, HC_X86_RCX, HC_X86_RAX, 0, 77), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x11e4: mov    r9d,esi [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R9, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11e7: xor    r9b,dil [exact-kop: xorb reg kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R9, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORB),
    ...
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_ALU64_IMM(BPF_AND, BPF_REG_7, 0xff),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_X, BPF_REG_6, BPF_REG_7, (19) - 1, 0),
    /* 0x11fb: add    sil,0x3a [exact-kop: add8 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RSI, 58), MICRO_HANDCRAFT_BPF_X86_ADDB),
    ...
    HC_MOV64_REG(BPF_REG_6, HC_X86_RAX),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, (-41) - 1, 64),
    ...
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_RAX, HC_X86_RCX, 139), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RAX, HC_X86_RAX, HC_X86_RAX, 1, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x122b: lea    rax,[rdx+rax*2] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RAX, HC_X86_RDX, HC_X86_RAX, 1, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RAX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KOP(HC_ROTATE_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 6), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x1244: mov    dil,0x1d [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_RDI, 29), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1247: mov    r8b,0x4 [exact-kop: mov8 immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R8, 4), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RSI, HC_X86_RCX, HC_X86_RDX, 0, 140), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1258: lea    r10d,[rdi-0x1d] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_R10, HC_X86_RDI, 0, 0, 1, 0, -29), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x125c: lea    r9d,[r8-0x4] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_R9, HC_X86_R8, 0, 0, 1, 0, -4), MICRO_HANDCRAFT_BPF_X86_LEAL),
    ...
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_ALU64_IMM(BPF_AND, BPF_REG_7, 0xff),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_X, BPF_REG_6, BPF_REG_7, (39) - 1, 0),
    /* 0x1270: movzx  esi,BYTE PTR [rcx+rdx*1+0x8d] [exact-kop: indexed memory load via x86 SIB kop] */
    HC_KOP(HC_X86_SIB_PAYLOAD(HC_X86_RSI, HC_X86_RCX, HC_X86_RDX, 0, 141), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R9, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORB),
    ...
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xff),
    HC_ALU64_IMM(BPF_AND, BPF_REG_7, 0xff),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_X, BPF_REG_6, BPF_REG_7, (23) - 1, 0),
    /* 0x128f: add    dil,0x3a [exact-kop: add8 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDI, 58), MICRO_HANDCRAFT_BPF_X86_ADDB),
    /* 0x1293: add    r8b,0x8 [exact-kop: add8 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R8, 8), MICRO_HANDCRAFT_BPF_X86_ADDB),
    ...
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDX, 1), MICRO_HANDCRAFT_BPF_X86_ORQ),
    ...
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_RDX, HC_X86_RCX, 203), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RDX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12c2: lea    rdi,[rdx*8+0x0] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RDI, 0, HC_X86_RDX, 3, 0, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x12ca: sub    rdi,rdx [exact-kop: sub64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RDI, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_SUBQ),
    ...
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RSI, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_RDX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x12de: add    rdx,rsi [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(HC_X86_RDX, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_ADDQ),
