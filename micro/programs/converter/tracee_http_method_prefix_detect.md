...
static const struct bpf_insn program[] = {
    ...
    /* 0x1141: mov    ecx,0x1 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_4, 1), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1146: cs nop WORD PTR [rax+rax*1+0x0] [padding: prefixed nop padding is not part of BPF semantics] */
    /* 0x1150: mov    rsi,rbx [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_2, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1153: movzx  edi,BYTE PTR [rax-0x6] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_MEM_PAYLOAD(BPF_REG_1, BPF_REG_0, -6), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x1157: movzx  r8d,BYTE PTR [rax-0x5] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_MEM_PAYLOAD(BPF_REG_5, BPF_REG_0, -5), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    /* 0x117d: mov    r8b,0x45 [exact-kop: movb immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_5, 69), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    /* 0x118a: mov    r10b,0x45 [exact-kop: movb immediate kop] */
    ...
    /* 0x1197: mov    r9d,0x1 [exact-kop: movl immediate kop] */
    ...
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R9, BPF_REG_5), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_STX(BPF_DW, BPF_REG_10, BPF_REG_6, -376),
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_6, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x11da: mov    r8b,0x4f [exact-kop: movb immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_5, 79), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    HC_LDX(BPF_DW, BPF_REG_6, BPF_REG_10, -376),
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (187) - 1),
    /* 0x11f1: mov    r10b,0x4f [exact-kop: movb immediate kop] */
    ...
    /* 0x11fe: mov    r9d,0x2 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R9, 2), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1204: mov    r8b,0x53 [exact-kop: movb immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_5, 83), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1207: mov    r11b,0x54 [exact-kop: movb immediate kop] */
    ...
    /* 0x1219: mov    r8b,0x45 [exact-kop: movb immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_5, 69), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    /* 0x1244: mov    r11b,0x45 [exact-kop: movb immediate kop] */
    ...
    /* 0x1250: mov    r9d,0x4 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R9, 4), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1256: mov    r8b,0x4c [exact-kop: movb immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_5, 76), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1259: mov    r10b,0x45 [exact-kop: movb immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R10, 69), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    /* 0x126d: mov    r8b,0x45 [exact-kop: movb immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_5, 69), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    /* 0x127c: mov    r10b,0x45 [exact-kop: movb immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R10, 69), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    /* 0x1285: mov    r9d,0x5 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R9, 5), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x128b: mov    r8b,0x41 [exact-kop: movb immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_5, 65), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x128e: mov    r11b,0x44 [exact-kop: movb immediate kop] */
    ...
    /* 0x1293: mov    r8b,0x55 [exact-kop: movb immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_5, 85), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    /* 0x129c: mov    r10b,0x55 [exact-kop: movb immediate kop] */
    ...
    /* 0x12a5: mov    r9d,0x3 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R9, 3), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12ab: mov    r8b,0x54 [exact-kop: movb immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_5, 84), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x12ae: mov    r11b,0x20 [exact-kop: movb immediate kop] */
    ...
    /* 0x12b3: mov    r8b,0x54 [exact-kop: movb immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(BPF_REG_5, 84), MICRO_HANDCRAFT_BPF_X86_MOVB),
    ...
    /* 0x12c8: mov    r9d,0x6 [exact-kop: movl immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R9, 6), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12ce: mov    r11b,0x50 [exact-kop: movb immediate kop] */
    HC_KOP(HC_X86_IMM_PAYLOAD(HC_X86_R11, 80), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x12d1: mov    r10b,0x54 [exact-kop: movb immediate kop] */
    ...
    /* 0x12e0: mov    r10d,r8d [exact-kop: movl register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(HC_X86_R10, BPF_REG_5), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12e3: movzx  r8d,BYTE PTR [rax-0x4] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_MEM_PAYLOAD(BPF_REG_5, BPF_REG_0, -4), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x12e8: movzx  r11d,BYTE PTR [rax-0x3] [exact-kop: direct memory load via x86 kop selector] */
    HC_KOP(HC_X86_MEM_PAYLOAD(HC_X86_R11, BPF_REG_0, -3), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_6, HC_X86_R9, 0, 0, 1, 0, 1), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x12f8: lea    r14,[rcx+0xa] [exact-kop: LEA via x86 kop selector] */
    HC_KOP(HC_LEA_PAYLOAD(BPF_REG_8, BPF_REG_4, 0, 0, 1, 0, 10), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x12fc: imul   rbx,r14 [exact-kop: imulq reg,reg kop] */
    HC_KOP(HC_REG_REG_PAYLOAD(BPF_REG_6, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_IMULQ),
    /* 0x1300: add    rsi,rbx [exact-kop: add64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(BPF_REG_2, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_5, BPF_REG_5), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x130b: shl    r8d,0x18 [exact-kop: shl32 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_5, 24), MICRO_HANDCRAFT_BPF_X86_SHLL),
    ...
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_1, 8), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x131a: or     edi,r10d [exact-kop: or32 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(BPF_REG_1, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_ORL),
    /* 0x131d: or     edi,r8d [exact-kop: or32 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(BPF_REG_1, BPF_REG_5), MICRO_HANDCRAFT_BPF_X86_ORL),
    /* 0x1320: or     rdi,r11 [exact-kop: or64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(BPF_REG_1, HC_X86_R11), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x1323: mov    ebx,r9d [exact-kop: movl register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_6, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1326: or     rbx,rdi [exact-kop: or64 reg kop] */
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(BPF_REG_6, BPF_REG_1), MICRO_HANDCRAFT_BPF_X86_ORQ),
    ...
    HC_KOP(HC_X86_ALU_RR_PAYLOAD(BPF_REG_6, BPF_REG_2), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x132f: add    rax,0x10 [exact-kop: add64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_0, 16), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_KOP(HC_X86_STORE_PAYLOAD(BPF_REG_2, BPF_REG_3, 0), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1343: mov    BYTE PTR [rdx+0x1],bh [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_BYTE_PAYLOAD(BPF_REG_6, BPF_REG_3, 1, 1), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1346: mov    eax,ebx [exact-kop: movl register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_0, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1348: shr    eax,0x10 [exact-kop: shr32 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_0, 16), MICRO_HANDCRAFT_BPF_X86_SHRL),
    /* 0x134b: mov    BYTE PTR [rdx+0x2],al [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(BPF_REG_0, BPF_REG_3, 2), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x134e: mov    eax,ebx [exact-kop: movl register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_0, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1350: shr    eax,0x18 [exact-kop: shr32 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_0, 24), MICRO_HANDCRAFT_BPF_X86_SHRL),
    /* 0x1353: mov    BYTE PTR [rdx+0x3],al [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(BPF_REG_0, BPF_REG_3, 3), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1356: mov    rax,rbx [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_0, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1359: shr    rax,0x20 [exact-kop: shr64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_0, 32), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x135d: mov    BYTE PTR [rdx+0x4],al [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(BPF_REG_0, BPF_REG_3, 4), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1360: mov    rax,rbx [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_0, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x1363: shr    rax,0x28 [exact-kop: shr64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_0, 40), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x1367: mov    BYTE PTR [rdx+0x5],al [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(BPF_REG_0, BPF_REG_3, 5), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x136a: mov    rax,rbx [exact-kop: movq register-to-register kop] */
    HC_KOP(HC_X86_RR_PAYLOAD(BPF_REG_0, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x136d: shr    rax,0x30 [exact-kop: shr64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_0, 48), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x1371: mov    BYTE PTR [rdx+0x6],al [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(BPF_REG_0, BPF_REG_3, 6), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x1374: shr    rbx,0x38 [exact-kop: shr64 imm kop] */
    HC_KOP(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_6, 56), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x1378: mov    BYTE PTR [rdx+0x7],bl [exact-kop: direct memory store via x86 kop selector] */
    HC_KOP(HC_X86_STORE_PAYLOAD(BPF_REG_6, BPF_REG_3, 7), MICRO_HANDCRAFT_BPF_X86_MOVB),
    /* 0x137b: mov    eax,0x2 [exact-kop: movl immediate kop] */
