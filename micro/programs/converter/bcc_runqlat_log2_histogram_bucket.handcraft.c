...
static const struct bpf_insn program[] = {
    ...
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_RDI, HC_X86_RSI, 0, 0, 1, 0, 1040), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RAX, 56), MICRO_HANDCRAFT_BPF_X86_ANDB),
    ...
    HC_MOV64_REG(BPF_REG_6, HC_X86_RDX),
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_6, 0, (22) - 1, 0),
    /* 0x1187: inc    rdx [exact-kop: incq reg kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RDX, 0), MICRO_HANDCRAFT_BPF_X86_INCQ),
    ...
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_R8, HC_X86_R9, 0, 0, 1, 0, 1), MICRO_HANDCRAFT_BPF_X86_LEAL),
    ...
    HC_RAW(BPF_JMP32 | BPF_JGT | BPF_K, BPF_REG_6, 0, (11) - 1, 61),
    ...
    /* 0x11a3: cmp    rdx,0x3 [control-flow-operand: cmp snapshotted for later ordinary BPF branch] */
    HC_MOV64_REG(BPF_REG_6, HC_X86_RDX),
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_K, BPF_REG_6, 0, (-16) - 1, 3),
    ...
    /* 0x11e9: cmp    r8d,0x19 [control-flow-operand: cmp snapshotted for later ordinary BPF branch] */
    ...
    /* 0x11f3: cmovb  r11d,r8d [exact-bpf: cmovb as ordinary BPF conditional move] */
    HC_LDX(BPF_DW, BPF_REG_6, BPF_REG_10, HC_X86_BRANCH_LHS_OFF),
    HC_RAW(BPF_JMP32 | BPF_JGE | BPF_K, BPF_REG_6, 0, 2, 25),
    ...
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_R14, HC_X86_R11, 0, 0, 1, 0, 1), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x11fb: mov    edx,r11d [exact-kop: mov32 register-to-register kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RDX, HC_X86_R11), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11fe: and    dl,0x7 [exact-kop: andb imm kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RDX, 7), MICRO_HANDCRAFT_BPF_X86_ANDB),
    ...
    HC_KOP(HC_LEA_PAYLOAD(HC_X86_R10, HC_X86_RAX, 0, 0, 1, 0, 1), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    /* 0x120e: imul   r14,r10 [exact-kop: imulq reg,reg kop] */
    HC_KOP(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R14, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_IMULQ),
    /* 0x1212: not    dl [exact-kop: not8 reg kop] */
    HC_KOP(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RDX, 0), MICRO_HANDCRAFT_BPF_X86_NOTB),
