...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_LEA_PAYLOAD(HC_X86_RDI, HC_X86_RSI, 0, 0, 1, 0, 1040), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KINSN(HC_X86_MEM_PAYLOAD(HC_X86_RDI, HC_X86_RSI, 12), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RAX, 3), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x1144: mov    edx,r11d [exact-kinsn: mov32 register-to-register kinsn] */
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_RDX, HC_X86_R11), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1147: and    al,0x38 [exact-kinsn: andb imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RAX, 56), MICRO_HANDCRAFT_BPF_X86_ANDB),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_RBX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_RAX, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_6, 0, (115) - 1, 128),
    /* 0x1164: movzx  edx,WORD PTR [rsi+rax*8+0x10] [exact-kinsn: indexed memory load via x86 SIB kinsn] */
    HC_KINSN(HC_X86_SIB_PAYLOAD(HC_X86_RDX, HC_X86_RSI, HC_X86_RAX, 3, 16), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    /* 0x1169: movzx  ecx,BYTE PTR [rsi+rax*8+0x12] [exact-kinsn: indexed memory load via x86 SIB kinsn] */
    HC_KINSN(HC_X86_SIB_PAYLOAD(HC_X86_RCX, HC_X86_RSI, HC_X86_RAX, 3, 18), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_RCX, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ORQ),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RDX, 1048575), MICRO_HANDCRAFT_BPF_X86_ANDL),
    /* 0x1185: je     11ac <bcc_runqlat_log2_histogram_bucket_xdp+0xac> [exact-bpf: je as ordinary BPF branch] */
    HC_MOV64_REG(BPF_REG_6, HC_X86_RDX),
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_6, 0, (24) - 1, 0),
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_R9, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1193: lea    r8d,[r9+0x1] [exact-kinsn: LEA via x86 kinsn selector] */
    HC_KINSN(HC_LEA_PAYLOAD(HC_X86_R8, HC_X86_R9, 0, 0, 1, 0, 1), MICRO_HANDCRAFT_BPF_X86_LEAL),
    ...
    HC_RAW(BPF_JMP32 | BPF_JGT | BPF_K, BPF_REG_6, 0, (13) - 1, 61),
    /* 0x119d: mov    r9,rdx [exact-kinsn: mov64 register-to-register kinsn] */
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_R9, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    /* 0x11a0: shr    r9,1 [exact-kinsn: shr64 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R9, 1), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    /* 0x11a3: cmp    rdx,0x3 [exact-kinsn: cmp64 reg,imm kinsn; branch operands snapshotted] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_RDX, 3), MICRO_HANDCRAFT_BPF_X86_CMPQ),
    HC_MOV64_REG(BPF_REG_6, HC_X86_RDX),
    ...
    HC_LDX(BPF_DW, BPF_REG_6, BPF_REG_10, HC_X86_BRANCH_LHS_OFF),
    HC_RAW(BPF_JMP | BPF_JGT | BPF_K, BPF_REG_6, 0, (-18) - 1, 3),
    /* 0x11ac: movzx  edx,BYTE PTR [rsi+rax*8+0x13] [exact-kinsn: indexed memory load via x86 SIB kinsn] */
    HC_KINSN(HC_X86_SIB_PAYLOAD(HC_X86_RDX, HC_X86_RSI, HC_X86_RAX, 3, 19), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_RDX, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x11b7: movzx  ecx,BYTE PTR [rsi+rax*8+0x14] [exact-kinsn: indexed memory load via x86 SIB kinsn] */
    HC_KINSN(HC_X86_SIB_PAYLOAD(HC_X86_RCX, HC_X86_RSI, HC_X86_RAX, 3, 20), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_X86_SIB_PAYLOAD(HC_X86_R10, HC_X86_RSI, HC_X86_RAX, 3, 21), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R10, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x11cd: or     r10,rdx [exact-kinsn: or64 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R10, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x11d0: movzx  ecx,BYTE PTR [rsi+rax*8+0x16] [exact-kinsn: indexed memory load via x86 SIB kinsn] */
    HC_KINSN(HC_X86_SIB_PAYLOAD(HC_X86_RCX, HC_X86_RSI, HC_X86_RAX, 3, 22), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_X86_SIB_PAYLOAD(HC_X86_R9, HC_X86_RSI, HC_X86_RAX, 3, 23), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, HC_X86_RCX), MICRO_HANDCRAFT_BPF_X86_ORQ),
    ...
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_R8, 25), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x11ed: mov    r11d,0x19 [exact-kinsn: mov32 immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_R11, 25), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11f3: cmovb  r11d,r8d [exact-kinsn: cmov kinsn using module shadow flags] */
    HC_KINSN(HC_CMOV_PAYLOAD(HC_X86_R11, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_CMOVBL),
    /* 0x11f7: lea    r14d,[r11+0x1] [exact-kinsn: LEA via x86 kinsn selector] */
    HC_KINSN(HC_LEA_PAYLOAD(HC_X86_R14, HC_X86_R11, 0, 0, 1, 0, 1), MICRO_HANDCRAFT_BPF_X86_LEAL),
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_R15, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KINSN(HC_LEA_PAYLOAD(HC_X86_R10, HC_X86_RAX, 0, 0, 1, 0, 1), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_RDI, HC_X86_R14), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x121f: or     rbx,r15 [exact-kinsn: or64 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_RBX, HC_X86_R15), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x1222: xor    rbx,rdi [exact-kinsn: xor64 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_RBX, HC_X86_RDI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    HC_RAW(BPF_JMP32 | BPF_JLT | BPF_K, BPF_REG_6, 0, (-127) - 1, 25),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_RBX, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_KINSN(HC_X86_STORE_PAYLOAD(HC_X86_RDI, HC_X86_RSI, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ),
