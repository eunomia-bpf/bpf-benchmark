 ...
 * - 0x1157: cmp    r10,0x80 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    r10,0x80]
 ...
 * - 0x11f7: lea    r14d,[r11+0x1] [warning-reg-remap: LEA via x86 kinsn selector; native r11 has no exact BPF JIT register; remapped to BPF_REG_7]
...
static const struct bpf_insn program[] = {
    ...
    /* 0x1147: and    al,0x38 [exact-kinsn: andb imm kinsn; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_REG_IMM_TMP_PAYLOAD(BPF_REG_0, 56, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ANDB_IMM),
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_3, 0, 19, 0),
    ...
    HC_KINSN(HC_REG_IMM_PAYLOAD(BPF_REG_9, 61), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_K, BPF_REG_9, 0, 10, 61),
    /* 0x119d: mov    r9,rdx [warning-reg-remap: movq register-to-register kinsn; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x11f3: cmovb  r11d,r8d [warning-unmapped: cmovb is carry-flag-bound; automatic conversion needs an adjacent unsigned cmp proof] */
    /* 0x11f7: lea    r14d,[r11+0x1] [warning-reg-remap: LEA via x86 kinsn selector; native r11 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KINSN(HC_LEA_PAYLOAD(BPF_REG_8, BPF_REG_7, 0, 0, 1, 0, 1), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x11fb: mov    edx,r11d [warning-reg-remap: 32-bit register move; native r11 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_RAW(BPF_ALU | BPF_MOV | BPF_X, BPF_REG_3, BPF_REG_7, 0, 0),
    /* 0x11fe: and    dl,0x7 [exact-kinsn: andb imm kinsn; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_REG_IMM_TMP_PAYLOAD(BPF_REG_3, 7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ANDB_IMM),
    ...
    /* 0x120a: lea    r10,[rax+0x1] [warning-unmapped: LEA operands are not representable] */
    /* 0x120e: imul   r14,r10 [warning-unmapped: IMUL operands are not in the 64-bit BPF JIT register file: imul   r14,r10] */
    /* 0x1212: not    dl [exact-kinsn: notb reg kinsn; verifier instantiate uses temp BPF_REG_6] */
