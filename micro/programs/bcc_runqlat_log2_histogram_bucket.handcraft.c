...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RAX, 56), MICRO_HANDCRAFT_BPF_X86_ANDB),
    ...
    HC_KINSN(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RDX, 0), MICRO_HANDCRAFT_BPF_X86_INCQ),
    ...
    HC_KINSN(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RDX, 7), MICRO_HANDCRAFT_BPF_X86_ANDB),
    ...
    HC_KINSN(HC_X86_ARCH_RR_PAYLOAD(HC_X86_R14, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_IMULQ),
    /* 0x1212: not    dl [exact-kinsn: not8 reg kinsn] */
    HC_KINSN(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RDX, 0), MICRO_HANDCRAFT_BPF_X86_NOTB),
