...
static const struct bpf_insn program[] = {
    ...
    /* 0x110c: ja     1139 <simple_xdp+0x39> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_4, BPF_REG_3, (17) - 1, 0),
    ...
    /* 0x1115: ja     1139 <simple_xdp+0x39> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_2, BPF_REG_3, (14) - 1, 0),
    ...
    /* 0x111e: ja     1139 <simple_xdp+0x39> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_2, BPF_REG_3, (11) - 1, 0),
