...
static const struct bpf_insn program[] = {
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_2, BPF_REG_3, (-10) - 1, 0),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_5, 0, (-20) - 1, 32),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_0, 0, (-43) - 1, 16),
