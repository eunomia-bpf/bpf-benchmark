 ...
 * - 0x1128: jne    110e <sorted_rule_binary_search_xdp+0xe> [warning-unmapped: jcc has no immediately preceding branchable cmp/test; needs a machine-level branch kinsn]
 * - 0x112e: jne    110e <sorted_rule_binary_search_xdp+0xe> [warning-unmapped: jcc has no immediately preceding branchable cmp/test; needs a machine-level branch kinsn]
 ...
 * - 0x119a: pop    rbp [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR]
 */
...
static const struct bpf_insn program[] = {
    ...
    /* 0x110c: jbe    110f <sorted_rule_binary_search_xdp+0xf> [bpf-branch: verifier-visible branch from preceding cmp    rcx,rdx; cmp kinsn is preserved] */
    ...
    /* 0x1116: ja     110e <sorted_rule_binary_search_xdp+0xe> [bpf-branch: verifier-visible branch from preceding cmp    rsi,rdx; cmp kinsn is preserved] */
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_2, BPF_REG_3), MICRO_HANDCRAFT_BPF_X86_CMPQ),
    /* 0x1122: ja     110e <sorted_rule_binary_search_xdp+0xe> [bpf-branch: verifier-visible branch from preceding cmp    rsi,rdx; cmp kinsn is preserved] */
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_2, BPF_REG_3, -11, 0),
    ...
    /* 0x1175: jne    1150 <sorted_rule_binary_search_xdp+0x50> [bpf-branch: verifier-visible branch from preceding cmp    r8,0x20; cmp kinsn is preserved] */
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_5, 0, -21, 32),
    ...
    /* 0x1190: jne    1140 <sorted_rule_binary_search_xdp+0x40> [bpf-branch: verifier-visible branch from preceding cmp    rax,0x10; cmp kinsn is preserved] */
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_0, 0, -44, 16),
    ...
    /* 0x119a: pop    rbp [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x119b: ret [bpf-jit: BPF exit; kernel JIT emits the real return sequence] */
    HC_EXIT(),
};
