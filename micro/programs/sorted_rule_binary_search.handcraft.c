 ...
 * - 0x110c: jbe    110f <sorted_rule_binary_search_xdp+0xf> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1116: ja     110e <sorted_rule_binary_search_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1122: ja     110e <sorted_rule_binary_search_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1128: jne    110e <sorted_rule_binary_search_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x112e: jne    110e <sorted_rule_binary_search_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1175: jne    1150 <sorted_rule_binary_search_xdp+0x50> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1190: jne    1140 <sorted_rule_binary_search_xdp+0x40> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 */
