...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_2, BPF_REG_4, 0, 0, 1, 0, 400, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x114d: xor    r9d,r9d [exact-kinsn: xor32 reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, HC_X86_R9, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1150: mov    r10d,r9d [exact-kinsn: movl register-to-register kinsn; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(HC_X86_R10, HC_X86_R9, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_MOVL_RR),
    ...
    /* 0x115b: sete   r9b [warning-unmapped: sete is flag-bound; automatic conversion needs an adjacent cmp/test proof] */
    /* 0x115f: cmove  rdi,r8 [warning-unmapped: cmove needs an adjacent test/cmp proof payload] */
    /* 0x1163: or     r9b,r10b [exact-kinsn: orb reg kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_REG_REG_TMP2_PAYLOAD(HC_X86_R9, HC_X86_R10, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_ORB_RR),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_5, 0, -12, 32),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_2, 32, 0), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_0, 0, -33, 16),
