...
/*
 * native asm to handcraft warnings: 62
 *
...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_2, BPF_REG_3, 0, 0, 1, 0, 144, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, -13, 8),
    /* 0x112a: cmp    DWORD PTR [rdx+0xc],0x10 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    DWORD PTR [rdx+0xc],0x10] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, -15, 16),
    /* 0x1130: push   r15 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1132: push   r14 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1134: push   rbx [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1135: lea    rax,[rdx+0x16] [exact-kinsn: LEA via x86 kinsn selector] */
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_0, BPF_REG_3, 0, 0, 1, 0, 22, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x1158: movzx  r9d,BYTE PTR [rax-0x5] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R9, BPF_REG_0, -5, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x115d: lea    r11d,[r8-0x44] [exact-kinsn: LEA via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_LEA_TMP_PAYLOAD(HC_X86_R11, BPF_REG_5, 0, 0, 1, 0, -68, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x1161: cmp    r11d,0xc [exact-kinsn: cmpl reg,imm32 kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_TMP_IMM_PAYLOAD(HC_X86_R11, BPF_REG_7, 12), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    /* 0x1165: ja     12c0 <tracee_http_method_prefix_detect_xdp+0x1c0> [warning-unmapped: cannot lower cmp    r11d,0xc + ja     12c0 <tracee_http_method_prefix_detect_xdp+0x1c0> to BPF branch] */
    ...
    /* 0x116f: movsxd r11,DWORD PTR [rsi+r11*4] [exact-kinsn: movsxd SIB kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_SIB_TMP_PAYLOAD(HC_X86_R11, BPF_REG_2, HC_X86_R11, 2, 0, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVSXD_SIB),
    /* 0x1173: add    r11,rsi [exact-kinsn: add64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_2, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1176: jmp    r11 [warning-unmapped: cannot parse branch target r11] */
    /* 0x1179: cmp    r9b,0x45 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    r9b,0x45] */
    /* 0x117d: jne    12c0 <tracee_http_method_prefix_detect_xdp+0x1c0> [warning-unmapped: cannot lower cmp    r9b,0x45 + jne    12c0 <tracee_http_method_prefix_detect_xdp+0x1c0> to BPF branch] */
    /* 0x1183: mov    r9b,0x45 [warning-unmapped: movq immediate into HC_X86_R9 needs an immediate-load kinsn] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -4),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 54, 76),
    /* 0x1190: cmp    BYTE PTR [rax-0x3],0x45 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    BYTE PTR [rax-0x3],0x45] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -3),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 52, 69),
    /* 0x119a: cmp    BYTE PTR [rax-0x2],0x54 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    BYTE PTR [rax-0x2],0x54] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -2),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 50, 84),
    /* 0x11a4: cmp    BYTE PTR [rax-0x1],0x45 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    BYTE PTR [rax-0x1],0x45] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -1),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 48, 69),
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, 0),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 45, 32),
    /* 0x11b9: mov    r10d,0x4 [warning-unmapped: movl immediate into HC_X86_R10 needs an immediate-load kinsn] */
    /* 0x11bf: mov    r9b,0x4c [warning-unmapped: movq immediate into HC_X86_R9 needs an immediate-load kinsn] */
    /* 0x11c2: mov    r11b,0x45 [warning-unmapped: movq immediate into HC_X86_R11 needs an immediate-load kinsn] */
    ...
    /* 0x11d0: cmp    r10d,0x54 [exact-kinsn: cmpl reg,imm32 kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_TMP_IMM_PAYLOAD(HC_X86_R10, BPF_REG_7, 84), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    /* 0x11d4: je     1275 <tracee_http_method_prefix_detect_xdp+0x175> [warning-unmapped: cannot lower cmp    r10d,0x54 + je     1275 <tracee_http_method_prefix_detect_xdp+0x175> to BPF branch] */
    /* 0x11da: cmp    r10d,0x45 [exact-kinsn: cmpl reg,imm32 kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_TMP_IMM_PAYLOAD(HC_X86_R10, BPF_REG_7, 69), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    /* 0x11de: jne    12c0 <tracee_http_method_prefix_detect_xdp+0x1c0> [warning-unmapped: cannot lower cmp    r10d,0x45 + jne    12c0 <tracee_http_method_prefix_detect_xdp+0x1c0> to BPF branch] */
    /* 0x11e4: mov    r9b,0x45 [warning-unmapped: movq immediate into HC_X86_R9 needs an immediate-load kinsn] */
    /* 0x11e7: cmp    BYTE PTR [rax-0x4],0x41 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    BYTE PTR [rax-0x4],0x41] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -4),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 38, 65),
    /* 0x11f1: cmp    BYTE PTR [rax-0x3],0x44 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    BYTE PTR [rax-0x3],0x44] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -3),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 36, 68),
    /* 0x11fb: mov    r11b,0x45 [warning-unmapped: movq immediate into HC_X86_R11 needs an immediate-load kinsn] */
    /* 0x11fe: cmp    BYTE PTR [rax-0x2],0x20 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    BYTE PTR [rax-0x2],0x20] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -2),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 34, 32),
    /* 0x1208: mov    r10d,0x5 [warning-unmapped: movl immediate into HC_X86_R10 needs an immediate-load kinsn] */
    /* 0x120e: mov    r9b,0x41 [warning-unmapped: movq immediate into HC_X86_R9 needs an immediate-load kinsn] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -4),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 30, 84),
    /* 0x122f: mov    r11b,0x45 [warning-unmapped: movq immediate into HC_X86_R11 needs an immediate-load kinsn] */
    /* 0x1232: cmp    BYTE PTR [rax-0x3],0x20 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    BYTE PTR [rax-0x3],0x20] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -3),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 28, 32),
    /* 0x123c: mov    r10d,0x1 [warning-unmapped: movl immediate into HC_X86_R10 needs an immediate-load kinsn] */
    ...
    /* 0x1244: cmp    r10d,0x55 [exact-kinsn: cmpl reg,imm32 kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_TMP_IMM_PAYLOAD(HC_X86_R10, BPF_REG_7, 85), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    /* 0x1248: je     1297 <tracee_http_method_prefix_detect_xdp+0x197> [warning-unmapped: cannot lower cmp    r10d,0x55 + je     1297 <tracee_http_method_prefix_detect_xdp+0x197> to BPF branch] */
    /* 0x124a: cmp    r10d,0x4f [exact-kinsn: cmpl reg,imm32 kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_TMP_IMM_PAYLOAD(HC_X86_R10, BPF_REG_7, 79), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    /* 0x124e: jne    12c0 <tracee_http_method_prefix_detect_xdp+0x1c0> [warning-unmapped: cannot lower cmp    r10d,0x4f + jne    12c0 <tracee_http_method_prefix_detect_xdp+0x1c0> to BPF branch] */
    /* 0x1250: mov    r9b,0x4f [warning-unmapped: movq immediate into HC_X86_R9 needs an immediate-load kinsn] */
    /* 0x1253: cmp    BYTE PTR [rax-0x4],0x53 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    BYTE PTR [rax-0x4],0x53] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -4),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 21, 83),
    /* 0x1259: cmp    BYTE PTR [rax-0x3],0x54 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    BYTE PTR [rax-0x3],0x54] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -3),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 19, 84),
    /* 0x125f: mov    r11b,0x4f [warning-unmapped: movq immediate into HC_X86_R11 needs an immediate-load kinsn] */
    /* 0x1262: cmp    BYTE PTR [rax-0x2],0x20 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    BYTE PTR [rax-0x2],0x20] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -2),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 17, 32),
    /* 0x1268: mov    r10d,0x2 [warning-unmapped: movl immediate into HC_X86_R10 needs an immediate-load kinsn] */
    /* 0x126e: mov    r9b,0x53 [warning-unmapped: movq immediate into HC_X86_R9 needs an immediate-load kinsn] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -4),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 13, 84),
    /* 0x127e: cmp    BYTE PTR [rax-0x3],0x50 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    BYTE PTR [rax-0x3],0x50] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -3),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 11, 80),
    /* 0x1284: cmp    BYTE PTR [rax-0x2],0x2f [warning-unmapped: CMP operand form has no current kinsn selector: cmp    BYTE PTR [rax-0x2],0x2f] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -2),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 9, 47),
    /* 0x128a: mov    r10d,0x6 [warning-unmapped: movl immediate into HC_X86_R10 needs an immediate-load kinsn] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -4),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 5, 84),
    /* 0x12a0: mov    r11b,0x55 [warning-unmapped: movq immediate into HC_X86_R11 needs an immediate-load kinsn] */
    /* 0x12a3: cmp    BYTE PTR [rax-0x3],0x20 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    BYTE PTR [rax-0x3],0x20] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -3),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 3, 32),
    /* 0x12a9: mov    r10d,0x3 [warning-unmapped: movl immediate into HC_X86_R10 needs an immediate-load kinsn] */
    /* 0x12af: mov    r9b,0x54 [warning-unmapped: movq immediate into HC_X86_R9 needs an immediate-load kinsn] */
    ...
    /* 0x12c0: mov    r11d,r9d [exact-kinsn: movl register-to-register kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(HC_X86_R11, HC_X86_R9, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVL_RR),
    /* 0x12c3: movzx  r9d,BYTE PTR [rax-0x4] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R9, BPF_REG_0, -4, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    ...
    /* 0x12cc: xor    r10d,r10d [exact-kinsn: xor32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R10, HC_X86_R10, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_XORL),
    ...
    /* 0x12d2: lea    r14d,[r10+0x1] [exact-kinsn: LEA via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_8, HC_X86_R10, 0, 0, 1, 0, 1, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x12d6: lea    r15,[rcx+0xa] [exact-kinsn: LEA via x86 kinsn selector] */
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_9, BPF_REG_4, 0, 0, 1, 0, 10, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x12e9: shl    r9d,0x18 [exact-kinsn: shl32 imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R9, 24, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_SHLL),
    ...
    /* 0x12f1: shl    r11d,0x10 [exact-kinsn: shl32 imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R11, 16, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x12f5: shl    r8d,0x8 [exact-kinsn: shl32 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_5, 8, 0), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x12f9: or     r8d,r11d [exact-kinsn: or32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_5, HC_X86_R11, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ORL),
    /* 0x12fc: or     r8d,r9d [exact-kinsn: or32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_5, HC_X86_R9, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ORL),
    /* 0x12ff: or     r8,rbx [exact-kinsn: or64 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_5, BPF_REG_6, 0, 0), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x1302: mov    ebx,r10d [exact-kinsn: movl register-to-register kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(BPF_REG_6, HC_X86_R10, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVL_RR),
    /* 0x1305: or     rbx,r8 [exact-kinsn: or64 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_6, BPF_REG_5, 0, 0), MICRO_HANDCRAFT_BPF_X86_ORQ),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_0, 16, 0), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_4, 0, -120, 9),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_0, 24, 0), MICRO_HANDCRAFT_BPF_X86_SHRL),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_0, 32, 0), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_0, 40, 0), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_0, 48, 0), MICRO_HANDCRAFT_BPF_X86_SHRQ),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_6, 56, 0), MICRO_HANDCRAFT_BPF_X86_SHRQ),
