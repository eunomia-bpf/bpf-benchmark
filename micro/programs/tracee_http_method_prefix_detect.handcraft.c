...
/*
 * native asm to handcraft warnings: 54
 *
 ...
 * - 0x115d: lea    r11d,[r8-0x44] [warning-unmapped: LEA operands are not representable]
 ...
 * - 0x116f: movsxd r11,DWORD PTR [rsi+r11*4] [warning-unmapped: movsxd destination r11 is not a 64-bit BPF JIT register]
 * - 0x1173: add    r11,rsi [warning-unmapped: ALU destination r11 is not in the BPF JIT register file]
 ...
 * - 0x11c2: mov    r11b,0x45 [warning-unmapped: unsupported mnemonic or operand form: mov    r11b,0x45]
 ...
 * - 0x11fb: mov    r11b,0x45 [warning-unmapped: unsupported mnemonic or operand form: mov    r11b,0x45]
 ...
 * - 0x122f: mov    r11b,0x45 [warning-unmapped: unsupported mnemonic or operand form: mov    r11b,0x45]
 ...
 * - 0x125f: mov    r11b,0x4f [warning-unmapped: unsupported mnemonic or operand form: mov    r11b,0x4f]
 ...
 * - 0x1292: mov    r11b,0x54 [warning-unmapped: unsupported mnemonic or operand form: mov    r11b,0x54]
 ...
 * - 0x12a0: mov    r11b,0x55 [warning-unmapped: unsupported mnemonic or operand form: mov    r11b,0x55]
 ...
 * - 0x12c0: mov    r11d,r9d [warning-unmapped: unsupported mnemonic or operand form: mov    r11d,r9d]
 ...
 * - 0x12ed: movzx  r11d,r11b [warning-unmapped: movzx source size not recognized: r11b]
 * - 0x12f1: shl    r11d,0x10 [warning-unmapped: ALU destination r11d is not in the BPF JIT register file]
 * - 0x12f9: or     r8d,r11d [warning-unmapped: ALU source r11d is not supported]
...
static const struct bpf_insn program[] = {
    ...
    /* 0x1124: cmp    DWORD PTR [rdx+0x8],0x8 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, -9, 8),
    /* 0x112a: cmp    DWORD PTR [rdx+0xc],0x10 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, -11, 16),
    /* 0x1130: push   r15 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1132: push   r14 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1134: push   rbx [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    ...
    /* 0x115d: lea    r11d,[r8-0x44] [warning-unmapped: LEA operands are not representable] */
    /* 0x1161: cmp    r11d,0xc [cmp-state: sets flags; materialized by following jcc when possible] */
    /* 0x1165: ja     12c0 <tracee_http_method_prefix_detect_xdp+0x1c0> [warning-unmapped: cannot lower cmp    r11d,0xc + ja     12c0 <tracee_http_method_prefix_detect_xdp+0x1c0> to BPF branch] */
    /* 0x116b: movzx  r10d,r9b [warning-unmapped: movzx source size not recognized: r9b] */
    /* 0x116f: movsxd r11,DWORD PTR [rsi+r11*4] [warning-unmapped: movsxd destination r11 is not a 64-bit BPF JIT register] */
    /* 0x1173: add    r11,rsi [warning-unmapped: ALU destination r11 is not in the BPF JIT register file] */
    /* 0x1176: jmp    r11 [warning-unmapped: cannot parse branch target r11] */
    /* 0x1179: cmp    r9b,0x45 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_9, 0, 58, 69),
    /* 0x1183: mov    r9b,0x45 [warning-reg-remap: 64-bit immediate move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_MOV64_IMM(BPF_REG_9, 69),
    /* 0x1186: cmp    BYTE PTR [rax-0x4],0x4c [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 55, 76),
    /* 0x1190: cmp    BYTE PTR [rax-0x3],0x45 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 53, 69),
    /* 0x119a: cmp    BYTE PTR [rax-0x2],0x54 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 51, 84),
    /* 0x11a4: cmp    BYTE PTR [rax-0x1],0x45 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 49, 69),
    /* 0x11ae: mov    bl,0x45 [bpf-jit: 64-bit immediate move] */
    HC_MOV64_IMM(BPF_REG_6, 69),
    /* 0x11b0: cmp    BYTE PTR [rax],0x20 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 46, 32),
    /* 0x11b9: mov    r10d,0x4 [warning-unmapped: unsupported mnemonic or operand form: mov    r10d,0x4] */
    /* 0x11bf: mov    r9b,0x4c [warning-reg-remap: 64-bit immediate move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x11d0: cmp    r10d,0x54 [cmp-state: sets flags; materialized by following jcc when possible] */
    /* 0x11d4: je     1275 <tracee_http_method_prefix_detect_xdp+0x175> [warning-unmapped: cannot lower cmp    r10d,0x54 + je     1275 <tracee_http_method_prefix_detect_xdp+0x175> to BPF branch] */
    /* 0x11da: cmp    r10d,0x45 [cmp-state: sets flags; materialized by following jcc when possible] */
    /* 0x11de: jne    12c0 <tracee_http_method_prefix_detect_xdp+0x1c0> [warning-unmapped: cannot lower cmp    r10d,0x45 + jne    12c0 <tracee_http_method_prefix_detect_xdp+0x1c0> to BPF branch] */
    /* 0x11e4: mov    r9b,0x45 [warning-reg-remap: 64-bit immediate move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_MOV64_IMM(BPF_REG_9, 69),
    /* 0x11e7: cmp    BYTE PTR [rax-0x4],0x41 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -4),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 41, 65),
    /* 0x11f1: cmp    BYTE PTR [rax-0x3],0x44 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -3),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 39, 68),
    /* 0x11fb: mov    r11b,0x45 [warning-unmapped: unsupported mnemonic or operand form: mov    r11b,0x45] */
    /* 0x11fe: cmp    BYTE PTR [rax-0x2],0x20 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -2),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 37, 32),
    /* 0x1208: mov    r10d,0x5 [warning-unmapped: unsupported mnemonic or operand form: mov    r10d,0x5] */
    /* 0x120e: mov    r9b,0x41 [warning-reg-remap: 64-bit immediate move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x1218: cmp    r9b,0x45 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_9, 0, 33, 69),
    /* 0x1222: mov    r9b,0x45 [warning-reg-remap: 64-bit immediate move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_MOV64_IMM(BPF_REG_9, 69),
    /* 0x1225: cmp    BYTE PTR [rax-0x4],0x54 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    /* 0x122f: mov    r11b,0x45 [warning-unmapped: unsupported mnemonic or operand form: mov    r11b,0x45] */
    /* 0x1232: cmp    BYTE PTR [rax-0x3],0x20 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    /* 0x1244: cmp    r10d,0x55 [cmp-state: sets flags; materialized by following jcc when possible] */
    /* 0x1248: je     1297 <tracee_http_method_prefix_detect_xdp+0x197> [warning-unmapped: cannot lower cmp    r10d,0x55 + je     1297 <tracee_http_method_prefix_detect_xdp+0x197> to BPF branch] */
    /* 0x124a: cmp    r10d,0x4f [cmp-state: sets flags; materialized by following jcc when possible] */
    /* 0x124e: jne    12c0 <tracee_http_method_prefix_detect_xdp+0x1c0> [warning-unmapped: cannot lower cmp    r10d,0x4f + jne    12c0 <tracee_http_method_prefix_detect_xdp+0x1c0> to BPF branch] */
    /* 0x1250: mov    r9b,0x4f [warning-reg-remap: 64-bit immediate move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_MOV64_IMM(BPF_REG_9, 79),
    /* 0x1253: cmp    BYTE PTR [rax-0x4],0x53 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -4),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 24, 83),
    /* 0x1259: cmp    BYTE PTR [rax-0x3],0x54 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -3),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 22, 84),
    /* 0x125f: mov    r11b,0x4f [warning-unmapped: unsupported mnemonic or operand form: mov    r11b,0x4f] */
    /* 0x1262: cmp    BYTE PTR [rax-0x2],0x20 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -2),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 20, 32),
    /* 0x1268: mov    r10d,0x2 [warning-unmapped: unsupported mnemonic or operand form: mov    r10d,0x2] */
    /* 0x126e: mov    r9b,0x53 [warning-reg-remap: 64-bit immediate move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x1278: cmp    BYTE PTR [rax-0x4],0x54 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -4),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 14, 84),
    /* 0x127e: cmp    BYTE PTR [rax-0x3],0x50 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -3),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 12, 80),
    /* 0x1284: cmp    BYTE PTR [rax-0x2],0x2f [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_LDX(BPF_B, BPF_REG_7, BPF_REG_0, -2),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, 10, 47),
    /* 0x128a: mov    r10d,0x6 [warning-unmapped: unsupported mnemonic or operand form: mov    r10d,0x6] */
    ...
    /* 0x129a: cmp    BYTE PTR [rax-0x4],0x54 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    /* 0x12a0: mov    r11b,0x55 [warning-unmapped: unsupported mnemonic or operand form: mov    r11b,0x55] */
    /* 0x12a3: cmp    BYTE PTR [rax-0x3],0x20 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    /* 0x1312: inc    rcx [bpf-jit: inc lowered to add immediate] */
    HC_RAW(BPF_ALU64 | BPF_ADD | BPF_K, BPF_REG_4, 0, 0, 1),
    /* 0x1315: cmp    rcx,0x9 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_4, 0, -89, 9),
