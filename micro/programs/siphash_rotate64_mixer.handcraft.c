...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_LEA_PAYLOAD(HC_X86_RSI, HC_X86_RCX, 0, 0, 1, 0, 72), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KINSN(HC_X86_MEM_PAYLOAD(HC_X86_R9, HC_X86_RCX, 8), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_RDI, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    HC_KINSN(HC_ROTATE_PAYLOAD(HC_X86_RDI, HC_X86_RDI, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    ...
    HC_KINSN(HC_ROTATE_PAYLOAD(HC_X86_RDI, HC_X86_RDI, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    ...
    HC_KINSN(HC_ROTATE_PAYLOAD(HC_X86_RAX, HC_X86_RAX, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R8, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x1186: rol    rdx,0xd [exact-kinsn: rolq imm kinsn] */
    HC_KINSN(HC_ROTATE_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    ...
    HC_KINSN(HC_ROTATE_PAYLOAD(HC_X86_R8, HC_X86_R8, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    ...
    HC_KINSN(HC_ROTATE_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 17), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x11a9: mov    rsi,QWORD PTR [rcx+0x10] [exact-kinsn: direct memory load via x86 kinsn selector] */
    HC_KINSN(HC_X86_MEM_PAYLOAD(HC_X86_RSI, HC_X86_RCX, 16), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x11b7: add    r9,rdx [exact-kinsn: add64 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, HC_X86_RDX), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11ba: rol    rdx,0xd [exact-kinsn: rolq imm kinsn] */
    HC_KINSN(HC_ROTATE_PAYLOAD(HC_X86_RDX, HC_X86_RDX, 13), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    /* 0x11be: xor    r8,rsi [exact-kinsn: xor64 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R8, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_RAX, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11ce: rol    r8,0x10 [exact-kinsn: rolq imm kinsn] */
    HC_KINSN(HC_ROTATE_PAYLOAD(HC_X86_R8, HC_X86_R8, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    ...
    HC_KINSN(HC_ROTATE_PAYLOAD(HC_X86_R8, HC_X86_R8, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    ...
    HC_KINSN(HC_X86_MEM_PAYLOAD(HC_X86_RDI, HC_X86_RCX, 24), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_RSI, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    HC_KINSN(HC_ROTATE_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    HC_KINSN(HC_X86_MEM_PAYLOAD(HC_X86_R8, HC_X86_RCX, 32), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_RSI, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    HC_KINSN(HC_ROTATE_PAYLOAD(HC_X86_RDI, HC_X86_RDI, 32), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    ...
    HC_KINSN(HC_ROTATE_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 16), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    ...
    HC_KINSN(HC_ROTATE_PAYLOAD(HC_X86_RSI, HC_X86_RSI, 21), MICRO_HANDCRAFT_BPF_X86_ROLQ),
    ...
    HC_KINSN(HC_X86_MEM_PAYLOAD(HC_X86_R9, HC_X86_RCX, 40), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KINSN(HC_X86_MEM_PAYLOAD(HC_X86_RSI, HC_X86_RCX, 48), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KINSN(HC_X86_MEM_PAYLOAD(HC_X86_RDI, HC_X86_RCX, 56), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KINSN(HC_X86_MEM_PAYLOAD(HC_X86_R8, HC_X86_RCX, 64), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_RAX, 255), MICRO_HANDCRAFT_BPF_X86_XORQ),
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_RDI, HC_X86_RAX), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KINSN(HC_X86_STORE_PAYLOAD(HC_X86_RDI, HC_X86_RCX, 0), MICRO_HANDCRAFT_BPF_X86_MOVQ),
