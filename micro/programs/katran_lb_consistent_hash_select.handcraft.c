...
static const struct bpf_insn program[] = {
    ...
    /* 0x1136: movabs rax,0x9e3779b97f4a7c15 [exact-bpf: movabs via verifier-visible BPF shadow write] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (598) - 1),
    ...
    /* 0x15b3: movabs rsi,0x200ffff000b [exact-bpf: movabs via verifier-visible BPF shadow write] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (373) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_9, 0, (-555) - 1, 16868362),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, 2),
    HC_LDX(BPF_DW, BPF_REG_6, BPF_REG_10, -376),
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-62) - 1),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_3, BPF_REG_2), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x1849: movabs rsi,0x200ffff000b [exact-bpf: movabs via verifier-visible BPF shadow write] */
    HC_LD_IMM64_RAW(BPF_REG_2, 0, 0x200ffff000bULL),
