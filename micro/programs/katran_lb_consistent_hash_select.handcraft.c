...
static const struct bpf_insn program[] = {
    ...
    /* 0x1113: cmp    rcx,rbx [absorbed-control-flow: cmp folded into following ordinary BPF ja] */
    /* 0x1116: ja     1612 <katran_lb_consistent_hash_select_xdp+0x512> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_4, BPF_REG_6, (638) - 1, 0),
    ...
    /* 0x1120: cmp    rsi,rbx [absorbed-control-flow: cmp folded into following ordinary BPF ja] */
    /* 0x1123: ja     1612 <katran_lb_consistent_hash_select_xdp+0x512> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_2, BPF_REG_6, (635) - 1, 0),
    ...
    /* 0x112d: cmp    rdx,rbx [absorbed-control-flow: cmp folded into following ordinary BPF ja] */
    /* 0x1130: ja     1612 <katran_lb_consistent_hash_select_xdp+0x512> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_3, BPF_REG_6, (632) - 1, 0),
    ...
    /* 0x114a: cmp    esi,0xdd86 [absorbed-control-flow: cmp folded into following ordinary BPF je] */
    /* 0x1150: je     11e5 <katran_lb_consistent_hash_select_xdp+0xe5> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (56) - 1, 56710),
    /* 0x1156: cmp    esi,0x8 [absorbed-control-flow: cmp folded into following ordinary BPF jne] */
    /* 0x1159: jne    1214 <katran_lb_consistent_hash_select_xdp+0x114> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (75) - 1, 8),
    ...
    /* 0x1169: cmp    rsi,rbx [absorbed-control-flow: cmp folded into following ordinary BPF ja] */
    /* 0x116c: ja     15eb <katran_lb_consistent_hash_select_xdp+0x4eb> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_2, BPF_REG_6, (595) - 1, 0),
    ...
    /* 0x1178: cmp    dl,0x5 [absorbed-control-flow: cmp folded into following ordinary BPF jne] */
    /* 0x117b: jne    15eb <katran_lb_consistent_hash_select_xdp+0x4eb> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_MOV64_REG(BPF_REG_6, BPF_REG_3),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, 1, 5),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (587) - 1, 0),
    ...
    /* 0x118f: jne    15eb <katran_lb_consistent_hash_select_xdp+0x4eb> [exact-bpf: jne ordinary BPF branch from preceding or] */
    HC_MOV64_REG(BPF_REG_6, BPF_REG_3),
    HC_ALU64_IMM(BPF_AND, BPF_REG_6, 0xffff),
    HC_RAW(BPF_JMP | BPF_JSET | BPF_K, BPF_REG_6, 0, 1, 65535),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (574) - 1, 0),
    ...
    /* 0x119f: cmp    r14d,0x1 [absorbed-control-flow: cmp folded into following ordinary BPF je] */
    /* 0x11a3: je     1232 <katran_lb_consistent_hash_select_xdp+0x132> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_8, 0, (62) - 1, 1),
    ...
    /* 0x11c3: cmp    r14d,0x11 [absorbed-control-flow: cmp folded into following ordinary BPF je] */
    /* 0x11c7: je     15e2 <katran_lb_consistent_hash_select_xdp+0x4e2> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_8, 0, (548) - 1, 17),
    /* 0x11cd: cmp    r14d,0x6 [absorbed-control-flow: cmp folded into following ordinary BPF jne] */
    /* 0x11d1: jne    1232 <katran_lb_consistent_hash_select_xdp+0x132> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_8, 0, (48) - 1, 6),
    ...
    /* 0x11d7: cmp    r12,rbx [absorbed-control-flow: cmp folded into following ordinary BPF ja] */
    /* 0x11da: ja     15eb <katran_lb_consistent_hash_select_xdp+0x4eb> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_6, HC_X86_R12), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    HC_MOV64_REG(BPF_REG_7, BPF_REG_6),
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_6, BPF_REG_7, 1, 0),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (547) - 1, 0),
    /* 0x11e0: jmp    161d <katran_lb_consistent_hash_select_xdp+0x51d> [exact-bpf: native jmp maps to ordinary BPF JA] */
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (581) - 1, 0),
    ...
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_R9, 1), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x11ef: cmp    rdx,rbx [absorbed-control-flow: cmp folded into following ordinary BPF ja] */
    /* 0x11f2: ja     15eb <katran_lb_consistent_hash_select_xdp+0x4eb> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_3, BPF_REG_6, (541) - 1, 0),
    ...
    /* 0x11fd: cmp    r12d,0x2c [absorbed-control-flow: cmp folded into following ordinary BPF je] */
    /* 0x1201: je     15eb <katran_lb_consistent_hash_select_xdp+0x4eb> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_6, HC_X86_R12), MICRO_HANDCRAFT_BPF_X86_MOVL),
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_6, 0, 1, 44),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (534) - 1, 0),
    /* 0x1207: cmp    r12d,0x3a [absorbed-control-flow: cmp folded into following ordinary BPF jne] */
    /* 0x120b: jne    123d <katran_lb_consistent_hash_select_xdp+0x13d> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_6, HC_X86_R12), MICRO_HANDCRAFT_BPF_X86_MOVL),
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_6, 0, 1, 58),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    ...
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (507) - 1, 0),
    ...
    /* 0x1259: mov    r8d,0xdeadc0ff [exact-kinsn: movl immediate kinsn] */
    ...
    /* 0x1263: mov    esi,0x2 [exact-kinsn: movl immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 2), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1268: cmp    r12d,0x11 [absorbed-control-flow: cmp folded into following ordinary BPF je] */
    /* 0x126c: je     1288 <katran_lb_consistent_hash_select_xdp+0x188> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_6, HC_X86_R12), MICRO_HANDCRAFT_BPF_X86_MOVL),
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_6, 0, 1, 17),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (12) - 1, 0),
    /* 0x126e: cmp    r12d,0x6 [absorbed-control-flow: cmp folded into following ordinary BPF jne] */
    /* 0x1272: jne    1232 <katran_lb_consistent_hash_select_xdp+0x132> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_6, HC_X86_R12), MICRO_HANDCRAFT_BPF_X86_MOVL),
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_6, 0, 1, 6),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (-32) - 1, 0),
    ...
    /* 0x1280: ja     15eb <katran_lb_consistent_hash_select_xdp+0x4eb> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_1, BPF_REG_6, (470) - 1, 0),
    ...
    /* 0x1291: cmp    rdi,rbx [absorbed-control-flow: cmp folded into following ordinary BPF ja] */
    /* 0x1294: ja     15eb <katran_lb_consistent_hash_select_xdp+0x4eb> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_1, BPF_REG_6, (464) - 1, 0),
    /* 0x129a: cmp    r12d,0x6 [absorbed-control-flow: cmp folded into following ordinary BPF jne] */
    /* 0x129e: jne    1232 <katran_lb_consistent_hash_select_xdp+0x132> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_6, HC_X86_R12), MICRO_HANDCRAFT_BPF_X86_MOVL),
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_6, 0, 1, 6),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (-48) - 1, 0),
    /* 0x12a0: cmp    r13d,0x101640a [absorbed-control-flow: cmp folded into following ordinary BPF jne] */
    /* 0x12a7: jne    1232 <katran_lb_consistent_hash_select_xdp+0x132> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_7, 0, (-49) - 1, 16868362),
    ...
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_R9, 2), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12b3: cmp    edi,0x901f [absorbed-control-flow: cmp folded into following ordinary BPF jne] */
    /* 0x12b9: jne    15f0 <katran_lb_consistent_hash_select_xdp+0x4f0> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_1, 0, (455) - 1, 36895),
    ...
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_R9, 1), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12ca: cmp    r10,0x5ea [absorbed-control-flow: cmp folded into following ordinary BPF jg] */
    /* 0x12d1: jg     15f0 <katran_lb_consistent_hash_select_xdp+0x4f0> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_6, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    HC_RAW(BPF_JMP | BPF_JSGT | BPF_K, BPF_REG_6, 0, 1, 1514),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (446) - 1, 0),
    ...
    /* 0x12ee: mov    edi,ebp [exact-kinsn: movl register-to-register kinsn] */
    ...
    /* 0x12fd: mov    r10d,ebp [exact-kinsn: movl register-to-register kinsn] */
    ...
    /* 0x130a: mov    edi,ebp [exact-kinsn: movl register-to-register kinsn] */
    HC_KINSN(HC_X86_ARCH_RR_PAYLOAD(BPF_REG_1, HC_X86_RBP), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    /* 0x13f3: mov    edi,0x70cc0000 [exact-kinsn: movl immediate kinsn] */
    ...
    /* 0x1444: mov    edi,0xffff0001 [exact-kinsn: movl immediate kinsn] */
    ...
    /* 0x1496: mov    ebx,0x901f0000 [exact-kinsn: movl immediate kinsn] */
    ...
    /* 0x15e6: cmp    r12,rbx [absorbed-control-flow: cmp folded into following ordinary BPF jbe] */
    /* 0x15e9: jbe    161d <katran_lb_consistent_hash_select_xdp+0x51d> [exact-bpf: jbe ordinary BPF branch from preceding cmp] */
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_6, HC_X86_R12), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    HC_MOV64_REG(BPF_REG_7, BPF_REG_6),
    HC_RAW(BPF_JMP | BPF_JLE | BPF_X, BPF_REG_6, BPF_REG_7, 1, 0),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    ...
    /* 0x160d: mov    eax,0x2 [exact-kinsn: movl immediate kinsn] */
    ...
    /* 0x161c: ret [abi-boundary: native ret maps to the BPF program exit boundary] */
    HC_EXIT(),
    /* 0x161d: cmp    r15d,0x101640a [absorbed-control-flow: cmp folded into following ordinary BPF jne] */
    /* 0x1624: jne    1232 <katran_lb_consistent_hash_select_xdp+0x132> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_9, 0, (-542) - 1, 16868362),
    ...
    /* 0x162f: cmp    r9d,0x901f [absorbed-control-flow: cmp folded into following ordinary BPF jne] */
    /* 0x1636: jne    1232 <katran_lb_consistent_hash_select_xdp+0x132> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_6, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_6, 0, 1, 36895),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (-549) - 1, 0),
    /* 0x163c: mov    r9d,0x2 [exact-kinsn: movl immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_R9, 2), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1642: cmp    r14b,0x6 [absorbed-control-flow: cmp folded into following ordinary BPF jne] */
    /* 0x1646: jne    15f0 <katran_lb_consistent_hash_select_xdp+0x4f0> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_MOV64_REG(BPF_REG_6, BPF_REG_8),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, 1, 6),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (-46) - 1, 0),
    /* 0x1648: mov    esi,0x1 [exact-kinsn: movl immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 1), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x164d: mov    r9d,0x1 [exact-kinsn: movl immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_R9, 1), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1653: cmp    r10,0x5ea [absorbed-control-flow: cmp folded into following ordinary BPF jg] */
    /* 0x165a: jg     15f0 <katran_lb_consistent_hash_select_xdp+0x4f0> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_6, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    HC_RAW(BPF_JMP | BPF_JSGT | BPF_K, BPF_REG_6, 0, 1, 1514),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R10, -525483785), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1688: mov    ebp,0x70cc0000 [exact-kinsn: movl immediate kinsn] */
    ...
    /* 0x16a8: mov    r14d,ebp [exact-kinsn: movl register-to-register kinsn] */
    ...
    /* 0x16de: mov    ebx,0xffff0001 [exact-kinsn: movl immediate kinsn] */
    ...
    /* 0x16eb: mov    ebp,ebx [exact-kinsn: movl register-to-register kinsn] */
    ...
    /* 0x1730: mov    r14d,0x901f0000 [exact-kinsn: movl immediate kinsn] */
    ...
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (-368) - 1, 0),
};
