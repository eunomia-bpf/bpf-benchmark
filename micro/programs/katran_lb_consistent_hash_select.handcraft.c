...
static const struct bpf_insn program[] = {
    ...
    /* 0x1114: cmp    rcx,rbx [exact-kinsn: cmpq reg,reg kinsn] */
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_4, BPF_REG_6, (711) - 1, 0),
    ...
    /* 0x1121: cmp    rsi,rbx [exact-kinsn: cmpq reg,reg kinsn] */
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_2, BPF_REG_6, (706) - 1, 0),
    ...
    /* 0x112e: cmp    rdx,rbx [exact-kinsn: cmpq reg,reg kinsn] */
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_3, BPF_REG_6, (701) - 1, 0),
    /* 0x1137: movabs rax,0x9e3779b97f4a7c15 [exact-bpf: movabs via verifier-visible BPF shadow write] */
    ...
    /* 0x114b: cmp    esi,0xdd86 [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (82) - 1, 56710),
    /* 0x1157: cmp    esi,0x8 [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (109) - 1, 8),
    ...
    /* 0x1179: cmp    dl,0x5 [exact-kinsn: cmpb reg,imm8 kinsn] */
    ...
    HC_LDX(BPF_DW, BPF_REG_6, BPF_REG_10, -376),
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (644) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, 2),
    HC_LDX(BPF_DW, BPF_REG_6, BPF_REG_10, -376),
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (628) - 1),
    ...
    /* 0x11a0: cmp    r14d,0x1 [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_8, 0, (83) - 1, 1),
    ...
    /* 0x11c4: cmp    r14d,0x11 [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_8, 0, (591) - 1, 17),
    /* 0x11ce: cmp    r14d,0x6 [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_8, 0, (65) - 1, 6),
    ...
    /* 0x11d8: cmp    r12,rbx [exact-kinsn: cmpq reg,reg kinsn] */
    ...
    /* 0x11fe: cmp    r12d,0x2c [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, 2),
    HC_LDX(BPF_DW, BPF_REG_6, BPF_REG_10, -376),
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (569) - 1),
    /* 0x1208: cmp    r12d,0x3a [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (538) - 1),
    ...
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 2), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1269: cmp    r12d,0x11 [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    /* 0x126f: cmp    r12d,0x6 [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_1, BPF_REG_6, (491) - 1, 0),
    ...
    /* 0x1290: cmp    rdi,rbx [exact-kinsn: cmpq reg,reg kinsn] */
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_1, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_CMPQ),
    /* 0x1293: ja     15e9 <katran_lb_consistent_hash_select_xdp+0x4e9> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_1, BPF_REG_6, (483) - 1, 0),
    /* 0x1299: cmp    r12d,0x6 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_R12, 6), MICRO_HANDCRAFT_BPF_X86_CMPL),
    ...
    /* 0x129f: cmp    r13d,0x101640a [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_7, 0, (-67) - 1, 16868362),
    ...
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_R9, 2), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12b2: cmp    edi,0x901f [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_1, 0, (466) - 1, 36895),
    ...
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_R9, 1), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x12c9: cmp    r10,0x5ea [exact-kinsn: cmpq reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, 2),
    HC_LDX(BPF_DW, BPF_REG_6, BPF_REG_10, -376),
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (453) - 1),
    ...
    /* 0x15b1: movabs rsi,0x200ffff000b [exact-bpf: movabs via verifier-visible BPF shadow write] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (386) - 1),
    ...
    /* 0x15e4: cmp    r12,rbx [exact-kinsn: cmpq reg,reg kinsn] */
    HC_KINSN(HC_X86_RR_PAYLOAD(HC_X86_R12, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_CMPQ),
    ...
    HC_EXIT(),
    /* 0x161f: cmp    r15d,0x101640a [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_9, 0, (-577) - 1, 16868362),
    ...
    HC_KINSN(HC_X86_IMM_PAYLOAD(HC_X86_R9, 2), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1644: cmp    r14b,0x6 [exact-kinsn: cmpb reg,imm8 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, 2),
    HC_LDX(BPF_DW, BPF_REG_6, BPF_REG_10, -376),
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-73) - 1),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_3, BPF_REG_2), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x184b: movabs rsi,0x200ffff000b [exact-bpf: movabs via verifier-visible BPF shadow write] */
    HC_LD_IMM64_RAW(BPF_REG_2, 0, 0x200ffff000bULL),
