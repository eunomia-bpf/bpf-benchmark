...
/home/yunwei37/workspace/bpf-benchmark/micro/results/x86_kvm_micro_20260515_033620_169457/details/jit_dumps/packed_header_bitfield_decode_handcraft__kernel__sample00.jited.bin:     file format binary
...
0000000000000000 <.data>:
  ...
  1e:	48 81 c6 08 02 00 00 	add    rsi,0x208
  ...
  2f:	c9                   	leave
  30:	c3                   	ret
  31:	48 8b 7b 08          	mov    rdi,QWORD PTR [rbx+0x8]
  35:	48 89 f8             	mov    rax,rdi
  38:	48 c1 e8 0b          	shr    rax,0xb
  3c:	81 e0 ff 07 00 00    	and    eax,0x7ff
  42:	48 89 fe             	mov    rsi,rdi
  45:	48 c1 ee 1e          	shr    rsi,0x1e
  49:	81 e6 ff 3f 00 00    	and    esi,0x3fff
  4f:	48 01 f0             	add    rax,rsi
  52:	48 89 43 f8          	mov    QWORD PTR [rbx-0x8],rax
  56:	b8 02 00 00 00       	mov    eax,0x2
  5b:	eb cf                	jmp    0x2c
```
