...
static const struct bpf_insn program[] = {
    ...
    HC_JMP_REG(BPF_JGT, BPF_REG_4, BPF_REG_3, 13),
    ...
    HC_JMP_REG(BPF_JGT, BPF_REG_2, BPF_REG_3, 10),
    ...
    /* 0x111b: cmp    rsi,rdx [cmp-state: sets flags; materialized by following jcc when possible] */
...
0000000000000000 <.data>:
  ...
  22:	77 23                	ja     0x47
  24:	48 8d 71 48          	lea    rsi,[rcx+0x48]
  28:	48 39 d6             	cmp    rsi,rdx
  2b:	77 1a                	ja     0x47
  2d:	66 c7 41 00 4e 61    	mov    WORD PTR [rcx+0x0],0x614e
  33:	c6 41 02 bc          	mov    BYTE PTR [rcx+0x2],0xbc
  37:	c7 41 03 00 00 00 00 	mov    DWORD PTR [rcx+0x3],0x0
  3e:	c6 41 07 00          	mov    BYTE PTR [rcx+0x7],0x0
  42:	b8 02 00 00 00       	mov    eax,0x2
  47:	c9                   	leave
  48:	c3                   	ret
```
