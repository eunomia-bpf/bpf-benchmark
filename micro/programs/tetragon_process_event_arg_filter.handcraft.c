...
static const struct bpf_insn program[] = {
    ...
    /* 0x110c: jbe    110f <tetragon_process_event_arg_filter_xdp+0xf> [exact-kinsn: jbe branch kinsn] */
    ...
    /* 0x1116: ja     110e <tetragon_process_event_arg_filter_xdp+0xe> [exact-kinsn: ja branch kinsn] */
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_3, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_CMPQ),
    /* 0x1122: ja     110e <tetragon_process_event_arg_filter_xdp+0xe> [exact-kinsn: ja branch kinsn] */
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(18, 44, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    /* 0x1178: je     13ee <tetragon_process_event_arg_filter_xdp+0x2ee> [exact-kinsn: je branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(307, 624, 1), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    /* 0x1192: ja     11b2 <tetragon_process_event_arg_filter_xdp+0xb2> [exact-kinsn: ja branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(11, 30, 0), MICRO_HANDCRAFT_BPF_X86_JA),
    /* 0x1194: lea    rsi,[rip+0xe65] [warning-unmapped: LEA base/index not in BPF register file: [rip+0xe65]] */
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(26, 62, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(20, 55, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(15, 41, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(10, 27, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(5, 13, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    /* 0x1229: je     1240 <tetragon_process_event_arg_filter_xdp+0x140> [exact-kinsn: je branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(10, 21, 0), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    /* 0x1231: jne    1250 <tetragon_process_event_arg_filter_xdp+0x150> [exact-kinsn: jne branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(10, 29, 0), MICRO_HANDCRAFT_BPF_X86_JNE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(20, 70, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(16, 57, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    /* 0x1262: je     1280 <tetragon_process_event_arg_filter_xdp+0x180> [exact-kinsn: je branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(10, 28, 0), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-123, -300, 1), MICRO_HANDCRAFT_BPF_X86_JNE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(30, 55, 0), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(24, 47, 0), MICRO_HANDCRAFT_BPF_X86_JNE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-187, -428, 1), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(34, 47, 0), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(30, 43, 0), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-311, -641, 1), MICRO_HANDCRAFT_BPF_X86_JMP),
