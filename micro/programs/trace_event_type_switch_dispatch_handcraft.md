...
/home/yunwei37/workspace/bpf-benchmark/micro/results/x86_kvm_micro_20260515_033620_169457/details/jit_dumps/trace_event_type_switch_dispatch_handcraft__kernel__sample00.jited.bin:     file format binary
...
0000000000000000 <.data>:
  ...
  1e:	48 81 c6 04 02 00 00 	add    rsi,0x204
  ...
  2f:	c9                   	leave
  30:	c3                   	ret
  31:	8b 53 04             	mov    edx,DWORD PTR [rbx+0x4]
  34:	b8 2b 00 00 00       	mov    eax,0x2b
  39:	be 38 00 00 00       	mov    esi,0x38
  3e:	48 85 d2             	test   rdx,rdx
  41:	48 0f 45 c6          	cmovne rax,rsi
  45:	48 89 43 f8          	mov    QWORD PTR [rbx-0x8],rax
  49:	b8 02 00 00 00       	mov    eax,0x2
  4e:	eb dc                	jmp    0x2c
```
