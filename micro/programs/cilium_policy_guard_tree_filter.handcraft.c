 ...
 * - 0x11c7: and    r9b,0x18 [warning-reg-remap: andb imm kinsn; verifier instantiate uses temp BPF_REG_8; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x1220: and    r10b,0x3 [warning-reg-remap: andb imm kinsn; verifier instantiate uses temp BPF_REG_8; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
...
static const struct bpf_insn program[] = {
    ...
    /* 0x1159: and    al,0x7 [exact-kinsn: andb imm kinsn; verifier instantiate uses temp BPF_REG_8] */
    HC_KINSN(HC_REG_IMM_TMP_PAYLOAD(BPF_REG_0, 7, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_ANDB_IMM),
    ...
    /* 0x1164: not    al [exact-kinsn: notb reg kinsn; verifier instantiate uses temp BPF_REG_8] */
    HC_KINSN(HC_NOT_NARROW_PAYLOAD(BPF_REG_0, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_NOTB_R),
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_5, 0, 61, 32),
    ...
    /* 0x11c7: and    r9b,0x18 [warning-reg-remap: andb imm kinsn; verifier instantiate uses temp BPF_REG_8; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KINSN(HC_REG_IMM_TMP_PAYLOAD(BPF_REG_9, 24, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_ANDB_IMM),
    /* 0x11cb: cmp    r9b,0x10 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    r9b,0x10] */
    ...
    HC_KINSN(HC_REG_IMM_PAYLOAD(BPF_REG_9, 170), MICRO_HANDCRAFT_BPF_X86_CMPL_IMM32),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_9, 0, 18, 170),
    /* 0x11df: xor    rcx,rax [bpf-jit: ALU reg operation] */
    HC_RAW(BPF_ALU64 | BPF_XOR | BPF_X, BPF_REG_4, BPF_REG_0, 0, 0),
    /* 0x11e2: shld   rcx,rax,0x7 [exact-kinsn: shld imm kinsn; verifier instantiate uses temp BPF_REG_8] */
    HC_KINSN(HC_SHD_PAYLOAD(BPF_REG_4, BPF_REG_0, 7, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_SHLDQ_IMM),
    ...
    /* 0x1220: and    r10b,0x3 [warning-reg-remap: andb imm kinsn; verifier instantiate uses temp BPF_REG_8; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KINSN(HC_REG_IMM_TMP_PAYLOAD(BPF_REG_7, 3, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_ANDB_IMM),
    /* 0x1224: cmp    r10b,0x1 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    r10b,0x1] */
