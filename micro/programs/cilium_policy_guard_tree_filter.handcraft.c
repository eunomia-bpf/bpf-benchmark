...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_0, BPF_REG_1, -7), MICRO_HANDCRAFT_BPF_X86_MOVQ),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(HC_X86_R9, BPF_REG_1, -13), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(HC_X86_R9, BPF_REG_1, -12), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(HC_X86_R9, BPF_REG_1, -11), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    /* 0x11b8: add    cl,r9b [warning-unmapped: add    cl,r9b needs a shadow-aware ALU kinsn] */
    /* 0x11bb: cmp    cl,0xbf [warning-unmapped: CMP operand form has no current kinsn selector: cmp    cl,0xbf] */
    ...
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_1, -10), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(HC_X86_R9, BPF_REG_1, -9), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
