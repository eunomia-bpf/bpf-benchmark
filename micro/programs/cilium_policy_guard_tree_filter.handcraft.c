 ...
 * - 0x110c: jbe    110f <cilium_policy_guard_tree_filter_xdp+0xf> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1116: ja     110e <cilium_policy_guard_tree_filter_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1122: ja     110e <cilium_policy_guard_tree_filter_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1127: jne    110e <cilium_policy_guard_tree_filter_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x113b: jmp    117f <cilium_policy_guard_tree_filter_xdp+0x7f> [warning-unmapped: needs a machine-level x86 branch kinsn]
 * - 0x1179: je     1234 <cilium_policy_guard_tree_filter_xdp+0x134> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x118b: jb     1150 <cilium_policy_guard_tree_filter_xdp+0x50> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1196: je     11f9 <cilium_policy_guard_tree_filter_xdp+0xf9> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x11a0: js     11ef <cilium_policy_guard_tree_filter_xdp+0xef> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x11b1: jb     11f5 <cilium_policy_guard_tree_filter_xdp+0xf5> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x11be: ja     1204 <cilium_policy_guard_tree_filter_xdp+0x104> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x11cf: jne    1210 <cilium_policy_guard_tree_filter_xdp+0x110> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x11dd: jne    1219 <cilium_policy_guard_tree_filter_xdp+0x119> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x11ea: jmp    1156 <cilium_policy_guard_tree_filter_xdp+0x56> [warning-unmapped: needs a machine-level x86 branch kinsn]
 * - 0x11f3: jmp    1208 <cilium_policy_guard_tree_filter_xdp+0x108> [warning-unmapped: needs a machine-level x86 branch kinsn]
 * - 0x11ff: jmp    1156 <cilium_policy_guard_tree_filter_xdp+0x56> [warning-unmapped: needs a machine-level x86 branch kinsn]
 * - 0x120b: jmp    1153 <cilium_policy_guard_tree_filter_xdp+0x53> [warning-unmapped: needs a machine-level x86 branch kinsn]
 * - 0x1217: jmp    11fc <cilium_policy_guard_tree_filter_xdp+0xfc> [warning-unmapped: needs a machine-level x86 branch kinsn]
 * - 0x1228: je     113d <cilium_policy_guard_tree_filter_xdp+0x3d> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1232: jmp    11f9 <cilium_policy_guard_tree_filter_xdp+0xf9> [warning-unmapped: needs a machine-level x86 branch kinsn]
 */
