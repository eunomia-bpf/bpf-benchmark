...
static const struct bpf_insn program[] = {
    ...
    /* 0x110c: jbe    110f <cilium_policy_guard_tree_filter_xdp+0xf> [exact-kinsn: jbe branch kinsn] */
    ...
    /* 0x1116: ja     110e <cilium_policy_guard_tree_filter_xdp+0xe> [exact-kinsn: ja branch kinsn] */
    ...
    /* 0x1122: ja     110e <cilium_policy_guard_tree_filter_xdp+0xe> [exact-kinsn: ja branch kinsn] */
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(34, 66, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    /* 0x1179: je     1234 <cilium_policy_guard_tree_filter_xdp+0x134> [exact-kinsn: je branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(102, 181, 1), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    /* 0x118b: jb     1150 <cilium_policy_guard_tree_filter_xdp+0x50> [exact-kinsn: jb branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-36, -61, 0), MICRO_HANDCRAFT_BPF_X86_JB),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(56, 97, 0), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(44, 77, 0), MICRO_HANDCRAFT_BPF_X86_JS),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(38, 66, 0), MICRO_HANDCRAFT_BPF_X86_JB),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(38, 68, 0), MICRO_HANDCRAFT_BPF_X86_JA),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(34, 63, 0), MICRO_HANDCRAFT_BPF_X86_JNE),
    ...
    /* 0x11dd: jne    1219 <cilium_policy_guard_tree_filter_xdp+0x119> [exact-kinsn: jne branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(34, 58, 0), MICRO_HANDCRAFT_BPF_X86_JNE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(12, 19, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-126, -241, 1), MICRO_HANDCRAFT_BPF_X86_JE),
