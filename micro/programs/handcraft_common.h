...
#define HC_X86_SHADOW_RAX_OFF -512
#define HC_X86_SHADOW_RCX_OFF -504
#define HC_X86_SHADOW_RDX_OFF -496
#define HC_X86_SHADOW_RBX_OFF -488
#define HC_X86_SHADOW_RSP_OFF -480
#define HC_X86_SHADOW_RBP_OFF -472
#define HC_X86_SHADOW_RSI_OFF -464
#define HC_X86_SHADOW_RDI_OFF -456
#define HC_X86_SHADOW_R8_OFF  -448
#define HC_X86_SHADOW_R9_OFF  -440
#define HC_X86_SHADOW_R10_OFF -432
#define HC_X86_SHADOW_R11_OFF -424
#define HC_X86_SHADOW_R12_OFF -416
#define HC_X86_SHADOW_R13_OFF -408
#define HC_X86_SHADOW_R14_OFF -400
#define HC_X86_SHADOW_R15_OFF -392
#define HC_X86_SHADOW_ZF_OFF  -384
#define HC_X86_SHADOW_CF_OFF  -380
#define HC_X86_SHADOW_GE_OFF  -352
#define HC_X86_SHADOW_SF_OFF  -348
#define HC_X86_BRANCH_LHS_OFF -344
#define HC_X86_BRANCH_RHS_OFF -336
...
#define HC_CMOV_PAYLOAD(DST, SRC) ((__u64)(DST) | ((__u64)(SRC) << 4))
#define HC_SETCC_PAYLOAD(DST) ((__u64)(DST))
...
#define HC_INIT_X86_STACK() \
    ...
    HC_STX(BPF_DW, BPF_REG_10, BPF_REG_6, HC_X86_SHADOW_RSP_OFF), \
    HC_STX(BPF_DW, BPF_REG_10, BPF_REG_1, HC_X86_SHADOW_RDI_OFF)
