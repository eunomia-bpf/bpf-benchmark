...
#define HC_X86_BRANCH_PROOF_FLAGS 0
#define HC_X86_BRANCH_PROOF_CMP_RR 1
#define HC_X86_BRANCH_PROOF_PAYLOAD(PC_DELTA, X86_DISP, NEAR, IS32, PROOF) \
    (((__u64)(NEAR) & 1) | (((__u64)(IS32) & 1) << 1) | \
     (((__u64)(PROOF) & 3) << 2) | ((__u64)(__u16)(PC_DELTA) << 4) | \
     ((__u64)(__u32)(X86_DISP) << 20))
#define HC_X86_BRANCH_PAYLOAD(PC_DELTA, X86_DISP, NEAR) \
    HC_X86_BRANCH_PROOF_PAYLOAD(PC_DELTA, X86_DISP, NEAR, 0, HC_X86_BRANCH_PROOF_FLAGS)
