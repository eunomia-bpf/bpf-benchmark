...
static const struct bpf_insn program[] = {
    ...
    /* 0x1124: cmp    DWORD PTR [rsi],0x80 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, -9, 128),
    ...
    /* 0x1147: cmp    rsi,0x20f [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_2, 0, 10, 527),
    ...
    /* 0x115d: cmp    r8d,0x3f [cmp-state: sets flags; materialized by following jcc when possible] */
