...
static const struct bpf_insn program[] = {
    ...
    /* 0x110c: jbe    110f <trace_event_type_switch_dispatch_xdp+0xf> [exact-kinsn: jbe branch kinsn; verifier proof from preceding cmp] */
    ...
    /* 0x1116: ja     110e <trace_event_type_switch_dispatch_xdp+0xe> [exact-kinsn: ja branch kinsn; verifier proof from preceding cmp] */
    ...
    /* 0x1122: ja     110e <trace_event_type_switch_dispatch_xdp+0xe> [exact-kinsn: ja branch kinsn; verifier proof from preceding cmp] */
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(34, 20, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    /* 0x114e: je     116c <trace_event_type_switch_dispatch_xdp+0x6c> [exact-kinsn: je branch kinsn; verifier proof from preceding cmp] */
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(79, 28, 0, 0, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    /* 0x1161: ja     1140 <trace_event_type_switch_dispatch_xdp+0x40> [exact-kinsn: ja branch kinsn; verifier proof from preceding cmp] */
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(-67, -35, 0, 1, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JA),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-97, -44, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
