...
static const struct bpf_insn program[] = {
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_2, BPF_REG_3, (-5) - 1, 0),
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_1, BPF_REG_3, (-10) - 1, 0),
    ...
    /* 0x1147: cmp    rdx,0x20f [exact-kinsn: cmpq reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_3, 527), MICRO_HANDCRAFT_BPF_X86_CMPQ),
    /* 0x114e: je     172a <trace_event_type_switch_dispatch_xdp+0x62a> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_3, 0, (482) - 1, 527),
    ...
    /* 0x115b: cmp    esi,0x1f [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 31), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x115e: jg     11a0 <trace_event_type_switch_dispatch_xdp+0xa0> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (25) - 1, 31),
    /* 0x1160: cmp    esi,0xf [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 15), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1163: jg     11e0 <trace_event_type_switch_dispatch_xdp+0xe0> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (43) - 1, 15),
    /* 0x1165: cmp    esi,0x7 [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (76) - 1, 7),
    /* 0x116e: cmp    esi,0x3 [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (133) - 1, 3),
    /* 0x1177: cmp    esi,0x1 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 1), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x117a: jg     1434 <trace_event_type_switch_dispatch_xdp+0x334> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (226) - 1, 1),
    ...
    /* 0x1185: test   esi,esi [exact-kinsn: testl reg,reg kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-31) - 1),
    /* 0x1189: cmp    esi,0x1 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 1), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x118c: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (451) - 1, 1),
    ...
    /* 0x11a0: cmp    esi,0x2f [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 47), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x11a3: jg     1220 <trace_event_type_switch_dispatch_xdp+0x120> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (37) - 1, 47),
    /* 0x11a5: cmp    esi,0x27 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 39), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x11a8: jg     1282 <trace_event_type_switch_dispatch_xdp+0x182> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (67) - 1, 39),
    /* 0x11ae: cmp    esi,0x23 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 35), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x11b1: jg     1331 <trace_event_type_switch_dispatch_xdp+0x231> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (121) - 1, 35),
    /* 0x11b7: cmp    esi,0x21 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 33), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x11ba: jg     1450 <trace_event_type_switch_dispatch_xdp+0x350> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (211) - 1, 33),
    /* 0x11c0: cmp    esi,0x20 [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (343) - 1, 32),
    /* 0x11c9: cmp    esi,0x21 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 33), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x11cc: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (430) - 1, 33),
    ...
    /* 0x11e0: cmp    esi,0x17 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 23), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x11e3: jg     12b0 <trace_event_type_switch_dispatch_xdp+0x1b0> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (64) - 1, 23),
    /* 0x11e9: cmp    esi,0x13 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 19), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x11ec: jg     1356 <trace_event_type_switch_dispatch_xdp+0x256> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (115) - 1, 19),
    /* 0x11f2: cmp    esi,0x11 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 17), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x11f5: jg     146c <trace_event_type_switch_dispatch_xdp+0x36c> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (202) - 1, 17),
    /* 0x11fb: cmp    esi,0x10 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 16), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x11fe: je     15fe <trace_event_type_switch_dispatch_xdp+0x4fe> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (328) - 1, 16),
    /* 0x1204: cmp    esi,0x11 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 17), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1207: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (412) - 1, 17),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-76) - 1),
    /* 0x1217: nop    WORD PTR [rax+rax*1+0x0] [padding: padding is not part of BPF semantics] */
    /* 0x1220: cmp    esi,0x37 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 55), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1223: jg     12de <trace_event_type_switch_dispatch_xdp+0x1de> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (61) - 1, 55),
    /* 0x1229: cmp    esi,0x33 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 51), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x122c: jg     137b <trace_event_type_switch_dispatch_xdp+0x27b> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (109) - 1, 51),
    /* 0x1232: cmp    esi,0x31 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 49), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1235: jg     1488 <trace_event_type_switch_dispatch_xdp+0x388> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (193) - 1, 49),
    /* 0x123b: cmp    esi,0x30 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 48), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x123e: je     1608 <trace_event_type_switch_dispatch_xdp+0x508> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (313) - 1, 48),
    /* 0x1244: cmp    esi,0x31 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 49), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1247: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (394) - 1, 49),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-94) - 1),
    /* 0x1254: cmp    esi,0xb [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 11), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1257: jg     13a0 <trace_event_type_switch_dispatch_xdp+0x2a0> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (106) - 1, 11),
    /* 0x125d: cmp    esi,0x9 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 9), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1260: jg     14a4 <trace_event_type_switch_dispatch_xdp+0x3a4> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (187) - 1, 9),
    /* 0x1266: cmp    esi,0x8 [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (301) - 1, 8),
    /* 0x126f: cmp    esi,0x9 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 9), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1272: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (379) - 1, 9),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-109) - 1),
    /* 0x1282: cmp    esi,0x2b [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 43), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1285: jg     13c5 <trace_event_type_switch_dispatch_xdp+0x2c5> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (103) - 1, 43),
    /* 0x128b: cmp    esi,0x29 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 41), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x128e: jg     14c0 <trace_event_type_switch_dispatch_xdp+0x3c0> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (181) - 1, 41),
    /* 0x1294: cmp    esi,0x28 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 40), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1297: je     161c <trace_event_type_switch_dispatch_xdp+0x51c> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (289) - 1, 40),
    /* 0x129d: cmp    esi,0x29 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 41), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x12a0: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (364) - 1, 41),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-124) - 1),
    /* 0x12b0: cmp    esi,0x1b [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 27), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x12b3: jg     13ea <trace_event_type_switch_dispatch_xdp+0x2ea> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (100) - 1, 27),
    /* 0x12b9: cmp    esi,0x19 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 25), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x12bc: jg     14dc <trace_event_type_switch_dispatch_xdp+0x3dc> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (175) - 1, 25),
    /* 0x12c2: cmp    esi,0x18 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 24), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x12c5: je     1626 <trace_event_type_switch_dispatch_xdp+0x526> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (277) - 1, 24),
    /* 0x12cb: cmp    esi,0x19 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 25), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x12ce: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (349) - 1, 25),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-139) - 1),
    /* 0x12de: cmp    esi,0x3b [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 59), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x12e1: jg     140f <trace_event_type_switch_dispatch_xdp+0x30f> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (97) - 1, 59),
    /* 0x12e7: cmp    esi,0x39 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 57), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x12ea: jg     14f8 <trace_event_type_switch_dispatch_xdp+0x3f8> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (169) - 1, 57),
    /* 0x12f0: cmp    esi,0x38 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 56), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x12f3: je     1630 <trace_event_type_switch_dispatch_xdp+0x530> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (265) - 1, 56),
    /* 0x12f9: cmp    esi,0x39 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 57), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x12fc: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (334) - 1, 57),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-154) - 1),
    /* 0x130c: cmp    esi,0x5 [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (166) - 1, 5),
    /* 0x1315: cmp    esi,0x4 [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (256) - 1, 4),
    /* 0x131e: cmp    esi,0x5 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 5), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1321: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (322) - 1, 5),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-166) - 1),
    /* 0x1331: cmp    esi,0x25 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 37), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1334: jg     1530 <trace_event_type_switch_dispatch_xdp+0x430> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (163) - 1, 37),
    /* 0x133a: cmp    esi,0x24 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 36), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x133d: je     1644 <trace_event_type_switch_dispatch_xdp+0x544> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (247) - 1, 36),
    /* 0x1343: cmp    esi,0x25 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 37), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1346: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (310) - 1, 37),
    ...
    /* 0x1356: cmp    esi,0x15 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 21), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1359: jg     154c <trace_event_type_switch_dispatch_xdp+0x44c> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (160) - 1, 21),
    /* 0x135f: cmp    esi,0x14 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 20), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1362: je     164e <trace_event_type_switch_dispatch_xdp+0x54e> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (238) - 1, 20),
    /* 0x1368: cmp    esi,0x15 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 21), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x136b: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (298) - 1, 21),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-190) - 1),
    /* 0x137b: cmp    esi,0x35 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 53), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x137e: jg     1568 <trace_event_type_switch_dispatch_xdp+0x468> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (157) - 1, 53),
    /* 0x1384: cmp    esi,0x34 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 52), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1387: je     1658 <trace_event_type_switch_dispatch_xdp+0x558> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (229) - 1, 52),
    /* 0x138d: cmp    esi,0x35 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 53), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1390: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (286) - 1, 53),
    ...
    /* 0x13a0: cmp    esi,0xd [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 13), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x13a3: jg     1584 <trace_event_type_switch_dispatch_xdp+0x484> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (154) - 1, 13),
    /* 0x13a9: cmp    esi,0xc [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 12), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x13ac: je     1662 <trace_event_type_switch_dispatch_xdp+0x562> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (220) - 1, 12),
    /* 0x13b2: cmp    esi,0xd [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 13), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x13b5: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (274) - 1, 13),
    ...
    /* 0x13c5: cmp    esi,0x2d [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 45), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x13c8: jg     15a0 <trace_event_type_switch_dispatch_xdp+0x4a0> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (151) - 1, 45),
    /* 0x13ce: cmp    esi,0x2c [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 44), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x13d1: je     166c <trace_event_type_switch_dispatch_xdp+0x56c> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (211) - 1, 44),
    /* 0x13d7: cmp    esi,0x2d [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 45), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x13da: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (262) - 1, 45),
    ...
    /* 0x13ea: cmp    esi,0x1d [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 29), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x13ed: jg     15bc <trace_event_type_switch_dispatch_xdp+0x4bc> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (148) - 1, 29),
    /* 0x13f3: cmp    esi,0x1c [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 28), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x13f6: je     1676 <trace_event_type_switch_dispatch_xdp+0x576> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (202) - 1, 28),
    /* 0x13fc: cmp    esi,0x1d [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 29), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x13ff: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (250) - 1, 29),
    ...
    /* 0x140f: cmp    esi,0x3d [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 61), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1412: jg     15d8 <trace_event_type_switch_dispatch_xdp+0x4d8> [exact-bpf: jg ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JSGT | BPF_K, BPF_REG_2, 0, (145) - 1, 61),
    /* 0x1418: cmp    esi,0x3c [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 60), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x141b: je     1680 <trace_event_type_switch_dispatch_xdp+0x580> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (193) - 1, 60),
    /* 0x1421: cmp    esi,0x3d [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 61), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1424: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (238) - 1, 61),
    ...
    /* 0x1434: cmp    esi,0x2 [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (187) - 1, 2),
    /* 0x143d: cmp    esi,0x3 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 3), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1440: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (229) - 1, 3),
    ...
    /* 0x1450: cmp    esi,0x22 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 34), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1453: je     1694 <trace_event_type_switch_dispatch_xdp+0x594> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (181) - 1, 34),
    /* 0x1459: cmp    esi,0x23 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 35), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x145c: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (220) - 1, 35),
    ...
    /* 0x146c: cmp    esi,0x12 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 18), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x146f: je     169e <trace_event_type_switch_dispatch_xdp+0x59e> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (175) - 1, 18),
    /* 0x1475: cmp    esi,0x13 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 19), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1478: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (211) - 1, 19),
    ...
    /* 0x1488: cmp    esi,0x32 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 50), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x148b: je     16a8 <trace_event_type_switch_dispatch_xdp+0x5a8> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (169) - 1, 50),
    /* 0x1491: cmp    esi,0x33 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 51), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1494: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (202) - 1, 51),
    ...
    /* 0x14a4: cmp    esi,0xa [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 10), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x14a7: je     16b2 <trace_event_type_switch_dispatch_xdp+0x5b2> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (163) - 1, 10),
    /* 0x14ad: cmp    esi,0xb [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 11), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x14b0: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (193) - 1, 11),
    ...
    /* 0x14c0: cmp    esi,0x2a [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 42), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x14c3: je     16bc <trace_event_type_switch_dispatch_xdp+0x5bc> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (157) - 1, 42),
    /* 0x14c9: cmp    esi,0x2b [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 43), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x14cc: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (184) - 1, 43),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-304) - 1),
    /* 0x14dc: cmp    esi,0x1a [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 26), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x14df: je     16c6 <trace_event_type_switch_dispatch_xdp+0x5c6> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (151) - 1, 26),
    /* 0x14e5: cmp    esi,0x1b [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 27), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x14e8: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (175) - 1, 27),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-313) - 1),
    /* 0x14f8: cmp    esi,0x3a [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 58), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x14fb: je     16d0 <trace_event_type_switch_dispatch_xdp+0x5d0> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (145) - 1, 58),
    /* 0x1501: cmp    esi,0x3b [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 59), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1504: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (166) - 1, 59),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-322) - 1),
    /* 0x1514: cmp    esi,0x6 [exact-kinsn: cmpl reg,imm32 kinsn] */
    ...
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (139) - 1, 6),
    /* 0x151d: cmp    esi,0x7 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 7), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1520: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (157) - 1, 7),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-331) - 1),
    /* 0x1530: cmp    esi,0x26 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 38), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1533: je     16e4 <trace_event_type_switch_dispatch_xdp+0x5e4> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (133) - 1, 38),
    /* 0x1539: cmp    esi,0x27 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 39), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x153c: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (148) - 1, 39),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-340) - 1),
    /* 0x154c: cmp    esi,0x16 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 22), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x154f: je     16ee <trace_event_type_switch_dispatch_xdp+0x5ee> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (127) - 1, 22),
    /* 0x1555: cmp    esi,0x17 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 23), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1558: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (139) - 1, 23),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-349) - 1),
    /* 0x1568: cmp    esi,0x36 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 54), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x156b: je     16f8 <trace_event_type_switch_dispatch_xdp+0x5f8> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (121) - 1, 54),
    /* 0x1571: cmp    esi,0x37 [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 55), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1574: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (130) - 1, 55),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-358) - 1),
    /* 0x1584: cmp    esi,0xe [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 14), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1587: je     1702 <trace_event_type_switch_dispatch_xdp+0x602> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (115) - 1, 14),
    /* 0x158d: cmp    esi,0xf [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 15), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x1590: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (121) - 1, 15),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-367) - 1),
    /* 0x15a0: cmp    esi,0x2e [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 46), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x15a3: je     170c <trace_event_type_switch_dispatch_xdp+0x60c> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (109) - 1, 46),
    /* 0x15a9: cmp    esi,0x2f [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 47), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x15ac: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (112) - 1, 47),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-376) - 1),
    /* 0x15bc: cmp    esi,0x1e [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 30), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x15bf: je     1716 <trace_event_type_switch_dispatch_xdp+0x616> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (103) - 1, 30),
    /* 0x15c5: cmp    esi,0x1f [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 31), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x15c8: jne    1720 <trace_event_type_switch_dispatch_xdp+0x620> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_2, 0, (103) - 1, 31),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-385) - 1),
    /* 0x15d8: cmp    esi,0x3e [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 62), MICRO_HANDCRAFT_BPF_X86_CMPL),
    /* 0x15db: je     1136 <trace_event_type_switch_dispatch_xdp+0x36> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_2, 0, (-390) - 1, 62),
    /* 0x15e1: cmp    esi,0x3f [exact-kinsn: cmpl reg,imm32 kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_2, 63), MICRO_HANDCRAFT_BPF_X86_CMPL),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-394) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-397) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-400) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-403) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-406) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-409) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-412) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-415) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-418) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-421) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-424) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-427) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-430) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-433) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-436) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-439) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-442) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-445) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-448) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-454) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-457) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-460) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-463) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-466) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-469) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-472) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-475) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-478) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-481) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-484) - 1),
    ...
    HC_RAW(BPF_JMP32 | BPF_JA, 0, 0, 0, (-487) - 1),
