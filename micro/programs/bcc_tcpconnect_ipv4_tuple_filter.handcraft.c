...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_REG_REG_PAYLOAD(BPF_REG_4, BPF_REG_0), MICRO_HANDCRAFT_BPF_X86_MOVSWL),
    ...
    HC_KINSN(HC_REG_REG_PAYLOAD(HC_X86_R9, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_TESTL_RR),
    /* 0x11f5: je     1290 <bcc_tcpconnect_ipv4_tuple_filter_xdp+0x190> [warning-unmapped: standalone x86 branch needs an immediately preceding cmp] */
    ...
    HC_KINSN(HC_ROTATE_PAYLOAD(BPF_REG_4, BPF_REG_4, 7), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x120b: xor    ecx,DWORD PTR [rsi-0xf] [exact-kinsn: xorl memory-source kinsn] */
    HC_KINSN(HC_ALU_MEM_PAYLOAD(BPF_REG_4, BPF_REG_2, -15), MICRO_HANDCRAFT_BPF_X86_XORL_MEM),
    /* 0x120e: movzx  r11d,WORD PTR [rsi-0x1] [exact-kinsn: direct memory load via x86 kinsn selector] */
    HC_KINSN(HC_MEM_PAYLOAD(HC_X86_R11, BPF_REG_2, -1), MICRO_HANDCRAFT_BPF_X86_MOVZWL_MEM),
    ...
    HC_KINSN(HC_REG_REG_PAYLOAD(BPF_REG_5, HC_X86_R10), MICRO_HANDCRAFT_BPF_X86_MOVL_RR),
