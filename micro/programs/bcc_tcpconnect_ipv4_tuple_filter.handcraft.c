 ...
 * - 0x11b2: setge  r9b [warning-reg-remap: setcc kinsn using adjacent cmp reg,imm proof payload; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 ...
 * - 0x11e0: mov    r10d,DWORD PTR [rsi-0x13] [warning-reg-remap: direct memory load via x86 kinsn selector; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 ...
 * - 0x122e: lea    r14d,[r10+rbx*1] [warning-reg-remap: LEA via x86 kinsn selector; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
...
static const struct bpf_insn program[] = {
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_1, 0, 96, 32),
    ...
    HC_RAW(BPF_JMP | BPF_JSGT | BPF_K, BPF_REG_0, 0, 9, 8079),
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_0, 0, 11, 443),
    /* 0x1184: mov    r9d,0x2 [warning-reg-remap: 32-bit immediate move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_0, 0, 3, 8443),
    /* 0x119e: mov    r9d,0x3 [warning-reg-remap: 32-bit immediate move; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x11b2: setge  r9b [warning-reg-remap: setcc kinsn using adjacent cmp reg,imm proof payload; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KINSN(HC_SETCC_CMP_IMM_PAYLOAD(BPF_REG_9, BPF_REG_4, BPF_REG_6, BPF_REG_7, 30000, HC_FLAG_CMP_IMM32), MICRO_HANDCRAFT_BPF_X86_SETGE_R),
    /* 0x11b6: shl    r9d,0x2 [warning-reg-remap: ALU imm operation; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x11e0: mov    r10d,DWORD PTR [rsi-0x13] [warning-reg-remap: direct memory load via x86 kinsn selector; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_7, BPF_REG_2, -19), MICRO_HANDCRAFT_BPF_X86_MOVL_MEM),
    /* 0x11e4: movzx  ebp,BYTE PTR [rsi-0x2] [warning-unmapped: destination register ebp is not in the BPF JIT register file] */
    /* 0x11e8: test   bpl,0x1 [warning-unmapped: only testq reg,same-reg is supported] */
    /* 0x11ec: je     1290 <bcc_tcpconnect_ipv4_tuple_filter_xdp+0x190> [warning-unmapped: standalone x86 branch needs an immediately preceding cmp] */
    /* 0x11f2: test   r9d,r9d [warning-reg-remap: testl reg,reg kinsn; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x1208: rol    ecx,0x7 [exact-kinsn: roll imm kinsn; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_ROTATE_PAYLOAD(BPF_REG_4, BPF_REG_4, 7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x120b: xor    ecx,DWORD PTR [rsi-0xf] [exact-kinsn: xorl memory-source kinsn; verifier instantiate uses temp BPF_REG_6] */
    HC_KINSN(HC_ALU_MEM_PAYLOAD(BPF_REG_4, BPF_REG_2, -15, BPF_REG_6, 0), MICRO_HANDCRAFT_BPF_X86_XORL_MEM),
    /* 0x120e: movzx  r11d,WORD PTR [rsi-0x1] [warning-unmapped: destination register r11d is not in the BPF JIT register file] */
    ...
    /* 0x122e: lea    r14d,[r10+rbx*1] [warning-reg-remap: LEA via x86 kinsn selector; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KINSN(HC_LEA_PAYLOAD(BPF_REG_8, BPF_REG_7, BPF_REG_6, 0, 1, 1, 0), MICRO_HANDCRAFT_BPF_X86_LEAL),
    ...
    /* 0x1242: rol    eax,cl [exact-kinsn: roll cl kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7] */
    HC_KINSN(HC_ROTATE_CL_PAYLOAD(BPF_REG_0, BPF_REG_4, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_ROLL_CL),
    /* 0x1244: test   bpl,0x4 [warning-unmapped: only testq reg,same-reg is supported] */
    /* 0x1248: cmove  eax,r14d [warning-unmapped: cmove needs an adjacent test/cmp proof payload] */
    ...
    /* 0x1257: and    al,0x7 [exact-kinsn: andb imm kinsn; verifier instantiate uses temp BPF_REG_6] */
    ...
    /* 0x1262: not    al [exact-kinsn: notb reg kinsn; verifier instantiate uses temp BPF_REG_6] */
    ...
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, -96, 0),
    ...
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, -100, 0),
