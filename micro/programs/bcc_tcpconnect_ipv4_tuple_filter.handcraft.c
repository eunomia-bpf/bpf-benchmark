...
static const struct bpf_insn program[] = {
    ...
    /* 0x110c: jbe    110f <bcc_tcpconnect_ipv4_tuple_filter_xdp+0xf> [exact-kinsn: jbe branch kinsn] */
    ...
    /* 0x1116: ja     110e <bcc_tcpconnect_ipv4_tuple_filter_xdp+0xe> [exact-kinsn: ja branch kinsn] */
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_2, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_CMPQ),
    /* 0x1122: ja     110e <bcc_tcpconnect_ipv4_tuple_filter_xdp+0xe> [exact-kinsn: ja branch kinsn] */
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(18, 37, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    /* 0x1167: je     129f <bcc_tcpconnect_ipv4_tuple_filter_xdp+0x19f> [exact-kinsn: je branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(162, 306, 1), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    /* 0x1176: jg     1190 <bcc_tcpconnect_ipv4_tuple_filter_xdp+0x90> [exact-kinsn: jg branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(14, 24, 0), MICRO_HANDCRAFT_BPF_X86_JG),
    ...
    /* 0x117b: je     11bc <bcc_tcpconnect_ipv4_tuple_filter_xdp+0xbc> [exact-kinsn: je branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(34, 63, 0), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    /* 0x1182: jne    11a6 <bcc_tcpconnect_ipv4_tuple_filter_xdp+0xa6> [exact-kinsn: jne branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(18, 34, 0), MICRO_HANDCRAFT_BPF_X86_JNE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(28, 68, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    /* 0x1195: je     119e <bcc_tcpconnect_ipv4_tuple_filter_xdp+0x9e> [exact-kinsn: je branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(6, 7, 0), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    /* 0x119c: jne    11a6 <bcc_tcpconnect_ipv4_tuple_filter_xdp+0xa6> [exact-kinsn: jne branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(6, 8, 0), MICRO_HANDCRAFT_BPF_X86_JNE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(16, 42, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(4, 20, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    /* 0x11da: jne    1150 <bcc_tcpconnect_ipv4_tuple_filter_xdp+0x50> [exact-kinsn: jne branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-66, -144, 1), MICRO_HANDCRAFT_BPF_X86_JNE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(94, 158, 1), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(90, 149, 1), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-158, -300, 1), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-166, -323, 1), MICRO_HANDCRAFT_BPF_X86_JMP),
