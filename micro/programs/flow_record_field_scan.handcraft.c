...
static const struct bpf_insn program[] = {
    ...
    /* 0x110c: jbe    110f <flow_record_field_scan_xdp+0xf> [exact-kinsn: jbe branch kinsn] */
    ...
    /* 0x1116: ja     110e <flow_record_field_scan_xdp+0xe> [exact-kinsn: ja branch kinsn] */
    ...
    /* 0x1122: ja     110e <flow_record_field_scan_xdp+0xe> [exact-kinsn: ja branch kinsn] */
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-19, -33, 0), MICRO_HANDCRAFT_BPF_X86_JNE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(46, 62, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    /* 0x117c: je     11c6 <flow_record_field_scan_xdp+0xc6> [exact-kinsn: je branch kinsn] */
