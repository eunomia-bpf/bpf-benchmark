...
static const struct bpf_insn program[] = {
    ...
    /* 0x110c: jbe    110f <flow_record_field_scan_xdp+0xf> [exact-kinsn: jbe branch kinsn; verifier proof from preceding cmp] */
    ...
    /* 0x1116: ja     110e <flow_record_field_scan_xdp+0xe> [exact-kinsn: ja branch kinsn; verifier proof from preceding cmp] */
    ...
    /* 0x1122: ja     110e <flow_record_field_scan_xdp+0xe> [exact-kinsn: ja branch kinsn; verifier proof from preceding cmp] */
    ...
    /* 0x1127: jne    110e <flow_record_field_scan_xdp+0xe> [exact-kinsn: jne branch kinsn] */
    ...
    /* 0x112d: jne    110e <flow_record_field_scan_xdp+0xe> [exact-kinsn: jne branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-19, -39, 0), MICRO_HANDCRAFT_BPF_X86_JNE),
    /* 0x112f: push   rbx [exact-kinsn: pushq kinsn] */
    HC_KINSN(HC_REG_PAYLOAD(BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_PUSHQ),
    /* 0x1130: movabs r8,0x9e3779b97f4a7c15 [exact-bpf: movabs via BPF_LD_IMM64; x86 JIT emits movabs] */
    HC_LD_IMM64_RAW(BPF_REG_5, 0, 11400714819323198485ULL),
    ...
    /* 0x113e: jmp    117e <flow_record_field_scan_xdp+0x7e> [exact-kinsn: jmp branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(116, 62, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    /* 0x117c: je     11c6 <flow_record_field_scan_xdp+0xc6> [exact-kinsn: je branch kinsn; verifier proof from preceding cmp] */
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(172, 72, 0, 0, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    /* 0x11b7: je     1140 <flow_record_field_scan_xdp+0x40> [exact-kinsn: je branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-74, -121, 0), MICRO_HANDCRAFT_BPF_X86_JE),
    ...
    /* 0x11c4: jmp    114e <flow_record_field_scan_xdp+0x4e> [exact-kinsn: jmp branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-72, -120, 0), MICRO_HANDCRAFT_BPF_X86_JMP),
    ...
    /* 0x1201: mov    eax,0x2 [exact-kinsn: movl immediate kinsn] */
    HC_KINSN(HC_X86_IMM_PAYLOAD(BPF_REG_0, 2), MICRO_HANDCRAFT_BPF_X86_MOVL),
    /* 0x1206: pop    rbx [exact-kinsn: popq kinsn] */
    HC_KINSN(HC_REG_PAYLOAD(BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_POPQ),
    /* 0x1207: ret [abi-boundary: native ret maps to the BPF program exit boundary] */
    HC_EXIT(),
};
