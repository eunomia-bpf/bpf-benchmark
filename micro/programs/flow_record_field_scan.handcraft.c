 ...
 * - 0x110c: jbe    110f <flow_record_field_scan_xdp+0xf> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1116: ja     110e <flow_record_field_scan_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1122: ja     110e <flow_record_field_scan_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1127: jne    110e <flow_record_field_scan_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x112d: jne    110e <flow_record_field_scan_xdp+0xe> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x113e: jmp    117e <flow_record_field_scan_xdp+0x7e> [warning-unmapped: needs a machine-level x86 branch kinsn]
 * - 0x117c: je     11c6 <flow_record_field_scan_xdp+0xc6> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x11b7: je     1140 <flow_record_field_scan_xdp+0x40> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x11c4: jmp    114e <flow_record_field_scan_xdp+0x4e> [warning-unmapped: needs a machine-level x86 branch kinsn]
 */
