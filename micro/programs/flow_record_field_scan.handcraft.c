...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_1, BPF_REG_3, 0, 0, 1, 0, 1040, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x1142: and    cl,0x7 [exact-kinsn: andb imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_IMM_TMP_PAYLOAD(BPF_REG_4, 7, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_ANDB_IMM),
    /* 0x1145: shr    r10,cl [warning-unmapped: shr    r10,cl needs a shadow-aware ALU kinsn] */
    /* 0x1148: xor    r9,r10 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_8] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, HC_X86_R10, BPF_REG_7, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x114b: add    r9,r11 [exact-kinsn: add64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_8] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, HC_X86_R11, BPF_REG_7, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    /* 0x1150: and    cl,0x18 [exact-kinsn: andb imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    ...
    /* 0x1159: xor    r8,r9 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_8] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_5, HC_X86_R9, BPF_REG_7, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x115c: and    al,0x7 [exact-kinsn: andb imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_2, 8, 0), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_1, 0, 38, 32),
    ...
    /* 0x1188: add    rcx,r10 [exact-kinsn: add64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_8] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_4, HC_X86_R10, BPF_REG_7, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    /* 0x1198: or     r9,rax [exact-kinsn: or64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_8] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, BPF_REG_0, BPF_REG_7, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_ORQ),
    ...
    /* 0x119f: mov    r11,rax [exact-kinsn: movq register-to-register kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(HC_X86_R11, BPF_REG_0, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x11a2: shl    r11,0x10 [exact-kinsn: shl64 imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R11, 16, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    ...
    /* 0x11ab: or     r11,rbx [exact-kinsn: or64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_8] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_6, BPF_REG_7, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x11ae: xor    r11,rcx [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_8] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_4, BPF_REG_7, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_XORQ),
    /* 0x11b1: add    r11,r8 [exact-kinsn: add64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_8] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R11, BPF_REG_5, BPF_REG_7, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    /* 0x11be: add    r9,rcx [exact-kinsn: add64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_8] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, BPF_REG_4, BPF_REG_7, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11c1: xor    r9,r11 [exact-kinsn: xor64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_8] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, HC_X86_R11, BPF_REG_7, BPF_REG_8), MICRO_HANDCRAFT_BPF_X86_XORQ),
