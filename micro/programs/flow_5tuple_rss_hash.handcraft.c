...
static const struct bpf_insn program[] = {
    ...
    /* 0x110c: ja     130f <flow_5tuple_rss_hash_xdp+0x20f> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
    ...
    /* 0x1119: ja     130f <flow_5tuple_rss_hash_xdp+0x20f> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
    ...
    /* 0x1126: ja     130f <flow_5tuple_rss_hash_xdp+0x20f> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP | BPF_JLE | BPF_X, BPF_REG_2, BPF_REG_3, 1, 0),
    HC_EXIT(),
    ...
    /* 0x1142: cmp    edi,0x800 [absorbed-control-flow: cmp folded into following ordinary BPF jne] */
    /* 0x1148: jne    1307 <flow_5tuple_rss_hash_xdp+0x207> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_1, 0, (240) - 1, 2048),
    ...
    /* 0x1152: cmp    rdi,rdx [absorbed-control-flow: cmp folded into following ordinary BPF ja] */
    /* 0x1155: ja     1307 <flow_5tuple_rss_hash_xdp+0x207> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_1, BPF_REG_3, (237) - 1, 0),
    ...
    /* 0x1165: cmp    r8b,0x40 [absorbed-control-flow: cmp folded into following ordinary BPF jne] */
    /* 0x1169: jne    1307 <flow_5tuple_rss_hash_xdp+0x207> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    HC_MOV64_REG(BPF_REG_6, BPF_REG_5),
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_6, 0, 1, 64),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (227) - 1, 0),
    /* 0x116f: and    edi,0xf [exact-kinsn: and32 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_1, 15), MICRO_HANDCRAFT_BPF_X86_ANDL),
    /* 0x1172: cmp    dil,0x5 [absorbed-control-flow: cmp folded into following ordinary BPF jb] */
    /* 0x1176: jb     1307 <flow_5tuple_rss_hash_xdp+0x207> [exact-bpf: jb ordinary BPF branch from preceding cmp] */
    ...
    /* 0x1180: cmp    rsi,rdx [absorbed-control-flow: cmp folded into following ordinary BPF ja] */
    /* 0x1183: ja     1307 <flow_5tuple_rss_hash_xdp+0x207> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
    ...
    /* 0x1196: cmp    ebx,0x11 [absorbed-control-flow: cmp folded into following ordinary BPF je] */
    /* 0x1199: je     11a4 <flow_5tuple_rss_hash_xdp+0xa4> [exact-bpf: je ordinary BPF branch from preceding cmp] */
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_6, 0, (2) - 1, 17),
    /* 0x119b: cmp    ebx,0x6 [absorbed-control-flow: cmp folded into following ordinary BPF jne] */
    /* 0x119e: jne    1307 <flow_5tuple_rss_hash_xdp+0x207> [exact-bpf: jne ordinary BPF branch from preceding cmp] */
    ...
    /* 0x11a8: cmp    r8,rdx [absorbed-control-flow: cmp folded into following ordinary BPF ja] */
    /* 0x11ab: ja     1307 <flow_5tuple_rss_hash_xdp+0x207> [exact-bpf: ja ordinary BPF branch from preceding cmp] */
