...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_2, BPF_REG_4, 0, 0, 1, 0, 22, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_1, BPF_REG_4, 0, 0, 1, 0, 42, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x115c: and    r8b,0xf0 [exact-kinsn: andb imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_IMM_TMP_PAYLOAD(BPF_REG_5, 240, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_ANDB_IMM),
    /* 0x1160: cmp    r8b,0x40 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    r8b,0x40] */
    ...
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_2, BPF_REG_2, BPF_REG_1, 2, 1, 1, 0, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x1184: movzx  r11d,BYTE PTR [rcx+0x18] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R11, BPF_REG_4, 24, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    ...
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_5, BPF_REG_2, 0, 0, 1, 0, 4, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x11ac: mov    eax,r11d [exact-kinsn: movl register-to-register kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(BPF_REG_0, HC_X86_R11, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVL_RR),
    /* 0x11af: shl    eax,0x8 [exact-kinsn: shl32 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_0, 8, 0), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x11b2: or     eax,edi [exact-kinsn: or32 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_0, BPF_REG_1, 0, 0), MICRO_HANDCRAFT_BPF_X86_ORL),
    ...
    /* 0x11b8: mov    r10d,DWORD PTR [rcx+0x26] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R10, BPF_REG_4, 38, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVL_MEM),
    /* 0x11bc: bswap  r10d [exact-kinsn: bswapl kinsn; verifier instantiate uses temp BPF_REG_7] */
    ...
    HC_KINSN(HC_REG_REG_PAYLOAD(BPF_REG_1, BPF_REG_1), MICRO_HANDCRAFT_BPF_X86_MOVZWL_RR),
    /* 0x11d7: lea    r9d,[rax+r8*1] [exact-kinsn: LEA via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_LEA_TMP_PAYLOAD(HC_X86_R9, BPF_REG_0, BPF_REG_5, 0, 1, 1, 0, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x11db: lea    ebp,[r10-0x61c88647] [warning-unmapped: LEA operands are not representable] */
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_3, 16, 0), MICRO_HANDCRAFT_BPF_X86_SHLL),
    /* 0x11e7: or     edx,edi [exact-kinsn: or32 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_3, BPF_REG_1, 0, 0), MICRO_HANDCRAFT_BPF_X86_ORL),
    /* 0x11e9: lea    r15d,[rbx+rdx*1] [exact-kinsn: LEA via x86 kinsn selector] */
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_9, BPF_REG_6, BPF_REG_3, 0, 1, 1, 0, 0), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x11ed: lea    r14d,[rbx+rdx*1] [exact-kinsn: LEA via x86 kinsn selector] */
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_8, BPF_REG_6, BPF_REG_3, 0, 1, 1, 0, 0), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x11f1: add    r14d,0x12345678 [exact-kinsn: add32 imm kinsn] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_8, 305419896, 0), MICRO_HANDCRAFT_BPF_X86_ADDL),
    /* 0x11f8: sub    r9d,r14d [exact-kinsn: sub32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, BPF_REG_8, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x11fb: add    r9d,0xdeadbeef [exact-kinsn: add32 imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R9, 3735928559, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_ADDL),
    ...
    /* 0x1206: xor    r14d,r9d [exact-kinsn: xor32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_8, HC_X86_R9, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1209: lea    r9d,[r10+r15*1] [exact-kinsn: LEA via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_LEA_TMP_PAYLOAD(HC_X86_R9, HC_X86_R10, BPF_REG_9, 0, 1, 1, 0, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_LEAL),
    /* 0x120d: add    r9d,0xb06bd031 [exact-kinsn: add32 imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R9, 2959855665, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_ADDL),
    ...
    /* 0x121b: sub    ebp,r14d [warning-unmapped: ALU destination ebp is not in the BPF JIT register file] */
    /* 0x121e: xor    r15d,ebp [warning-unmapped: ALU source ebp is not supported] */
    /* 0x1221: add    r14d,r9d [exact-kinsn: add32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_8, HC_X86_R9, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ADDL),
    /* 0x1224: sub    r9d,r15d [exact-kinsn: sub32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, BPF_REG_9, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x1227: mov    ebp,r15d [warning-unmapped: unsupported mnemonic or operand form: mov    ebp,r15d] */
    /* 0x122a: rol    ebp,0x8 [warning-unmapped: ROL width/register not supported by current selectors: ebp] */
    /* 0x122d: xor    ebp,r9d [warning-unmapped: ALU destination ebp is not in the BPF JIT register file] */
    /* 0x1230: add    r15d,r14d [exact-kinsn: add32 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_9, BPF_REG_8, 0, 0), MICRO_HANDCRAFT_BPF_X86_ADDL),
    /* 0x1233: mov    r9d,ebp [warning-unmapped: unsupported mnemonic or operand form: mov    r9d,ebp] */
    /* 0x1236: rol    r9d,0x10 [exact-kinsn: roll imm kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_ROTATE_SHADOW_PAYLOAD(HC_X86_R9, HC_X86_R9, 16, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x123a: sub    r14d,ebp [warning-unmapped: ALU source ebp is not supported] */
    /* 0x123d: xor    r9d,r14d [exact-kinsn: xor32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, BPF_REG_8, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1240: add    ebp,r15d [warning-unmapped: ALU destination ebp is not in the BPF JIT register file] */
    /* 0x1243: sub    r15d,r9d [exact-kinsn: sub32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_9, HC_X86_R9, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x1246: mov    r14d,r9d [exact-kinsn: movl register-to-register kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(BPF_REG_8, HC_X86_R9, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVL_RR),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_8, BPF_REG_9, 0, 0), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1250: add    r9d,ebp [warning-unmapped: ALU source ebp is not supported] */
    /* 0x1253: xor    r8d,r10d [exact-kinsn: xor32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_5, HC_X86_R10, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_XORL),
    ...
    /* 0x125a: sub    ebp,r14d [warning-unmapped: ALU destination ebp is not in the BPF JIT register file] */
    /* 0x125d: add    r8d,r9d [exact-kinsn: add32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_5, HC_X86_R9, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ADDL),
    /* 0x1260: add    r9d,edx [exact-kinsn: add32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, BPF_REG_3, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ADDL),
    /* 0x1263: add    r9d,r14d [exact-kinsn: add32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, BPF_REG_8, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ADDL),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_3, BPF_REG_0, 0, 0), MICRO_HANDCRAFT_BPF_X86_ORL),
    /* 0x1274: add    edx,r14d [exact-kinsn: add32 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_3, BPF_REG_8, 0, 0), MICRO_HANDCRAFT_BPF_X86_ADDL),
    /* 0x1277: xor    edx,r9d [exact-kinsn: xor32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_3, HC_X86_R9, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x127a: mov    r10d,r9d [exact-kinsn: movl register-to-register kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(HC_X86_R10, HC_X86_R9, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVL_RR),
    /* 0x127d: rol    r10d,0xe [exact-kinsn: roll imm kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_ROTATE_SHADOW_PAYLOAD(HC_X86_R10, HC_X86_R10, 14, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x1281: sub    edx,r10d [exact-kinsn: sub32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_3, HC_X86_R10, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x1284: mov    r10d,edx [exact-kinsn: movl register-to-register kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(HC_X86_R10, BPF_REG_3, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVL_RR),
    /* 0x1287: rol    r10d,0xb [exact-kinsn: roll imm kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_ROTATE_SHADOW_PAYLOAD(HC_X86_R10, HC_X86_R10, 11, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x128b: xor    r8d,edx [exact-kinsn: xor32 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_5, BPF_REG_3, 0, 0), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x128e: sub    r8d,r10d [exact-kinsn: sub32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_5, HC_X86_R10, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x1291: xor    r9d,r8d [exact-kinsn: xor32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, BPF_REG_5, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x1294: mov    r10d,r8d [exact-kinsn: movl register-to-register kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(HC_X86_R10, BPF_REG_5, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVL_RR),
    /* 0x1297: rol    r10d,0x19 [exact-kinsn: roll imm kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_ROTATE_SHADOW_PAYLOAD(HC_X86_R10, HC_X86_R10, 25, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x129b: sub    r9d,r10d [exact-kinsn: sub32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, HC_X86_R10, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x129e: xor    edx,r9d [exact-kinsn: xor32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_3, HC_X86_R9, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x12a1: mov    r10d,r9d [exact-kinsn: movl register-to-register kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(HC_X86_R10, HC_X86_R9, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVL_RR),
    /* 0x12a4: rol    r10d,0x10 [exact-kinsn: roll imm kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_ROTATE_SHADOW_PAYLOAD(HC_X86_R10, HC_X86_R10, 16, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x12a8: sub    edx,r10d [exact-kinsn: sub32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_3, HC_X86_R10, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x12ab: xor    r8d,edx [exact-kinsn: xor32 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_5, BPF_REG_3, 0, 0), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x12ae: mov    r10d,edx [exact-kinsn: movl register-to-register kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(HC_X86_R10, BPF_REG_3, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVL_RR),
    /* 0x12b1: rol    r10d,0x4 [exact-kinsn: roll imm kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_ROTATE_SHADOW_PAYLOAD(HC_X86_R10, HC_X86_R10, 4, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x12b5: sub    r8d,r10d [exact-kinsn: sub32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_5, HC_X86_R10, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x12b8: xor    r9d,r8d [exact-kinsn: xor32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, BPF_REG_5, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_XORL),
    ...
    /* 0x12bf: sub    r9d,r8d [exact-kinsn: sub32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, BPF_REG_5, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_SUBL),
    /* 0x12c2: xor    edx,r9d [exact-kinsn: xor32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_3, HC_X86_R9, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x12c5: rol    r9d,0x18 [exact-kinsn: roll imm kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_ROTATE_SHADOW_PAYLOAD(HC_X86_R9, HC_X86_R9, 24, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_ROLL_IMM),
    /* 0x12c9: sub    edx,r9d [exact-kinsn: sub32 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_6] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_3, HC_X86_R9, BPF_REG_7, BPF_REG_6), MICRO_HANDCRAFT_BPF_X86_SUBL),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_6, BPF_REG_2, 0, 0), MICRO_HANDCRAFT_BPF_X86_ORL),
    /* 0x12d4: xor    ebx,edi [exact-kinsn: xor32 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_6, BPF_REG_1, 0, 0), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x12d6: xor    esi,eax [exact-kinsn: xor32 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_2, BPF_REG_0, 0, 0), MICRO_HANDCRAFT_BPF_X86_XORL),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_2, 16, 0), MICRO_HANDCRAFT_BPF_X86_SHRL),
    ...
    /* 0x12e4: mov    BYTE PTR [rcx+0x3],r11b [exact-kinsn: direct memory store via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_STORE_REG_TMP_PAYLOAD(HC_X86_R11, BPF_REG_4, 3, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVB_MEM_REG),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_0, 16, 0), MICRO_HANDCRAFT_BPF_X86_SHRL),
