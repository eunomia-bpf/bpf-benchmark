...
static const struct bpf_insn program[] = {
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_4, BPF_REG_3, (297) - 1, 0),
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_2, BPF_REG_3, (292) - 1, 0),
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_2, BPF_REG_3, (287) - 1, 0),
    ...
    HC_RAW(BPF_JMP32 | BPF_JNE | BPF_K, BPF_REG_1, 0, (262) - 1, 2048),
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_1, BPF_REG_3, (257) - 1, 0),
    ...
    /* 0x1160: cmp    r8b,0x40 [exact-kinsn: cmpb reg,imm8 kinsn] */
    ...
    /* 0x116d: cmp    dil,0x5 [exact-kinsn: cmpb reg,imm8 kinsn] */
    ...
    HC_RAW(BPF_JMP | BPF_JGT | BPF_X, BPF_REG_2, BPF_REG_3, (224) - 1, 0),
