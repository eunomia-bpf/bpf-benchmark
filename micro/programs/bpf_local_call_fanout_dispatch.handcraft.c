 ...
 * - 0x115c: mov    r12d,0x17 [warning-unmapped: unsupported mnemonic or operand form: mov    r12d,0x17]
 ...
 * - 0x1194: add    r12,0x18 [warning-unmapped: ALU destination r12 is not in the BPF JIT register file]
 * - 0x11a1: movzx  ebx,BYTE PTR [r14+r12*1-0x7] [warning-unmapped: SIB index r12 scale 1 is not expressible]
 ...
 * - 0x11b2: lea    rdx,[r12-0xf] [warning-unmapped: LEA base/index not in BPF register file: [r12-0xf]]
...
static const struct bpf_insn program[] = {
    ...
    /* 0x1114: cmp    r14,rcx [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    /* 0x112c: mov    QWORD PTR [rsp],rdx [warning-unmapped: store base rsp is not in the BPF JIT register file] */
    /* 0x1130: cmp    rdx,rcx [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    /* 0x113c: cmp    rdx,rcx [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    /* 0x1141: cmp    DWORD PTR [r14+0x8],0x10 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_5, 0, -9, 16),
    /* 0x1148: cmp    DWORD PTR [r14+0xc],0x18 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_5, 0, -11, 24),
    ...
    /* 0x117e: and    cl,0x38 [bpf-jit: ALU imm operation] */
    HC_RAW(BPF_ALU | BPF_AND | BPF_K, BPF_REG_4, 0, 0, 56),
    ...
    /* 0x1194: add    r12,0x18 [warning-unmapped: ALU destination r12 is not in the BPF JIT register file] */
    /* 0x1198: cmp    r13,0x80 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_7, 0, 9, 128),
    /* 0x11a1: movzx  ebx,BYTE PTR [r14+r12*1-0x7] [warning-unmapped: SIB index r12 scale 1 is not expressible] */
    /* 0x11a7: and    ebx,0x3 [exact-kinsn: andl imm32 kinsn] */
    HC_KINSN(HC_REG_IMM_PAYLOAD(BPF_REG_6, 3), MICRO_HANDCRAFT_BPF_X86_ANDL_IMM32),
    /* 0x11aa: mov    ebp,DWORD PTR [r14+r12*1-0x3] [warning-unmapped: unsupported mnemonic or operand form: mov    ebp,DWORD PTR [r14+r12*1-0x3]] */
    /* 0x11af: xor    ebp,r15d [warning-unmapped: ALU destination ebp is not in the BPF JIT register file] */
    /* 0x11b2: lea    rdx,[r12-0xf] [warning-unmapped: LEA base/index not in BPF register file: [r12-0xf]] */
    /* 0x11b7: cmp    rbx,0x2 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_6, 0, 4, 2),
    /* 0x11bd: cmp    ebx,0x1 [cmp-state: sets flags; materialized by following jcc when possible] */
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_6, 0, -12, 1),
