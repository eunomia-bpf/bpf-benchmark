...
/home/yunwei37/workspace/bpf-benchmark/micro/results/x86_kvm_micro_20260515_033620_169457/details/jit_dumps/packet_toeplitz_rss_hash__kernel__sample00.jited.bin:     file format binary
...
/home/yunwei37/workspace/bpf-benchmark/micro/results/x86_kvm_micro_20260515_033620_169457/details/jit_dumps/packet_toeplitz_rss_hash__llvmbpf__sample00.jited.bin:     file format binary
...
/home/yunwei37/workspace/bpf-benchmark/micro/results/x86_kvm_micro_20260515_033620_169457/details/jit_dumps/packet_toeplitz_rss_hash_handcraft__kernel__sample00.jited.bin:     file format binary
...
0000000000000000 <.data>:
   ...
   d:	41 55                	push   r13
   f:	41 57                	push   r15
  11:	48 8b 5f 00          	mov    rbx,QWORD PTR [rdi+0x0]
  15:	4c 8b 6f 08          	mov    r13,QWORD PTR [rdi+0x8]
  19:	48 83 c3 08          	add    rbx,0x8
  1d:	48 89 de             	mov    rsi,rbx
  20:	48 83 c6 36          	add    rsi,0x36
  24:	49 39 f5             	cmp    r13,rsi
  27:	73 09                	jae    0x32
  ...
  30:	c9                   	leave
  31:	c3                   	ret
  32:	45 31 ff             	xor    r15d,r15d
  35:	42 0f 38 f0 44 3b 1a 	movbe  eax,DWORD PTR [rbx+r15*1+0x1a]
  3c:	42 0f 38 f0 7c 3b 1e 	movbe  edi,DWORD PTR [rbx+r15*1+0x1e]
  43:	48 31 f8             	xor    rax,rdi
  46:	42 0f 38 f0 74 3b 22 	movbe  esi,DWORD PTR [rbx+r15*1+0x22]
  4d:	48 01 f0             	add    rax,rsi
  50:	48 89 43 f8          	mov    QWORD PTR [rbx-0x8],rax
  54:	b8 02 00 00 00       	mov    eax,0x2
  59:	eb d0                	jmp    0x2b
```
