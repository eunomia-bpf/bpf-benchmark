...
/home/yunwei37/workspace/bpf-benchmark/micro/results/x86_kvm_micro_20260515_033620_169457/details/jit_dumps/bitmap_popcount_scan_handcraft__kernel__sample00.jited.bin:     file format binary
...
0000000000000000 <.data>:
  ...
  1e:	48 81 c6 08 08 00 00 	add    rsi,0x808
  ...
  2f:	c9                   	leave
  30:	c3                   	ret
  31:	8b 43 04             	mov    eax,DWORD PTR [rbx+0x4]
  34:	48 8b 7b 08          	mov    rdi,QWORD PTR [rbx+0x8]
  38:	48 31 c7             	xor    rdi,rax
  3b:	f3 48 0f b8 f7       	popcnt rsi,rdi
  40:	48 01 f0             	add    rax,rsi
  43:	48 8b 7b 10          	mov    rdi,QWORD PTR [rbx+0x10]
  47:	48 31 c7             	xor    rdi,rax
  4a:	f3 48 0f b8 f7       	popcnt rsi,rdi
  4f:	48 01 f0             	add    rax,rsi
  52:	48 8b 7b 18          	mov    rdi,QWORD PTR [rbx+0x18]
  56:	48 31 c7             	xor    rdi,rax
  59:	f3 48 0f b8 f7       	popcnt rsi,rdi
  5e:	48 01 f0             	add    rax,rsi
  61:	48 8b 7b 20          	mov    rdi,QWORD PTR [rbx+0x20]
  65:	48 31 c7             	xor    rdi,rax
  68:	f3 48 0f b8 f7       	popcnt rsi,rdi
  6d:	48 01 f0             	add    rax,rsi
  70:	48 89 43 f8          	mov    QWORD PTR [rbx-0x8],rax
