...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_0, BPF_REG_3, 20), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_2, BPF_REG_3, 22), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    /* 0x1170: movzx  ecx,WORD PTR [rdx+0x18] [exact-kinsn: direct memory load via x86 kinsn selector] */
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_3, 24), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_3, 28), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_4, BPF_REG_3, 26), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_1, HC_X86_R9, 0), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(HC_X86_R11, BPF_REG_6, 12), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_0, HC_X86_R9, 2), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(HC_X86_R10, HC_X86_R9, 12), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(HC_X86_R9, HC_X86_R9, 16), MICRO_HANDCRAFT_BPF_X86_MOVL),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_8, BPF_REG_6, 2), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    /* 0x12b1: rol    bp,0x8 [warning-unmapped: ROL width/register not supported by current selectors: bp] */
    /* 0x12b5: movzx  r15d,bp [warning-unmapped: movzx source size not recognized: bp] */
    ...
    HC_KINSN(HC_MEM_PAYLOAD(HC_X86_R9, BPF_REG_6, 22), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_8, BPF_REG_6, 23), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(HC_X86_R10, BPF_REG_6, 27), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
    ...
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_6, BPF_REG_6, 31), MICRO_HANDCRAFT_BPF_X86_MOVZBL),
