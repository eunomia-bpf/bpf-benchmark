 ...
 * - 0x1227: cmp    r11,0x50 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    r11,0x50]
 ...
 * - 0x129b: mov    r10d,DWORD PTR [r9+0xc] [warning-reg-remap: direct memory load via x86 kinsn selector; native r10 has no exact BPF JIT register; remapped to BPF_REG_7; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
 * - 0x129f: bswap  r10d [warning-reg-remap: bswapl kinsn; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 ...
 * - 0x12fb: movzx  r10d,BYTE PTR [rbx+0x1b] [warning-reg-remap: direct memory load via x86 kinsn selector; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 * - 0x1300: mov    r14,r10 [warning-reg-remap: movq register-to-register kinsn; native r10 has no exact BPF JIT register; remapped to BPF_REG_7]
 ...
 * - 0x1352: rol    r9,cl [warning-reg-remap: rolq cl kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15]
...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_REG_REG_PAYLOAD(BPF_REG_3, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    ...
    HC_KINSN(HC_REG_REG_PAYLOAD(BPF_REG_4, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    ...
    HC_KINSN(HC_REG_REG_PAYLOAD(BPF_REG_9, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    ...
    HC_KINSN(HC_REG_REG_PAYLOAD(BPF_REG_1, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    ...
    HC_KINSN(HC_REG_REG_PAYLOAD(BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    ...
    HC_KINSN(HC_REG_REG_PAYLOAD(BPF_REG_8, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_CMPQ_RR),
    ...
    HC_JMP_REG(BPF_JLE, BPF_REG_9, BPF_REG_7, 4),
    /* 0x123e: pop    rbx [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x123f: pop    r14 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1241: pop    r15 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1243: pop    rbp [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    ...
    /* 0x129b: mov    r10d,DWORD PTR [r9+0xc] [warning-reg-remap: direct memory load via x86 kinsn selector; native r10 has no exact BPF JIT register; remapped to BPF_REG_7; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_7, BPF_REG_9, 12), MICRO_HANDCRAFT_BPF_X86_MOVL_MEM),
    /* 0x129f: bswap  r10d [warning-reg-remap: bswapl kinsn; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KINSN(HC_REG_PAYLOAD(BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_BSWAPL),
    /* 0x12a2: mov    r9d,DWORD PTR [r9+0x10] [warning-reg-remap: direct memory load via x86 kinsn selector; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    ...
    /* 0x12fb: movzx  r10d,BYTE PTR [rbx+0x1b] [warning-reg-remap: direct memory load via x86 kinsn selector; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KINSN(HC_MEM_PAYLOAD(BPF_REG_7, BPF_REG_6, 27), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x1300: mov    r14,r10 [warning-reg-remap: movq register-to-register kinsn; native r10 has no exact BPF JIT register; remapped to BPF_REG_7] */
    HC_KINSN(HC_REG_REG_PAYLOAD(BPF_REG_8, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    ...
    /* 0x1352: rol    r9,cl [warning-reg-remap: rolq cl kinsn; verifier instantiate uses temps BPF_REG_6/BPF_REG_7; native r9 has no exact BPF JIT register; remapped to BPF_REG_9/final r15] */
    HC_KINSN(HC_ROTATE_CL_PAYLOAD(BPF_REG_9, BPF_REG_4, BPF_REG_6, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_ROLQ_CL),
