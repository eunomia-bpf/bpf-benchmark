...
static const struct bpf_insn program[] = {
    ...
    /* 0x110a: jbe    1121 <tc_packet_checksum_fold_prog+0x21> [exact-kinsn: jbe branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(11, 21, 0), MICRO_HANDCRAFT_BPF_X86_JBE),
    ...
    /* 0x1128: ja     110c <tc_packet_checksum_fold_prog+0xc> [exact-kinsn: ja branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-13, -30, 0), MICRO_HANDCRAFT_BPF_X86_JA),
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_3, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_CMPQ),
    /* 0x1134: ja     110c <tc_packet_checksum_fold_prog+0xc> [exact-kinsn: ja branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-19, -42, 0), MICRO_HANDCRAFT_BPF_X86_JA),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-23, -48, 0), MICRO_HANDCRAFT_BPF_X86_JNE),
    ...
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-27, -57, 0), MICRO_HANDCRAFT_BPF_X86_JNE),
    ...
    /* 0x1193: jne    1160 <tc_packet_checksum_fold_prog+0x60> [exact-kinsn: jne branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-24, -53, 0), MICRO_HANDCRAFT_BPF_X86_JNE),
    ...
    /* 0x11b4: jne    1150 <tc_packet_checksum_fold_prog+0x50> [exact-kinsn: jne branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-52, -102, 0), MICRO_HANDCRAFT_BPF_X86_JNE),
