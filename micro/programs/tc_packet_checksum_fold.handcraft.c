 ...
 * - 0x110a: jbe    1121 <tc_packet_checksum_fold_prog+0x21> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1128: ja     110c <tc_packet_checksum_fold_prog+0xc> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1134: ja     110c <tc_packet_checksum_fold_prog+0xc> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x113a: jne    110c <tc_packet_checksum_fold_prog+0xc> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1143: jne    110c <tc_packet_checksum_fold_prog+0xc> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x1193: jne    1160 <tc_packet_checksum_fold_prog+0x60> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 * - 0x11b4: jne    1150 <tc_packet_checksum_fold_prog+0x50> [warning-unmapped: needs a machine-level x86 conditional-branch kinsn]
 */
