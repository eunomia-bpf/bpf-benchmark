 ...
 * - 0x113a: jne    110c <tc_packet_checksum_fold_prog+0xc> [warning-unmapped: cannot lower cmp    DWORD PTR [rax+0x8],0x20 + jne    110c <tc_packet_checksum_fold_prog+0xc> to BPF branch]
 ...
 * - 0x1143: jne    110c <tc_packet_checksum_fold_prog+0xc> [warning-unmapped: cannot lower cmp    DWORD PTR [rax+0xc],0x200 + jne    110c <tc_packet_checksum_fold_prog+0xc> to BPF branch]
 */
...
static const struct bpf_insn program[] = {
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_2, 0, -50, 32),
