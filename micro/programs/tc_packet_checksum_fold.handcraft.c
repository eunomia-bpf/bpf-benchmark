...
static const struct bpf_insn program[] = {
    ...
    /* 0x110a: jbe    1121 <tc_packet_checksum_fold_prog+0x21> [exact-kinsn: jbe branch kinsn; verifier proof from preceding cmp] */
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(26, 21, 0, 0, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JBE),
    ...
    /* 0x1128: ja     110c <tc_packet_checksum_fold_prog+0xc> [exact-kinsn: ja branch kinsn; verifier proof from preceding cmp] */
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(-31, -30, 0, 0, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JA),
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_3, BPF_REG_4), MICRO_HANDCRAFT_BPF_X86_CMPQ),
    /* 0x1134: ja     110c <tc_packet_checksum_fold_prog+0xc> [exact-kinsn: ja branch kinsn; verifier proof from preceding cmp] */
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(-64, -42, 0, 0, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JA),
    ...
    /* 0x113a: jne    110c <tc_packet_checksum_fold_prog+0xc> [exact-kinsn: jne branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-94, -48, 0), MICRO_HANDCRAFT_BPF_X86_JNE),
    ...
    /* 0x1143: jne    110c <tc_packet_checksum_fold_prog+0xc> [exact-kinsn: jne branch kinsn] */
    HC_KINSN(HC_X86_BRANCH_PAYLOAD(-123, -57, 0), MICRO_HANDCRAFT_BPF_X86_JNE),
    ...
    /* 0x1193: jne    1160 <tc_packet_checksum_fold_prog+0x60> [exact-kinsn: jne branch kinsn; verifier proof from preceding cmp] */
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(-99, -53, 0, 0, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JNE),
    ...
    /* 0x11b4: jne    1150 <tc_packet_checksum_fold_prog+0x50> [exact-kinsn: jne branch kinsn; verifier proof from preceding cmp] */
    HC_KINSN(HC_X86_BRANCH_PROOF_PAYLOAD(-165, -102, 0, 1, HC_X86_BRANCH_PROOF_CMP_RR), MICRO_HANDCRAFT_BPF_X86_JNE),
