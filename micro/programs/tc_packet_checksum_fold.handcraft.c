...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_LEA_ARCH_PAYLOAD(HC_X86_RDX, HC_X86_RAX, 0, 0, 1, 0, 1040), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KINSN(HC_X86_ARCH_SIB_PAYLOAD(HC_X86_R9, HC_X86_RAX, HC_X86_RCX, 1, 16), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    ...
    HC_KINSN(HC_X86_ARCH_SIB_PAYLOAD(HC_X86_R8, HC_X86_RAX, HC_X86_RCX, 1, 18), MICRO_HANDCRAFT_BPF_X86_MOVZWL),
    ...
    HC_KINSN(HC_X86_ARCH_IMM_PAYLOAD(HC_X86_RCX, 2), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    ...
    HC_KINSN(HC_X86_ARCH_RR_PAYLOAD(HC_X86_RCX, HC_X86_R8), MICRO_HANDCRAFT_BPF_X86_ADDL),
    ...
    HC_KINSN(HC_REG_PAYLOAD(HC_X86_RSI), MICRO_HANDCRAFT_BPF_X86_INCL),
