...
static const struct bpf_insn program[] = {
    ...
    /* 0x110c: ja     1135 <simple_packet_xdp+0x35> [exact-kinsn: ja branch kinsn; verifier proof from preceding cmp] */
    ...
    /* 0x1115: ja     1135 <simple_packet_xdp+0x35> [exact-kinsn: ja branch kinsn; verifier proof from preceding cmp] */
    ...
    /* 0x1135: ret [abi-boundary: native ret maps to the BPF program exit boundary] */
    HC_EXIT(),
};
