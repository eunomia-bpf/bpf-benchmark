...
static const struct bpf_insn program[] = {
    ...
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_4, 0, 1, 2048),
    HC_EXIT(),
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_6, 0, 1, 5),
    HC_EXIT(),
    ...
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_6, 0, 1, 104),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (172) - 1, 0),
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_6, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    HC_RAW(BPF_JMP32 | BPF_JLE | BPF_K, BPF_REG_6, 0, 1, 31),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_6, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    HC_RAW(BPF_JMP32 | BPF_JLE | BPF_K, BPF_REG_6, 0, 1, 63),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_6, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    HC_RAW(BPF_JMP32 | BPF_JLE | BPF_K, BPF_REG_6, 0, 1, 79),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    ...
    HC_KINSN(HC_X86_RR_PAYLOAD(BPF_REG_6, HC_X86_R9), MICRO_HANDCRAFT_BPF_X86_MOVL),
    HC_RAW(BPF_JMP32 | BPF_JGT | BPF_K, BPF_REG_6, 0, 1, 95),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, 1, 0),
    ...
    HC_RAW(BPF_JMP | BPF_JSET | BPF_K, BPF_REG_3, 0, 1, -1),
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (-156) - 1, 0),
    ...
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (-160) - 1, 0),
    ...
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_3, 0, (-161) - 1, 6),
    ...
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (-165) - 1, 0),
    ...
    HC_RAW(BPF_JMP32 | BPF_JEQ | BPF_K, BPF_REG_3, 0, (-168) - 1, 3),
    ...
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (-174) - 1, 0),
    ...
    HC_RAW(BPF_JMP | BPF_JA, 0, 0, (-180) - 1, 0),
