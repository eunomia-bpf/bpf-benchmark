...
static const struct bpf_insn program[] = {
    ...
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_3, BPF_REG_2, 0, 0, 1, 0, 62, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    /* 0x1138: and    cl,0xf [exact-kinsn: andb imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_IMM_TMP_PAYLOAD(BPF_REG_4, 15, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_ANDB_IMM),
    /* 0x113b: cmp    cl,0x5 [warning-unmapped: CMP operand form has no current kinsn selector: cmp    cl,0x5] */
    ...
    HC_RAW(BPF_JMP | BPF_JNE | BPF_K, BPF_REG_7, 0, -27, 6),
    /* 0x1146: push   rbp [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1147: push   r14 [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    /* 0x1149: push   rbx [warning-unmapped: native stack-frame instruction belongs to ABI/prologue, not BPF verifier IR] */
    ...
    HC_KINSN(HC_LEA_TMP_PAYLOAD(BPF_REG_5, BPF_REG_2, 0, 0, 1, 0, 34, 0), MICRO_HANDCRAFT_BPF_X86_LEAQ),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_6, BPF_REG_6, 0, 0), MICRO_HANDCRAFT_BPF_X86_XORL),
    ...
    HC_RAW(BPF_JMP | BPF_JEQ | BPF_K, BPF_REG_6, 0, 39, 104),
    ...
    HC_RAW(BPF_JMP | BPF_JLE | BPF_K, BPF_REG_6, 0, 12, 31),
    ...
    HC_RAW(BPF_JMP | BPF_JLE | BPF_K, BPF_REG_6, 0, 9, 63),
    ...
    HC_RAW(BPF_JMP | BPF_JLE | BPF_K, BPF_REG_6, 0, 6, 79),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_4, BPF_REG_5, 0, 0), MICRO_HANDCRAFT_BPF_X86_ADDQ),
    /* 0x11a5: movzx  ebp,BYTE PTR [rcx] [warning-unmapped: destination register ebp is not in the BPF JIT register file] */
    ...
    /* 0x11e2: movzx  r9d,BYTE PTR [rsi+0x2c] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R9, BPF_REG_2, 44, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x11e7: movzx  r10d,BYTE PTR [rsi+0x2d] [exact-kinsn: direct memory load via x86 kinsn selector; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_MEM_TMP_PAYLOAD(HC_X86_R10, BPF_REG_2, 45, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVZBL_MEM),
    /* 0x11ec: mov    r11,rax [exact-kinsn: movq register-to-register kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_REG_REG_TMP_PAYLOAD(HC_X86_R11, BPF_REG_0, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_MOVQ_RR),
    /* 0x11ef: shl    r11,0x20 [exact-kinsn: shl64 imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_1, BPF_REG_0, 0, 0), MICRO_HANDCRAFT_BPF_X86_XORL),
    /* 0x11fc: or     rdi,r11 [exact-kinsn: or64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_9] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_1, HC_X86_R11, BPF_REG_7, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_ORQ),
    ...
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(BPF_REG_5, 48, 0), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x1207: or     r8,rcx [exact-kinsn: or64 reg kinsn] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_5, BPF_REG_4, 0, 0), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x120a: shl    r9,0x28 [exact-kinsn: shl64 imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R9, 40, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x120e: or     r9,r8 [exact-kinsn: or64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_9] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(HC_X86_R9, BPF_REG_5, BPF_REG_7, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x1211: shl    r10,0x20 [exact-kinsn: shl64 imm kinsn; verifier instantiate uses temp BPF_REG_7] */
    HC_KINSN(HC_X86_ALU_IMM_PAYLOAD(HC_X86_R10, 32, BPF_REG_7), MICRO_HANDCRAFT_BPF_X86_SHLQ),
    /* 0x1215: or     rdx,r9 [exact-kinsn: or64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_9] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_3, HC_X86_R9, BPF_REG_7, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_ORQ),
    /* 0x1218: or     rdx,r10 [exact-kinsn: or64 reg kinsn; verifier instantiate uses temps BPF_REG_7/BPF_REG_9] */
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_3, HC_X86_R10, BPF_REG_7, BPF_REG_9), MICRO_HANDCRAFT_BPF_X86_ORQ),
    ...
    HC_KINSN(HC_X86_ALU_RR_PAYLOAD(BPF_REG_3, BPF_REG_5, 0, 0), MICRO_HANDCRAFT_BPF_X86_ORQ),
