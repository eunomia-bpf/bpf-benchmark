...
vng --run .cache/runtime-kernel/x86_64/bzImage \
    ...
    --exec "ebpf-vm/x86/native_lab/tests/run_micro_one.sh bitmap_popcount_scan bitmap_popcount_scan_xdp 2056 1000"
```

Full sweep (all 26 xdp micros):

```sh
vng ... --exec ebpf-vm/x86/native_lab/tests/run_all_micro.sh \
