...
x86_l_1112:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_RCX, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_1116:
	/* 0x1116: cmp    rcx,r10 */
...
x86_l_111f:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_R9, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 22ULL);
x86_l_1123:
	/* 0x1123: cmp    r9,r10 */
...
x86_l_115f:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_R9, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 26ULL);
x86_l_1163:
	/* 0x1163: cmp    r9,r10 */
	X86_VM_RUN_STEP(X86_OP_CMP_REG, X86_R9, X86_R10, X86_WIDTH_64, 0, 0);
x86_l_1166:
...
x86_l_119f:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_RCX, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 30ULL);
x86_l_11a3:
	/* 0x11a3: cmp    rcx,r10 */
	X86_VM_RUN_STEP(X86_OP_CMP_REG, X86_RCX, X86_R10, X86_WIDTH_64, 0, 0);
x86_l_11a6:
...
x86_l_11bf:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_RCX, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 50ULL);
x86_l_11c3:
	/* 0x11c3: cmp    rcx,r10 */
	X86_VM_RUN_STEP(X86_OP_CMP_REG, X86_RCX, X86_R10, X86_WIDTH_64, 0, 0);
x86_l_11c6:
...
x86_l_11c8:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_R9, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 30ULL);
x86_l_11cc:
...
x86_l_11e3:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_RDI, X86_R9, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 20ULL);
x86_l_11e7:
	/* 0x11e7: cmp    rdi,r10 */
...
x86_l_1209:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_RBX, X86_R9, X86_WIDTH_64, X86_MEM_AUX(X86_RDI, 2), 0ULL);
x86_l_120d:
	/* 0x120d: cmp    rbx,r10 */
...
x86_l_1219:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_R14, X86_RBX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 20ULL);
x86_l_121d:
	/* 0x121d: cmp    r14,r10 */
...
x86_l_1235:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_R15, X86_RBX, X86_WIDTH_64, X86_MEM_AUX(X86_R11, 0), 0ULL);
x86_l_1239:
	/* 0x1239: cmp    r15,r10 */
...
x86_l_124c:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_R15, X86_RBX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 32ULL);
x86_l_1250:
	/* 0x1250: cmp    r15,r10 */
	X86_VM_RUN_STEP(X86_OP_CMP_REG, X86_R15, X86_R10, X86_WIDTH_64, 0, 0);
x86_l_1253:
