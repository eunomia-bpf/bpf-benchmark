...
x86_l_113b:
	...
	X86_VM_RUN_OP(X86_OP_MOV_IMM, X86_R9, X86_REG_NONE, X86_WIDTH_64, 0, 15485907386658061715ULL);
x86_l_1145:
	/* 0x1145: mov    edi,0x300 */
	X86_VM_RUN_OP(X86_OP_MOV_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, 0, 768ULL);
x86_l_114a:
	/* 0x114a: xor    r8d,r8d */
...
x86_l_1154:
	/* 0x1154: mov    ecx,ecx */
	X86_VM_RUN_OP(X86_OP_MOV_REG, X86_RCX, X86_RCX, X86_WIDTH_32, 0, 0);
x86_l_1156:
	/* 0x1156: or     rcx,r14 */
	X86_VM_RUN_OP(X86_OP_ALU_REG, X86_RCX, X86_R14, X86_WIDTH_64, X86_ALU_OR, 0);
x86_l_1159:
	/* 0x1159: add    r11,rcx */
	X86_VM_RUN_OP(X86_OP_ALU_REG, X86_R11, X86_RCX, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_115c:
	/* 0x115c: movzx  r9d,WORD PTR [rsi-0x1] */
	X86_VM_RUN_OP(X86_OP_MOV_LOAD, X86_R9, X86_RSI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_16), 18446744073709551615ULL);
x86_l_1161:
	/* 0x1161: lea    ecx,[rax*4+0x0] */
	X86_VM_RUN_OP(X86_OP_LEA, X86_RCX, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_RAX, 2), 0ULL);
x86_l_1168:
	/* 0x1168: and    cl,0x1c */
	X86_VM_RUN_OP(X86_OP_ALU_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_8, X86_ALU_AND, 28ULL);
x86_l_116b:
	/* 0x116b: shl    rbx,cl */
	X86_VM_RUN_OP(X86_OP_ALU_REG, X86_RBX, X86_RCX, X86_WIDTH_64, X86_ALU_SHL, 0);
x86_l_116e:
	/* 0x116e: xor    rbx,r11 */
	X86_VM_RUN_OP(X86_OP_ALU_REG, X86_RBX, X86_R11, X86_WIDTH_64, X86_ALU_XOR, 0);
x86_l_1171:
	/* 0x1171: mov    ecx,r8d */
...
x86_l_1186:
	/* 0x1186: mov    r10,r9 */
	X86_VM_RUN_OP(X86_OP_MOV_REG, X86_R10, X86_R9, X86_WIDTH_64, 0, 0);
x86_l_1189:
	/* 0x1189: shl    r10,cl */
	X86_VM_RUN_OP(X86_OP_ALU_REG, X86_R10, X86_RCX, X86_WIDTH_64, X86_ALU_SHL, 0);
x86_l_118c:
	/* 0x118c: not    al */
...
x86_l_1190:
	/* 0x1190: shr    r9,cl */
	X86_VM_RUN_OP(X86_OP_ALU_REG, X86_R9, X86_RCX, X86_WIDTH_64, X86_ALU_SHR, 0);
x86_l_1193:
	/* 0x1193: or     r9,r10 */
...
x86_l_119e:
	...
	X86_VM_RUN_OP(X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 18446744073709551592ULL);
x86_l_11a2:
...
x86_l_11a4:
	...
	X86_VM_RUN_OP(X86_OP_MOV_LOAD, X86_R10, X86_RSI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 18446744073709551593ULL);
x86_l_11a9:
	/* 0x11a9: and    r10d,0x3 */
	X86_VM_RUN_OP(X86_OP_ALU_IMM, X86_R10, X86_REG_NONE, X86_WIDTH_32, X86_ALU_AND, 3ULL);
x86_l_11ad:
	/* 0x11ad: lea    rax,[r10+0x18] */
	X86_VM_RUN_OP(X86_OP_LEA, X86_RAX, X86_R10, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 24ULL);
x86_l_11b1:
	/* 0x11b1: cmp    rdi,rax */
	X86_VM_RUN_OP(X86_OP_CMP_REG, X86_RDI, X86_RAX, X86_WIDTH_64, 0, 0);
x86_l_11b4:
...
x86_l_11b6:
	...
	X86_VM_RUN_OP(X86_OP_MOV_LOAD, X86_RAX, X86_RSI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 18446744073709551594ULL);
x86_l_11ba:
	/* 0x11ba: mov    ebx,DWORD PTR [rsi-0x13] */
	X86_VM_RUN_OP(X86_OP_MOV_LOAD, X86_RBX, X86_RSI, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551597ULL);
x86_l_11bd:
	/* 0x11bd: mov    r14d,DWORD PTR [rsi-0xf] */
	X86_VM_RUN_OP(X86_OP_MOV_LOAD, X86_R14, X86_RSI, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551601ULL);
x86_l_11c1:
...
x86_l_11c4:
	...
	X86_VM_RUN_OP(X86_OP_MOV_LOAD, X86_R11, X86_RSI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_16), 18446744073709551613ULL);
x86_l_11c9:
	/* 0x11c9: add    rbx,r9 */
	X86_VM_RUN_OP(X86_OP_ALU_REG, X86_RBX, X86_R9, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_11cc:
	/* 0x11cc: add    r11,r14 */
	X86_VM_RUN_OP(X86_OP_ALU_REG, X86_R11, X86_R14, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_11cf:
	/* 0x11cf: add    r11,rbx */
	X86_VM_RUN_OP(X86_OP_ALU_REG, X86_R11, X86_RBX, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_11d2:
	/* 0x11d2: mov    ebx,DWORD PTR [rsi-0x7] */
	X86_VM_RUN_OP(X86_OP_MOV_LOAD, X86_RBX, X86_RSI, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551609ULL);
x86_l_11d5:
	/* 0x11d5: test   al,0x1 */
	X86_VM_RUN_OP(X86_OP_TEST_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_8, 0, 1ULL);
x86_l_11d7:
...
x86_l_11e1:
	/* 0x11e1: or     rcx,rbx */
	X86_VM_RUN_OP(X86_OP_ALU_REG, X86_RCX, X86_RBX, X86_WIDTH_64, X86_ALU_OR, 0);
x86_l_11e4:
	/* 0x11e4: xor    r11,rcx */
