...
x86_l_1160:
	...
	X86_VM_LOOP_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_R9, X86_RAX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_RCX, 1, X86_WIDTH_16), 16ULL);
x86_l_1166:
	/* 0x1166: add    r9d,r8d */
	X86_VM_LOOP_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R9, X86_R8, X86_WIDTH_32, X86_ALU_ADD, 0);
x86_l_1169:
	/* 0x1169: movzx  r8d,r9w */
	X86_VM_LOOP_OP(x86_exec_movzx_reg, X86_OP_MOVZX_REG, X86_R8, X86_R9, X86_WIDTH_32, X86_WIDTH_16, 0);
x86_l_116d:
	/* 0x116d: shr    r9d,0x10 */
	X86_VM_LOOP_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R9, X86_REG_NONE, X86_WIDTH_32, X86_ALU_SHR, 16ULL);
x86_l_1171:
	/* 0x1171: add    r9d,r8d */
	X86_VM_LOOP_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R9, X86_R8, X86_WIDTH_32, X86_ALU_ADD, 0);
x86_l_1174:
	/* 0x1174: movzx  r8d,WORD PTR [rax+rcx*2+0x12] */
	X86_VM_LOOP_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_R8, X86_RAX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_RCX, 1, X86_WIDTH_16), 18ULL);
x86_l_117a:
	/* 0x117a: add    r8d,r9d */
	X86_VM_LOOP_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R8, X86_R9, X86_WIDTH_32, X86_ALU_ADD, 0);
x86_l_117d:
	/* 0x117d: movzx  r9d,r8w */
	X86_VM_LOOP_OP(x86_exec_movzx_reg, X86_OP_MOVZX_REG, X86_R9, X86_R8, X86_WIDTH_32, X86_WIDTH_16, 0);
x86_l_1181:
	/* 0x1181: shr    r8d,0x10 */
...
x86_l_1188:
	/* 0x1188: add    rcx,0x2 */
	X86_VM_LOOP_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 2ULL);
x86_l_118c:
...
x86_l_1150:
	/* 0x1150: xor    ecx,ecx */
	X86_VM_LOOP_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RCX, X86_RCX, X86_WIDTH_32, X86_ALU_XOR, 0);
x86_l_1152:
	/* 0x1152: xor    r8d,r8d */
	X86_VM_LOOP_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R8, X86_R8, X86_WIDTH_32, X86_ALU_XOR, 0);
x86_l_1155:
...
x86_l_1195:
	/* 0x1195: mov    ecx,r8d */
	X86_VM_LOOP_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RCX, X86_R8, X86_WIDTH_32, 0, 0);
x86_l_1198:
	/* 0x1198: shr    ecx,0x10 */
	X86_VM_LOOP_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, X86_ALU_SHR, 16ULL);
x86_l_119b:
	/* 0x119b: add    ecx,r8d */
	X86_VM_LOOP_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RCX, X86_R8, X86_WIDTH_32, X86_ALU_ADD, 0);
x86_l_119e:
	/* 0x119e: not    ecx */
	X86_VM_LOOP_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, X86_ALU_NOT, 0);
x86_l_11a0:
	/* 0x11a0: movzx  r8d,cx */
	X86_VM_LOOP_OP(x86_exec_movzx_reg, X86_OP_MOVZX_REG, X86_R8, X86_RCX, X86_WIDTH_32, X86_WIDTH_16, 0);
x86_l_11a4:
	/* 0x11a4: mov    ecx,esi */
	X86_VM_LOOP_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RCX, X86_RSI, X86_WIDTH_32, 0, 0);
x86_l_11a6:
	/* 0x11a6: shl    ecx,0x4 */
	X86_VM_LOOP_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, X86_ALU_SHL, 4ULL);
x86_l_11a9:
	/* 0x11a9: shl    r8,cl */
	X86_VM_LOOP_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R8, X86_RCX, X86_WIDTH_64, X86_ALU_SHL, 0);
x86_l_11ac:
	/* 0x11ac: xor    rdx,r8 */
	X86_VM_LOOP_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDX, X86_R8, X86_WIDTH_64, X86_ALU_XOR, 0);
x86_l_11af:
	/* 0x11af: inc    esi */
	X86_VM_LOOP_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RSI, X86_REG_NONE, X86_WIDTH_32, X86_ALU_INC, 1);
x86_l_11b1:
	/* 0x11b1: cmp    esi,0x20 */
