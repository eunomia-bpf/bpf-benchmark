...
x86_l_111f:
	...
	X86_VM_X86_JCC(X86_CC_A, 0x111f, 0x110e, x86_l_110e);
x86_l_1121:
...
x86_l_1132:
	...
	X86_VM_X86_JCC(X86_CC_NE, 0x1132, 0x110e, x86_l_110e);
x86_l_1134:
...
x86_l_113e:
	...
	X86_VM_X86_JCC(X86_CC_NE, 0x113e, 0x110e, x86_l_110e);
x86_l_1140:
...
x86_l_1144:
	...
	X86_VM_X86_JCC(X86_CC_NE, 0x1144, 0x110e, x86_l_110e);
x86_l_1146:
	/* 0x1146: push   rbp */
...
x86_l_1157:
	...
	X86_VM_X86_JMP(0x1157, 0x117c, x86_l_117c);
x86_l_1159:
...
x86_l_1176:
	...
	X86_VM_X86_JCC(X86_CC_E, 0x1176, 0x1389, x86_l_1389);
x86_l_117c:
	/* 0x117c: mov    edx,r9d */
...
x86_l_119b:
	...
	X86_VM_X86_JCC(X86_CC_A, 0x119b, 0x11a5, x86_l_11a5);
x86_l_119d:
...
x86_l_124e:
	...
	X86_VM_X86_JMP(0x124e, 0x12c0, x86_l_12c0);
x86_l_1250:
...
x86_l_125c:
	...
	X86_VM_X86_JMP(0x125c, 0x12c0, x86_l_12c0);
x86_l_125e:
...
x86_l_126a:
	...
	X86_VM_X86_JMP(0x126a, 0x12c0, x86_l_12c0);
x86_l_126c:
	/* 0x126c: mov    r11d,0xe */
...
x86_l_1278:
	...
	X86_VM_X86_JMP(0x1278, 0x12c0, x86_l_12c0);
x86_l_127a:
...
x86_l_1286:
	...
	X86_VM_X86_JMP(0x1286, 0x12c0, x86_l_12c0);
x86_l_1288:
...
x86_l_1294:
	...
	X86_VM_X86_JMP(0x1294, 0x12c0, x86_l_12c0);
x86_l_1296:
...
x86_l_12a2:
	...
	X86_VM_X86_JMP(0x12a2, 0x12c0, x86_l_12c0);
x86_l_12a4:
...
x86_l_12b0:
	...
	X86_VM_X86_JMP(0x12b0, 0x12c0, x86_l_12c0);
x86_l_12b2:
...
x86_l_12c5:
	...
	X86_VM_X86_JCC(X86_CC_E, 0x12c5, 0x116c, x86_l_116c);
x86_l_12cb:
	/* 0x12cb: shl    r10d,cl */
	X86_VM_RUN_OP(X86_OP_ALU_REG, X86_R10, X86_RCX, X86_WIDTH_32, X86_ALU_SHL, 0);
x86_l_12ce:
