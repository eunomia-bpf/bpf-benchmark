...
x86_l_1154:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_R9, X86_REG_NONE, X86_WIDTH_64, 0, 3749ULL);
x86_l_115b:
	/* 0x115b: lea    r10,[rip+0xed2] */
	X86_VM_RUN_STEP(X86_OP_LEA, X86_R10, X86_REG_NONE, X86_WIDTH_64, 0, 3794ULL);
x86_l_1162:
	/* 0x1162: lea    r11,[rip+0xeff] */
	X86_VM_RUN_STEP(X86_OP_LEA, X86_R11, X86_REG_NONE, X86_WIDTH_64, 0, 3839ULL);
x86_l_1169:
	/* 0x1169: xor    ebx,ebx */
