...
x86_l_1118:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_RDX, X86_RSI, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 62ULL);
x86_l_111c:
	/* 0x111c: cmp    rdx,rcx */
	X86_VM_RUN_STEP(X86_OP_CMP_REG, X86_RDX, X86_RCX, X86_WIDTH_64, 0, 0);
x86_l_111f:
...
x86_l_114a:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_RDI, X86_RSI, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 31ULL);
x86_l_114e:
	/* 0x114e: lea    r8,[rsi+0x22] */
	X86_VM_RUN_STEP(X86_OP_LEA, X86_R8, X86_RSI, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 34ULL);
x86_l_1152:
	/* 0x1152: xor    eax,eax */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_RAX, X86_RAX, X86_WIDTH_32, X86_ALU_XOR, 0);
x86_l_1154:
...
x86_l_11ba:
	...
	X86_VM_RUN_STEP(X86_OP_ALU_MEM, X86_RBP, X86_R9, X86_WIDTH_32, (X86_MEM_AUX_FULL(X86_RDX, 2, X86_WIDTH_32) | X86_MEM_AUX_ALU_OP(X86_ALU_OR)), 0ULL);
x86_l_11be:
	/* 0x11be: test   ecx,ecx */
...
x86_l_11f3:
	...
	X86_VM_RUN_STEP(X86_OP_ALU_MEM, X86_RDX, X86_RSI, X86_WIDTH_32, (X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_32) | X86_MEM_AUX_ALU_OP(X86_ALU_XOR)), 34ULL);
x86_l_11f6:
	/* 0x11f6: bswap  edx */
