...
x86_l_1195:
	...
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_R14, X86_RCX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 31ULL);
x86_l_119a:
	/* 0x119a: mov    esi,0x2 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RSI, X86_REG_NONE, X86_WIDTH_32, 0, 2ULL);
x86_l_119f:
	/* 0x119f: cmp    r14d,0x1 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, 0, 1ULL);
x86_l_11a3:
...
x86_l_11ad:
	...
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_RBP, X86_RCX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_16), 24ULL);
x86_l_11b1:
...
x86_l_11bf:
	...
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_R15, X86_RCX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 38ULL);
x86_l_11c3:
	/* 0x11c3: cmp    r14d,0x11 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, 0, 17ULL);
x86_l_11c7:
...
x86_l_11cd:
	/* 0x11cd: cmp    r14d,0x6 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, 0, 6ULL);
x86_l_11d1:
...
x86_l_11d3:
	...
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_R12, X86_RCX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 62ULL);
x86_l_11d7:
	/* 0x11d7: cmp    r12,rbx */
	X86_VM_RUN_OP(x86_exec_cmp_reg, X86_OP_CMP_REG, X86_R12, X86_RBX, X86_WIDTH_64, 0, 0);
x86_l_11da:
...
x86_l_11f8:
	...
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_R12, X86_RCX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 28ULL);
x86_l_11fd:
	/* 0x11fd: cmp    r12d,0x2c */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_R12, X86_REG_NONE, X86_WIDTH_32, 0, 44ULL);
x86_l_1201:
...
x86_l_1207:
	...
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_R12, X86_REG_NONE, X86_WIDTH_32, 0, 58ULL);
x86_l_120b:
...
x86_l_123d:
	...
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_RDX, X86_RCX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 22ULL);
x86_l_1241:
	/* 0x1241: movzx  r15d,BYTE PTR [rcx+0x17] */
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_R15, X86_RCX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 23ULL);
x86_l_1246:
	/* 0x1246: movzx  r14d,WORD PTR [rcx+0x1a] */
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_R14, X86_RCX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_16), 26ULL);
x86_l_124b:
	/* 0x124b: mov    edi,DWORD PTR [rcx+0x1e] */
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_RDI, X86_RCX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 30ULL);
x86_l_124e:
	/* 0x124e: mov    r11d,DWORD PTR [rcx+0x26] */
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_R11, X86_RCX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 38ULL);
x86_l_1252:
	/* 0x1252: mov    ebp,DWORD PTR [rcx+0x2a] */
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_RBP, X86_RCX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 42ULL);
x86_l_1255:
	/* 0x1255: mov    r13d,DWORD PTR [rcx+0x2e] */
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_R13, X86_RCX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 46ULL);
x86_l_1259:
...
x86_l_1268:
	...
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_R12, X86_REG_NONE, X86_WIDTH_32, 0, 17ULL);
x86_l_126c:
...
x86_l_126e:
	/* 0x126e: cmp    r12d,0x6 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_R12, X86_REG_NONE, X86_WIDTH_32, 0, 6ULL);
x86_l_1272:
...
x86_l_1274:
	...
	X86_VM_RUN_OP(x86_exec_mov_store_reg, X86_OP_MOV_STORE_REG, X86_RSP, X86_RDI, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551608ULL);
x86_l_1279:
	/* 0x1279: lea    rdi,[rcx+0x52] */
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_RDI, X86_RCX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 82ULL);
x86_l_127d:
	/* 0x127d: cmp    rdi,rbx */
	X86_VM_RUN_OP(x86_exec_cmp_reg, X86_OP_CMP_REG, X86_RDI, X86_RBX, X86_WIDTH_64, 0, 0);
x86_l_1280:
...
x86_l_128d:
	...
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_RDI, X86_RCX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 70ULL);
x86_l_1291:
	/* 0x1291: cmp    rdi,rbx */
	X86_VM_RUN_OP(x86_exec_cmp_reg, X86_OP_CMP_REG, X86_RDI, X86_RBX, X86_WIDTH_64, 0, 0);
x86_l_1294:
...
x86_l_12a0:
	...
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_R13, X86_REG_NONE, X86_WIDTH_32, 0, 16868362ULL);
x86_l_12a7:
...
x86_l_12a9:
	...
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_RDI, X86_RCX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_16), 64ULL);
x86_l_12ad:
	/* 0x12ad: mov    r9d,0x2 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R9, X86_REG_NONE, X86_WIDTH_32, 0, 2ULL);
x86_l_12b3:
	/* 0x12b3: cmp    edi,0x901f */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, 0, 36895ULL);
x86_l_12b9:
...
x86_l_12d7:
	/* 0x12d7: shr    r15b,0x4 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R15, X86_REG_NONE, X86_WIDTH_8, X86_ALU_SHR, 4ULL);
x86_l_12db:
	/* 0x12db: mov    r12d,edx */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_R12, X86_RDX, X86_WIDTH_32, 0, 0);
x86_l_12de:
	/* 0x12de: shl    r12b,0x4 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R12, X86_REG_NONE, X86_WIDTH_8, X86_ALU_SHL, 4ULL);
x86_l_12e2:
	/* 0x12e2: or     r12b,r15b */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R12, X86_R15, X86_WIDTH_8, X86_ALU_OR, 0);
x86_l_12e5:
	/* 0x12e5: rol    r14w,0x8 */
...
x86_l_12ee:
	/* 0x12ee: mov    edi,ebp */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RDI, X86_RBP, X86_WIDTH_32, 0, 0);
x86_l_12f0:
	/* 0x12f0: and    edi,0xff000000 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, X86_ALU_AND, 4278190080ULL);
x86_l_12f6:
	/* 0x12f6: lea    r9d,[r11-0x21523f01] */
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_R9, X86_R11, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073150513407ULL);
x86_l_12fd:
	/* 0x12fd: mov    r10d,ebp */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_R10, X86_RBP, X86_WIDTH_32, 0, 0);
x86_l_1300:
	/* 0x1300: and    r10d,0xff0000 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R10, X86_REG_NONE, X86_WIDTH_32, X86_ALU_AND, 16711680ULL);
x86_l_1307:
	/* 0x1307: add    r10d,edi */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R10, X86_RDI, X86_WIDTH_32, X86_ALU_ADD, 0);
x86_l_130a:
	/* 0x130a: mov    edi,ebp */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RDI, X86_RBP, X86_WIDTH_32, 0, 0);
x86_l_130c:
	/* 0x130c: and    edi,0xff00 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, X86_ALU_AND, 65280ULL);
x86_l_1312:
	/* 0x1312: add    edi,r10d */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDI, X86_R10, X86_WIDTH_32, X86_ALU_ADD, 0);
x86_l_1315:
	/* 0x1315: movzx  ebx,bpl */
	X86_VM_RUN_OP(x86_exec_movzx_reg, X86_OP_MOVZX_REG, X86_RBX, X86_RBP, X86_WIDTH_32, X86_WIDTH_8, 0);
x86_l_1319:
	/* 0x1319: add    ebx,edi */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RBX, X86_RDI, X86_WIDTH_32, X86_ALU_ADD, 0);
x86_l_131b:
	/* 0x131b: mov    rdx,QWORD PTR [rsp-0x8] */
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_RDX, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551608ULL);
x86_l_1320:
	/* 0x1320: mov    edi,edx */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RDI, X86_RDX, X86_WIDTH_32, 0, 0);
x86_l_1322:
	/* 0x1322: sub    edi,r11d */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDI, X86_R11, X86_WIDTH_32, X86_ALU_SUB, 0);
x86_l_1325:
	/* 0x1325: mov    r14d,r9d */
...
x86_l_132c:
	/* 0x132c: xor    r14d,edi */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R14, X86_RDI, X86_WIDTH_32, X86_ALU_XOR, 0);
x86_l_132f:
	/* 0x132f: add    r9d,r8d */
...
x86_l_1342:
	...
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_RDI, X86_R10, X86_WIDTH_32, X86_MEM_AUX(X86_R14, 0), 0ULL);
x86_l_1346:
	/* 0x1346: sub    r9d,r10d */
...
x86_l_1368:
	...
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_R14, X86_R11, X86_WIDTH_32, 0, 0);
x86_l_136b:
	/* 0x136b: rol    r14d,0x13 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, X86_ALU_ROL, 19ULL);
x86_l_136f:
	/* 0x136f: xor    r14d,edi */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R14, X86_RDI, X86_WIDTH_32, X86_ALU_XOR, 0);
x86_l_1372:
...
x86_l_1375:
	...
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_R9, X86_R14, X86_WIDTH_32, X86_MEM_AUX(X86_R11, 0), 0ULL);
x86_l_1379:
...
x86_l_1386:
	...
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R10, X86_R14, X86_WIDTH_32, X86_ALU_XOR, 0);
x86_l_1389:
	/* 0x1389: mov    edi,r9d */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RDI, X86_R9, X86_WIDTH_32, 0, 0);
x86_l_138c:
	/* 0x138c: rol    edi,0xe */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, X86_ALU_ROL, 14ULL);
x86_l_138f:
	/* 0x138f: sub    r10d,edi */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R10, X86_RDI, X86_WIDTH_32, X86_ALU_SUB, 0);
x86_l_1392:
	/* 0x1392: mov    edi,r10d */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RDI, X86_R10, X86_WIDTH_32, 0, 0);
x86_l_1395:
	/* 0x1395: rol    edi,0xb */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, X86_ALU_ROL, 11ULL);
x86_l_1398:
	/* 0x1398: xor    r11d,r10d */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R11, X86_R10, X86_WIDTH_32, X86_ALU_XOR, 0);
x86_l_139b:
	/* 0x139b: sub    r11d,edi */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R11, X86_RDI, X86_WIDTH_32, X86_ALU_SUB, 0);
x86_l_139e:
	/* 0x139e: xor    r9d,r11d */
...
x86_l_13a4:
	/* 0x13a4: rol    edi,0x19 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, X86_ALU_ROL, 25ULL);
x86_l_13a7:
	/* 0x13a7: sub    r9d,edi */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R9, X86_RDI, X86_WIDTH_32, X86_ALU_SUB, 0);
x86_l_13aa:
	/* 0x13aa: xor    r10d,r9d */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R10, X86_R9, X86_WIDTH_32, X86_ALU_XOR, 0);
x86_l_13ad:
...
x86_l_13b0:
	/* 0x13b0: rol    edi,0x10 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, X86_ALU_ROL, 16ULL);
x86_l_13b3:
	/* 0x13b3: sub    r10d,edi */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R10, X86_RDI, X86_WIDTH_32, X86_ALU_SUB, 0);
x86_l_13b6:
...
x86_l_13cf:
	/* 0x13cf: rol    edi,0x18 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, X86_ALU_ROL, 24ULL);
x86_l_13d2:
	/* 0x13d2: xor    r9d,r10d */
...
x86_l_13f3:
	...
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, 0, 1892417536ULL);
x86_l_13f8:
	/* 0x13f8: shrd   edi,r11d,0x12 */
	X86_VM_RUN_OP(x86_exec_shrd_imm, X86_OP_SHRD_IMM, X86_RDI, X86_R11, X86_WIDTH_32, 0, 18ULL);
x86_l_13fd:
	/* 0x13fd: sub    r10d,edi */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R10, X86_RDI, X86_WIDTH_32, X86_ALU_SUB, 0);
x86_l_1400:
...
x86_l_1444:
	...
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, 0, 4294901761ULL);
x86_l_1449:
	/* 0x1449: imul   rdi,r10 */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDI, X86_R10, X86_WIDTH_64, X86_ALU_IMUL, 0);
x86_l_144d:
	/* 0x144d: shr    rdi,0x30 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_64, X86_ALU_SHR, 48ULL);
x86_l_1451:
	/* 0x1451: mov    r9d,edi */
...
x86_l_1458:
	/* 0x1458: or     r9d,edi */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R9, X86_RDI, X86_WIDTH_32, X86_ALU_OR, 0);
x86_l_145b:
	/* 0x145b: sub    r10d,r9d */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R10, X86_R9, X86_WIDTH_32, X86_ALU_SUB, 0);
x86_l_145e:
	/* 0x145e: mov    rdi,rdx */
...
x86_l_146e:
	/* 0x146e: mov    r11,rdi */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_R11, X86_RDI, X86_WIDTH_64, 0, 0);
x86_l_1471:
	/* 0x1471: shr    r11,0x2 */
...
x86_l_1478:
	...
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R9, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 16868362ULL);
x86_l_147f:
	/* 0x147f: xor    r9,rdi */
...
x86_l_1496:
	...
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_32, 0, 2417950720ULL);
x86_l_149b:
	/* 0x149b: add    rbx,rdi */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RBX, X86_RDI, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_149e:
	/* 0x149e: add    rbx,r11 */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RBX, X86_R11, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_14a1:
	/* 0x14a1: xor    rbx,r9 */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RBX, X86_R9, X86_WIDTH_64, X86_ALU_XOR, 0);
x86_l_14a4:
	/* 0x14a4: mov    rdi,rbx */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RDI, X86_RBX, X86_WIDTH_64, 0, 0);
x86_l_14a7:
	/* 0x14a7: shl    rdi,0x6 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_64, X86_ALU_SHL, 6ULL);
x86_l_14ab:
	/* 0x14ab: mov    r9,rbx */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_R9, X86_RBX, X86_WIDTH_64, 0, 0);
x86_l_14ae:
	/* 0x14ae: shr    r9,0x2 */
...
x86_l_14bb:
	/* 0x14bb: xor    rdi,rbx */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDI, X86_RBX, X86_WIDTH_64, X86_ALU_XOR, 0);
x86_l_14be:
	/* 0x14be: mov    r9,rdi */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_R9, X86_RDI, X86_WIDTH_64, 0, 0);
x86_l_14c1:
...
x86_l_14cf:
	/* 0x14cf: add    r9,r10 */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R9, X86_R10, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_14d2:
	/* 0x14d2: inc    r9 */
...
x86_l_14e9:
	/* 0x14e9: add    r10,rdi */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R10, X86_RDI, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_14ec:
	/* 0x14ec: xor    r10,r9 */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R10, X86_R9, X86_WIDTH_64, X86_ALU_XOR, 0);
x86_l_14ef:
	/* 0x14ef: mov    r11,r10 */
...
x86_l_14f6:
	/* 0x14f6: add    r11,rsi */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R11, X86_RSI, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_14f9:
	/* 0x14f9: add    r11,rax */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R11, X86_RAX, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_14fc:
...
x86_l_150f:
	...
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RDX, X86_REG_NONE, X86_WIDTH_32, X86_ALU_AND, 4294901760ULL);
x86_l_1515:
	/* 0x1515: xor    edx,r8d */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDX, X86_R8, X86_WIDTH_32, X86_ALU_XOR, 0);
x86_l_1518:
	/* 0x1518: mov    edi,esi */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RDI, X86_RSI, X86_WIDTH_32, 0, 0);
x86_l_151a:
	/* 0x151a: add    edi,0x14 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, X86_ALU_ADD, 20ULL);
x86_l_151d:
	/* 0x151d: rol    di,0x8 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_16, X86_ALU_ROL, 8ULL);
x86_l_1521:
	/* 0x1521: movzx  r8d,r12b */
	X86_VM_RUN_OP(x86_exec_movzx_reg, X86_OP_MOVZX_REG, X86_R8, X86_R12, X86_WIDTH_32, X86_WIDTH_8, 0);
x86_l_1525:
	/* 0x1525: movzx  edi,di */
	X86_VM_RUN_OP(x86_exec_movzx_reg, X86_OP_MOVZX_REG, X86_RDI, X86_RDI, X86_WIDTH_32, X86_WIDTH_16, 0);
x86_l_1528:
	/* 0x1528: mov    r11d,edx */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_R11, X86_RDX, X86_WIDTH_32, 0, 0);
x86_l_152b:
	/* 0x152b: shr    r11d,0x10 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R11, X86_REG_NONE, X86_WIDTH_32, X86_ALU_SHR, 16ULL);
x86_l_152f:
	/* 0x152f: add    rdi,r8 */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDI, X86_R8, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_1532:
	/* 0x1532: add    rdi,r11 */
...
x86_l_1543:
	...
	X86_VM_RUN_OP(x86_exec_movzx_reg, X86_OP_MOVZX_REG, X86_R11, X86_RDI, X86_WIDTH_32, X86_WIDTH_16, 0);
x86_l_1547:
	/* 0x1547: add    r11,r8 */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R11, X86_R8, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_154a:
...
x86_l_1551:
	...
	X86_VM_RUN_OP(x86_exec_cmov, X86_OP_CMOV, X86_R11, X86_RDI, X86_WIDTH_64, X86_CC_B, 0);
x86_l_1555:
	/* 0x1555: mov    edi,r11d */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RDI, X86_R11, X86_WIDTH_32, 0, 0);
x86_l_1558:
...
x86_l_155b:
	...
	X86_VM_RUN_OP(x86_exec_movzx_reg, X86_OP_MOVZX_REG, X86_R8, X86_R11, X86_WIDTH_32, X86_WIDTH_16, 0);
x86_l_155f:
	/* 0x155f: add    r8,rdi */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R8, X86_RDI, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_1562:
	/* 0x1562: cmp    r11,0x10000 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_R11, X86_REG_NONE, X86_WIDTH_64, 0, 65536ULL);
x86_l_1569:
	/* 0x1569: cmovb  r8,r11 */
	X86_VM_RUN_OP(x86_exec_cmov, X86_OP_CMOV, X86_R8, X86_R11, X86_WIDTH_64, X86_CC_B, 0);
x86_l_156d:
	/* 0x156d: mov    edi,r8d */
...
x86_l_1573:
	...
	X86_VM_RUN_OP(x86_exec_movzx_reg, X86_OP_MOVZX_REG, X86_R11, X86_R8, X86_WIDTH_32, X86_WIDTH_16, 0);
x86_l_1577:
	/* 0x1577: add    r11,rdi */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R11, X86_RDI, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_157a:
	/* 0x157a: cmp    r8,0x10000 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_64, 0, 65536ULL);
x86_l_1581:
	/* 0x1581: cmovb  r11,r8 */
	X86_VM_RUN_OP(x86_exec_cmov, X86_OP_CMOV, X86_R11, X86_R8, X86_WIDTH_64, X86_CC_B, 0);
x86_l_1585:
	/* 0x1585: mov    edi,r11d */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RDI, X86_R11, X86_WIDTH_32, 0, 0);
x86_l_1588:
...
x86_l_158b:
	/* 0x158b: add    edi,r11d */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDI, X86_R11, X86_WIDTH_32, X86_ALU_ADD, 0);
x86_l_158e:
	/* 0x158e: xor    r9,r10 */
...
x86_l_15a9:
	...
	X86_VM_RUN_OP(x86_exec_cmov, X86_OP_CMOV, X86_RDI, X86_R11, X86_WIDTH_32, X86_CC_B, 0);
x86_l_15ad:
	/* 0x15ad: shl    edi,0x10 */
...
x86_l_15e2:
	...
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_R12, X86_RCX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 50ULL);
x86_l_15e6:
	/* 0x15e6: cmp    r12,rbx */
	X86_VM_RUN_OP(x86_exec_cmp_reg, X86_OP_CMP_REG, X86_R12, X86_RBX, X86_WIDTH_64, 0, 0);
x86_l_15e9:
...
x86_l_161d:
	...
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_R15, X86_REG_NONE, X86_WIDTH_32, 0, 16868362ULL);
x86_l_1624:
...
x86_l_1642:
	/* 0x1642: cmp    r14b,0x6 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_8, 0, 6ULL);
x86_l_1646:
...
x86_l_165c:
	/* 0x165c: rol    bp,0x8 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RBP, X86_REG_NONE, X86_WIDTH_16, X86_ALU_ROL, 8ULL);
x86_l_1660:
	/* 0x1660: movzx  esi,bp */
	X86_VM_RUN_OP(x86_exec_movzx_reg, X86_OP_MOVZX_REG, X86_RSI, X86_RBP, X86_WIDTH_32, X86_WIDTH_16, 0);
x86_l_1663:
	/* 0x1663: shl    r8d,0x10 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_32, X86_ALU_SHL, 16ULL);
x86_l_1667:
...
x86_l_1688:
	...
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RBP, X86_REG_NONE, X86_WIDTH_32, 0, 1892417536ULL);
x86_l_168d:
	/* 0x168d: shrd   ebp,ebx,0x12 */
	X86_VM_RUN_OP(x86_exec_shrd_imm, X86_OP_SHRD_IMM, X86_RBP, X86_RBX, X86_WIDTH_32, 0, 18ULL);
x86_l_1691:
	/* 0x1691: sub    r10d,ebp */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R10, X86_RBP, X86_WIDTH_32, X86_ALU_SUB, 0);
x86_l_1694:
	/* 0x1694: lea    ebp,[r11-0x1f523f09] */
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_RBP, X86_R11, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073184067831ULL);
x86_l_169b:
	/* 0x169b: xor    ebp,r10d */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RBP, X86_R10, X86_WIDTH_32, X86_ALU_XOR, 0);
x86_l_169e:
	/* 0x169e: mov    r14d,r10d */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_R14, X86_R10, X86_WIDTH_32, 0, 0);
x86_l_16a1:
	/* 0x16a1: rol    r14d,0xb */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, X86_ALU_ROL, 11ULL);
x86_l_16a5:
	/* 0x16a5: sub    ebp,r14d */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RBP, X86_R14, X86_WIDTH_32, X86_ALU_SUB, 0);
x86_l_16a8:
	/* 0x16a8: mov    r14d,ebp */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_R14, X86_RBP, X86_WIDTH_32, 0, 0);
x86_l_16ab:
	/* 0x16ab: rol    r14d,0x19 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, X86_ALU_ROL, 25ULL);
x86_l_16af:
	/* 0x16af: xor    ebx,ebp */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RBX, X86_RBP, X86_WIDTH_32, X86_ALU_XOR, 0);
x86_l_16b1:
	/* 0x16b1: sub    ebx,r14d */
...
x86_l_16ba:
	...
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, X86_ALU_ROL, 16ULL);
x86_l_16be:
...
x86_l_16d0:
	/* 0x16d0: rol    ebp,0xe */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RBP, X86_REG_NONE, X86_WIDTH_32, X86_ALU_ROL, 14ULL);
x86_l_16d3:
	/* 0x16d3: sub    ebx,ebp */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RBX, X86_RBP, X86_WIDTH_32, X86_ALU_SUB, 0);
x86_l_16d5:
	/* 0x16d5: xor    r10d,ebx */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R10, X86_RBX, X86_WIDTH_32, X86_ALU_XOR, 0);
x86_l_16d8:
...
x86_l_16eb:
	/* 0x16eb: mov    ebp,ebx */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RBP, X86_RBX, X86_WIDTH_32, 0, 0);
x86_l_16ed:
	/* 0x16ed: shl    ebp,0x10 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RBP, X86_REG_NONE, X86_WIDTH_32, X86_ALU_SHL, 16ULL);
x86_l_16f0:
	/* 0x16f0: or     ebp,ebx */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RBP, X86_RBX, X86_WIDTH_32, X86_ALU_OR, 0);
x86_l_16f2:
	/* 0x16f2: sub    r10d,ebp */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R10, X86_RBP, X86_WIDTH_32, X86_ALU_SUB, 0);
x86_l_16f5:
