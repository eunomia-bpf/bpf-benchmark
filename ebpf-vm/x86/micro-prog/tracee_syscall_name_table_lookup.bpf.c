...
x86_l_1133:
	...
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_64, 0, 7640891576956012809ULL);
x86_l_113d:
...
x86_l_114a:
	...
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_R10, X86_REG_NONE, X86_WIDTH_64, X86_PTR_RODATA, 3759ULL);
x86_l_1151:
	/* 0x1151: lea    r11,[rsi+0xfa0614] */
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_R11, X86_RSI, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 16385556ULL);
x86_l_1158:
	/* 0x1158: lea    r15,[rip+0x111d] */
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_R15, X86_REG_NONE, X86_WIDTH_64, X86_PTR_RODATA, 4381ULL);
x86_l_115f:
	/* 0x115f: movabs r13,0x74616b6e696c6e75 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R13, X86_REG_NONE, X86_WIDTH_64, 0, 8386102103099862645ULL);
x86_l_1169:
	/* 0x1169: movabs rbp,0x74613274617473 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RBP, X86_REG_NONE, X86_WIDTH_64, 0, 32757966627239027ULL);
x86_l_1173:
	/* 0x1173: movabs r9,0x647466656e676973 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R9, X86_REG_NONE, X86_WIDTH_64, 0, 7238523086921230707ULL);
x86_l_117d:
...
x86_l_119c:
	/* 0x119c: cmp    eax,0xd8 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 216ULL);
x86_l_11a1:
...
x86_l_11ac:
	...
	X86_VM_RUN_OP(x86_exec_movsx_load, X86_OP_MOVSX_LOAD, X86_RCX, X86_R10, X86_WIDTH_64, X86_MEM_AUX_FULL(X86_RCX, 2, X86_WIDTH_32), 0ULL);
x86_l_11b0:
	/* 0x11b0: add    rcx,r10 */
...
x86_l_11c0:
	...
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 320ULL);
x86_l_11c5:
...
x86_l_11c7:
	...
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_RCX, X86_RAX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551359ULL);
x86_l_11cd:
	/* 0x11cd: cmp    ecx,0x22 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 34ULL);
x86_l_11d0:
...
x86_l_11d2:
	...
	X86_VM_RUN_OP(x86_exec_movsx_load, X86_OP_MOVSX_LOAD, X86_RCX, X86_R15, X86_WIDTH_64, X86_MEM_AUX_FULL(X86_RCX, 2, X86_WIDTH_32), 0ULL);
x86_l_11d6:
	/* 0x11d6: add    rcx,r15 */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RCX, X86_R15, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_11d9:
	/* 0x11d9: jmp    rcx */
	return XDP_ABORTED;
x86_l_11db:
	/* 0x11db: movabs rcx,0x74616e65706f */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_64, 0, 127961812791407ULL);
x86_l_11e5:
...
x86_l_1236:
	/* 0x1236: mov    rcx,rbp */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RCX, X86_RBP, X86_WIDTH_64, 0, 0);
x86_l_1239:
...
x86_l_1260:
	/* 0x1260: xor    r14,rax */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R14, X86_RAX, X86_WIDTH_64, X86_ALU_XOR, 0);
x86_l_1263:
...
x86_l_12c8:
	/* 0x12c8: mov    rcx,r11 */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RCX, X86_R11, X86_WIDTH_64, 0, 0);
x86_l_12cb:
...
x86_l_1300:
	/* 0x1300: mov    ebx,eax */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RBX, X86_RAX, X86_WIDTH_32, 0, 0);
x86_l_1302:
	/* 0x1302: xor    rbx,rcx */
...
x86_l_130e:
	/* 0x130e: mov    r12,rbx */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_R12, X86_RBX, X86_WIDTH_64, 0, 0);
x86_l_1311:
	/* 0x1311: shl    r12,cl */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R12, X86_RCX, X86_WIDTH_64, X86_ALU_SHL, 0);
x86_l_1314:
	/* 0x1314: mov    ecx,eax */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RCX, X86_RAX, X86_WIDTH_32, 0, 0);
x86_l_1316:
...
x86_l_1323:
	/* 0x1323: or     rbx,r12 */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RBX, X86_R12, X86_WIDTH_64, X86_ALU_OR, 0);
x86_l_1326:
	/* 0x1326: add    rbx,r14 */
...
x86_l_132c:
	/* 0x132c: mov    r14,rdi */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_R14, X86_RDI, X86_WIDTH_64, 0, 0);
x86_l_132f:
	/* 0x132f: inc    r8 */
...
x86_l_133c:
	...
	X86_VM_RUN_OP(x86_exec_mov_store_reg, X86_OP_MOV_STORE_REG, X86_RDX, X86_R14, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_133f:
	/* 0x133f: mov    eax,0x2 */
