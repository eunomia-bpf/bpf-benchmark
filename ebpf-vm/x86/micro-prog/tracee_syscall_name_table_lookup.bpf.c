...
x86_l_1118:
	...
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_RDI, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 268ULL);
x86_l_111f:
	/* 0x111f: cmp    rdi,rcx */
...
x86_l_1124:
	...
	X86_VM_RUN_OP(x86_exec_cmp_mem_imm, X86_OP_CMP_MEM_IMM, X86_RSI, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 64ULL);
x86_l_1127:
...
x86_l_1136:
	...
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R10, X86_REG_NONE, X86_WIDTH_64, 0, 7640891576956012809ULL);
x86_l_1140:
	/* 0x1140: movabs rsi,0x65736f6c63 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RSI, X86_REG_NONE, X86_WIDTH_64, 0, 435728378979ULL);
x86_l_114a:
	/* 0x114a: xor    r8d,r8d */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R8, X86_R8, X86_WIDTH_32, X86_ALU_XOR, 0);
x86_l_114d:
	/* 0x114d: lea    r9,[rsi+0xfa0614] */
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_R9, X86_RSI, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 16385556ULL);
x86_l_1154:
	/* 0x1154: movabs rbx,0x74616e65706f */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_64, 0, 127961812791407ULL);
x86_l_115e:
	/* 0x115e: movabs r14,0x74616b6e696c6e75 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_64, 0, 8386102103099862645ULL);
x86_l_1168:
	/* 0x1168: movabs r12,0x74613274617473 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R12, X86_REG_NONE, X86_WIDTH_64, 0, 32757966627239027ULL);
x86_l_1172:
	/* 0x1172: movabs r13,0x647466656e676973 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R13, X86_REG_NONE, X86_WIDTH_64, 0, 7238523086921230707ULL);
x86_l_117c:
...
x86_l_1180:
	...
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_RDI, X86_RDX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_R8, 2, X86_WIDTH_8), 12ULL);
x86_l_1186:
	/* 0x1186: movzx  ecx,BYTE PTR [rdx+r8*4+0xd] */
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_RCX, X86_RDX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_R8, 2, X86_WIDTH_8), 13ULL);
x86_l_118c:
	/* 0x118c: shl    ecx,0x8 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, X86_ALU_SHL, 8ULL);
x86_l_118f:
	/* 0x118f: or     ecx,edi */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RCX, X86_RDI, X86_WIDTH_32, X86_ALU_OR, 0);
x86_l_1191:
	/* 0x1191: movzx  eax,WORD PTR [rdx+r8*4+0xe] */
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_RAX, X86_RDX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_R8, 2, X86_WIDTH_16), 14ULL);
x86_l_1197:
	/* 0x1197: shl    eax,0x10 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, X86_ALU_SHL, 16ULL);
x86_l_119a:
	/* 0x119a: or     eax,ecx */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RAX, X86_RCX, X86_WIDTH_32, X86_ALU_OR, 0);
x86_l_119c:
	/* 0x119c: cmp    eax,0x4f */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 79ULL);
x86_l_119f:
...
x86_l_11a1:
	/* 0x11a1: cmp    eax,0x26 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 38ULL);
x86_l_11a4:
...
x86_l_11c9:
	...
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 1852141679ULL);
x86_l_11ce:
...
x86_l_11e0:
	...
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 256ULL);
x86_l_11e5:
...
x86_l_11e7:
	/* 0x11e7: cmp    eax,0x9d */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 157ULL);
x86_l_11ec:
...
x86_l_11fb:
	/* 0x11fb: cmp    eax,0x57 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 87ULL);
x86_l_11fe:
...
x86_l_1204:
	/* 0x1204: cmp    eax,0x59 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 89ULL);
x86_l_1207:
...
x86_l_120d:
	...
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_64, 0, 461413903445ULL);
x86_l_1217:
...
x86_l_1220:
	/* 0x1220: cmp    eax,0x3a */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 58ULL);
x86_l_1223:
...
x86_l_1229:
	/* 0x1229: cmp    eax,0x27 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 39ULL);
x86_l_122c:
...
x86_l_1232:
	/* 0x1232: cmp    eax,0x38 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 56ULL);
x86_l_1235:
...
x86_l_123b:
	/* 0x123b: cmp    eax,0x39 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 57ULL);
x86_l_123e:
...
x86_l_1244:
	...
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 1802661734ULL);
x86_l_1249:
...
x86_l_1250:
	...
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 290ULL);
x86_l_1255:
...
x86_l_125b:
	...
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 257ULL);
x86_l_1260:
...
x86_l_1266:
	...
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 263ULL);
x86_l_126b:
...
x86_l_1271:
	...
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 281ULL);
x86_l_1276:
...
x86_l_127c:
	/* 0x127c: mov    rcx,r12 */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RCX, X86_R12, X86_WIDTH_64, 0, 0);
x86_l_127f:
...
x86_l_1290:
	/* 0x1290: cmp    eax,0x9 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 9ULL);
x86_l_1293:
...
x86_l_1299:
	/* 0x1299: cmp    eax,0xc */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 12ULL);
x86_l_129c:
...
x86_l_12a2:
	...
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 1802658411ULL);
x86_l_12a7:
	/* 0x12a7: jmp    13b0 <tracee_syscall_name_table_lookup_xdp+0x2b0> */
	goto x86_l_13b0;
x86_l_12ac:
	/* 0x12ac: cmp    eax,0x9e */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 158ULL);
x86_l_12b1:
...
x86_l_12b7:
	/* 0x12b7: cmp    eax,0xca */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 202ULL);
x86_l_12bc:
...
x86_l_12c2:
	/* 0x12c2: cmp    eax,0xd9 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 217ULL);
x86_l_12c7:
...
x86_l_12cd:
	...
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_64, 0, 110382294525287ULL);
x86_l_12d7:
	/* 0x12d7: jmp    13b0 <tracee_syscall_name_table_lookup_xdp+0x2b0> */
	goto x86_l_13b0;
x86_l_12dc:
	/* 0x12dc: cmp    eax,0x3b */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 59ULL);
x86_l_12df:
...
x86_l_12e5:
	/* 0x12e5: cmp    eax,0x3c */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 60ULL);
x86_l_12e8:
...
x86_l_12ea:
	/* 0x12ea: cmp    eax,0x3d */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 61ULL);
x86_l_12ed:
...
x86_l_12f3:
	...
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_64, 0, 57674588845909ULL);
x86_l_12fd:
	/* 0x12fd: jmp    13b0 <tracee_syscall_name_table_lookup_xdp+0x2b0> */
	goto x86_l_13b0;
x86_l_1302:
	/* 0x1302: cmp    eax,0x123 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 291ULL);
x86_l_1307:
...
x86_l_130d:
	...
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 321ULL);
x86_l_1312:
...
x86_l_1314:
	...
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 332ULL);
x86_l_1319:
...
x86_l_131f:
	...
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 2020893043ULL);
x86_l_1324:
	/* 0x1324: jmp    13b0 <tracee_syscall_name_table_lookup_xdp+0x2b0> */
	goto x86_l_13b0;
x86_l_1329:
	/* 0x1329: mov    rcx,r9 */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RCX, X86_R9, X86_WIDTH_64, 0, 0);
x86_l_132c:
	/* 0x132c: jmp    13b0 <tracee_syscall_name_table_lookup_xdp+0x2b0> */
	goto x86_l_13b0;
x86_l_1331:
	/* 0x1331: movabs rcx,0x6b6e696c6e75 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_64, 0, 118121959288437ULL);
x86_l_133b:
	/* 0x133b: jmp    13b0 <tracee_syscall_name_table_lookup_xdp+0x2b0> */
	goto x86_l_13b0;
x86_l_133d:
	/* 0x133d: movabs rcx,0x656e6f6c6355 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_64, 0, 111524990182229ULL);
x86_l_1347:
...
x86_l_134e:
	...
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 1885433197ULL);
x86_l_1353:
	/* 0x1353: jmp    13b0 <tracee_syscall_name_table_lookup_xdp+0x2b0> */
	goto x86_l_13b0;
x86_l_1355:
	/* 0x1355: movabs rcx,0x786574756655 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_64, 0, 132377140880981ULL);
x86_l_135f:
	/* 0x135f: jmp    13b0 <tracee_syscall_name_table_lookup_xdp+0x2b0> */
	goto x86_l_13b0;
x86_l_1361:
	/* 0x1361: mov    ecx,0x74697865 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 1953069157ULL);
x86_l_1366:
	/* 0x1366: jmp    13b0 <tracee_syscall_name_table_lookup_xdp+0x2b0> */
	goto x86_l_13b0;
x86_l_1368:
	/* 0x1368: mov    ecx,0x706662 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 7366242ULL);
x86_l_136d:
	/* 0x136d: jmp    13b0 <tracee_syscall_name_table_lookup_xdp+0x2b0> */
	goto x86_l_13b0;
x86_l_136f:
	/* 0x136f: mov    ecx,0x72656164 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 1919246692ULL);
x86_l_1374:
	/* 0x1374: jmp    13b0 <tracee_syscall_name_table_lookup_xdp+0x2b0> */
	goto x86_l_13b0;
x86_l_1376:
	/* 0x1376: mov    ecx,0x69646863 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 1768188003ULL);
x86_l_137b:
	/* 0x137b: jmp    13b0 <tracee_syscall_name_table_lookup_xdp+0x2b0> */
	goto x86_l_13b0;
x86_l_137d:
	/* 0x137d: movabs rcx,0x6469707467 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_64, 0, 431265707111ULL);
x86_l_1387:
	/* 0x1387: jmp    13b0 <tracee_syscall_name_table_lookup_xdp+0x2b0> */
	goto x86_l_13b0;
x86_l_1389:
	/* 0x1389: mov    rcx,rbx */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RCX, X86_RBX, X86_WIDTH_64, 0, 0);
x86_l_138c:
	/* 0x138c: jmp    13b0 <tracee_syscall_name_table_lookup_xdp+0x2b0> */
	goto x86_l_13b0;
x86_l_138e:
	/* 0x138e: movabs rcx,0x6c74635f68637261 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_64, 0, 7814980514819043937ULL);
x86_l_1398:
	/* 0x1398: jmp    13b0 <tracee_syscall_name_table_lookup_xdp+0x2b0> */
	goto x86_l_13b0;
x86_l_139a:
	/* 0x139a: movabs rcx,0x657663657865 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_64, 0, 111559148140645ULL);
x86_l_13a4:
	/* 0x13a4: jmp    13b0 <tracee_syscall_name_table_lookup_xdp+0x2b0> */
	goto x86_l_13b0;
x86_l_13a6:
	/* 0x13a6: mov    rcx,r13 */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RCX, X86_R13, X86_WIDTH_64, 0, 0);
x86_l_13a9:
	/* 0x13a9: nop    DWORD PTR [rax+0x0] */
	X86_VM_RUN_OP(x86_exec_nop, X86_OP_NOP, X86_REG_NONE, X86_REG_NONE, X86_WIDTH_64, 0, 0);
x86_l_13b0:
	/* 0x13b0: mov    r15d,eax */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_R15, X86_RAX, X86_WIDTH_32, 0, 0);
x86_l_13b3:
	/* 0x13b3: xor    r15,rcx */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R15, X86_RCX, X86_WIDTH_64, X86_ALU_XOR, 0);
x86_l_13b6:
	/* 0x13b6: mov    eax,r8d */
...
x86_l_13bf:
	/* 0x13bf: mov    r11,r15 */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_R11, X86_R15, X86_WIDTH_64, 0, 0);
x86_l_13c2:
	/* 0x13c2: shl    r11,cl */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R11, X86_RCX, X86_WIDTH_64, X86_ALU_SHL, 0);
x86_l_13c5:
	/* 0x13c5: mov    ecx,eax */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RCX, X86_RAX, X86_WIDTH_32, 0, 0);
x86_l_13c7:
	/* 0x13c7: not    cl */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_8, X86_ALU_NOT, 0);
x86_l_13c9:
	/* 0x13c9: shr    r15,cl */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R15, X86_RCX, X86_WIDTH_64, X86_ALU_SHR, 0);
x86_l_13cc:
	/* 0x13cc: shl    eax,0x3 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, X86_ALU_SHL, 3ULL);
x86_l_13cf:
	/* 0x13cf: mov    ecx,eax */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RCX, X86_RAX, X86_WIDTH_32, 0, 0);
x86_l_13d1:
	/* 0x13d1: shl    rdi,cl */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDI, X86_RCX, X86_WIDTH_64, X86_ALU_SHL, 0);
x86_l_13d4:
	/* 0x13d4: or     r15,r11 */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R15, X86_R11, X86_WIDTH_64, X86_ALU_OR, 0);
x86_l_13d7:
	/* 0x13d7: add    r15,r10 */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R15, X86_R10, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_13da:
	/* 0x13da: xor    rdi,r15 */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDI, X86_R15, X86_WIDTH_64, X86_ALU_XOR, 0);
x86_l_13dd:
	/* 0x13dd: mov    r10,rdi */
...
x86_l_13e3:
	/* 0x13e3: cmp    r8,0x40 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_64, 0, 64ULL);
x86_l_13e7:
...
x86_l_13f1:
	...
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_64, 0, 11400714785074694791ULL);
x86_l_13fb:
	/* 0x13fb: imul   rax,rcx */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RAX, X86_RCX, X86_WIDTH_64, X86_ALU_IMUL, 0);
x86_l_13ff:
	/* 0x13ff: xor    r10,rax */
...
x86_l_1404:
	...
	X86_VM_RUN_OP(x86_exec_mov_store_reg, X86_OP_MOV_STORE_REG, X86_RDX, X86_R10, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_1407:
	/* 0x1407: mov    eax,0x2 */
