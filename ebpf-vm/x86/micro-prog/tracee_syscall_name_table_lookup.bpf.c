...
x86_l_1118:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_RDI, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 268ULL);
x86_l_111f:
	/* 0x111f: cmp    rdi,rcx */
...
x86_l_114a:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_R10, X86_REG_NONE, X86_WIDTH_64, X86_PTR_RODATA, 3759ULL);
x86_l_1151:
	/* 0x1151: lea    r11,[rsi+0xfa0614] */
	X86_VM_RUN_STEP(X86_OP_LEA, X86_R11, X86_RSI, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 16385556ULL);
x86_l_1158:
	/* 0x1158: lea    r15,[rip+0x111d] */
	X86_VM_RUN_STEP(X86_OP_LEA, X86_R15, X86_REG_NONE, X86_WIDTH_64, X86_PTR_RODATA, 4381ULL);
x86_l_115f:
...
x86_l_11c7:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_RCX, X86_RAX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551359ULL);
x86_l_11cd:
	/* 0x11cd: cmp    ecx,0x22 */
