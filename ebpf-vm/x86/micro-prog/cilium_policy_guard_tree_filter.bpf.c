...
x86_l_1118:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_RDI, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 524ULL);
x86_l_111f:
	/* 0x111f: cmp    rdi,rcx */
...
x86_l_1124:
	...
	X86_VM_RUN_STEP(X86_OP_CMP_MEM_IMM, X86_RSI, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 32ULL);
x86_l_1127:
...
x86_l_112a:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_RDI, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 27ULL);
x86_l_112e:
	/* 0x112e: movabs rsi,0xe7037ed1a0b428db */
	X86_VM_RUN_STEP(X86_OP_MOV_IMM, X86_RSI, X86_REG_NONE, X86_WIDTH_64, 0, 16646288086500911323ULL);
x86_l_1138:
	/* 0x1138: xor    r8d,r8d */
...
x86_l_1150:
	/* 0x1150: xor    rax,rcx */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_RAX, X86_RCX, X86_WIDTH_64, X86_ALU_XOR, 0);
x86_l_1153:
	/* 0x1153: add    rsi,rax */
...
x86_l_115e:
	/* 0x115e: mov    rbx,rsi */
	X86_VM_RUN_STEP(X86_OP_MOV_REG, X86_RBX, X86_RSI, X86_WIDTH_64, 0, 0);
x86_l_1161:
	/* 0x1161: shl    rbx,cl */
...
x86_l_116b:
	/* 0x116b: or     rsi,rbx */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_RSI, X86_RBX, X86_WIDTH_64, X86_ALU_OR, 0);
x86_l_116e:
	/* 0x116e: inc    r8 */
...
x86_l_1183:
	...
	X86_VM_RUN_STEP(X86_OP_MOV_LOAD, X86_RAX, X86_RDI, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551609ULL);
x86_l_1187:
	/* 0x1187: cmp    rcx,0x21 */
	X86_VM_RUN_STEP(X86_OP_CMP_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_64, 0, 33ULL);
x86_l_118b:
...
x86_l_1198:
	...
	X86_VM_RUN_STEP(X86_OP_MOV_LOAD, X86_R9, X86_RDI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 18446744073709551603ULL);
x86_l_119d:
	/* 0x119d: test   r9b,r9b */
	X86_VM_RUN_STEP(X86_OP_TEST_REG, X86_R9, X86_R9, X86_WIDTH_8, 0, 0);
x86_l_11a0:
...
x86_l_11a2:
	...
	X86_VM_RUN_STEP(X86_OP_MOV_LOAD, X86_R9, X86_RDI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 18446744073709551604ULL);
x86_l_11a7:
	/* 0x11a7: mov    r10d,r9d */
...
x86_l_11ad:
	...
	X86_VM_RUN_STEP(X86_OP_CMP_IMM, X86_R10, X86_REG_NONE, X86_WIDTH_8, 0, 17ULL);
x86_l_11b1:
...
x86_l_11b3:
	...
	X86_VM_RUN_STEP(X86_OP_MOV_LOAD, X86_R9, X86_RDI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 18446744073709551605ULL);
x86_l_11b8:
	/* 0x11b8: add    cl,r9b */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_RCX, X86_R9, X86_WIDTH_8, X86_ALU_ADD, 0);
x86_l_11bb:
	/* 0x11bb: cmp    cl,0xbf */
	X86_VM_RUN_STEP(X86_OP_CMP_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_8, 0, 191ULL);
x86_l_11be:
...
x86_l_11c0:
	...
	X86_VM_RUN_STEP(X86_OP_MOV_LOAD, X86_RCX, X86_RDI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 18446744073709551606ULL);
x86_l_11c4:
	/* 0x11c4: mov    r9d,ecx */
	X86_VM_RUN_STEP(X86_OP_MOV_REG, X86_R9, X86_RCX, X86_WIDTH_32, 0, 0);
x86_l_11c7:
	/* 0x11c7: and    r9b,0x18 */
	X86_VM_RUN_STEP(X86_OP_ALU_IMM, X86_R9, X86_REG_NONE, X86_WIDTH_8, X86_ALU_AND, 24ULL);
x86_l_11cb:
	/* 0x11cb: cmp    r9b,0x10 */
	X86_VM_RUN_STEP(X86_OP_CMP_IMM, X86_R9, X86_REG_NONE, X86_WIDTH_8, 0, 16ULL);
x86_l_11cf:
...
x86_l_11d1:
	...
	X86_VM_RUN_STEP(X86_OP_MOV_LOAD, X86_R9, X86_RDI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 18446744073709551607ULL);
x86_l_11d6:
	/* 0x11d6: cmp    r9d,0xaa */
	X86_VM_RUN_STEP(X86_OP_CMP_IMM, X86_R9, X86_REG_NONE, X86_WIDTH_32, 0, 170ULL);
x86_l_11dd:
...
x86_l_11df:
	/* 0x11df: xor    rcx,rax */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_RCX, X86_RAX, X86_WIDTH_64, X86_ALU_XOR, 0);
x86_l_11e2:
	/* 0x11e2: shld   rcx,rax,0x7 */
	X86_VM_RUN_STEP(X86_OP_SHLD_IMM, X86_RCX, X86_RAX, X86_WIDTH_64, 0, 7ULL);
x86_l_11e7:
	/* 0x11e7: add    rsi,rcx */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_RSI, X86_RCX, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_11ea:
...
x86_l_1208:
	/* 0x1208: xor    rax,r9 */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_RAX, X86_R9, X86_WIDTH_64, X86_ALU_XOR, 0);
x86_l_120b:
...
x86_l_121d:
	/* 0x121d: mov    r10d,ecx */
	X86_VM_RUN_STEP(X86_OP_MOV_REG, X86_R10, X86_RCX, X86_WIDTH_32, 0, 0);
x86_l_1220:
	/* 0x1220: and    r10b,0x3 */
	X86_VM_RUN_STEP(X86_OP_ALU_IMM, X86_R10, X86_REG_NONE, X86_WIDTH_8, X86_ALU_AND, 3ULL);
x86_l_1224:
	/* 0x1224: cmp    r10b,0x1 */
	X86_VM_RUN_STEP(X86_OP_CMP_IMM, X86_R10, X86_REG_NONE, X86_WIDTH_8, 0, 1ULL);
x86_l_1228:
...
x86_l_1234:
	...
	X86_VM_RUN_STEP(X86_OP_MOV_STORE_REG, X86_RDX, X86_RSI, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_1237:
