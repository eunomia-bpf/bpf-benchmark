...
x86_l_1118:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_RDI, X86_RDX, X86_WIDTH_64, 0, 524ULL);
x86_l_111f:
	/* 0x111f: cmp    rdi,rcx */
...
x86_l_112a:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_RDI, X86_RDX, X86_WIDTH_64, 0, 27ULL);
x86_l_112e:
...
x86_l_1237:
	...
	X86_VM_RUN_STEP(X86_OP_MOV_STORE_REG, X86_RDX, X86_RBX, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 1ULL);
x86_l_123a:
	/* 0x123a: mov    eax,ebx */
