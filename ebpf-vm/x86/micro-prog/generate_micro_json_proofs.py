#!/usr/bin/env python3
"""Generate ReverseJIT JSON proof definitions from micro Native ASM blocks.
...
SCHEMA = "reversejit.x86.micro-proof.v0"
FLOW_NORMAL = 0
FLOW_JCC = 1
FLOW_JMP = 2
FLOW_CALL = 3
...
def build_artifact(md_path: Path, *, native_source: str) -> dict[str, Any]:
    ...
    artifact = {
        ...
        "entry": {
            ...
            "bpf_program": f"{name}_x86_vm_xdp",
        },
        "source": {
        ...
        "link": {
            "kind": "reversejit_interpreter_helper_link",
