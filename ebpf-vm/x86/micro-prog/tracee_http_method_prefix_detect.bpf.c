...
x86_l_1118:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_RSI, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 144ULL);
x86_l_111f:
	/* 0x111f: cmp    rsi,rcx */
	X86_VM_RUN_STEP(X86_OP_CMP_REG, X86_RSI, X86_RCX, X86_WIDTH_64, 0, 0);
x86_l_1122:
...
x86_l_1135:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_RAX, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 22ULL);
x86_l_1139:
...
x86_l_115d:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_R11, X86_R8, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551548ULL);
x86_l_1161:
	/* 0x1161: cmp    r11d,0xc */
...
x86_l_12d2:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_R14, X86_R10, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 1ULL);
x86_l_12d6:
	/* 0x12d6: lea    r15,[rcx+0xa] */
	X86_VM_RUN_STEP(X86_OP_LEA, X86_R15, X86_RCX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 10ULL);
x86_l_12da:
	/* 0x12da: imul   r14,r15 */
