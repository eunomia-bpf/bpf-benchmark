...
x86_l_1150:
	/* 0x1150: mov    rsi,rbx */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RSI, X86_RBX, X86_WIDTH_64, 0, 0);
x86_l_1153:
	/* 0x1153: movzx  edi,BYTE PTR [rax-0x6] */
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_RDI, X86_RAX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 18446744073709551610ULL);
x86_l_1157:
	/* 0x1157: movzx  r8d,BYTE PTR [rax-0x5] */
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_R8, X86_RAX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 18446744073709551611ULL);
x86_l_115c:
	/* 0x115c: cmp    edi,0x47 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, 0, 71ULL);
x86_l_115f:
...
x86_l_1161:
	/* 0x1161: cmp    edi,0x44 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, 0, 68ULL);
x86_l_1164:
...
x86_l_1173:
	/* 0x1173: cmp    r8b,0x45 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_8, 0, 69ULL);
x86_l_1177:
...
x86_l_117d:
	/* 0x117d: mov    r8b,0x45 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_8, 0, 69ULL);
x86_l_1180:
...
x86_l_118a:
	...
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R10, X86_REG_NONE, X86_WIDTH_8, 0, 69ULL);
x86_l_118d:
...
x86_l_11b0:
	...
	X86_VM_RUN_OP(x86_exec_movzx_reg, X86_OP_MOVZX_REG, X86_R9, X86_R8, X86_WIDTH_32, X86_WIDTH_8, 0);
x86_l_11b4:
	/* 0x11b4: cmp    edi,0x48 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, 0, 72ULL);
x86_l_11b7:
...
x86_l_11bd:
	/* 0x11bd: cmp    edi,0x50 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, 0, 80ULL);
x86_l_11c0:
...
x86_l_11c6:
	/* 0x11c6: cmp    r9d,0x55 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_R9, X86_REG_NONE, X86_WIDTH_32, 0, 85ULL);
x86_l_11ca:
...
x86_l_11da:
	/* 0x11da: mov    r8b,0x4f */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_8, 0, 79ULL);
x86_l_11dd:
...
x86_l_11f1:
	...
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R10, X86_REG_NONE, X86_WIDTH_8, 0, 79ULL);
x86_l_11f4:
...
x86_l_1204:
	/* 0x1204: mov    r8b,0x53 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_8, 0, 83ULL);
x86_l_1207:
...
x86_l_1250:
	/* 0x1250: mov    r9d,0x4 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R9, X86_REG_NONE, X86_WIDTH_32, 0, 4ULL);
x86_l_1256:
	/* 0x1256: mov    r8b,0x4c */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_8, 0, 76ULL);
x86_l_1259:
...
x86_l_1261:
	/* 0x1261: cmp    r9d,0x54 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_R9, X86_REG_NONE, X86_WIDTH_32, 0, 84ULL);
x86_l_1265:
...
x86_l_1267:
	/* 0x1267: cmp    r9d,0x45 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_R9, X86_REG_NONE, X86_WIDTH_32, 0, 69ULL);
x86_l_126b:
...
x86_l_1285:
	/* 0x1285: mov    r9d,0x5 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R9, X86_REG_NONE, X86_WIDTH_32, 0, 5ULL);
x86_l_128b:
	/* 0x128b: mov    r8b,0x41 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_8, 0, 65ULL);
x86_l_128e:
	/* 0x128e: mov    r11b,0x44 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R11, X86_REG_NONE, X86_WIDTH_8, 0, 68ULL);
x86_l_1291:
	/* 0x1291: jmp    12f0 <tracee_http_method_prefix_detect_xdp+0x1f0> */
	goto x86_l_12f0;
x86_l_1293:
	/* 0x1293: mov    r8b,0x55 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_8, 0, 85ULL);
x86_l_1296:
...
x86_l_129c:
	...
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R10, X86_REG_NONE, X86_WIDTH_8, 0, 85ULL);
x86_l_129f:
...
x86_l_12ab:
	/* 0x12ab: mov    r8b,0x54 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_8, 0, 84ULL);
x86_l_12ae:
	/* 0x12ae: mov    r11b,0x20 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R11, X86_REG_NONE, X86_WIDTH_8, 0, 32ULL);
x86_l_12b1:
...
x86_l_12c8:
	/* 0x12c8: mov    r9d,0x6 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R9, X86_REG_NONE, X86_WIDTH_32, 0, 6ULL);
x86_l_12ce:
	/* 0x12ce: mov    r11b,0x50 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R11, X86_REG_NONE, X86_WIDTH_8, 0, 80ULL);
x86_l_12d1:
	/* 0x12d1: mov    r10b,0x54 */
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R10, X86_REG_NONE, X86_WIDTH_8, 0, 84ULL);
x86_l_12d4:
...
x86_l_12e3:
	...
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_R8, X86_RAX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 18446744073709551612ULL);
x86_l_12e8:
	/* 0x12e8: movzx  r11d,BYTE PTR [rax-0x3] */
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_R11, X86_RAX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 18446744073709551613ULL);
x86_l_12ed:
	/* 0x12ed: xor    r9d,r9d */
...
x86_l_12f4:
	...
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_RBX, X86_R9, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 1ULL);
x86_l_12f8:
	/* 0x12f8: lea    r14,[rcx+0xa] */
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_R14, X86_RCX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 10ULL);
x86_l_12fc:
	/* 0x12fc: imul   rbx,r14 */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RBX, X86_R14, X86_WIDTH_64, X86_ALU_IMUL, 0);
x86_l_1300:
	/* 0x1300: add    rsi,rbx */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RSI, X86_RBX, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_1303:
	/* 0x1303: shl    r11,0x20 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R11, X86_REG_NONE, X86_WIDTH_64, X86_ALU_SHL, 32ULL);
x86_l_1307:
	/* 0x1307: movzx  r8d,r8b */
	X86_VM_RUN_OP(x86_exec_movzx_reg, X86_OP_MOVZX_REG, X86_R8, X86_R8, X86_WIDTH_32, X86_WIDTH_8, 0);
x86_l_130b:
	/* 0x130b: shl    r8d,0x18 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_32, X86_ALU_SHL, 24ULL);
x86_l_130f:
	/* 0x130f: movzx  r10d,r10b */
	X86_VM_RUN_OP(x86_exec_movzx_reg, X86_OP_MOVZX_REG, X86_R10, X86_R10, X86_WIDTH_32, X86_WIDTH_8, 0);
x86_l_1313:
...
x86_l_131a:
	/* 0x131a: or     edi,r10d */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDI, X86_R10, X86_WIDTH_32, X86_ALU_OR, 0);
x86_l_131d:
	/* 0x131d: or     edi,r8d */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDI, X86_R8, X86_WIDTH_32, X86_ALU_OR, 0);
x86_l_1320:
	/* 0x1320: or     rdi,r11 */
...
x86_l_1326:
	/* 0x1326: or     rbx,rdi */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RBX, X86_RDI, X86_WIDTH_64, X86_ALU_OR, 0);
x86_l_1329:
	/* 0x1329: shl    rbx,cl */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RBX, X86_RCX, X86_WIDTH_64, X86_ALU_SHL, 0);
x86_l_132c:
	/* 0x132c: xor    rbx,rsi */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RBX, X86_RSI, X86_WIDTH_64, X86_ALU_XOR, 0);
x86_l_132f:
	/* 0x132f: add    rax,0x10 */
...
x86_l_1340:
	...
	X86_VM_RUN_OP(x86_exec_mov_store_reg, X86_OP_MOV_STORE_REG, X86_RDX, X86_RSI, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_1343:
