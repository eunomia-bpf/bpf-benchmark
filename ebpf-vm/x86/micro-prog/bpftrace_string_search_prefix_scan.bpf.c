...
x86_l_111f:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_RSI, X86_RCX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 120ULL);
x86_l_1123:
	/* 0x1123: cmp    rsi,rdx */
	X86_VM_RUN_STEP(X86_OP_CMP_REG, X86_RSI, X86_RDX, X86_WIDTH_64, 0, 0);
x86_l_1126:
...
x86_l_11cc:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_R10, X86_RSI, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 3ULL);
x86_l_11d0:
...
x86_l_1209:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_R11, X86_RSI, X86_WIDTH_64, X86_MEM_AUX(X86_R8, 0), 0ULL);
x86_l_120d:
	/* 0x120d: cmp    r11,r9 */
...
x86_l_122d:
	...
	X86_VM_RUN_STEP(X86_OP_ALU_MEM, X86_RBX, X86_RCX, X86_WIDTH_8, (X86_MEM_AUX_FULL(X86_R8, 0, X86_WIDTH_8) | X86_MEM_AUX_ALU_OP(X86_ALU_XOR)), 17ULL);
x86_l_1232:
	/* 0x1232: or     r11b,bl */
...
x86_l_123e:
	...
	X86_VM_RUN_STEP(X86_OP_ALU_MEM, X86_RBX, X86_RCX, X86_WIDTH_8, (X86_MEM_AUX_FULL(X86_R8, 0, X86_WIDTH_8) | X86_MEM_AUX_ALU_OP(X86_ALU_XOR)), 18ULL);
x86_l_1243:
	/* 0x1243: or     r11b,bl */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_R11, X86_RBX, X86_WIDTH_8, X86_ALU_OR, 0);
x86_l_1246:
...
x86_l_124f:
	...
	X86_VM_RUN_STEP(X86_OP_ALU_MEM, X86_RBX, X86_RCX, X86_WIDTH_8, (X86_MEM_AUX_FULL(X86_R8, 0, X86_WIDTH_8) | X86_MEM_AUX_ALU_OP(X86_ALU_XOR)), 19ULL);
x86_l_1254:
	/* 0x1254: or     r11b,bl */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_R11, X86_RBX, X86_WIDTH_8, X86_ALU_OR, 0);
x86_l_1257:
...
x86_l_1260:
	...
	X86_VM_RUN_STEP(X86_OP_ALU_MEM, X86_RBX, X86_RCX, X86_WIDTH_8, (X86_MEM_AUX_FULL(X86_R8, 0, X86_WIDTH_8) | X86_MEM_AUX_ALU_OP(X86_ALU_XOR)), 20ULL);
x86_l_1265:
	/* 0x1265: or     r11b,bl */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_R11, X86_RBX, X86_WIDTH_8, X86_ALU_OR, 0);
x86_l_1268:
...
x86_l_1271:
	...
	X86_VM_RUN_STEP(X86_OP_ALU_MEM, X86_RBX, X86_RCX, X86_WIDTH_8, (X86_MEM_AUX_FULL(X86_R8, 0, X86_WIDTH_8) | X86_MEM_AUX_ALU_OP(X86_ALU_XOR)), 21ULL);
x86_l_1276:
	/* 0x1276: or     r11b,bl */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_R11, X86_RBX, X86_WIDTH_8, X86_ALU_OR, 0);
x86_l_1279:
...
x86_l_1286:
	...
	X86_VM_RUN_STEP(X86_OP_ALU_MEM, X86_RBX, X86_RCX, X86_WIDTH_8, (X86_MEM_AUX_FULL(X86_R8, 0, X86_WIDTH_8) | X86_MEM_AUX_ALU_OP(X86_ALU_XOR)), 22ULL);
x86_l_128b:
	/* 0x128b: or     r11b,bl */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_R11, X86_RBX, X86_WIDTH_8, X86_ALU_OR, 0);
x86_l_128e:
...
x86_l_129b:
	...
	X86_VM_RUN_STEP(X86_OP_ALU_MEM, X86_RBX, X86_RCX, X86_WIDTH_8, (X86_MEM_AUX_FULL(X86_R8, 0, X86_WIDTH_8) | X86_MEM_AUX_ALU_OP(X86_ALU_XOR)), 23ULL);
x86_l_12a0:
	/* 0x12a0: or     r11b,bl */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_R11, X86_RBX, X86_WIDTH_8, X86_ALU_OR, 0);
x86_l_12a3:
