...
x86_l_1150:
	...
	X86_VM_LOOP_OP(X86_OP_MOV_LOAD, X86_R8, X86_RDX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_RCX, 0, X86_WIDTH_16), 18446744073709551613ULL);
x86_l_1156:
	/* 0x1156: add    r8d,edi */
	X86_VM_LOOP_OP(X86_OP_ALU_REG, X86_R8, X86_RDI, X86_WIDTH_32, X86_ALU_ADD, 0);
x86_l_1159:
	/* 0x1159: movzx  edi,r8w */
	X86_VM_LOOP_OP(X86_OP_MOVZX_REG, X86_RDI, X86_R8, X86_WIDTH_32, X86_WIDTH_16, 0);
x86_l_115d:
	/* 0x115d: shr    r8d,0x10 */
...
x86_l_1164:
	...
	X86_VM_LOOP_OP(X86_OP_MOV_LOAD, X86_RDI, X86_RDX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_RCX, 0, X86_WIDTH_16), 18446744073709551615ULL);
x86_l_1169:
	/* 0x1169: add    edi,r8d */
	X86_VM_LOOP_OP(X86_OP_ALU_REG, X86_RDI, X86_R8, X86_WIDTH_32, X86_ALU_ADD, 0);
x86_l_116c:
	/* 0x116c: movzx  r8d,di */
	X86_VM_LOOP_OP(X86_OP_MOVZX_REG, X86_R8, X86_RDI, X86_WIDTH_32, X86_WIDTH_16, 0);
x86_l_1170:
	/* 0x1170: shr    edi,0x10 */
	X86_VM_LOOP_OP(X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, X86_ALU_SHR, 16ULL);
x86_l_1173:
	/* 0x1173: add    edi,r8d */
	X86_VM_LOOP_OP(X86_OP_ALU_REG, X86_RDI, X86_R8, X86_WIDTH_32, X86_ALU_ADD, 0);
x86_l_1176:
	/* 0x1176: add    rcx,0x4 */
	X86_VM_LOOP_OP(X86_OP_ALU_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 4ULL);
x86_l_117a:
	/* 0x117a: cmp    rcx,0x413 */
	X86_VM_LOOP_OP(X86_OP_CMP_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_64, 0, 1043ULL);
x86_l_1181:
...
x86_l_1140:
	/* 0x1140: mov    ecx,0x13 */
	X86_VM_LOOP_OP(X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 19ULL);
x86_l_1145:
	/* 0x1145: xor    edi,edi */
	X86_VM_LOOP_OP(X86_OP_ALU_REG, X86_RDI, X86_RDI, X86_WIDTH_32, X86_ALU_XOR, 0);
x86_l_1147:
...
x86_l_1183:
	/* 0x1183: mov    ecx,edi */
	X86_VM_LOOP_OP(X86_OP_MOV_REG, X86_RCX, X86_RDI, X86_WIDTH_32, 0, 0);
x86_l_1185:
	/* 0x1185: shr    ecx,0x10 */
	X86_VM_LOOP_OP(X86_OP_ALU_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, X86_ALU_SHR, 16ULL);
x86_l_1188:
	/* 0x1188: add    ecx,edi */
	X86_VM_LOOP_OP(X86_OP_ALU_REG, X86_RCX, X86_RDI, X86_WIDTH_32, X86_ALU_ADD, 0);
x86_l_118a:
	/* 0x118a: not    ecx */
	X86_VM_LOOP_OP(X86_OP_ALU_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, X86_ALU_NOT, 0);
x86_l_118c:
	/* 0x118c: movzx  edi,cx */
	X86_VM_LOOP_OP(X86_OP_MOVZX_REG, X86_RDI, X86_RCX, X86_WIDTH_32, X86_WIDTH_16, 0);
x86_l_118f:
	/* 0x118f: mov    ecx,eax */
	X86_VM_LOOP_OP(X86_OP_MOV_REG, X86_RCX, X86_RAX, X86_WIDTH_32, 0, 0);
x86_l_1191:
	/* 0x1191: shl    ecx,0x4 */
	X86_VM_LOOP_OP(X86_OP_ALU_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, X86_ALU_SHL, 4ULL);
x86_l_1194:
	/* 0x1194: shl    rdi,cl */
	X86_VM_LOOP_OP(X86_OP_ALU_REG, X86_RDI, X86_RCX, X86_WIDTH_64, X86_ALU_SHL, 0);
x86_l_1197:
	/* 0x1197: xor    rsi,rdi */
	X86_VM_LOOP_OP(X86_OP_ALU_REG, X86_RSI, X86_RDI, X86_WIDTH_64, X86_ALU_XOR, 0);
x86_l_119a:
	/* 0x119a: inc    eax */
	X86_VM_LOOP_OP(X86_OP_ALU_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, X86_ALU_INC, 1);
x86_l_119c:
	/* 0x119c: cmp    eax,0x20 */
	X86_VM_LOOP_OP(X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 32ULL);
x86_l_119f:
