...
static long packet_checksum_fold_inner_cb(__u32 index, void *ctx)
{
	...
	/* 0x1156: add    r8d,edi */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R8, X86_RDI, X86_WIDTH_32, X86_ALU_ADD, 0);
	/* 0x1159: movzx  edi,r8w */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_movzx_reg, X86_OP_MOVZX_REG, X86_RDI, X86_R8, X86_WIDTH_32, X86_WIDTH_16, 0);
	/* 0x115d: shr    r8d,0x10 */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_32, X86_ALU_SHR, 16ULL);
	/* 0x1161: add    r8d,edi */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R8, X86_RDI, X86_WIDTH_32, X86_ALU_ADD, 0);
	/* 0x1164: movzx  edi,WORD PTR [rdx+rcx*1-0x1] */
	PACKET_CHECKSUM_LOAD_U16(rdi, p_rdi, tag_rdi, 18 + (loop->inner << 2));
	/* 0x1169: add    edi,r8d */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDI, X86_R8, X86_WIDTH_32, X86_ALU_ADD, 0);
	/* 0x116c: movzx  r8d,di */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_movzx_reg, X86_OP_MOVZX_REG, X86_R8, X86_RDI, X86_WIDTH_32, X86_WIDTH_16, 0);
	/* 0x1170: shr    edi,0x10 */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RDI, X86_REG_NONE, X86_WIDTH_32, X86_ALU_SHR, 16ULL);
	/* 0x1173: add    edi,r8d */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDI, X86_R8, X86_WIDTH_32, X86_ALU_ADD, 0);
	/* 0x1176: add    rcx,0x4 */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 4ULL);
	/* 0x117a: cmp    rcx,0x413 */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_64, 0, 1043ULL);
...
static long packet_checksum_fold_outer_cb(__u32 index, void *ctx)
{
	...
	loop->inner = 0;
	/* 0x1140: mov    ecx,0x13 */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, 0, 19ULL);
	/* 0x1145: xor    edi,edi */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDI, X86_RDI, X86_WIDTH_32, X86_ALU_XOR, 0);
	/* 0x1147: nop    WORD PTR [rax+rax*1+0x0] */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_nop, X86_OP_NOP, X86_REG_NONE, X86_REG_NONE, X86_WIDTH_64, 0, 0);
	...
	if (loop->failed)
		return 1;
	/* 0x1183: mov    ecx,edi */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RCX, X86_RDI, X86_WIDTH_32, 0, 0);
	/* 0x1185: shr    ecx,0x10 */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, X86_ALU_SHR, 16ULL);
	/* 0x1188: add    ecx,edi */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RCX, X86_RDI, X86_WIDTH_32, X86_ALU_ADD, 0);
	/* 0x118a: not    ecx */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, X86_ALU_NOT, 0);
	/* 0x118c: movzx  edi,cx */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_movzx_reg, X86_OP_MOVZX_REG, X86_RDI, X86_RCX, X86_WIDTH_32, X86_WIDTH_16, 0);
	/* 0x118f: mov    ecx,eax */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RCX, X86_RAX, X86_WIDTH_32, 0, 0);
	/* 0x1191: shl    ecx,0x4 */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_32, X86_ALU_SHL, 4ULL);
	/* 0x1194: shl    rdi,cl */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDI, X86_RCX, X86_WIDTH_64, X86_ALU_SHL, 0);
	/* 0x1197: xor    rsi,rdi */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RSI, X86_RDI, X86_WIDTH_64, X86_ALU_XOR, 0);
	/* 0x119a: inc    eax */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, X86_ALU_INC, 1);
	/* 0x119c: cmp    eax,0x20 */
	PACKET_CHECKSUM_LOOP_STEP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_32, 0, 32ULL);
