...
x86_l_1118:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_RDI, X86_RDX, X86_WIDTH_64, 0, 2064ULL);
x86_l_111f:
	/* 0x111f: cmp    rdi,rcx */
...
x86_l_1124:
	...
	X86_VM_RUN_STEP(X86_OP_CMP_MEM_IMM, X86_RSI, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 256ULL);
x86_l_112a:
...
x86_l_112c:
	...
	X86_VM_RUN_STEP(X86_OP_MOV_LOAD, X86_RCX, X86_RDX, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 12ULL);
x86_l_112f:
	/* 0x112f: xor    eax,eax */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_RAX, X86_RAX, X86_WIDTH_32, X86_ALU_XOR, 0);
x86_l_1131:
...
x86_l_1140:
	...
	X86_VM_RUN_STEP(X86_OP_MOV_LOAD, X86_RSI, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_RAX, 3), 16ULL);
x86_l_1145:
	/* 0x1145: mov    rdi,rsi */
	X86_VM_RUN_STEP(X86_OP_MOV_REG, X86_RDI, X86_RSI, X86_WIDTH_64, 0, 0);
x86_l_1148:
	/* 0x1148: xor    rdi,rcx */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_RDI, X86_RCX, X86_WIDTH_64, X86_ALU_XOR, 0);
x86_l_114b:
	/* 0x114b: popcnt rdi,rdi */
	X86_VM_RUN_STEP(X86_OP_POPCNT, X86_RDI, X86_RDI, X86_WIDTH_64, 0, 0);
x86_l_1150:
	/* 0x1150: add    rdi,rcx */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_RDI, X86_RCX, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_1153:
	/* 0x1153: mov    ecx,eax */
	X86_VM_RUN_STEP(X86_OP_MOV_REG, X86_RCX, X86_RAX, X86_WIDTH_32, 0, 0);
x86_l_1155:
	/* 0x1155: and    cl,0x7 */
	X86_VM_RUN_STEP(X86_OP_ALU_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_8, X86_ALU_AND, 7ULL);
x86_l_1158:
	/* 0x1158: shr    rsi,cl */
...
x86_l_115e:
	/* 0x115e: xor    rcx,rdi */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_RCX, X86_RDI, X86_WIDTH_64, X86_ALU_XOR, 0);
x86_l_1161:
	/* 0x1161: inc    rax */
	X86_VM_RUN_STEP(X86_OP_ALU_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_64, X86_ALU_INC, 1);
x86_l_1164:
	/* 0x1164: cmp    rax,0x100 */
	X86_VM_RUN_STEP(X86_OP_CMP_IMM, X86_RAX, X86_REG_NONE, X86_WIDTH_64, 0, 256ULL);
x86_l_116a:
...
x86_l_116c:
	...
	X86_VM_RUN_STEP(X86_OP_MOV_STORE_REG, X86_RDX, X86_RCX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_116f:
	/* 0x116f: mov    eax,0x2 */
