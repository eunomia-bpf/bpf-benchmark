...
x86_l_12b0:
	/* 0x12b0: push   r14 */
	X86_VM_RUN_OP_SUB(x86_exec_push, X86_OP_PUSH, X86_REG_NONE, X86_R14, X86_WIDTH_64, 0, 0);
x86_l_12b2:
	/* 0x12b2: push   rbx */
	X86_VM_RUN_OP_SUB(x86_exec_push, X86_OP_PUSH, X86_REG_NONE, X86_RBX, X86_WIDTH_64, 0, 0);
x86_l_12b3:
	/* 0x12b3: mov    r8d,ecx */
	X86_VM_RUN_OP_SUB(x86_exec_mov_reg, X86_OP_MOV_REG, X86_R8, X86_RCX, X86_WIDTH_32, 0, 0);
x86_l_12b6:
...
x86_l_1332:
	/* 0x1332: pop    rbx */
	X86_VM_RUN_OP_SUB(x86_exec_pop, X86_OP_POP, X86_RBX, X86_REG_NONE, X86_WIDTH_64, 0, 0);
x86_l_1333:
	/* 0x1333: pop    r14 */
	X86_VM_RUN_OP_SUB(x86_exec_pop, X86_OP_POP, X86_R14, X86_REG_NONE, X86_WIDTH_64, 0, 0);
x86_l_1335:
	/* 0x1335: ret */
	return X86_INTERP_CONTINUE;
	#undef __x86_vm_state
...
x86_l_110a:
	/* 0x110a: push   rax */
	X86_VM_RUN_OP(x86_exec_push, X86_OP_PUSH, X86_REG_NONE, X86_RAX, X86_WIDTH_64, 0, 0);
x86_l_110b:
	/* 0x110b: mov    r14,QWORD PTR [rdi] */
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_R14, X86_RDI, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_110e:
...
x86_l_1114:
	/* 0x1114: cmp    r14,rcx */
	X86_VM_RUN_OP(x86_exec_cmp_reg, X86_OP_CMP_REG, X86_R14, X86_RCX, X86_WIDTH_64, 0, 0);
x86_l_1117:
...
x86_l_1119:
	/* 0x1119: add    rsp,0x8 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 8ULL);
x86_l_111d:
	/* 0x111d: pop    rbx */
...
x86_l_1128:
	...
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_RDX, X86_R14, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 8ULL);
x86_l_112c:
	/* 0x112c: mov    QWORD PTR [rsp],rdx */
	X86_VM_RUN_OP(x86_exec_mov_store_reg, X86_OP_MOV_STORE_REG, X86_RSP, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_1130:
	/* 0x1130: cmp    rdx,rcx */
...
x86_l_1135:
	...
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_RDX, X86_R14, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 400ULL);
x86_l_113c:
	/* 0x113c: cmp    rdx,rcx */
	X86_VM_RUN_OP(x86_exec_cmp_reg, X86_OP_CMP_REG, X86_RDX, X86_RCX, X86_WIDTH_64, 0, 0);
x86_l_113f:
...
x86_l_1141:
	...
	X86_VM_RUN_OP(x86_exec_cmp_mem_imm, X86_OP_CMP_MEM_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 34359738384ULL);
x86_l_1146:
...
x86_l_1148:
	...
	X86_VM_RUN_OP(x86_exec_cmp_mem_imm, X86_OP_CMP_MEM_IMM, X86_R14, X86_REG_NONE, X86_WIDTH_32, X86_MEM_AUX(X86_REG_NONE, 0), 51539607576ULL);
x86_l_114d:
...
x86_l_115c:
	...
	X86_VM_RUN_OP(x86_exec_mov_imm, X86_OP_MOV_IMM, X86_R12, X86_REG_NONE, X86_WIDTH_32, 0, 23ULL);
x86_l_1162:
...
x86_l_1170:
	...
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_RSI, X86_RSP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_1174:
	/* 0x1174: mov    ecx,ebp */
...
x86_l_117b:
	/* 0x117b: mov    ecx,r13d */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RCX, X86_R13, X86_WIDTH_32, 0, 0);
x86_l_117e:
	/* 0x117e: and    cl,0x38 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RCX, X86_REG_NONE, X86_WIDTH_8, X86_ALU_AND, 56ULL);
x86_l_1181:
	/* 0x1181: shl    rbx,cl */
...
x86_l_1186:
	/* 0x1186: add    rdi,rbx */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDI, X86_RBX, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_1189:
	/* 0x1189: xor    rdi,rax */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDI, X86_RAX, X86_WIDTH_64, X86_ALU_XOR, 0);
x86_l_118c:
	/* 0x118c: add    r13,0x8 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R13, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 8ULL);
x86_l_1190:
	/* 0x1190: add    r15d,0x10 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R15, X86_REG_NONE, X86_WIDTH_32, X86_ALU_ADD, 16ULL);
x86_l_1194:
	/* 0x1194: add    r12,0x18 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R12, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 24ULL);
x86_l_1198:
	/* 0x1198: cmp    r13,0x80 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_R13, X86_REG_NONE, X86_WIDTH_64, 0, 128ULL);
x86_l_119f:
...
x86_l_11a1:
	...
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_RBX, X86_R14, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_R12, 0, X86_WIDTH_8), 18446744073709551609ULL);
x86_l_11a7:
	/* 0x11a7: and    ebx,0x3 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_32, X86_ALU_AND, 3ULL);
x86_l_11aa:
	/* 0x11aa: mov    ebp,DWORD PTR [r14+r12*1-0x3] */
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_RBP, X86_R14, X86_WIDTH_32, X86_MEM_AUX(X86_R12, 0), 18446744073709551613ULL);
x86_l_11af:
	/* 0x11af: xor    ebp,r15d */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RBP, X86_R15, X86_WIDTH_32, X86_ALU_XOR, 0);
x86_l_11b2:
	/* 0x11b2: lea    rdx,[r12-0xf] */
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_RDX, X86_R12, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551601ULL);
x86_l_11b7:
	/* 0x11b7: cmp    rbx,0x2 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_64, 0, 2ULL);
x86_l_11bb:
...
x86_l_11bd:
	/* 0x11bd: cmp    ebx,0x1 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_32, 0, 1ULL);
x86_l_11c0:
...
x86_l_11c2:
	/* 0x11c2: test   ebx,ebx */
	X86_VM_RUN_OP(x86_exec_test_reg, X86_OP_TEST_REG, X86_RBX, X86_RBX, X86_WIDTH_32, 0, 0);
x86_l_11c4:
...
x86_l_1200:
	...
	X86_VM_RUN_OP(x86_exec_mov_store_reg, X86_OP_MOV_STORE_REG, X86_R14, X86_RDI, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_1203:
	/* 0x1203: mov    eax,0x2 */
