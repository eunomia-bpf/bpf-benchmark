...
x86_l_1280:
	/* 0x1280: push   rbp */
	X86_VM_RUN_OP_SUB(x86_exec_push, X86_OP_PUSH, X86_REG_NONE, X86_RBP, X86_WIDTH_64, 0, 0);
x86_l_1281:
	/* 0x1281: mov    rbp,rsp */
	X86_VM_RUN_OP_SUB(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RBP, X86_RSP, X86_WIDTH_64, 0, 0);
x86_l_1284:
	/* 0x1284: mov    eax,edx */
...
x86_l_12cd:
	/* 0x12cd: pop    rbp */
	X86_VM_RUN_OP_SUB(x86_exec_pop, X86_OP_POP, X86_RBP, X86_REG_NONE, X86_WIDTH_64, 0, 0);
x86_l_12ce:
	/* 0x12ce: ret */
...
x86_l_111f:
	/* 0x111f: sub    rsp,0x18 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_ALU_SUB, 24ULL);
x86_l_1123:
...
x86_l_1184:
	/* 0x1184: mov    ecx,r14d */
	X86_VM_RUN_OP(x86_exec_mov_reg, X86_OP_MOV_REG, X86_RCX, X86_R14, X86_WIDTH_32, 0, 0);
x86_l_1187:
...
x86_l_1197:
	/* 0x1197: add    rdi,r15 */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDI, X86_R15, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_119a:
	/* 0x119a: xor    rdi,rax */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RDI, X86_RAX, X86_WIDTH_64, X86_ALU_XOR, 0);
x86_l_119d:
	/* 0x119d: add    rbx,0x8 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 8ULL);
x86_l_11a1:
	/* 0x11a1: add    r12d,0x10 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R12, X86_REG_NONE, X86_WIDTH_32, X86_ALU_ADD, 16ULL);
x86_l_11a5:
	/* 0x11a5: add    r13,0x18 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R13, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 24ULL);
x86_l_11a9:
	/* 0x11a9: cmp    rbx,0x80 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_64, 0, 128ULL);
x86_l_11b0:
	/* 0x11b0: mov    rsi,QWORD PTR [rbp-0x38] */
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_RSI, X86_RBP, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551560ULL);
x86_l_11b4:
...
x86_l_11b6:
	...
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_R15, X86_RSI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_R13, 0, X86_WIDTH_8), 18446744073709551609ULL);
x86_l_11bc:
	/* 0x11bc: and    r15d,0x3 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_R15, X86_REG_NONE, X86_WIDTH_32, X86_ALU_AND, 3ULL);
x86_l_11c0:
	/* 0x11c0: mov    r14d,DWORD PTR [rsi+r13*1-0x3] */
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_R14, X86_RSI, X86_WIDTH_32, X86_MEM_AUX(X86_R13, 0), 18446744073709551613ULL);
x86_l_11c5:
...
x86_l_11c8:
	...
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_RDX, X86_R13, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 18446744073709551601ULL);
x86_l_11cc:
	/* 0x11cc: cmp    r15,0x2 */
	X86_VM_RUN_OP(x86_exec_cmp_imm, X86_OP_CMP_IMM, X86_R15, X86_REG_NONE, X86_WIDTH_64, 0, 2ULL);
x86_l_11d0:
...
x86_l_11d8:
	...
	X86_VM_RUN_OP(x86_exec_test_reg, X86_OP_TEST_REG, X86_R15, X86_R15, X86_WIDTH_32, 0, 0);
x86_l_11db:
...
x86_l_1219:
	/* 0x1219: add    rsp,0x18 */
	X86_VM_RUN_OP(x86_exec_alu_imm, X86_OP_ALU_IMM, X86_RSP, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 24ULL);
x86_l_121d:
	/* 0x121d: pop    rbx */
...
x86_l_1227:
	...
	if (__x86_call_depth == 1) {
		__x86_call_depth = 0;
		if (__x86_call_ret0 == 0x118c)
			goto x86_l_118c;
		if (__x86_call_ret0 == 0x11e9)
			goto x86_l_11e9;
		if (__x86_call_ret0 == 0x11fc)
			goto x86_l_11fc;
		if (__x86_call_ret0 == 0x120c)
			goto x86_l_120c;
		return XDP_ABORTED;
	}
	if (__x86_call_depth == 2) {
		__x86_call_depth = 1;
		if (__x86_call_ret1 == 0x118c)
			goto x86_l_118c;
		if (__x86_call_ret1 == 0x11e9)
			goto x86_l_11e9;
		if (__x86_call_ret1 == 0x11fc)
			goto x86_l_11fc;
		if (__x86_call_ret1 == 0x120c)
			goto x86_l_120c;
		return XDP_ABORTED;
	}
	return XDP_ABORTED;
