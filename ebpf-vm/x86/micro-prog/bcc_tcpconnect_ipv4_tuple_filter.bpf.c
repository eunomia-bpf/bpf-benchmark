...
x86_l_11e4:
	...
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_R14, X86_RSI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 18446744073709551614ULL);
x86_l_11e9:
...
x86_l_11ff:
	...
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_R15, X86_RSI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 18446744073709551609ULL);
x86_l_1204:
	/* 0x1204: movzx  r12d,BYTE PTR [rsi-0x6] */
	X86_VM_RUN_OP(x86_exec_mov_load, X86_OP_MOV_LOAD, X86_R12, X86_RSI, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_REG_NONE, 0, X86_WIDTH_8), 18446744073709551610ULL);
x86_l_1209:
	/* 0x1209: rol    ecx,0x7 */
...
x86_l_1222:
	/* 0x1222: xor    eax,r15d */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_RAX, X86_R15, X86_WIDTH_32, X86_ALU_XOR, 0);
x86_l_1225:
	/* 0x1225: xor    eax,ecx */
...
x86_l_1230:
	...
	X86_VM_RUN_OP(x86_exec_lea, X86_OP_LEA, X86_R15, X86_R10, X86_WIDTH_32, X86_MEM_AUX(X86_RBX, 0), 0ULL);
x86_l_1234:
	/* 0x1234: and    r15d,ecx */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R15, X86_RCX, X86_WIDTH_32, X86_ALU_AND, 0);
x86_l_1237:
	/* 0x1237: xor    r15d,r11d */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R15, X86_R11, X86_WIDTH_32, X86_ALU_XOR, 0);
x86_l_123a:
	/* 0x123a: xor    r15d,eax */
	X86_VM_RUN_OP(x86_exec_alu_reg, X86_OP_ALU_REG, X86_R15, X86_RAX, X86_WIDTH_32, X86_ALU_XOR, 0);
x86_l_123d:
...
x86_l_124a:
	...
	X86_VM_RUN_OP(x86_exec_cmov, X86_OP_CMOV, X86_RAX, X86_R15, X86_WIDTH_32, X86_CC_E, 0);
x86_l_124e:
	/* 0x124e: shl    rax,0x20 */
