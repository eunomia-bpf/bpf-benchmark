...
x86_l_1118:
	...
	X86_VM_RUN_STEP(X86_OP_LEA, X86_RDI, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_REG_NONE, 0), 1040ULL);
x86_l_111f:
	/* 0x111f: cmp    rdi,rcx */
...
x86_l_1130:
	...
	X86_VM_RUN_STEP(X86_OP_MOV_IMM, X86_R8, X86_REG_NONE, X86_WIDTH_64, 0, 11400714819323198485ULL);
x86_l_113a:
	/* 0x113a: xor    esi,esi */
...
x86_l_1145:
	/* 0x1145: shr    r10,cl */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_R10, X86_RCX, X86_WIDTH_64, X86_ALU_SHR, 0);
x86_l_1148:
	/* 0x1148: xor    r9,r10 */
...
x86_l_1153:
	/* 0x1153: mov    r8,rax */
	X86_VM_RUN_STEP(X86_OP_MOV_REG, X86_R8, X86_RAX, X86_WIDTH_64, 0, 0);
x86_l_1156:
	/* 0x1156: shl    r8,cl */
...
x86_l_1161:
	/* 0x1161: mov    rbx,r8 */
	X86_VM_RUN_STEP(X86_OP_MOV_REG, X86_RBX, X86_R8, X86_WIDTH_64, 0, 0);
x86_l_1164:
	/* 0x1164: shl    rbx,cl */
...
x86_l_116b:
	/* 0x116b: shr    r8,cl */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_R8, X86_RCX, X86_WIDTH_64, X86_ALU_SHR, 0);
x86_l_116e:
	/* 0x116e: or     r8,rbx */
...
x86_l_1174:
	/* 0x1174: add    rsi,0x8 */
	X86_VM_RUN_STEP(X86_OP_ALU_IMM, X86_RSI, X86_REG_NONE, X86_WIDTH_64, X86_ALU_ADD, 8ULL);
x86_l_1178:
	/* 0x1178: cmp    rdi,0x20 */
...
x86_l_117e:
	...
	X86_VM_RUN_STEP(X86_OP_MOV_LOAD, X86_R10, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_RSI, 2), 32ULL);
x86_l_1183:
	/* 0x1183: mov    rcx,QWORD PTR [rdx+rsi*4+0x18] */
	X86_VM_RUN_STEP(X86_OP_MOV_LOAD, X86_RCX, X86_RDX, X86_WIDTH_64, X86_MEM_AUX(X86_RSI, 2), 24ULL);
x86_l_1188:
	/* 0x1188: add    rcx,r10 */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_RCX, X86_R10, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_118b:
	/* 0x118b: mov    eax,DWORD PTR [rdx+rsi*4+0x28] */
	X86_VM_RUN_STEP(X86_OP_MOV_LOAD, X86_RAX, X86_RDX, X86_WIDTH_32, X86_MEM_AUX(X86_RSI, 2), 40ULL);
x86_l_118f:
	/* 0x118f: shl    rax,0x20 */
...
x86_l_1193:
	...
	X86_VM_RUN_STEP(X86_OP_MOV_LOAD, X86_R9, X86_RDX, X86_WIDTH_32, X86_MEM_AUX(X86_RSI, 2), 44ULL);
x86_l_1198:
	/* 0x1198: or     r9,rax */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_R9, X86_RAX, X86_WIDTH_64, X86_ALU_OR, 0);
x86_l_119b:
	/* 0x119b: mov    eax,DWORD PTR [rdx+rsi*4+0x10] */
	X86_VM_RUN_STEP(X86_OP_MOV_LOAD, X86_RAX, X86_RDX, X86_WIDTH_32, X86_MEM_AUX(X86_RSI, 2), 16ULL);
x86_l_119f:
	/* 0x119f: mov    r11,rax */
	X86_VM_RUN_STEP(X86_OP_MOV_REG, X86_R11, X86_RAX, X86_WIDTH_64, 0, 0);
x86_l_11a2:
	/* 0x11a2: shl    r11,0x10 */
	X86_VM_RUN_STEP(X86_OP_ALU_IMM, X86_R11, X86_REG_NONE, X86_WIDTH_64, X86_ALU_SHL, 16ULL);
x86_l_11a6:
	/* 0x11a6: movzx  ebx,WORD PTR [rdx+rsi*4+0x14] */
	X86_VM_RUN_STEP(X86_OP_MOV_LOAD, X86_RBX, X86_RDX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_RSI, 2, X86_WIDTH_16), 20ULL);
x86_l_11ab:
	/* 0x11ab: or     r11,rbx */
...
x86_l_11b4:
	/* 0x11b4: test   bl,0x1 */
	X86_VM_RUN_STEP(X86_OP_TEST_IMM, X86_RBX, X86_REG_NONE, X86_WIDTH_8, 0, 1ULL);
x86_l_11b7:
...
x86_l_11b9:
	...
	X86_VM_RUN_STEP(X86_OP_MOV_LOAD, X86_RCX, X86_RDX, X86_WIDTH_32, X86_MEM_AUX_FULL(X86_RSI, 2, X86_WIDTH_16), 22ULL);
x86_l_11be:
	/* 0x11be: add    r9,rcx */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_R9, X86_RCX, X86_WIDTH_64, X86_ALU_ADD, 0);
x86_l_11c1:
	/* 0x11c1: xor    r9,r11 */
	X86_VM_RUN_STEP(X86_OP_ALU_REG, X86_R9, X86_R11, X86_WIDTH_64, X86_ALU_XOR, 0);
x86_l_11c4:
	/* 0x11c4: jmp    114e <flow_record_field_scan_xdp+0x4e> */
	goto x86_l_114e;
x86_l_11c6:
	/* 0x11c6: mov    BYTE PTR [rdx],r8b */
	X86_VM_RUN_STEP(X86_OP_MOV_STORE_REG, X86_RDX, X86_R8, X86_WIDTH_8, X86_MEM_AUX(X86_REG_NONE, 0), 0ULL);
x86_l_11c9:
